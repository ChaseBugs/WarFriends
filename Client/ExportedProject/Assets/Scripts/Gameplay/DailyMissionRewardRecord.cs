...
public class DailyMissionRewardRecord : Core_BaseScript
{
	...
	[Header("Text")]
	[FormerlySerializedAs("mMultiplierAmount")]
	[SerializeField]
	...
	{
		mXpLabel.gameObject.SetActive(value: true);
		mWarbucksSprite.gameObject.SetActive(value: true);
		mHeroicPoints.SetActive(value: true);
		mGoldSprite.gameObject.SetActive(value: true);
		mCardpack.gameObject.SetActive(value: true);
		mScraps.gameObject.SetActive(value: false);
		mArenaTickets.gameObject.SetActive(value: false);
		mEliteParts.SetActive(value: true);
	}
	...
	{
		mXpLabel.gameObject.SetActive(value: true);
		mWarbucksSprite.gameObject.SetActive(value: false);
		mHeroicPoints.SetActive(value: true);
		mGoldSprite.gameObject.SetActive(value: false);
		mCardpack.gameObject.SetActive(value: false);
		mScraps.gameObject.SetActive(value: false);
		mArenaTickets.gameObject.SetActive(value: true);
		mEliteParts.SetActive(value: true);
	}

	private void DBKJEFGADBG()
	{
		mXpLabel.gameObject.SetActive(value: false);
		mWarbucksSprite.gameObject.SetActive(value: true);
		mHeroicPoints.SetActive(value: false);
		mGoldSprite.gameObject.SetActive(value: false);
		mCardpack.gameObject.SetActive(value: true);
		mScraps.gameObject.SetActive(value: true);
		mArenaTickets.gameObject.SetActive(value: true);
		mEliteParts.SetActive(value: false);
	}
