...
public class TutorialManagerStage3 : TutorialManagerBase
{
	private sealed class EOANNIBMAOM : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool GNFCLHDPPFP()
		{
			...
			case 0u:
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize(")"), DMDICGADGCG: true);
		...
		public bool JMCPAKBLPML()
		{
			...
			case 0u:
				...
				LoadingDialog.ShowLoading(Localization.Localize("{0} 3 / 3"), DMDICGADGCG: true, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
		...
		public bool NJBCJDFKGHO()
		{
			...
			case 0u:
				...
				LoadingDialog.ShowLoading(Localization.Localize("ID_TUTORIAL_TAPON"), DMDICGADGCG: true);
				Singleton<AtlasPreparer>.instance.UnloadTutorial();
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
		...
		public bool HMLAEHJKPJE()
		{
			...
			case 0u:
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("PNManager: Not rescheduling -> Beanstalk.currentTimestamp is zero!"), DMDICGADGCG: true, BGOHKCCLDJP: true);
		...
		public bool BPHPJKKHNNG()
		{
			...
			case 0u:
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("-{0}-{1}"), DMDICGADGCG: true);
				Singleton<AtlasPreparer>.instance.JLOPPDCLCIB();
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
		...
		public bool PJJPPMIBNLN()
		{
			...
			case 0u:
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("FuseBoxx: Ad Will Close"), DMDICGADGCG: true, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
		...
		public bool ILNBJIJONKD()
		{
			...
			case 0u:
				...
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("Weapon"), DMDICGADGCG: false, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
				Singleton<AtlasPreparer>.instance.IMKHDAHDLLI();
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
		...
		public bool FCJCLBMPBFK()
		{
			...
			case 0u:
				...
				LoadingDialog.ShowLoading(Localization.Localize("FuseBox Event VisualGained for rarity {0}"), DMDICGADGCG: true);
				Singleton<AtlasPreparer>.instance.IMKHDAHDLLI();
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
		...
		public bool HNCDLFFBMAA()
		{
			...
			case 0u:
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("SquadRank"), DMDICGADGCG: true, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
				Singleton<AtlasPreparer>.instance.IMKHDAHDLLI();
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
		...
		public bool CCOPPEKLJOB()
		{
			...
			case 0u:
				...
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("Player connectionState {0} to player {1}"), DMDICGADGCG: true, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
				Singleton<AtlasPreparer>.instance.UnloadTutorial();
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
		...
		public bool PMCFLKAJNHO()
		{
			...
			case 0u:
				...
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("()I"), DMDICGADGCG: true, BGOHKCCLDJP: true);
		...
		public bool GAPIFMKNJBN()
		{
			...
			case 0u:
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("PlayeScifiParticles"), DMDICGADGCG: false, BGOHKCCLDJP: true);
				Singleton<AtlasPreparer>.instance.ACOLPEPNNMA();
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
		...
		public bool PMBOHHPPJAC()
		{
			...
			case 0u:
				...
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("Time-limited Offers"), DMDICGADGCG: false, BGOHKCCLDJP: false, KKLNBPJCLHC: true);
				Singleton<AtlasPreparer>.instance.ACOLPEPNNMA();
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
		...
		public bool BKJCILLNJLG()
		{
			...
			case 0u:
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("ID_GETFORNUMBERONE2"), DMDICGADGCG: true, BGOHKCCLDJP: false, KKLNBPJCLHC: true);
		...
		public bool DDBCLDGNFBB()
		{
			...
			case 0u:
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("GooglePlay"), DMDICGADGCG: true, BGOHKCCLDJP: false, KKLNBPJCLHC: true);
				Singleton<AtlasPreparer>.instance.IMKHDAHDLLI();
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
		...
		public bool HKPECDLGFJB()
		{
			...
			case 0u:
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("PlacementMatchesRequired"), DMDICGADGCG: true, BGOHKCCLDJP: true);
		...
		public bool EKGEDEKHBME()
		{
			...
			case 0u:
				...
				LoadingDialog.ShowLoading(Localization.Localize("173432c2"), DMDICGADGCG: false, BGOHKCCLDJP: false, KKLNBPJCLHC: true);
		...
		public bool IIJKAMFGNKA()
		{
			...
			case 0u:
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize(" BOXES "), DMDICGADGCG: false, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
				Singleton<AtlasPreparer>.instance.BLCCADCEEED();
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
		...
		public bool NAMPBIHOFGI()
		{
			...
			case 0u:
				...
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("MagazineSize"), DMDICGADGCG: false, BGOHKCCLDJP: false, KKLNBPJCLHC: true);
				Singleton<AtlasPreparer>.instance.IMKHDAHDLLI();
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
		...
		public bool CBGPIONEKLM()
		{
			...
			case 0u:
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("withAttribute2"), DMDICGADGCG: false, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
				Singleton<AtlasPreparer>.instance.IMKHDAHDLLI();
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
	...
	private sealed class JAAGHMKDIIA : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool LPCBKGKFNFD()
		{
			...
			case 3u:
				...
				PNBNBGCNMCF.FIODCBFFKAN(IDEBKDPMPGM: true);
			...
			case 5u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("_", "ID_LOGOUT", 1039f, TutorialDialog.DODBDLEJOAM.TopLeft, BBGAMLLOING: false, BEBMEBEJIOB: true);
		...
		public bool HDGDKCMIOGK()
		{
			...
			case 3u:
				...
				PNBNBGCNMCF.OLDDFGBFMFK(IDEBKDPMPGM: true);
		...
		public bool KKINHOPBKLH()
		{
			...
			case 3u:
				...
				PNBNBGCNMCF.ANMBBDFMCMJ(IDEBKDPMPGM: true);
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BLHCFKIELCA().MDBPINJMNKO.AHPJFHNNODC(IDEBKDPMPGM: false);
			...
			case 5u:
				...
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("WarBucks", " Waypoint Target", 1561f, TutorialDialog.DODBDLEJOAM.Right, BBGAMLLOING: false, BEBMEBEJIOB: true);
		...
		public bool MHNPBDBGBLK()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BLHCFKIELCA().Enable();
				Singleton<SpawningManagerDeathMatch>.instance.PGBMKIHFJML(BJGCPDNMHDH.InstanceOnArmyChangedFirst);
				DeathMatchUnitsGuiElement.instance.MDBPINJMNKO.GAODJMFOOHM(IDEBKDPMPGM: true);
				DeathMatchUnitsGuiElement.BLHCFKIELCA().MDBPINJMNKO.CLLJEINIGBL();
				Singleton<SpawningManagerDeathMatch>.instance.Enable();
				PHDOCKCBJOF = new WaitForSeconds(174f);
				if (!FDKOKMKIIMG)
			...
			case 5u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("{0} ({1})", "bronze", 377f, TutorialDialog.DODBDLEJOAM.Left, BBGAMLLOING: false, BEBMEBEJIOB: true);
		...
		public bool IDBCKIPOEEI()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BLHCFKIELCA().Enable();
				Singleton<SpawningManagerDeathMatch>.instance.PGBMKIHFJML(BJGCPDNMHDH.InstanceOnArmyChangedFirst);
				DeathMatchUnitsGuiElement.BLHCFKIELCA().MDBPINJMNKO.LIOJDDABNKO(IDEBKDPMPGM: false);
			...
			case 5u:
				...
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("ID_HEROIC", "ID_OFFERACTIVE", 650f, TutorialDialog.DODBDLEJOAM.TopRight, BBGAMLLOING: true, BEBMEBEJIOB: true);
			...
			case 6u:
				...
				Singleton<SpawningManagerDeathMatch>.instance.KPGIELJBLEH(IDEBKDPMPGM: true);
		...
		public bool MoveNext()
		{
			...
			case 5u:
				...
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("ID_TUTORIAL_START_PHASE2", "ID_TUTORIAL_START_PHASE2_DOWN", 0f, TutorialDialog.DODBDLEJOAM.Center, BBGAMLLOING: true);
		...
		public bool PGOBEIMCPGA()
		{
			...
			case 5u:
				...
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("[]", "ID_RELOG_TO_FB_DIALOG_TITLE", 106f, TutorialDialog.DODBDLEJOAM.Top, BBGAMLLOING: true);
		...
		public bool CGOKGPGALLH()
		{
			...
			case 3u:
				...
				PNBNBGCNMCF.BBAFFFOGING(IDEBKDPMPGM: false);
			...
			case 4u:
				...
				Singleton<SpawningManagerDeathMatch>.instance.PGBMKIHFJML(BJGCPDNMHDH.InstanceOnArmyChangedFirst);
				DeathMatchUnitsGuiElement.instance.MDBPINJMNKO.INGNIDHDLPD(IDEBKDPMPGM: false);
			...
			case 5u:
				...
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("placement", "game-card-ico-headsup", 1242f, TutorialDialog.DODBDLEJOAM.Right, BBGAMLLOING: true);
		...
		public bool BJBEBPMDICE()
		{
			...
			case 3u:
				...
				PNBNBGCNMCF.OLDDFGBFMFK(IDEBKDPMPGM: false);
			...
			case 5u:
				...
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("Password", "0", 431f, TutorialDialog.DODBDLEJOAM.Left, BBGAMLLOING: true, BEBMEBEJIOB: true);
		...
		public bool JPAOKNLNFCB()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().Enable();
				Singleton<SpawningManagerDeathMatch>.instance.ArmyChanged += BJGCPDNMHDH.InstanceOnArmyChangedFirst;
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().MDBPINJMNKO.NHOKPBAKMKL(IDEBKDPMPGM: false);
			...
			case 5u:
				...
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("ID_SELECTTWOUNITS", "Automatic_Equip", 917f, TutorialDialog.DODBDLEJOAM.Center, BBGAMLLOING: true, BEBMEBEJIOB: true);
		...
		public bool LPMIKEPIMCM()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().Enable();
				Singleton<SpawningManagerDeathMatch>.instance.JNEGMAGNBJI(BJGCPDNMHDH.InstanceOnArmyChangedFirst);
				DeathMatchUnitsGuiElement.BLHCFKIELCA().MDBPINJMNKO.NHOKPBAKMKL(IDEBKDPMPGM: true);
			...
			case 5u:
				Singleton<EventTrackingManager>.instance.RegisterTutorialEvent(" ");
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("Action ", "#AccoutCheck# account exist", 1606f, TutorialDialog.DODBDLEJOAM.Top, BBGAMLLOING: true, BEBMEBEJIOB: true);
		...
		public bool ECPGMIIEFDP()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.instance.Enable();
				Singleton<SpawningManagerDeathMatch>.instance.PGBMKIHFJML(BJGCPDNMHDH.InstanceOnArmyChangedFirst);
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().MDBPINJMNKO.LIOJDDABNKO(IDEBKDPMPGM: false);
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().MDBPINJMNKO.HDOFLJONIFH();
				Singleton<SpawningManagerDeathMatch>.instance.Enable();
			...
			case 5u:
				...
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("clipSize", "Turret", 1729f, TutorialDialog.DODBDLEJOAM.Center, BBGAMLLOING: true, BEBMEBEJIOB: true);
		...
		public bool APJNFAOFAFD()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BLHCFKIELCA().Enable();
				Singleton<SpawningManagerDeathMatch>.instance.ArmyChanged += BJGCPDNMHDH.InstanceOnArmyChangedFirst;
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().MDBPINJMNKO.PFPLHOHDFFD(IDEBKDPMPGM: true);
		...
		public bool BJIPDEICIML()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().Enable();
				Singleton<SpawningManagerDeathMatch>.instance.ArmyChanged += BJGCPDNMHDH.InstanceOnArmyChangedFirst;
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().MDBPINJMNKO.PJFDIEGEGAC(IDEBKDPMPGM: false);
			...
			case 5u:
				...
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("ExtraHeart", "SHOW WAR ARENA DIALOG!!", 974f, TutorialDialog.DODBDLEJOAM.Bottom, BBGAMLLOING: true, BEBMEBEJIOB: true);
		...
		public bool MOFPMNMAOND()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BLHCFKIELCA().Enable();
				Singleton<SpawningManagerDeathMatch>.instance.PGBMKIHFJML(BJGCPDNMHDH.InstanceOnArmyChangedFirst);
				DeathMatchUnitsGuiElement.BLHCFKIELCA().MDBPINJMNKO.PFPLHOHDFFD(IDEBKDPMPGM: true);
			...
			case 5u:
				...
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("UpdateIndicatorRPC", "x", 1375f, TutorialDialog.DODBDLEJOAM.TopRight, BBGAMLLOING: false, BEBMEBEJIOB: true);
		...
		public bool DDLMLOJGJMA()
		{
			...
			case 5u:
				...
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("_MIN_", "AccountType", 675f, TutorialDialog.DODBDLEJOAM.BottomLeft, BBGAMLLOING: true, BEBMEBEJIOB: true);
		...
		public bool EKGEDEKHBME()
		{
			...
			case 3u:
				...
				PNBNBGCNMCF.KLLJIBDDKHB(IDEBKDPMPGM: false);
		...
		public bool GPIPJIDGCKM()
		{
			...
			case 5u:
				Singleton<EventTrackingManager>.instance.RegisterTutorialEvent("ID_LOADING");
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("Army upgrade for ", "ID_WAITINGFORFRIENDCARDS", 315f, TutorialDialog.DODBDLEJOAM.TopLeft, BBGAMLLOING: true);
		...
		public bool HMLAEHJKPJE()
		{
			...
			case 5u:
				Singleton<EventTrackingManager>.instance.RegisterTutorialEvent("]=");
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("ID_GAMECENTERUSER", "ID_TUTORIAL_GO_TO_ARMORY_2_DOWN", 33f, TutorialDialog.DODBDLEJOAM.Left, BBGAMLLOING: true);
		...
		public bool BEIABOJAIFM()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().Enable();
				Singleton<SpawningManagerDeathMatch>.instance.ArmyChanged += BJGCPDNMHDH.InstanceOnArmyChangedFirst;
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().MDBPINJMNKO.INGNIDHDLPD(IDEBKDPMPGM: false);
			...
			case 5u:
				Singleton<EventTrackingManager>.instance.RegisterTutorialEvent("N");
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("Time", "ID_CONFIRM_LEAVE_SPECTATE_TEXT", 1982f, TutorialDialog.DODBDLEJOAM.BottomRight, BBGAMLLOING: true, BEBMEBEJIOB: true);
		...
		public bool AKFKBNAMOAI()
		{
			...
			case 5u:
				...
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("NewArena", "Reward", 234f, TutorialDialog.DODBDLEJOAM.Left, BBGAMLLOING: false, BEBMEBEJIOB: true);
		...
		public bool BLHOCNMMPNP()
		{
			...
			case 3u:
				...
				PNBNBGCNMCF.ANMBBDFMCMJ(IDEBKDPMPGM: false);
			...
			case 5u:
				...
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN(" NOT OK!\t\t\t\t\t\t", "game-card-ico-swiftimmortality", 529f, TutorialDialog.DODBDLEJOAM.Right, BBGAMLLOING: true);
		...
		public bool JFPOOBJNEPF()
		{
			...
			case 5u:
				...
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("SpawnByCardRPC", "<", 1165f, TutorialDialog.DODBDLEJOAM.Left, BBGAMLLOING: true, BEBMEBEJIOB: true);
		...
		public bool FGAFKEKGPHF()
		{
			...
			case 5u:
				Singleton<EventTrackingManager>.instance.RegisterTutorialEvent(" (");
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("_", "id", 1700f, TutorialDialog.DODBDLEJOAM.TopLeft, BBGAMLLOING: true, BEBMEBEJIOB: true);
	...
	private sealed class LFCKGNCMGMB : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool IDBCKIPOEEI()
		{
			...
			case 2u:
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("아니오", string.Empty, 914f, TutorialDialog.DODBDLEJOAM.BottomLeft, BBGAMLLOING: true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
		...
		public bool GBHCODKDPBO()
		{
			...
			case 2u:
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("testingidsquadjoinrequest", string.Empty, 317f, TutorialDialog.DODBDLEJOAM.Top, BBGAMLLOING: false, BEBMEBEJIOB: true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool EKHDJADMNJK()
		{
			...
			case 2u:
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("ID_ISALREADYMEMBEROFANOTHERSQUAD", string.Empty, 1690f, TutorialDialog.DODBDLEJOAM.BottomLeft, BBGAMLLOING: true, BEBMEBEJIOB: true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
		...
		public bool DKIKFMODFJF()
		{
			...
			case 2u:
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("ID_XTICKETS", string.Empty, 465f, TutorialDialog.DODBDLEJOAM.BottomRight, BBGAMLLOING: false, BEBMEBEJIOB: true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool NJBCJDFKGHO()
		{
			...
			case 2u:
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("#VOJTA# LOADED DAILY MISSIONS AFTER LEVEL UP", string.Empty, 119f, TutorialDialog.DODBDLEJOAM.BottomRight, BBGAMLLOING: true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
				BJGCPDNMHDH.data.overtimeShowed = false;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool HEHJAEIGHDN()
		{
			...
			case 2u:
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("Vip", string.Empty, 833f, TutorialDialog.DODBDLEJOAM.Right, BBGAMLLOING: true, BEBMEBEJIOB: true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
				BJGCPDNMHDH.data.overtimeShowed = false;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool PMBOHHPPJAC()
		{
			...
			case 2u:
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("ID_GUI_BEADVISED", string.Empty, 593f, TutorialDialog.DODBDLEJOAM.Bottom, BBGAMLLOING: false, BEBMEBEJIOB: true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool LGNMOMFLLPP()
		{
			...
			case 2u:
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("TW_Follow", string.Empty, 1005f, TutorialDialog.DODBDLEJOAM.TopLeft, BBGAMLLOING: true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
				BJGCPDNMHDH.data.overtimeShowed = false;
				BJGCPDNMHDH.Save();
				goto case 3u;
