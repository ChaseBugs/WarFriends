...
public class CFX_SpawnSystem : MonoBehaviour
{
	...
	[FormerlySerializedAs("KFANDCDDOIO")]
	public GameObject[] FHDMFGMKOJL = new GameObject[0];

	[FormerlySerializedAs("LFPKMEGGPGE")]
	public int[] HJPLNEOCCIF = new int[0];

	[FormerlySerializedAs("IJLHCGJEIJM")]
	...
	public static bool AllObjectsLoaded => MFDCIFEBHHF.MPMAKHGPIIH;
