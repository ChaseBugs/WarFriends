...
public class ChatGuiElement : GuiElementSingle<ChatGuiElement>
{
	...
	[FormerlySerializedAs("CKHMMLJGCDO")]
	[Header("Core")]
	public GameObject HDFFFBIONDI;

	[FormerlySerializedAs("HFACMDDEGGB")]
	public GameObject LIFKKKHLJBN;

	[FormerlySerializedAs("BHJIDIPDEFM")]
	...
	[FormerlySerializedAs("LAFOJAEOCLI")]
	public UIPanel KKIONKMPPIB;

	[FormerlySerializedAs("BKLGBMIMGIM")]
	public GameObject CKOALACFHLL;

	[FormerlySerializedAs("DNNPJJOODAD")]
	public GameObject CHFFPACNFCN;

	[FormerlySerializedAs("BGBDFAKJPOB")]
	public BoxCollider IEJJOPIKFNI;

	[FormerlySerializedAs("FMBOFLNHGJF")]
	public UILabel EIOIFEPAAFD;

	[FormerlySerializedAs("MIGGMLMBAIF")]
	public UISprite LDLMMECACBP;

	[FormerlySerializedAs("DJJBPCGIPJB")]
	...
	[FormerlySerializedAs("DPBPKECJEJF")]
	public GameObject NCAJPIJMEOK;

	[FormerlySerializedAs("CPJDFIDJCJM")]
	public GameObject PAMFBCPEBED;

	[FormerlySerializedAs("HEDCOOKGFGI")]
	public BoxCollider OIEEICKACEB;

	[FormerlySerializedAs("MINMHGAGOEC")]
	public UILabel CGAABNOLNKD;

	[FormerlySerializedAs("DOPLBFCKGCK")]
	public UISprite LEIEBLLDKEF;

	[FormerlySerializedAs("MBEBCMGPHFN")]
	public UISprite EPAPPICPKHN;

	[FormerlySerializedAs("LFLNCJDPLDO")]
	[Header("ACTIVE UNITS")]
	public ActiveUnitsTab GECCCEDFCEI;

	[FormerlySerializedAs("NPPJHENIBDK")]
	public UIPanel EIAABJABMMD;

	[FormerlySerializedAs("LCOMJEKIDDO")]
	public GameObject IDNPMEEBDLO;

	[FormerlySerializedAs("IFMGINMHONK")]
	public GameObject OFCAABECCEE;

	[FormerlySerializedAs("MOPGKELAGOA")]
	public BoxCollider LNLDFMJJDFH;

	[FormerlySerializedAs("AMHABFGIPOJ")]
	public GameObject PDEGHPMGDCO;

	[FormerlySerializedAs("LLFJKKOHDDD")]
	...
	public bool isRightPartDisplayed => PHFGDCMBGOF != JLANLLEABDC.Closed;

	public bool anyChatNotifications => KNFBABCOLEC > 0;

	public bool anyMessageCenterNotifications => HPGFPCAEGBM > 0;

	private bool KIMJLCKKBOE => (Singleton<GameController>.instance.isTutorial && (TutorialManagerStage1.instance.isTutorialRunning || TutorialManagerStage2.instance.isTutorialRunning || TutorialManagerStage3.instance.isTutorialRunning)) || TutorialManagerPlayWarcards.instance.isTutorialRunning;
	...
	private float PENLKOKBAFO => -60f - UIHelper.safeAreaSize;

	private float MFONNBNANCG => -60f;
	...
	{
		if (Singleton<GuiManager>.instance.AODFEHKBJIN != null && (object)Singleton<GuiManager>.instance.AODFEHKBJIN != null && Singleton<GuiManager>.instance.AODFEHKBJIN.DLJHPBBKIBD && PHFGDCMBGOF == (JLANLLEABDC)7 && !GECCCEDFCEI.OJBNDDNDAHN(IBLEHIFJBJK: false))
		{
			return true;
		}
	...
	{
		UnityEngine.Debug.Log($"Chat - new notifications: {GEJBLIEINLJ}, selectedSquadChat: {FNNHCGMNDKN.isSelectedSquadChat}, currentState: {PHFGDCMBGOF}");
	...
	{
		FNNHCGMNDKN.EHLLLMGBONP(GKAKLBKHBMP: false);
		OAHIOEEICFI.ShowMessageCenter(GKAKLBKHBMP: true);
		GECCCEDFCEI.ShowTab(GKAKLBKHBMP: true);
	}
	...
	{
		MKGJHBCCEEH = true;
		KKIONKMPPIB.gameObject.SetActive(value: false);
	}
	...
	private void JPOLFBLLFEI()
	{
		...
		{
			MKGJHBCCEEH = false;
			FNNHCGMNDKN.GLFMIOMMIAB(GKAKLBKHBMP: true);
			OAHIOEEICFI.ShowMessageCenter(GKAKLBKHBMP: false);
	...
	public virtual void MLAEGNJBKIM()
	{
		...
		{
			EIAABJABMMD.gameObject.SetActive(value: false);
		}
	...
	{
		if (!MKGJHBCCEEH || KIMJLCKKBOE || (PHFGDCMBGOF == (JLANLLEABDC)5 && !GECCCEDFCEI.OJBNDDNDAHN(IBLEHIFJBJK: false)))
		{
			return;
		}
		if (PHFGDCMBGOF == JLANLLEABDC.Chat)
	...
	private void DKJEGDAGJAB()
	{
		...
		{
			MKGJHBCCEEH = false;
			FNNHCGMNDKN.ShowChat(GKAKLBKHBMP: false);
			OAHIOEEICFI.ShowMessageCenter(GKAKLBKHBMP: false);
	...
	public virtual void DBMCMLINOPD()
	{
		...
		{
			EIAABJABMMD.gameObject.SetActive(value: true);
		}
	...
	public void JMMFLOFFAHN()
	{
		...
		{
			GECCCEDFCEI.OJBNDDNDAHN(IBLEHIFJBJK: false);
		}
	}
	...
	private void ONBBGBOHAOL()
	{
		...
		{
			MKGJHBCCEEH = false;
			GECCCEDFCEI.ShowTab(GKAKLBKHBMP: false);
	...
	private void CDJLNPMCBBP()
	{
		if (!KKIONKMPPIB.gameObject.activeSelf)
		{
			KKIONKMPPIB.gameObject.SetActive(value: true);
