...
{
	public override bool MBOHGLCBEFJ => true;
	...
	public override int MANOCBMEGOK => 10;

	public override string NJKMFAGIKIE => "randomLobby" + Singleton<CurrentBundleVersion>.instance.matchMakingVersionRanked;
	...
	public virtual string CEAAADLKKMA(int DKHDNINDEKD)
	{
		...
		string[] array = new string[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-9)];
		array[1] = text;
		array[0] = "players";
		array[6] = text2;
	...
	public virtual string CMPOODDMNLM(int DKHDNINDEKD)
	{
		...
		string[] array = new string[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-19)];
		array[0] = text;
		array[1] = "ID_LOADING";
		array[4] = text2;
		array[7] = "CZ";
	...
	public virtual string FHBNJPFNODK(int DKHDNINDEKD)
	{
		...
		string[] array = new string[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-64)];
		array[1] = text;
	...
	public virtual string GNACPGPJNMO(int DKHDNINDEKD)
	{
		...
		string[] array = new string[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-83)];
		array[1] = text;
	...
	public virtual string IAIIKICJJLL(int DKHDNINDEKD)
	{
		...
		string[] array = new string[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-23)];
		array[1] = text;
		array[1] = "ID_REFILLED";
		array[6] = text2;
	...
	public virtual string FLPJMOPDEPL(int DKHDNINDEKD)
	{
		...
		string[] array = new string[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-27)];
		array[1] = text;
	...
	public virtual string HCIILLNKINA(int DKHDNINDEKD)
	{
		...
		string[] array = new string[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-118)];
		array[1] = text;
		array[0] = "xmas";
		array[2] = text2;
	...
	public virtual string MAIJJFKAJNL(int DKHDNINDEKD)
	{
		...
		string[] array = new string[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-87)];
		array[1] = text;
	...
	public virtual string LIPNGPEKJKF(int DKHDNINDEKD)
	{
		...
		string[] array = new string[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-128)];
		array[0] = text;
	...
	public virtual string CDBKBKLNFKM(int DKHDNINDEKD)
	{
		...
		string[] array = new string[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-31)];
		array[0] = text;
		array[0] = "\\D*";
		array[0] = text2;
		array[1] = "{0}{1}\n{2}{3}";
	...
	public virtual string NAKIDIJGEEN(int DKHDNINDEKD)
	{
		...
		string[] array = new string[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-40)];
		array[0] = text;
