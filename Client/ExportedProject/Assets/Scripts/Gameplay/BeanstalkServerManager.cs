...
public class BeanstalkServerManager : Singleton<BeanstalkServerManager>
{
			...
			case 3u:
				try
				{
					...
					if (!string.IsNullOrEmpty(MPNMIMHFOCN) && (!Singleton<GameController>.instance.DAIEAMEFGIE() || KFCAECGLKKO.MHLAAHNPMFG == (DatabaseAction)(-82)))
					{
						...
						{
							WarningDialog.ShowError(Localization.Localize("ID_ARENABOXDESCRIPTION_GOLD"), Localization.Localize("CONFIRM"), 183f, KFCAECGLKKO.LGJCNCHBFDA, Localization.Localize("Hiding CONFIRM dialog"), JCOGJEEFLBC: true);
						}
			...
			case 3u:
				try
				{
					...
					if (!string.IsNullOrEmpty(MPNMIMHFOCN) && (!Singleton<GameController>.instance.DAIEAMEFGIE() || KFCAECGLKKO.MHLAAHNPMFG == (DatabaseAction)(-77)))
					{
						...
						{
							WarningDialog.KHOMNBHMFGA(Localization.Localize("OnOffersReleased"), Localization.Localize("Started delivering army upgrade for {0} {1}. It will be ready in {2} seconds."), 136f, KFCAECGLKKO.LGJCNCHBFDA, Localization.Localize("+{0}"), JCOGJEEFLBC: true);
						}
	...
	private sealed class PIEDAILOECP : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool DKIKFMODFJF()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MMNKNBKLFFC(IDEBKDPMPGM: true);
				CLPPIAGLCJJ = -1;
				goto default;
			default:
				{
		...
		public bool FNEPBDLIKOD()
		{
			...
			case 1u:
				...
				LoadingDialog.Hide();
				BJGCPDNMHDH.JIHFFFHPOAP();
				BJGCPDNMHDH.MMNKNBKLFFC(IDEBKDPMPGM: false);
				CLPPIAGLCJJ = -1;
				goto default;
			default:
				{
	...
	private int _003CFBPEDMMDCCB_003Ek__BackingField;

	[FormerlySerializedAs("IPMCBFANODE")]
	public bool DIEFNOGGPOA;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private string _003CDCBJPMOIAFB_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private bool _003CJIKKGJKGKGE_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private bool _003CAKDLGLKJOKI_003Ek__BackingField;
	...
	[FormerlySerializedAs("KIADJMMHHBM")]
	...
	[FormerlySerializedAs("KCDJMMGBFCK")]
	...
	public int dataDownloaded
	{
		...
		get
		{
			return _003CFBPEDMMDCCB_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			_003CFBPEDMMDCCB_003Ek__BackingField = value;
		}
	}
	...
	public string postParameters
	{
		...
		private set
		{
			_003CDCBJPMOIAFB_003Ek__BackingField = value;
		}
	}
	...
	public bool isPlayerDataLoaded
	{
		...
		get
		{
			return _003CJIKKGJKGKGE_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			_003CJIKKGJKGKGE_003Ek__BackingField = value;
		}
	}

	public bool loadingPlayerData
	{
		[CompilerGenerated]
		get
		{
		...
		private set
		{
			_003CAKDLGLKJOKI_003Ek__BackingField = value;
		}
	}
	...
	public bool isSending => KIFPBCLGKJG;

	public DateTime currentAccountDateTime => currentDateTime.AddHours(FBBKCGLIIOB.EMHCIOCDGIJ());
	...
	public int midnight => FBBKCGLIIOB.BDPLOPBMHAB;

	public double currentTimestampDouble => FBBKCGLIIOB.NAHHEKDIHOD();

	public Packs packDefinition => HAMNHLDLHGE ?? (HAMNHLDLHGE = GetComponent<Packs>());

	public DatabaseEnvironment environment => DJOJPKGADMP.AAMEOPMABGB;
	...
	internal void PDHFCIDODIP(long IOFHDGKGFBG, string EGLIJCPPLIP)
	{
		if (DebugSettings.debugEnabled)
		{
			UnityEngine.Debug.LogError($"AddFacebookToCustomAccount ID: {IOFHDGKGFBG} PSWD: {EGLIJCPPLIP}");
		}
		List<Tuple<string, string>> list = new List<Tuple<string, string>>();
	...
	{
		List<DatabasePlayer> list = Singleton<ServerResultsCache>.instance.CCPMCLFPCIF(MBBMHKBOKAI, NICBOKPIBIA: true);
		if (list != null)
		{
	...
	private void CKHDBGFHGIG(DatabaseAction IFGAGNBDKBE, string LFJLGAGDHMO, HKNKJFBJJBH KOPCNKJMJBC)
	{
		...
		if (KOPCNKJMJBC != (HKNKJFBJJBH)4)
		{
			...
			{
				WarningDialog.ShowError(Localization.Localize("JP"), Localization.Localize("ID_GUI_BRONZE"), GuiElementSingle<WaitingDialog>.instance.DCIKANJJFIJ, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
			}
	...
	internal void OBJBMMCOABJ(long IOFHDGKGFBG, string EGLIJCPPLIP)
	{
		...
		LoadingDialog.PGFBMJFLHPC(Localization.Localize("UnitID"), DMDICGADGCG: true, BGOHKCCLDJP: true);
	}
	...
	internal void BICJAICFDHB(long IOFHDGKGFBG, string BCMCMKDCLGP, string EGLIJCPPLIP)
	{
		if (DebugSettings.debugEnabled)
		{
			UnityEngine.Debug.LogError($"AddFacebookToCustomAccount ID: {IOFHDGKGFBG} Name: {BCMCMKDCLGP} PSWD: {EGLIJCPPLIP}");
		}
		List<Tuple<string, string>> list = new List<Tuple<string, string>>();
		list.Add(new Tuple<string, string>("Name", BCMCMKDCLGP));
		list.Add(new Tuple<string, string>("FacebookId", IOFHDGKGFBG.ToString(CultureInfo.InvariantCulture)));
	...
	public void DIMIGOPEBLA(string BCMCMKDCLGP, bool HNLJDNFOCOM = false)
	{
		...
		List<Tuple<string, string>> gMDJHENPLHB = list;
		StartCoroutine(RadicalRoutine.Run(HBFJFGANDPE(DatabaseAction.DepositCards, gMDJHENPLHB)));
		LoadingDialog.ShowLoading(Localization.Localize("improper JSON formatting:"), DMDICGADGCG: true, BGOHKCCLDJP: true);
	}
	...
	public void Challenge(DatabasePlayer NCFFGKHPJLH, string FBEAOHMDKDJ, int HLPHCDNMJLG = -1, string OKIIAAPDJIK = "", string ADBBOLJGLCA = "", string JLBLNDGIINB = "default")
	{
		...
		list.Add(new Tuple<string, string>("Region", ((int)PhotonConnectionManager.GetBestRegion(PhotonConnectionManager.IFOKPNHLEBP, NCFFGKHPJLH.bestRegions, out var _)/*cast due to constrained. prefix*/).ToString()));
	...
	{
		UnityEngine.Debug.Log($"GetAllSquadMembers - squad {CGIFEHPDBAL} - force {FHKKPEIDDJN}");
	...
	public void GenerateSpecialOffer(long NGPMJNJPNMB, int DBOLKNNJGMH, string EDKJOPECOFP, string ICIDFPHMBIF, bool LPGMLOCLBGP = false)
	{
		...
		UnityEngine.Debug.Log($"try generate special offer: {EDKJOPECOFP}\n end {NGPMJNJPNMB} (duration {NGPMJNJPNMB - currentTimestamp})\ndiscount {DBOLKNNJGMH}");
	...
	private void CHNFKPCEMPD(DatabaseAction IFGAGNBDKBE, string LFJLGAGDHMO, HKNKJFBJJBH KOPCNKJMJBC)
	{
		...
		if (KOPCNKJMJBC != (HKNKJFBJJBH)7)
		{
			...
			{
				WarningDialog.KHOMNBHMFGA(Localization.Localize("Labels under Table:\n"), Localization.Localize("ID_ARENARULES_NOWARCARDS"), GuiElementSingle<WaitingDialog>.instance.DCIKANJJFIJ, null, string.Empty, JCOGJEEFLBC: true);
			}
			SendErrorMessage(new Exception(LFJLGAGDHMO), IFGAGNBDKBE, LFJLGAGDHMO, string.Empty);
			ErrorWasReceived(IFGAGNBDKBE);
		}
	...
	internal void PLJDHDMFPBJ(string BCMCMKDCLGP, string PGHCHNIDLNJ)
	{
		...
		LoadingDialog.ShowLoading(Localization.Localize("Overtime_Was_Already_Explained"), DMDICGADGCG: true);
	}
	...
	internal void OGJDPPDGANP(string CGIFEHPDBAL, bool FHKKPEIDDJN = false)
	{
		...
		List<DatabasePlayer> list = Singleton<ServerResultsCache>.instance.OOCMLOAOOIB(CGIFEHPDBAL, NICBOKPIBIA: true);
		if (list != null && !FHKKPEIDDJN)
		{
			DataWasLoaded(databaseAction);
			return;
