...
{
	[FormerlySerializedAs("PMBLMJPFGHO")]
	public bool JFHNEDNOHIJ;

	[FormerlySerializedAs("JPDCODAPKNM")]
	public bool LCMAHPKKGOA;

	[FormerlySerializedAs("EBPOLLFJBFG")]
	public string PJIOKCKLBJH;

	[FormerlySerializedAs("GFIKJPFJOHP")]
	...
	[FormerlySerializedAs("IKFGHHJLHIO")]
