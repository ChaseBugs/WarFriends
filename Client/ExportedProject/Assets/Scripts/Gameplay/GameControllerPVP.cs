...
public abstract class GameControllerPVP : GameControllerOnline
{
	...
	private bool MLAJIPACEDO => this == Singleton<GameController>.instance.mainController;

	protected virtual string AMNDDFPPMGI => Localization.Localize("ID_WAITINGFOROPPONENTCARDS");
	...
	protected override GHPGNELIDBM GPONIACGBDN(PhotonPlayer KHLGDCHJJPB)
	{
		...
		UnityEngine.Debug.Log($"Getting fraction for {KHLGDCHJJPB} with result {gHPGNELIDBM}");
		return gHPGNELIDBM;
	}
