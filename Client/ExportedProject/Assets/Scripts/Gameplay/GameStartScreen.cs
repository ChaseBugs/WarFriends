...
{
	[FormerlySerializedAs("FPGCGBHENNE")]
	[Header("Player 1 Part (Left)")]
	public GameObject HIOHPOMALHE;

	[FormerlySerializedAs("JDJFDJDFFFH")]
	public PlayerIcon IFCIHNCCADJ;

	[FormerlySerializedAs("JIGPMIKEHHB")]
	public UISprite NEFBBJLKNKA;

	[FormerlySerializedAs("KEEFENIKIAI")]
	public UISprite GMKFMNAHAJH;

	[FormerlySerializedAs("DFPKEOLLJIF")]
	public UILabel AHHABDEJPJL;

	[FormerlySerializedAs("DNMMOCCLGJK")]
	public UITable BDADGLHAOBA;

	[FormerlySerializedAs("DJBHDHKAMFD")]
	public UISprite LMFDBNECCGO;

	[FormerlySerializedAs("GLGLOIOJGMA")]
	public UISprite PEKHKDCCMGN;

	[FormerlySerializedAs("MHODMLMFBPK")]
	public UISprite IFBNKNIGOKJ;

	[Header("-Power Band Part")]
	[FormerlySerializedAs("LADJEPCJMGM")]
	public GameObject KAOOPIHJPNG;

	[FormerlySerializedAs("AHFHAIAKBEC")]
	public UISprite NIBAOAONCLA;

	[FormerlySerializedAs("NBCDGILLMEE")]
	public UILabel MHKIFHKBMOD;

	[FormerlySerializedAs("HGGBDJHGEOO")]
	public UISprite JCFMFAOJHGK;

	[Header("Middle")]
	[FormerlySerializedAs("DLIDPBEPALF")]
	public GameObject IIHJFLPFIEF;

	[FormerlySerializedAs("FFIEFLILBAE")]
	[Header("Player 2 Part (Right)")]
	public GameObject DNDCODMGGEE;

	[FormerlySerializedAs("MBHGKCDPDBG")]
	public PlayerIcon DEIGAMPPJPD;

	[FormerlySerializedAs("HIMMJNMDCNH")]
	public UISprite AEKGHHGPFIN;

	[FormerlySerializedAs("ILMGPAIPIDE")]
	public UISprite MGGGCGAOPHJ;

	[FormerlySerializedAs("MPNDLHJAHCL")]
	public UILabel GBHDAKINMIL;

	[FormerlySerializedAs("AJMMPHNHJDF")]
	public UITable GHICBPOOMEI;

	[FormerlySerializedAs("NNILIIHJAEE")]
	public UISprite PEJCGKACMCO;

	[FormerlySerializedAs("CNEKNADCOAM")]
	public UISprite DMACIGNEEJP;

	[FormerlySerializedAs("KMAENPFIAKM")]
	public UISprite LPOJICGIOPL;

	[Header("-Power Band Part")]
	[FormerlySerializedAs("ODKPKHKNFEH")]
	public GameObject ANNIDFMIMAN;

	[FormerlySerializedAs("OHDHLICNOBP")]
	public UISprite PKMIIPLIGPO;

	[FormerlySerializedAs("CJDGMLALHGF")]
	public UILabel MBBNHBMPHKC;

	[FormerlySerializedAs("CIEGCFCNALM")]
	...
	private void OBBDANOPLHJ(int BPGIPOKANNI, League BMNDININJCE, int HNEFOLPHMHK, bool GKEOILLNCHG)
	{
		if (BPGIPOKANNI < 1)
		{
			DMACIGNEEJP.gameObject.SetActive(value: false);
		...
		{
			DMACIGNEEJP.gameObject.SetActive(value: true);
	...
	private void GDCBEMJCMMF(int BPGIPOKANNI, League BMNDININJCE, int HNEFOLPHMHK, bool GKEOILLNCHG)
	{
		if (BPGIPOKANNI < 1)
		{
			PEKHKDCCMGN.gameObject.SetActive(value: true);
		...
		{
			PEKHKDCCMGN.gameObject.SetActive(value: false);
		}
	}
	...
	private void ANIDBHGOHNN()
	{
		...
		FEOJFCABOEM(HMGOHGOLMJB: false, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.None);
		NLODHENBGEJ(null);
		GDCBEMJCMMF(1, League.NoLeague, 0, GKEOILLNCHG: false);
		...
		HDNOGLKPCAL(1, League.NoLeague, 0, GKEOILLNCHG: false);
	...
	private void GMGLBALMHAP()
	{
		...
		CLIAOCAGHGN(HMGOHGOLMJB: true, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.None);
		NGKMIIGKIKK(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CAAKEPHMPHI);
		EAAMHKFCEBK(1, League.Bronze3, 1, GKEOILLNCHG: true);
		...
		HDNOGLKPCAL(0, League.Bronze3, 1, GKEOILLNCHG: false);
	...
	private void EAIGEAALAMB()
	{
		...
		FEOJFCABOEM(HMGOHGOLMJB: false, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.None);
		NGKMIIGKIKK(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CAAKEPHMPHI);
		FLBFNPNNJGN(1, League.Bronze3, 1, GKEOILLNCHG: true);
		string iNFLHPGMEOB = Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CBBDICBLHMM[3];
		...
		FJKCONFDFLK(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		CALFDOJBEKP(0, League.NoLeague, 1, GKEOILLNCHG: true);
		string iNFLHPGMEOB2 = PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CBBDICBLHMM[3];
	...
	private void CAFICDAANNO()
	{
		...
		HBPGEDLEBKC(1);
		FEOJFCABOEM(HMGOHGOLMJB: false, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.FHCMFHABMLE);
		NLODHENBGEJ(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CAAKEPHMPHI);
		MLGPJNPHJAH(0, League.NoLeague, 1, GKEOILLNCHG: false);
		JIHEPDNKKIO(null);
		DEIGAMPPJPD.DHDPJLAPAPO(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.EBFDAICCJAK);
		CKDAIGFHKCJ(1);
		FIKFLIKDCFB(HMGOHGOLMJB: false, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.MHPNDNJDPGE, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.FHCMFHABMLE);
		BIPHPDCMLDB(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		AFDNODFKKNG(1, League.NoLeague, 0, GKEOILLNCHG: false);
		JMNLBEKFFFG(null);
	}
	...
	private void JHKCCNINGBL()
	{
		...
		DLBJODBNPHA(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.OCPEHLIIGML());
		GBFIOODGMOH(HMGOHGOLMJB: false, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.None);
		NGKMIIGKIKK(null);
		PBHMAFFHOGM(1, League.Bronze3, 0, GKEOILLNCHG: true);
		...
		INNNCOLBMCH(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.HMGOHGOLMJB, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.MHPNDNJDPGE, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.FHCMFHABMLE);
		BFEDNGGPACI(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		CPIMHMKNGPG(1, League.Bronze3, 1, GKEOILLNCHG: false);
	...
	private void PNBINDCAPNB()
	{
		...
		FEOJFCABOEM(HMGOHGOLMJB: true, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.None);
		HEIJPDIOMID(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CAAKEPHMPHI);
		PBHMAFFHOGM(1, League.Bronze3, 0, GKEOILLNCHG: false);
		string iNFLHPGMEOB = Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CBBDICBLHMM[2];
		...
		FJKCONFDFLK(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		HDNOGLKPCAL(1, League.NoLeague, 1, GKEOILLNCHG: false);
	...
	private void OGLPDOMPDPL()
	{
		...
		GBFIOODGMOH(HMGOHGOLMJB: true, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.BronzeCrown);
		HEIJPDIOMID(null);
		GDCBEMJCMMF(1, League.Bronze3, 0, GKEOILLNCHG: false);
		string iNFLHPGMEOB = Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CBBDICBLHMM[3];
		...
		FIKFLIKDCFB(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.HMGOHGOLMJB, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.MHPNDNJDPGE, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.FHCMFHABMLE);
		FJKCONFDFLK(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		FGGJPHOJPGA(1, League.NoLeague, 0, GKEOILLNCHG: false);
		string iNFLHPGMEOB2 = PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CBBDICBLHMM[3];
	...
	private void ELCMENMFABN()
	{
		...
		HBPGEDLEBKC(0);
		LABKOGAGEKE(HMGOHGOLMJB: true, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.FHCMFHABMLE);
		NGKMIIGKIKK(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CAAKEPHMPHI);
		MLGPJNPHJAH(0, League.NoLeague, 0, GKEOILLNCHG: false);
		HKIJOJOAEEP(null);
		DEIGAMPPJPD.JIBFCGECCFI(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.EBFDAICCJAK);
		IENGAFLIJED(0);
		INNNCOLBMCH(HMGOHGOLMJB: false, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.MHPNDNJDPGE, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.FHCMFHABMLE);
		BIPHPDCMLDB(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		GCFNHMGDALG(0, League.NoLeague, 0, GKEOILLNCHG: false);
		BJPIDPBPNPG(null);
	}
	...
	private void PCGAIHIJOGG()
	{
		...
		LABKOGAGEKE(HMGOHGOLMJB: true, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.BronzeCrown);
		KPAHCHEJADL(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CAAKEPHMPHI);
		FLBFNPNNJGN(1, League.Bronze3, 0, GKEOILLNCHG: false);
		string iNFLHPGMEOB = Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CBBDICBLHMM[2];
		...
		BFEDNGGPACI(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		OBBDANOPLHJ(0, League.NoLeague, 1, GKEOILLNCHG: true);
		string iNFLHPGMEOB2 = PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CBBDICBLHMM[8];
	...
	private void AOKLDFAJIGJ()
	{
		...
		FEOJFCABOEM(HMGOHGOLMJB: true, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.BronzeCrown);
		KPAHCHEJADL(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CAAKEPHMPHI);
		PBHMAFFHOGM(0, League.NoLeague, 0, GKEOILLNCHG: true);
		string iNFLHPGMEOB = Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CBBDICBLHMM[2];
	...
	private void HKIAAOFGHPH()
	{
		...
		CLIAOCAGHGN(HMGOHGOLMJB: false, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.BronzeCrown);
		NGKMIIGKIKK(null);
		GDCBEMJCMMF(1, League.NoLeague, 0, GKEOILLNCHG: true);
		...
		AFDNODFKKNG(1, League.Bronze3, 0, GKEOILLNCHG: true);
		string iNFLHPGMEOB2 = PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CBBDICBLHMM[8];
	...
	private void GCEFMLIMIOB()
	{
		...
		HBPGEDLEBKC(0);
		GBFIOODGMOH(HMGOHGOLMJB: true, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.FHCMFHABMLE);
		NGKMIIGKIKK(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CAAKEPHMPHI);
		GDCBEMJCMMF(0, League.NoLeague, 1, GKEOILLNCHG: false);
		BHGDABMNHBL(null);
		DEIGAMPPJPD.ECKBKNCJLOC(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.EBFDAICCJAK);
		IENGAFLIJED(1);
		MIMOKCBDMII(HMGOHGOLMJB: true, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.MHPNDNJDPGE, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.FHCMFHABMLE);
		JGIMALFEHCP(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		CALFDOJBEKP(0, League.NoLeague, 0, GKEOILLNCHG: true);
		JDJNDFHMHIB(null);
	}
	...
	private void CHANANMEANF()
	{
		...
		CLIAOCAGHGN(HMGOHGOLMJB: true, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.BronzeCrown);
		NGKMIIGKIKK(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CAAKEPHMPHI);
		GDCBEMJCMMF(1, League.Bronze3, 0, GKEOILLNCHG: true);
		...
		FIKFLIKDCFB(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.HMGOHGOLMJB, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.MHPNDNJDPGE, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.FHCMFHABMLE);
		BFEDNGGPACI(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		AFDNODFKKNG(1, League.Bronze3, 1, GKEOILLNCHG: false);
	...
	private void BDAPDKOODNI()
	{
		IFCIHNCCADJ.BIEIDBBDNIF(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.EBFDAICCJAK);
		HBPGEDLEBKC(1);
		FEOJFCABOEM(HMGOHGOLMJB: true, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.FHCMFHABMLE);
		DJOEMHFGEIP(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CAAKEPHMPHI);
		GDCBEMJCMMF(1, League.NoLeague, 1, GKEOILLNCHG: false);
		HLFJNGOKOAB(null);
		DEIGAMPPJPD.DJPNDAICDPN(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.EBFDAICCJAK);
		IENGAFLIJED(1);
		ENCGLEIDDFO(HMGOHGOLMJB: true, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.MHPNDNJDPGE, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.FHCMFHABMLE);
		BFEDNGGPACI(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		FGGJPHOJPGA(0, League.Bronze3, 0, GKEOILLNCHG: true);
		LHOIONMEGBE(null);
	}
	...
	private void HLKPGGIKPMA()
	{
		IFCIHNCCADJ.avatar = Singleton<GameController>.instance.opponent.EHHHBEMKGOE.EBFDAICCJAK;
		GFGHNBKIPOB(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.ALJJMKANFNO());
		CLIAOCAGHGN(HMGOHGOLMJB: false, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.None);
		DJOEMHFGEIP(null);
		FNPODLBCFNF(0, League.Bronze3, 1, GKEOILLNCHG: true);
		...
		JGIMALFEHCP(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		AFDNODFKKNG(0, League.Bronze3, 1, GKEOILLNCHG: true);
	...
	private void GKKAPGGLOCL()
	{
		...
		GBFIOODGMOH(HMGOHGOLMJB: false, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.BronzeCrown);
		DJOEMHFGEIP(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CAAKEPHMPHI);
		GDCBEMJCMMF(1, League.Bronze3, 1, GKEOILLNCHG: false);
		string iNFLHPGMEOB = Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CBBDICBLHMM[5];
	...
	private void EOHKBJJOMCL()
	{
		...
		FIKFLIKDCFB(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.HMGOHGOLMJB, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.MHPNDNJDPGE, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.FHCMFHABMLE);
		BIPHPDCMLDB(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		CPIMHMKNGPG(1, League.NoLeague, 1, GKEOILLNCHG: false);
	...
	private void MNPPKEPEDJN()
	{
		...
		FEOJFCABOEM(HMGOHGOLMJB: true, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.None);
		NGKMIIGKIKK(null);
		EAAMHKFCEBK(1, League.NoLeague, 0, GKEOILLNCHG: false);
		string iNFLHPGMEOB = Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CBBDICBLHMM[1];
		HKIJOJOAEEP(CamosManager.instance.playerVisualCategories[0][iNFLHPGMEOB]);
		DEIGAMPPJPD.ECKBKNCJLOC(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.EBFDAICCJAK);
		IENGAFLIJED(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.BPNPPKPCFGN());
	...
	private void IBKABGMLNNJ()
	{
		IFCIHNCCADJ.JJGFMKCHIPE(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.EBFDAICCJAK);
		DLBJODBNPHA(1);
		CLIAOCAGHGN(HMGOHGOLMJB: true, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.FHCMFHABMLE);
		NLODHENBGEJ(Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CAAKEPHMPHI);
		MLGPJNPHJAH(0, League.Bronze3, 1, GKEOILLNCHG: false);
		HKIJOJOAEEP(null);
		DEIGAMPPJPD.KHIPFLOFKMC(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.EBFDAICCJAK);
		AEAMIHEMOHD(0);
		CDJIIBLJHHM(HMGOHGOLMJB: true, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.MHPNDNJDPGE, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.FHCMFHABMLE);
		BIPHPDCMLDB(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		FGGJPHOJPGA(0, League.Bronze3, 1, GKEOILLNCHG: true);
		HGOPFKCDGEB(null);
	}
	...
	private void DEOOKENCAFH()
	{
		...
		GBFIOODGMOH(HMGOHGOLMJB: false, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.None);
		KMJPOBKPOPI(null);
		MLGPJNPHJAH(0, League.Bronze3, 1, GKEOILLNCHG: true);
		string iNFLHPGMEOB = Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CBBDICBLHMM[2];
		...
		FIKFLIKDCFB(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.HMGOHGOLMJB, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.MHPNDNJDPGE, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.FHCMFHABMLE);
		FJKCONFDFLK(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		HDNOGLKPCAL(0, League.Bronze3, 0, GKEOILLNCHG: false);
		string iNFLHPGMEOB2 = PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CBBDICBLHMM[0];
	...
	private void OPINIJHHJCK()
	{
		...
		FEOJFCABOEM(HMGOHGOLMJB: false, Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE, WarArenaCrown.BronzeCrown);
		HEIJPDIOMID(null);
		FNPODLBCFNF(0, League.Bronze3, 0, GKEOILLNCHG: true);
		string iNFLHPGMEOB = Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CBBDICBLHMM[3];
		...
		INNNCOLBMCH(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.HMGOHGOLMJB, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.MHPNDNJDPGE, PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.FHCMFHABMLE);
		BIPHPDCMLDB(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CAAKEPHMPHI);
		OBBDANOPLHJ(1, League.Bronze3, 0, GKEOILLNCHG: true);
		string iNFLHPGMEOB2 = PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.CBBDICBLHMM[6];
