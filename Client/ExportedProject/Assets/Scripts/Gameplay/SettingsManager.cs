...
public class SettingsManager : DatabaseSerializedObjectGeneric<SettingsManager.Settings>
{
	...
	public static SettingsManager instance
	{
		get
		{
			mInstance = mInstance ?? ((SettingsManager)SingletonSupport.FindOrCreate(typeof(SettingsManager)));
			return mInstance;
		}
	}
	...
	internal void OnDialogClose()
	{
		...
		{
			Singleton<BeanstalkServerManager>.instance.CGAAHJNEIAN(JsonConvert.SerializeObject(data));
		}
	}
}
