...
public class ReminderDialog : GuiElementSingle<ReminderDialog>, PAIIOKBBHBC
{
	...
	[FormerlySerializedAs("LHHBGAKJKIK")]
	public GameObject FOOEHBHCANN;

	[FormerlySerializedAs("HHEPHPLFJFG")]
	...
	[FormerlySerializedAs("JKHHKIFBKLF")]
	...
	[FormerlySerializedAs("NMEDJBFDFJF")]
	public UIButton NBFALGNGGBK;

	[FormerlySerializedAs("BLLKPOELELN")]
	[Header("Bottom Buttons VIP")]
	public GameObject LEEHGENOGIB;

	[FormerlySerializedAs("DNKKHKEEJPO")]
	public UIButton BJCLBPCNCBB;

	[FormerlySerializedAs("GLNKEMMEJDB")]
	...
	[FormerlySerializedAs("MDLIPDHGOEG")]
	public UIAtlas AOOKDKCIPHO;

	[FormerlySerializedAs("PPMKJKELMNO")]
	...
	private void CPEFPEEMMKE()
	{
		...
		AOOICFOHDKC.SetActive(value: false);
		GPAJFHDIHLM.SetActive(value: true);
	}
	...
	private void FFOHEDAOMPC()
	{
		...
		KDDHAECKHDH.SetActive(value: true);
		GPAJFHDIHLM.SetActive(value: true);
	}
	...
	{
		AOOICFOHDKC.SetActive(value: false);
		KDDHAECKHDH.SetActive(value: false);
		HPNGIBHDNNP.SetActive(value: false);
		FOOEHBHCANN.SetActive(value: false);
		MGKLCNLGOOG.SetActive(value: false);
		LEEHGENOGIB.SetActive(value: false);
		GPAJFHDIHLM.SetActive(value: false);
	...
	private void PMBPHBCLBEH()
	{
		...
		MGKLCNLGOOG.SetActive(value: false);
		LEEHGENOGIB.SetActive(value: true);
	}
	...
	private void HJGLEGGMEFG()
	{
		...
		LEECNEIAFMJ(965f);
		FOOEHBHCANN.SetActive(value: true);
	...
	private void FMPPGGALOKJ()
	{
		...
		MGKLCNLGOOG.SetActive(value: true);
		LEEHGENOGIB.SetActive(value: true);
	}
	...
	private void BJHDNLEJDOI()
	{
		...
		AOOICFOHDKC.SetActive(value: true);
		GPAJFHDIHLM.SetActive(value: true);
	}
