...
public class AssignmentPauseRecord : Core_BaseScript
{
	...
	[FormerlySerializedAs("FPFOCJFBOEI")]
	public UISprite GPPCDCLKJHC;

	[FormerlySerializedAs("GJMMNLEFHLP")]
	public UILabel NIGMBGABEKF;

	[FormerlySerializedAs("IACKAFPIAKK")]
	...
	public void Initialize(Assignment EFEIDBFDDBE)
	{
		...
		if (EFEIDBFDDBE != null)
		{
			...
			OKMNFHNBMFA.text = $"{((currentState != Assignment.JLANLLEABDC.InProgress) ? EFEIDBFDDBE.goldDescription : EFEIDBFDDBE.blueDescription)} {EFEIDBFDDBE.status}";
