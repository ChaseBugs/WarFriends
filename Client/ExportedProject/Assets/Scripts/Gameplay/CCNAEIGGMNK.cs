...
public class CCNAEIGGMNK
{
	...
	public PlayerVisual LOKDBPPOLPM => (!string.IsNullOrEmpty(HJAJAAMHKKG)) ? CamosManager.instance.GetVisual(HJAJAAMHKKG) : null;

	public string MJADIIIJPEA => string.Format("{0} : {1} - {2}", HJAJAAMHKKG, AMEELJHHGKP, (!HMGOHGOLMJB) ? "isNormal" : "isVip");
