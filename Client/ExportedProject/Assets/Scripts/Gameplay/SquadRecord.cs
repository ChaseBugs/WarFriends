...
public class SquadRecord : PoolableObject
{
	...
	[FormerlySerializedAs("GHAEIOJNECB")]
	public GameObject IEHFAJFHNDH;

	[FormerlySerializedAs("JPJDFHICDMC")]
	...
	private void ACLHHIEFCCG(GameObject KHAHPAKDIKE)
	{
		...
		{
			WarningDialog.ShowError(Localization.Localize("Before CreateFromDatabase"), Localization.Localize("PaidInstantBattles"), 966f, null, string.Empty, JCOGJEEFLBC: true);
			return;
		}
	...
	private void IFBCDCCHNDF(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.currentPlayer.squadRank == (SquadRank)8)
		{
			WarningDialog.JACKIDKHKAI(Localization.Localize("MASTER"), Localization.Localize("["), 1699f, null, string.Empty, JCOGJEEFLBC: true);
			return;
		}
	...
	private void DNDCCHKFLOA(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.currentPlayer.squadRank == SquadRank.Veteran)
		{
			WarningDialog.JACKIDKHKAI(Localization.Localize("DisableOnStart"), Localization.Localize("Reward"), 520f, null, string.Empty, JCOGJEEFLBC: true);
			return;
		}
	...
	private void CJCMIFNGKLC(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.currentPlayer.squadRank == (SquadRank)8)
		{
			WarningDialog.JACKIDKHKAI(Localization.Localize("ID_CONFIRM_NOSQUADACTIONS_TEXT"), Localization.Localize("No main position was set in map definition"), 1523f, null, string.Empty, JCOGJEEFLBC: true);
			return;
		}
		if (DDAGBCNGIOF.JODOHNCDJNC() <= 1)
		{
	...
	private void MDMBILGIEGJ(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.currentPlayer.squadRank == SquadRank.Member)
		{
			WarningDialog.JACKIDKHKAI(Localization.Localize("302 GAME STARTED"), Localization.Localize("{0} {1}"), 1307f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
			return;
		}
	...
	private void LDEAIGGHJOO(GameObject KHAHPAKDIKE)
	{
		...
		{
			WarningDialog.KHOMNBHMFGA(Localization.Localize("CARDS_MIN"), Localization.Localize("warp_idle"), 475f, null, string.Empty, JCOGJEEFLBC: true);
			return;
		}
	...
	private void OFBOOJKHGME(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.currentPlayer.squadRank == SquadRank.Veteran)
		{
			WarningDialog.ShowError(Localization.Localize("{0} {1}"), Localization.Localize("SpawningManagerMultiplayer.prefab"), 51f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
			return;
		}
		if (DDAGBCNGIOF.INBFDIKBKIA() <= 0)
		{
	...
	private void GHECPOGCJJP(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.currentPlayer.squadRank == SquadRank.Member)
		{
			WarningDialog.ShowError(Localization.Localize("ID_CONFIRM_EXITINGCOOP"), Localization.Localize("N"), 795f, null, string.Empty, JCOGJEEFLBC: true);
			return;
		}
		if (DDAGBCNGIOF.MGDCJLAENHG() <= 0)
		{
	...
	private void NAOMGIGAAAL(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.currentPlayer.squadRank == (SquadRank)8)
		{
			WarningDialog.KHOMNBHMFGA(Localization.Localize("reloadTime"), Localization.Localize("TIMEOUT"), 1689f, null, string.Empty, JCOGJEEFLBC: true);
			return;
		}
	...
	private void IHDMJJONIFB(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.currentPlayer.squadRank == SquadRank.Member)
		{
			WarningDialog.ShowError(Localization.Localize("ShotFrequencyMin"), Localization.Localize("Server price {0} != client price {1} ({2}) "), 1802f, null, string.Empty, JCOGJEEFLBC: true);
			return;
		}
	...
	private void FFHOFHADHLD(GameObject KHAHPAKDIKE)
	{
		...
		{
			WarningDialog.ShowError(Localization.Localize("attack"), Localization.Localize("ID_NOTIFICATION_PLAYERLEAGUEEND"), 1251f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
			return;
		}
		if (DDAGBCNGIOF.MGDCJLAENHG() <= 1)
		{
	...
	private void DNPAGJDGACN(GameObject KHAHPAKDIKE)
	{
		...
		{
			WarningDialog.ShowError(Localization.Localize("GoldDeducted"), Localization.Localize("-"), 1022f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
			return;
		}
		if (DDAGBCNGIOF.FJFIHGNGAKD() <= 1)
		{
	...
	private void EELHKHFBMGE(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.currentPlayer.squadRank == SquadRank.Veteran)
		{
			WarningDialog.JACKIDKHKAI(Localization.Localize("SessionManager: Send OnApplicationResumed to Managers !!!"), Localization.Localize("menu-assignments-bar-blue"), 1401f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
			return;
		}
		if (DDAGBCNGIOF.DLDHIJAEFHG() <= 0)
		{
	...
	private void AICFAMBPHKF(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.currentPlayer.squadRank == SquadRank.Veteran)
		{
			WarningDialog.KHOMNBHMFGA(Localization.Localize("tc"), Localization.Localize("Broadcast_Duration"), 1133f, null, string.Empty, JCOGJEEFLBC: true);
			return;
		}
		if (DDAGBCNGIOF.MGDCJLAENHG() <= 0)
		{
	...
	private void DEDKIKHEOKN(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.currentPlayer.squadRank == (SquadRank)4)
		{
			WarningDialog.JACKIDKHKAI(Localization.Localize("canSendLogs"), Localization.Localize("Assignment Second parameter"), 833f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
			return;
		}
		if (DDAGBCNGIOF.JODOHNCDJNC() <= 1)
		{
