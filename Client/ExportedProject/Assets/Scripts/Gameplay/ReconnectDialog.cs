...
{
	[FormerlySerializedAs("mUpStripe")]
	[Header("Core")]
	public UISprite KMFGCJEGJJK;

	public UILabel OKMNFHNBMFA;

	[FormerlySerializedAs("mMiddleLabel")]
	public UILabel FOAJPBBHHDF;

	[FormerlySerializedAs("mTimerLabel")]
	public UILabel CNMDFMGELLH;

	[FormerlySerializedAs("mBlueShieldObject")]
