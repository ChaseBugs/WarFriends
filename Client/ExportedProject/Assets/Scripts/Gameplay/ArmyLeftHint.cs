...
public class ArmyLeftHint : Core_BaseScript
{
	...
	private void PLGMFJCMMLD()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 108f, mBasePosition.AddY(1686f), useLocal: false);
	...
	private void HMOODEGLJMP()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1357f, mBasePosition.AddY(1553f), useLocal: false);
		tweenPosition.method = UITweener.Method.EaseIn;
		tweenPosition.onFinished = delegate
		{
			PNNGFGIJHDD();
	...
	private void AMKADDAMKML()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1123f, mBasePosition.AddY(1139f), mBasePosition.AddY(1952f), useLocal: false);
	...
	private void PIMOOHHMCDJ()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 426f, mBasePosition.AddY(671f), useLocal: false);
		tweenPosition.method = UITweener.Method.Linear;
	...
	private void PDDNDNKOGDC()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1941f, mBasePosition.AddY(668f), mBasePosition.AddY(181f), useLocal: false);
		tweenPosition.method = UITweener.Method.Linear;
	...
	private void DAALINAACLI()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1934f, mBasePosition.AddY(1976f), useLocal: false);
		tweenPosition.method = UITweener.Method.EaseIn;
	...
	private void OCJEKNKLDEF()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1856f, mBasePosition.AddY(395f), mBasePosition.AddY(783f), useLocal: false);
		tweenPosition.method = UITweener.Method.EaseIn;
		tweenPosition.onFinished = HLGLCKOFGKJ;
	}
	...
	private void EGEDPJKFMDC()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 659f, mBasePosition.AddY(164f), useLocal: false);
		tweenPosition.method = UITweener.Method.Linear;
	...
	private void KNDHJKMCPAG()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1990f, mBasePosition.AddY(1339f), useLocal: false);
		tweenPosition.method = UITweener.Method.EaseIn;
		tweenPosition.onFinished = PPFPOKNBJJC;
	}
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1978f, mBasePosition, useLocal: false);
		tweenPosition.method = UITweener.Method.EaseIn;
		tweenPosition.onFinished = null;
	}
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 314f, mBasePosition, useLocal: false);
