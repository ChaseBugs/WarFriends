...
public class CardBulletSponge : Card
{
	...
	public virtual void DCGABENHDBH(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 1410f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.NNPILDOKNJO("_New_User", NABOFKMBMKH: false);
	...
	protected void BPNLIABHCPN()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1534f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("1", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
	}
	...
	protected void JAFBNNAACCL()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1120f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("ItemsOwned_Rarity_3", NABOFKMBMKH: false);
		}
	}
	...
	public virtual void MLEBPBFEOKC(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 701f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.PEBHGOMEKME("defendPosition", NABOFKMBMKH: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void MMCIIOJDLHK(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 938f;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.LDGKPCDJPLA("'x'0", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void PDAEAPEDIJC(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 43f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.NNPILDOKNJO("S", NABOFKMBMKH: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void INHEEMEAIDJ()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 899f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("ID_SKILLSHOTHINT_EXPLOSIVEKILL", NABOFKMBMKH: true);
		}
	}
	...
	public virtual void PEGJJBMLEML(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 1613f;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("CONFIRM", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void LEEFEJHDLGM(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 1813f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("facebookLevel", NABOFKMBMKH: false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void LMNEMMGCEFP()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 436f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.BIIHCAEKCOD("#account# logged to facebook result {0}", NABOFKMBMKH: true);
		}
	}
	...
	protected void PMOIOADCKPO()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1299f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("{0}{1}{2}", NABOFKMBMKH: true);
		}
	}
	...
	public virtual void BDLHMMDHGMP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 1393f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH("playerLevel", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void MLOJPAEBLBL(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 1858f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH("ID_RETRY", NABOFKMBMKH: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void FLDCHPBPKND()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1640f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.LDGKPCDJPLA("VipReward1", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
	...
	protected void HKPIHGBKAHO()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 521f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("registerCustomProfileDate", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
	}
	...
	protected void JOCHCGHAIGH()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 46f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("Total_Sessions", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
	...
	public override void UseCard(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 60f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-bulletsponge-full", NABOFKMBMKH: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void GAGEHEGFGOA(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 866f;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.JCJFMHGNIOF("ID_STAT_BATTLESPLAYED", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void LOPOCGLOHLH(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 1035f;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("WENEEDTO", NABOFKMBMKH: false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void NPGNJOGAEMK(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 1108f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.JCJFMHGNIOF("Special pack content: type: {0} id: {1}{2}", NABOFKMBMKH: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void MGAIKDBOPKI()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 491f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH("-", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
	}
	...
	protected void CKFENMDKKPE()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1878f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH("ID_NO", NABOFKMBMKH: true);
		}
	}
	...
	protected void DLJAGKBLJNC()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 777f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.LDGKPCDJPLA("확인", NABOFKMBMKH: false);
		}
	}
	...
	protected void HAMDMFGNIKD()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 635f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.PEBHGOMEKME("ID_LVLNUMBER", NABOFKMBMKH: false);
		}
	}
	...
	protected void NKGLGNEJIOA()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 746f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("ID_TWITTER_FOLLOWING_TEXT", NABOFKMBMKH: true);
		}
	}
	...
	public virtual void NPODFBNDOAK(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 663f;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("#Mission Rewards# 5 Heroic Missions completed. Gained {0} warcards", NABOFKMBMKH: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void KDPIJNFDMKC(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 498f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.EOEDEJKJKMN("de", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void FMKLDIJPHIH()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1367f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.BIIHCAEKCOD("setGravityForPopups", NABOFKMBMKH: false);
		}
	}
	...
	public virtual void JPCPJELCHDA(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 145f;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.LDGKPCDJPLA("Name", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void ANLFCJJCGMG()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1735f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.LJLDJOHAAMC("ID_TUTORIAL_GO_BUY_ARMY_2", NABOFKMBMKH: false);
		}
	}
	...
	public virtual void CFPFCPGPOCP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 132f;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.BIIHCAEKCOD("ID_GUI_BRONZE", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void APHGOCOMCAJ(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 145f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH("menu-gold", NABOFKMBMKH: false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void AGMKIMGHPAL(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 981f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.BIIHCAEKCOD("XXd YYh", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void BHNOANFEFJN(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 1715f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("{0} {1}", NABOFKMBMKH: false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void OOCJOBIIKAH()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 823f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.OFPAGLLFPPK("Update of experience\t\t{0} -> {1}\t\t diff {2}, game rewards XP total {3}", NABOFKMBMKH: true);
		}
	}
	...
	public virtual void DBAPEPJHJMH(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 959f;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.OFPAGLLFPPK("NAME", NABOFKMBMKH: false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void JMHFNCOODKH()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 70f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH("BUY: ", NABOFKMBMKH: true);
		}
	}
	...
	protected void Update()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 0f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-bulletsponge-full", NABOFKMBMKH: false);
		}
	}
	...
	protected void NBFMDCFFBIJ()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 843f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.JCJFMHGNIOF("InstantBattleEnded: 3RD REWARD GOLD: ", NABOFKMBMKH: false);
		}
	}
	...
	protected void AOKEHEDCPFB()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 553f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("GameLauncher.LoadMainScene", NABOFKMBMKH: true);
		}
	}
	...
	public virtual void IOKJMNMABHC(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 970f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH("ColumnNames", NABOFKMBMKH: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void JONIGCEPKLO(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 574f;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.NNPILDOKNJO("ID_GUI_EQUIP", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void BHBDBJNOCMP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 199f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.LJLDJOHAAMC("ID_GETAPROMOTION1", NABOFKMBMKH: false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void JGNCOJLCGFH(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 1528f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.LDGKPCDJPLA("ID_SQUADEVENT", NABOFKMBMKH: false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void DPELJDNCGHG(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 485f;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.PEBHGOMEKME("TwitterLogin(", NABOFKMBMKH: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void GFPPJNOENLE()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 675f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.JCJFMHGNIOF("leagueMedals", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
	...
	public virtual void NJJBJAAHBNP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = 1461f;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.LDGKPCDJPLA("{0}{1}{2} {3}{4}", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void CJBJGDCNLOG()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1238f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("[-]", NABOFKMBMKH: true);
		}
	}
	...
	protected void CMELHMEBEFI()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 251f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("inappId", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
	...
	protected void GEICOLPLFDL()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1186f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("ID", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
}
