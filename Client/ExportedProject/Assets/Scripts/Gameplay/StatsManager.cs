...
public class StatsManager : DatabaseSerializedObjectGeneric<StatsManager.StatisticsData>
{
	public class StatisticsData
	{
		...
		[FormerlySerializedAs("soldierUnitsSpawned")]
		public int vehiclesDeployed;

		[FormerlySerializedAs("vehiclesDeployed")]
		public int cardsPlayed;

		[FormerlySerializedAs("cardsPlayed")]
		public int scorestreakGained;

		[FormerlySerializedAs("scorestreakGained")]
		public int cratesStolen;

		[FormerlySerializedAs("cratesStolen")]
	...
	public static StatsManager instance
	{
		get
		{
			mInstance = mInstance ?? ((StatsManager)SingletonSupport.FindOrCreate(typeof(StatsManager)));
			return mInstance;
		}
	}
