...
{
	[FormerlySerializedAs("PDIHDIPBEKA")]
	[Header("Settings")]
	...
	[FormerlySerializedAs("OJNKGNJCCIL")]
	public UILabel DMDFANNPMGO;

	[Header("Overlay")]
	[FormerlySerializedAs("AGNNKAMKEDD")]
	public GameObject KHEBEJHEKMO;

	[FormerlySerializedAs("CDMLHKGBMGI")]
	public GameObject FOOODDABACJ;

	[FormerlySerializedAs("BLKPFJKELGB")]
	[Header("-Sale")]
	public GameObject PIFMBGDJJJK;

	[FormerlySerializedAs("CCHGPLOHNPN")]
	public UILabel DEMILBJODKK;

	[FormerlySerializedAs("IBNMGKBHKJK")]
	...
	public string id => (FONIAMFBFAH == null) ? string.Empty : FONIAMFBFAH.id;
	...
	public int discount => OKGNPCBCIDN;
