...
public class WeaponLeftContent : Core_BaseScript
{
	...
	[FormerlySerializedAs("NMKGIALDHCJ")]
	...
	[Header("-Line 2")]
	[FormerlySerializedAs("HDNOICHCBPP")]
	public UITable IEIKMKFHDOJ;

	[FormerlySerializedAs("LMDABLCFAHM")]
	public UISprite NOFOFAAFPOJ;

	[FormerlySerializedAs("OADHOEOJGHC")]
	public UILabel PPFCOELFDEI;

	[Header("-Line 3")]
	[FormerlySerializedAs("EFGIENBKMEA")]
	public UITable LMHBCNBKOCG;

	[FormerlySerializedAs("PHBLIGJKLOF")]
	public UILabel PPEHOGPDIGI;

	[Header("Statistics")]
	[FormerlySerializedAs("BMMOJJKBGDN")]
	public List<WeaponStatProgressBar> CAOEDDHFEFA;

	[Header("Button")]
	[FormerlySerializedAs("JCGILHLPNCE")]
	...
	[FormerlySerializedAs("NHDENIPCHPC")]
	[Header("-Empty")]
	...
	[FormerlySerializedAs("GMGKGKNNDOG")]
	public UITable MAAMDIKGBBD;

	[FormerlySerializedAs("CHKJMFHDPNP")]
	public UILabel EEHIBOFCIBP;

	[Header("--Sale Part")]
	[FormerlySerializedAs("mBoosterPart")]
	...
	[FormerlySerializedAs("JBGKMDHPHHJ")]
	public UILabel LPPOJMGOEFN;

	[FormerlySerializedAs("CJAOJKGGINA")]
	public UILabel PPDGFFJLHKK;

	[FormerlySerializedAs("IINCECNBKIC")]
	public UISprite IAIHLFMNAOA;

	[FormerlySerializedAs("KDPKLJPOHLM")]
	public UITable CKPLDDIPNAA;

	[FormerlySerializedAs("HDEHPDHBFFJ")]
	public UILabel NBFHHHGJDJA;

	[FormerlySerializedAs("PHJPIPKHEGN")]
	[SerializeField]
	[Header("--Subsccription")]
	private GameObject mSubscriptionPart;

	[FormerlySerializedAs("IJDIEJJIBEA")]
	[SerializeField]
	private UILabel mSubscriptionHint;

	[FormerlySerializedAs("mDeliveryTimeSale")]
	[Header("-Activate")]
	...
	[Header("-Rental")]
	[FormerlySerializedAs("ICIKKEEAFAL")]
	public GameObject GCMFKPMOCFL;

	[FormerlySerializedAs("LAJEJGEHEBK")]
	...
	private float HPNPMCEMJNM => -620f - UIHelper.safeAreaSize;
	...
	private void DMPOOCHHBNK()
	{
		...
		GuiScreenSingle<WeaponScreen>.instance.APGDCFFDPOF(MDAJJIAMDGH, CDMKCIKHIMM: false);
	...
	{
		int armyPowerX = LevelManager.instance.armyPowerX10;
		GuiScreenSingle<WeaponScreen>.instance.MBKJEPDJFKJ(MDAJJIAMDGH, CDMKCIKHIMM: true);
		JLIPONCMMFE(armyPowerX);
		CPIEGCEDKNK();
	}
	...
	private void GMGJFOKCHCK()
	{
		...
		GCMFKPMOCFL.SetActive(value: false);
		bool tryOutWeapon = MDAJJIAMDGH.tryOutWeapon;
		if (tryOutWeapon)
		{
			NJMAGIBDNLM.SetActive(value: true);
			NBGKOCKGCCK.SetActive(value: true);
			JEFAKEIGOEN.SetActive(value: false);
			LLOLKNBCPKP.SetActive(value: true);
			KKIBELEPAOK.SetActive(value: false);
			GCMFKPMOCFL.SetActive(value: false);
			BKCGCJPOPEE.SetActive(value: false);
		}
		BKCGCJPOPEE.SetActive(value: false);
		DIGHOBILJAJ();
	...
	private void LHLDMBBJHFF()
	{
		...
		int armyPowerX = LevelManager.instance.armyPowerX10;
		Singleton<Wallet>.instance.ALBICJOEMEF(num);
		GuiScreenSingle<WeaponScreen>.instance.APGDCFFDPOF(MDAJJIAMDGH, CDMKCIKHIMM: true);
	...
	{
		FPPPLPHDBMO();
		TweenPosition.Begin(IJFDHHLOHII, JCAFFELIFAO, IJFDHHLOHII.transform.localPosition.ReplaceX(1749f), useLocal: false);
	}
	...
	private void FPPPLPHDBMO()
	{
		...
		int weaponLevel = MDAJJIAMDGH.weaponLevel;
		int maxWeaponLevel = MDAJJIAMDGH.maxWeaponLevel;
		PPEHOGPDIGI.text = $"{weaponLevel}{Colours.stringGray} / {maxWeaponLevel}";
		FAGNIAIBJBJ();
		...
		if (tryOutWeapon)
		{
			NJMAGIBDNLM.SetActive(value: false);
			NBGKOCKGCCK.SetActive(value: false);
			JEFAKEIGOEN.SetActive(value: false);
			LLOLKNBCPKP.SetActive(value: false);
			KKIBELEPAOK.SetActive(value: false);
			GCMFKPMOCFL.SetActive(value: true);
			BKCGCJPOPEE.SetActive(value: false);
		}
		BKCGCJPOPEE.SetActive(value: false);
		LFEHKNDLOEN();
	...
	private void DBINHFIAEHF()
	{
		...
		if (tryOutWeapon)
		{
			...
			JEFAKEIGOEN.SetActive(value: false);
			LLOLKNBCPKP.SetActive(value: true);
			KKIBELEPAOK.SetActive(value: true);
			GCMFKPMOCFL.SetActive(value: false);
			BKCGCJPOPEE.SetActive(value: false);
		}
		BKCGCJPOPEE.SetActive(value: true);
		GHFGKBLAPPJ();
		bool flag3 = !flag && !flag2 && tryOutWeapon;
		AIPKDCLGOAN.enabled = flag3;
		DHDAODPNMCF(weaponState);
	...
	private void DOKLBGAJNAH()
	{
		...
		if (num > 0)
		{
			Debug.Log($"Have discount {num} to upgrade {MDAJJIAMDGH.DHHKOKKDDDO()}");
		}
	...
	public void PJBGBJAIJDJ(bool LGIIPHPACIC = true)
	{
		if (LGIIPHPACIC)
		{
			TweenPosition.Begin(IJFDHHLOHII, JCAFFELIFAO, IJFDHHLOHII.transform.localPosition.ReplaceX(652f), useLocal: false);
			GMGJFOKCHCK();
		}
	...
	public void UpdateLeftContent(bool LGIIPHPACIC = true)
	{
		...
		{
			PPEHOGPDIGI.text = $"{MDAJJIAMDGH.weaponLevel}{Colours.stringGray} / {MDAJJIAMDGH.maxWeaponLevel}";
		}
	}
	...
	private void ELPKDAHCHGL()
	{
		...
		GuiScreenSingle<WeaponScreen>.instance.NHAPEPLDGBB(MDAJJIAMDGH, CDMKCIKHIMM: true);
