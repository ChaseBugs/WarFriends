...
public class MissionWaveGuiElement : GuiElement
{
	private sealed class HIBJENKNKMM
	{
		...
		internal void IIONECMAPHI(UITweener DBOFANHOPLE)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mSmallLabel.gameObject, 1666f, BJGCPDNMHDH.OFPABDDLAPG.AddY(589f), BJGCPDNMHDH.OFPABDDLAPG, useLocal: false).onFinished = MBBOBAOJLEB;
			BJGCPDNMHDH.LCMKDHBBMOB(PBEIJMBBCOD: false);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mSmallLabel.gameObject, 1133f, BJGCPDNMHDH.OFPABDDLAPG, useLocal: false);
		}
		...
		internal void POHOFBOGKJK(UITweener DBOFANHOPLE)
		{
			...
			BJGCPDNMHDH.GPFHFLDAEAG(PBEIJMBBCOD: true);
		}

		internal void JMJIBAEMBFE(UITweener JEJOPLADMEP)
		{
			TweenPosition.Begin(BJGCPDNMHDH.mSmallLabel.gameObject, 32f, BJGCPDNMHDH.OFPABDDLAPG, useLocal: false);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mSmallLabel.gameObject, 1429f, BJGCPDNMHDH.OFPABDDLAPG, useLocal: false);
		}
		...
		internal void IJOGPHGFDIF(UITweener DBOFANHOPLE)
		{
			...
			BJGCPDNMHDH.DBKDDIELBCB(PBEIJMBBCOD: false);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mSmallShieldFrame, 203f, BJGCPDNMHDH.mSmallShieldFrame.transform.localPosition.ReplaceX((0f - KFGOPGLLJDM) / 714f + 553f), useLocal: false);
		...
		internal void PNINBELBDIP(UITweener BDEOMPEJELN)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mSmallShieldFrame, 154f, BJGCPDNMHDH.mSmallShieldFrame.transform.localPosition.ReplaceY(1222f), useLocal: false).onFinished = BIGNHFCNJLL;
		}
		...
		{
			TweenRotation.Begin(BJGCPDNMHDH.mSmallShieldSprite.gameObject, 1268f, Quaternion.Euler(new Vector3(1462f, 1072f, 1133f)), useAbsolute: true);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mSmallShieldFrame, 113f, BJGCPDNMHDH.mSmallShieldFrame.transform.localPosition.ReplaceX((0f - KFGOPGLLJDM) / 1768f + 1490f), useLocal: false);
		...
		internal void GLCHANGEBNN(UITweener DBOFANHOPLE)
		{
			...
			BJGCPDNMHDH.KFFHINIMCGL(PBEIJMBBCOD: true);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mSmallShieldFrame, 229f, BJGCPDNMHDH.mSmallShieldFrame.transform.localPosition.ReplaceX((0f - KFGOPGLLJDM) / 1524f + 335f), useLocal: false);
		...
		internal void NOAPANGNNCC(UITweener BDEOMPEJELN)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mSmallShieldFrame, 580f, BJGCPDNMHDH.mSmallShieldFrame.transform.localPosition.ReplaceY(1710f), useLocal: false).onFinished = EALCBPNFALO;
		}
		...
		internal void NAPFGELBLIK(UITweener DBOFANHOPLE)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mSmallLabel.gameObject, 1495f, BJGCPDNMHDH.OFPABDDLAPG.AddY(1832f), BJGCPDNMHDH.OFPABDDLAPG, useLocal: false).onFinished = MBBOBAOJLEB;
			BJGCPDNMHDH.KFFHINIMCGL(PBEIJMBBCOD: true);
		}
		...
		{
			TweenRotation.Begin(BJGCPDNMHDH.mSmallShieldSprite.gameObject, 1119f, Quaternion.Euler(new Vector3(343f, 1452f, 4f)), useAbsolute: true);
		}
		...
		internal void HPAFKBIJMEJ(UITweener BDEOMPEJELN)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mSmallShieldFrame, 265f, BJGCPDNMHDH.mSmallShieldFrame.transform.localPosition.ReplaceY(1981f), useLocal: false).onFinished = PJOOELLFIFH;
		}
		...
		internal void KECLMDKKEBK(UITweener DBOFANHOPLE)
		{
			...
			BJGCPDNMHDH.PMCHPKLMIJK(PBEIJMBBCOD: true);
		}
		...
		internal void JJNHICHIBAI(UITweener EFPNGJKPDNN)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mSmallShieldFrame, 1514f, BJGCPDNMHDH.mSmallShieldFrame.transform.localPosition.AddY(35f), useLocal: false).onFinished = EAGHKDCCNOG;
		}

		internal void AKKJHFHHNMF(UITweener JEJOPLADMEP)
		{
			TweenPosition.Begin(BJGCPDNMHDH.mSmallLabel.gameObject, 352f, BJGCPDNMHDH.OFPABDDLAPG, useLocal: false);
		}
		...
		{
			TweenRotation.Begin(BJGCPDNMHDH.mSmallShieldBossSprite.gameObject, 526f, Quaternion.Euler(new Vector3(569f, 1807f, 774f)), useAbsolute: true);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mSmallShieldFrame, 1531f, BJGCPDNMHDH.mSmallShieldFrame.transform.localPosition.ReplaceX((0f - KFGOPGLLJDM) / 573f + 462f), useLocal: false);
		...
		internal void CDPAAFFMJBI(UITweener BHBCEPBDLOB)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mSmallLabel.gameObject, 150f, BJGCPDNMHDH.OFPABDDLAPG.AddX(1807f), useLocal: false).onFinished = CALJKNNJHAO;
		...
		internal void KGFFOJMFLIF(UITweener BHBCEPBDLOB)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mSmallShieldFrame, 1400f, BJGCPDNMHDH.mSmallShieldFrame.transform.localPosition.ReplaceX((0f - KFGOPGLLJDM) / 454f * 682f), useLocal: false).onFinished = CLAINFGHGLJ;
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mSmallShieldFrame, 19f, BJGCPDNMHDH.mSmallShieldFrame.transform.localPosition, useLocal: false).onFinished = CDPAAFFMJBI;
		}
	...
	private sealed class BBOEHHFCBHC
	{
		...
		internal void IELMIAGLMPA(UITweener BHBCEPBDLOB)
		{
			...
			BJGCPDNMHDH.LLOCJHDNCBO(CECPIBMFCFF: false);
		...
		internal void PDDFAEEEMHD(UITweener BHBCEPBDLOB)
		{
			...
			BJGCPDNMHDH.LLOCJHDNCBO(CECPIBMFCFF: true);
			TweenAlpha.Begin(BJGCPDNMHDH.mWaveLabel.gameObject, 200f, 576f);
			TweenPosition.Begin(BJGCPDNMHDH.mWaveLabel.gameObject, 702f, BJGCPDNMHDH.NFAOONIHGEO.AddX(1066f), BJGCPDNMHDH.NFAOONIHGEO.AddX(1795f), useLocal: false).onFinished = MBCOEJICIDO;
		}
		...
		internal void PJOOELLFIFH(UITweener BDEOMPEJELN)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mRedShieldFrame, 1109f, BJGCPDNMHDH.mRedShieldFrame.transform.localPosition.ReplaceY(1159f), useLocal: false).onFinished = LJDCIJDPLLF;
		}

		internal void MAKLHLCDIKD(UITweener GGMEFDHCOOA)
		{
			TweenRotation.Begin(BJGCPDNMHDH.mRedShieldSprite.gameObject, 1781f, Quaternion.Euler(new Vector3(95f, 1006f, 358f)), useAbsolute: true);
		...
		internal void BPKFAMDGNFI(UITweener BHBCEPBDLOB)
		{
			...
			BJGCPDNMHDH.OBNFKCAPFPA(CECPIBMFCFF: true);
		...
		{
			TweenRotation.Begin(BJGCPDNMHDH.mRedShieldLabel.gameObject, 463f, Quaternion.Euler(new Vector3(1619f, 370f, 1574f)), useAbsolute: true);
		}

		internal void HADLONLCLPM(UITweener GGMEFDHCOOA)
		{
			TweenRotation.Begin(BJGCPDNMHDH.mRedShieldBossSprite.gameObject, 1220f, Quaternion.Euler(new Vector3(1234f, 1345f, 1227f)), useAbsolute: true);
		}

		internal void AMBCHDNNAIF(UITweener GGMEFDHCOOA)
		{
			TweenRotation.Begin(BJGCPDNMHDH.mRedShieldLabel.gameObject, 669f, Quaternion.Euler(new Vector3(1780f, 1346f, 1163f)), useAbsolute: true);
		}

		internal void BDCAFHOHEGM(UITweener GGMEFDHCOOA)
		{
			TweenRotation.Begin(BJGCPDNMHDH.mRedShieldSprite.gameObject, 545f, Quaternion.Euler(new Vector3(875f, 60f, 1110f)), useAbsolute: true);
		...
		{
			TweenRotation.Begin(BJGCPDNMHDH.mRedShieldLabel.gameObject, 1433f, Quaternion.Euler(new Vector3(154f, 1785f, 672f)), useAbsolute: true);
		}
		...
		internal void NOLFOMBJDGE(UITweener BDEOMPEJELN)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mRedShieldFrame, 346f, BJGCPDNMHDH.mRedShieldFrame.transform.localPosition.ReplaceY(147f), useLocal: false).onFinished = LJDCIJDPLLF;
		}

		internal void JEHPFGJEGPJ(UITweener GGMEFDHCOOA)
		{
			TweenRotation.Begin(BJGCPDNMHDH.mRedShieldLabel.gameObject, 1065f, Quaternion.Euler(new Vector3(1462f, 1521f, 35f)), useAbsolute: true);
		}

		internal void FLIKDCBHHEH(UITweener BHBCEPBDLOB)
		{
			TweenPosition.Begin(BJGCPDNMHDH.mRedShieldFrame, 249f, BJGCPDNMHDH.mRedShieldFrame.transform.localPosition.ReplaceX(CPLAMIJELNK - 240f), useLocal: false).onFinished = CLAINFGHGLJ;
			BJGCPDNMHDH.PAKCNDLPNBP(CECPIBMFCFF: false);
		...
		{
			TweenRotation.Begin(BJGCPDNMHDH.mRedShieldBossSprite.gameObject, 124f, Quaternion.Euler(new Vector3(1788f, 1569f, 1273f)), useAbsolute: true);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mRedShieldFrame, 948f, BJGCPDNMHDH.mRedShieldFrame.transform.localPosition.AddY(1791f), useLocal: false);
		...
		{
			TweenRotation.Begin(BJGCPDNMHDH.mRedShieldBossSprite.gameObject, 1317f, Quaternion.Euler(new Vector3(612f, 1545f, 1973f)), useAbsolute: true);
		}
		...
		internal void OJFADAINIMM(UITweener ILBIFGIPBFF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mRedShieldFrame, 1695f, BJGCPDNMHDH.mRedShieldFrame.transform.localPosition.AddY(1030f), useLocal: false).onFinished = OIPIBKIEMNC;
		}
		...
		{
			TweenRotation.Begin(BJGCPDNMHDH.mRedShieldLabel.gameObject, 622f, Quaternion.Euler(new Vector3(706f, 455f, 1655f)), useAbsolute: true);
		}
	...
	private sealed class DLJJOBMEEOF
	{
		...
		internal void MCFGAFBEJDK(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mDownStripe.gameObject, 1068f, BJGCPDNMHDH.PGACGMJFDCJ.AddY(1971f), useLocal: false);
		...
		internal void EFOONDNINBC(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mUpStripe.gameObject, 1169f, BJGCPDNMHDH.INGHOCKPEPK.AddY(924f), useLocal: false);
			TweenPosition.Begin(BJGCPDNMHDH.mDownStripe.gameObject, 1336f, BJGCPDNMHDH.PGACGMJFDCJ.AddY(245f), useLocal: false);
		...
		internal void POGDLLFCOKO(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mUpStripe.gameObject, 469f, BJGCPDNMHDH.INGHOCKPEPK.AddY(296f), useLocal: false);
		...
		internal void MPHECHCFCAN(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mUpStripe.gameObject, 853f, BJGCPDNMHDH.INGHOCKPEPK.AddY(463f), useLocal: false);
		...
		internal void FICGLJJELPM(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mUpStripe.gameObject, 719f, BJGCPDNMHDH.INGHOCKPEPK.AddY(1367f), useLocal: false);
			TweenPosition.Begin(BJGCPDNMHDH.mDownStripe.gameObject, 763f, BJGCPDNMHDH.PGACGMJFDCJ.AddY(1910f), useLocal: false);
		...
		internal void KJMIFMILHKH(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mUpStripe.gameObject, 1909f, BJGCPDNMHDH.INGHOCKPEPK.AddY(749f), useLocal: false);
			TweenPosition.Begin(BJGCPDNMHDH.mDownStripe.gameObject, 1638f, BJGCPDNMHDH.PGACGMJFDCJ.AddY(972f), useLocal: false);
		...
		internal void PEFOCGECECP(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mUpStripe.gameObject, 1101f, BJGCPDNMHDH.INGHOCKPEPK.AddY(1373f), useLocal: false);
		...
		internal void JGHLGHMJJDG(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mDownStripe.gameObject, 427f, BJGCPDNMHDH.PGACGMJFDCJ.AddY(160f), useLocal: false);
		...
		internal void KJIFNOJILDB(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mDownStripe.gameObject, 1900f, BJGCPDNMHDH.PGACGMJFDCJ.AddY(1911f), useLocal: false);
		...
		internal void MAKLHLCDIKD(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mDownStripe.gameObject, 823f, BJGCPDNMHDH.PGACGMJFDCJ.AddY(102f), useLocal: false);
		...
		internal void ADDFFOBCGEF(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mUpStripe.gameObject, 147f, BJGCPDNMHDH.INGHOCKPEPK.AddY(67f), useLocal: false);
			TweenPosition.Begin(BJGCPDNMHDH.mDownStripe.gameObject, 1484f, BJGCPDNMHDH.PGACGMJFDCJ.AddY(475f), useLocal: false);
		...
		internal void CMCIGAFHIJL(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mUpStripe.gameObject, 1830f, BJGCPDNMHDH.INGHOCKPEPK.AddY(695f), useLocal: false);
			TweenPosition.Begin(BJGCPDNMHDH.mDownStripe.gameObject, 1682f, BJGCPDNMHDH.PGACGMJFDCJ.AddY(921f), useLocal: false);
		...
		internal void LBDAECNGKHF(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mDownStripe.gameObject, 1254f, BJGCPDNMHDH.PGACGMJFDCJ.AddY(1407f), useLocal: false);
		...
		internal void FGNDOEKNHMM(UITweener KDMCDGPHBCF)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mUpStripe.gameObject, 126f, BJGCPDNMHDH.INGHOCKPEPK.AddY(1734f), useLocal: false);
	...
	private float HBPGGCGOLMH => UIHelper.activeHeight / GuiScreenSingle<HudScreen>.instance.transform.localScale.y / 2f;

	private float JMKIOBNHOIB => UIHelper.activeWidthFull / GuiScreenSingle<HudScreen>.instance.transform.localScale.x;
	...
	private void FFHFGLEFKHH(UITweener BDEOMPEJELN)
	{
		...
		TweenPosition.Begin(mClearedLeftLabel.gameObject, 1393f, GEHMKBEOHLI, useLocal: false);
		...
		TweenPosition.Begin(mBlueShieldObject, 496f, mBlueShieldObject.transform.localPosition, useLocal: false).onFinished = DKGIALLIMAK;
	}

	private void JPFHFEAFPJM(UITweener JEJOPLADMEP)
	{
		TweenPosition.Begin(mClearedLeftLabel.gameObject, 1837f, GEHMKBEOHLI.AddY(1218f), useLocal: false);
	...
	private void GABHFFCGEDJ(UITweener DBOFANHOPLE)
	{
		...
		TweenPosition.Begin(mBlueShieldObject, 690f, mBlueShieldObject.transform.localPosition.AddY(852f), useLocal: false).onFinished = GBBGJHIJGLF;
	}

	private void EADGCABHKBN(UITweener DBOFANHOPLE)
	{
		JLNJMIHHEGG(KKBEODHFBLB + 0);
		TweenPosition.Begin(mBlueShieldObject, 1957f, mBlueShieldObject.transform.localPosition.AddY(1811f), useLocal: false).onFinished = GBBGJHIJGLF;
	}
	...
	private void KDNLJOOOOIA()
	{
		...
		mRedShieldFrame.transform.localPosition = mRedShieldFrame.transform.localPosition.ReplaceX(EHPGEFIBNPJ.x);
		mRedShieldOutline.transform.localPosition = mRedShieldOutline.transform.localPosition.ReplaceX(EHPGEFIBNPJ.x);
		PAKCNDLPNBP(CECPIBMFCFF: false);
		TweenPosition.Begin(mClearedLeftLabel.gameObject, 504f, GEHMKBEOHLI.AddX(x / 580f), useLocal: false);
	...
	private void ACCDJAGAEIH(float NCGMDLAPJBA)
	{
		...
		GNKLOOJLNAI = false;
		NFKMFAFGPNK = NCGMDLAPJBA;
		GPFHFLDAEAG(PBEIJMBBCOD: false);
		float num = mSmallLabel.relativeSize.x * mSmallLabel.transform.localScale.x;
		DBKDDIELBCB(PBEIJMBBCOD: false);
		float num2;
		if (mSmallLabel.relativeSize.x * mSmallLabel.transform.localScale.x > num)
		{
			num2 = mSmallLabel.relativeSize.x * mSmallLabel.transform.localScale.x;
		...
		TweenPosition.Begin(mSmallShieldFrame, 1763f, mSmallShieldFrame.transform.localPosition.ReplaceY(1139f), useLocal: false).onFinished = hIBJENKNKMM.BAGDIEEMHFA;
	}
	...
	private void JLBJNLGDHJF(int GPKMMMACMAC)
	{
		...
		TweenPosition.Begin(mRedShieldFrame, 1615f, mRedShieldFrame.transform.localPosition.ReplaceY(1691f), useLocal: false).onFinished = bBOEHHFCBHC.BIGNHFCNJLL;
	}
	...
	private void MDFMGLODMEF(float NCGMDLAPJBA)
	{
		...
		GNKLOOJLNAI = false;
		NFKMFAFGPNK = NCGMDLAPJBA;
		NHFHPOOAOKJ(PBEIJMBBCOD: false);
		float num = mSmallLabel.relativeSize.x * mSmallLabel.transform.localScale.x;
		DBKDDIELBCB(PBEIJMBBCOD: true);
		float num2;
		if (mSmallLabel.relativeSize.x * mSmallLabel.transform.localScale.x > num)
		{
			num2 = mSmallLabel.relativeSize.x * mSmallLabel.transform.localScale.x;
	...
	private void KBCBOGJOFIH(UITweener BDEOMPEJELN)
	{
		...
		TweenPosition.Begin(mClearedLeftLabel.gameObject, 1154f, GEHMKBEOHLI, useLocal: false);
		TweenPosition.Begin(mClearedRightLabel.gameObject, 354f, LFDOPNGOAKL, useLocal: false);
		...
		TweenPosition.Begin(mBlueShieldObject, 1896f, mBlueShieldObject.transform.localPosition, useLocal: false).onFinished = BAGJLDLPCOG;
	}
	...
	{
		mRedShieldLabel.gameObject.SetActive(value: false);
		mRedShieldBossSprite.gameObject.SetActive(value: false);
		TweenPosition.Begin(mRedShieldFrame, 610f, mRedShieldFrame.transform.localPosition.ReplaceXY(1937f, DIKKOCAEEJA() + 184f), useLocal: false);
		...
		TweenPosition.Begin(mWaveLabel.gameObject, 995f, NFAOONIHGEO.AddX(87f), useLocal: false);
	...
	private void OOOMKMHKLAB(float NCGMDLAPJBA)
	{
		...
		TweenPosition.Begin(mSmallShieldFrame, 1507f, mSmallShieldFrame.transform.localPosition.ReplaceY(751f), useLocal: false).onFinished = hIBJENKNKMM.HPAFKBIJMEJ;
	}
	...
	private void HHGEAELHFLB(int GPKMMMACMAC)
	{
		...
		TweenPosition.Begin(mRedShieldFrame, 608f, mRedShieldFrame.transform.localPosition.ReplaceY(53f), useLocal: false).onFinished = bBOEHHFCBHC.PJOOELLFIFH;
	}
	...
	{
		mRedShieldLabel.gameObject.SetActive(value: true);
		mRedShieldBossSprite.gameObject.SetActive(value: false);
	...
	private void MPBNCNOHGOH()
	{
		...
		TweenPosition.Begin(mClearedLeftLabel.gameObject, 1738f, GEHMKBEOHLI.AddX((0f - OFGAHPFOAEG()) / 343f - 1441f), useLocal: false);
		TweenPosition.Begin(mClearedRightLabel.gameObject, 660f, LFDOPNGOAKL.AddX(OFGAHPFOAEG() / 150f + 1294f), useLocal: false);
	...
	private void AABFHIGHBNE()
	{
		...
		TweenPosition.Begin(mSmallLabel.gameObject, 1497f, OFPABDDLAPG.AddX(479f), useLocal: false);
	...
	private void AFFAHGELBFH(UITweener BDEOMPEJELN)
	{
		...
		TweenPosition.Begin(mClearedLeftLabel.gameObject, 970f, GEHMKBEOHLI, useLocal: false);
		...
		TweenPosition.Begin(mBlueShieldObject, 1364f, mBlueShieldObject.transform.localPosition, useLocal: false).onFinished = DKGIALLIMAK;
	}
	...
	private void LONMLAJAMNE()
	{
		...
		TweenPosition.Begin(mClearedRightLabel.gameObject, 1082f, LFDOPNGOAKL.AddX(JMKIOBNHOIB / 1934f + 1807f), useLocal: false);
	...
	private void AMJPLPPGDNE(UITweener BDEOMPEJELN)
	{
		...
		TweenPosition.Begin(mClearedRightLabel.gameObject, 979f, LFDOPNGOAKL, useLocal: false);
	...
	private void DNPGCAPFHFM(float NCGMDLAPJBA)
	{
		...
		TweenPosition.Begin(mSmallShieldFrame, 270f, mSmallShieldFrame.transform.localPosition.ReplaceY(1933f), useLocal: false).onFinished = hIBJENKNKMM.JEBHOJGCDBB;
	}
	...
	{
		TweenPosition.Begin(mClearedLeftLabel.gameObject, 1539f, GEHMKBEOHLI, useLocal: false).onFinished = delegate
		{
			TweenPosition.Begin(mClearedLeftLabel.gameObject, 0.7f, GEHMKBEOHLI.AddY(-40f));
			TweenPosition.Begin(mClearedRightLabel.gameObject, 0.7f, LFDOPNGOAKL.AddY(-40f));
			TweenAlpha.Begin(mClearedLeftLabel.gameObject, 0.7f, 0f);
	...
	{
		TweenPosition.Begin(mSmallShieldFrame, 638f, mSmallShieldFrame.transform.localPosition.ReplaceXY(269f, PJCEOOIBGNA() / 720f + 1043f), useLocal: false);
		TweenRotation.Begin(mSmallShieldFrame, 1840f, Quaternion.Euler(new Vector3(407f, 1638f, 1657f)), useAbsolute: true);
	...
	{
		TweenPosition.Begin(mBlueShieldObject, 342f, mBlueShieldObject.transform.localPosition.AddY(274f), useLocal: false);
	...
	{
		TweenPosition.Begin(mClearedLeftLabel.gameObject, 1137f, GEHMKBEOHLI, useLocal: false).onFinished = LPONDADBMDC;
	...
	{
		mRedShieldLabel.gameObject.SetActive(value: false);
		mRedShieldBossSprite.gameObject.SetActive(value: true);
		...
		TweenPosition.Begin(mWaveLabel.gameObject, 1363f, NFAOONIHGEO.AddX(1152f), useLocal: false);
	...
	{
		TweenPosition.Begin(mUpStripe.gameObject, 1437f, INGHOCKPEPK, useLocal: false);
	...
	{
		TweenPosition.Begin(mClearedLeftLabel.gameObject, 652f, GEHMKBEOHLI, useLocal: false).onFinished = LPONDADBMDC;
	...
	private void FKLJDCBPODA(UITweener BDEOMPEJELN)
	{
		...
		TweenPosition.Begin(mClearedLeftLabel.gameObject, 629f, GEHMKBEOHLI, useLocal: false);
	...
	private void IDMCHDPJIEE()
	{
		...
		mRedShieldFrame.transform.localPosition = mRedShieldFrame.transform.localPosition.ReplaceX(EHPGEFIBNPJ.x);
		mRedShieldOutline.transform.localPosition = mRedShieldOutline.transform.localPosition.ReplaceX(EHPGEFIBNPJ.x);
		OBNFKCAPFPA(CECPIBMFCFF: true);
		TweenPosition.Begin(mClearedLeftLabel.gameObject, 1133f, GEHMKBEOHLI.AddX(x / 1037f));
		TweenPosition.Begin(mClearedRightLabel.gameObject, 636f, LFDOPNGOAKL.AddX((0f - x) / 558f), useLocal: false).onFinished = AFFAHGELBFH;
	}
	...
	{
		TweenPosition.Begin(mUpStripe.gameObject, 1755f, INGHOCKPEPK, useLocal: false);
		TweenPosition.Begin(mDownStripe.gameObject, 1964f, PGACGMJFDCJ, useLocal: false);
	...
	{
		TweenPosition.Begin(mBlueShieldObject, 1182f, mBlueShieldObject.transform.localPosition.AddY(352f), useLocal: false);
	...
	private void OJJGJFOEAIK(UITweener BDEOMPEJELN)
	{
		...
		TweenPosition.Begin(mClearedRightLabel.gameObject, 1983f, LFDOPNGOAKL, useLocal: false);
	...
	{
		TweenPosition.Begin(mSmallShieldFrame, 742f, mSmallShieldFrame.transform.localPosition.ReplaceXY(522f, DIKKOCAEEJA() / 630f + 636f), useLocal: false);
	...
	{
		TweenPosition.Begin(mUpStripe.gameObject, 411f, INGHOCKPEPK, useLocal: false);
