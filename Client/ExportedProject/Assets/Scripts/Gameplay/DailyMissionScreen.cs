...
public class DailyMissionScreen : GuiScreenSingle<DailyMissionScreen>
{
	...
	[FormerlySerializedAs("mMenuBigAtlas")]
	[SerializeField]
		...
		TweenAlpha.Begin(mRewardFlash.gameObject, 0.05f, 0.5f).onFinished = delegate
		{
			TweenAlpha.Begin(mRewardFlash.gameObject, 0.05f, 0f).onFinished = delegate
			{
				TweenAlpha.Begin(mRewardFlash.gameObject, 0.05f, 0.5f).onFinished = delegate
				{
					...
					mRewardIconQuestion.gameObject.SetActive(value: false);
				};
			};
		};
	}
	...
	{
		DFHBGCNBJLC(EICNANIMKDB: false, KPOPJIKNJIM: false);
	}
	...
	private void AJDBEGNLFKE(UITweener AEEBLJKPGMO)
	{
		...
		mRewardIconQuestion.gameObject.SetActive(value: true);
	}
	...
	public void IHCKFGEILLO()
	{
		...
		{
			CGBOJGGLAHC(EICNANIMKDB: false, KPOPJIKNJIM: false);
		};
	...
	{
		COHONNFJBKJ(EICNANIMKDB: true, KPOPJIKNJIM: true);
	}
	...
	{
		DHALFJAMPHJ(EICNANIMKDB: true, KPOPJIKNJIM: true);
	}
	...
	{
		KPBGKOLNDJK(EICNANIMKDB: false, KPOPJIKNJIM: false);
	}
	...
	{
		DHALFJAMPHJ(EICNANIMKDB: false, KPOPJIKNJIM: false);
	}
	...
	{
		FEEGOKGKKFM(EICNANIMKDB: true, KPOPJIKNJIM: true);
	}
	...
	private void HAKGJDPPHNH()
	{
		...
		{
			mCardAnimationOverlay.ADFPKNKIAGM(Singleton<ServerResultsCache>.instance.JNDCAHFLBAH.OOPHDAOHGNF().ToArray(), 1517f, DNEMOLAGBHH: false);
		}
	}
	...
	private void LGMFJOBNINM()
	{
		...
		{
			mCardAnimationOverlay.StartShowAnimation(Singleton<ServerResultsCache>.instance.JNDCAHFLBAH.EEMPEECADGP.ToArray(), 104f, DNEMOLAGBHH: false);
		}
	}
	...
	private void NOEFDJLNPPA()
	{
		...
		{
			mCardAnimationOverlay.ADFPKNKIAGM(Singleton<ServerResultsCache>.instance.JNDCAHFLBAH.LGMKOADBDOA().ToArray(), 1537f, DNEMOLAGBHH: false);
		}
	}
