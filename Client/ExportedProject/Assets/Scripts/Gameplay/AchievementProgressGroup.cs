...
public sealed class AchievementProgressGroup
{
	...
	[CompilerGenerated]
	private Achievement _003Cachievement_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private AchievementProgress[] _003CachievementProgresses_003Ek__BackingField;
	...
	public AchievementProgress[] achievementProgresses
	{
		...
		get
		{
			return _003CachievementProgresses_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			_003CachievementProgresses_003Ek__BackingField = value;
		}
	}
	...
	public bool hasMultipleAchievementProgresses => achievementProgresses != null && achievementProgresses.Length > 1;
	...
	public bool isCompleted => Mathf.Approximately(globalProgress, 1f);

	public bool isClaimed => achievementProgresses != null && achievementProgresses.Length != 0 && achievementProgresses[achievementProgresses.Length - 1].isClaimed;
	...
	public int localCurrentValue => mData.localCurrentValue;
	...
	public void Evaluate()
	{
		if (!isCompleted)
		{
			SetLocalCurrentValue(achievement.GOPJOOHKCNB(), addOffset: true);
		}
	}
	...
	public void Complete()
	{
		if (!isCompleted)
		{
			SetLocalCurrentValue(localTargetValue, addOffset: false);
		}
	}
	...
	public void CompleteTier(AchievementProgress achievementProgress)
	{
		...
		{
			SetLocalCurrentValue(achievementProgress.targetValue, addOffset: false);
		}
	}
