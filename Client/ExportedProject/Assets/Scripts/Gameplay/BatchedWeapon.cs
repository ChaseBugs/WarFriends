...
public class BatchedWeapon : Core_BaseScript
{
	...
	[FormerlySerializedAs("IOJFENBEHBP")]
	...
	private bool _003CONBLHPPKGAD_003Ek__BackingField;
	...
	public bool shooting
	{
		...
		private set
		{
			_003CONBLHPPKGAD_003Ek__BackingField = value;
		}
	}
	...
	protected void IODGCIIDJEK()
	{
		...
		{
			MDKABJDCKBI(GIJMLIOJPLH, GGJPNLDIGGM: false);
		}
		else
		{
			...
			MDKABJDCKBI(GIJMLIOJPLH + vector + new Vector3(401f, 639f, 1706f) * KPHGDDGHFCH, GGJPNLDIGGM: true);
		}
		MJNENAGPCGF += 0;
		if (MJNENAGPCGF >= OONPHPCNBJF)
		{
			MJNENAGPCGF = 1;
			CBHIPABHGHC(IDEBKDPMPGM: false);
			if (NNHLHDENDPM != null)
			{
				NNHLHDENDPM();
			}
	...
	protected void CKFENMDKKPE()
	{
		...
		else
		{
			...
			MDKABJDCKBI(GIJMLIOJPLH + vector + new Vector3(468f, 1334f, 1977f) * KPHGDDGHFCH, GGJPNLDIGGM: false);
		}
		MJNENAGPCGF++;
		if (MJNENAGPCGF >= OONPHPCNBJF)
		{
	...
	protected void ECFIMCCNBBN()
	{
		...
		{
			MDKABJDCKBI(GIJMLIOJPLH, GGJPNLDIGGM: true);
		}
		else
		{
			...
			MDKABJDCKBI(GIJMLIOJPLH + vector + new Vector3(1417f, 1947f, 1450f) * KPHGDDGHFCH, GGJPNLDIGGM: false);
		}
		MJNENAGPCGF++;
		if (MJNENAGPCGF >= OONPHPCNBJF)
		{
	...
	protected void Update()
	{
		...
		else
		{
			...
			MDKABJDCKBI(GIJMLIOJPLH + vector + new Vector3(0f, 0.3f, 0f) * KPHGDDGHFCH, GGJPNLDIGGM: true);
		}
		MJNENAGPCGF++;
		if (MJNENAGPCGF >= OONPHPCNBJF)
		{
