...
public class SquadWarEndMemberRecord : PoolableObject
{
	...
	public virtual void IDEKKBMPNKL()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.FNHIOAADLFN(MBIAKMPDOPG.id, PNDNEMDPFHC: true, CJONGDEPJHC: true, BCHINGHDGEF: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public virtual void JJFFOGIJHIH()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.IEPBDAHEKCL(MBIAKMPDOPG.id, PNDNEMDPFHC: true, CJONGDEPJHC: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public void EDKFKNGLLBM(SquadWarsContent.IAIOAHOIDOF NDPMDKGJAFH)
	{
		...
		else
		{
			...
			Singleton<PlayerTexturePool>.instance.MFKFEHJBEPA(MBIAKMPDOPG, PNDNEMDPFHC: false);
			BCMCMKDCLGP.text = MBIAKMPDOPG.name;
	...
	public virtual void CBMJBMDBOHE()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.DAGIACKCPKH(MBIAKMPDOPG.id, PNDNEMDPFHC: true, CJONGDEPJHC: false, BCHINGHDGEF: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public virtual void HFFLPBCIDOF()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.IEPBDAHEKCL(MBIAKMPDOPG.id, PNDNEMDPFHC: false, CJONGDEPJHC: true, BCHINGHDGEF: true);
		}
		MBIAKMPDOPG = null;
	}
}
