...
public class SquadEventDialog : GuiElementSingle<SquadEventDialog>, PAIIOKBBHBC
{
	...
	private void HLMPIJKDDNM()
	{
		...
		APLPHKGPKKM.gameObject.SetActive(value: false);
		JKKLBACFOJG.SetActive(value: false);
		PLIGIOJGJEA.gameObject.SetActive(value: false);
		FFBCEGEDFMD.gameObject.SetActive(value: false);
	}
	...
	private void GJPIKMPFFIB()
	{
		...
		PLIGIOJGJEA.gameObject.SetActive(value: true);
		FFBCEGEDFMD.gameObject.SetActive(value: true);
	}
	...
	{
		AGEJHBMILHO.SetActive(value: true);
		OHPOLBHAIJJ.SetActive(value: true);
	...
	public void LFBIPCBJPFK(int MOEMPHPNBLM, int PDKIAALFDNG)
	{
		...
		AGEJHBMILHO.SetActive(value: false);
		OHPOLBHAIJJ.SetActive(value: true);
	...
	{
		AOOBDPAHAIH.JEMKCLKCOMI = null;
		APLPHKGPKKM.gameObject.SetActive(value: true);
		JKKLBACFOJG.SetActive(value: true);
		PLIGIOJGJEA.gameObject.SetActive(value: true);
		FFBCEGEDFMD.gameObject.SetActive(value: false);
	}
	...
	{
		AGEJHBMILHO.SetActive(value: true);
		OHPOLBHAIJJ.SetActive(value: false);
	...
	public void ShowResult(int MOEMPHPNBLM, int PDKIAALFDNG)
	{
		...
		AAOJDLOBAJG.text = $"{MEJMLNDFDBP.GMIPFLIEOHD(MOEMPHPNBLM)}";
		Singleton<GuiManager>.instance.ShowDialog(GuiElementSingle<SquadEventDialog>.instance);
	}
