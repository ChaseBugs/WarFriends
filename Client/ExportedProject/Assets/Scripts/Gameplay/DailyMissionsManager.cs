...
public class DailyMissionsManager : DatabaseSerializedObjectGeneric<DailyMissionsManager.DailyMissionsData>
{
	...
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private List<DailyMission> _003CPKMHCOGCJGI_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private List<DailyMission> _003CCGKLFCCGLMH_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private List<DailyMission> _003CCJMPAEIMKLO_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private DailyMission _003CCEEKNMDHNAH_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private CDACJEGCGLB _003CFFGEAJCCHMJ_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private List<CDACJEGCGLB> _003CALLJADAEIMJ_003Ek__BackingField;
	...
	public static DailyMissionsManager instance
	{
		get
		{
			BJHPKLAEFCI = BJHPKLAEFCI ?? ((DailyMissionsManager)SingletonSupport.FindOrCreate(typeof(DailyMissionsManager)));
			return BJHPKLAEFCI;
		}
	}

	public int heroicMissionPlayerLevel => data.heroicMissionLevel + 1;

	public int dailyMissionPlayerLevel => data.dailyMissionLevel + 1;
	...
	public List<DailyMission> dailyMissions
	{
		...
		get
		{
			return _003CPKMHCOGCJGI_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			_003CPKMHCOGCJGI_003Ek__BackingField = value;
		}
	}

	public List<DailyMission> dailyCoopMissions
	{
		[CompilerGenerated]
		get
		{
		...
		private set
		{
			_003CCGKLFCCGLMH_003Ek__BackingField = value;
		}
	}

	public List<DailyMission> heroicMissions
	{
		[CompilerGenerated]
		get
		{
		...
		private set
		{
			_003CCJMPAEIMKLO_003Ek__BackingField = value;
		}
	}
	...
	public DailyMission currentMission
	{
		...
		set
		{
			_003CCEEKNMDHNAH_003Ek__BackingField = value;
		}
	}

	public MissionSpawningSystem spawningSystem => mSpawningSystem;

	public MissionsSettings missionsSettings => mMissionsSettings;

	public CDACJEGCGLB dailyMissionsReward
	{
		[CompilerGenerated]
		get
		{
		...
		private set
		{
			_003CFFGEAJCCHMJ_003Ek__BackingField = value;
		}
	}
	...
	public List<CDACJEGCGLB> heroicRewards
	{
		[CompilerGenerated]
		get
		{
		...
		private set
		{
			_003CALLJADAEIMJ_003Ek__BackingField = value;
		}
	}
	...
	public int heroicPointsToUnlock => (int)mMissionConstants.GetRow(MissionsConstants.rowIds.HeroicLimit).VALUE;

	public float heroicProgress => (float)data.heroicPoints / (float)heroicPointsToUnlock;

	public int timeUntilMidnight => data.tomorrow - Singleton<BeanstalkServerManager>.instance.currentTimestamp;

	public MissionsConstants missionConstants => mMissionConstants;

	public MissionsRewards missionRewards => mMissionRewards;
	...
	public void NALNMNAHFKA(string OKIIAAPDJIK, string BBHNKMIFAEP, int HLPHCDNMJLG)
	{
		...
		dailyMission.Load(missionConfig, completedInSolo: true, completedInCoop: true, (GEIKAIJBCPE)4, HLPHCDNMJLG, unitLevels: false);
	...
	private void DOAIJCNCHDD(NKMKCCDCHCL MAIPDGCABNL, DestroyableObject.CJLNCMMNPBM OHJPPHFEAFI)
	{
		...
		if (Singleton<GameController>.instance.isMission)
		{
			...
			{
				currentMission.EndMission(isWin: false);
			}
		}
	}
	...
	public void SetInviteMission(string OKIIAAPDJIK, string BBHNKMIFAEP, int HLPHCDNMJLG)
	{
		...
		DailyMission dailyMission = (DailyMission)Activator.CreateInstance(type);
		JToken missionConfig = JsonConvert.DeserializeObject<JToken>(BBHNKMIFAEP);
		dailyMission.Load(missionConfig, completedInSolo: false, completedInCoop: false, GEIKAIJBCPE.CoopClient, HLPHCDNMJLG, unitLevels: false);
	...
	private void CGJPHEEKIIN(NKMKCCDCHCL MAIPDGCABNL, DestroyableObject.CJLNCMMNPBM OHJPPHFEAFI)
	{
		...
		if (Singleton<GameController>.instance.ECHCLJJJPML())
		{
			...
			if (PhotonNetwork.isMasterClient)
			{
				DPLEEBIFDKL().EndMission(isWin: false);
			}
		}
	}
	...
	public void ELDEAAAOPJF(string OKIIAAPDJIK, string BBHNKMIFAEP, int HLPHCDNMJLG)
	{
		...
		DailyMission dailyMission = (DailyMission)Activator.CreateInstance(type);
		JToken missionConfig = JsonConvert.DeserializeObject<JToken>(BBHNKMIFAEP);
		dailyMission.Load(missionConfig, completedInSolo: true, completedInCoop: false, GEIKAIJBCPE.Heroic, HLPHCDNMJLG);
		currentMission = dailyMission;
	}
