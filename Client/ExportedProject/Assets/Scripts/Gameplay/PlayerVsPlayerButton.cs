...
public class PlayerVsPlayerButton : Core_BaseScript
{
	...
	[Header("Core")]
	[FormerlySerializedAs("POCOIPLIAEH")]
	public UIButtonSetter CJBEJLIFALJ;

	[FormerlySerializedAs("AHNAAHPFNHH")]
	public GameObject ECJHCGPGGDC;

	[FormerlySerializedAs("AFKGIEOELEF")]
	public GameObject KIPFNEOKJBB;

	[FormerlySerializedAs("AGFOKBCHNPO")]
	public UITable EMKNGHNLNIM;

	[FormerlySerializedAs("PCFFNKBGAPL")]
	public UILabel MIALHLAHHJL;

	[FormerlySerializedAs("CLPFPOBJPFH")]
	...
	[FormerlySerializedAs("DPOILNKMHMK")]
	...
	{
		TweenPosition.Begin(ALJEPHCHIIJ, JCAFFELIFAO, ALJEPHCHIIJ.transform.localPosition, ALJEPHCHIIJ.transform.localPosition.ReplaceY(535f), useLocal: false);
		TweenPosition tweenPosition = TweenPosition.Begin(DFDFBOAKFID, JCAFFELIFAO, DFDFBOAKFID.transform.localPosition, DFDFBOAKFID.transform.localPosition.ReplaceY(1951f), useLocal: false);
	...
	{
		BNPEMLKENPB.gameObject.SetActive(value: false);
		KIPFNEOKJBB.SetActive(value: true);
		DFDFBOAKFID.SetActive(value: false);
		ALJEPHCHIIJ.SetActive(value: true);
	...
	{
		TweenPosition.Begin(ALJEPHCHIIJ, JCAFFELIFAO, ALJEPHCHIIJ.transform.localPosition, ALJEPHCHIIJ.transform.localPosition.ReplaceY(3f), useLocal: false);
		TweenPosition tweenPosition = TweenPosition.Begin(DFDFBOAKFID, JCAFFELIFAO, DFDFBOAKFID.transform.localPosition, DFDFBOAKFID.transform.localPosition.ReplaceY(876f), useLocal: false);
		tweenPosition.onFinished = MOGEDCGMOPD;
	}

	public void EGBPOAIPKCF()
	{
		BNPEMLKENPB.gameObject.SetActive(value: true);
		KIPFNEOKJBB.SetActive(value: true);
		DFDFBOAKFID.SetActive(value: true);
		ALJEPHCHIIJ.SetActive(value: true);
	...
	{
		BNPEMLKENPB.gameObject.SetActive(value: false);
		KIPFNEOKJBB.SetActive(value: false);
		DFDFBOAKFID.SetActive(value: true);
		ALJEPHCHIIJ.SetActive(value: false);
	...
	private void KHEECJHDAKF()
	{
		...
		component = TweenPosition.Begin(DFDFBOAKFID, 1865f * JCAFFELIFAO, DFDFBOAKFID.transform.localPosition, DFDFBOAKFID.transform.localPosition, useLocal: false);
	...
	public void LBKKAHOOCAA(GameObject KHAHPAKDIKE)
	{
		if (TutorialManagerPlayWarcards.instance.shouldStartTutorial)
		{
			TutorialManagerPlayWarcards.instance.StartTutorial(isContinue: true);
		}
		else if (Singleton<GameController>.instance.ICINKELJCAH() || Singleton<GameController>.instance.isTutorialStage2)
		{
			Singleton<GameController>.instance.ContinueTutorialImmediately();
	...
	{
		TweenPosition.Begin(ALJEPHCHIIJ, JCAFFELIFAO, ALJEPHCHIIJ.transform.localPosition, ALJEPHCHIIJ.transform.localPosition.ReplaceY(33f), useLocal: false);
	...
	private void MCKBIFLIFHD()
	{
		...
		component = TweenPosition.Begin(DFDFBOAKFID, 1503f * JCAFFELIFAO, DFDFBOAKFID.transform.localPosition, DFDFBOAKFID.transform.localPosition, useLocal: false);
		component.onFinished = LMEBFMPALPK;
	}
	...
	{
		TweenPosition.Begin(ALJEPHCHIIJ, JCAFFELIFAO, ALJEPHCHIIJ.transform.localPosition, ALJEPHCHIIJ.transform.localPosition.ReplaceY(516f), useLocal: false);
		TweenPosition tweenPosition = TweenPosition.Begin(DFDFBOAKFID, JCAFFELIFAO, DFDFBOAKFID.transform.localPosition, DFDFBOAKFID.transform.localPosition.ReplaceY(1649f), useLocal: false);
	...
	private void NPMHANDOCLA()
	{
		...
		component = TweenPosition.Begin(DFDFBOAKFID, 1020f * JCAFFELIFAO, DFDFBOAKFID.transform.localPosition, DFDFBOAKFID.transform.localPosition, useLocal: false);
		component.onFinished = delegate
		{
			FCMLDGPJHOG();
		};
	...
	private void BOHINJAKEIO()
	{
		...
		component = TweenPosition.Begin(DFDFBOAKFID, 1828f * JCAFFELIFAO, DFDFBOAKFID.transform.localPosition, DFDFBOAKFID.transform.localPosition, useLocal: false);
	...
	private void PEEKPMAOFFH()
	{
		...
		component = TweenPosition.Begin(DFDFBOAKFID, 1930f * JCAFFELIFAO, DFDFBOAKFID.transform.localPosition, DFDFBOAKFID.transform.localPosition, useLocal: false);
