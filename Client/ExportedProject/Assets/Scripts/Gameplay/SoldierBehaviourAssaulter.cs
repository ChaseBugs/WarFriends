...
public class SoldierBehaviourAssaulter : SoldierBehaviourGeneric<SoldierBehaviourDefinititonBasicSoldier>
{
	...
	protected virtual void IODGCIIDJEK()
	{
		...
		{
			item.HealSoldier(LMNPOINIJBD.destroyableObj.maxHealth * base.soldierBehaviourDefinititon.special, CAKABHIPCDF: true);
		}
	...
	protected override void Update()
	{
		...
		foreach (DestroyableObject item in list)
		{
			item.HealSoldier(LMNPOINIJBD.destroyableObj.maxHealth * base.soldierBehaviourDefinititon.special, CAKABHIPCDF: false);
		}
