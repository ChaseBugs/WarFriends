...
public class GameCamera : Singleton<GameCamera>
{
	private sealed class CDKNAFJNELJ : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool FPMHODJKAKK()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND = TweenPosition.Begin(BJGCPDNMHDH.gameObject, KBJEOEEOEFG, IJOFKOKMJJH, BJGCPDNMHDH.NGCDDPCAGJB.position, useLocal: false);
	...
	private sealed class PGGPOFLKAGC : IEnumerator, IDisposable, IEnumerator<object>
	{
		private sealed class OMDOIAFEAKI
		{
			...
			internal void EMKPBGFBPFI(UITweener MGDJMGHCAAI)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(AIHDNGDNDHH.BJGCPDNMHDH.gameObject, PNAICLCIHKB, AIHDNGDNDHH.BJGCPDNMHDH.transform.position, toPos, useLocal: false);
		...
		public bool FADACBKMFGG()
		{
			...
			case 0u:
				...
				Singleton<PerformanceManager>.instance.AGMMGEJNAMD(FIKGLFBFBON: true);
				BJGCPDNMHDH.HLLODJKPDPK();
				Time.timeScale = 907f;
		...
		public bool PMBOHHPPJAC()
		{
			...
			case 0u:
				KFCAECGLKKO = new OMDOIAFEAKI();
				KFCAECGLKKO.AIHDNGDNDHH = this;
				Singleton<PerformanceManager>.instance.CLABLOFKMGA(FIKGLFBFBON: true);
				BJGCPDNMHDH.Enable();
				Time.timeScale = 567f;
				BJGCPDNMHDH.BFOLCPKOJIJ = false;
				BJGCPDNMHDH.ECPHFACGEIE.enabled = false;
			...
			case 2u:
			{
				...
				AJOCDHFNLND = TweenPosition.Begin(BJGCPDNMHDH.gameObject, KFCAECGLKKO.PNAICLCIHKB, BJGCPDNMHDH.transform.position, ONGOEJMKLJC, useLocal: false);
			...
			case 3u:
				...
				Singleton<PerformanceManager>.instance.AGMMGEJNAMD(FIKGLFBFBON: false);
				BJGCPDNMHDH.ECPHFACGEIE.enabled = true;
				FGMEIEBKNEK.PCDHJCEAHBD();
				CLPPIAGLCJJ = -1;
				goto default;
		...
		public bool BIGKCFMEBJE()
		{
			...
			case 0u:
				KFCAECGLKKO = new OMDOIAFEAKI();
				KFCAECGLKKO.AIHDNGDNDHH = this;
				Singleton<PerformanceManager>.instance.AKNADEPIPNP(FIKGLFBFBON: true);
				BJGCPDNMHDH.HLLODJKPDPK();
		...
		public bool PMJICFJGOBE()
		{
			...
			case 0u:
				KFCAECGLKKO = new OMDOIAFEAKI();
				KFCAECGLKKO.AIHDNGDNDHH = this;
				Singleton<PerformanceManager>.instance.LCOIHOCJGLF(FIKGLFBFBON: true);
				BJGCPDNMHDH.Enable();
				Time.timeScale = 530f;
				BJGCPDNMHDH.BFOLCPKOJIJ = false;
				BJGCPDNMHDH.ECPHFACGEIE.enabled = false;
			...
			case 1u:
			{
				...
				KFCAECGLKKO.NGPMJNJPNMB.z = FGMEIEBKNEK.ECMEFIJPCCG(PlayerController.OGMBJPKOPCB).z;
				KFCAECGLKKO.FNMHOPJFDOH = true;
				AJOCDHFNLND = TweenPosition.Begin(BJGCPDNMHDH.gameObject, KFCAECGLKKO.PNAICLCIHKB, KFCAECGLKKO.JGBFNKBFCKM, KFCAECGLKKO.NGPMJNJPNMB, useLocal: false);
				AJOCDHFNLND.method = UITweener.Method.Linear;
				TweenRotation.Begin(BJGCPDNMHDH.gameObject, KFCAECGLKKO.PNAICLCIHKB, NGAGLEOMOJO, CHDINDNHOPN);
				TweenPosition aJOCDHFNLND = AJOCDHFNLND;
		...
		public bool MKLIDMNLNPN()
		{
			...
			case 0u:
				KFCAECGLKKO = new OMDOIAFEAKI();
				KFCAECGLKKO.AIHDNGDNDHH = this;
				Singleton<PerformanceManager>.instance.MBIALLFNEFO(FIKGLFBFBON: true);
				BJGCPDNMHDH.Enable();
		...
		public bool PMCFLKAJNHO()
		{
			...
			case 0u:
				KFCAECGLKKO = new OMDOIAFEAKI();
				KFCAECGLKKO.AIHDNGDNDHH = this;
				Singleton<PerformanceManager>.instance.FDFJMPCABLN(FIKGLFBFBON: true);
				BJGCPDNMHDH.Enable();
				Time.timeScale = 698f;
				BJGCPDNMHDH.BFOLCPKOJIJ = true;
				BJGCPDNMHDH.ECPHFACGEIE.enabled = true;
	...
	private sealed class ILPLKEMPGIH : IEnumerator, IDisposable, IEnumerator<object>
	{
		private sealed class ADGFNJOKCEJ
		{
			...
			internal void POGLHCIAAGH(UITweener MGDJMGHCAAI)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(ALIKEGIJIHD.BJGCPDNMHDH.gameObject, 1109f, ALIKEGIJIHD.BJGCPDNMHDH.transform.position, toPos, useLocal: false);
			...
			internal void JEDCBCPMJGI(UITweener MGDJMGHCAAI)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(ALIKEGIJIHD.BJGCPDNMHDH.gameObject, 1025f, ALIKEGIJIHD.BJGCPDNMHDH.transform.position, toPos, useLocal: false);
			...
			internal void NDJOJHNIBFC(UITweener MGDJMGHCAAI)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(ALIKEGIJIHD.BJGCPDNMHDH.gameObject, 1094f, ALIKEGIJIHD.BJGCPDNMHDH.transform.position, toPos, useLocal: false);
			...
			internal void POGDLLFCOKO(UITweener MGDJMGHCAAI)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(ALIKEGIJIHD.BJGCPDNMHDH.gameObject, 177f, ALIKEGIJIHD.BJGCPDNMHDH.transform.position, toPos, useLocal: false);
			...
			internal void LJCDGJKCNEC(UITweener MGDJMGHCAAI)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(ALIKEGIJIHD.BJGCPDNMHDH.gameObject, 15f, ALIKEGIJIHD.BJGCPDNMHDH.transform.position, toPos, useLocal: false);
			...
			internal void AGFEDJAKLAC(UITweener MGDJMGHCAAI)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(ALIKEGIJIHD.BJGCPDNMHDH.gameObject, 808f, ALIKEGIJIHD.BJGCPDNMHDH.transform.position, toPos, useLocal: false);
			...
			internal void KPHEPHDFCKK(UITweener MGDJMGHCAAI)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(ALIKEGIJIHD.BJGCPDNMHDH.gameObject, 1446f, ALIKEGIJIHD.BJGCPDNMHDH.transform.position, toPos, useLocal: false);
			...
			internal void KIACGAKNBLD(UITweener MGDJMGHCAAI)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(ALIKEGIJIHD.BJGCPDNMHDH.gameObject, 830f, ALIKEGIJIHD.BJGCPDNMHDH.transform.position, toPos, useLocal: false);
			...
			internal void OFJDLANHAMD(UITweener MGDJMGHCAAI)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(ALIKEGIJIHD.BJGCPDNMHDH.gameObject, 1104f, ALIKEGIJIHD.BJGCPDNMHDH.transform.position, toPos, useLocal: false);
			...
			internal void NAJNECOMDDN(UITweener MGDJMGHCAAI)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(ALIKEGIJIHD.BJGCPDNMHDH.gameObject, 1926f, ALIKEGIJIHD.BJGCPDNMHDH.transform.position, toPos, useLocal: false);
			...
			internal void FIBGJHCGHJH(UITweener MGDJMGHCAAI)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(ALIKEGIJIHD.BJGCPDNMHDH.gameObject, 1312f, ALIKEGIJIHD.BJGCPDNMHDH.transform.position, toPos, useLocal: false);
		...
		public bool PMBOHHPPJAC()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND.method = UITweener.Method.EaseIn;
				TweenPosition.Begin(BJGCPDNMHDH.gameObject, OAGNKGDKODI, BJGCPDNMHDH.transform.position, KFCAECGLKKO.NNIFEFPIPAN, useLocal: false).delay = 767f;
		...
		public bool CCOPPEKLJOB()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND = TweenRotation.Begin(BJGCPDNMHDH.gameObject, OAGNKGDKODI, Quaternion.LookRotation(PJKJEGDNCOM - KFCAECGLKKO.NNIFEFPIPAN), useAbsolute: true);
		...
		public bool CCDJGNJGPDM()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND.method = UITweener.Method.Linear;
				TweenPosition.Begin(BJGCPDNMHDH.gameObject, OAGNKGDKODI, BJGCPDNMHDH.transform.position, KFCAECGLKKO.NNIFEFPIPAN, useLocal: false).delay = 594f;
				TweenRotation aJOCDHFNLND = AJOCDHFNLND;
				aJOCDHFNLND.onFinished = (UITweener.OnFinished)Delegate.Combine(aJOCDHFNLND.onFinished, new UITweener.OnFinished(KFCAECGLKKO.MFCNOIDCJME));
				goto case 1u;
			}
		...
		public bool MKCOLOBIAAP()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND.method = UITweener.Method.Linear;
				TweenPosition.Begin(BJGCPDNMHDH.gameObject, OAGNKGDKODI, BJGCPDNMHDH.transform.position, KFCAECGLKKO.NNIFEFPIPAN, useLocal: false).delay = 518f;
				TweenRotation aJOCDHFNLND = AJOCDHFNLND;
				aJOCDHFNLND.onFinished = (UITweener.OnFinished)Delegate.Combine(aJOCDHFNLND.onFinished, new UITweener.OnFinished(KFCAECGLKKO.OFJDLANHAMD));
				goto case 1u;
			}
		...
		public bool KIFNNJFJJCG()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND.method = UITweener.Method.Linear;
				TweenPosition.Begin(BJGCPDNMHDH.gameObject, OAGNKGDKODI, BJGCPDNMHDH.transform.position, KFCAECGLKKO.NNIFEFPIPAN, useLocal: false).delay = 1316f;
				TweenRotation aJOCDHFNLND = AJOCDHFNLND;
		...
		public bool ANIKAJEKMPM()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND.method = UITweener.Method.Linear;
				TweenPosition.Begin(BJGCPDNMHDH.gameObject, OAGNKGDKODI, BJGCPDNMHDH.transform.position, KFCAECGLKKO.NNIFEFPIPAN, useLocal: false).delay = 1418f;
				TweenRotation aJOCDHFNLND = AJOCDHFNLND;
				aJOCDHFNLND.onFinished = (UITweener.OnFinished)Delegate.Combine(aJOCDHFNLND.onFinished, new UITweener.OnFinished(KFCAECGLKKO.EOHOLKEGGLH));
				goto case 1u;
			}
		...
		public bool DNDHHHDOLMO()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND.method = UITweener.Method.Linear;
				TweenPosition.Begin(BJGCPDNMHDH.gameObject, OAGNKGDKODI, BJGCPDNMHDH.transform.position, KFCAECGLKKO.NNIFEFPIPAN, useLocal: false).delay = 330f;
				TweenRotation aJOCDHFNLND = AJOCDHFNLND;
				aJOCDHFNLND.onFinished = (UITweener.OnFinished)Delegate.Combine(aJOCDHFNLND.onFinished, new UITweener.OnFinished(KFCAECGLKKO.FIBGJHCGHJH));
				goto case 1u;
			}
		...
		public bool FNIOOIGJPAM()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND.method = UITweener.Method.EaseIn;
				TweenPosition.Begin(BJGCPDNMHDH.gameObject, OAGNKGDKODI, BJGCPDNMHDH.transform.position, KFCAECGLKKO.NNIFEFPIPAN, useLocal: false).delay = 157f;
				TweenRotation aJOCDHFNLND = AJOCDHFNLND;
		...
		public bool KBPKMAKLNPB()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND.method = UITweener.Method.Linear;
				TweenPosition.Begin(BJGCPDNMHDH.gameObject, OAGNKGDKODI, BJGCPDNMHDH.transform.position, KFCAECGLKKO.NNIFEFPIPAN, useLocal: false).delay = 881f;
				TweenRotation aJOCDHFNLND = AJOCDHFNLND;
				aJOCDHFNLND.onFinished = (UITweener.OnFinished)Delegate.Combine(aJOCDHFNLND.onFinished, new UITweener.OnFinished(KFCAECGLKKO.NDJOJHNIBFC));
				goto case 1u;
			}
		...
		public bool MoveNext()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND.method = UITweener.Method.EaseIn;
				TweenPosition.Begin(BJGCPDNMHDH.gameObject, OAGNKGDKODI, BJGCPDNMHDH.transform.position, KFCAECGLKKO.NNIFEFPIPAN, useLocal: false).delay = 0f;
				TweenRotation aJOCDHFNLND = AJOCDHFNLND;
				aJOCDHFNLND.onFinished = (UITweener.OnFinished)Delegate.Combine(aJOCDHFNLND.onFinished, new UITweener.OnFinished(KFCAECGLKKO.LJCDGJKCNEC));
				goto case 1u;
			}
		...
		public bool LGLPPAENMGK()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND.method = UITweener.Method.EaseIn;
				TweenPosition.Begin(BJGCPDNMHDH.gameObject, OAGNKGDKODI, BJGCPDNMHDH.transform.position, KFCAECGLKKO.NNIFEFPIPAN, useLocal: false).delay = 35f;
				TweenRotation aJOCDHFNLND = AJOCDHFNLND;
				aJOCDHFNLND.onFinished = (UITweener.OnFinished)Delegate.Combine(aJOCDHFNLND.onFinished, new UITweener.OnFinished(KFCAECGLKKO.FDKEAJLEMCM));
				goto case 1u;
			}
		...
		public bool MHCIOCPGMHF()
		{
			...
			case 0u:
			{
				...
				AJOCDHFNLND.method = UITweener.Method.EaseIn;
				TweenPosition.Begin(BJGCPDNMHDH.gameObject, OAGNKGDKODI, BJGCPDNMHDH.transform.position, KFCAECGLKKO.NNIFEFPIPAN, useLocal: false).delay = 1230f;
				TweenRotation aJOCDHFNLND = AJOCDHFNLND;
				aJOCDHFNLND.onFinished = (UITweener.OnFinished)Delegate.Combine(aJOCDHFNLND.onFinished, new UITweener.OnFinished(KFCAECGLKKO.FDKEAJLEMCM));
				goto case 1u;
			}
		...
		public bool MoveNext()
		{
			...
			case 3u:
				if (GFMHPOJAKKK < BJGCPDNMHDH.FFBCLAAGOEK)
				{
					...
					{
						UnityEngine.Debug.LogWarning($"Look vector is small! .. phase: {COOGKNIEOPA} target: {PJKJEGDNCOM} transform.position: {BJGCPDNMHDH.transform.position} playerPosition: {NJEEECDEAAP} upPosition: {LDOPAMLMIEM} cameraLeanPhase: {EGPAJKLILCP} rotatedLookVector: {DBBPNFBMCKG}");
					}
					else if (PJKJEGDNCOM.x == BJGCPDNMHDH.transform.position.x && PJKJEGDNCOM.z == BJGCPDNMHDH.transform.position.z)
					{
						UnityEngine.Debug.LogWarning($"Look vector error! .. phase: {COOGKNIEOPA} target: {PJKJEGDNCOM} transform.position: {BJGCPDNMHDH.transform.position} playerPosition: {NJEEECDEAAP} upPosition: {LDOPAMLMIEM} cameraLeanPhase: {EGPAJKLILCP} rotatedLookVector: {DBBPNFBMCKG}");
					}
					else
					{
		...
		public bool MoveNext()
		{
			...
			case 3u:
				if (GFMHPOJAKKK < Mathf.Min(BJGCPDNMHDH.FFBCLAAGOEK, BJGCPDNMHDH.GDCIBDACJDL))
				{
					...
					if ((PJKJEGDNCOM.AddY(BJGCPDNMHDH.APHOIGGJEJH) - BJGCPDNMHDH.transform.position).magnitude < 0.0001f)
					{
						UnityEngine.Debug.LogWarning($"Look vector is small! .. phase: {COOGKNIEOPA} target: {PJKJEGDNCOM} transform.position: {BJGCPDNMHDH.transform.position} playerPosition: {CEPFACIMILH} upPosition: {LDOPAMLMIEM} rotatedLookVector: {DBBPNFBMCKG}");
					}
					else if (PJKJEGDNCOM.x == BJGCPDNMHDH.transform.position.x && PJKJEGDNCOM.z == BJGCPDNMHDH.transform.position.z)
					{
						UnityEngine.Debug.LogWarning($"Look vector error! .. phase: {COOGKNIEOPA} target: {PJKJEGDNCOM} transform.position: {BJGCPDNMHDH.transform.position} playerPosition: {CEPFACIMILH} upPosition: {LDOPAMLMIEM} rotatedLookVector: {DBBPNFBMCKG}");
					}
					else
					{
						BJGCPDNMHDH.transform.rotation = Quaternion.Lerp(Quaternion.LookRotation(CEPFACIMILH.AddY(BJGCPDNMHDH.APHOIGGJEJH) - BJGCPDNMHDH.transform.position), Quaternion.LookRotation(PJKJEGDNCOM.AddY(BJGCPDNMHDH.APHOIGGJEJH) - BJGCPDNMHDH.transform.position), LILCFFODCCL);
	...
	[FormerlySerializedAs("MJMOBOCCKIG")]
	public GameObject FKFDNNPBOFI;

	[FormerlySerializedAs("GDDLNFEDPHF")]
	...
	[FormerlySerializedAs("KDPJAGGIIFH")]
	public float NBAAPLMCCJJ = 0.5f;

	[FormerlySerializedAs("EKCDJMLMAFO")]
	public float BGHBLOIHDOB = 0.8f;

	[FormerlySerializedAs("NGEAAFJLNDH")]
	public float JLHFPANIKPO = 0.5f;

	[FormerlySerializedAs("EGDMOKDHHNL")]
	...
	[FormerlySerializedAs("HCHBNHMPAIP")]
	public float DBKEIAILHKD;

	[FormerlySerializedAs("KENOCHBLNPN")]
	public List<Vector3> GDAFLEDIOJP;

	[FormerlySerializedAs("NJJMGPLCCOK")]
	public List<Quaternion> JPMGIHOPPCH;

	[FormerlySerializedAs("NCBPCDDOGCB")]
	public float BHANGOBFOHH = 4f;

	[FormerlySerializedAs("DNKGMJDCGDD")]
	public float BJIPJGFPIAJ = 4f;

	[FormerlySerializedAs("BJFEOOFJLFP")]
	public float MOMGGEKOBDC = 2f;

	private readonly List<Vector3> LCIECDBFPFF = new List<Vector3>();

	[Header("Focus Enemy Animation")]
	[FormerlySerializedAs("EPLHELDOEEH")]
	public float EHFLEBJNBLN = 1f;

	[FormerlySerializedAs("HKNFHCOAAJE")]
	public float LINAKKNHIMN = 2f;

	[FormerlySerializedAs("OJLNFDFJGDB")]
	public float LAEADIDHNGP = 0.3f;

	[FormerlySerializedAs("GGABANDMNDP")]
	public float FCJAGHDNONI = 0.2f;

	[FormerlySerializedAs("PAECNPOGBFL")]
	public float DMOJKNBFAIG = 0.2f;

	[FormerlySerializedAs("NKIJBOJIKDH")]
	public float ECFEPPBGAIO = 70f;

	[FormerlySerializedAs("FGEHLAJCPFL")]
	public float LNIPMGOFEJN = 0.5f;

	[FormerlySerializedAs("FKKBLPJGPDJ")]
	public Vector2 AMMELLKBLID = new Vector2(1f, 0.25f);

	[FormerlySerializedAs("GICLJMCKPCG")]
	public float APHOIGGJEJH = 0.35f;

	[FormerlySerializedAs("EFFNJFBGOAL")]
	public float NGLBIAMOBHF = 0.2f;

	[FormerlySerializedAs("HANHPIMCONJ")]
	public float MKBOFBPMAKK = 10f;

	[FormerlySerializedAs("NGGMIOIBANL")]
	public AnimationCurve CMGCJMNLCPB;

	[FormerlySerializedAs("FEOHILJFOPL")]
	public AnimationCurve OPBPBKGFLLO;

	[FormerlySerializedAs("CFJIEKJDMEI")]
	public float HNGMFABKLKF = 1f;

	[FormerlySerializedAs("HNJLEKGGNPJ")]
	public float FFBCLAAGOEK = 8f;

	[FormerlySerializedAs("EJCNLNGAABH")]
	public float JCAOCHMKFOI = 1f;

	[FormerlySerializedAs("NGACCAMCCBJ")]
	public AnimationCurve BLCBHCPDOLO;

	[FormerlySerializedAs("GLPIKMKLPLG")]
	public AnimationCurve NDNCOKHKKFM;

	[FormerlySerializedAs("KACFNNKLJPG")]
	public AnimationCurve FJGHEKIIIJJ;

	[FormerlySerializedAs("CNFAPDJMKMC")]
	public float GDCIBDACJDL = 4f;

	[FormerlySerializedAs("AEJDABDHHFO")]
	...
	public new Camera camera
	{
		get
		{
			if (GNICEGBOGOL == null)
			{
				GNICEGBOGOL = (Camera)SingletonSupport.FirstOrDefault((UnityEngine.Object[])GetComponentsInChildren<Camera>(includeInactive: true));
			}
			return GNICEGBOGOL;
		}
	}

	private float PNKCLMJBMNI => (!ScreenManager.isSmallScreen) ? 52 : 34;
	...
	{
		MMICNPGHHEM = true;
		FKFDNNPBOFI.gameObject.SetActive(value: false);
	...
	private void OEACJGJDHBB()
	{
		...
		float nearestPoint = cameraPath.GetNearestPoint(position, ignoreNormalisation: false);
	...
	public void HLLODJKPDPK()
	{
		...
		FKFDNNPBOFI.gameObject.SetActive(value: true);
	}
	...
	public void MEKHLFKJEKD()
	{
		...
		TweenRotation tweenRotation = TweenRotation.Begin(base.gameObject, num * 1102f, AEEFNAGJNMN, useAbsolute: true);
		TweenPosition.Begin(base.gameObject, num, base.transform.position, AGPLEANDGFF, useLocal: false);
	...
	protected override void Awake()
	{
		...
		PDLJPAKACDM = new BKKKEBHEFPI(NGCDDPCAGJB, BKKKEBHEFPI.NBAOBLLJBEF.PositionAdditive, FJGOHNANGMN: false)
		{
		...
		DNPJGODEPON = new BKKKEBHEFPI(NGCDDPCAGJB, BKKKEBHEFPI.NBAOBLLJBEF.PositionAdditive, FJGOHNANGMN: false)
		{
	...
	public Camera JLJAJAMJJJM()
	{
		if (GNICEGBOGOL == null)
		{
			GNICEGBOGOL = GetComponentsInChildren<Camera>(includeInactive: false)[1];
		}
		return GNICEGBOGOL;
	}
	...
	public void PFBCLMECEHL(PlayerController KHLGDCHJJPB)
	{
		...
		TweenRotation tweenRotation = TweenRotation.Begin(base.gameObject, num * 1503f, Quaternion.LookRotation(vector2 - vector), useAbsolute: true);
	...
	public Camera LBBFBJMLEJB()
	{
		if (GNICEGBOGOL == null)
		{
			GNICEGBOGOL = (Camera)SingletonSupport.FirstOrDefault((UnityEngine.Object[])GetComponentsInChildren<Camera>(includeInactive: false));
		}
		return GNICEGBOGOL;
	}
	...
	public void KPOCOCMEJLC(PlayerController KHLGDCHJJPB)
	{
		...
		TweenRotation tweenRotation = TweenRotation.Begin(base.gameObject, num * 805f, Quaternion.LookRotation(vector2 - vector), useAbsolute: true);
	...
	public void PGOKOPPJINA()
	{
		float num = 1654f;
		TweenFOV.Begin(base.gameObject, num, PNKCLMJBMNI);
		TweenRotation tweenRotation = TweenRotation.Begin(base.gameObject, num * 426f, AEEFNAGJNMN, useAbsolute: true);
	...
	public void JKJNLCILLPC()
	{
		float num = 172f;
		TweenFOV.Begin(base.gameObject, num, PKFIMNPJMPK());
		TweenRotation tweenRotation = TweenRotation.Begin(base.gameObject, num * 554f, AEEFNAGJNMN, useAbsolute: true);
		TweenPosition.Begin(base.gameObject, num, base.transform.position, AGPLEANDGFF);
		tweenRotation.onFinished = (UITweener.OnFinished)Delegate.Combine(tweenRotation.onFinished, (UITweener.OnFinished)delegate
		{
			ECPHFACGEIE.enabled = true;
