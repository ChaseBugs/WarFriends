...
{
	public override string name => Localization.Localize("ID_FEATURE_CRITICAL");

	public override string fancyName => Localization.Localize("ID_FEATURE_CRITICAL-FANCY");

	public override string icon => "menu-weaponstats-criticalchance";

	public override string description => Localization.Localize("ID_FEATURE_CRITICAL-DESCRIPTION");

	public override string statisticIncrease => MEJMLNDFDBP.DPAFFLMAFJG(base.value);

	public override string weaponPrefix => Localization.Localize("ID_FEATURE_CRITICAL-WEAPONPREFIX");

	public override float criticalCoef => 1f + (float)base.value;
