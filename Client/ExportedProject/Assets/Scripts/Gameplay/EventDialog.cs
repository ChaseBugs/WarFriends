...
public class EventDialog : GuiElementSingle<EventDialog>, PAIIOKBBHBC
{
	private sealed class FLCNNIBJNDM : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool HNCDLFFBMAA()
		{
			...
			case 0u:
				...
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(Singleton<ArmyPreviewCamera>.instance.BOKMFOEFHAP(HAGGALMAHKP, PNDNEMDPFHC: false, PlayerTexturePool.DFJJOANIJID.Card));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
				return false;
			case 1u:
				BJGCPDNMHDH.mPlayerVisual.gameObject.SetActive(value: false);
		...
		public bool OGLKGILLKIO()
		{
			...
			case 0u:
				HAGGALMAHKP = new DatabasePlayer();
				HAGGALMAHKP.playerVisuals = NNOFPAGLFMM.BHGDDCDEJJA;
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(Singleton<ArmyPreviewCamera>.instance.BOKMFOEFHAP(HAGGALMAHKP, PNDNEMDPFHC: true, PlayerTexturePool.DFJJOANIJID.Card));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
				return false;
			case 1u:
				BJGCPDNMHDH.mPlayerVisual.gameObject.SetActive(value: true);
		...
		public bool CONJMMKAAGH()
		{
			...
			case 0u:
				HAGGALMAHKP = new DatabasePlayer();
				HAGGALMAHKP.playerVisuals = NNOFPAGLFMM.BHGDDCDEJJA;
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(Singleton<ArmyPreviewCamera>.instance.CAEHLCHOPMO(HAGGALMAHKP, PNDNEMDPFHC: false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool LPMIKEPIMCM()
		{
			...
			case 0u:
				HAGGALMAHKP = new DatabasePlayer();
				HAGGALMAHKP.playerVisuals = NNOFPAGLFMM.BHGDDCDEJJA;
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(Singleton<ArmyPreviewCamera>.instance.CreateHiresPlayerTexture(HAGGALMAHKP, PNDNEMDPFHC: false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool KHNDCDGBFJH()
		{
			...
			case 0u:
				HAGGALMAHKP = new DatabasePlayer();
				HAGGALMAHKP.playerVisuals = NNOFPAGLFMM.BHGDDCDEJJA;
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(Singleton<ArmyPreviewCamera>.instance.CAEHLCHOPMO(HAGGALMAHKP, PNDNEMDPFHC: true, PlayerTexturePool.DFJJOANIJID.Card));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool PMJICFJGOBE()
		{
			...
			case 0u:
				HAGGALMAHKP = new DatabasePlayer();
				HAGGALMAHKP.playerVisuals = NNOFPAGLFMM.BHGDDCDEJJA;
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(Singleton<ArmyPreviewCamera>.instance.CAEHLCHOPMO(HAGGALMAHKP, PNDNEMDPFHC: false, PlayerTexturePool.DFJJOANIJID.Card));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
	...
	[SerializeField]
	[FormerlySerializedAs("mHeaderDay")]
	...
	public GameObject endEventPointsAnimationObject => mProgressEvent.FGLAMAFNPFO.gameObject;
	...
	public override void InitGUIValues()
	{
		...
		mPlayerVisual.Reset();
		mPlayerVisual.gameObject.SetActive(value: false);
	...
	public virtual void KLABPENJAHJ()
	{
		...
		mPlayerVisual.gameObject.SetActive(value: true);
		StartCoroutine(GHDHBPDGONH());
		if (NNOFPAGLFMM.ILDBNBEPBLI)
		{
			mParticleFallingSnow.Play();
