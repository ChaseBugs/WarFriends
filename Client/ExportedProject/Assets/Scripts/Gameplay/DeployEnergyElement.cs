...
{
	[FormerlySerializedAs("DGBDNGADEBH")]
	[Header("Core")]
	public UISprite NPJPLGDNLLB;

	[FormerlySerializedAs("DDCAMPODKED")]
	public UILabel HEBKHNHHGGC;

	[FormerlySerializedAs("CGLBNJOPANA")]
	public UISprite FHJOHLKIPID;

	[FormerlySerializedAs("BBFEBJBGNND")]
	public UILabel NGKPNAMDKNJ;

	[FormerlySerializedAs("JMAPELOAIBP")]
	...
	private int MAGBOFCGLJN => 2 * (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.MaxEnergy).FLOATVALUE;
	...
	private void LELGJOPKOIL()
	{
		...
		if (TutorialManagerStage1.instance.isTutorialRunning)
		{
			...
			PABFCMGCIAI.gameObject.SetActive(value: false);
			return;
		}
		PABFCMGCIAI.gameObject.SetActive(value: false);
	...
	private void BJJEKIBIOFE()
	{
		...
		if (TutorialManagerStage1.instance.isTutorialRunning)
		{
			...
			PABFCMGCIAI.gameObject.SetActive(value: true);
			return;
		}
		PABFCMGCIAI.gameObject.SetActive(value: false);
		string text2 = MEJMLNDFDBP.GMIPFLIEOHD(EGEJOIAKMAE);
