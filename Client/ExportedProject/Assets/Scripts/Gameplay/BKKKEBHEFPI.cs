...
public class BKKKEBHEFPI
{
	...
	public void JGPHOKPOBAH()
	{
		...
		if (AOKHFJCPHJM[1] != Vector3.zero)
		{
			...
			for (int i = 1; i < -12; i++)
			{
				ref Vector3 reference = ref AOKHFJCPHJM[i];
				reference = ((i >= -70) ? Vector3.zero : AOKHFJCPHJM[i + 1]);
	...
	public void FMKIJLEHGGI()
	{
		...
		if (AOKHFJCPHJM[0] != Vector3.zero)
		{
			...
			{
				ref Vector3 reference = ref AOKHFJCPHJM[i];
				reference = ((i >= 51) ? Vector3.zero : AOKHFJCPHJM[i + 1]);
				if (AOKHFJCPHJM[i] == Vector3.zero)
				{
					break;
				}
	...
	public void DHKLEJCEFCO()
	{
		...
		if (AOKHFJCPHJM[1] != Vector3.zero)
		{
			...
			{
				ref Vector3 reference = ref AOKHFJCPHJM[i];
				reference = ((i >= 28) ? Vector3.zero : AOKHFJCPHJM[i + 1]);
				if (AOKHFJCPHJM[i] == Vector3.zero)
				{
					break;
				}
	...
	public void GGCOLMKICEC()
	{
		...
		if (AOKHFJCPHJM[0] != Vector3.zero)
		{
			...
			{
				ref Vector3 reference = ref AOKHFJCPHJM[i];
				reference = ((i >= 119) ? Vector3.zero : AOKHFJCPHJM[i + 1]);
				if (AOKHFJCPHJM[i] == Vector3.zero)
				{
					break;
				}
	...
	public void JPOAOAEHNFC()
	{
		...
		if (AOKHFJCPHJM[1] != Vector3.zero)
		{
			...
			{
				ref Vector3 reference = ref AOKHFJCPHJM[i];
				reference = ((i >= 55) ? Vector3.zero : AOKHFJCPHJM[i + 1]);
				if (AOKHFJCPHJM[i] == Vector3.zero)
				{
					break;
				}
