...
public class LeftGoldenSuitcase : Core_BaseScript
{
	...
	[FormerlySerializedAs("PALKMHMLDNK")]
	public GameObject HPKOHODOPMH;

	[FormerlySerializedAs("PHOAJBPDMHK")]
	...
	[FormerlySerializedAs("APEOMLKPFBH")]
	public UILabel PIGCPLONEIC;

	[FormerlySerializedAs("KFGJBPFPAAB")]
	...
	[FormerlySerializedAs("PEOKCCIPFEL")]
	...
	private void GBNNEKKMFMJ()
	{
		...
		NEPIMKJAFGP.text = MEJMLNDFDBP.CJCFPDLDMEK(num, "com.tune.TuneDebugUtilities", "NextBuddyDeposit", IEJMLKBCDJB: false);
	...
	private void CDCJKDJDEEF()
	{
		...
		NEPIMKJAFGP.text = MEJMLNDFDBP.CJCFPDLDMEK(num, "LeagueEvaluation", "subscription1", IEJMLKBCDJB: false);
