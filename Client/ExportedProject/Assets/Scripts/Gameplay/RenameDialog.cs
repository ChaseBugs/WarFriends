...
{
	[Header("Core")]
	[FormerlySerializedAs("ANAFOAOENII")]
	...
	[FormerlySerializedAs("AAIKHAPCOKL")]
	public UIButton EJNLELFGBJE;

	[FormerlySerializedAs("ICNHNCPKGAE")]
	public UILabel FCOPKOJILNB;

	[FormerlySerializedAs("KEHCBOIGJFJ")]
	public GameObject DICPLMJFBJF;

	[FormerlySerializedAs("GHLGLJEEAJC")]
	public UITable KPJAHKLCDBB;

	[FormerlySerializedAs("FIBAGFPPDPA")]
	...
	private void DIAKILDNOOM(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.instance.data.isDeviceRegistered)
		{
			...
			Singleton<BeanstalkServerManager>.instance.DIMIGOPEBLA(KAIAJMCHLLD.text, HNLJDNFOCOM: true);
		}
		HideDialog();
	}
	...
	public virtual void HMHGKOPGCDK()
	{
		...
		KAIAJMCHLLD.mKeyboard = TouchScreenKeyboard.Open(KAIAJMCHLLD.text, TouchScreenKeyboardType.Default, autocorrection: false, multiline: false, secure: false);
	}
	...
	public virtual void JIODMKHANMM()
	{
		...
		string text = KAIAJMCHLLD.text;
		KAIAJMCHLLD.selected = false;
		KAIAJMCHLLD.mKeyboard = TouchScreenKeyboard.Open(KAIAJMCHLLD.text, TouchScreenKeyboardType.ASCIICapable, autocorrection: true, multiline: false, secure: false);
	}
	...
	private void BMJKJLEJAIC(GameObject KHAHPAKDIKE)
	{
		...
		if (GameLoginManager.instance.data.isDeviceRegistered)
		{
			...
			Singleton<BeanstalkServerManager>.instance.ChangePlayerName(KAIAJMCHLLD.text, HNLJDNFOCOM: true);
		}
		HideDialog();
	}
	...
	public virtual void JBHLDCBCNFI()
	{
		...
		KAIAJMCHLLD.mKeyboard = TouchScreenKeyboard.Open(KAIAJMCHLLD.text, TouchScreenKeyboardType.ASCIICapable, autocorrection: false, multiline: false, secure: false);
	}
	...
	public virtual void KFJBNAMKENC()
	{
		...
		string text = KAIAJMCHLLD.text;
		KAIAJMCHLLD.selected = true;
		KAIAJMCHLLD.mKeyboard = TouchScreenKeyboard.Open(KAIAJMCHLLD.text, TouchScreenKeyboardType.Default, autocorrection: true, multiline: true, secure: true);
	}
	...
	public virtual void KENGMIFPNCC()
	{
		...
		string text = KAIAJMCHLLD.text;
		KAIAJMCHLLD.selected = false;
		KAIAJMCHLLD.mKeyboard = TouchScreenKeyboard.Open(KAIAJMCHLLD.text, TouchScreenKeyboardType.ASCIICapable, autocorrection: false, multiline: true, secure: false);
	}
	...
	public virtual void AAFMJALHANJ()
	{
		...
		string text = KAIAJMCHLLD.text;
		KAIAJMCHLLD.selected = true;
		KAIAJMCHLLD.mKeyboard = TouchScreenKeyboard.Open(KAIAJMCHLLD.text, TouchScreenKeyboardType.Default, autocorrection: true, multiline: false, secure: true);
	}
	...
	public virtual void LAOCMJLFPLN()
	{
		...
		string text = KAIAJMCHLLD.text;
		KAIAJMCHLLD.selected = false;
		KAIAJMCHLLD.mKeyboard = TouchScreenKeyboard.Open(KAIAJMCHLLD.text, TouchScreenKeyboardType.Default, autocorrection: false, multiline: false, secure: true);
	}
