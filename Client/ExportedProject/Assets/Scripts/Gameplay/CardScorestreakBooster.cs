...
{
	[FormerlySerializedAs("LDEPDKIDLNK")]
	...
	protected override string mBonusName => MEJMLNDFDBP.KEPEILBMDMD(ONCPAMMJEMB - 1f);
	...
	protected void OFNEGNKMKKG()
	{
		...
		if (ALBPBCEAEOJ)
		{
			MBIAKMPDOPG.cardIconIndicator.JCJFMHGNIOF("1", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
	...
	protected void PHABEKGALCE()
	{
		...
		if (ALBPBCEAEOJ)
		{
			MBIAKMPDOPG.cardIconIndicator.JCJFMHGNIOF("BlackMarketOffer", NABOFKMBMKH: true);
		}
	}
	...
	public virtual void GFDBGJLHODL(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH(" NOT OK!", NABOFKMBMKH: true);
		NGBJPCBHJKA();
		ALBPBCEAEOJ = PhotonNetwork.isMasterClient;
	...
	protected void BLOBBBLIJPI()
	{
		...
		if (ALBPBCEAEOJ)
		{
			MBIAKMPDOPG.cardIconIndicator.JCJFMHGNIOF("ID_CONFIRM_ERROR", NABOFKMBMKH: true);
		}
	}
	...
	protected void GPLKEOAHFJI()
	{
		...
		if (ALBPBCEAEOJ)
		{
			MBIAKMPDOPG.cardIconIndicator.Show("ID_VISUALRARITY3", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
	}
	...
	protected void JBGDAOIDBGF()
	{
		...
		if (ALBPBCEAEOJ)
		{
			MBIAKMPDOPG.cardIconIndicator.NNPILDOKNJO("Adding MessageId after first", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
	}
	...
	protected void Update()
	{
		...
		if (ALBPBCEAEOJ)
		{
			MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-streakboost-full", NABOFKMBMKH: false);
		}
	}
	...
	protected void MNFDMKFLAKO()
	{
		...
		if (ALBPBCEAEOJ)
		{
			MBIAKMPDOPG.cardIconIndicator.LDGKPCDJPLA("special", NABOFKMBMKH: false);
		}
	}
	...
	{
		MBIAKMPDOPG = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH("Slon", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		ACEHIOEEKKD();
		ALBPBCEAEOJ = PhotonNetwork.isMasterClient;
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	{
		MBIAKMPDOPG = PlayerController.GetPlayerOld(CIOPAKLHFIL);
		MBIAKMPDOPG.cardIconIndicator.BIIHCAEKCOD("MaintenanceMessage", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		KLHAMOOEPCC();
		ALBPBCEAEOJ = PhotonNetwork.isMasterClient;
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	{
		MBIAKMPDOPG = PlayerController.GetPlayerOld(CIOPAKLHFIL);
		MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-streakboost-full", NABOFKMBMKH: true);
		ILEBMLBPINN();
		ALBPBCEAEOJ = PhotonNetwork.isMasterClient;
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	{
		MBIAKMPDOPG = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		MBIAKMPDOPG.cardIconIndicator.LJLDJOHAAMC("ID_NOHEROESINPREVIOUSARENA", NABOFKMBMKH: true);
		NGBJPCBHJKA();
		ALBPBCEAEOJ = PhotonNetwork.isMasterClient;
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void KNIAAECLFFK()
	{
		...
		if (ALBPBCEAEOJ)
		{
			MBIAKMPDOPG.cardIconIndicator.LJLDJOHAAMC("bazooka_reload", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
	...
	{
		MBIAKMPDOPG = PlayerController.GetPlayerOld(CIOPAKLHFIL);
		MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH("ID_ARENARULES_SHOOTERSPROHIBITED", NABOFKMBMKH: false);
		HMILDANPGMH();
		ALBPBCEAEOJ = PhotonNetwork.isMasterClient;
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	{
		MBIAKMPDOPG = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("warbucks", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		NGBJPCBHJKA();
		ALBPBCEAEOJ = PhotonNetwork.isMasterClient;
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void NHEOMLPEBLC()
	{
		...
		if (ALBPBCEAEOJ)
		{
			MBIAKMPDOPG.cardIconIndicator.PEBHGOMEKME("bad card visuals for", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
	...
	protected void OFDJHFMAJBI()
	{
		...
		if (ALBPBCEAEOJ)
		{
			MBIAKMPDOPG.cardIconIndicator.BIIHCAEKCOD("ArenaPoorConnection", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
	...
	protected void CJBJGDCNLOG()
	{
		...
		if (ALBPBCEAEOJ)
		{
			MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH("RunningOut", NABOFKMBMKH: true);
		}
	}
