...
public class ArmyUpgradeIcon : PoolableObject
{
	...
	[Header("-Locked")]
	[FormerlySerializedAs("KNMDGOMHOPJ")]
	public GameObject IAPMLEKENDK;

	[FormerlySerializedAs("JIJMCICAMLN")]
	...
	[FormerlySerializedAs("DLALECDMKOJ")]
	public UISprite AAMOJLNJNGN;

	[FormerlySerializedAs("PGKNKDEBKDC")]
	public UISprite OPFDLJKGPON;

	[Header("-Promote")]
	[FormerlySerializedAs("PCDIKIJLNKH")]
	public GameObject LCFGDKHAMMN;

	[FormerlySerializedAs("HBEMDAPNDKH")]
	public ParticleSystem FIEJLLLEOMN;

	[Header("-Ability")]
	[FormerlySerializedAs("IFEFBCDHNAK")]
	...
	[FormerlySerializedAs("NJHNCDGHNPG")]
	public UISprite EAOIENMNEKK;

	[FormerlySerializedAs("KLEMDBADHDL")]
	public GameObject LKNHEHBOBDL;

	[FormerlySerializedAs("GFAFDAFDPAP")]
	public ParticleSystem AGKFKCKBPHA;

	[Header("-Upgrade")]
	[FormerlySerializedAs("NDJHCJFEJNI")]
	public UISprite FKBOBOBIGIA;

	[FormerlySerializedAs("GMGCBMDDFPM")]
	public UISprite KGIEBHBOHFO;

	[FormerlySerializedAs("ADOBKHOBBMI")]
	public GameObject DMJGINPLADN;

	[FormerlySerializedAs("GCFHPEJLDHC")]
	public List<UISprite> BADMGKEEJAC;

	[FormerlySerializedAs("DJMDJJHINLA")]
	public UISprite JCJKHLPLKLD;

	[FormerlySerializedAs("BAHPBJNCKDH")]
	public List<UISprite> CLFDALDDJNN;

	[FormerlySerializedAs("ACDGKOPLCBN")]
	[Header("-Rented")]
	public UILabel EKGIJFHNFIG;

	[FormerlySerializedAs("mEarlyAccessPart")]
	[Header("-Sale")]
	public GameObject GIPFEBBMKPM;

	[FormerlySerializedAs("mSkippedPart")]
	[Header("-Notification")]
	...
	public LevelBehaviour levelBehaviour => IFFDIHCPKFE;
	...
	private void LGPAGBKNGCC()
	{
		...
		{
			GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().FKMOMAOKCGI(NCFKLBGOEEF: true);
		}
	...
	public void ODELKDIEACB(bool NABOFKMBMKH)
	{
		if (!NABOFKMBMKH)
		{
			KHJBFBDODGM.SetActive(value: true);
	...
	public void GUIForReposition(bool NABOFKMBMKH)
	{
		if (!NABOFKMBMKH)
		{
			KHJBFBDODGM.SetActive(value: false);
	...
	private void MGMKHCIJJGC()
	{
		if (GuiScreenSingle<ArmyScreen>.instance.selectedIcon != null)
		{
			GuiScreenSingle<ArmyScreen>.instance.selectedIcon.DINJCFNOENO(NCFKLBGOEEF: true);
		}
		SoundsManager.Instance.PlayButtonClickedSound();
		DINJCFNOENO(NCFKLBGOEEF: true);
	...
	private void OnClick()
	{
		if (GuiScreenSingle<ArmyScreen>.instance.selectedIcon != null)
		{
			GuiScreenSingle<ArmyScreen>.instance.selectedIcon.SetHighlight(NCFKLBGOEEF: false);
		}
		SoundsManager.Instance.PlayButtonClickedSound();
		SetHighlight(NCFKLBGOEEF: true);
	...
	private void FFKFIHEEIKL()
	{
		...
		{
			GuiScreenSingle<ArmyScreen>.instance.selectedIcon.SetHighlight(NCFKLBGOEEF: true);
		}
		SoundsManager.Instance.PlayButtonClickedSound();
		FGDLKJOINNE(NCFKLBGOEEF: false);
