...
public class CraftResult : Core_BaseScript
{
	...
	private sealed class CPPNFFGBKBM
	{
		...
		{
			BJGCPDNMHDH.BLIHMKFOAAL.gameObject.SetActive(value: true);
			BJGCPDNMHDH.IPKDAFGCGPH(JLANLLEABDC.None);
		}

		internal void MMAFECEHENB(UITweener GCNILAHBDMJ)
		{
			BJGCPDNMHDH.EHAMCACFNHK.SetActive(value: false);
		...
		{
			BJGCPDNMHDH.BLIHMKFOAAL.gameObject.SetActive(value: false);
			BJGCPDNMHDH.MHNLKDDHOHN(JLANLLEABDC.Craft);
		}

		internal void ENOBKGECBGB(UITweener GCNILAHBDMJ)
		{
			BJGCPDNMHDH.EHAMCACFNHK.SetActive(value: true);
		...
		{
			BJGCPDNMHDH.MOAFNNALINF(NABOFKMBMKH: true, HAMKIKMJHDP);
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.JJBFKDFFGKM.gameObject, HAMKIKMJHDP, new Vector3(1985f, 106f, 572f), new Vector3(1278f, 16f, 888f), useLocal: false);
			tweenPosition.method = UITweener.Method.Linear;
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.JJBFKDFFGKM.gameObject, HAMKIKMJHDP, new Vector3(1288f, 735f, 367f), new Vector3(115f, 1577f, 438f), useLocal: false);
		...
		{
			BJGCPDNMHDH.DILEELFOKDO(NABOFKMBMKH: false, HAMKIKMJHDP);
		...
		{
			BJGCPDNMHDH.AEAAFAAJFFP(NABOFKMBMKH: false, HAMKIKMJHDP);
		...
		{
			BJGCPDNMHDH.GJFDHIKIICB(NABOFKMBMKH: true, HAMKIKMJHDP);
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.JJBFKDFFGKM.gameObject, HAMKIKMJHDP, new Vector3(1879f, 769f, 1982f), useLocal: false);
		...
		{
			BJGCPDNMHDH.DILEELFOKDO(NABOFKMBMKH: true, HAMKIKMJHDP);
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.JJBFKDFFGKM.gameObject, HAMKIKMJHDP, new Vector3(1836f, 1252f, 500f), useLocal: false);
			tweenPosition.method = (UITweener.Method)6;
	...
	[FormerlySerializedAs("KEDEKIBDIMP")]
	[Header("Core")]
	public UISprite CLMHAMJCGGF;

	[FormerlySerializedAs("DBCJEJNMBMD")]
	...
	[FormerlySerializedAs("BGACHJNBHAG")]
	[Header("Craft Button")]
	public GameObject LPIJFGELDFG;

	[FormerlySerializedAs("NMJCEOAINJN")]
	public UISprite EPFJEIAPDGL;

	[FormerlySerializedAs("MODPIKABHDH")]
	...
	[FormerlySerializedAs("EKJGJDMEFGP")]
	...
	[FormerlySerializedAs("GLCEEKOEONK")]
	...
	private void EKAFHGGHOHP(JLANLLEABDC EBMMFKDEBEM)
	{
		...
		{
			TweenPosition.Begin(JJBFKDFFGKM.gameObject, 1749f, new Vector3(1701f, (PHFGDCMBGOF != JLANLLEABDC.None) ? 1236f : 344f, 1632f), useLocal: false);
	...
	private void MNCHLLOIOBK(int PDMGPGEHLNM, JLANLLEABDC CJEGGNPOJBJ)
	{
		...
		BLIHMKFOAAL.gameObject.SetActive(value: true);
	...
	private void MOAFNNALINF(bool NABOFKMBMKH, float HAMKIKMJHDP)
	{
		...
		{
			LPIJFGELDFG.SetActive(value: false);
	...
	{
		BLIHMKFOAAL.gameObject.SetActive(value: false);
	}
	...
	{
		GuiScreenSingle<CardMenuScreen>.instance.ONOFJIENPPD.InitializeArrowsAnimations();
		GGAHNKIKJKD((JLANLLEABDC)8, MBBBMNKCAKB: true);
	}
	...
	private void LDKKNMODNMA(JLANLLEABDC OPEDLKOOKGL, JLANLLEABDC EBMMFKDEBEM)
	{
		...
		if (OPEDLKOOKGL == JLANLLEABDC.None && EBMMFKDEBEM == JLANLLEABDC.Craft)
		{
			...
			JJBFKDFFGKM.gameObject.SetActive(value: true);
			BLIHMKFOAAL.gameObject.SetActive(value: true);
		...
		if (OPEDLKOOKGL == JLANLLEABDC.Craft && EBMMFKDEBEM == JLANLLEABDC.Crafting)
		{
			...
			float toAlpha = 1f;
			GJFDHIKIICB(NABOFKMBMKH: false, cPPNFFGBKBM.HAMKIKMJHDP);
			BLIHMKFOAAL.gameObject.SetActive(value: true);
		...
		if (OPEDLKOOKGL == JLANLLEABDC.Crafting && EBMMFKDEBEM == JLANLLEABDC.Ready)
		{
			...
			EHAMCACFNHK.SetActive(value: false);
			BILDEAOMLAB(NABOFKMBMKH: true, cPPNFFGBKBM.HAMKIKMJHDP, JLANLLEABDC.Ready);
		}
	...
	private void ADMIPLIAIHP(JLANLLEABDC EBMMFKDEBEM)
	{
		if (JJBFKDFFGKM.gameObject.activeSelf)
		{
			TweenPosition.Begin(JJBFKDFFGKM.gameObject, 1521f, new Vector3(1458f, (PHFGDCMBGOF != JLANLLEABDC.None) ? 1090f : 576f, 638f), useLocal: false);
	...
	private void GJFDHIKIICB(bool NABOFKMBMKH, float HAMKIKMJHDP)
	{
		...
		if (jPAGNDPGONN.NABOFKMBMKH)
		{
			LPIJFGELDFG.SetActive(value: true);
	...
	{
		GuiScreenSingle<CardMenuScreen>.instance.ONOFJIENPPD.InitializeArrowsAnimations(MBBBMNKCAKB: true);
		Initialize(JLANLLEABDC.None, MBBBMNKCAKB: true);
	}
	...
	{
		GuiScreenSingle<CardMenuScreen>.instance.ONOFJIENPPD.InitializeArrowsAnimations();
		HIHAFDPJPKC(JLANLLEABDC.Ready, MBBBMNKCAKB: true);
	}
	...
	private void LIAFPHCDBBD(JLANLLEABDC OPEDLKOOKGL, JLANLLEABDC EBMMFKDEBEM)
	{
		...
		if (OPEDLKOOKGL == JLANLLEABDC.None && EBMMFKDEBEM == JLANLLEABDC.None)
		{
			...
			JJBFKDFFGKM.gameObject.SetActive(value: false);
			BLIHMKFOAAL.gameObject.SetActive(value: false);
		...
		if (OPEDLKOOKGL == JLANLLEABDC.Craft && EBMMFKDEBEM == (JLANLLEABDC)6)
		{
			...
			float toAlpha = 1740f;
			AEAAFAAJFFP(NABOFKMBMKH: true, cPPNFFGBKBM.HAMKIKMJHDP);
			BLIHMKFOAAL.gameObject.SetActive(value: false);
		...
		if (OPEDLKOOKGL == (JLANLLEABDC)5 && EBMMFKDEBEM == JLANLLEABDC.Crafting)
		{
			...
			EHAMCACFNHK.SetActive(value: true);
			FJONNAPILKD(NABOFKMBMKH: true, cPPNFFGBKBM.HAMKIKMJHDP, JLANLLEABDC.Ready);
		}
		if (OPEDLKOOKGL == JLANLLEABDC.None && EBMMFKDEBEM == (JLANLLEABDC)8)
		{
			...
			LPIJFGELDFG.SetActive(value: false);
			BLIHMKFOAAL.gameObject.SetActive(value: false);
			BILDEAOMLAB(NABOFKMBMKH: false, cPPNFFGBKBM.HAMKIKMJHDP, (JLANLLEABDC)6);
		}
		if (OPEDLKOOKGL == (JLANLLEABDC)8 && EBMMFKDEBEM == JLANLLEABDC.None)
		{
			...
			JJBFKDFFGKM.gameObject.SetActive(value: true);
			DBFHBJBENLG();
			TweenPosition tweenPosition = TweenPosition.Begin(JJBFKDFFGKM.gameObject, cPPNFFGBKBM.HAMKIKMJHDP, new Vector3(1387f, 102f, 736f), useLocal: false);
			tweenPosition.onFinished = cPPNFFGBKBM.BJLLLNAOOOB;
		}
		if (OPEDLKOOKGL == JLANLLEABDC.Craft && EBMMFKDEBEM == JLANLLEABDC.None)
		{
			Debug.Log("Player_Waited_Till_Delivery_Ends");
			AEAAFAAJFFP(NABOFKMBMKH: false, cPPNFFGBKBM.HAMKIKMJHDP);
			EKOCDFGMLKG.SetActive(value: true);
			JJBFKDFFGKM.gameObject.SetActive(value: true);
	...
	{
		GuiScreenSingle<CardMenuScreen>.instance.ONOFJIENPPD.InitializeArrowsAnimations();
		HIHAFDPJPKC((JLANLLEABDC)5, MBBBMNKCAKB: true);
	}
	...
	private void DFCAHJJMHBI(JLANLLEABDC OPEDLKOOKGL, JLANLLEABDC EBMMFKDEBEM)
	{
		...
		if (OPEDLKOOKGL == (JLANLLEABDC)6 && EBMMFKDEBEM == (JLANLLEABDC)8)
		{
			Debug.Log("Value3");
			EHAMCACFNHK.SetActive(value: true);
			BILDEAOMLAB(NABOFKMBMKH: true, cPPNFFGBKBM.HAMKIKMJHDP, JLANLLEABDC.None);
		}
		if (OPEDLKOOKGL == JLANLLEABDC.Craft && EBMMFKDEBEM == JLANLLEABDC.None)
		{
			Debug.Log("N");
			LPIJFGELDFG.SetActive(value: true);
			BLIHMKFOAAL.gameObject.SetActive(value: false);
			DJAEMOIAPOG(NABOFKMBMKH: false, cPPNFFGBKBM.HAMKIKMJHDP, (JLANLLEABDC)4);
		}
		...
		if (OPEDLKOOKGL == JLANLLEABDC.None && EBMMFKDEBEM == JLANLLEABDC.None)
		{
			...
			EKOCDFGMLKG.SetActive(value: false);
			JJBFKDFFGKM.gameObject.SetActive(value: true);
			TweenPosition tweenPosition2 = TweenPosition.Begin(JJBFKDFFGKM.gameObject, cPPNFFGBKBM.HAMKIKMJHDP, new Vector3(1078f, 1412f, 831f), useLocal: false);
			tweenPosition2.onFinished = cPPNFFGBKBM.GNDPMPILDOC;
		}
	}
	...
	private void GBKPJBGHFIG(JLANLLEABDC OPEDLKOOKGL, JLANLLEABDC EBMMFKDEBEM)
	{
		...
		if (OPEDLKOOKGL == JLANLLEABDC.None && EBMMFKDEBEM == JLANLLEABDC.Craft)
		{
			...
			float toAlpha = 692f;
			DILEELFOKDO(NABOFKMBMKH: false, cPPNFFGBKBM.HAMKIKMJHDP);
			BLIHMKFOAAL.gameObject.SetActive(value: false);
			TweenAlpha.Begin(BLIHMKFOAAL.gameObject, cPPNFFGBKBM.HAMKIKMJHDP, fromAlpha, toAlpha).onFinished = cPPNFFGBKBM.EJLGBICBIFK;
		}
		if (OPEDLKOOKGL == JLANLLEABDC.Ready && EBMMFKDEBEM == (JLANLLEABDC)7)
		{
			...
			EHAMCACFNHK.SetActive(value: true);
			ONMLKKMHLDI(NABOFKMBMKH: false, cPPNFFGBKBM.HAMKIKMJHDP, JLANLLEABDC.Ready);
		}
		if (OPEDLKOOKGL == JLANLLEABDC.Craft && EBMMFKDEBEM == (JLANLLEABDC)8)
		{
			...
			LPIJFGELDFG.SetActive(value: false);
			BLIHMKFOAAL.gameObject.SetActive(value: true);
			DJAEMOIAPOG(NABOFKMBMKH: false, cPPNFFGBKBM.HAMKIKMJHDP, JLANLLEABDC.Craft);
		}
		if (OPEDLKOOKGL == JLANLLEABDC.Ready && EBMMFKDEBEM == JLANLLEABDC.None)
		{
			...
			JJBFKDFFGKM.gameObject.SetActive(value: false);
			KPPDPJGKKOD();
			TweenPosition tweenPosition = TweenPosition.Begin(JJBFKDFFGKM.gameObject, cPPNFFGBKBM.HAMKIKMJHDP, new Vector3(1884f, 957f, 1758f), useLocal: false);
			tweenPosition.onFinished = cPPNFFGBKBM.BJLLLNAOOOB;
		}
		if (OPEDLKOOKGL == JLANLLEABDC.None && EBMMFKDEBEM == JLANLLEABDC.None)
		{
			...
			EKOCDFGMLKG.SetActive(value: true);
			JJBFKDFFGKM.gameObject.SetActive(value: false);
			TweenPosition tweenPosition2 = TweenPosition.Begin(JJBFKDFFGKM.gameObject, cPPNFFGBKBM.HAMKIKMJHDP, new Vector3(517f, 1706f, 921f), useLocal: false);
