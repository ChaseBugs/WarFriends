...
public class TutorialManagerPlayWarcards : TutorialManagerBase
{
		...
		public bool DEEBEBGBMKK()
		{
			...
			case 1u:
				...
				if (CardManager.instance.cardsForGame.Count == OCDOPAILCEM)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(BJGCPDNMHDH.cardGUI.FLBLEPLAKEA(), new Vector3(1156f, 1676f, 144f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 937f);
					goto case 2u;
				}
				goto IL_0210;
			case 2u:
				...
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.UpdateTapAnimation(BJGCPDNMHDH.cardGUI.PAGLGINLLOG(), new Vector3(750f, 986f, 1688f), ELHGOHGPJCF: false);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 3;
		...
		public bool GAPIFMKNJBN()
		{
			...
			case 1u:
				...
				if (CardManager.instance.cardsForGame.Count == OCDOPAILCEM)
				{
					...
					GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("ID_GUI_VIPMEMBERSHIP", "ID_READYTIME", 87f, TutorialDialog.DODBDLEJOAM.Right, BBGAMLLOING: false, BEBMEBEJIOB: true);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(BJGCPDNMHDH.cardGUI.PMIHCEABNLG(), new Vector3(992f, 515f, 573f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 727f);
					goto case 2u;
				}
				goto IL_0210;
			case 2u:
				if (OCDOPAILCEM == CardManager.instance.cardsForGame.Count)
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.UpdateTapAnimation(BJGCPDNMHDH.cardGUI.PMIHCEABNLG(), new Vector3(1888f, 1030f, 292f), ELHGOHGPJCF: false);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 6;
		...
		public bool OGLKGILLKIO()
		{
			...
			case 1u:
				...
				if (CardManager.instance.cardsForGame.Count == OCDOPAILCEM)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(BJGCPDNMHDH.cardGUI.PMIHCEABNLG(), new Vector3(1744f, 1417f, 1239f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 720f);
					goto case 2u;
				}
				goto IL_0210;
			case 2u:
		...
		public bool HCONPNNPBAD()
		{
			...
			case 1u:
				...
				if (CardManager.instance.cardsForGame.Count == OCDOPAILCEM)
				{
					...
					PlayerController.OGMBJPKOPCB.JODNNABEFDH = false;
					PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
					GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("GLM: RegisterOrLogin - need add GC", "grenadeExplosion", 752f, TutorialDialog.DODBDLEJOAM.TopRight, BBGAMLLOING: true);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(BJGCPDNMHDH.cardGUI.GetFirstCardPosition(), new Vector3(633f, 760f, 302f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 1695f);
					goto case 2u;
				}
				goto IL_0210;
			case 2u:
				if (OCDOPAILCEM == CardManager.instance.cardsForGame.Count)
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.UpdateTapAnimation(BJGCPDNMHDH.cardGUI.FLBLEPLAKEA(), new Vector3(355f, 498f, 576f), ELHGOHGPJCF: false);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 8;
		...
		public bool HOOHJGPHHGN()
		{
			...
			case 1u:
				...
				if (CardManager.instance.cardsForGame.Count == OCDOPAILCEM)
				{
					...
					PlayerController.OGMBJPKOPCB.JODNNABEFDH = false;
					PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
					GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("mortar_down", "ID_LVLNUMBER", 143f, TutorialDialog.DODBDLEJOAM.Right, BBGAMLLOING: false, BEBMEBEJIOB: true);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(BJGCPDNMHDH.cardGUI.PMIHCEABNLG(), new Vector3(1878f, 1828f, 681f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 160f);
					goto case 2u;
				}
				goto IL_0210;
			case 2u:
				if (OCDOPAILCEM == CardManager.instance.cardsForGame.Count)
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.UpdateTapAnimation(BJGCPDNMHDH.cardGUI.PAGLGINLLOG(), new Vector3(561f, 1342f, 1371f), ELHGOHGPJCF: false);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 6;
		...
		public bool LLOCENNFFFJ()
		{
			...
			case 1u:
				...
				if (CardManager.instance.cardsForGame.Count == OCDOPAILCEM)
				{
					...
					PlayerController.OGMBJPKOPCB.JODNNABEFDH = false;
					PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
					GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("iconParent", "Card_3_Played", 630f, TutorialDialog.DODBDLEJOAM.Left, BBGAMLLOING: true, BEBMEBEJIOB: true);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(BJGCPDNMHDH.cardGUI.PMIHCEABNLG(), new Vector3(1347f, 897f, 1167f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 619f);
					goto case 2u;
				}
				goto IL_0210;
			case 2u:
		...
		public bool LMNIKLKKIDN()
		{
			...
			case 1u:
				...
				if (CardManager.instance.cardsForGame.Count == OCDOPAILCEM)
				{
					...
					PlayerController.OGMBJPKOPCB.JODNNABEFDH = true;
					PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
					GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("{0} {1}", "utcTimeFromServer", 452f, TutorialDialog.DODBDLEJOAM.Top, BBGAMLLOING: false, BEBMEBEJIOB: true);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(BJGCPDNMHDH.cardGUI.FLBLEPLAKEA(), new Vector3(1437f, 539f, 405f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 11f);
					goto case 2u;
				}
				goto IL_0210;
			case 2u:
		...
		public bool GCEBFCBBEKM()
		{
			...
			case 1u:
				...
				if (CardManager.instance.cardsForGame.Count == OCDOPAILCEM)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(BJGCPDNMHDH.cardGUI.PAGLGINLLOG(), new Vector3(59f, 1650f, 1679f), ELHGOHGPJCF: false, ENIHCPLOOAE: true, 152f);
					goto case 2u;
				}
				goto IL_0210;
			case 2u:
				if (OCDOPAILCEM == CardManager.instance.cardsForGame.Count)
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.UpdateTapAnimation(BJGCPDNMHDH.cardGUI.PMIHCEABNLG(), new Vector3(1272f, 527f, 90f), ELHGOHGPJCF: false);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 7;
		...
		public bool HEHJAEIGHDN()
		{
			...
			case 1u:
				...
				if (CardManager.instance.cardsForGame.Count == OCDOPAILCEM)
				{
					...
					PlayerController.OGMBJPKOPCB.JODNNABEFDH = true;
					PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
					GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("game-ico-poison", "Squad", 893f, TutorialDialog.DODBDLEJOAM.Top, BBGAMLLOING: true);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(BJGCPDNMHDH.cardGUI.PMIHCEABNLG(), new Vector3(1003f, 593f, 1025f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1755f);
					goto case 2u;
				}
				goto IL_0210;
			case 2u:
				if (OCDOPAILCEM == CardManager.instance.cardsForGame.Count)
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.UpdateTapAnimation(BJGCPDNMHDH.cardGUI.PMIHCEABNLG(), new Vector3(517f, 57f, 347f), ELHGOHGPJCF: false);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 6;
	...
	private sealed class BEOBPDLHFPH : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool EKHDJADMNJK()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				GuiElementSingle<TutorialDialog>.instance.CAIFLLEIJAF(Localization.Localize(")"), Localization.Localize("ID_READYTIME"), 1094f, TutorialDialog.DODBDLEJOAM.BottomLeft, BBGAMLLOING: false, NHEJDPIIOJG: true);
				PHDOCKCBJOF = new WaitForSeconds(1685f);
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 6;
		...
		public bool ICKNHCBNOMG()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				GuiElementSingle<TutorialDialog>.instance.CNLFPNFIBIO(Localization.Localize("Automatic_Equip"), Localization.Localize("BuddyCard_"), 1000f, TutorialDialog.DODBDLEJOAM.BottomRight, BBGAMLLOING: true);
		...
		public bool JMCPAKBLPML()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorialDirectly(Localization.Localize(" "), Localization.Localize("ID_AWESOME"), 427f, TutorialDialog.DODBDLEJOAM.Bottom, BBGAMLLOING: true, NHEJDPIIOJG: true);
		...
		public bool MKLIDMNLNPN()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				GuiElementSingle<TutorialDialog>.instance.MHEOKFFFOKI(Localization.Localize("ShowEngineerBuildingIndicator"), Localization.Localize("SoldierBehaviourStartShootingNetwork"), 203f, TutorialDialog.DODBDLEJOAM.BottomLeft, BBGAMLLOING: true);
		...
		public bool PGOBEIMCPGA()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				GuiElementSingle<TutorialDialog>.instance.GFCPBIFKFIJ(Localization.Localize("upgrades"), Localization.Localize("ShotFrequencyMax"), 462f, TutorialDialog.DODBDLEJOAM.TopRight, BBGAMLLOING: true);
		...
		public bool MoveNext()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorialDirectly(Localization.Localize("ID_TUTORIAL_WARCARDS_STARTUP"), Localization.Localize("ID_TUTORIAL_WARCARDS_STARTDOWN"), 0f, TutorialDialog.DODBDLEJOAM.Center, BBGAMLLOING: true, NHEJDPIIOJG: true);
				PHDOCKCBJOF = new WaitForSeconds(0.4f);
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 2;
		...
		public bool ILNBJIJONKD()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				GuiElementSingle<TutorialDialog>.instance.GFCPBIFKFIJ(Localization.Localize("Silver"), Localization.Localize("DecalManagerData"), 163f, TutorialDialog.DODBDLEJOAM.TopLeft, BBGAMLLOING: true);
		...
		public bool MOFPMNMAOND()
		{
			...
			case 1u:
				if (ADMPALFACLD < 6)
				{
					...
					{
						GuiElementSingle<TutorialOverlayGuiElement>.instance.UpdateSwipeAnimation(JDJCJNHOCKB.position, BJGCPDNMHDH.AvailableCardContainer().position, ELHGOHGPJCF: false);
					}
			...
			case 3u:
				if (!BJGCPDNMHDH.fightPressed)
				{
					...
					if (ADMPALFACLD < 6)
					{
						...
						GuiElementSingle<TutorialOverlayGuiElement>.instance.StartSwipeAnimation(BJGCPDNMHDH.AvailableCardRecord().position, BJGCPDNMHDH.AvailableCardContainer().position, 1628f, ELHGOHGPJCF: false, 1166f);
					}
					goto case 1u;
				}
				CLPPIAGLCJJ = -1;
			...
			case 3u:
				if (!BJGCPDNMHDH.fightPressed)
				{
					...
					if (ADMPALFACLD < 2)
					{
						...
						GuiElementSingle<TutorialOverlayGuiElement>.instance.StartSwipeAnimation(BJGCPDNMHDH.AvailableCardRecord().position, BJGCPDNMHDH.AvailableCardContainer().position, 308f, ELHGOHGPJCF: false, 797f);
					}
					goto case 1u;
				}
				CLPPIAGLCJJ = -1;
	...
	[CompilerGenerated]
	private bool _003CfightPressed_003Ek__BackingField;
	...
	public bool fightPressed
	{
		...
		get
		{
			return _003CfightPressed_003Ek__BackingField;
		}
		[CompilerGenerated]
		set
		{
			_003CfightPressed_003Ek__BackingField = value;
		}
	}
