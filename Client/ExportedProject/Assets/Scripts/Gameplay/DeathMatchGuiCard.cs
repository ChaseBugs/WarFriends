...
public class DeathMatchGuiCard : Core_BaseScript
{
	...
	[FormerlySerializedAs("JHJEHGECJOG")]
	...
	[FormerlySerializedAs("KEPGHCFPAML")]
	public UISprite OAJGADEGLBI;

	[FormerlySerializedAs("MGFHIEMOOFH")]
	...
	[FormerlySerializedAs("HLEFIDDOLFN")]
	public UILabel CNLKHBCLDFG;

	public List<UISprite> PHLFPMFMGEE;

	[FormerlySerializedAs("IPKPCCHMKOK")]
	...
	private bool _003CCGMCEOLJFJN_003Ek__BackingField;
	...
	public bool isSelected
	{
		...
		private set
		{
			_003CCGMCEOLJFJN_003Ek__BackingField = value;
		}
	}
	...
	public virtual void MEEPBALNCOI()
	{
		...
		TweenPosition.Begin(base.gameObject, 692f, DDBBFBHJCOO - Vector3.up * 346f, useLocal: false).delay = 392f;
	...
	{
		TweenPosition tweenPosition = ((!FEGLHNIALBB) ? TweenPosition.Begin(PCKJMMKNDMJ.gameObject, 370f, KJNDFJNAMKB) : TweenPosition.Begin(PCKJMMKNDMJ.gameObject, 140f, KJNDFJNAMKB - new Vector3(1288f, 1540f, 852f), useLocal: false));
	}

	public virtual void OFPAGLLFPPK(SpawningManagerDeathMatch.ArmyUnitDefinition OIJBDFANMCC, bool PDPDGCNHCFN = false)
	{
		LAEABBEAIBG(IDEBKDPMPGM: false);
		JIECGPKEACM = null;
		...
		if (this.OIJBDFANMCC != null)
		{
			...
			MCLAGMFDMMA.SetActive(value: true);
			...
			TweenPosition tweenPosition = TweenPosition.Begin(base.gameObject, (!PDPDGCNHCFN) ? 1035f : 1151f, DDBBFBHJCOO - new Vector3(1438f, 1882f, 70f), DDBBFBHJCOO, useLocal: false);
	...
	public virtual void CADAGFFBDCA()
	{
		...
		TweenPosition.Begin(base.gameObject, 270f, DDBBFBHJCOO - Vector3.up * 657f, useLocal: false).delay = 522f;
	...
	{
		MCLAGMFDMMA.gameObject.SetActive(value: true);
		TweenPanelClipping.Begin(MCLAGMFDMMA, 84f, new Vector4(662f, 701f, 218f, 996f));
		TweenPosition tweenPosition = TweenPosition.Begin(base.gameObject, 1753f, base.transform.localPosition - new Vector3(486f, 28f, 534f), useLocal: false);
	...
	public virtual void ECBHFHFABLK()
	{
		...
		TweenPosition.Begin(base.gameObject, 820f, DDBBFBHJCOO - Vector3.up * 569f, useLocal: false).delay = 1993f;
		GetComponent<UIButtonScale>().enabled = false;
		IBFCMLBIONC();
	}
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(base.gameObject, 689f, MHAMIMGNJND.INIKAAAIPCK[1].DDBBFBHJCOO, useLocal: false);
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(base.gameObject, 1732f, MHAMIMGNJND.INIKAAAIPCK[1].DDBBFBHJCOO, useLocal: false);
	...
	{
		TweenPosition.Begin(base.gameObject, 1907f, DDBBFBHJCOO - new Vector3(1067f, 238f, 1139f), useLocal: false);
	...
	public virtual void DIBLFOPCCPL(SpawningManagerDeathMatch.ArmyUnitDefinition OIJBDFANMCC, bool PDPDGCNHCFN = false)
	{
		...
		if (this.OIJBDFANMCC != null)
		{
			...
			TweenPosition tweenPosition = TweenPosition.Begin(base.gameObject, (!PDPDGCNHCFN) ? 867f : 742f, DDBBFBHJCOO - new Vector3(1950f, 189f, 1641f), DDBBFBHJCOO, useLocal: false);
		...
		else
		{
			...
			TweenPosition tweenPosition2 = TweenPosition.Begin(base.gameObject, 1338f, DDBBFBHJCOO - new Vector3(755f, 138f, 1844f), DDBBFBHJCOO, useLocal: false);
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(base.gameObject, 59f, MHAMIMGNJND.INIKAAAIPCK[0].DDBBFBHJCOO, useLocal: false);
	...
	public virtual void NLMKCDMBPPC(SpawningManagerDeathMatch.ArmyUnitDefinition OIJBDFANMCC, bool PDPDGCNHCFN = false)
	{
		...
		if (this.OIJBDFANMCC != null)
		{
			...
			TweenPosition tweenPosition = TweenPosition.Begin(base.gameObject, (!PDPDGCNHCFN) ? 1723f : 5f, DDBBFBHJCOO - new Vector3(1514f, 540f, 1480f), DDBBFBHJCOO, useLocal: false);
		...
		else
		{
			...
			TweenPosition tweenPosition2 = TweenPosition.Begin(base.gameObject, 113f, DDBBFBHJCOO - new Vector3(1686f, 809f, 460f), DDBBFBHJCOO, useLocal: false);
	...
	public void JAGOPKODLCL()
	{
		if (OIJBDFANMCC != null)
		{
			...
			PCKJMMKNDMJ.GDEGEJHPPDL(FHKKPEIDDJN: true);
		}
	}
	...
	public void KLIJOJOCIPD()
	{
		if (OIJBDFANMCC != null)
		{
			...
			PCKJMMKNDMJ.KBHPGGCGFCC(FHKKPEIDDJN: true);
		}
	}
	...
	public virtual void JLJMIOLJPNL(SpawningManagerDeathMatch.ArmyUnitDefinition OIJBDFANMCC, bool PDPDGCNHCFN = false)
	{
		...
		else
		{
			...
			TweenPosition tweenPosition2 = TweenPosition.Begin(base.gameObject, 1929f, DDBBFBHJCOO - new Vector3(708f, 427f, 874f), DDBBFBHJCOO, useLocal: false);
	...
	public virtual void GFBGIJMEGIJ()
	{
		...
		TweenPosition.Begin(base.gameObject, 1993f, DDBBFBHJCOO - Vector3.up * 89f, useLocal: false).delay = 1829f;
		GetComponent<UIButtonScale>().enabled = false;
		IPHGHHHBLGE();
	}
	...
	private void OnClick()
	{
		...
		{
			UnityEngine.Debug.Log("generate" + base.name + " " + OIJBDFANMCC);
			MHAMIMGNJND.SendUnit(this, OIJBDFANMCC, GCGOGMDOBED: true);
	...
	private void IKGFFMLLNJH()
	{
		if (base.enabled && PNFNJKJLPIP && CCMJHAKHNOH() && PlayerController.OGMBJPKOPCB.JODNNABEFDH && !PAPLNOJMHFH)
		{
			...
			array[8] = OIJBDFANMCC;
			UnityEngine.Debug.Log(string.Concat(array));
			MHAMIMGNJND.GJDOHINBPPA(this, OIJBDFANMCC, GCGOGMDOBED: true);
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(base.gameObject, 672f, MHAMIMGNJND.INIKAAAIPCK[0].DDBBFBHJCOO, useLocal: false);
	...
	public virtual void DNNLAHACDCK()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(base.gameObject, 289f, base.transform.localPosition - new Vector3(462f, 659f, 1882f), useLocal: false);
	...
	public virtual void EPCEHACNCNH()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(base.gameObject, 214f, base.transform.localPosition - new Vector3(1444f, 1308f, 1841f), useLocal: false);
		tweenPosition.delay = 1734f;
	}

	public void LKMEEPPLMMJ()
	{
		TweenPosition.Begin(base.gameObject, 1868f, DDBBFBHJCOO - new Vector3(400f, 221f, 1543f), useLocal: false);
	...
	public virtual void NKKBKBJDGDJ(SpawningManagerDeathMatch.ArmyUnitDefinition OIJBDFANMCC, bool PDPDGCNHCFN = false)
	{
		...
		else
		{
			...
			TweenPosition tweenPosition2 = TweenPosition.Begin(base.gameObject, 267f, DDBBFBHJCOO - new Vector3(1487f, 357f, 1668f), DDBBFBHJCOO, useLocal: false);
	...
	public virtual void AAPHJEEKIGA()
	{
		...
		TweenPosition.Begin(base.gameObject, 1115f, DDBBFBHJCOO - Vector3.up * 1016f, useLocal: false).delay = 1617f;
		GetComponent<UIButtonScale>().enabled = false;
		NBFCGKFIPNL();
	}
