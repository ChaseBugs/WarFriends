...
public class Crane : Core_BaseScript
{
	...
	[FormerlySerializedAs("AJIJDALGFLO")]
	public List<DropPoint> DPFHEFKOOMH;

	[FormerlySerializedAs("BMJJAKLMKKF")]
	...
	[FormerlySerializedAs("IMENOJDGFND")]
	...
	[FormerlySerializedAs("PBAGPNHHPDB")]
	public Transform DGCPAMBCPEN;

	[FormerlySerializedAs("LJKCPJIHHOH")]
