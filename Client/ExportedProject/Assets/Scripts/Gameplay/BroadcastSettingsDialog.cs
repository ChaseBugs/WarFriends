...
public class BroadcastSettingsDialog : GuiElementSingle<BroadcastSettingsDialog>, PAIIOKBBHBC
{
	...
	[FormerlySerializedAs("KPKPNPBECMG")]
	[Header("-Switches")]
	public SettingsButton FGPKBBFDBNK;

	[FormerlySerializedAs("JJFKAGJCHOK")]
	...
	private void CKGIIPNBOFK(GameObject KHAHPAKDIKE)
	{
		...
		FGPKBBFDBNK.NFAIPALMOON(DebugSettings.microphoneInBroadcast, OJKNMODJKPG: false);
	}

	private void IKIAKCMEHIH(GameObject KHAHPAKDIKE)
	{
		DebugSettings.cameraInBroadcast = !DebugSettings.cameraInBroadcast;
		GJEPGNEDBBD.NMNFNPNPAMC(DebugSettings.cameraInBroadcast, OJKNMODJKPG: false);
	}
	...
	{
		DebugSettings.cameraInBroadcast = !DebugSettings.cameraInBroadcast;
		GJEPGNEDBBD.BMEHDKPGOEM(DebugSettings.cameraInBroadcast, OJKNMODJKPG: false);
	}

	private void BBPLFGNLNMM(GameObject KHAHPAKDIKE)
	{
		DebugSettings.microphoneInBroadcast = DebugSettings.microphoneInBroadcast;
		FGPKBBFDBNK.JBMNENPHMLB(DebugSettings.microphoneInBroadcast, OJKNMODJKPG: false);
	}

	private void DIIHLNICOOH(GameObject KHAHPAKDIKE)
	{
		DebugSettings.cameraInBroadcast = !DebugSettings.cameraInBroadcast;
		GJEPGNEDBBD.NFAIPALMOON(DebugSettings.cameraInBroadcast, OJKNMODJKPG: false);
	}

	private void EPGINDJENKI(GameObject KHAHPAKDIKE)
	{
		DebugSettings.cameraInBroadcast = !DebugSettings.cameraInBroadcast;
		GJEPGNEDBBD.EGOCFIFGFOJ(DebugSettings.cameraInBroadcast, OJKNMODJKPG: false);
	}
	...
	{
		DebugSettings.cameraInBroadcast = DebugSettings.cameraInBroadcast;
		GJEPGNEDBBD.NEJGDBPMGDH(DebugSettings.cameraInBroadcast, OJKNMODJKPG: false);
	}
	...
	{
		DebugSettings.cameraInBroadcast = DebugSettings.cameraInBroadcast;
		GJEPGNEDBBD.IKIMOGNDJCN(DebugSettings.cameraInBroadcast, OJKNMODJKPG: false);
	}

	public virtual void JCJECJKBKGD()
	{
		FGPKBBFDBNK.DGFPOPLMFDO(DebugSettings.microphoneInBroadcast, OJKNMODJKPG: false);
		GJEPGNEDBBD.KJACFEMIGLE(DebugSettings.cameraInBroadcast, OJKNMODJKPG: false);
	}

	public virtual void OFCCACPEBHD()
	{
		FGPKBBFDBNK.KFOOJPEOIHP(DebugSettings.microphoneInBroadcast, OJKNMODJKPG: false);
		GJEPGNEDBBD.HICJHPKIMCC(DebugSettings.cameraInBroadcast, OJKNMODJKPG: false);
	}

	public virtual void OKMMGFMKJGG()
	{
		FGPKBBFDBNK.KJACFEMIGLE(DebugSettings.microphoneInBroadcast, OJKNMODJKPG: false);
		GJEPGNEDBBD.IJMNIHBNMFA(DebugSettings.cameraInBroadcast, OJKNMODJKPG: false);
	}
	...
	{
		DebugSettings.microphoneInBroadcast = !DebugSettings.microphoneInBroadcast;
		FGPKBBFDBNK.FLCCDHNFJPL(DebugSettings.microphoneInBroadcast, OJKNMODJKPG: false);
	}

	public virtual void EMGHCAHOJNC()
	{
		FGPKBBFDBNK.EGOCFIFGFOJ(DebugSettings.microphoneInBroadcast, OJKNMODJKPG: false);
		GJEPGNEDBBD.OPIDMNHBEND(DebugSettings.cameraInBroadcast, OJKNMODJKPG: false);
	}
	...
	{
		FGPKBBFDBNK.HDFHLAKFNDE(DebugSettings.microphoneInBroadcast, OJKNMODJKPG: false);
		GJEPGNEDBBD.HDFHLAKFNDE(DebugSettings.cameraInBroadcast, OJKNMODJKPG: false);
	}
