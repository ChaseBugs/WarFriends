...
public class KillStreakBonusTurret : KillStreakBonus
{
	...
	public virtual bool IENDHGPJJFE(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.ActivateBonus(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 63f, 0);
	...
	public virtual bool DFPGPKIIHFA(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.CKMJBNEMDIG(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 921f, 0);
			Vector3 position = hit.position;
			SpawningManager.instance.SpawnForCard(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return false;
		}
		return true;
	}
	...
	public virtual bool DHGFPILPDBN(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.GCHILNJMFPD(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 1733f, 1);
			Vector3 position = hit.position;
			SpawningManager.BMNEPICFHNO().MGIDDHIPJBC(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return false;
		}
		return false;
	}
	...
	public virtual bool OAHGHHFHBEI(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.DAECMMEPAHL(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 502f, 1);
			Vector3 position = hit.position;
			SpawningManager.instance.OMANPOHJAGO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return false;
		}
		return true;
	}
	...
	public virtual bool BCGJKNHOKBM(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.DAECMMEPAHL(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 1073f, 1);
			Vector3 position = hit.position;
	...
	public virtual bool HDMPEMAGGFN(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.CMPIFPBJDLM(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 419f, 1);
			Vector3 position = hit.position;
			SpawningManager.LDGAKJJINEO().OMANPOHJAGO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, KHLGDCHJJPB.fraction, position);
			return false;
		}
	...
	public virtual bool FICFAOOANCJ(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.CKMPBKMOIAF(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 1828f, 1);
			Vector3 position = hit.position;
	...
	public virtual bool FFJBHDGFIHI(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.CMPIFPBJDLM(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 810f, 1);
			Vector3 position = hit.position;
			SpawningManager.instance.GGBPHPOPCAM(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return true;
		}
		return false;
	}
	...
	public virtual bool JEKNHBPDBJO(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.LJBDCGFBAHE(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 1638f, 1);
			Vector3 position = hit.position;
	...
	public virtual bool BLGCKFBMKGF(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.CKMPBKMOIAF(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 1829f, 1);
			Vector3 position = hit.position;
			SpawningManager.OKBAIGKCPKA().EEOMJOEDAMO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return false;
		}
		return true;
	}
	...
	public virtual bool JJOOCBLMFFH(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.GONLNEJFBKH(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 948f, 1);
			Vector3 position = hit.position;
			SpawningManager.instance.JAMPFGHHAPP(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return false;
		}
		return false;
	}
	...
	public virtual bool BPHFNDPJHFG(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.DAECMMEPAHL(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 63f, 1);
			Vector3 position = hit.position;
	...
	public virtual bool MILOFINNGIP(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.LJBDCGFBAHE(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 1574f, 1);
			Vector3 position = hit.position;
	...
	public virtual bool KGALFBPJBKO(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.FJAJKEBLFOE(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 1015f, 0);
			Vector3 position = hit.position;
			SpawningManager.BMNEPICFHNO().JAMPFGHHAPP(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return false;
		}
		return false;
	}
	...
	public virtual bool NILJDLKGKCP(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.MCDFGACAGCG(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 720f, 0);
			Vector3 position = hit.position;
			SpawningManager.LDGAKJJINEO().OMANPOHJAGO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return true;
		}
		return true;
	}
	...
	public override bool LJBDCGFBAHE(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.CMPIFPBJDLM(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 538f, 1);
			Vector3 position = hit.position;
			SpawningManager.BMNEPICFHNO().OMANPOHJAGO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return false;
		}
		return true;
	}
	...
	public virtual bool MDNMJNFHAFB(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.ActivateBonus(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 1046f, 1);
			Vector3 position = hit.position;
	...
	public virtual bool LFDMFMPFOJJ(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.DAECMMEPAHL(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 512f, 1);
			Vector3 position = hit.position;
			SpawningManager.instance.OMANPOHJAGO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return false;
		}
		return true;
	}
	...
	public override bool CMPIFPBJDLM(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.CKMPBKMOIAF(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 1405f, 0);
			Vector3 position = hit.position;
	...
	public virtual bool ECCIBBNHBOF(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.BCDFEBKGHCN(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 646f, 1);
			Vector3 position = hit.position;
			SpawningManager.instance.JAMPFGHHAPP(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return false;
		}
		return true;
	}
	...
	public virtual bool AIFHKFOGBAL(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.DAECMMEPAHL(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 1480f, 1);
			Vector3 position = hit.position;
			SpawningManager.OKBAIGKCPKA().MGIDDHIPJBC(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, KHLGDCHJJPB.fraction, position);
			return true;
		}
	...
	public virtual bool JGAEDEHMMOK(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.DAECMMEPAHL(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 1847f, 1);
			Vector3 position = hit.position;
	...
	public virtual bool ECMIOMNFOPD(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.ActivateBonus(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 752f, 0);
			Vector3 position = hit.position;
	...
	public virtual bool IBJCOBEOPKH(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.OHHOJEJKLBB(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 255f, 1);
			Vector3 position = hit.position;
			SpawningManager.BMNEPICFHNO().JAMPFGHHAPP(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return false;
		}
		return false;
	}
	...
	public virtual bool OEJLKDJAEGD(GameObject NPNGCEJFAOP, PlayerController KHLGDCHJJPB)
	{
		if (base.CKMJBNEMDIG(NPNGCEJFAOP, KHLGDCHJJPB))
		{
			...
			NavMesh.SamplePosition(sourcePosition, out var hit, 327f, 0);
			Vector3 position = hit.position;
			SpawningManager.LDGAKJJINEO().EEOMJOEDAMO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, KHLGDCHJJPB.fraction, position, KKAIPHCKJHO: false);
			return false;
		}
		return false;
	}
