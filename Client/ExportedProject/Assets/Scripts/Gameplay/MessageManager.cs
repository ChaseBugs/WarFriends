...
public class MessageManager : Singleton<MessageManager>
{
	...
	private LDDEMALIBBK _003CMEPGOIMCPOB_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private BOAFLMMKCGB _003CICOECACIGKK_003Ek__BackingField;
	...
	public LDDEMALIBBK lastRewardMessage
	{
		[CompilerGenerated]
		get
		{
		...
		set
		{
			_003CMEPGOIMCPOB_003Ek__BackingField = value;
		}
	}

	public BOAFLMMKCGB lastDepositWarcardsMessage
	{
		[CompilerGenerated]
		get
		{
		...
		set
		{
			_003CICOECACIGKK_003Ek__BackingField = value;
		}
	}
	...
	public void ODEAFFPKDKN(string NHHGDIDEIMM)
	{
		...
		requestBuffer.AddRequest((DatabaseAction)83, NHHGDIDEIMM, 0, 1, string.Empty, additionalParameter: true);
	}
	...
	{
		RequestBuffer requestBuffer = RequestBufferManager.instance.GetRequestBuffer();
		requestBuffer.AddRequest((DatabaseAction)(-127), NHHGDIDEIMM, 1, 1, string.Empty, additionalParameter: true);
	}
	...
	{
		RequestBuffer requestBuffer = RequestBufferManager.instance.GetRequestBuffer();
		requestBuffer.AddRequest((DatabaseAction)11, NHHGDIDEIMM, 1, 1, string.Empty, additionalParameter: true);
	}
