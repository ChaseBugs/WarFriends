...
{
	public override string name => Localization.Localize("ID_FEATURE_DAMAGE");

	public override string fancyName => Localization.Localize("ID_FEATURE_DAMAGE-FANCY");

	public override string icon => "menu-unitstats-shotdamage";

	public override string description => Localization.Localize("ID_FEATURE_DAMAGE-DESCRIPTION");

	public override string statisticIncrease => MEJMLNDFDBP.DPAFFLMAFJG(base.value);

	public override string weaponPrefix => Localization.Localize("ID_FEATURE_DAMAGE-WEAPONPREFIX");

	public override float damageCoef => 1f + (float)base.value;
