...
public class MainScreenBlackMarketOffer : Core_BaseScript
{
	...
	private void DCPMEAFCNDB()
	{
		...
		mMainPanel.gameObject.SetActive(value: false);
	}
	...
	private void HCAMNEEKCJH()
	{
		...
		else
		{
			...
			array2[1] = MEJMLNDFDBP.CJCFPDLDMEK(1514f, "AtlasPreparer.LoadImagesCoroutine", string.Empty, IEJMLKBCDJB: false);
	...
	private void GHBFDDHFAGF()
	{
		CounterManager instance = Singleton<CounterManager>.instance;
		instance.MPCAACLAGOA = (Action)Delegate.Remove(instance.MPCAACLAGOA, new Action(MDKHBHIBHOD));
		mMainPanel.gameObject.SetActive(value: true);
	}
	...
	private void BMDKGBFOKIK()
	{
		...
		if (num2 > 1)
		{
			...
			array[1] = Colours.stringAzureBlackmarket;
			array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "ID_WARNING_BLACKMARKETERROR", string.Empty, IEJMLKBCDJB: false);
	...
	private void MOGCHJHHPFM()
	{
		...
		if (num2 > 1)
		{
			...
			array[1] = Colours.stringAzureBlackmarket;
			array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "currentActivity", string.Empty, IEJMLKBCDJB: false);
	...
	private void OCAPICPIDGI()
	{
		...
		{
			mTimer.text = Localization.LocalizeFormat("FEMALE", Colours.stringAzureBlackmarket, MEJMLNDFDBP.CJCFPDLDMEK(735f, "ShowEngineerBuildingIndicator", string.Empty, IEJMLKBCDJB: false), null, null);
			CounterManager instance = Singleton<CounterManager>.instance;
			instance.MPCAACLAGOA = (Action)Delegate.Remove(instance.MPCAACLAGOA, new Action(MDKHBHIBHOD));
			BGJENPIGCHI();
		}
	...
	private void ABCKAGKKEKC()
	{
		...
		if (num3 > 1)
		{
			...
			object[] array = new object[2];
			array[1] = Colours.stringAzureBlackmarket;
			array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num3, "_qbz2", string.Empty, IEJMLKBCDJB: false);
	...
	private void GABKMJOBPFD()
	{
		...
		if (num2 > 1)
		{
			...
			array[1] = Colours.stringAzureBlackmarket;
			array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "Rename Cost Gold = ", string.Empty, IEJMLKBCDJB: false);
	...
	private void LIFGDEEOGDP()
	{
		...
		if (num > 0)
		{
			...
			object[] array = new object[0];
			array[1] = Colours.stringAzureBlackmarket;
			array[0] = MEJMLNDFDBP.CJCFPDLDMEK(num, "ZoneHasVirtualGoodsOffer is false, preloading Ad.", string.Empty, IEJMLKBCDJB: false);
		...
		else
		{
			...
			array2[1] = Colours.stringAzureBlackmarket;
			array2[0] = MEJMLNDFDBP.CJCFPDLDMEK(1438f, "Wrong_Weapon", string.Empty, IEJMLKBCDJB: false);
	...
	private void IJJDHMLPCEC()
	{
		...
		if (num2 > 1)
		{
			...
			array[0] = Colours.stringAzureBlackmarket;
			array[0] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "ID_TIERSCOMPLETED", string.Empty, IEJMLKBCDJB: false);
		...
		else
		{
			...
			object[] array2 = new object[2];
			array2[1] = Colours.stringAzureBlackmarket;
			array2[0] = MEJMLNDFDBP.CJCFPDLDMEK(426f, "ID_RANK", string.Empty, IEJMLKBCDJB: false);
