...
public class ArmyRightContent : Core_BaseScript
{
	...
	[FormerlySerializedAs("BPNPABIPGBN")]
	public GameObject GDCNCNGOPIH;

	[FormerlySerializedAs("MEPFAOIPBKG")]
	public GameObject[] GOBKHCALGHA;

	[FormerlySerializedAs("ABMNGGAFJDF")]
	public UILabel JGIGODHJNMO;

	[FormerlySerializedAs("NMFMBFEDLCJ")]
	[Header("-Army Unit Type")]
	public UILabel AODBLOCIBAM;

	[FormerlySerializedAs("mArmyHybridIcon")]
	public UISprite JHNJAPJJKMD;

	[FormerlySerializedAs("ENFPNNCLEPJ")]
	public UISprite CJPLJHJPGAN;

	[FormerlySerializedAs("LNGLHFCDHDE")]
	public UILabel ALEFOLOOMIH;

	[FormerlySerializedAs("FPLCIJOCCFL")]
	public UILabel NENIJEEPPBJ;

	[Header("-Army Rating - Unit Power")]
	[FormerlySerializedAs("mSuperChargedCategoryLabel")]
	public UILabel OPMJLGFLNJB;

	[FormerlySerializedAs("mSuperChargedEffectLabel")]
	public UILabel JANJPPELPBG;

	[FormerlySerializedAs("mSuperChargedHintCollider")]
	public BoxCollider OKLHOACLPDG;

	[FormerlySerializedAs("mSuperChargedHintSprite")]
	public UISprite PKAGCKHJODA;

	[FormerlySerializedAs("mSuperChargedHintLabel")]
	public UILabel BKOOOBJDJHO;

	[FormerlySerializedAs("OFNEAMFIPJG")]
	public UILabel FEJELKKFMPK;

	[FormerlySerializedAs("IFNNFKPKBBJ")]
	public UISprite DOIHNIFPOLP;

	[FormerlySerializedAs("DLLNGAKMNBM")]
	public UILabel GHKLHGDNAAC;

	[FormerlySerializedAs("KAHHGBOJLLH")]
	public UILabel PMDCIMIFLMD;

	[FormerlySerializedAs("MHKHKBJFPDN")]
	public UISprite LHLNNPGFOKE;

	[FormerlySerializedAs("OMGNGGJDABA")]
	public UILabel IKNDFOJPCJP;

	[FormerlySerializedAs("PHBEABJANEI")]
	public UILabel APEPPPIIANB;

	[FormerlySerializedAs("KDNBKBLCJNC")]
	public UISprite FAMLAICPKAP;

	[FormerlySerializedAs("AELDEHFFEBD")]
	public UILabel AGELGEBACHH;

	[FormerlySerializedAs("MHDCKIMEKIE")]
	public UILabel CKAKEFGAIEN;

	[FormerlySerializedAs("EOKGPNPANHJ")]
	public UISprite JJKPAKGNMCP;

	[FormerlySerializedAs("CEMJCKKPJBB")]
	public UILabel IKBHFOFDEHK;

	[FormerlySerializedAs("DLBIDOHNDPO")]
	public UISprite EOEGBEKBJEM;

	[FormerlySerializedAs("MDIDEIMHBMP")]
	public UISprite EHNNKBIFOCP;

	[FormerlySerializedAs("DMNHPJMEKDE")]
	[Header("--Army Hint Statistics")]
	public BoxCollider OKDNHPCJFLB;

	[FormerlySerializedAs("GNKEMJNPCFG")]
	public UIPanel GGMOJMMLEKA;

	[FormerlySerializedAs("GHNGJGHMFML")]
	public UILabel OMGFCIHDGIB;

	[FormerlySerializedAs("HNDJANPBLLI")]
	public UITable BHBAPKGBANI;

	[FormerlySerializedAs("GLIIIBBMDGA")]
	public UILabel IKNLLGBNMAB;

	[FormerlySerializedAs("OFAGCOJIMHK")]
	public UISprite[] LHNGDJNBDKK;

	[FormerlySerializedAs("LEJDFBCFPMP")]
	public UILabel BKMGNFFEJDB;

	[FormerlySerializedAs("JEPHNIIFKDM")]
	public UILabel OMEMJGFOEPO;

	[FormerlySerializedAs("KAHJPNABPAC")]
	public UILabel DCBCIOILMNB;

	[FormerlySerializedAs("FGANCNPCLBK")]
	public UILabel PDLEOCMNIJJ;

	[FormerlySerializedAs("PEDBOCAKBFB")]
	public UILabel BAOHBIDKMHP;

	[FormerlySerializedAs("mSecondUnitSpecificLabel")]
	public UILabel FKGOPBHJNCC;

	[FormerlySerializedAs("mSecondUnitSpecificValue")]
	public UILabel IPBIOHCKOLD;

	[FormerlySerializedAs("mThirdUnitSpecificLabel")]
	public UILabel EKPANJBEICA;

	[FormerlySerializedAs("mThirdUnitSpecificValue")]
	public UILabel JMELHLPBHIH;

	[FormerlySerializedAs("mForthUnitSpecificLabel")]
	public UILabel MFANFFJGJDK;

	[FormerlySerializedAs("mForthUnitSpecificValue")]
	public UILabel HGJCLKGJLND;

	[Header("-Button")]
	[FormerlySerializedAs("AIKPCPNBHKP")]
	...
	[Header("---Sale Part")]
	[FormerlySerializedAs("mSubscriberOnlyPart")]
	...
	[Header("--Deliver Now")]
	[FormerlySerializedAs("mTransitionOfferPart")]
	public GameObject LNFLDPLGEJE;

	[FormerlySerializedAs("mTransitionOfferPercent")]
	...
	private float HPNPMCEMJNM => 705f + UIHelper.safeAreaSize;
	...
	private void FOPKJKDCDON()
	{
		...
		GGMOJMMLEKA.gameObject.SetActive(value: false);
		OJBKADHPNFN = false;
	}
	...
	private void HODIEAACBED()
	{
		if (!GGMOJMMLEKA.gameObject.activeSelf)
		{
			...
			GGMOJMMLEKA.gameObject.SetActive(value: true);
			OJBKADHPNFN = true;
	...
	private void EAKECIHGCLC()
	{
		...
		KEFCFMIDHBF(FAMLAICPKAP, HMFNIBOFGMB: false, flag2);
	...
	public void LHFBPFKOONF(float EJEDANLAMBI, float PAENPHMEMGC)
	{
		...
		LPPOJMGOEFN.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "Already loading player data, wait", string.Empty, IEJMLKBCDJB: false);
	...
	private void BDDIDGFEJEN(GameObject KHAHPAKDIKE)
	{
		...
		case UpgradeSlots.JLANLLEABDC.UnitDelivering:
			...
			GHCIIJEDFND();
			GuiScreenSingle<ArmyScreen>.instance.FHFIPPFJIAH.AGJKPJANEBC(IDEBKDPMPGM: true);
			break;
	...
	{
		NDDIDNIJAPK();
		TweenPosition.Begin(EPFODCCNGDL.gameObject, JCAFFELIFAO, EPFODCCNGDL.transform.localPosition.ReplaceX(754f), useLocal: false);
	}
	...
	public void MNIBCGDEAHG(float EJEDANLAMBI, float PAENPHMEMGC)
	{
		...
		IAIHLFMNAOA.fillAmount = Mathf.Clamp01(PAENPHMEMGC);
		LPPOJMGOEFN.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "country-portugal", string.Empty, IEJMLKBCDJB: false);
		string text = MEJMLNDFDBP.GMIPFLIEOHD(IFFDIHCPKFE.upgradeSlots.instantUnitDeliveryPrice);
		if (GPBMPAPOEOE.text != text)
		{
			GPBMPAPOEOE.text = text;
	...
	private void EMMKHDAGKCO()
	{
		...
		AIOPMALGJJN(FAMLAICPKAP, HMFNIBOFGMB: false, flag2);
	...
	public void DJOEGBIMLOK(bool NOLODGKKCDH = true)
	{
		...
		{
			TweenPosition.Begin(EPFODCCNGDL.gameObject, JCAFFELIFAO, EPFODCCNGDL.transform.localPosition.ReplaceX(DLELKMDPODO()), useLocal: false);
	...
	public void LPOPNGPOKIN(float EJEDANLAMBI, float PAENPHMEMGC)
	{
		...
		IAIHLFMNAOA.fillAmount = Mathf.Clamp01(PAENPHMEMGC);
		LPPOJMGOEFN.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "GetVGOfferInfoForZone", string.Empty, IEJMLKBCDJB: false);
		string text = MEJMLNDFDBP.GMIPFLIEOHD(IFFDIHCPKFE.upgradeSlots.instantUnitDeliveryPrice);
		if (GPBMPAPOEOE.text != text)
		{
			GPBMPAPOEOE.text = text;
	...
	private void BNACCFOJBOI(GameObject KHAHPAKDIKE)
	{
		...
		case UpgradeSlots.JLANLLEABDC.UnitDelivering:
			Debug.Log("07");
			CMMFJNGPAAB();
			GuiScreenSingle<ArmyScreen>.instance.FHFIPPFJIAH.NCDHKBKPPMG(IDEBKDPMPGM: false);
			break;
		case UpgradeSlots.JLANLLEABDC.UnitDelivered:
	...
	private void JDGDJDDANFA()
	{
		...
		if (levelBehaviour != null)
		{
			...
			else
			{
				...
				{
					GuiElementSingle<OtherUpgradeDialog>.instance.ShowDialogUnits(levelBehaviour, IFFDIHCPKFE, JBAIGADPMCI: false);
					return;
				}
				GuiScreenSingle<ArmyScreen>.instance.NGAOKIAMKAD(levelBehaviour, CDMKCIKHIMM: true);
			}
		}
	...
	{
		KDHACIJKGNH();
		TweenPosition.Begin(EPFODCCNGDL.gameObject, JCAFFELIFAO, EPFODCCNGDL.transform.localPosition.ReplaceX(1863f), useLocal: false);
	}
	...
	{
		NDNNJMAKKBD();
		TweenPosition.Begin(EPFODCCNGDL.gameObject, JCAFFELIFAO, EPFODCCNGDL.transform.localPosition.ReplaceX(601f), useLocal: false);
	}
	...
	{
		NLDFGEFNLNL();
		TweenPosition.Begin(EPFODCCNGDL.gameObject, JCAFFELIFAO, EPFODCCNGDL.transform.localPosition.ReplaceX(1448f), useLocal: false);
	}
	...
	private void HMAPLDEANJF()
	{
		...
		if (num > 0)
		{
			Debug.Log($"Have discount {num} to buy {IFFDIHCPKFE.upgradeSlots.GetSheetName()}");
		}
		if (!Singleton<Wallet>.instance.CanBuyW(num2))
		{
	...
	{
		HLLEMKBDCHJ();
		TweenPosition.Begin(EPFODCCNGDL.gameObject, JCAFFELIFAO, EPFODCCNGDL.transform.localPosition.ReplaceX(596f), useLocal: false);
	}
	...
	public void FBBJKJGBOJL(bool NOLODGKKCDH = true)
	{
		...
		{
			TweenPosition.Begin(EPFODCCNGDL.gameObject, JCAFFELIFAO, EPFODCCNGDL.transform.localPosition.ReplaceX(ALNEPJFGINB()), useLocal: false).onFinished = HCPKABIHLKC;
		}
		...
		{
			TweenPosition.Begin(EPFODCCNGDL.gameObject, JCAFFELIFAO, EPFODCCNGDL.transform.localPosition.ReplaceX(ALNEPJFGINB()), useLocal: false);
	...
	public void CLPOIBICIJA(float EJEDANLAMBI, float PAENPHMEMGC)
	{
		...
		IAIHLFMNAOA.fillAmount = Mathf.Clamp01(PAENPHMEMGC);
		LPPOJMGOEFN.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "THANK YOU", string.Empty, IEJMLKBCDJB: false);
		string text = MEJMLNDFDBP.GMIPFLIEOHD(IFFDIHCPKFE.upgradeSlots.instantUnitDeliveryPrice);
		if (GPBMPAPOEOE.text != text)
		{
			GPBMPAPOEOE.text = text;
	...
	private void DBBCLFJHHGP()
	{
		...
		AIOPMALGJJN(FAMLAICPKAP, HMFNIBOFGMB: true, flag3);
	...
	public void NKNJCBEPGFK(bool NOLODGKKCDH = true)
	{
		if (NOLODGKKCDH)
		{
			TweenPosition.Begin(EPFODCCNGDL.gameObject, JCAFFELIFAO, EPFODCCNGDL.transform.localPosition.ReplaceX(692f), useLocal: false);
			NDNOOOOIMOJ();
		}
	...
	private void KPHGDHGCBOC(GameObject KHAHPAKDIKE)
	{
		...
		case UpgradeSlots.JLANLLEABDC.UnitDelivering:
			...
			FNIONNPPHCI();
			GuiScreenSingle<ArmyScreen>.instance.FHFIPPFJIAH.IGHALNDAGCL(IDEBKDPMPGM: true);
			break;
		case UpgradeSlots.JLANLLEABDC.UnitDelivered:
	...
	private void HACDMJBJHOD()
	{
		...
		AOMMBBJOMCE(FAMLAICPKAP, HMFNIBOFGMB: true, flag3);
	...
	private void LFAIFCNCIEM()
	{
		...
		BLJMMDILOLC(FAMLAICPKAP, HMFNIBOFGMB: true, flag4);
	...
	private void HGDDEHJJLNP()
	{
		...
		KEFCFMIDHBF(FAMLAICPKAP, HMFNIBOFGMB: true, flag4);
	...
	private void GBNAGBKIBML()
	{
		...
		MMJIFMCIAON(FAMLAICPKAP, HMFNIBOFGMB: false, flag4);
	...
	public void NOIMPGJIPPK(float EJEDANLAMBI, float PAENPHMEMGC)
	{
		...
		IAIHLFMNAOA.fillAmount = Mathf.Clamp01(PAENPHMEMGC);
		LPPOJMGOEFN.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "ID_GC_LOGIN_TUTORIAL_TEXT", string.Empty, IEJMLKBCDJB: false);
		string text = MEJMLNDFDBP.GMIPFLIEOHD(IFFDIHCPKFE.upgradeSlots.instantUnitDeliveryPrice);
		if (GPBMPAPOEOE.text != text)
		{
			GPBMPAPOEOE.text = text;
	...
	private void JGEAOHCLKPF()
	{
		...
		NMIDCFHHOOE(FAMLAICPKAP, HMFNIBOFGMB: true, flag3);
	...
	private void AGPCMJFLAIB()
	{
		...
		if (num > 0)
		{
			Debug.Log($"{num} {IFFDIHCPKFE.upgradeSlots.GetSheetName()}");
		}
		if (!Singleton<Wallet>.instance.CanBuyW(num2))
		{
		...
		if (levelBehaviour != null)
		{
			...
			else
			{
				...
				{
					GuiElementSingle<OtherUpgradeDialog>.instance.ECDBLKDFAMF(levelBehaviour, IFFDIHCPKFE, JBAIGADPMCI: true);
					return;
				}
				GuiScreenSingle<ArmyScreen>.instance.JOFEFBHDFIN(levelBehaviour, CDMKCIKHIMM: false);
			}
