...
public class BlackmarketWeaponRecord : Core_BaseScript
{
	...
	[FormerlySerializedAs("mHintForDuplicatesLabel")]
	[Header("Statistics")]
	[SerializeField]
	private UILabel mWeaponIncreasePower;

	[SerializeField]
	[FormerlySerializedAs("mWeaponIncreasePower")]
	private UILabel mWeaponCurrentPower;

	[FormerlySerializedAs("mWeaponCurrentPower")]
	[SerializeField]
	...
	public bool isHidden => PJHFOJMDKOA;
	...
	private void DMCJHEOPLNC(GameObject KHAHPAKDIKE)
	{
		OGDEIIGIILF = OGDEIIGIILF;
		mHintIcon.spriteName = ((!OGDEIIGIILF) ? MEJMLNDFDBP.NAMLCOOKDIO : MEJMLNDFDBP.HECFMGKKKMN);
		TweenPosition.Begin(mHintMoving, 383f, mHintMoving.transform.localPosition.ReplaceX((!OGDEIIGIILF) ? 1048f : 1140f), useLocal: false);
	}
