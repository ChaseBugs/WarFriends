...
public class GameModesContent : Core_BaseScript
{
	...
	private void NDNAFLDENOF()
	{
		if (JCKOBELDCGD)
		{
			...
			MCLKJNDAFKC.JDMPFHKFBBP(DLIIEJPDENK: false);
	...
	private void PJPJJKNPGEP()
	{
		...
		{
			DJOOIHBFJKC.enabled = true;
			MCLKJNDAFKC.GPMGLAMIFID(DLIIEJPDENK: true);
			BPLMAPCPGMN.HKKPCMGDEDC.enabled = false;
		}
		else
		{
	...
	public void GHGOGKMAIEM(GameObject KHAHPAKDIKE)
	{
		JCKOBELDCGD = false;
		HNPBPDLHFAE();
		UIPanel[] componentsInChildren = OMCNMJHAHOK.GetComponentsInChildren<UIPanel>(includeInactive: true);
		bool flag = false;
	...
	{
		OMCNMJHAHOK.SetActive(value: false);
		JCKOBELDCGD = false;
		FLAAHMHIKDA();
	...
	private void CFLKAOJGPMF(UITweener MGDJMGHCAAI)
	{
		JCKOBELDCGD = false;
		FLAAHMHIKDA();
		NIOPPLBGEOE.SetActive(value: false);
	}
	...
	private void BIEBPGOLOCM(UITweener MGDJMGHCAAI)
	{
		JCKOBELDCGD = true;
		EGPMIGNHICA();
		NIOPPLBGEOE.SetActive(value: true);
	}
	...
	private void KCNJPHKMGGI(UITweener MGDJMGHCAAI)
	{
		JCKOBELDCGD = true;
		EGPMIGNHICA();
		OMCNMJHAHOK.SetActive(value: true);
		IOKKIPMHNKI();
	}
	...
	private void OADCIKPKPCB(GameObject KHAHPAKDIKE)
	{
		...
		OMCNMJHAHOK.SetActive(value: true);
		BPLMAPCPGMN.IFAICOBKCLA();
		UIPanel[] componentsInChildren = OMCNMJHAHOK.GetComponentsInChildren<UIPanel>(includeInactive: false);
		bool flag = true;
	...
	private void EDEANOHKOCC()
	{
		...
		{
			DJOOIHBFJKC.enabled = false;
			MCLKJNDAFKC.HNIOANBCJBE(DLIIEJPDENK: true);
			BPLMAPCPGMN.HKKPCMGDEDC.enabled = false;
		}
		else
		{
	...
	private void EGPMIGNHICA()
	{
		...
		{
			DJOOIHBFJKC.enabled = false;
			MCLKJNDAFKC.SetCollider(DLIIEJPDENK: false);
			BPLMAPCPGMN.HKKPCMGDEDC.enabled = false;
		}
		else
		{
	...
	private void LBILFDEAILE()
	{
		...
		{
			DJOOIHBFJKC.enabled = true;
			MCLKJNDAFKC.BNINAFFNEMN(DLIIEJPDENK: true);
	...
	private void FLAAHMHIKDA()
	{
		...
		{
			DJOOIHBFJKC.enabled = false;
			MCLKJNDAFKC.SetCollider(DLIIEJPDENK: true);
			BPLMAPCPGMN.HKKPCMGDEDC.enabled = false;
		}
		else
		{
