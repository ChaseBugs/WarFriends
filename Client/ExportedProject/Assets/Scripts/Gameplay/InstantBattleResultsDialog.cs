...
public class InstantBattleResultsDialog : GuiElementSingle<InstantBattleResultsDialog>, PAIIOKBBHBC
{
	...
	[FormerlySerializedAs("BNNNFOPMMLF")]
	public BoxCollider LMMNICNFIPH;

	[FormerlySerializedAs("CMNLKBAPGLM")]
	[Header("Rewards")]
	public SetInstantBattleRewards JPMFEINCHNP;

	[FormerlySerializedAs("AIMMHJBCPAG")]
	public SetInstantBattleRewards HKDPDFLOEDK;

	[FormerlySerializedAs("JHMFLOFBDHD")]
	public SetInstantBattleRewards AGBEGILONLK;

	[Header("Unlock")]
	[FormerlySerializedAs("LNHDNODOKLB")]
	public UILabel OIBCMHANALH;

	[FormerlySerializedAs("GAKCHKPHHAJ")]
	public UISprite ECDJAAAKMOF;

	[FormerlySerializedAs("MMNKAOCKJLL")]
	public UISprite GHOAHINBKGH;

	[FormerlySerializedAs("NHOKCGOFLAM")]
	public UISprite PAPLCDHJIBJ;

	[FormerlySerializedAs("MCLMEBMOCPK")]
	...
	public override void InitGUIValues()
	{
		...
		GHOAHINBKGH.gameObject.SetActive(value: true);
	...
	{
		GHOAHINBKGH.gameObject.SetActive(value: false);
		LMMNICNFIPH.enabled = false;
