...
public class InappLootboxes : Core_BaseScript
{
	private sealed class HAJEIGIFBOO
	{
		...
		internal void FIBGJHCGHJH(UITweener MGDJMGHCAAI)
		{
			...
			{
				BJGCPDNMHDH.HDBKEMNLOJD(PDPDGCNHCFN: true);
			}
		}
		...
		internal void LGJCNCHBFDA(UITweener MGDJMGHCAAI)
		{
			...
			{
				BJGCPDNMHDH.CKONFJBHNDL(PDPDGCNHCFN: true);
			}
		}
		...
		internal void ECPMEMNKMCB(UITweener MGDJMGHCAAI)
		{
			...
			{
				BJGCPDNMHDH.HGGOBMNLBIJ(PDPDGCNHCFN: true);
			}
		}
	}
	...
	[FormerlySerializedAs("MBALHDIAEFK")]
	public UIPanel ILKPDBKMAGE;

	[FormerlySerializedAs("AIAGHAJDFFE")]
	...
	{
		PIDCGBIALAD.AlignToPos(PDPDGCNHCFN, UIDraggablePanel.Alingment.BottomRight, onePanelDisabledAfterAlign: true);
	}
