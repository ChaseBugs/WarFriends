...
public class ChatButtonUnderline : Core_BaseScript
{
	...
	private void LGNNDCCOKEC(bool GCGOGMDOBED)
	{
		...
		if (GCGOGMDOBED)
		{
			TweenPosition tweenPosition = TweenPosition.Begin(FKLKLCBOMNE.gameObject, 981f, FKLKLCBOMNE.transform.localPosition.ReplaceY(BKHNNGLJJDI), FKLKLCBOMNE.transform.localPosition.ReplaceY(BKHNNGLJJDI + 1545f), useLocal: false);
	...
	private void AOIPHCKEKFP(bool GCGOGMDOBED)
	{
		...
		if (GCGOGMDOBED)
		{
			TweenPosition tweenPosition = TweenPosition.Begin(FKLKLCBOMNE.gameObject, 1476f, FKLKLCBOMNE.transform.localPosition.ReplaceY(BKHNNGLJJDI), FKLKLCBOMNE.transform.localPosition.ReplaceY(BKHNNGLJJDI + 1722f), useLocal: false);
	...
	private void KKGKDLDCDCJ(bool GCGOGMDOBED)
	{
		...
		if (GCGOGMDOBED)
		{
			TweenPosition tweenPosition = TweenPosition.Begin(FKLKLCBOMNE.gameObject, 102f, FKLKLCBOMNE.transform.localPosition.ReplaceY(BKHNNGLJJDI), FKLKLCBOMNE.transform.localPosition.ReplaceY(BKHNNGLJJDI + 640f), useLocal: false);
			tweenPosition.style = UITweener.Style.Once;
			tweenPosition.NumOfRepetitions = 6;
			return;
		}
