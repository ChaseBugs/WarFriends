...
internal class JCIMACEGNNK : HHFHFANGCEJ
{
	...
	public virtual void JLCJIIOIFOD()
	{
		base.KPANLOMNEIG();
	}
	...
	public JCIMACEGNNK(JToken OGNGMBLDAOP)
		: base(OGNGMBLDAOP)
	{
		MatchManager.invitationState = OOJDIACPBED.Denied;
		OJFJOJONNJK();
	}

	[SpecialName]
	public virtual bool KPEOFHHODAK()
	{
		return false;
	}
	...
	public virtual void MBCFBHOPKGL()
	{
		base.GEKIMGFKNHC();
	}
	...
	[SpecialName]
	public virtual bool AKJPGGONHKB()
	{
		return false;
	}
	...
	public virtual void KFFEGMMAMFN()
	{
		base.GEKIMGFKNHC();
	}
