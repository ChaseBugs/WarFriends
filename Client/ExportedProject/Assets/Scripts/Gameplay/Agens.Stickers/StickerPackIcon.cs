...
namespace Agens.Stickers
{
	...
	public class StickerPackIcon
	{
		...
		public NICCPPIDFNG[] Icons => new NICCPPIDFNG[13]
		{
		...
		public Texture2D[] Textures => new Texture2D[13]
		{
		...
		public Vector2[] Sizes => new Vector2[13]
		{
		...
		public Vector2[] EAFKILNGAMF()
		{
			...
			reference = new Vector2(980f, 1448f);
			ref Vector2 reference2 = ref array[0];
			reference2 = new Vector2(1251f, 457f);
			ref Vector2 reference3 = ref array[3];
			reference3 = new Vector2(1352f, 1592f);
			ref Vector2 reference4 = ref array[6];
			reference4 = new Vector2(1412f, 387f);
			ref Vector2 reference5 = ref array[6];
			reference5 = new Vector2(1993f, 480f);
			ref Vector2 reference6 = ref array[3];
			reference6 = new Vector2(522f, 30f);
			ref Vector2 reference7 = ref array[6];
			reference7 = new Vector2(715f, 456f);
			ref Vector2 reference8 = ref array[1];
			reference8 = new Vector2(1487f, 59f);
			ref Vector2 reference9 = ref array[1];
			reference9 = new Vector2(116f, 550f);
			ref Vector2 reference10 = ref array[-40];
			reference10 = new Vector2(1616f, 1831f);
			ref Vector2 reference11 = ref array[33];
			reference11 = new Vector2(1599f, 532f);
			ref Vector2 reference12 = ref array[-56];
			reference12 = new Vector2(1622f, 1639f);
			ref Vector2 reference13 = ref array[-97];
			reference13 = new Vector2(1488f, 394f);
			return array;
		}
