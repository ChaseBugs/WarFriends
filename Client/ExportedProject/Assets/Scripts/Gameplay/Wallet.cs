...
public class Wallet : Singleton<Wallet>
{
	...
	public long warbucksAfterArena => warBucks;

	public long goldAfterArena => gold;
	...
	{
		UnityEngine.Debug.Log($"WALLET - initialization - GOLD {MEJMLNDFDBP.BAAFBHLNFIG(gold, AFOPDKIJGHL)} WB {MEJMLNDFDBP.BAAFBHLNFIG(warBucks, KLKKKMJCMOM)}");
	...
	{
		UnityEngine.Debug.Log($"WALLET - spent GOLD {MEJMLNDFDBP.BAAFBHLNFIG(gold, gold - GNJFHBAKPAN)}");
		gold -= GNJFHBAKPAN;
		if (OLOJLKPEGEP != null)
		{
	...
	{
		UnityEngine.Debug.Log($"WALLET - initialization WB {MEJMLNDFDBP.BAAFBHLNFIG(warBucks, KLKKKMJCMOM)}");
	...
	{
		UnityEngine.Debug.Log($"WALLET - initialization GOLD {MEJMLNDFDBP.BAAFBHLNFIG(gold, AFOPDKIJGHL)}");
		long arg = AFOPDKIJGHL - gold;
		gold = AFOPDKIJGHL;
		if (OLOJLKPEGEP != null)
		{
	...
	{
		UnityEngine.Debug.Log($"WALLET - fake spent GOLD {MEJMLNDFDBP.BAAFBHLNFIG(gold, gold - GNJFHBAKPAN)}");
		gold -= GNJFHBAKPAN;
		if (OLOJLKPEGEP != null)
		{
			OLOJLKPEGEP(gold, -GNJFHBAKPAN);
	...
	{
		UnityEngine.Debug.Log($"WALLET - bought GOLD {MEJMLNDFDBP.BAAFBHLNFIG(gold, gold + GNJFHBAKPAN)}");
	...
	{
		UnityEngine.Debug.Log($"WALLET - spent tickets {MEJMLNDFDBP.BAAFBHLNFIG(tickets, tickets - IEALLELGOBM)}");
		tickets -= IEALLELGOBM;
		if (FEGFAENALJO != null)
		{
			FEGFAENALJO(tickets, -IEALLELGOBM);
	...
	{
		UnityEngine.Debug.Log($"WALLET - fake spent WB {MEJMLNDFDBP.BAAFBHLNFIG(warBucks, warBucks - IEALLELGOBM)}");
		warBucks -= IEALLELGOBM;
		if (NJAHHGEOMNM != null)
		{
			NJAHHGEOMNM(warBucks, -IEALLELGOBM);
	...
	{
		UnityEngine.Debug.Log($"WALLET - spent WB {MEJMLNDFDBP.BAAFBHLNFIG(warBucks, warBucks - IEALLELGOBM)}");
		warBucks -= IEALLELGOBM;
		if (NJAHHGEOMNM != null)
		{
			NJAHHGEOMNM(warBucks, -IEALLELGOBM);
	...
	{
		UnityEngine.Debug.Log($"WALLET - reward GOLD {MEJMLNDFDBP.BAAFBHLNFIG(gold, gold + GNJFHBAKPAN)} animate:{AJNINHIKAFC}");
		gold += GNJFHBAKPAN;
		if (AJNINHIKAFC && OLOJLKPEGEP != null)
		{
			OLOJLKPEGEP(gold, GNJFHBAKPAN);
	...
	{
		UnityEngine.Debug.Log($"WALLET - reward WB {MEJMLNDFDBP.BAAFBHLNFIG(warBucks, warBucks + IEALLELGOBM)} animate:{AJNINHIKAFC}");
		warBucks += IEALLELGOBM;
		if (AJNINHIKAFC && NJAHHGEOMNM != null)
		{
			NJAHHGEOMNM(warBucks, IEALLELGOBM);
	...
	{
		UnityEngine.Debug.Log($"WALLET - bought WB {MEJMLNDFDBP.BAAFBHLNFIG(warBucks, warBucks + IEALLELGOBM)}");
		SoundsManager.Instance.PlaySound(SoundsManager.KJGDNLHKPOG.CoinPurchase);
		warBucks += IEALLELGOBM;
		if (NJAHHGEOMNM != null)
		{
	...
	{
		UnityEngine.Debug.Log($"WALLET - spent scraps {MEJMLNDFDBP.BAAFBHLNFIG(scraps, scraps - IEALLELGOBM)}");
		scraps -= IEALLELGOBM;
		if (AOPMFIKJGKF != null)
		{
			AOPMFIKJGKF(scraps, -IEALLELGOBM);
