...
{
	[FormerlySerializedAs("DNOHILKLHKC")]
	[Header("Core")]
	public UIPanel HNLBEOIIJCP;

	[FormerlySerializedAs("ACKPLAAJLGF")]
	public GameObject JKGHPLKKPLE;

	[FormerlySerializedAs("FGGMABKFOFF")]
	public UITable HDFKOABOICJ;

	[FormerlySerializedAs("HLCAGBOHAGB")]
	public UISprite[] BALFMMAPJLN;

	[FormerlySerializedAs("FHGJDCKHHKC")]
	public UILabel NEKIBLFNDJJ;

	[FormerlySerializedAs("CENDAGENCCC")]
	public ArmyUnitStatistics JFECAHAKAND;

	[FormerlySerializedAs("JLJHNEHMMOP")]
	public ArmyUnitStatistics PLJAHLHLJOA;

	[FormerlySerializedAs("CFMICOPJMKM")]
	public ArmyPowerAnimation GHGJLMAJJGG;

	[FormerlySerializedAs("ANEMDCENBNI")]
	[Header("-Upgrade Button")]
	public GameObject KPMOMJNFELI;

	[FormerlySerializedAs("FBEIEFLNAOA")]
	public UITable LCIPCONLPGE;

	[FormerlySerializedAs("JHKMCGOKJNO")]
	public UILabel HKGGCIGOONK;

	[FormerlySerializedAs("GJBIHAKALLA")]
	public GameObject GKFCJANHFOI;

	[FormerlySerializedAs("AKHDLFCFAJA")]
	public UILabel CPNOCPEFAAG;

	[FormerlySerializedAs("JNNPGNKOCIF")]
	public WinStreakCounter AIPKGLCJCAE;

	[FormerlySerializedAs("NACINBFGFEM")]
	[Header("-Deliver now Button")]
	public GameObject GEIOMOLICCC;

	[FormerlySerializedAs("PAFMHHAFHNF")]
	public UILabel PHPMMLNNLDA;

	[FormerlySerializedAs("CMFFMOLLHKN")]
	public UILabel MPEBFNCHINC;

	[FormerlySerializedAs("CHIPECBICBA")]
	public UISprite GHKALFDLHOO;

	[FormerlySerializedAs("KKCDOPKOBPN")]
	public UITable LEOBAFLAJLF;

	[FormerlySerializedAs("CEKGCIEIIFN")]
	public UILabel BDJMJKALCDA;

	[SerializeField]
	[FormerlySerializedAs("mUnitButtonDeliverSalePart")]
	[Header("--Subsccription")]
	private GameObject mSubscriptionPart;

	[SerializeField]
	[FormerlySerializedAs("mUnitButtonDeliverSaleLabel")]
	private UILabel mSubscriptionHint;

	[FormerlySerializedAs("mUnitButtonDeliveryTimeSale")]
	...
	[FormerlySerializedAs("DKLFBGFGPMG")]
	public BoxCollider PKENJHFCOLE;

	[FormerlySerializedAs("KLEKBALBJCL")]
	public UISprite FKBECJHKHDF;

	[FormerlySerializedAs("KEBKOCBMMNH")]
	public UITable CNFJGPHLDLP;

	[FormerlySerializedAs("CDKCEHHICEK")]
	public UILabel JCEODHLJJBD;

	[FormerlySerializedAs("CLCLLIGNBNN")]
	public UISprite[] GHGIMHLODBM;

	[FormerlySerializedAs("FABMMGNEOOC")]
	public UISprite NPGBFCGCECI;

	[FormerlySerializedAs("CHJDCFBLJJI")]
	public UILabel LIOALOJLHKI;

	[FormerlySerializedAs("FKFABAEONLK")]
	public UISprite MBCEFIINFLB;

	[FormerlySerializedAs("ECEGLBNKOIJ")]
	public UILabel LOAMICJLCCN;

	[FormerlySerializedAs("IKMOFEFMGCG")]
	public GameObject ABDADCEJOID;

	[FormerlySerializedAs("HOEAHCBPAFC")]
	[Header("-Max Button")]
	public GameObject LBGIFBDFHFO;

	[FormerlySerializedAs("MLGFMIEADMA")]
	...
	public void MCJEBLNCJMM()
	{
		...
		{
			CNBJMDECEJG = false;
			JKGHPLKKPLE.SetActive(value: true);
			...
			ECILIHAEHGN();
			BHMGBEIDINC();
			UIPanel[] componentsInChildren = JKGHPLKKPLE.GetComponentsInChildren<UIPanel>(includeInactive: true);
	...
	private void FGCPBAKOBMI(GameObject KHAHPAKDIKE)
	{
		...
		if (levelBehaviour != null)
		{
			...
			else
			{
				...
				{
					GuiElementSingle<OtherUpgradeDialog>.instance.AGNPEGKPDPC(levelBehaviour, IFFDIHCPKFE, JBAIGADPMCI: false);
					return;
				}
				GuiScreenSingle<ArmyScreen>.instance.DPJBOLDMLMH(levelBehaviour, CDMKCIKHIMM: false);
				ABLGPDJDAHO();
			}
		}
	...
	private void MBMDIHIDILO(GameObject KHAHPAKDIKE)
	{
		...
		if (levelBehaviour != null)
		{
			...
			else
			{
				if (levelBehaviour.upgradeSlots.unitState != UpgradeSlots.JLANLLEABDC.UnitDelivering)
				{
					GuiElementSingle<OtherUpgradeDialog>.instance.FKMGFKKGJFN(levelBehaviour, IFFDIHCPKFE, JBAIGADPMCI: true);
					return;
				}
				GuiScreenSingle<ArmyScreen>.instance.JOFEFBHDFIN(levelBehaviour, CDMKCIKHIMM: true);
				ABLGPDJDAHO();
			}
		}
		Singleton<Wallet>.instance.BKLFEOMJMFC(num2);
	...
	public void FMEMGEELIKG()
	{
		if (CNBJMDECEJG)
		{
			...
			TweenPosition.Begin(JKGHPLKKPLE, JCAFFELIFAO / 703f, new Vector3(846f, 134f, 1356f), useLocal: false).onFinished = CMIEJHLDHPM;
			UIPanel[] componentsInChildren = JKGHPLKKPLE.GetComponentsInChildren<UIPanel>(includeInactive: false);
	...
	private void HOAHBDHIPHN()
	{
		...
		JFECAHAKAND.GCBFCCNLMDN(tuple, bought, jHFKBODINGN, LPFLPCOLHPJ: true);
		PLJAHLHLJOA.ONGAIEOAHMA(tuple2, bought, jHFKBODINGN, LPFLPCOLHPJ: true);
		SetSaleAndPrize();
	...
	{
		int armyPowerX = LevelManager.instance.armyPowerX10;
		GuiScreenSingle<ArmyScreen>.instance.DPJBOLDMLMH(IFFDIHCPKFE, CDMKCIKHIMM: true);
	...
	private void JFOGKJNGKEJ()
	{
		...
		JFECAHAKAND.OAMBDKHLJKI(tuple, bought, jHFKBODINGN, LPFLPCOLHPJ: true);
	...
	private void KEADAOCDAID(UITweener MGDJMGHCAAI)
	{
		if (CNBJMDECEJG)
		{
			TweenPosition.Begin(JKGHPLKKPLE, JCAFFELIFAO / 1088f, new Vector3(1522f, 278f, 1511f), useLocal: false).onFinished = null;
		}
	}
	...
	{
		int armyPowerX = LevelManager.instance.armyPowerX10;
		GuiScreenSingle<ArmyScreen>.instance.NGAOKIAMKAD(IFFDIHCPKFE, CDMKCIKHIMM: false);
	...
	private void CMIEJHLDHPM(UITweener MGDJMGHCAAI)
	{
		if (!CNBJMDECEJG)
		{
			JKGHPLKKPLE.SetActive(value: false);
		}
	}
	...
	private void HJAGOMAFIFN(GameObject KHAHPAKDIKE)
	{
		...
		if (levelBehaviour != null)
		{
			...
			else
			{
				...
				{
					GuiElementSingle<OtherUpgradeDialog>.instance.AGNPEGKPDPC(levelBehaviour, IFFDIHCPKFE, JBAIGADPMCI: true);
					return;
				}
				GuiScreenSingle<ArmyScreen>.instance.NGAOKIAMKAD(levelBehaviour, CDMKCIKHIMM: false);
				OKPKDAHFPCI();
			}
		}
		Singleton<Wallet>.instance.CDIDDJGINID(num2);
		GuiScreenSingle<ArmyScreen>.instance.PGBNFKHKNGE(IFFDIHCPKFE, num, LANBHLJINFJ: true);
	...
	{
		GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MLPCPLNGOHB.UpdateLeftContent(NOLODGKKCDH: false);
		GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.KEHDDJNMMMB.APDJJBILBIM(NOLODGKKCDH: false);
	}
	...
	private void GOMPNKDBPFN(GameObject KHAHPAKDIKE)
	{
		...
		int armyPowerX = LevelManager.instance.armyPowerX10;
		Singleton<Wallet>.instance.ALBICJOEMEF(instantBuyPrice);
		GuiScreenSingle<ArmyScreen>.instance.ANLLAOJLPGN(IFFDIHCPKFE, CDMKCIKHIMM: false);
	...
	{
		int armyPowerX = LevelManager.instance.armyPowerX10;
		GuiScreenSingle<ArmyScreen>.instance.NGAOKIAMKAD(IFFDIHCPKFE, CDMKCIKHIMM: true);
	...
	public void GKCAKMLOIBI()
	{
		if (!CNBJMDECEJG)
		{
			...
			TweenPosition.Begin(JKGHPLKKPLE, JCAFFELIFAO / 1834f, new Vector3(162f, 744f, 104f), new Vector3(1528f, 1134f, 134f), useLocal: false).onFinished = NIDGBJICFLB;
			FPPPLPHDBMO();
			KIOOEACJNOD();
			UIPanel[] componentsInChildren = JKGHPLKKPLE.GetComponentsInChildren<UIPanel>(includeInactive: true);
	...
	public void KGBCNPBBBOE()
	{
		if (CNBJMDECEJG)
		{
			...
			TweenPosition.Begin(JKGHPLKKPLE, JCAFFELIFAO / 1516f, new Vector3(1030f, 1525f, 334f), useLocal: false).onFinished = CMIEJHLDHPM;
			UIPanel[] componentsInChildren = JKGHPLKKPLE.GetComponentsInChildren<UIPanel>(includeInactive: true);
			foreach (UIPanel uIPanel in componentsInChildren)
			{
	...
	public void OENGJJJMJOL(float EJEDANLAMBI, float PAENPHMEMGC)
	{
		...
		int num = MEJMLNDFDBP.LJDADOKBBNA(EJEDANLAMBI);
		GHKALFDLHOO.fillAmount = Mathf.Clamp01(PAENPHMEMGC);
		PHPMMLNNLDA.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "ID_LEAGUESTAYHINT2", string.Empty, IEJMLKBCDJB: false);
		string text = MEJMLNDFDBP.GMIPFLIEOHD(IFFDIHCPKFE.upgradeSlots.instantUnitDeliveryPrice);
		if (BDJMJKALCDA.text != text)
		{
			BDJMJKALCDA.text = text;
	...
	private void NJIABKBJLJA(GameObject KHAHPAKDIKE)
	{
		...
		if (levelBehaviour != null)
		{
			...
			else
			{
				if (levelBehaviour.upgradeSlots.unitState != UpgradeSlots.JLANLLEABDC.Locked)
				{
					GuiElementSingle<OtherUpgradeDialog>.instance.MHFEPMNAFDG(levelBehaviour, IFFDIHCPKFE, JBAIGADPMCI: true);
					return;
				}
				GuiScreenSingle<ArmyScreen>.instance.DPJBOLDMLMH(levelBehaviour, CDMKCIKHIMM: false);
				OKPKDAHFPCI();
	...
	private void LHPMPGACKPI()
	{
		...
		JFECAHAKAND.GCBFCCNLMDN(tuple, bought, jHFKBODINGN, LPFLPCOLHPJ: true);
		PLJAHLHLJOA.Initialize(tuple2, bought, jHFKBODINGN, LPFLPCOLHPJ: true);
		IOJKJKKMGPK();
		BDJMJKALCDA.text = string.Empty;
		TweenAlpha component = PHPMMLNNLDA.gameObject.GetComponent<TweenAlpha>();
		if (component != null)
	...
	private void NEDNLNICAJB()
	{
		...
		NEKIBLFNDJJ.text = $"{actualUnitLevel}{Colours.stringGray} / {actualMaxUnitLevel}";
		HDFKOABOICJ.repositionNow = true;
		bool bought = IFFDIHCPKFE.upgradeSlots.bought;
		...
		JFECAHAKAND.Initialize(tuple, bought, jHFKBODINGN, LPFLPCOLHPJ: true);
	...
	private void AJEHGEJBIJC(UITweener MGDJMGHCAAI)
	{
		if (CNBJMDECEJG)
		{
			TweenPosition.Begin(JKGHPLKKPLE, JCAFFELIFAO / 913f, new Vector3(91f, 928f, 902f), useLocal: false).onFinished = null;
		}
	}
	...
	private void CLNKGFMDBBN(UITweener MGDJMGHCAAI)
	{
		if (CNBJMDECEJG)
		{
			TweenPosition.Begin(JKGHPLKKPLE, JCAFFELIFAO / 568f, new Vector3(105f, 117f, 150f), useLocal: false).onFinished = null;
		}
	}
	...
	public void FAEKFHAALBJ()
	{
		...
		TweenPosition.Begin(JKGHPLKKPLE, JCAFFELIFAO / 519f, new Vector3(1087f, 879f, 1637f), useLocal: false).onFinished = delegate
		{
			if (!CNBJMDECEJG)
			{
				JKGHPLKKPLE.SetActive(value: false);
	...
	public void FGEBFIKIALJ()
	{
		if (!CNBJMDECEJG)
		{
			...
			TweenPosition.Begin(JKGHPLKKPLE, JCAFFELIFAO / 1847f, new Vector3(1247f, 1082f, 1679f), new Vector3(1860f, 1645f, 803f), useLocal: false).onFinished = AJEHGEJBIJC;
			EPAIAGGEIIF();
			FMINPJBPPIE();
			UIPanel[] componentsInChildren = JKGHPLKKPLE.GetComponentsInChildren<UIPanel>(includeInactive: false);
			for (int i = 0; i < componentsInChildren.Length; i += 0)
