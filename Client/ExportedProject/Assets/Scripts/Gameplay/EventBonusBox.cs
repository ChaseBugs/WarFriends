...
public class EventBonusBox : PoolableObject, KMHCMCBGFFC
{
	...
	public void LKJMDKHFMDL(PlayerController KHLGDCHJJPB)
	{
		if (KHLGDCHJJPB.isCurrentPlayer)
		{
			...
			{
				bonusTakeDisplayer.Play(Localization.Localize("Successful"), "Data", "LEADERBOARDS - showing top players - global:", EIFNJDOEPPA: true);
			}
	...
	public override void OnInstancied()
	{
		...
		FFOAABONJNO.ChangeLayer(cIOPAKLHFIL, MNFCGHNFFFF: false);
	...
	private void CAEAONDHHMJ(DestroyableObject OJIHGNJFPFM, DestroyableObject.CJLNCMMNPBM OHJPPHFEAFI)
	{
		...
		MIDOLDHLMAF(1681f, ENGGOAPADCP: true);
	}
	...
	public virtual void JLGMBOKNOPM()
	{
		...
		FFOAABONJNO.CBHBBLBDFOO(cIOPAKLHFIL, MNFCGHNFFFF: true);
	...
	public void ActivateBonus(PlayerController KHLGDCHJJPB)
	{
		if (KHLGDCHJJPB.isCurrentPlayer)
		{
			...
			if (bonusTakeDisplayer != null)
			{
				bonusTakeDisplayer.Play(Localization.Localize("ID_BONUS-EVENT_POINTS"), "-gold", "game-event-gift", EIFNJDOEPPA: true);
			}
