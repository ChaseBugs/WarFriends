...
public class CardsContent : Core_BaseScript
{
	...
	[FormerlySerializedAs("DIHFDBKEOAA")]
	public UILabel DKJJIIFHMEL;

	[FormerlySerializedAs("GDPHLCPNAEI")]
	[Header("Left Button")]
	...
	[FormerlySerializedAs("PPCHMCDBJDJ")]
	public UIDraggablePanel HKJLIGAMNKA;

	[FormerlySerializedAs("NLECEEPCKMB")]
	public UIGrid HBIPFOKMHAP;

	[Header("No Cards")]
	[FormerlySerializedAs("CNHCIDDLHNN")]
	...
	private void MCPICANHEAK()
	{
		...
		foreach (Card item2 in obtainedCards)
		{
			...
			CardRecord cardRecord = (CardRecord)IHFILHIAGLG.InstantiateAsChild(HMAGHPPJCND, HBIPFOKMHAP.gameObject, $"Card {5 - item2.rarityNumber} {item2.cardName} {IMBPEAIHHEG++}");
			if (cardRecord != null)
			{
