...
public class GameLauncher : Core_BaseScript
{
	...
	private sealed class JNAGDDONNMO : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool KHNDCDGBFJH()
		{
			...
			case 1u:
				...
				break;
			case 2u:
				BJGCPDNMHDH.HKAFPCAPDIG.gameObject.SetActive(value: false);
				BJGCPDNMHDH.ENMLDHGLIJN.gameObject.SetActive(value: true);
		...
		public bool FNEPBDLIKOD()
		{
			...
			case 1u:
				...
				break;
			case 2u:
				BJGCPDNMHDH.HKAFPCAPDIG.gameObject.SetActive(value: true);
				BJGCPDNMHDH.ENMLDHGLIJN.gameObject.SetActive(value: false);
	...
	private sealed class EDJCKHBMGAB : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MPKAJACHAIC()
		{
			...
			default:
				...
				BJGCPDNMHDH.FAGNMEOAFNF.SetActive(value: false);
		...
		public bool PMBOHHPPJAC()
		{
			...
			default:
				...
				BJGCPDNMHDH.FAGNMEOAFNF.SetActive(value: true);
	...
	[FormerlySerializedAs("HHMNPGBFCGK")]
	public GameObject FAGNMEOAFNF;

	[FormerlySerializedAs("BPKBNAKKDNA")]
	public GameObject HKAFPCAPDIG;

	public GameObject ENMLDHGLIJN;

	[FormerlySerializedAs("ENLMFHDJGEL")]
	public UIAtlas BINPHPBJPMD;

	[FormerlySerializedAs("BFHEDCCNDOB")]
	public DownloadAssetsDialog JDFMLCIODND;

	[FormerlySerializedAs("IGEOCBCECIF")]
	...
	[FormerlySerializedAs("LLNOFMPEKDF")]
	public GameObject IJBAHPOPPLA;

	[FormerlySerializedAs("KOJNDFALFMO")]
	public Camera AADLIDMHFLM;

	[FormerlySerializedAs("MOPKNAPHOPG")]
	...
	private void PAKHIIOAOBI()
	{
		...
		Terms.initialiseTermsSession(preCOPPA: true, useCustomSkin: false, Terms.ComplianceLevel.FULLY_COMPLIANT, isChinaOnly: false);
	}
	...
	private void ICBPFCJFJIA()
	{
		...
		Terms.initialiseTermsSession(preCOPPA: true, useCustomSkin: true, Terms.ComplianceLevel.FULLY_COMPLIANT_CHILD_SAFE_CONTENT, isChinaOnly: false);
	}
	...
	protected virtual void FIGOGIMJIIN()
	{
		...
		ENMLDHGLIJN.gameObject.SetActive(value: true);
		HKAFPCAPDIG.gameObject.SetActive(value: false);
	...
	private void ELPPGFCBFKL()
	{
		...
		Terms.initialiseTermsSession(preCOPPA: true, useCustomSkin: true, (Terms.ComplianceLevel)6, isChinaOnly: false);
	}
	...
	protected override void Awake()
	{
		...
		ENMLDHGLIJN.gameObject.SetActive(value: false);
		HKAFPCAPDIG.gameObject.SetActive(value: true);
		StartCoroutine(JIJEKLICJKE());
