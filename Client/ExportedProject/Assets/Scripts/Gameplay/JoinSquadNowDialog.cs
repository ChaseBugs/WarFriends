...
public class JoinSquadNowDialog : GuiElementSingle<JoinSquadNowDialog>, PAIIOKBBHBC
{
	...
	private void NMPOGNBLNAF(GameObject KHAHPAKDIKE)
	{
		...
		{
			WarningDialog.KHOMNBHMFGA(Localization.Localize("menu-wftv-mobcrush-ico"), Localization.Localize("menu-gold"), 682f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
		}
		else
		{
	...
	private void EMCOIPCCDEB(GameObject KHAHPAKDIKE)
	{
		...
		{
			WarningDialog.JACKIDKHKAI(Localization.Localize("check offer"), Localization.Localize("ID_WARNING_ERRORCLAIMEVENT"), 1187f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
		}
		else
		{
