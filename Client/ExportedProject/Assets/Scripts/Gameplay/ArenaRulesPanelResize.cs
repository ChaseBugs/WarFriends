...
public class ArenaRulesPanelResize : Core_BaseScript
{
	...
	[FormerlySerializedAs("HCBDJJAPDMK")]
	...
	[FormerlySerializedAs("OIBAKLLFOIC")]
	public UISprite MIGEGKDMPAE;

	[FormerlySerializedAs("FANKAIEPOOM")]
	public UISprite JLLJLNKEAHP;

	[FormerlySerializedAs("HIGCJPDLNGE")]
	...
	[FormerlySerializedAs("BLKGBICPGOA")]
	public UIPanel PDMFMGCMNCA;

	[FormerlySerializedAs("JCGNGKMDMHL")]
	public UISprite NAPPMPICLGF;

	public static float contentWidth => (UIHelper.activeWidthSafe - MFALNOGJIEE - 622f) / 2f - 120f;

	private static float MFALNOGJIEE => 120f;
