...
public class PlayerVisualIcon : Core_BaseScript
{
	...
	[FormerlySerializedAs("NGILJMHPPCL")]
	public UISprite PMMNANLHKNH;

	[FormerlySerializedAs("ICPHDNEDNLG")]
	[Header("-Equiped")]
	public UISprite IMGOIFHGPAB;

	[FormerlySerializedAs("OJOPAGHLBFI")]
	[Header("---Locked")]
	...
	public PlayerVisual visual => HHOJADAAMGF;
	...
	public void Initialize(PlayerVisual DJOAHABGGNA)
	{
		...
		base.gameObject.name = $"{num} {num2} {(int)DJOAHABGGNA.rarity} {DJOAHABGGNA.id}";
		JAJCFNOIBPM.gameObject.SetActive(value: false);
		IAPMLEKENDK.SetActive(value: false);
		ICIECPEDMIG.SetActive(value: false);
		EKGIJFHNFIG.gameObject.SetActive(value: false);
		BCFOLGJLFDP.SetActive(value: false);
		IGIENAGNFEO.SetActive(value: false);
		DAANKCOLJGJ.gameObject.SetActive(value: true);
	...
	public void IHMEAAIKGAP(PlayerVisual DJOAHABGGNA)
	{
		...
		JAJCFNOIBPM.gameObject.SetActive(value: true);
		IAPMLEKENDK.SetActive(value: true);
		ICIECPEDMIG.SetActive(value: true);
		EKGIJFHNFIG.gameObject.SetActive(value: false);
		BCFOLGJLFDP.SetActive(value: true);
		IGIENAGNFEO.SetActive(value: false);
		DAANKCOLJGJ.gameObject.SetActive(value: false);
		DAANKCOLJGJ.spriteName = DJOAHABGGNA.icon;
		DAANKCOLJGJ.MakePixelPerfect();
	...
	public void NBOODHLLBAA(PlayerVisual DJOAHABGGNA)
	{
		...
		IAPMLEKENDK.SetActive(value: false);
		ICIECPEDMIG.SetActive(value: false);
		EKGIJFHNFIG.gameObject.SetActive(value: true);
		BCFOLGJLFDP.SetActive(value: false);
		IGIENAGNFEO.SetActive(value: true);
		DAANKCOLJGJ.gameObject.SetActive(value: false);
		DAANKCOLJGJ.spriteName = DJOAHABGGNA.icon;
		DAANKCOLJGJ.MakePixelPerfect();
	...
	internal void CLNFHCHFEAD()
	{
		...
		if (flag)
		{
			NJHBBJMPGJI.text = $"{visual.numberOfParts}{Colours.stringGrayParts}/{Colours.stringWhite}{visual.numberOfPartsMax}";
		}
		ANODBGELEBJ.SetActive(!isBought && !purchasableInShop && !isFromArena);
		JOLGMBIAPJB();
		SetSale();
