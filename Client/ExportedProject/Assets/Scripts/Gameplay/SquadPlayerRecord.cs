...
public class SquadPlayerRecord : PoolableObject
{
	...
	[FormerlySerializedAs("AEFPPEDMJKC")]
	...
	[FormerlySerializedAs("NJDCNIOIDOO")]
	...
	[FormerlySerializedAs("BGKHMINPHBM")]
	...
	public virtual void DJDFKKJLHIC()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.LBKLINGCPBA(MBIAKMPDOPG.id, PNDNEMDPFHC: true, CJONGDEPJHC: false, BCHINGHDGEF: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public virtual void NHJKBCGFIAN()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.FNHIOAADLFN(MBIAKMPDOPG.id, PNDNEMDPFHC: false, CJONGDEPJHC: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public void JIMBEDOMAFD(SquadWarsContent.IAIOAHOIDOF NDPMDKGJAFH)
	{
		...
		else
		{
			...
			Singleton<PlayerTexturePool>.instance.IIMHJDIPNIA(MBIAKMPDOPG, PNDNEMDPFHC: true, PlayerTexturePool.DFJJOANIJID.Card);
			BCMCMKDCLGP.text = MBIAKMPDOPG.name;
	...
	public virtual void KJDECEJDGHF()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.FreePlayerTexture(MBIAKMPDOPG.id, PNDNEMDPFHC: false);
		}
		MBIAKMPDOPG = null;
	}
	...
	public virtual void CBMJBMDBOHE()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.DAGIACKCPKH(MBIAKMPDOPG.id, PNDNEMDPFHC: false, CJONGDEPJHC: true, BCHINGHDGEF: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public virtual void DKMEHOEOADL()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.BPEHHBALINP(MBIAKMPDOPG.id, PNDNEMDPFHC: false);
		}
		MBIAKMPDOPG = null;
	}
	...
	public virtual void HGOBLCPDFCD()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.MDANAEPCCHK(MBIAKMPDOPG.id, PNDNEMDPFHC: true, CJONGDEPJHC: false, BCHINGHDGEF: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public virtual void EMCFMPHKILC()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.BJFCGMCKOPO(MBIAKMPDOPG.id, PNDNEMDPFHC: false);
		}
		MBIAKMPDOPG = null;
	}
	...
	public void KOABMGAPCKP(SquadWarsContent.IAIOAHOIDOF NDPMDKGJAFH)
	{
		...
		else
		{
			...
			Singleton<PlayerTexturePool>.instance.APIIPFCGDBO(MBIAKMPDOPG, PNDNEMDPFHC: false);
			BCMCMKDCLGP.text = MBIAKMPDOPG.name;
	...
	public virtual void HOCPBJGFEON()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.FNHIOAADLFN(MBIAKMPDOPG.id, PNDNEMDPFHC: false, CJONGDEPJHC: true, BCHINGHDGEF: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public virtual void GFNFMCDOKIJ()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.IEPBDAHEKCL(MBIAKMPDOPG.id, PNDNEMDPFHC: true, CJONGDEPJHC: false, BCHINGHDGEF: true);
		}
		MBIAKMPDOPG = null;
	}
