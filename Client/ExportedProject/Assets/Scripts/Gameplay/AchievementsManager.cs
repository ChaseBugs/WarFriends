...
public class AchievementsManager : Singleton<AchievementsManager>
{
	public sealed class CHIDHGCKCIK
	{
		...
		public Achievements.rowIds FJMCPEDNBGG => FNFMGDOECDA;

		public string INFLHPGMEOB => (!BundleVersionBindings.BundleID.Contains("about")) ? OJDHGFADFDF.ANDROIDIDCHILL : OJDHGFADFDF.ANDROIDID;

		public string CABMKLIDMEH => OJDHGFADFDF.CLASS;

		public int JAJGLLMBPNB => OJDHGFADFDF.VALUE;

		public int FKIGMDIHKAA => OJDHGFADFDF.REWARDGOLD;

		public int BJFGHKNAIIE => OJDHGFADFDF.REWARDWB;

		public int KMCEFANOLKM => OJDHGFADFDF.REWARDSCRAPS;

		public int ELCDCFHKGHC => OJDHGFADFDF.REWARDTICKETS;

		public int KHKKGLMKBLP => OJDHGFADFDF.GROUPID;

		public string MHEHLJGIEKD => OJDHGFADFDF.GUITITLE;

		public string JOJLPMLBOMO => OJDHGFADFDF.GUIDESCRIPTION;

		public int OJHENOBMDDF => FKIGMDIHKAA + BJFGHKNAIIE + KMCEFANOLKM + ELCDCFHKGHC;
	...
	[FormerlySerializedAs("DGMBOFCCGOA")]
	public AchievementProgressGroups OOLANIBDBAE;

	public Dictionary<int, List<CHIDHGCKCIK>> achievements => MFPOLAAKDMH;

	public ReadOnlyCollection<Type> achievementTypes => PGMKIEGEKHC.AsReadOnly();
	...
	public void EnsureInitialized()
	{
		...
		for (int i = 0; i < length; i++)
		{
			...
			if (!MFPOLAAKDMH.TryGetValue(row.GROUPID, out var value))
			{
