...
public class CardHealMeNow : Card
{
	...
	public override string description => (!ANMEHGAFBEG) ? Localization.LocalizeFormat(mDescriptionID, MEJMLNDFDBP.JJBMMICPIIG(amountOfHealMin), MEJMLNDFDBP.JJBMMICPIIG(amountOfHealMax), MEJMLNDFDBP.AIPKMDCJCOG(timeInSec)) : Localization.LocalizeFormat(mDescriptionID, MEJMLNDFDBP.JJBMMICPIIG(amountOfHealMin));

	protected override string mBonusName => MEJMLNDFDBP.KEPEILBMDMD(amountOfHealMin);
	...
	public virtual void JIDDCBAEAGC()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 1881f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH("shotgun_reload", NABOFKMBMKH: true);
		}
	}
	...
	public virtual void EKBAEHKJCHL()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 1260f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("ID_CONFIRM_SERVERERROR", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
	...
	public virtual void HKFPNJECIJN()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 1344f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.OFPAGLLFPPK("menu-health-ico", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
	...
	protected void NBFMDCFFBIJ()
	{
		...
		if (BHABHIDDBLH > 793f)
		{
			...
			if (FDGLGCIJCBA != (int)Time.time)
			{
				...
				MBIAKMPDOPG.FOCIOKMPCAG.LNPKAAGJIGO(MBIAKMPDOPG.FOCIOKMPCAG.maxHealth * FNAPLODKCKC / GNKGAIABFHM(), CAKABHIPCDF: true);
			}
		}
		else
		{
	...
	public virtual void DPELJDNCGHG(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (ANMEHGAFBEG)
		{
			MBIAKMPDOPG.FOCIOKMPCAG.Heal(MBIAKMPDOPG.FOCIOKMPCAG.maxHealth * FNAPLODKCKC, CAKABHIPCDF: true);
			MBIAKMPDOPG.FOCIOKMPCAG.EHFOHNLMJOH();
			MBIAKMPDOPG.cardIconIndicator.JEDGCOMDEKM("FOUND", 657f, 1475f, GBJOJBKCEKN: true);
		}
		else
		{
			MBIAKMPDOPG.cardIconIndicator.PEBHGOMEKME("playerVisuals", NABOFKMBMKH: false);
	...
	protected void LIMHNKKJODK()
	{
		...
		if (BHABHIDDBLH > 1141f)
		{
			...
			{
				FDGLGCIJCBA = (int)Time.time;
				MBIAKMPDOPG.FOCIOKMPCAG.Heal(MBIAKMPDOPG.FOCIOKMPCAG.maxHealth * FNAPLODKCKC / CKHBNPMNBFL(), CAKABHIPCDF: false);
			}
		}
		else
		{
	...
	protected void GPLKEOAHFJI()
	{
		...
		if (BHABHIDDBLH > 1299f)
		{
			...
			{
				FDGLGCIJCBA = (int)Time.time;
				MBIAKMPDOPG.FOCIOKMPCAG.LNPKAAGJIGO(MBIAKMPDOPG.FOCIOKMPCAG.maxHealth * FNAPLODKCKC / HODMEPFPDEO(), CAKABHIPCDF: false);
			}
		}
		else
		{
	...
	protected void CJAHPFMAMKK()
	{
		...
		if (BHABHIDDBLH > 676f)
		{
			...
			{
				FDGLGCIJCBA = (int)Time.time;
				MBIAKMPDOPG.FOCIOKMPCAG.Heal(MBIAKMPDOPG.FOCIOKMPCAG.maxHealth * FNAPLODKCKC / HODMEPFPDEO(), CAKABHIPCDF: false);
			}
		}
		else
		{
	...
	protected void HNOBCHFHPNF()
	{
		...
		if (BHABHIDDBLH > 1954f)
		{
			...
			{
				FDGLGCIJCBA = (int)Time.time;
				MBIAKMPDOPG.FOCIOKMPCAG.LNPKAAGJIGO(MBIAKMPDOPG.FOCIOKMPCAG.maxHealth * FNAPLODKCKC / DFLOEMPMJPJ(), CAKABHIPCDF: false);
			}
		}
		else
		{
	...
	public virtual void KDPIJNFDMKC(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (ANMEHGAFBEG)
		{
			MBIAKMPDOPG.FOCIOKMPCAG.Heal(MBIAKMPDOPG.FOCIOKMPCAG.maxHealth * FNAPLODKCKC, CAKABHIPCDF: false);
			MBIAKMPDOPG.FOCIOKMPCAG.Sync();
			MBIAKMPDOPG.cardIconIndicator.JOGFDHFOOBC("Value2", 1860f, 1410f, GBJOJBKCEKN: true);
		}
		else
		{
			MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("clientVersion", NABOFKMBMKH: false);
	...
	public virtual void NPAMMCJAFLL()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 586f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("checking connection", NABOFKMBMKH: true);
		}
	}
	...
	public virtual void JBNMBMOJPAK()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 193f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("DogTagLastUpdate", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
	...
	public virtual void EHFIHPJILMG()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 1424f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH("RemoveRewards", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
	}
	...
	public override void UseCard(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (ANMEHGAFBEG)
		{
			MBIAKMPDOPG.FOCIOKMPCAG.Heal(MBIAKMPDOPG.FOCIOKMPCAG.maxHealth * FNAPLODKCKC, CAKABHIPCDF: false);
			MBIAKMPDOPG.FOCIOKMPCAG.Sync();
			MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-healingstorm", 3f, 3f, GBJOJBKCEKN: false);
		}
		else
		{
			MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-healingstorm", NABOFKMBMKH: true);
	...
	public virtual void NMOKBODAKHB()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 1203f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("ArenaPrice", NABOFKMBMKH: false);
		}
	}
	...
	public virtual void CFIKIKCBGKI()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 1363f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.LDGKPCDJPLA("ID_BOSS", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
	}
	...
	public virtual void GKDDIKLDCHC()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 604f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.NNPILDOKNJO("S", NABOFKMBMKH: false);
		}
	}
	...
	public virtual void AJLIIHKDAOD()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 1458f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("Warbucks", NABOFKMBMKH: false);
		}
	}
	...
	protected void PHABEKGALCE()
	{
		...
		if (BHABHIDDBLH > 87f)
		{
			...
			{
				FDGLGCIJCBA = (int)Time.time;
				MBIAKMPDOPG.FOCIOKMPCAG.Heal(MBIAKMPDOPG.FOCIOKMPCAG.maxHealth * FNAPLODKCKC / KHIDFKLBIOJ(), CAKABHIPCDF: false);
			}
		}
		else
		{
	...
	protected void OFNEGNKMKKG()
	{
		...
		if (BHABHIDDBLH > 869f)
		{
			...
			{
				FDGLGCIJCBA = (int)Time.time;
				MBIAKMPDOPG.FOCIOKMPCAG.LNPKAAGJIGO(MBIAKMPDOPG.FOCIOKMPCAG.maxHealth * FNAPLODKCKC / CJHIENIBMJA(), CAKABHIPCDF: false);
			}
		}
		else
		{
	...
	public virtual void KLEPKFBJIBA()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 815f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.LJLDJOHAAMC("Ground texture: ", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
	}
	...
	public virtual void HHKFLIABFCA()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 70f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("S", NABOFKMBMKH: false);
		}
	}
	...
	protected void Update()
	{
		...
		if (BHABHIDDBLH > 0f)
		{
			...
			{
				FDGLGCIJCBA = (int)Time.time;
				MBIAKMPDOPG.FOCIOKMPCAG.Heal(MBIAKMPDOPG.FOCIOKMPCAG.maxHealth * FNAPLODKCKC / timeInSec, CAKABHIPCDF: false);
			}
		}
		else
		{
	...
	protected void FLDCHPBPKND()
	{
		...
		if (BHABHIDDBLH > 841f)
		{
			...
			{
				FDGLGCIJCBA = (int)Time.time;
				MBIAKMPDOPG.FOCIOKMPCAG.LNPKAAGJIGO(MBIAKMPDOPG.FOCIOKMPCAG.maxHealth * FNAPLODKCKC / DDBOGDKNMFC(), CAKABHIPCDF: true);
			}
		}
		else
		{
	...
	public override void DisconnectEvents()
	{
		...
		if (NNDMKIACBBM)
		{
			BHABHIDDBLH = 0f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-healingstorm", NABOFKMBMKH: false);
		}
	}
