...
internal class KillEnemiesUsingSpecificWeaponAssignment : Assignment
{
	...
	private string weaponCategoryName => Singleton<GameVariables>.instance.GetWeaponCategory((WeaponCategory)base.mData[1], JHNPNPKOJMO.LowerCase, FBBIHBFHNEG.Singular);
	...
	public override bool hasHint => LevelManager.instance.currentLevel.displayNumber >= LevelManager.instance.dailyMissionUnlockLevel;
