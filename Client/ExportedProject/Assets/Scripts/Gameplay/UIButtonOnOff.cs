...
{
	[FormerlySerializedAs("GLJKHPKLJLN")]
	public bool KPNALEEJIDM = true;

	[FormerlySerializedAs("PEPECJFJCJL")]
	...
	public override void OnPress(bool DGOOLMFNBFB)
	{
		...
		if (!DGOOLMFNBFB)
		{
			...
			if (!KPNALEEJIDM)
			{
				OMNPLDJEENB.gameObject.SetActive(value: true);
			}
	...
	private void HJFLDABMJAO(UITweener MGDJMGHCAAI)
	{
		if (KPNALEEJIDM)
		{
			OMNPLDJEENB.gameObject.SetActive(value: false);
		}
	}
