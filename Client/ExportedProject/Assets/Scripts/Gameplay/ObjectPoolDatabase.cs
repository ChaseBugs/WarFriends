...
public class ObjectPoolDatabase : Singleton<ObjectPoolDatabase>
{
	...
	[FormerlySerializedAs("JHNLELMEJDL")]
	public NoMoveIndikator GFJILBKKDFA;

	[FormerlySerializedAs("OLNIBDCEABI")]
	public BuddyNameDisplayer JDNMAKKMPOA;

	[FormerlySerializedAs("FJDJAOPMOOG")]
	public BulletSlow MBFIEGEELKG;

	[FormerlySerializedAs("DCOBLABOPMI")]
	...
	public static ObjectPool mainPool => Singleton<ObjectPoolDatabase>.instance.GHGMIFHAOMI;
