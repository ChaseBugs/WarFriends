...
public class IntroductionSquadButton : Core_BaseScript
{
	...
	[FormerlySerializedAs("EMDNAMHFODK")]
	public BoxCollider GPEBKLLAGFH;

	[FormerlySerializedAs("CJOKFCGHBHJ")]
	public UISprite NNCFFDJMJHD;

	[FormerlySerializedAs("JAJPPHDDKGA")]
	public GameObject FEFPKLBBNHM;

	[FormerlySerializedAs("OGLFNPOOIOL")]
	...
	[Header("--Squad War")]
	[FormerlySerializedAs("FDPJPEKCFCL")]
	public GameObject GOCBCJHKMEH;

	[FormerlySerializedAs("PGBDGPPPNMI")]
	public UILabel FKEODBNNJPH;

	[Header("--Notification")]
	[FormerlySerializedAs("LIANLBEKMCK")]
	public GameObject PCODODIMPIK;

	[FormerlySerializedAs("LPODELJJIHH")]
	...
	private void GKBAHGPDEFE(AANECPGDMGM MIDDFOCJJOP)
	{
		...
		if (flag)
		{
			...
			CGIFEHPDBAL.text = $"[0BBCFF]{arg}[-] {MIDDFOCJJOP.MHPNDNJDPGE}";
	...
	private void DDKDGBOMJMB(AANECPGDMGM MIDDFOCJJOP)
	{
		...
		if (isSquadLocked)
		{
			NFFEEAHIJEL.SetActive(value: false);
