...
public class CardSabotage : Card
{
	...
	private void BGKICDIFJNP(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			gameShootableEntity.KHAGKKNPFMP().cardIconIndicator.GCLFBCIKNAH("opponent defense stop shooting", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	...
	private void DGJNFJGDMCP(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			gameShootableEntity.KHAGKKNPFMP().cardIconIndicator.DLNGGGOEDLL("{0} {1}", NABOFKMBMKH: true);
		}
	...
	private void EFILJJGPOJM(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			gameShootableEntity.NOGODFOGKCK().cardIconIndicator.EOEDEJKJKMN("Loaded values during loading data from PlayerAnalytics : lastSeenSquadChatTimeStampDB = {0}, squadCreationsCount = {1}, matchesToNextLootboxes = {2}", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
		gameShootableEntity.destroyableObject.DoDamage(kMJKKNFDFMM);
	}
	...
	private void JBLFEMNFJNP(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.KHAGKKNPFMP() != null)
		{
			gameShootableEntity.KHAGKKNPFMP().cardIconIndicator.OFPAGLLFPPK("GameLoginManager: Login successful, getting player data", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
		gameShootableEntity.GILBHOPNBPH().DoDamage(kMJKKNFDFMM);
	}
	...
	private void NLNJAKHLOFO(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			gameShootableEntity.mainGameEntity.cardIconIndicator.EOEDEJKJKMN("Client_", NABOFKMBMKH: false);
		}
	...
	private void KAMNHAJGEDH(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.HIICFFBMLNO() != null)
		{
			gameShootableEntity.KPLADAFODKB().cardIconIndicator.PEBHGOMEKME("TotalBattles", NABOFKMBMKH: false);
		}
	...
	private void PJHDAIKJPOB(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.mainGameEntity != null)
		{
			gameShootableEntity.NOGODFOGKCK().cardIconIndicator.DLNGGGOEDLL("registerCustomEventString", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
		gameShootableEntity.EIMJEBNPHAM().DoDamage(kMJKKNFDFMM);
	}
	...
	private void EPOEMPCNOPB(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.HIICFFBMLNO() != null)
		{
			gameShootableEntity.NOGODFOGKCK().cardIconIndicator.PEBHGOMEKME("fire", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
	...
	private void GMIHEFMIAIB(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.HIICFFBMLNO() != null)
		{
			gameShootableEntity.KHAGKKNPFMP().cardIconIndicator.FJILILFMPIF("Card_1_Played", NABOFKMBMKH: false);
		}
		gameShootableEntity.AFEPMIFFLFH().DoDamage(kMJKKNFDFMM);
	}
	...
	private void BKBMHIBHLHJ(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.KHAGKKNPFMP() != null)
		{
			gameShootableEntity.HIICFFBMLNO().cardIconIndicator.OFPAGLLFPPK("SquadRank", NABOFKMBMKH: true);
		}
		gameShootableEntity.GILBHOPNBPH().DoDamage(kMJKKNFDFMM);
	}
	...
	private void ICLJEOIMHHG(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.mainGameEntity != null)
		{
			gameShootableEntity.mainGameEntity.cardIconIndicator.Show("game-card-ico-backstab", NABOFKMBMKH: true);
		}
		gameShootableEntity.destroyableObject.DoDamage(kMJKKNFDFMM);
	}
	...
	private void BGNANEOOKJO(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.HIICFFBMLNO() != null)
		{
			gameShootableEntity.KPLADAFODKB().cardIconIndicator.DLNGGGOEDLL("run", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
		gameShootableEntity.GILBHOPNBPH().DoDamage(kMJKKNFDFMM);
	}
	...
	private void BJKLOIJJIEF(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.mainGameEntity != null)
		{
			gameShootableEntity.mainGameEntity.cardIconIndicator.LDGKPCDJPLA("Chat: Disconected: ", NABOFKMBMKH: false);
		}
		gameShootableEntity.EIMJEBNPHAM().DoDamage(kMJKKNFDFMM);
	}
	...
	private void IALDONBKFNI(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.mainGameEntity != null)
		{
			gameShootableEntity.HIICFFBMLNO().cardIconIndicator.GKAOMCGCDGE("offers", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
		gameShootableEntity.NHOFLPJMKBA().DoDamage(kMJKKNFDFMM);
	}
	...
	private void IHPPNEKIGEN(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			gameShootableEntity.KPLADAFODKB().cardIconIndicator.BBJADAJPJHH("ID_WARSHOP_PACKS", NABOFKMBMKH: false);
		}
		gameShootableEntity.EIMJEBNPHAM().DoDamage(kMJKKNFDFMM);
	}
	...
	private void IJOPPFEHJFE(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.KPLADAFODKB() != null)
		{
			gameShootableEntity.KHAGKKNPFMP().cardIconIndicator.FJILILFMPIF("ID_ARENALOSSREWARD", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
		gameShootableEntity.destroyableObject.DoDamage(kMJKKNFDFMM);
	}
	...
	private void LCMKKIEOJBM(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.NOGODFOGKCK() != null)
		{
			gameShootableEntity.KPLADAFODKB().cardIconIndicator.EOEDEJKJKMN("Yes_Clicked", NABOFKMBMKH: false);
		}
		gameShootableEntity.destroyableObject.DoDamage(kMJKKNFDFMM);
	}
	...
	private void NKCOEPEOFLP(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.HIICFFBMLNO() != null)
		{
			gameShootableEntity.mainGameEntity.cardIconIndicator.LJLDJOHAAMC("grenade_reload", NABOFKMBMKH: true);
		}
		gameShootableEntity.EIMJEBNPHAM().DoDamage(kMJKKNFDFMM);
	}
	...
	private void LLCHNMNLCFN(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.KPLADAFODKB() != null)
		{
			gameShootableEntity.KPLADAFODKB().cardIconIndicator.JCJFMHGNIOF("Awaiting players - Player id:\"{0}\" already added to message center", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
		gameShootableEntity.NHOFLPJMKBA().DoDamage(kMJKKNFDFMM);
	}
	...
	private void MLEFGBFHHOI(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.mainGameEntity != null)
		{
			gameShootableEntity.KPLADAFODKB().cardIconIndicator.GGHDIAFACAH("ID_CONFIRM_STARTUPERROR", NABOFKMBMKH: true);
		}
		gameShootableEntity.destroyableObject.DoDamage(kMJKKNFDFMM);
	}
	...
	private void EEJMEKFNHAA(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.HIICFFBMLNO() != null)
		{
			gameShootableEntity.KHAGKKNPFMP().cardIconIndicator.GGHDIAFACAH("\"{0}\"", NABOFKMBMKH: false);
		}
		gameShootableEntity.AFEPMIFFLFH().DoDamage(kMJKKNFDFMM);
	}
	...
	private void PPNAPIKGNCD(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.HIICFFBMLNO() != null)
		{
			gameShootableEntity.NOGODFOGKCK().cardIconIndicator.FJILILFMPIF("game-card-ico-triggerhappy", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
		gameShootableEntity.EIMJEBNPHAM().DoDamage(kMJKKNFDFMM);
	}
	...
	private void HLHCEEJHDGK(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.KPLADAFODKB() != null)
		{
			gameShootableEntity.KPLADAFODKB().cardIconIndicator.GKAOMCGCDGE("312 MENU CONNECT FB", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
		gameShootableEntity.destroyableObject.DoDamage(kMJKKNFDFMM);
	}
	...
	private void KPNAKLGKFFL(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.KHAGKKNPFMP() != null)
		{
			gameShootableEntity.mainGameEntity.cardIconIndicator.JCJFMHGNIOF("IsMatchMaking", NABOFKMBMKH: true);
		}
		gameShootableEntity.destroyableObject.DoDamage(kMJKKNFDFMM);
	}
	...
	private void IBHGBKKILME(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.HIICFFBMLNO() != null)
		{
			gameShootableEntity.KHAGKKNPFMP().cardIconIndicator.DLNGGGOEDLL("FuseRewardedOptionKey_PostRollContinueButtonText", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
		gameShootableEntity.AFEPMIFFLFH().DoDamage(kMJKKNFDFMM);
	}
	...
	private void NCNMCJCGLOG(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.KPLADAFODKB() != null)
		{
			gameShootableEntity.mainGameEntity.cardIconIndicator.NNPILDOKNJO("Sniper_Tutorial_Duration", NABOFKMBMKH: false);
		}
		gameShootableEntity.AFEPMIFFLFH().DoDamage(kMJKKNFDFMM);
	}
	...
	private void PPOFKEMMNOC(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (gameShootableEntity.KHAGKKNPFMP() != null)
		{
			gameShootableEntity.KPLADAFODKB().cardIconIndicator.BBJADAJPJHH("ID_ARENAREWARD_WARBUCKS", NABOFKMBMKH: true, HGNIGKCLLHM: true);
		}
		gameShootableEntity.AFEPMIFFLFH().DoDamage(kMJKKNFDFMM);
	}
