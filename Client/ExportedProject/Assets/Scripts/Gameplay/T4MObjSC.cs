...
{
	[FormerlySerializedAs("GPBEDDEHEEP")]
	[HideInInspector]
	public string EEGDCFPMPLA = string.Empty;

	[FormerlySerializedAs("KADGGCLHCKH")]
	[HideInInspector]
	public bool BKJBHOKKNKA = true;

	[HideInInspector]
	[FormerlySerializedAs("LHDHILGDFNG")]
	public Vector3[] KAJBHJDNIFP;

	[FormerlySerializedAs("GCFBNOCGICI")]
	[HideInInspector]
	...
	[HideInInspector]
	[FormerlySerializedAs("IEMJGEEKKMN")]
	public int KEFMFLIJOPM;

	[HideInInspector]
	[FormerlySerializedAs("JHJLKDCHELC")]
	public bool OGFDMBCLGJG = true;

	[HideInInspector]
	[FormerlySerializedAs("GJPLGGGIFKA")]
	public Vector3[] DGCHDHIELHD;

	[HideInInspector]
	[FormerlySerializedAs("CEKCBFPMFLO")]
	public float DLDEMPCHCIE = 0.05f;

	[HideInInspector]
	[FormerlySerializedAs("KCDBPHOGNEP")]
	public int[] DHKDJIMLKAM;

	[FormerlySerializedAs("IJCHIPEKKLI")]
	[HideInInspector]
	public float ANJNIMBBANI = 30f;

	[HideInInspector]
	[FormerlySerializedAs("DDEAIEHHABD")]
	public T4MBillBObjSC[] MDHJPDMACKD;

	[HideInInspector]
	[FormerlySerializedAs("IFNOMLKBNMA")]
	public bool FLMFLMONEIB = true;

	[FormerlySerializedAs("KJNOAKAOJLM")]
	[HideInInspector]
	public float FDGGADCGIKD = 1000f;

	[FormerlySerializedAs("INFBFEAFJDF")]
	[HideInInspector]
	public float HPFADDJGBCG = 200f;

	[FormerlySerializedAs("HBBALPBEIEK")]
	[HideInInspector]
	public float ECCPEJHBOEE = 60f;

	[FormerlySerializedAs("CHALHOFJPMD")]
	[HideInInspector]
	...
	[HideInInspector]
	[FormerlySerializedAs("ALFHPGBOMEB")]
	public int HMBKEKIODFK;

	[HideInInspector]
	[FormerlySerializedAs("ABKDICLBPEB")]
	public bool AGLOAGDAGBG = true;

	[FormerlySerializedAs("IKMKLPOOMNO")]
	[HideInInspector]
	public bool BJBFPJMEFBD = true;

	[FormerlySerializedAs("KOHEHOEKIPO")]
	public Material JLDPCFKAEEO;

	[FormerlySerializedAs("NDMOFPFOILO")]
	public MeshFilter BBJGJGONKEK;

	[FormerlySerializedAs("MAPJKPBMEEJ")]
	public Color GDMFPPBDKBD = new Color(0.73f, 0.85f, 0.4f, 1f);

	[FormerlySerializedAs("ANBHMNNIKPM")]
	public Vector4 FIJCPAJCNCG = new Vector4(0.85f, 0.075f, 0.4f, 0.5f);

	[FormerlySerializedAs("AOFEMAADMKF")]
	public float MPGOLKLOAMI = 0.75f;

	[FormerlySerializedAs("PONBHECOKMB")]
	public float ODGKKPCIGAK = 1.5f;

	[FormerlySerializedAs("MLODPCCGEMP")]
	public bool BGMCMEAJEOD;

	[FormerlySerializedAs("AJHABLCLOAC")]
	public bool NKFMIIEKIAD;

	[FormerlySerializedAs("EDBDJADKKHL")]
	public bool GHNOECFGIPF;

	[FormerlySerializedAs("KJPBKGCELLO")]
	public bool ONBKBPHJDGL;

	[FormerlySerializedAs("CMOLBOIKJEH")]
	public Texture2D FMGPGKMOMAB;

	[FormerlySerializedAs("GADIOMLFFFJ")]
