...
{
	[FormerlySerializedAs("HGOJPCIJPHJ")]
	public UISprite[] EFAPADCIBDO;

	[FormerlySerializedAs("BDGLMOHONBG")]
	public UISprite IMJALOGDCJI;

	[FormerlySerializedAs("GJCOHPIIGIO")]
	...
	private float HOLDFDIMINM => 720f;
	...
	public void ActivePhase(int DFHAAIFFLOE)
	{
		...
		{
			HFKOPPNILNN.gameObject.SetActive(value: false);
			IMJALOGDCJI.gameObject.SetActive(value: false);
		}
	}
	...
	public void DKFPNGLFGCK(int PDMGPGEHLNM)
	{
		...
		{
		case 1:
			EFAPADCIBDO[1].gameObject.SetActive(value: false);
		...
		{
			EFAPADCIBDO[i].gameObject.SetActive(value: false);
	...
	public void KKAONFKHBJG(int PDMGPGEHLNM)
	{
		...
		{
		case 1:
			EFAPADCIBDO[1].gameObject.SetActive(value: true);
	...
	{
		HFKOPPNILNN.gameObject.SetActive(value: true);
		IMJALOGDCJI.gameObject.SetActive(value: false);
		UISprite[] eFAPADCIBDO = EFAPADCIBDO;
		foreach (UISprite uISprite in eFAPADCIBDO)
		{
	...
	public void OEHANPMJIKD(int PDMGPGEHLNM)
	{
		...
		{
		case 1:
			EFAPADCIBDO[0].gameObject.SetActive(value: true);
	...
	public void DKIKJKIBIDB(int PDMGPGEHLNM)
	{
		if (PDMGPGEHLNM == 0)
		{
			EFAPADCIBDO[0].gameObject.SetActive(value: false);
		...
		else if (PDMGPGEHLNM != 0)
		{
			...
			{
				EFAPADCIBDO[i].gameObject.SetActive(value: true);
				EFAPADCIBDO[i].transform.localPosition = EFAPADCIBDO[i].transform.localPosition.ReplaceX(CILBIHGIDKB * (float)i);
				EFAPADCIBDO[i].transform.localScale = EFAPADCIBDO[i].transform.localScale.ReplaceX(JLEIHNHAFMA);
			}
		}
	...
	public void JEDJHHIOGPP(int DFHAAIFFLOE)
	{
		...
		{
			HFKOPPNILNN.gameObject.SetActive(value: true);
			IMJALOGDCJI.gameObject.SetActive(value: true);
		}
	}
