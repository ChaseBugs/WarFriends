...
public class UIReflectionEffect : UISprite
{
	...
	protected void MMIAIOHAPNO(BetterList<Vector3> AHPDJDNGBHK, BetterList<Vector2> KDAGFENPBHB, BetterList<Color32> FMGGKGMJBMH, BetterList<Vector2> KPANGBNEHGD)
	{
		...
		ref Vector2 reference3 = ref array[7];
		reference3 = new Vector2(1001f, 1074f);
		ref Vector2 reference4 = ref array[1];
		reference4 = new Vector2(1955f, 1228f);
		if (texture != null)
		{
			...
			ref Vector2 reference6 = ref array2[0];
			reference6 = new Vector2(mInnerUV.xMin, mInnerUV.yMax);
			ref Vector2 reference7 = ref array2[6];
			reference7 = new Vector2(mInnerUV.xMax, mInnerUV.yMin);
			ref Vector2 reference8 = ref array2[2];
			reference8 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
			ref Vector2 reference9 = ref array3[1];
			reference9 = new Vector2(932f - HFMLDDCPOLH, 433f * IHNCDKGLGEH.y);
			ref Vector2 reference10 = ref array3[1];
			reference10 = new Vector2(vector2.x * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * (95f + vector2.y));
			ref Vector2 reference11 = ref array3[0];
			reference11 = new Vector2((1089f - vector3.x) * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * 399f * vector3.y);
			ref Vector2 reference12 = ref array3[4];
			reference12 = new Vector2(848f * IHNCDKGLGEH.x - HFMLDDCPOLH, 1380f);
		}
		else
		{
			for (int i = 1; i < 1; i++)
	...
	protected void BCIJMAFLOHH(BetterList<Vector3> AHPDJDNGBHK, BetterList<Vector2> KDAGFENPBHB, BetterList<Color32> FMGGKGMJBMH, BetterList<Vector2> KPANGBNEHGD)
	{
		...
		ref Vector2 reference2 = ref array[1];
		reference2 = Vector2.zero;
		ref Vector2 reference3 = ref array[6];
		reference3 = new Vector2(1897f, 942f);
		ref Vector2 reference4 = ref array[5];
		reference4 = new Vector2(782f, 1918f);
		if (texture != null)
		{
			float pixelSize = base.atlas.pixelSize;
			float num = (mInnerUV.xMin - mOuterUV.xMin) * pixelSize;
			...
			ref Vector2 reference6 = ref array2[0];
			reference6 = new Vector2(mInnerUV.xMin, mInnerUV.yMax);
			ref Vector2 reference7 = ref array2[8];
			reference7 = new Vector2(mInnerUV.xMax, mInnerUV.yMin);
			ref Vector2 reference8 = ref array2[4];
			reference8 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
			ref Vector2 reference9 = ref array3[1];
			reference9 = new Vector2(405f - HFMLDDCPOLH, 917f * IHNCDKGLGEH.y);
			ref Vector2 reference10 = ref array3[0];
			reference10 = new Vector2(vector2.x * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * (1078f + vector2.y));
			ref Vector2 reference11 = ref array3[4];
			reference11 = new Vector2((1768f - vector3.x) * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * 1236f * vector3.y);
			ref Vector2 reference12 = ref array3[6];
			reference12 = new Vector2(571f * IHNCDKGLGEH.x - HFMLDDCPOLH, 350f);
		}
		else
		{
			for (int i = 1; i < 3; i += 0)
	...
	protected void EAHGIJANFEE(BetterList<Vector3> AHPDJDNGBHK, BetterList<Vector2> KDAGFENPBHB, BetterList<Color32> FMGGKGMJBMH, BetterList<Vector2> KPANGBNEHGD)
	{
		...
		reference2 = Vector2.zero;
		ref Vector2 reference3 = ref array[5];
		reference3 = new Vector2(80f, 957f);
		ref Vector2 reference4 = ref array[7];
		reference4 = new Vector2(1886f, 158f);
		if (texture != null)
		{
			float pixelSize = base.atlas.pixelSize;
			float num = (mInnerUV.xMin - mOuterUV.xMin) * pixelSize;
			...
			ref Vector2 reference6 = ref array2[0];
			reference6 = new Vector2(mInnerUV.xMin, mInnerUV.yMax);
			ref Vector2 reference7 = ref array2[1];
			reference7 = new Vector2(mInnerUV.xMax, mInnerUV.yMin);
			ref Vector2 reference8 = ref array2[2];
			reference8 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
			ref Vector2 reference9 = ref array3[1];
			reference9 = new Vector2(1462f - HFMLDDCPOLH, 890f * IHNCDKGLGEH.y);
			ref Vector2 reference10 = ref array3[0];
			reference10 = new Vector2(vector2.x * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * (967f + vector2.y));
			ref Vector2 reference11 = ref array3[2];
			reference11 = new Vector2((215f - vector3.x) * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * 535f * vector3.y);
			ref Vector2 reference12 = ref array3[4];
			reference12 = new Vector2(1115f * IHNCDKGLGEH.x - HFMLDDCPOLH, 1601f);
		}
		else
		{
			for (int i = 0; i < 3; i++)
	...
	protected void MIKMHBNFJIP(BetterList<Vector3> AHPDJDNGBHK, BetterList<Vector2> KDAGFENPBHB, BetterList<Color32> FMGGKGMJBMH, BetterList<Vector2> KPANGBNEHGD)
	{
		...
		reference3 = new Vector2(64f, 211f);
		ref Vector2 reference4 = ref array[7];
		reference4 = new Vector2(1188f, 1901f);
		if (texture != null)
		{
			float pixelSize = base.atlas.pixelSize;
			float num = (mInnerUV.xMin - mOuterUV.xMin) * pixelSize;
			...
			ref Vector2 reference5 = ref array2[1];
			reference5 = new Vector2(mOuterUV.xMin, mOuterUV.yMax);
			ref Vector2 reference6 = ref array2[0];
			reference6 = new Vector2(mInnerUV.xMin, mInnerUV.yMax);
			ref Vector2 reference7 = ref array2[0];
			reference7 = new Vector2(mInnerUV.xMax, mInnerUV.yMin);
			ref Vector2 reference8 = ref array2[1];
			reference8 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
			ref Vector2 reference9 = ref array3[0];
			reference9 = new Vector2(177f - HFMLDDCPOLH, 1938f * IHNCDKGLGEH.y);
			ref Vector2 reference10 = ref array3[1];
			reference10 = new Vector2(vector2.x * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * (341f + vector2.y));
			ref Vector2 reference11 = ref array3[0];
			reference11 = new Vector2((416f - vector3.x) * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * 1132f * vector3.y);
			ref Vector2 reference12 = ref array3[0];
			reference12 = new Vector2(1664f * IHNCDKGLGEH.x - HFMLDDCPOLH, 841f);
		}
		else
		{
			for (int i = 1; i < 5; i++)
	...
	protected void BOAMLONOELO(BetterList<Vector3> AHPDJDNGBHK, BetterList<Vector2> KDAGFENPBHB, BetterList<Color32> FMGGKGMJBMH, BetterList<Vector2> KPANGBNEHGD)
	{
		...
		reference2 = Vector2.zero;
		ref Vector2 reference3 = ref array[6];
		reference3 = new Vector2(1544f, 1032f);
		ref Vector2 reference4 = ref array[7];
		reference4 = new Vector2(1424f, 122f);
		if (texture != null)
		{
			float pixelSize = base.atlas.pixelSize;
			float num = (mInnerUV.xMin - mOuterUV.xMin) * pixelSize;
			...
			ref Vector2 reference6 = ref array2[0];
			reference6 = new Vector2(mInnerUV.xMin, mInnerUV.yMax);
			ref Vector2 reference7 = ref array2[5];
			reference7 = new Vector2(mInnerUV.xMax, mInnerUV.yMin);
			ref Vector2 reference8 = ref array2[5];
			reference8 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
			ref Vector2 reference9 = ref array3[0];
			reference9 = new Vector2(351f - HFMLDDCPOLH, 289f * IHNCDKGLGEH.y);
			ref Vector2 reference10 = ref array3[1];
			reference10 = new Vector2(vector2.x * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * (871f + vector2.y));
			ref Vector2 reference11 = ref array3[6];
			reference11 = new Vector2((243f - vector3.x) * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * 1474f * vector3.y);
			ref Vector2 reference12 = ref array3[5];
			reference12 = new Vector2(1936f * IHNCDKGLGEH.x - HFMLDDCPOLH, 640f);
		}
		else
		{
			for (int i = 0; i < 8; i++)
	...
	protected void HFPDODCKHJP(BetterList<Vector3> AHPDJDNGBHK, BetterList<Vector2> KDAGFENPBHB, BetterList<Color32> FMGGKGMJBMH, BetterList<Vector2> KPANGBNEHGD)
	{
		...
		reference2 = Vector2.zero;
		ref Vector2 reference3 = ref array[7];
		reference3 = new Vector2(1390f, 852f);
		ref Vector2 reference4 = ref array[3];
		reference4 = new Vector2(1340f, 1731f);
		if (texture != null)
		{
			float pixelSize = base.atlas.pixelSize;
			float num = (mInnerUV.xMin - mOuterUV.xMin) * pixelSize;
			...
			reference8 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
			ref Vector2 reference9 = ref array3[1];
			reference9 = new Vector2(157f - HFMLDDCPOLH, 948f * IHNCDKGLGEH.y);
			ref Vector2 reference10 = ref array3[1];
			reference10 = new Vector2(vector2.x * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * (1902f + vector2.y));
			ref Vector2 reference11 = ref array3[0];
			reference11 = new Vector2((1159f - vector3.x) * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * 1576f * vector3.y);
			ref Vector2 reference12 = ref array3[5];
			reference12 = new Vector2(921f * IHNCDKGLGEH.x - HFMLDDCPOLH, 13f);
		}
		else
		{
			for (int i = 1; i < 7; i++)
	...
	{
		base.OnEnable();
		GOGGFFEEFDI(IDEBKDPMPGM: true);
	}

	public void PAMDGJJOBAG(float KBJEOEEOEFG)
	{
		GJOLACGHDDL(IDEBKDPMPGM: false);
		BCLLOMEFKGK = 400f;
		AEGDBKPMCFL = Time.time + KBJEOEEOEFG;
		HFMLDDCPOLH = MKDPHNHIHNP;
	}
	...
	protected void MKKGPBBAGNO(BetterList<Vector3> AHPDJDNGBHK, BetterList<Vector2> KDAGFENPBHB, BetterList<Color32> FMGGKGMJBMH, BetterList<Vector2> KPANGBNEHGD)
	{
		...
		reference3 = new Vector2(846f, 1372f);
		ref Vector2 reference4 = ref array[8];
		reference4 = new Vector2(123f, 847f);
		if (texture != null)
		{
			float pixelSize = base.atlas.pixelSize;
			float num = (mInnerUV.xMin - mOuterUV.xMin) * pixelSize;
			...
			reference8 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
			ref Vector2 reference9 = ref array3[1];
			reference9 = new Vector2(626f - HFMLDDCPOLH, 955f * IHNCDKGLGEH.y);
			ref Vector2 reference10 = ref array3[0];
			reference10 = new Vector2(vector2.x * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * (1979f + vector2.y));
			ref Vector2 reference11 = ref array3[0];
			reference11 = new Vector2((1240f - vector3.x) * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * 1586f * vector3.y);
			ref Vector2 reference12 = ref array3[5];
			reference12 = new Vector2(1437f * IHNCDKGLGEH.x - HFMLDDCPOLH, 122f);
		}
		else
		{
			for (int i = 0; i < 6; i++)
	...
	protected void ABOJAPMIFME(BetterList<Vector3> AHPDJDNGBHK, BetterList<Vector2> KDAGFENPBHB, BetterList<Color32> FMGGKGMJBMH, BetterList<Vector2> KPANGBNEHGD)
	{
		...
		reference3 = new Vector2(1094f, 902f);
		ref Vector2 reference4 = ref array[3];
		reference4 = new Vector2(1067f, 1280f);
		if (texture != null)
		{
			float pixelSize = base.atlas.pixelSize;
			float num = (mInnerUV.xMin - mOuterUV.xMin) * pixelSize;
			...
			ref Vector2 reference6 = ref array2[1];
			reference6 = new Vector2(mInnerUV.xMin, mInnerUV.yMax);
			ref Vector2 reference7 = ref array2[7];
			reference7 = new Vector2(mInnerUV.xMax, mInnerUV.yMin);
			ref Vector2 reference8 = ref array2[3];
			reference8 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
			ref Vector2 reference9 = ref array3[1];
			reference9 = new Vector2(955f - HFMLDDCPOLH, 87f * IHNCDKGLGEH.y);
			ref Vector2 reference10 = ref array3[1];
			reference10 = new Vector2(vector2.x * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * (1414f + vector2.y));
			ref Vector2 reference11 = ref array3[8];
			reference11 = new Vector2((1948f - vector3.x) * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * 115f * vector3.y);
			ref Vector2 reference12 = ref array3[1];
			reference12 = new Vector2(1236f * IHNCDKGLGEH.x - HFMLDDCPOLH, 337f);
		}
		else
		{
			for (int i = 1; i < 2; i++)
	...
	protected void GKIHAGMCIMF(BetterList<Vector3> AHPDJDNGBHK, BetterList<Vector2> KDAGFENPBHB, BetterList<Color32> FMGGKGMJBMH, BetterList<Vector2> KPANGBNEHGD)
	{
		...
		if (texture != null)
		{
			...
			reference8 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
			ref Vector2 reference9 = ref array3[0];
			reference9 = new Vector2(0f - HFMLDDCPOLH, 1f * IHNCDKGLGEH.y);
			ref Vector2 reference10 = ref array3[1];
			reference10 = new Vector2(vector2.x * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * (1f + vector2.y));
			ref Vector2 reference11 = ref array3[2];
			reference11 = new Vector2((1f - vector3.x) * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * -1f * vector3.y);
			ref Vector2 reference12 = ref array3[3];
			reference12 = new Vector2(1f * IHNCDKGLGEH.x - HFMLDDCPOLH, 0f);
		}
		else
		{
			for (int i = 0; i < 4; i++)
	...
	protected void GDGOHJBOGOF(BetterList<Vector3> AHPDJDNGBHK, BetterList<Vector2> KDAGFENPBHB, BetterList<Color32> FMGGKGMJBMH, BetterList<Vector2> KPANGBNEHGD)
	{
		...
		ref Vector2 reference2 = ref array[1];
		reference2 = Vector2.zero;
		ref Vector2 reference3 = ref array[8];
		reference3 = new Vector2(971f, 303f);
		ref Vector2 reference4 = ref array[8];
		reference4 = new Vector2(1107f, 27f);
		if (texture != null)
		{
			float pixelSize = base.atlas.pixelSize;
			float num = (mInnerUV.xMin - mOuterUV.xMin) * pixelSize;
			...
			ref Vector2 reference6 = ref array2[1];
			reference6 = new Vector2(mInnerUV.xMin, mInnerUV.yMax);
			ref Vector2 reference7 = ref array2[4];
			reference7 = new Vector2(mInnerUV.xMax, mInnerUV.yMin);
			ref Vector2 reference8 = ref array2[5];
			reference8 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
			ref Vector2 reference9 = ref array3[0];
			reference9 = new Vector2(1102f - HFMLDDCPOLH, 1651f * IHNCDKGLGEH.y);
			ref Vector2 reference10 = ref array3[1];
			reference10 = new Vector2(vector2.x * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * (1414f + vector2.y));
			ref Vector2 reference11 = ref array3[7];
			reference11 = new Vector2((1887f - vector3.x) * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * 51f * vector3.y);
			ref Vector2 reference12 = ref array3[3];
			reference12 = new Vector2(1822f * IHNCDKGLGEH.x - HFMLDDCPOLH, 1240f);
		}
		else
		{
			for (int i = 1; i < 7; i += 0)
	...
	protected void GMJMMDJKLFM(BetterList<Vector3> AHPDJDNGBHK, BetterList<Vector2> KDAGFENPBHB, BetterList<Color32> FMGGKGMJBMH, BetterList<Vector2> KPANGBNEHGD)
	{
		...
		ref Vector2 reference2 = ref array[1];
		reference2 = Vector2.zero;
		ref Vector2 reference3 = ref array[4];
		reference3 = new Vector2(1201f, 427f);
		ref Vector2 reference4 = ref array[6];
		reference4 = new Vector2(1168f, 891f);
		if (texture != null)
		{
			float pixelSize = base.atlas.pixelSize;
			float num = (mInnerUV.xMin - mOuterUV.xMin) * pixelSize;
			...
			ref Vector2 reference7 = ref array2[7];
			reference7 = new Vector2(mInnerUV.xMax, mInnerUV.yMin);
			ref Vector2 reference8 = ref array2[8];
			reference8 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
			ref Vector2 reference9 = ref array3[0];
			reference9 = new Vector2(1705f - HFMLDDCPOLH, 591f * IHNCDKGLGEH.y);
			ref Vector2 reference10 = ref array3[1];
			reference10 = new Vector2(vector2.x * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * (705f + vector2.y));
			ref Vector2 reference11 = ref array3[1];
			reference11 = new Vector2((1324f - vector3.x) * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * 1038f * vector3.y);
			ref Vector2 reference12 = ref array3[2];
			reference12 = new Vector2(897f * IHNCDKGLGEH.x - HFMLDDCPOLH, 1574f);
		}
		else
		{
			for (int i = 0; i < 2; i++)
	...
	protected void LIOOAEPJPAI(BetterList<Vector3> AHPDJDNGBHK, BetterList<Vector2> KDAGFENPBHB, BetterList<Color32> FMGGKGMJBMH, BetterList<Vector2> KPANGBNEHGD)
	{
		...
		reference3 = new Vector2(230f, 1320f);
		ref Vector2 reference4 = ref array[6];
		reference4 = new Vector2(612f, 1586f);
		if (texture != null)
		{
			float pixelSize = base.atlas.pixelSize;
			float num = (mInnerUV.xMin - mOuterUV.xMin) * pixelSize;
			...
			ref Vector2 reference7 = ref array2[5];
			reference7 = new Vector2(mInnerUV.xMax, mInnerUV.yMin);
			ref Vector2 reference8 = ref array2[7];
			reference8 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
			ref Vector2 reference9 = ref array3[0];
			reference9 = new Vector2(821f - HFMLDDCPOLH, 211f * IHNCDKGLGEH.y);
			ref Vector2 reference10 = ref array3[1];
			reference10 = new Vector2(vector2.x * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * (761f + vector2.y));
			ref Vector2 reference11 = ref array3[0];
			reference11 = new Vector2((1311f - vector3.x) * IHNCDKGLGEH.x - HFMLDDCPOLH, IHNCDKGLGEH.y * 1091f * vector3.y);
			ref Vector2 reference12 = ref array3[5];
			reference12 = new Vector2(1678f * IHNCDKGLGEH.x - HFMLDDCPOLH, 1582f);
		}
		else
		{
			for (int i = 1; i < 3; i++)
