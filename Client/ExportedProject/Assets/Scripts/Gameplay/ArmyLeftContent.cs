...
public class ArmyLeftContent : Core_BaseScript
{
	...
	[FormerlySerializedAs("MPGIELLNNFJ")]
	...
	{
		CAOEDDHFEFA[0].InitializeStat(IFFDIHCPKFE, LPFLPCOLHPJ: true);
		CAOEDDHFEFA[1].InitializeStat(IFFDIHCPKFE, LPFLPCOLHPJ: false);
	...
	{
		CDBNOEGOFOI.text = $"{BCCDDJMPBLL}{Colours.stringGray} / {OLPMJEEGLIC}";
	...
	{
		CAOEDDHFEFA[0].OEKBNBEPBDB(IFFDIHCPKFE, LPFLPCOLHPJ: false);
		CAOEDDHFEFA[1].KGOKAPLKADI(IFFDIHCPKFE, LPFLPCOLHPJ: false);
	...
	{
		CAOEDDHFEFA[1].InitializeStat(IFFDIHCPKFE, LPFLPCOLHPJ: false);
		CAOEDDHFEFA[0].InitializeStat(IFFDIHCPKFE, LPFLPCOLHPJ: false);
	...
	{
		CAOEDDHFEFA[0].IHJPBPBLPAF(IFFDIHCPKFE, LPFLPCOLHPJ: false);
		CAOEDDHFEFA[0].IGEFMGGGOKP(IFFDIHCPKFE, LPFLPCOLHPJ: false);
	...
	{
		CAOEDDHFEFA[1].MEDFIABEFMP(IFFDIHCPKFE, LPFLPCOLHPJ: false);
		CAOEDDHFEFA[1].IGEFMGGGOKP(IFFDIHCPKFE, LPFLPCOLHPJ: false);
		CAOEDDHFEFA[2].InitializeSpecial(IFFDIHCPKFE);
		if (IFFDIHCPKFE.upgradeSlots.upgradeSlotElite.isUnlocked)
		{
