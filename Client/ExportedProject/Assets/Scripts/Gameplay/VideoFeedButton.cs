...
public class VideoFeedButton : Core_BaseScript
{
	...
	{
		JMIEDOAAODB();
		mWaiting.gameObject.SetActive(value: false);
	...
	private void HNCIADLKIJJ(GameObject KHAHPAKDIKE)
	{
		if (AGLCHFLACPL != null)
		{
			GuiScreenSingle<VideoFeedScreen>.instance.HAKFINEHCAD(AGLCHFLACPL, PJAGOCOIONA: false);
		}
	...
	private void HKOPCDABMNO(GameObject KHAHPAKDIKE)
	{
		if (AGLCHFLACPL != null)
		{
			GuiScreenSingle<VideoFeedScreen>.instance.PreselectVideo(AGLCHFLACPL, PJAGOCOIONA: false);
		}
	...
	private void BOJBCFNDLFO()
	{
		...
		mTexture.gameObject.SetActive(value: false);
		if (AGLCHFLACPL != null)
		{
	...
	private void MJOCAEBNBAK(string GDIAEJILINE)
	{
		...
		{
			mWaiting.gameObject.SetActive(value: true);
			mTexture.gameObject.SetActive(value: false);
	...
	private void HJFMHPEJIFE(string GDIAEJILINE)
	{
		...
		{
			mWaiting.gameObject.SetActive(value: true);
			mTexture.gameObject.SetActive(value: true);
	...
	private void DDKFMNCDFOP(GameObject KHAHPAKDIKE)
	{
		if (AGLCHFLACPL != null)
		{
			GuiScreenSingle<VideoFeedScreen>.instance.FNOHCONPGNI(AGLCHFLACPL, PJAGOCOIONA: true);
		}
		Singleton<GuiManager>.instance.ShowGui(GuiScreenSingle<VideoFeedScreen>.instance);
	}
	...
	private void HLBPNODAIEF(GameObject KHAHPAKDIKE)
	{
		if (AGLCHFLACPL != null)
		{
			GuiScreenSingle<VideoFeedScreen>.instance.PreselectVideo(AGLCHFLACPL, PJAGOCOIONA: true);
		}
		Singleton<GuiManager>.instance.ShowGui(GuiScreenSingle<VideoFeedScreen>.instance);
	}
	...
	public void FACKIKMABGK()
	{
		...
		case IMLJICEBDFA.VideoRotating:
			mDefaultLook.SetActive(value: false);
			GCCAHCIMBMA();
			break;
	...
	public void BAAOGDMJCLK()
	{
		...
		case IMLJICEBDFA.VideoRotating:
			...
			break;
		case IMLJICEBDFA.Default:
			mDefaultLook.SetActive(value: true);
			DLDMIAGAONN();
			mWaiting.gameObject.SetActive(value: true);
			NFPJFHENJEG();
			break;
