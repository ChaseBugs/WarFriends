...
{
	protected override float PCPCPEFOOEJ => 0f;

	protected override bool BDKNNNCHILL => Singleton<GameController>.instance.mainController.spawningType == BNKNNCBAPIH.Fixed;
