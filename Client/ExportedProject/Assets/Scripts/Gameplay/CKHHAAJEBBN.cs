...
public class CKHHAAJEBBN : KJMGFHMIBII
{
	...
	public override string NJKMFAGIKIE => "warArenaLobby" + Singleton<CurrentBundleVersion>.instance.matchMakingVersionRanked;
	...
	public override List<CloudRegionCode> FCOKCCNOHBA => LIABKJNONBH();
	...
	{
		return $"{DDBKNOGNAHF} == {Singleton<GameController>.instance.MBPKLMKBJAB.GetTopRunGroup()}";
	}
}
