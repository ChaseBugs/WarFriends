...
public class SwitchableGui : Core_BaseScript
{
	...
	private bool _003CIKNIGPKOPAL_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private bool _003CNIMIAILJOFB_003Ek__BackingField;

	[FormerlySerializedAs("CMMFNHCOLJM")]
	public bool CLOAEKHKBHF;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private GuiScreen _003CIDFANONCFNC_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private GuiScreen _003CJCBFIDANOPI_003Ek__BackingField;

	[FormerlySerializedAs("JJAGIONGDOI")]
	public float HECFOEMLJCD = 1f;

	[FormerlySerializedAs("MPNPGBLIBAO")]
	public float DCIKANJJFIJ = 1f;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private bool _003CJLAMOFBFIFB_003Ek__BackingField;
	...
	public bool readyToHide
	{
		...
		protected set
		{
			_003CIKNIGPKOPAL_003Ek__BackingField = value;
		}
	}
	...
	public bool readyToShowUp
	{
		...
		protected set
		{
			_003CNIMIAILJOFB_003Ek__BackingField = value;
		}
	}
	...
	public GuiScreen previousScreen
	{
		...
		set
		{
			_003CIDFANONCFNC_003Ek__BackingField = value;
		}
	}
	...
	public GuiScreen previousScreenForElementsToHide
	{
		...
		set
		{
			_003CJCBFIDANOPI_003Ek__BackingField = value;
		}
	}
	...
	public virtual bool isShowed
	{
		...
		protected set
		{
			_003CJLAMOFBFIFB_003Ek__BackingField = value;
		}
	}

	public bool isFullyShowed => isShowed && !CGMKKHNGHLM;
	...
	{
		ECKNNDKKKDJ(IDEBKDPMPGM: false);
		LBCNIBOEIFF(IDEBKDPMPGM: false);
	}

	public virtual void MOOACPIOELI()
	{
		MNCFFKKLKKM(IDEBKDPMPGM: false);
		LBCNIBOEIFF(IDEBKDPMPGM: false);
	}
	...
	{
		LDKPMGBKELN(IDEBKDPMPGM: true);
		DFHFMFAPLFL(IDEBKDPMPGM: false);
	}
	...
	public virtual void ADKCODGMIDB(bool JODEPBNLLAO)
	{
		...
		{
			float z = base.transform.localPosition.z;
			TweenPosition.Begin(base.gameObject, DCIKANJJFIJ, (!CLOAEKHKBHF) ? new Vector3(382f, 423f, z) : new Vector3(798f, 1768f, z), new Vector3(608f, 1790f, z), useLocal: false);
	...
	public virtual void GGOOMBMCDPL(bool EAKEFLLCHCJ)
	{
		if (base.gameObject.activeInHierarchy)
		{
			...
			{
				float z = base.transform.localPosition.z;
				TweenPosition.Begin(base.gameObject, HECFOEMLJCD, new Vector3(644f, 135f, z), (!CLOAEKHKBHF) ? new Vector3(484f, 1194f, z) : new Vector3(1068f, 692f, z), useLocal: false);
				num = HECFOEMLJCD;
			}
	...
	{
		ECKNNDKKKDJ(IDEBKDPMPGM: true);
		JDDOLIBINOC(IDEBKDPMPGM: false);
	}
	...
	{
		LDKPMGBKELN(IDEBKDPMPGM: true);
		GCENJJCIEHL(IDEBKDPMPGM: false);
	}

	public virtual void PDBDILLHKID()
	{
		MNCFFKKLKKM(IDEBKDPMPGM: true);
		DFHFMFAPLFL(IDEBKDPMPGM: false);
	}
	...
	public virtual void NNFAKNLMAJK(bool JODEPBNLLAO)
	{
		...
		if (JODEPBNLLAO || KELJGDKCJJJ == HJPGAGODCOA.Fade || KELJGDKCJJJ == HJPGAGODCOA.Fade)
		{
			mGNKEKPNCJL = FadeIn();
			base.transform.localPosition = PMJDGAIKLIM;
			TweenPosition.Begin(base.gameObject, 1980f, PMJDGAIKLIM, useLocal: false);
		}
		if (KELJGDKCJJJ == HJPGAGODCOA.TeenPositionAndFade || KELJGDKCJJJ == HJPGAGODCOA.TweenPosition)
		{
			float z = base.transform.localPosition.z;
			TweenPosition.Begin(base.gameObject, DCIKANJJFIJ, (!CLOAEKHKBHF) ? new Vector3(528f, 1155f, z) : new Vector3(96f, 1232f, z), new Vector3(1473f, 1155f, z), useLocal: false);
			mGNKEKPNCJL = DCIKANJJFIJ;
		}
	...
	public virtual void FABCFPJHOBH(bool JODEPBNLLAO)
	{
		...
		{
			float z = base.transform.localPosition.z;
			TweenPosition.Begin(base.gameObject, DCIKANJJFIJ, (!CLOAEKHKBHF) ? new Vector3(537f, 1052f, z) : new Vector3(1708f, 383f, z), new Vector3(870f, 1286f, z), useLocal: false);
			mGNKEKPNCJL = DCIKANJJFIJ;
		}
		JFLDMLOBIDL(mGNKEKPNCJL);
	}
