...
public class SkillShotDisplayer : PoolableObject
{
	private sealed class OEDCMGHNIDF : IEnumerator, IDisposable, IEnumerator<object>
	{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(49f, DLMKHPAJKDJ: true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
		...
		public bool OKELILGDPLJ()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(506f, DLMKHPAJKDJ: true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 0;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.JFJEJMHDMDG(IDEBKDPMPGM: false);
					BJGCPDNMHDH.DestroyPooled();
					CLPPIAGLCJJ = -1;
					break;
				}
		...
		public bool PMBOHHPPJAC()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(1399f, DLMKHPAJKDJ: false));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 0;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.PBNLJNBIBIO(IDEBKDPMPGM: true);
		...
		public bool IBEPOFJDKLG()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(1209f, DLMKHPAJKDJ: true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 0;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.EAGDKIFKPDM(IDEBKDPMPGM: true);
					BJGCPDNMHDH.DestroyPooled();
					CLPPIAGLCJJ = -1;
					break;
				}
		...
		public bool KKINHOPBKLH()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(1740f, DLMKHPAJKDJ: true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.JFCJMJOBILM(IDEBKDPMPGM: true);
					BJGCPDNMHDH.BOHCNEDIJPE();
					CLPPIAGLCJJ = -1;
					break;
				}
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(1921f, DLMKHPAJKDJ: true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 0;
							}
		...
		public bool DDBCLDGNFBB()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(204f, DLMKHPAJKDJ: false));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.DOIEBBMBKCN(IDEBKDPMPGM: true);
					BJGCPDNMHDH.BOHCNEDIJPE();
					CLPPIAGLCJJ = -1;
					break;
				}
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(1615f, DLMKHPAJKDJ: false));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(1348f, DLMKHPAJKDJ: false));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
		...
		public bool NOHPKMDNEAO()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(693f, DLMKHPAJKDJ: false));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.EFMLKEOIAOC(IDEBKDPMPGM: false);
					BJGCPDNMHDH.DestroyPooled();
					CLPPIAGLCJJ = -1;
					break;
				}
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(1315f, DLMKHPAJKDJ: true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
		...
		public bool CJGDOJHLOII()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(102f, DLMKHPAJKDJ: true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.JGIDFONLBAF(IDEBKDPMPGM: false);
					BJGCPDNMHDH.BOHCNEDIJPE();
					CLPPIAGLCJJ = -1;
					break;
				}
		...
		public bool ACHIHMMCDNF()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(1540f, DLMKHPAJKDJ: false));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 0;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.JFJEJMHDMDG(IDEBKDPMPGM: true);
					BJGCPDNMHDH.DestroyPooled();
					CLPPIAGLCJJ = -1;
					break;
				}
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(0.15f, DLMKHPAJKDJ: true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
		...
		public bool OOECALAHCFK()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(1656f, DLMKHPAJKDJ: true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 0;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.JDFILEOFIIP(IDEBKDPMPGM: false);
					BJGCPDNMHDH.DestroyPooled();
					CLPPIAGLCJJ = -1;
					break;
				}
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(1103f, DLMKHPAJKDJ: true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 0;
							}
		...
		public bool DMPHMFDEINI()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(291f, DLMKHPAJKDJ: false));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.LFHPFNOMMGL(IDEBKDPMPGM: false);
					BJGCPDNMHDH.OBCAIFMOPPA();
					CLPPIAGLCJJ = -1;
					break;
				}
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(170f, DLMKHPAJKDJ: true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
		...
		public bool CMBMOAECEJG()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(621f, DLMKHPAJKDJ: false));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 0;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.MFBIHIAHBIB(IDEBKDPMPGM: false);
					BJGCPDNMHDH.OBCAIFMOPPA();
					CLPPIAGLCJJ = -1;
					break;
				}
		...
		public bool FCPJPIDEPOF()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(650f, DLMKHPAJKDJ: false));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.JDFILEOFIIP(IDEBKDPMPGM: true);
					BJGCPDNMHDH.DestroyPooled();
					CLPPIAGLCJJ = -1;
					break;
				}
		...
		public bool GBLFIBDBMGE()
		{
				...
				try
				{
					...
					default:
						if (GHCPBBJDIBB.MoveNext())
						{
							...
							PHDOCKCBJOF = new WaitForSeconds(TimeManager.GetTimeScaledInterval(1369f, DLMKHPAJKDJ: true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 0;
							}
			...
			case 2u:
				{
					BJGCPDNMHDH.HGLCGMLMBNM(IDEBKDPMPGM: true);
					BJGCPDNMHDH.OBCAIFMOPPA();
					CLPPIAGLCJJ = -1;
					break;
				}
	...
	[CompilerGenerated]
	private bool _003CNBLCNCGALCN_003Ek__BackingField;
	...
	public bool isPlaying
	{
		...
		private set
		{
			_003CNBLCNCGALCN_003Ek__BackingField = value;
		}
	}
