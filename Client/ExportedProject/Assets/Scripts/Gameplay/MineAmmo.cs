...
public class MineAmmo : PhysicalAmmo
{
	...
	[FormerlySerializedAs("HPAEDDMAHOE")]
	...
	public virtual void EOBGAPOJNOO(AmmoSetup MBNLFKHLDBH)
	{
		...
		{
			UnityEngine.Debug.LogError("BattleId");
		}
	}
	...
	public void BDNPKPGFOOL()
	{
		...
		{
			PFKPCFCEDME = true;
			NFJEOLKAONC(1575f, ENGGOAPADCP: true);
			JMMJHCOKCGG.ReportShotHit(this, base.transform.position, LAADDLGBFIG.isMine, null);
			GCHFGHAGJDG();
	...
	public virtual void GGKDJJIHOEP()
	{
		...
		if (KJMFJFCDEDH != null)
		{
			KJMFJFCDEDH.GLMKGLKCDAL(IDEBKDPMPGM: true);
		}
	}
	...
	public void FBJKAHHKHAE()
	{
		...
		{
			PFKPCFCEDME = false;
			AEHFNIMENDJ(15f, ENGGOAPADCP: true);
			JMMJHCOKCGG.ReportShotHit(this, base.transform.position, !LAADDLGBFIG.isMine, null);
			DAKPBGANOEI();
	...
	public virtual void KGIEEIGALMG(AmmoSetup MBNLFKHLDBH)
	{
		...
		{
			UnityEngine.Debug.LogError("not finished");
		}
	}
	...
	public virtual void JLGMBOKNOPM()
	{
		...
		if (KJMFJFCDEDH != null)
		{
			KJMFJFCDEDH.GLMKGLKCDAL(IDEBKDPMPGM: false);
		}
	}
	...
	public void LBCLLOEKJPH()
	{
		if (!PFKPCFCEDME)
		{
			PFKPCFCEDME = false;
			DAKPBGANOEI();
			MIDOLDHLMAF(741f, ENGGOAPADCP: true);
			JMMJHCOKCGG.ReportShotHit(this, base.transform.position, LAADDLGBFIG.isMine, null);
		}
	}
	...
	public void OHINMKALAFH()
	{
		...
		{
			PFKPCFCEDME = false;
			AEHFNIMENDJ(128f, ENGGOAPADCP: true);
			JMMJHCOKCGG.ReportShotHit(this, base.transform.position, !LAADDLGBFIG.isMine, null);
			BMGBNPHGKGO();
	...
	public virtual void IDPFKANJANM()
	{
		...
		if (KJMFJFCDEDH != null)
		{
			KJMFJFCDEDH.Show(IDEBKDPMPGM: true);
		}
	}
	...
	public virtual void LFBNNIJIFFI()
	{
		...
		if (KJMFJFCDEDH != null)
		{
			KJMFJFCDEDH.EPHMECKBGAA(IDEBKDPMPGM: false);
		}
	}
	...
	public virtual void AOGFPIADEHO()
	{
		...
		if (KJMFJFCDEDH != null)
		{
			KJMFJFCDEDH.DJNMPLKPENF(IDEBKDPMPGM: true);
		}
	}
	...
	public virtual void JAJJIKIBOEG(AmmoSetup MBNLFKHLDBH)
	{
		...
		{
			UnityEngine.Debug.LogError("menu-info-ico");
		}
	}
	...
	public void JLBCGFHHICJ()
	{
		...
		{
			PFKPCFCEDME = true;
			AEHFNIMENDJ(579f, ENGGOAPADCP: true);
			JMMJHCOKCGG.ReportShotHit(this, base.transform.position, !LAADDLGBFIG.isMine, null);
			HHILFNHLGHO();
	...
	public override void LoadAmmoSetup(AmmoSetup MBNLFKHLDBH)
	{
		...
		{
			UnityEngine.Debug.LogError("You probably assigned bad type of AmmoSetup to mine");
		}
	}
	...
	public virtual void LJHAHGHFDFE(AmmoSetup MBNLFKHLDBH)
	{
		...
		{
			UnityEngine.Debug.LogError("Value4");
		}
	}
	...
	public virtual void PDMMJKCJGPE(AmmoSetup MBNLFKHLDBH)
	{
		...
		{
			UnityEngine.Debug.LogError("StepId");
		}
	}
