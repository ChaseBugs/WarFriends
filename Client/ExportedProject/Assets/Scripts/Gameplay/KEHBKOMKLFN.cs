...
{
	public override string name => Localization.Localize("ID_FEATURE_MAGAZINE");

	public override string fancyName => Localization.Localize("ID_FEATURE_MAGAZINE-FANCY");

	public override string icon => "menu-army-ammo-ico";

	public override bool menuMainAtlas => false;

	public override string description => Localization.Localize("ID_FEATURE_MAGAZINE-DESCRIPTION");

	public override string statisticIncrease => MEJMLNDFDBP.DPAFFLMAFJG(base.value);

	public override string weaponPrefix => Localization.Localize("ID_FEATURE_MAGAZINE-WEAPONPREFIX");

	public override float clipSizeCoef => 1f + (float)base.value;
