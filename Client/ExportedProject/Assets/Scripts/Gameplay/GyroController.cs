...
public class GyroController : MonoBehaviour
{
	...
	[FormerlySerializedAs("OPOIBODDPMI")]
	public Quaternion KGPGAPNAIBM;

	public void HGAFMOJIIGA()
	{
		OKLAKKMAJGG = false;
		LEIOILJPDCJ(HLJINDGKCGB: true);
		GGCPJPOPPEJ();
	}
