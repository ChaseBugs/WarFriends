...
public class LEDNENKKDJM
{
	...
	private sealed class PADJFKLJGHH
	{
		...
		internal void CIFEDFPPPOK(bool FBFJNHLKJEC)
		{
			...
			{
				Debug.Log("QUITTER");
				LoadingDialog.ShowLoading(Localization.Localize("AddCoopScoreRPC"), DMDICGADGCG: false, BGOHKCCLDJP: false, KKLNBPJCLHC: true);
			...
			LoadingDialog.PGFBMJFLHPC(Localization.Localize("0"), DMDICGADGCG: true, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
		...
		internal void MCFGAFBEJDK(bool FBFJNHLKJEC)
		{
			if (FBFJNHLKJEC)
			{
				...
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("menu-army-ammo-ico"), DMDICGADGCG: false, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
				GameLoginManager.instance.acountDataDownloadingInProgress = true;
				Singleton<BeanstalkServerManager>.instance.HBCBKAPGJKG(PIIIKJJHJPN, PNHFNCDAJIJ: true);
				return;
			}
			...
			Singleton<DailyRewardManager>.instance.LNAIDLKGCFN = null;
			LoadingDialog.FDBHFJFKALH(Localization.Localize("setEmailCollection"), DMDICGADGCG: true, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
			GameLoginManager.instance.acountDataDownloadingInProgress = true;
			Singleton<GameController>.instance.FAFIFKHDPKN();
			Singleton<BeanstalkServerManager>.instance.CreateGcAccount(PIIIKJJHJPN);
		}
		...
		internal void BDCAFHOHEGM(bool FBFJNHLKJEC)
		{
			if (FBFJNHLKJEC)
			{
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("special"), DMDICGADGCG: false, BGOHKCCLDJP: false, KKLNBPJCLHC: true);
				GameLoginManager.instance.acountDataDownloadingInProgress = true;
				Singleton<BeanstalkServerManager>.instance.HBCBKAPGJKG(PIIIKJJHJPN, PNHFNCDAJIJ: true);
				return;
			}
			...
			Singleton<MessageManager>.instance.ClearAllMessages();
			Singleton<DailyRewardManager>.instance.LNAIDLKGCFN = null;
			LoadingDialog.ShowLoading(Localization.Localize("Level"), DMDICGADGCG: true, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
			GameLoginManager.instance.acountDataDownloadingInProgress = true;
		...
		internal void KJIFNOJILDB(bool FBFJNHLKJEC)
		{
			...
			{
				Debug.Log("/");
				LoadingDialog.FDBHFJFKALH(Localization.Localize("ID_RANDOMWARCARDS"), DMDICGADGCG: true, BGOHKCCLDJP: false, KKLNBPJCLHC: true);
				GameLoginManager.instance.acountDataDownloadingInProgress = false;
				Singleton<BeanstalkServerManager>.instance.HBCBKAPGJKG(PIIIKJJHJPN, PNHFNCDAJIJ: true);
				return;
			}
		...
		internal void FHDOHCJJEMM(bool FBFJNHLKJEC)
		{
			if (FBFJNHLKJEC)
			{
				...
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("percent"), DMDICGADGCG: false, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
				GameLoginManager.instance.acountDataDownloadingInProgress = false;
				Singleton<BeanstalkServerManager>.instance.HBCBKAPGJKG(PIIIKJJHJPN, PNHFNCDAJIJ: true);
				return;
			}
			...
			Singleton<MessageManager>.instance.ClearAllMessages();
			Singleton<DailyRewardManager>.instance.LNAIDLKGCFN = null;
			LoadingDialog.ShowLoading(Localization.Localize("ЗАГРУЗИТЬ"), DMDICGADGCG: true, BGOHKCCLDJP: true);
			GameLoginManager.instance.acountDataDownloadingInProgress = false;
			Singleton<GameController>.instance.FAFIFKHDPKN();
			Singleton<BeanstalkServerManager>.instance.CreateGcAccount(PIIIKJJHJPN);
		}
		...
		internal void GMFJFMHNDMC(bool FBFJNHLKJEC)
		{
			if (FBFJNHLKJEC)
			{
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("Leaderboard removed succesfully"), DMDICGADGCG: true, BGOHKCCLDJP: false, KKLNBPJCLHC: true);
				GameLoginManager.instance.acountDataDownloadingInProgress = true;
				Singleton<BeanstalkServerManager>.instance.HBCBKAPGJKG(PIIIKJJHJPN, PNHFNCDAJIJ: true);
				return;
			}
			...
			Singleton<MessageManager>.instance.ClearAllMessages();
			Singleton<DailyRewardManager>.instance.LNAIDLKGCFN = null;
			LoadingDialog.FDBHFJFKALH(Localization.Localize("Grenade_Throwing_Tutorial_Duration"), DMDICGADGCG: true, BGOHKCCLDJP: true);
			GameLoginManager.instance.acountDataDownloadingInProgress = true;
			Singleton<GameController>.instance.FAFIFKHDPKN();
			Singleton<BeanstalkServerManager>.instance.CreateGcAccount(PIIIKJJHJPN);
		}
		...
		internal void NAJNECOMDDN(bool FBFJNHLKJEC)
		{
			...
			Singleton<DailyRewardManager>.instance.LNAIDLKGCFN = null;
			LoadingDialog.ShowLoading(Localization.Localize("TotalAmmo"), DMDICGADGCG: true, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
			GameLoginManager.instance.acountDataDownloadingInProgress = false;
			Singleton<GameController>.instance.FAFIFKHDPKN();
			Singleton<BeanstalkServerManager>.instance.CreateGcAccount(PIIIKJJHJPN);
		}
		...
		internal void BMCMDMKGHHO(bool FBFJNHLKJEC)
		{
			if (FBFJNHLKJEC)
			{
				...
				LoadingDialog.ShowLoading(Localization.Localize("menu-warbucks"), DMDICGADGCG: true, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
				GameLoginManager.instance.acountDataDownloadingInProgress = false;
				Singleton<BeanstalkServerManager>.instance.HBCBKAPGJKG(PIIIKJJHJPN, PNHFNCDAJIJ: true);
				return;
			}
			...
			Singleton<MessageManager>.instance.JJFNBAMGIDD();
			Singleton<DailyRewardManager>.instance.LNAIDLKGCFN = null;
			LoadingDialog.FDBHFJFKALH(Localization.Localize("WarShop"), DMDICGADGCG: false, BGOHKCCLDJP: false, KKLNBPJCLHC: true);
			GameLoginManager.instance.acountDataDownloadingInProgress = false;
			Singleton<GameController>.instance.FAFIFKHDPKN();
			Singleton<BeanstalkServerManager>.instance.CreateGcAccount(PIIIKJJHJPN);
		}
		...
		internal void MPHECHCFCAN(bool FBFJNHLKJEC)
		{
			if (FBFJNHLKJEC)
			{
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("ДА"), DMDICGADGCG: false, BGOHKCCLDJP: true);
				GameLoginManager.instance.acountDataDownloadingInProgress = false;
				Singleton<BeanstalkServerManager>.instance.HBCBKAPGJKG(PIIIKJJHJPN);
				return;
			}
			...
			Singleton<MessageManager>.instance.JJFNBAMGIDD();
			Singleton<DailyRewardManager>.instance.LNAIDLKGCFN = null;
			LoadingDialog.PGFBMJFLHPC(Localization.Localize("Grenade_Throwing_Tutorial_Duration"), DMDICGADGCG: true, BGOHKCCLDJP: false, KKLNBPJCLHC: true);
			GameLoginManager.instance.acountDataDownloadingInProgress = true;
			Singleton<GameController>.instance.PGCANLPKKOL();
			Singleton<BeanstalkServerManager>.instance.CreateGcAccount(PIIIKJJHJPN);
		}
	...
	internal void PAIDOPMKBPC(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG, DatabaseAction IFGAGNBDKBE, List<Tuple<string, string>> GMDJHENPLHB)
	{
		...
		default:
			if (CDLPMHEODBN != (IJEAJGCCHEF)(-58))
			{
				if (CDLPMHEODBN != (IJEAJGCCHEF)20)
				{
							...
							if (CDLPMHEODBN != (IJEAJGCCHEF)122)
							{
								if (CDLPMHEODBN != (IJEAJGCCHEF)(-126))
								{
									if (CDLPMHEODBN != (IJEAJGCCHEF)(-116) && CDLPMHEODBN != (IJEAJGCCHEF)(-160))
									{
										...
										{
											LoadingDialog.Hide();
											WarningDialog.ShowError(Localization.Localize("null"), Localization.Localize("{0} -> {1}"), 380f, null, string.Empty, JCOGJEEFLBC: true);
											break;
										}
										if (CDLPMHEODBN == (IJEAJGCCHEF)72)
										{
											WarningDialog.JACKIDKHKAI(Localization.Localize("ID_CONFIRM_ERROR"), Localization.Localize("Updated Player League And Medals to BeginnersLeague:{0} NormalLeague:{1} GlobalMedals:{2} LeagueMedals:{3} RemainingMatches:{4}"), 1528f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
											...
											CardCraftingManager.instance.SetWaitingForServerResponse(newValue: false);
										...
										{
											WarningDialog.ShowError(Localization.Localize("Donate_Card"), Localization.Localize("ERROR FROM SERVER "), 997f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
												...
												if (CDLPMHEODBN != (IJEAJGCCHEF)94)
												{
													if (CDLPMHEODBN != (IJEAJGCCHEF)(-36))
													{
														...
														case (IJEAJGCCHEF)(-80):
															...
															LoadingDialog.ShowLoading(Localization.Localize("shield_idle"), DMDICGADGCG: true, BGOHKCCLDJP: false, KKLNBPJCLHC: true);
															WarningDialog.ShowError(Localization.Localize("/ {0}{1}"), Localization.Localize("ID_VISUALCATEGORY1"), 1276f, BDIKIDFCDKO, Localization.Localize("ID_TUTORIAL_PROGRESS_KILLING2"), JCOGJEEFLBC: true);
															return;
														case (IJEAJGCCHEF)68:
															WarningDialog.ShowError(Localization.Localize("dogtag"), Localization.Localize("LevelName"), 622f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
															return;
														case (IJEAJGCCHEF)71:
															WarningDialog.ShowError(Localization.Localize(". "), Localization.Localize("ID_ARENARULES_DOUBLEAMMO"), 1950f, null, string.Empty, JCOGJEEFLBC: true);
															return;
														case (IJEAJGCCHEF)(-196):
															WarningDialog.JACKIDKHKAI(Localization.Localize("Arena Wins: "), Localization.Localize("\\D*"), 900f, pADJFKLJGHH.IFOPOPPMCFG, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
														...
														case (IJEAJGCCHEF)(-26):
															...
															WarningDialog.ShowError(Localization.Localize(" NOT OK!\t\t\t\t\t\t"), Localization.Localize("groundBoxHit"), 1150f, null, string.Empty, JCOGJEEFLBC: true);
														...
														case (IJEAJGCCHEF)(-145):
															...
															Singleton<BeanstalkServerManager>.instance.MatchMakingGameWasCreated(FBFJNHLKJEC: true);
															return;
														case (IJEAJGCCHEF)18:
															Debug.LogError("seconds" + jHOGFIPAAJH.IFGAGNBDKBE);
															WarningDialog.KHOMNBHMFGA(Localization.Localize("ID_ASSIGNMENTHINTWARPATH"), Localization.Localize("GoldDeducted"), 627f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
														...
														case (IJEAJGCCHEF)117:
															LoadingDialog.Hide();
															WarningDialog.ShowError(Localization.Localize(","), Localization.Localize("ID_DIVISION"), 1476f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
															return;
														...
														case (IJEAJGCCHEF)93:
															...
															return;
														case (IJEAJGCCHEF)68:
															WarningDialog.JACKIDKHKAI(Localization.Localize(" set league "), Localization.Localize("Time"), 1595f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
															BeanstalkServerManager.LoadSquadMembers(EENKJBCCPBG);
															return;
														case (IJEAJGCCHEF)(-194):
															break;
														case (IJEAJGCCHEF)133:
															WarningDialog.JACKIDKHKAI(Localization.Localize("AndroidID"), Localization.Localize("ID_WARNING_WRONGINDEXTOACTIVATEELITE"), 1042f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
															return;
														...
														case IJEAJGCCHEF.PlayerNameTaken:
															WarningDialog.ShowError(Localization.Localize("PowerBandId"), Localization.Localize("T_pose"), 1706f, null, string.Empty, JCOGJEEFLBC: true);
															return;
														...
														case (IJEAJGCCHEF)43:
															...
															return;
														case (IJEAJGCCHEF)(-64):
															WarningDialog.KHOMNBHMFGA(Localization.Localize("Cards"), Localization.Localize("Shots_Fired"), 686f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
															if (EENKJBCCPBG.ContainsKey("shield_unhide"))
															{
																Singleton<OfferManager>.instance.UpdateFromServer((JToken)EENKJBCCPBG["0"], IPDFNBKLLLO: true);
															}
															else
															{
									...
									if (Singleton<GameController>.instance.isInMenuOrWait)
									{
										...
										{
											WarningDialog.JACKIDKHKAI(Localization.Localize("LootboxCost"), Localization.Localize("forDay"), 22f, MGHBLNJMDHL, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
										}
										else
										{
											WarningDialog.KHOMNBHMFGA(Localization.Localize("ID_CONFIRM_FRIENDINSQUAD"), Localization.Localize("ID_DEBUG_STACKTRACEINCONSOLE"), 1486f, LEBLHNDFNEK, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
										}
									}
								}
								else
					...
					WarningDialog.ShowError(Localization.Localize("_qbz2"), Localization.Localize("ID_STARTERASSIGNMENT"), 1644f, null, string.Empty, JCOGJEEFLBC: true);
					BeanstalkServerManager.LoadSquadMembers(EENKJBCCPBG);
					break;
				}
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("added"), Localization.Localize("Video_feed_watched"), 1420f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
			break;
		case (IJEAJGCCHEF)(-26):
			Singleton<BeanstalkServerManager>.instance.UserLoggedOut();
			...
			LoadingDialog.FDBHFJFKALH(Localization.Localize("withPublisherSub4"), DMDICGADGCG: false, BGOHKCCLDJP: true);
			WarningDialog.KHOMNBHMFGA(Localization.Localize("ID_TUTORIAL_UPGRADEWEAPON_8"), Localization.Localize("D3"), 1732f, AMEDBJHACKK, Localization.Localize(" succesfully joined squad "), JCOGJEEFLBC: true);
			break;
		case (IJEAJGCCHEF)(-91):
		...
		case (IJEAJGCCHEF)(-94):
		{
			WarningDialog.ShowError(Localization.Localize(" ID_"), Localization.Localize("No Request ready or already sent"), 95f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
		...
		case (IJEAJGCCHEF)(-93):
		{
			WarningDialog.KHOMNBHMFGA(Localization.Localize("Cards_Owned_Silver"), Localization.Localize("setPluginName"), 817f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
		...
		case (IJEAJGCCHEF)2:
			...
			break;
		case (IJEAJGCCHEF)74:
			WarningDialog.ShowError(Localization.Localize("WarArenaData"), Localization.Localize("InstantBattleEnded: LEVEL UP "), 1489f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
			if (EENKJBCCPBG.ContainsKey("ID_CONGRATULATIONSPLACEDINLEAGUE"))
			{
				Singleton<AwaitingSquadMembersManager>.instance.FFAGKCAPLIO(EENKJBCCPBG["ID_CONFIRM_KICKPLAYER"].ToString(), IHJGCEHAAJN: true);
			}
			break;
		case (IJEAJGCCHEF)73:
		{
			...
			array3[0] = text3;
			WarningDialog.ShowError(hOLNKOFHDNK, Localization.LocalizeFormat("ID_PLAYERLEAGUEPROCESSINGHINT", array3), 1942f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
			if (EENKJBCCPBG.ContainsKey("ios"))
			{
				Singleton<AwaitingSquadMembersManager>.instance.EOPEBHMLGBP(EENKJBCCPBG["ID_SILVERSMALL"].ToString(), IHJGCEHAAJN: true);
			}
			break;
		}
		...
		case (IJEAJGCCHEF)(-1):
			LoadingDialog.Hide();
			WarningDialog.ShowError(Localization.Localize("null"), Localization.Localize("Warbucks"), 505f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
			break;
		case IJEAJGCCHEF.SameFacebookAlreadyCreated:
			WarningDialog.JACKIDKHKAI(Localization.Localize("0"), Localization.Localize("mortar_hide"), 1786f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
			break;
		case (IJEAJGCCHEF)0:
			LoadingDialog.Hide();
		...
		case (IJEAJGCCHEF)20:
			LoadingDialog.Hide();
			WarningDialog.ShowError(Localization.Localize("testingidsquadrankup"), Localization.Localize("]"), 952f, null, string.Empty, JCOGJEEFLBC: true);
			break;
		case (IJEAJGCCHEF)(-41):
			WarningDialog.ShowError(Localization.Localize("some_pub_sub3"), Localization.Localize(" AND "), 921f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
			break;
		case (IJEAJGCCHEF)17:
			if (Singleton<GameController>.instance.isInMenuOrWait)
			{
				...
				Singleton<GameController>.instance.Quit();
				WarningDialog.KHOMNBHMFGA(Localization.Localize("ID_TUTORIAL_TAPON"), Localization.Localize("OnAgeVerificationPendingDisplayed"), 360f, JFJBOAMMHGL, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
			}
			break;
		case (IJEAJGCCHEF)79:
		case (IJEAJGCCHEF)80:
		...
		case (IJEAJGCCHEF)(-56):
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.Localize("635 STAGE 10 PLAY CARD"), Localization.Localize("Squad"), 858f, null, string.Empty, JCOGJEEFLBC: true);
			break;
		}
		case (IJEAJGCCHEF)14:
			Singleton<BeanstalkServerManager>.instance.UserLoggedOut();
		...
		case (IJEAJGCCHEF)16:
		{
			...
			WarningDialog.KHOMNBHMFGA(empty, Localization.Localize("InAppRow '"), 355f, CMKECGNLPGJ, Localization.Localize("StepId"), JCOGJEEFLBC: true, EENKJBCCPBG.ContainsKey("animationEnd"));
			break;
		}
		case (IJEAJGCCHEF)(-24):
			if (Singleton<GameController>.instance.isInMenuOrWait)
		...
		case (IJEAJGCCHEF)15:
			...
			IL_0e12:
			WarningDialog.KHOMNBHMFGA(Localization.Localize("NotificationAction()"), Localization.Localize("ID_GUI_DELIVERING"), 325f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
			break;
		}
	}
	...
	internal void PMDEGLOIPEH(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG, DatabaseAction IFGAGNBDKBE, List<Tuple<string, string>> GMDJHENPLHB)
	{
			...
			if (CDLPMHEODBN != (IJEAJGCCHEF)(-195))
			{
				if (CDLPMHEODBN != (IJEAJGCCHEF)(-59) && CDLPMHEODBN != (IJEAJGCCHEF)96)
				{
					if (CDLPMHEODBN != (IJEAJGCCHEF)9)
					{
										...
										if (CDLPMHEODBN != (IJEAJGCCHEF)64)
										{
											if (CDLPMHEODBN != IJEAJGCCHEF.DecalCategoryNotFound)
											{
												...
												case (IJEAJGCCHEF)(-106):
													Singleton<BeanstalkServerManager>.instance.INNIDHNEKEA();
													Singleton<BeanstalkServerManager>.instance.CancelAllRequests();
													LoadingDialog.ShowLoading(Localization.Localize("!!!UNDER TABLE!!! "), DMDICGADGCG: false, BGOHKCCLDJP: true, KKLNBPJCLHC: true);
													WarningDialog.JACKIDKHKAI(Localization.Localize("Video {0:2}"), Localization.Localize("PlayerData"), 478f, BDIKIDFCDKO, Localization.Localize("Create player instance at "), JCOGJEEFLBC: true);
													return;
												...
												case (IJEAJGCCHEF)(-151):
													...
													WarningDialog.JACKIDKHKAI(Localization.Localize("ID_BEGINNERSLEAGUE2"), Localization.Localize("unregisterConnectionCallbacks"), 704f, null, string.Empty, JCOGJEEFLBC: true);
												...
												case (IJEAJGCCHEF)80:
													...
													WarningDialog.ShowError(Localization.Localize("ID_READYTIME"), Localization.Localize("NewLevelId"), 1965f, null, string.Empty, JCOGJEEFLBC: true);
												...
												case (IJEAJGCCHEF)195:
													LoadingDialog.Hide();
													WarningDialog.ShowError(Localization.Localize("ID_SQUADWAREND"), Localization.Localize(" arena id"), 905f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
													return;
												case (IJEAJGCCHEF)85:
												{
													Singleton<BeanstalkServerManager>.instance.BPDHHBFKHJP();
												...
												case (IJEAJGCCHEF)(-71):
													...
													return;
												case (IJEAJGCCHEF)(-56):
													WarningDialog.KHOMNBHMFGA(Localization.Localize("null"), Localization.Localize("Player {0} {1}"), 975f, null, string.Empty, JCOGJEEFLBC: true);
													return;
												case (IJEAJGCCHEF)(-37):
													WarningDialog.KHOMNBHMFGA(Localization.Localize("Mortar"), Localization.Localize(" "), 1291f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
													return;
												case (IJEAJGCCHEF)(-52):
													WarningDialog.ShowError(Localization.Localize("leagueDiff"), Localization.Localize("Para funcionar, WarFriends necesita descargar unos 190 MB de datos adicionales.\nEl tiempo de descarga puede variar, dependiendo de tu red y tu ubicación.\n\n¿Continuar?"), 1638f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
													BeanstalkServerManager.LoadSquadMembers(EENKJBCCPBG);
													return;
												case (IJEAJGCCHEF)(-104):
													WarningDialog.ShowError(Localization.Localize("Ground texture: "), Localization.Localize("#DEBUG_50# "), 496f, pADJFKLJGHH.EJLGBICBIFK, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
													GameLoginManager.instance.LogoutFromFacebook(clientOnly: true);
												...
												case (IJEAJGCCHEF)35:
													break;
												case (IJEAJGCCHEF)82:
													WarningDialog.ShowError(Localization.Localize("Generating extra enemy"), Localization.Localize("logout from FB"), 1819f, null, string.Empty, JCOGJEEFLBC: true);
													return;
												case (IJEAJGCCHEF)(-73):
												{
												...
												case (IJEAJGCCHEF)(-155):
													WarningDialog.JACKIDKHKAI(Localization.Localize("com.aboutfun.soldiers"), Localization.Localize("ID_PLAYAGAIN"), 790f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
													return;
												...
												case (IJEAJGCCHEF)76:
													...
													{
														Singleton<OfferManager>.instance.UpdateFromServer((JToken)EENKJBCCPBG["RewardMessage"], IPDFNBKLLLO: true);
													}
													else
													{
														Singleton<OfferManager>.instance.UpdateFromServer(null);
						...
						WarningDialog.KHOMNBHMFGA(Localization.Localize("ID_NOTIFICATION_DAILYREWARD_CARD"), Localization.Localize("ManualRegisterForPushNotifications("), 524f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
					...
					CardCraftingManager.instance.SetWaitingForServerResponse(newValue: true);
					CardManager.instance.LoadData(KHJJFPPACBP.BKFCLMMJNHK(EENKJBCCPBG[")"], string.Empty));
					break;
				}
				LoadingDialog.Hide();
				WarningDialog.KHOMNBHMFGA(Localization.Localize("ShotFrequencyMax"), Localization.Localize("menu-arena-ticket"), 1245f, null, string.Empty, JCOGJEEFLBC: true);
				break;
			}
		...
		case (IJEAJGCCHEF)199:
			...
			WarningDialog.ShowError(Localization.Localize("ID_RENTAL_SHOTGUN"), Localization.Localize("LevelExperience"), 1124f, LOLHPMKHCBF, Localization.Localize("getHighSpenderProbability"), JCOGJEEFLBC: true);
			break;
		case (IJEAJGCCHEF)9:
		...
		case (IJEAJGCCHEF)(-122):
			...
			break;
		case (IJEAJGCCHEF)(-50):
			WarningDialog.KHOMNBHMFGA(Localization.Localize("_FrustumCornersWS"), Localization.Localize("DogTagSeconds"), 362f, GJAENDJLJJF, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
			break;
		case (IJEAJGCCHEF)(-125):
		{
			WarningDialog.ShowError(Localization.Localize("0"), Localization.Localize("ID_CONFIRM_PLAYERNOTEXISTS_TEXT"), 1724f, null, string.Empty, JCOGJEEFLBC: true);
		...
		{
			WarningDialog.JACKIDKHKAI(Localization.Localize("sniper_idle"), Localization.Localize("menu-sidetab-messageicon"), 1343f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
		...
		{
			WarningDialog.ShowError(Localization.Localize("not added, called already!!"), Localization.Localize("ID_POSITIONXYREWARD"), 582f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
		...
		case (IJEAJGCCHEF)21:
			WarningDialog.ShowError(Localization.Localize("ID_BUTTONPREVIOUSHEROES"), Localization.Localize("Can not find player with fraction "), 893f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
			break;
		case (IJEAJGCCHEF)144:
			...
			break;
		case (IJEAJGCCHEF)(-51):
			WarningDialog.KHOMNBHMFGA(Localization.Localize("S"), Localization.Localize("ID_MAXSTAT"), 62f, null, string.Empty, JCOGJEEFLBC: true);
			if (EENKJBCCPBG.ContainsKey("fire"))
			{
				Singleton<AwaitingSquadMembersManager>.instance.JEONJCCHDMB(EENKJBCCPBG["SpentParts"].ToString(), IHJGCEHAAJN: false);
			}
			break;
		case (IJEAJGCCHEF)(-52):
		{
			...
			array3[1] = text3;
			WarningDialog.JACKIDKHKAI(hOLNKOFHDNK, Localization.LocalizeFormat("Show Ground", array3), 270f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
			if (EENKJBCCPBG.ContainsKey("Chillingo: On Restart Drawing "))
			{
				Singleton<AwaitingSquadMembersManager>.instance.JEONJCCHDMB(EENKJBCCPBG[" AND "].ToString(), IHJGCEHAAJN: true);
			}
			break;
		}
		...
		case (IJEAJGCCHEF)141:
			LoadingDialog.Hide();
			WarningDialog.KHOMNBHMFGA(Localization.Localize("S"), Localization.Localize("Buy_Unit"), 797f, null, string.Empty, JCOGJEEFLBC: false, PAHBOLDKBHK: true);
			break;
		case (IJEAJGCCHEF)145:
		...
		case (IJEAJGCCHEF)122:
			LoadingDialog.Hide();
			WarningDialog.ShowError(Localization.Localize("DogTagCap"), Localization.Localize("Wrong_Category"), 393f, null, string.Empty, JCOGJEEFLBC: true);
			break;
		case (IJEAJGCCHEF)(-83):
			WarningDialog.JACKIDKHKAI(Localization.Localize("fire"), Localization.Localize("FB: FacebookLogout - DeletePlayerAccount - 2"), 1457f, null, string.Empty, JCOGJEEFLBC: true);
			break;
		case (IJEAJGCCHEF)130:
			WarningDialog.JACKIDKHKAI(Localization.Localize(" "), Localization.Localize("ID_ARENARULES_NOSHIELDS"), 1688f, null, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
			BeanstalkServerManager.LoadSquadMembers(EENKJBCCPBG);
			break;
		case (IJEAJGCCHEF)(-195):
			WarningDialog.JACKIDKHKAI(Localization.Localize("bronze"), Localization.Localize("ID_WARNING_SERVERTIMEDOUT"), 1620f, null, string.Empty, JCOGJEEFLBC: true);
			break;
		case (IJEAJGCCHEF)(-168):
			if (Singleton<GameController>.instance.isInMenuOrWait)
			{
				...
				Singleton<GameController>.instance.TryStopLoading();
				Singleton<GameController>.instance.HGBNEFDBFDC();
				WarningDialog.ShowError(Localization.Localize("Chillingo SDK: activate offers"), Localization.Localize("ID_MEMBERSHIP_HINT5TRIAL"), 0f, EBGMHAGCFNB, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
			}
			break;
		case (IJEAJGCCHEF)(-93):
		case (IJEAJGCCHEF)(-92):
		...
		case (IJEAJGCCHEF)59:
			...
			if (Singleton<GameController>.instance.isInMenuOrWait)
			{
				...
				{
					WarningDialog.ShowError(Localization.Localize("SquadWarsId"), Localization.Localize("ID_VISUALRARITY3"), 2f, BPPHEBADMAG, string.Empty, JCOGJEEFLBC: true, PAHBOLDKBHK: true);
				}
				else
				{
		...
		case (IJEAJGCCHEF)(-169):
		{
			...
			WarningDialog.KHOMNBHMFGA(empty, Localization.Localize(" {0}{1}"), 1164f, LMIOPPOPNLN, Localization.Localize("ID_PURCHASED"), JCOGJEEFLBC: false, EENKJBCCPBG.ContainsKey("ID_LEAGUEPROMOTION"));
			break;
		}
	...
	public static void MDCHGDJIGAA()
	{
		...
		WarningDialog.ShowError(Localization.Localize("-veteran"), Localization.Localize("GoldCoefficient"), 1209f, delegate
		{
			...
			Singleton<BeanstalkServerManager>.instance.DHFLFIEBDAF = false;
		}, Localization.Localize("ID_INROOKIE2"), JCOGJEEFLBC: true);
	}
	...
	public static void LBLCJNOGPBL()
	{
		...
		WarningDialog.KHOMNBHMFGA(Localization.Localize("()I"), Localization.Localize("visuals: null"), 346f, delegate
		{
			...
			LoadingDialog.ShowLoading(Localization.Localize("ID_CONNECTING"));
			Singleton<BeanstalkServerManager>.instance.DHFLFIEBDAF = false;
		}, Localization.Localize("ID_NA"), JCOGJEEFLBC: false, PAHBOLDKBHK: true);
	}
	...
	internal void GOEHBPFDMLM(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG, DatabaseAction IFGAGNBDKBE, List<Tuple<string, string>> GMDJHENPLHB)
	{
		...
		case IJEAJGCCHEF.ServerError:
			...
			{
				GameLoginManager.Relog();
			}, Localization.Localize("ID_RETRY"), JCOGJEEFLBC: true);
			break;
		...
		case IJEAJGCCHEF.CouldNotStartGame:
			...
			Singleton<BeanstalkServerManager>.instance.MatchMakingGameWasCreated(FBFJNHLKJEC: false);
			break;
		...
		case IJEAJGCCHEF.SquadJoinRequestNotExists:
			...
			{
				Singleton<AwaitingSquadMembersManager>.instance.OnPlayerAcceptedOrDeclined(EENKJBCCPBG["PlayerId"].ToString(), IHJGCEHAAJN: true);
			}
			break;
		...
		case IJEAJGCCHEF.AccountBanned:
		{
			...
			{
				GameLoginManager.Relog();
			}, Localization.Localize("ID_RETRY"), JCOGJEEFLBC: true, EENKJBCCPBG.ContainsKey("canSendLogs"));
			break;
		}
	...
	public static void BKEEBIDAAOG()
	{
		...
		WarningDialog.ShowError(Localization.Localize("XP"), Localization.Localize("Army_Unit_ID"), 174f, delegate
		{
			...
			LoadingDialog.ShowLoading(Localization.Localize("ID_CONNECTING"));
			Singleton<BeanstalkServerManager>.instance.DHFLFIEBDAF = false;
		}, Localization.Localize("Overtime_Was_Already_Explained"), JCOGJEEFLBC: false, PAHBOLDKBHK: true);
	}
