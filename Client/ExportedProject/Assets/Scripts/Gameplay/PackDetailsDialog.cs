...
public class PackDetailsDialog : GuiElementSingle<PackDetailsDialog>, PAIIOKBBHBC
{
	...
	[Header("Left")]
	[FormerlySerializedAs("JFBGODKNIKP")]
	...
	[FormerlySerializedAs("CGIEIBIDENM")]
	...
	[Header("Button")]
	[FormerlySerializedAs("AOFJIBMEMMC")]
	public UIButton PGBMNGMFBHD;

	[FormerlySerializedAs("MLDGEPOFCNE")]
	...
	private bool HEGPFIGACED(NGNPIOOAHEH IGOHEBEDMFH, CardPackRecord MEFPMJIOPLN)
	{
		...
		object[] array = new object[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-101)];
		array[0] = text;
	...
	private bool MFMJPBCIHEH(NGNPIOOAHEH IGOHEBEDMFH, CardPackRecord MEFPMJIOPLN)
	{
		...
		UILabel jPCIACBHGHO = JPCIACBHGHO;
		object[] array = new object[WarFriends.Legacy.DecompilerCompatibility.RuntimeArrayLength(-68)];
		array[1] = text;
		array[1] = CardManager.instance.cardsInPack;
		array[1] = num2;
