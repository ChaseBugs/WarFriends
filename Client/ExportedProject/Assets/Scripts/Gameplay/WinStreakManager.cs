...
public class WinStreakManager : DatabaseSerializedObjectGeneric<WinStreakManager.WinStreak>
{
	public class WinStreak
	{
		...
		public bool isInfinite => TimeStamp - Singleton<BeanstalkServerManager>.instance.currentTimestamp > (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.WinstreakInterval).FLOATVALUE;
		...
		public bool isActive => WinCount > 0 && (deadline > Singleton<BeanstalkServerManager>.instance.currentTimestamp || isInfinite);
