...
public abstract class KJMGFHMIBII
{
	...
	public virtual bool MBOHGLCBEFJ => false;
	...
	public virtual string NJKMFAGIKIE => "myLobby" + Singleton<CurrentBundleVersion>.instance.matchMakingVersionRanked;

	public TypedLobby FDABONGOFJO => new TypedLobby(NJKMFAGIKIE, LobbyType.SqlLobby);
	...
	public virtual int MANOCBMEGOK => 0;

	public virtual bool IGBMAJGJDEL => true;

	public virtual float MGOBKMIGPEK => Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.MaxPingToConnectRegion).FLOATVALUE;
	...
	public virtual List<CloudRegionCode> FCOKCCNOHBA => LKELMHBFOAH;
