...
{
	[FormerlySerializedAs("EDMBEKKEDBK")]
	[Header("Background")]
	public UISprite OKLIALBIMHC;

	[FormerlySerializedAs("GPIEJFDGGKM")]
	public UISprite NKJLNMGKAFL;

	[FormerlySerializedAs("KCFJKGJMALK")]
	public UISprite AIDOOKGKCBF;

	[FormerlySerializedAs("PCBOLCJBLJN")]
	[Header("Icon Part")]
	...
	[FormerlySerializedAs("FCGOAEMILBN")]
	public UISprite MENNNPNMMPF;

	[FormerlySerializedAs("HBAFLCHKHFE")]
	public UILabel IINGNIOGEAD;

	[FormerlySerializedAs("ENMOACKKEEH")]
	public UILabel AIELHBIOBJL;

	[FormerlySerializedAs("GECFFFDEADO")]
	public GameObject BHNCEHHMGFP;

	[FormerlySerializedAs("LGEOPAPGINN")]
	public UISprite NHDKLLCCJPO;

	[FormerlySerializedAs("NCNCHMBFBGO")]
	...
	[FormerlySerializedAs("JJCGCCFDAGN")]
	...
	{
		DHBOLLDMMEL.gameObject.SetActive(value: true);
		NGHCDIMLGMO.gameObject.SetActive(value: true);
		IPJGCHLDPNN.gameObject.SetActive(value: false);
		DNCJEBDPBNA.gameObject.SetActive(value: true);
		...
		BHNCEHHMGFP.SetActive(value: true);
	...
	{
		DHBOLLDMMEL.gameObject.SetActive(value: false);
		NGHCDIMLGMO.gameObject.SetActive(value: false);
		IPJGCHLDPNN.gameObject.SetActive(value: true);
		DNCJEBDPBNA.gameObject.SetActive(value: false);
		AIFGOKIDMMO.gameObject.SetActive(value: true);
	...
	private void BKFIIKNBGNM(int HNDGIJBHMOD)
	{
		...
		PHAIDPNIKIK.gameObject.SetActive(value: false);
		NKGDLICJDBG.SetActive(value: true);
		BHNCEHHMGFP.SetActive(value: false);
	...
	private void CNJPGBLOJFK(int IEALLELGOBM)
	{
		...
		AIFGOKIDMMO.gameObject.SetActive(value: false);
		PHAIDPNIKIK.gameObject.SetActive(value: false);
		NKGDLICJDBG.SetActive(value: false);
		BHNCEHHMGFP.SetActive(value: true);
