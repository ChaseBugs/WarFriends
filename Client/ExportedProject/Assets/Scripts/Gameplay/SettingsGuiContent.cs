...
{
	[Header("Core")]
	[FormerlySerializedAs("KAALEOEHBOK")]
	public SettingsButton DBFLEAABFGI;

	[FormerlySerializedAs("BIMPMDCAHOJ")]
	public SettingsButton EKJGFIPEKJB;

	[FormerlySerializedAs("APMAIEODKFB")]
	public SettingsButton IAOAJDBIAKH;

	[FormerlySerializedAs("AJALCECBKIH")]
	public SettingsButton FNHHPIDIKGE;

	[FormerlySerializedAs("DHNIKKDMILP")]
	public SettingsButton OCMKFJJKKFP;

	[FormerlySerializedAs("HLJNMJFLLGD")]
	...
	private void CFKBBDCJGDM(GameObject KHAHPAKDIKE)
	{
		...
		EKJGFIPEKJB.BMEHDKPGOEM(DHFPCPLBJEA(), OJKNMODJKPG: false);
	}
	...
	{
		DBFLEAABFGI.HICJHPKIMCC(IJEIBNNAKDB(), OJKNMODJKPG: false);
		EKJGFIPEKJB.EIKGDPJEJAL(DHFPCPLBJEA());
		IAOAJDBIAKH.HPMFEBKKDFO(MIDDFNLNKHN, OJKNMODJKPG: false);
		FNHHPIDIKGE.GBCDOBCFNOK(NLJBOJDAGEE());
		OCMKFJJKKFP.MLHECBGDMNE(ECBKIBKBJHM, OJKNMODJKPG: false);
		CKCIOAGNPED.PLMKLGGKMNH(KHAKFABBLAG, OJKNMODJKPG: false);
	}

	private void EIGHAKHHGEI(GameObject KHAHPAKDIKE)
	{
		MCBLPCLMCFB(!FFAMNEJDFHI);
		EKJGFIPEKJB.HBFBBLFKOMD(DHFPCPLBJEA(), OJKNMODJKPG: false);
	}
	...
	private void BFEOEKANJBP(GameObject KHAHPAKDIKE)
	{
		...
		IAOAJDBIAKH.NFAIPALMOON(BIKKNBENENH(), OJKNMODJKPG: false);
	}

	private void MKPNHDDPHGJ(GameObject KHAHPAKDIKE)
	{
		JPIONCCLHEN(BIKKNBENENH());
		IAOAJDBIAKH.KFOOJPEOIHP(BIKKNBENENH(), OJKNMODJKPG: false);
	}
	...
	{
		DBFLEAABFGI.HDFHLAKFNDE(BLOFHEBNAID, OJKNMODJKPG: false);
		EKJGFIPEKJB.HDFHLAKFNDE(FFAMNEJDFHI, OJKNMODJKPG: false);
		IAOAJDBIAKH.HDFHLAKFNDE(MIDDFNLNKHN, OJKNMODJKPG: false);
		FNHHPIDIKGE.HDFHLAKFNDE(LJKBCICLEME, OJKNMODJKPG: false);
		OCMKFJJKKFP.HDFHLAKFNDE(ECBKIBKBJHM, OJKNMODJKPG: false);
		CKCIOAGNPED.HDFHLAKFNDE(KHAKFABBLAG, OJKNMODJKPG: false);
	}
