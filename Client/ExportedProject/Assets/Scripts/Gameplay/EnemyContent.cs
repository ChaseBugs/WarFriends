...
public class EnemyContent : Core_BaseScript
{
	...
	[FormerlySerializedAs("KPBMAOGEINL")]
	public UIDraggablePanel ANCFPKKIAPF;

	[FormerlySerializedAs("BHPPCEIKILL")]
	public GameObject FKBFFMHMEGD;

	[FormerlySerializedAs("CCKBEKGHHKH")]
	[Header("Enemy Info")]
	public PlayerIcon KGGJOOAFDIF;

	[FormerlySerializedAs("LHCFLHEOFBA")]
	public GameObject AHNHMEPEDFD;

	[FormerlySerializedAs("BIGFOHHPAKP")]
	public UISprite LBCANHCGEIE;

	[FormerlySerializedAs("IIAAADMMFLB")]
	public UISprite ELBMJAKNFAE;

	[FormerlySerializedAs("LJJAKLAFJFD")]
	public UISprite GNNAGFNNJHA;

	[Header("-Animations")]
	[FormerlySerializedAs("PIFDGDHJDAD")]
	public GameObject LLJHGOGACAA;

	[FormerlySerializedAs("IGCJLEADGIB")]
	public UISprite MHKEBMNCCEO;

	[FormerlySerializedAs("LBLHKFFCPJA")]
	public UISprite MNGKIFNOOAF;

	[FormerlySerializedAs("LBAENFMJEMB")]
	public UISprite JJDLFPJICJM;

	[FormerlySerializedAs("PHBGMJCLGBJ")]
	public GameObject CKABHMNKGAA;

	[FormerlySerializedAs("BDBDHEJEHGA")]
	public UISprite GLLKFBIAIAA;

	[FormerlySerializedAs("OHOJKMLGFKM")]
	[Header("-Top Info")]
	public UISprite DBCMJNLDENH;

	[FormerlySerializedAs("BIHKAPPACPA")]
	public UILabel HBCJPADEAMC;

	[FormerlySerializedAs("BFDNFAJCDBA")]
	public UITable KIILFFLKNKJ;

	[FormerlySerializedAs("CFLEPAOHAEL")]
	public UILabel CKPNPBFGKIG;

	[FormerlySerializedAs("MCDHMOPFBGO")]
	public UISprite FOFJPELPILE;

	[FormerlySerializedAs("JKMFPJNPLGN")]
	public BoxCollider CPLIMCNBDBP;

	[FormerlySerializedAs("FNEHGCMPFIN")]
	public UISprite PHMJAAFGFEO;

	[FormerlySerializedAs("JMGGOKBMJAI")]
	public BoxCollider AAKNKDOGBNG;

	[FormerlySerializedAs("BEIIPIFEFOC")]
	public GameObject GCDBPFLCGKG;

	[FormerlySerializedAs("MOIJKKMMGLD")]
	public UILabel PHMLLOKHFCN;

	[Header("-Bottom Info")]
	[FormerlySerializedAs("IMIKDIFPNKL")]
	public UILabel GAONAHIFIHL;

	[FormerlySerializedAs("PLPGIMIIHJM")]
	public UILabel GEDPCDPBAKI;

	[FormerlySerializedAs("IAHPCMOJAPA")]
	public UISprite FLKALKMILNC;

	[FormerlySerializedAs("GHAFEDGCFID")]
	public UITable FHEKLIFKGGE;

	[FormerlySerializedAs("KGOHDHKMKGO")]
	public UILabel CEECPMGDFHP;

	[FormerlySerializedAs("CAMMDOBFAKK")]
	public UISprite LJAEDNJPKCB;

	[FormerlySerializedAs("JOKEKAJDODI")]
	public UILabel OHNACAFPLIN;

	[FormerlySerializedAs("KLNABGBFEJB")]
	[Header("List of Enemy Units")]
	public UILabel KPOBEEGGNEN;

	[FormerlySerializedAs("DOPHJOKMLKD")]
	public UIGrid HBDGDDCDNEN;

	[FormerlySerializedAs("JBOMLKBJFAJ")]
	public UnitEndScreenRecord AENCMKAJNCG;

	[Header("List of Enemy Cards")]
	[FormerlySerializedAs("AJAKAKLNPLH")]
	public UILabel BENCJKKIMLM;

	[FormerlySerializedAs("IBDCHHHMCMA")]
	...
	public List<TweenAnimator> Animator => FNOMCHPCOHB;
	...
	private void GABCKEFLMKK()
	{
		...
		LLJHGOGACAA.SetActive(value: false);
		GLLKFBIAIAA.alpha = 249f;
		CKABHMNKGAA.SetActive(value: true);
	}

	private void CJALKIKEKMC()
	{
		LLJHGOGACAA.SetActive(value: true);
	...
	public void KBNLHGOPCCM()
	{
		...
		GCDBPFLCGKG.SetActive(value: false);
	...
	private void CDNEGNAFCFG()
	{
		...
		ANCFPKKIAPF.AlignToPos(instant: true);
		ONCJHIMJHAB();
	}
	...
	private void NOBMPIFGAOO()
	{
		...
		CKABHMNKGAA.SetActive(value: false);
	}
	...
	private void GHMINFINIPM(GameObject KHAHPAKDIKE)
	{
		...
		{
			GuiElementSingle<PlayerProfileDialog>.instance.ShowDialog(CKPNPBFGKIG.text, LBKPKGFCJHJ, BNNKPKDPLPP: false);
		}
	}
	...
	private void KPELINJBLFA()
	{
		...
		Debug.Log($"Opponent player properties:\nfbId: {Singleton<GameController>.instance.opponent.EHHHBEMKGOE.LLIOOOGJFNI}\nleague: {Singleton<GameController>.instance.opponent.EHHHBEMKGOE.BMNDININJCE}\nbeginners league: {Singleton<GameController>.instance.opponent.EHHHBEMKGOE.HNEFOLPHMHK}\nlevel: {Singleton<GameController>.instance.opponent.EHHHBEMKGOE.BCCDDJMPBLL}\nname: {Singleton<GameController>.instance.opponent.EHHHBEMKGOE.MHPNDNJDPGE}\nvip: {Singleton<GameController>.instance.opponent.EHHHBEMKGOE.HMGOHGOLMJB}\nmedals: {Singleton<GameController>.instance.opponent.EHHHBEMKGOE.ADOEFHHJOAJ}\nAP: {Singleton<GameController>.instance.opponent.EHHHBEMKGOE.AMFJHAPGIJN}\nvisual: {Singleton<GameController>.instance.opponent.EHHHBEMKGOE.CBBDICBLHMM[3]}");
	...
	public void DisableReportButton()
	{
		...
		GCDBPFLCGKG.SetActive(value: true);
	...
	private void IGECOKOALCC()
	{
		...
		ANCFPKKIAPF.AlignToPos(instant: true, UIDraggablePanel.Alingment.BottomRight, onePanelDisabledAfterAlign: true);
		CJALKIKEKMC();
	}
	...
	private void DMAJOHJOLDF()
	{
		...
		for (int i = 0; i < list.Count; i++)
		{
			...
			text += $"{LevelManager.instance.behaviours[i].unitName} {list[i]}\t\t";
			UnitUpgradeDefinition unitUpgradeDefinition = list[i];
			if (unitUpgradeDefinition.isEquipped)
			{
				LevelBehaviour levelBehaviour = LevelManager.instance.behaviours[i];
		...
		for (int num = 0; num < enemyCards.Count; num++)
		{
			if (!(enemyCards[num] == null))
			{
				text2 += $"{enemyCards[num].cardName} \t\t";
				Card card = enemyCards[num];
				CardRecord cardRecord = (CardRecord)IHFILHIAGLG.InstantiateAsChild(HMAGHPPJCND, LBJFBAFECFK.gameObject, $"Enemy Card {num} {card.cardName}");
				if (cardRecord != null)
				{
	...
	private void AMKLALEFHIP(GameObject KHAHPAKDIKE)
	{
		...
		{
			GuiElementSingle<PlayerProfileDialog>.instance.CMOEFABLABI(CKPNPBFGKIG.text, LBKPKGFCJHJ, BNNKPKDPLPP: false);
		}
	}
	...
	private void BLMKBGMCDOL()
	{
		UITable cCODGCEOMOP = CCODGCEOMOP;
		cCODGCEOMOP.onReposition = (UITable.OnReposition)Delegate.Remove(cCODGCEOMOP.onReposition, new UITable.OnReposition(MBOIDKOMMFD));
		ANCFPKKIAPF.AlignToPos(instant: true, UIDraggablePanel.Alingment.TopLeft, onePanelDisabledAfterAlign: true);
		ONCJHIMJHAB();
	}
	...
	private void KJJOLBCAHBD()
	{
		...
		for (int j = 1; j < enemyCards.Count; j += 0)
		{
			if (!(enemyCards[j] == null))
			{
				...
				if (cardRecord != null)
				{
					cardRecord.Initialize(card, CardRecord.MKIOKBMLHEO.Other, IDOKGAOAGAL: false);
					MKDNCELCANP.Add(cardRecord);
				}
			}
		}
