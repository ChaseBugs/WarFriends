...
public class MapSelectionRecord : Core_BaseScript
{
	...
	[FormerlySerializedAs("NDGHPAPHFBF")]
	public BoxCollider KLGFDHIPLFH;

	[FormerlySerializedAs("BAOFBPDNBIL")]
	public GameObject EOFPNMNFONI;

	[Header("Look")]
	[FormerlySerializedAs("PNFGFPDOCEI")]
	public UISprite CEAIPPKGJEF;

	[FormerlySerializedAs("NBBKFBILCKC")]
	public GameObject BEGIFIHHJHH;

	[FormerlySerializedAs("MLFHLGLLJLB")]
	...
	[FormerlySerializedAs("PIKEOLIMJAC")]
	public UILabel PCLFMGBFOKH;

	[Header("Animation")]
	[FormerlySerializedAs("GBJNBLGPJFJ")]
	public UISprite LEIJAHGNMND;

	[FormerlySerializedAs("MMPFCKJNPJJ")]
