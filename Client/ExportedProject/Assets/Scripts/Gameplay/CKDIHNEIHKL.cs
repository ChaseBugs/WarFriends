...
public class CKDIHNEIHKL
{
	...
	private PlayerController _003COPCFPJLGOLK_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private int _003CKNBOKMGIKIH_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private bool _003CCPPMNOHHAAK_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private int _003CPMMCDEFMDBP_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private int _003CAHOOHOFKLNC_003Ek__BackingField;

	public PlayerController HNFNINFCBEJ
	{
		[CompilerGenerated]
		get
		{
	...
	public bool DFKBPAGFPKB
	{
		get
		{
			...
			{
				FCAIAJGFGIK = flag;
				UnityEngine.Debug.Log($"Internet off: {flag} {DateTime.UtcNow}");
			}
			return flag;
		}
	}

	public bool NHMNBNGPOGJ => DFKBPAGFPKB || LEOEPDNAONM == ICDOJKMJFKM.Disconnected;
	...
	public int HAJHEIBNMJF
	{
		...
		set
		{
			_003CKNBOKMGIKIH_003Ek__BackingField = value;
		}
	}
	...
	public bool EIPHAAGCHCP
	{
		...
		set
		{
			_003CCPPMNOHHAAK_003Ek__BackingField = value;
		}
	}

	public bool LFBKPCIODNO => CJNJHAJDJJP == ICDOJKMJFKM.Connected && EHFIJJBPEEG >= GLFPILGCAPM.GameFinished;

	public int EPNLKGPLBEN
	{
		[CompilerGenerated]
		get
		{
		...
		private set
		{
			_003CPMMCDEFMDBP_003Ek__BackingField = value;
		}
	}

	public int GNACLALEPDB
	{
		[CompilerGenerated]
		get
		{
		...
		set
		{
			_003CAHOOHOFKLNC_003Ek__BackingField = value;
		}
	}
	...
	public GLFPILGCAPM EHFIJJBPEEG
	{
		...
		{
			ILHNFHOFLCM = value;
			UnityEngine.Debug.Log($"Player match state {ILHNFHOFLCM} to player {HNFNINFCBEJ.name}");
	...
	public ICDOJKMJFKM LEOEPDNAONM
	{
		...
		set
		{
			if (CJNJHAJDJJP != value)
			{
				...
				CJNJHAJDJJP = value;
				UnityEngine.Debug.Log($"Player connectionState {CJNJHAJDJJP} to player {HNFNINFCBEJ.name}");
	...
	public bool ECJNMCMBHFF()
	{
		...
		{
			FCAIAJGFGIK = flag;
			UnityEngine.Debug.Log(string.Format("WarFriends", flag, DateTime.UtcNow));
		}
		return flag;
	}
	...
	public void PPDNINOMMKK(GLFPILGCAPM IDEBKDPMPGM)
	{
		...
		UnityEngine.Debug.Log(string.Format("ShotFrequencyMax", ILHNFHOFLCM, CJIFJGHMEFI().name));
		if (CKDIHNEIHKL.KMKIKLKOALI != null)
		{
	...
	public bool JIDBMKHKOOA()
	{
		...
		{
			FCAIAJGFGIK = flag;
			UnityEngine.Debug.Log(string.Format("ID_GOLDENSUITCASE", flag, DateTime.UtcNow));
		}
		return flag;
	}
	...
	public bool DDKALPEGJCM()
	{
		...
		{
			FCAIAJGFGIK = flag;
			UnityEngine.Debug.Log(string.Format("ID_CONFIRM_SQUADFULL", flag, DateTime.UtcNow));
		}
		return flag;
	}
	...
	public bool BALCAFMGHOG()
	{
		...
		{
			FCAIAJGFGIK = flag;
			UnityEngine.Debug.Log($"Have discount {flag} to upgrade {DateTime.UtcNow}");
		}
		return flag;
	}
	...
	{
		ILHNFHOFLCM = IDEBKDPMPGM;
		UnityEngine.Debug.Log(string.Format("AmmoPool", ILHNFHOFLCM, CACCABLDNHF().name));
		if (CKDIHNEIHKL.KMKIKLKOALI != null)
		{
	...
	public void MLKANICNIOF(ICDOJKMJFKM IDEBKDPMPGM)
	{
		if (CJNJHAJDJJP != IDEBKDPMPGM)
		{
			...
			UnityEngine.Debug.Log(string.Format("REWARD CARDPACK: ", CJNJHAJDJJP, CACCABLDNHF().name));
	...
	public void KPOADHJBNDE(ICDOJKMJFKM IDEBKDPMPGM)
	{
		if (CJNJHAJDJJP != IDEBKDPMPGM)
		{
			EMLNLJIMGLG = CJNJHAJDJJP;
			CJNJHAJDJJP = IDEBKDPMPGM;
			UnityEngine.Debug.Log(string.Format("changing country to ", CJNJHAJDJJP, CACCABLDNHF().name));
			if (IDEBKDPMPGM == ICDOJKMJFKM.Connected)
			{
	...
	public void KNPKNOPEBIE(ICDOJKMJFKM IDEBKDPMPGM)
	{
		if (CJNJHAJDJJP != IDEBKDPMPGM)
		{
			EMLNLJIMGLG = CJNJHAJDJJP;
			CJNJHAJDJJP = IDEBKDPMPGM;
			UnityEngine.Debug.Log(string.Format("RematchRPC", CJNJHAJDJJP, KPIIAPDNOJB().name));
	...
	public bool EJEEDINNKOH(GLFPILGCAPM IGBEGIBGLKK, int HAJHEIBNMJF)
	{
		...
		UnityEngine.Debug.LogError(string.Format("ID_CONFIRM_THANKYOUPURCHASE", IGBEGIBGLKK, CACCABLDNHF().name));
		return true;
	}
	...
	public void LMBDNFMBGON(ICDOJKMJFKM IDEBKDPMPGM)
	{
		if (CJNJHAJDJJP != IDEBKDPMPGM)
		{
			EMLNLJIMGLG = CJNJHAJDJJP;
			CJNJHAJDJJP = IDEBKDPMPGM;
			UnityEngine.Debug.Log(string.Format("service", CJNJHAJDJJP, CACCABLDNHF().name));
			if (IDEBKDPMPGM == ICDOJKMJFKM.Connected)
			{
	...
	public bool AJBGJBKOCMO()
	{
		...
		{
			FCAIAJGFGIK = flag;
			UnityEngine.Debug.Log(string.Format("ID_LEAGUE6", flag, DateTime.UtcNow));
		}
		return flag;
	}
	...
	public bool JBIOODKPKIF(GLFPILGCAPM IGBEGIBGLKK, int HAJHEIBNMJF)
	{
		...
		UnityEngine.Debug.LogError(string.Format("ID_TUTORIAL_OVERTIME", IGBEGIBGLKK, KPIIAPDNOJB().name));
		return false;
	}
	...
	public bool LMOCNIAPGCF()
	{
		...
		{
			FCAIAJGFGIK = flag;
			UnityEngine.Debug.Log(string.Format("ЗАГРУЗИТЬ", flag, DateTime.UtcNow));
		}
		return flag;
	}
	...
	public void CJPNPDBHJCG(ICDOJKMJFKM IDEBKDPMPGM)
	{
		if (CJNJHAJDJJP != IDEBKDPMPGM)
		{
			EMLNLJIMGLG = CJNJHAJDJJP;
			CJNJHAJDJJP = IDEBKDPMPGM;
			UnityEngine.Debug.Log(string.Format("FinishGameMultiplayerRPC", CJNJHAJDJJP, KPIIAPDNOJB().name));
			if (IDEBKDPMPGM == ICDOJKMJFKM.Disconnected)
			{
	...
	public bool MLKAMPJNAKO(GLFPILGCAPM IGBEGIBGLKK, int HAJHEIBNMJF)
	{
		...
		UnityEngine.Debug.LogError($"Error setting match state {IGBEGIBGLKK} to player {HNFNINFCBEJ.name}");
		return false;
	}
	...
	{
		ILHNFHOFLCM = IDEBKDPMPGM;
		UnityEngine.Debug.Log($"Player profile - {ILHNFHOFLCM} is banned {KPIIAPDNOJB().name}");
		if (CKDIHNEIHKL.KMKIKLKOALI != null)
		{
			CKDIHNEIHKL.KMKIKLKOALI(ILHNFHOFLCM, CACCABLDNHF());
		}
	...
	public bool DADKCFEGCIP(GLFPILGCAPM IGBEGIBGLKK, int HAJHEIBNMJF)
	{
		...
		UnityEngine.Debug.LogError(string.Format("ID_CONFIRM_EXITINGMATCH_TEXT", IGBEGIBGLKK, KPIIAPDNOJB().name));
		return true;
	}
	...
	public void JALAIEHBLMJ(ICDOJKMJFKM IDEBKDPMPGM)
	{
		if (CJNJHAJDJJP != IDEBKDPMPGM)
		{
			EMLNLJIMGLG = CJNJHAJDJJP;
			CJNJHAJDJJP = IDEBKDPMPGM;
			UnityEngine.Debug.Log(string.Format("ID_CONFIRM_ERROR", CJNJHAJDJJP, CACCABLDNHF().name));
			if (IDEBKDPMPGM == ICDOJKMJFKM.Connected)
			{
	...
	public void IPPACHHBGCF(ICDOJKMJFKM IDEBKDPMPGM)
	{
		if (CJNJHAJDJJP != IDEBKDPMPGM)
		{
			EMLNLJIMGLG = CJNJHAJDJJP;
			CJNJHAJDJJP = IDEBKDPMPGM;
			UnityEngine.Debug.Log(string.Format("ReputationPointsAdded", CJNJHAJDJJP, CACCABLDNHF().name));
			if (IDEBKDPMPGM == ICDOJKMJFKM.Disconnected)
			{
	...
	public bool CPELPNBIMPD(GLFPILGCAPM IGBEGIBGLKK, int HAJHEIBNMJF)
	{
		...
		UnityEngine.Debug.LogError(string.Format("0", IGBEGIBGLKK, CJIFJGHMEFI().name));
		return false;
	}
	...
	public void AFDGKBBLDDN(ICDOJKMJFKM IDEBKDPMPGM)
	{
		if (CJNJHAJDJJP != IDEBKDPMPGM)
		{
			EMLNLJIMGLG = CJNJHAJDJJP;
			CJNJHAJDJJP = IDEBKDPMPGM;
			UnityEngine.Debug.Log($"{CJNJHAJDJJP}\u00a0{KPIIAPDNOJB().name}");
			if (IDEBKDPMPGM == ICDOJKMJFKM.Disconnected)
			{
				JJHFKEGEFBO(OEKGGHBMJBH() + 1);
			}
	...
	public void OMNNJAHHCDO(ICDOJKMJFKM IDEBKDPMPGM)
	{
		if (CJNJHAJDJJP != IDEBKDPMPGM)
		{
			EMLNLJIMGLG = CJNJHAJDJJP;
			CJNJHAJDJJP = IDEBKDPMPGM;
			UnityEngine.Debug.Log(string.Format("CONFIRM", CJNJHAJDJJP, CACCABLDNHF().name));
			if (IDEBKDPMPGM == ICDOJKMJFKM.Connected)
			{
	...
	{
		ILHNFHOFLCM = IDEBKDPMPGM;
		UnityEngine.Debug.Log(string.Format("AccountType", ILHNFHOFLCM, CACCABLDNHF().name));
		if (CKDIHNEIHKL.KMKIKLKOALI != null)
		{
			CKDIHNEIHKL.KMKIKLKOALI(ILHNFHOFLCM, CACCABLDNHF());
		}
	...
	public void MEBPMHDHIPJ()
	{
		...
		CJNJHAJDJJP = ICDOJKMJFKM.Connected;
		EMLNLJIMGLG = ICDOJKMJFKM.Connected;
		APKDGLNPHAG(IDEBKDPMPGM: false);
		AMPHMMCMGOK(1);
		BFDDIOPPNIL(IDEBKDPMPGM: false);
		OBBFFOIMOBB(1);
		JLAKDNBIPHK(1);
		FCAIAJGFGIK = true;
	}
	...
	{
		ILHNFHOFLCM = IDEBKDPMPGM;
		UnityEngine.Debug.Log(string.Format("ID_WARNING_RESTOREERROR", ILHNFHOFLCM, KPIIAPDNOJB().name));
		if (CKDIHNEIHKL.KMKIKLKOALI != null)
		{
	...
	public bool FMEMAOKMNDK()
	{
		...
		{
			FCAIAJGFGIK = flag;
			UnityEngine.Debug.Log(string.Format("TuneListener trackerDidReceiveDeeplink: ", flag, DateTime.UtcNow));
		}
		return flag;
	}
	...
	public bool IDAHGCLPPPE()
	{
		...
		{
			FCAIAJGFGIK = flag;
			UnityEngine.Debug.Log(string.Format("RegisterEvent(", flag, DateTime.UtcNow));
		}
		return flag;
	}
	...
	public void NPFLAFCJJPE(ICDOJKMJFKM IDEBKDPMPGM)
	{
		if (CJNJHAJDJJP != IDEBKDPMPGM)
		{
			EMLNLJIMGLG = CJNJHAJDJJP;
			CJNJHAJDJJP = IDEBKDPMPGM;
			UnityEngine.Debug.Log(string.Format("resizing texture ", CJNJHAJDJJP, KPIIAPDNOJB().name));
			if (IDEBKDPMPGM == ICDOJKMJFKM.Connected)
			{
	...
	public bool FKEIIKKHKLO(GLFPILGCAPM IGBEGIBGLKK, int HAJHEIBNMJF)
	{
		...
		UnityEngine.Debug.LogError(string.Format("1", IGBEGIBGLKK, HNFNINFCBEJ.name));
		return false;
	}
	...
	public bool GBHJEKJFOLM(GLFPILGCAPM IGBEGIBGLKK, int HAJHEIBNMJF)
	{
		...
		UnityEngine.Debug.LogError(string.Format("SquadEmblem", IGBEGIBGLKK, CJIFJGHMEFI().name));
		return true;
	}
	...
	public bool HNMJPALEMLA(GLFPILGCAPM IGBEGIBGLKK, int HAJHEIBNMJF)
	{
		...
		UnityEngine.Debug.LogError(string.Format("ID_STAT_HANDGUNKILLS", IGBEGIBGLKK, CJIFJGHMEFI().name));
		return true;
	}
