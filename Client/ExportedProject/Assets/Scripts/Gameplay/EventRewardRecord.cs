...
public class EventRewardRecord : Core_BaseScript
{
	[Header("Core")]
	[SerializeField]
	[FormerlySerializedAs("mVisualRewardSprite")]
	private UISprite mGlow1;

	[SerializeField]
	[FormerlySerializedAs("mGoldRewardSprite")]
	private UISprite mGlow2;

	[SerializeField]
	[FormerlySerializedAs("mScrapsRewardSprite")]
	private UISprite mRewardSprite;

	[SerializeField]
	[FormerlySerializedAs("mBoosterLevel")]
