...
public class LeagueDialog : GuiElementSingle<LeagueDialog>, PAIIOKBBHBC
{
	...
	[FormerlySerializedAs("DJOEAPCIELO")]
	public GameObject FINMIFPAMOB;

	[FormerlySerializedAs("ADPPCKMLIJJ")]
	public UILabel MOJBNLMNMDB;

	[FormerlySerializedAs("DPBONNGLKBA")]
	public UITexture OFBKFOHFJFA;

	[FormerlySerializedAs("OHNNDMFCMLD")]
	public UILabel KBKEOJDDMEH;

	[FormerlySerializedAs("FPPEGGNHOEE")]
	public UISprite HPFONLBPBCO;

	[FormerlySerializedAs("JDLCMBHNHEK")]
	public UISprite PAAEHCPLNKK;

	[FormerlySerializedAs("FJEIJEPPIAB")]
	public UILabel ODAOBKCLCMK;

	[FormerlySerializedAs("NDBHHCKPKLI")]
	public UILabel GNMEBGHHPLF;

	[Header("Normal League First Time")]
	[FormerlySerializedAs("PAMCJLMAKFN")]
	public GameObject GBHHKOGMNGB;

	[FormerlySerializedAs("MLEBLCDJKOA")]
	public UILabel EJMOEOOKIGD;

	[FormerlySerializedAs("DNMNKBHNCNG")]
	public LeagueArcGuiElement BDGGHODPFMA;

	[FormerlySerializedAs("DFMHEEKJKHM")]
	public UITable NAMIHDBDELC;

	[FormerlySerializedAs("FFDNEEJKJKF")]
	public UILabel COFHPEDAOOM;

	[FormerlySerializedAs("PCAKJPNKHKK")]
	public UILabel GGLEFIMCBPF;

	[FormerlySerializedAs("BOHGMBAKNOC")]
	public UILabel ECDBKOGDDBF;

	[FormerlySerializedAs("OEDJKOOANIO")]
	public UISprite FFNADCNPFIM;

	[FormerlySerializedAs("BHEKFJKLENK")]
	public UISprite FNMPGJDGHDM;

	[FormerlySerializedAs("KMHCOHGLABM")]
	public UILabel OLAJJEJPFGF;

	[FormerlySerializedAs("HDEOKLHHKDN")]
	public UILabel ADDNGFEDJEM;

	[FormerlySerializedAs("GLEOJPFKDJB")]
	[Header("Beginners League")]
	public GameObject PKNHNJMAOKG;

	[FormerlySerializedAs("FOLGNDOKKMO")]
	public UILabel EBBOGIMHNAE;

	[FormerlySerializedAs("HNEFHBIOKFI")]
	public UITexture ENHAMAGNOPE;

	[FormerlySerializedAs("JJJALEJJAEI")]
	public UITable LGAFGHAJAPE;

	[FormerlySerializedAs("KPJLHFENIIM")]
	public UITable MAMIGNILNPH;

	[FormerlySerializedAs("OHNKIIDNAPC")]
	public UILabel[] FCIHCKJPIJP;

	[FormerlySerializedAs("GGOCOIHLBJH")]
	public UILabel ONLHNMMEOOI;

	[FormerlySerializedAs("EOBDNCKFEBK")]
	public UISprite EPJFKEGIPGB;

	[FormerlySerializedAs("CFEBDAOOPPI")]
	public UISprite JFFBEAMIANF;

	[FormerlySerializedAs("MKLANAMBHHD")]
	public UILabel AHIBCBOKCIO;

	[FormerlySerializedAs("KJAKNKKKEOM")]
	public UISprite DEEGLPABKBM;

	[Header("Finished Beginners League")]
	[FormerlySerializedAs("LLJFFBMNPFG")]
	public GameObject FPEAMLHNKEL;

	[FormerlySerializedAs("HHBCIMDLABI")]
	public UITexture[] KDKLMCLOFLB;

	[FormerlySerializedAs("LOBGFIGPBGL")]
	public UISprite EFIEBOAFJBM;

	[FormerlySerializedAs("AHKPHNNHOMK")]
	...
	public override void InitGUIValues()
	{
		...
		case NKHJBLBAAEB.EnteredBeginnersLeague:
		{
			...
			EPJFKEGIPGB.fillAmount = fillAmount;
			AHIBCBOKCIO.text = $"{medalsBalance} [9A9999]/[0BBCFF] {num}";
