...
public class SoldierBehaviourEngineer : SoldierBehaviourGeneric<SoldierBehaviourDefinititonEngineer>
{
	...
	private void LPBEHKGFLCK()
	{
		if (IBBCIFFPJAO != null)
		{
			IBBCIFFPJAO.JLHMFBILMCF(DCDEEADIGEH: true);
			IBBCIFFPJAO = null;
		}
	}
	...
	private void BKBDBBCDEID()
	{
		if (IBBCIFFPJAO != null)
		{
			IBBCIFFPJAO.DestroyPooled(DCDEEADIGEH: true);
			IBBCIFFPJAO = null;
		}
	}
	...
	private void NIGGCFEKIJC()
	{
		if (IBBCIFFPJAO != null)
		{
			IBBCIFFPJAO.JLHMFBILMCF(DCDEEADIGEH: false);
			IBBCIFFPJAO = null;
		}
	}
	...
	private void PGBNCBFBBCE()
	{
		if (IBBCIFFPJAO != null)
		{
			IBBCIFFPJAO.CADILLCGODA(DCDEEADIGEH: true);
			IBBCIFFPJAO = null;
		}
	}
	...
	private void BNEPAADIDHA()
	{
		if (IBBCIFFPJAO != null)
		{
			IBBCIFFPJAO.CADILLCGODA(DCDEEADIGEH: false);
			IBBCIFFPJAO = null;
		}
	}
	...
	private void DKDGNDJAEEJ()
	{
		if (IBBCIFFPJAO != null)
		{
			IBBCIFFPJAO.DestroyPooled(DCDEEADIGEH: false);
			IBBCIFFPJAO = null;
		}
	}
	...
	private void LCCGPBIPOMO()
	{
		if (IBBCIFFPJAO != null)
		{
			IBBCIFFPJAO.KIFFEEEDFPD(DCDEEADIGEH: false);
			IBBCIFFPJAO = null;
		}
	}
