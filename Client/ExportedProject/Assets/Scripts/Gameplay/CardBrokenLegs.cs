...
public class CardBrokenLegs : Card
{
	...
	private float JMMPIENOKCH => Singleton<GameVariables>.instance.cardConstants.GetRow(CardConstants.rowIds.BrokenLegsTime).FLOATVALUE;

	public override string description => Localization.LocalizeFormat(mDescriptionID, MEJMLNDFDBP.AIPKMDCJCOG(JMMPIENOKCH));
	...
	protected void EKPBOMOMMFB()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1491f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.LJLDJOHAAMC("country-noflag", NABOFKMBMKH: false);
		}
	}
	...
	protected void Update()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 0f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-paralyzethese", NABOFKMBMKH: false);
		}
	}
	...
	public virtual void GJCKHJLEPKG(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.BIIHCAEKCOD("ID_READYTIME", NABOFKMBMKH: true, HGNIGKCLLHM: true);
	}
	...
	protected void IDPOHKDKDNL()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 856f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.JCJFMHGNIOF("PT", NABOFKMBMKH: false, HGNIGKCLLHM: true);
		}
	}
	...
	public override void UseCardOnline(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-paralyzethese", NABOFKMBMKH: true);
	}
