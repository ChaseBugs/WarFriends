...
public class VideoFeedManager : Core_BaseScript
{
	...
	public class VideoFeed
	{
		...
		[FormerlySerializedAs("thumbnailHD")]
		public string thumbnailSD;

		[FormerlySerializedAs("thumbnailSD")]
		public string smallThumbnailHD;

		[FormerlySerializedAs("smallThumbnailHD")]
		public string smallThumbnailSD;

		[FormerlySerializedAs("smallThumbnailSD")]
		public string url;
		...
		public string thumbnail => (!Singleton<PerformanceManager>.instance.isHD) ? thumbnailSD : thumbnailHD;

		public string smallThumbnail => (!Singleton<PerformanceManager>.instance.isHD) ? smallThumbnailSD : smallThumbnailHD;
		...
		public string textureName => (!Singleton<PerformanceManager>.instance.isHD) ? textureNameSD : textureNameHD;

		public string smallTextureName => (!Singleton<PerformanceManager>.instance.isHD) ? smallTextureNameSD : smallTextureNameHD;

		public string debugString => $"Video {videoName} service {service} thumbnail {thumbnail}";
	}

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private VideoFeedData _003CACEDIMBMPFK_003Ek__BackingField;
	...
	public VideoFeedData videoFeeds
	{
		[CompilerGenerated]
		get
		{
		...
		private set
		{
			_003CACEDIMBMPFK_003Ek__BackingField = value;
		}
	}
	...
	public static VideoFeedManager instance
	{
		get
		{
			BJHPKLAEFCI = BJHPKLAEFCI ?? ((VideoFeedManager)SingletonSupport.FindOrCreate(typeof(VideoFeedManager)));
			return BJHPKLAEFCI;
		}
	}
	...
	public bool shouldShowVideoInApp => KJJGBJCPJFI;

	private string KNAKALPENAP => $"{Application.persistentDataPath}/videoFeedTextures/";
