...
public class LeagueResultDialog : GuiElementSingle<LeagueResultDialog>, PAIIOKBBHBC
{
	...
	[FormerlySerializedAs("PAFIPCMJABD")]
	public GameObject ENAGBHIDGNC;

	[FormerlySerializedAs("CPEPGICEBJD")]
	[Header("-Finished Part")]
	public GameObject FLKBAPLOPCF;

	[FormerlySerializedAs("KGGINHHBLNN")]
	public UILabel GFCGJNJCOCC;

	[FormerlySerializedAs("KABGJGEIHNF")]
	public UILabel JKGDFGAPCEC;

	[FormerlySerializedAs("BNKAEEDMGCO")]
	public UISprite MJKICJCNBEC;

	[FormerlySerializedAs("CLGEJPNDHEB")]
	...
	[FormerlySerializedAs("EGLHGCIPHGD")]
	...
	[FormerlySerializedAs("HBGBLJJKPNA")]
	public UISprite EMHGDFGBNFA;

	[FormerlySerializedAs("NFLDFIKDAGI")]
	public GameObject HKMJJILBLPH;

	[Header("Animation Part")]
	[FormerlySerializedAs("BOHKBPEBPEN")]
	public UITexture APIDNBIHEFB;

	[FormerlySerializedAs("DJHHKHLNMCN")]
	public UILabel MEKIBLPANJI;

	[FormerlySerializedAs("EANAOEDMMPA")]
	public UITexture NOPEIEHIJIA;

	[FormerlySerializedAs("OKHFFJPIBBA")]
	public UILabel PIMPLAINMJN;

	[Header("-Particles")]
	[FormerlySerializedAs("LDOJKHKBEBC")]
	public ParticleSystem DNNNFJGLMJC;

	[FormerlySerializedAs("ENLOOHFKPEJ")]
	...
	private void ADDPJHEAPBP()
	{
		...
		else
		{
			...
			LDNGAJMBPNM(ref EMINBMPHPFJ, oFDMBFAPAAC3, OCAILDBABGH: false);
	...
	private void BPFIHIDAEGK()
	{
		...
		else
		{
			ODCAOAHHBAG(ref EMINBMPHPFJ);
			int oFDMBFAPAAC3 = NBEABDDNFBN(ref EMINBMPHPFJ);
			LAGFNMNNDDI(ref EMINBMPHPFJ, oFDMBFAPAAC3, OCAILDBABGH: false);
			PGIEENOKEGE(ref EMINBMPHPFJ);
