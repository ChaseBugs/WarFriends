...
{
	public override string name => Localization.Localize("ID_FEATURE_RELOAD");

	public override string fancyName => Localization.Localize("ID_FEATURE_RELOAD-FANCY");

	public override string icon => "menu-army-reload-ico";

	public override bool menuMainAtlas => false;

	public override string description => Localization.Localize("ID_FEATURE_RELOAD-DESCRIPTION");

	public override string statisticIncrease => MEJMLNDFDBP.DPAFFLMAFJG(0f - (float)base.value);

	public override string weaponPrefix => Localization.Localize("ID_FEATURE_RELOAD-WEAPONPREFIX");

	public override float reloadCoef => 1f - (float)base.value;
