...
public class CardRecord : PoolableObject
{
	...
	private sealed class PGIPBLKMANL
	{
		...
		{
			TweenPosition tweenPosition = ((!FGNKGDIJKEO) ? TweenPosition.Begin(BJGCPDNMHDH.gameObject, 484f, Vector3.zero, Vector3.zero, useLocal: false) : TweenPosition.Begin(BJGCPDNMHDH.gameObject, 1365f, Vector3.zero, new Vector3(1025f, 754f, 1480f)));
		...
		{
			BJGCPDNMHDH.FlipBuyAnimation(1);
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.gameObject, 411f, Vector3.zero, new Vector3(999f, 853f, 1310f), useLocal: false);
		...
		{
			BJGCPDNMHDH.FlipBuyAnimation(1);
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.gameObject, 1511f, Vector3.zero, new Vector3(1478f, 922f, 330f), useLocal: false);
		...
		{
			BJGCPDNMHDH.FlipBuyAnimation(1);
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.gameObject, 297f, Vector3.zero, new Vector3(1225f, 559f, 1892f), useLocal: false);
		...
		{
			BJGCPDNMHDH.FlipBuyAnimation(1);
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.gameObject, 1746f, Vector3.zero, new Vector3(118f, 571f, 1673f), useLocal: false);
			tweenPosition.NumOfRepetitions = 8;
	...
	[FormerlySerializedAs("KGLGDGCFCJC")]
	public UIPanel FIDIEPCJLMF;

	[FormerlySerializedAs("HBMLLLPEGMK")]
	...
	[FormerlySerializedAs("HKOBAANEKHJ")]
	[Header("Card Look")]
	...
	[FormerlySerializedAs("ENNBPJIFMCK")]
	public UILabel BOFBOGHBKLC;

	[FormerlySerializedAs("LINHEOKNIEE")]
	public UILabel EJLICNDCAAH;

	[Header("Buddy Card Look")]
	[FormerlySerializedAs("FHJLNPEAHJF")]
	public UITable ELAIBCJCJPG;

	[FormerlySerializedAs("HLJBCNKMOEH")]
	public UISprite BCHPGKPFBPE;

	[FormerlySerializedAs("PHKKDKKJFMJ")]
	public UILabel GLDGGCNMKFP;

	[FormerlySerializedAs("GPIGFNJADGK")]
	public UILabel KBHPNGLJEOG;

	[FormerlySerializedAs("POHFKGMHJDJ")]
	public UILabel DDNNJKANIBP;

	[Header("Right Up Corner Icon Part")]
	[FormerlySerializedAs("EMHJMPCIFGL")]
	public GameObject KPBPIGONFDI;

	[FormerlySerializedAs("AFIGDMKNGOB")]
	public UISprite NINBBGJCEEO;

	[FormerlySerializedAs("BKBDKPLIOOD")]
	public UISprite DILDMHKDHJH;

	[FormerlySerializedAs("LGKALODLHOB")]
	public UISprite ADEMDNIDBJD;

	[FormerlySerializedAs("JPDJMFPJJPG")]
	public GameObject EHGOBKNHGNA;

	[FormerlySerializedAs("MHIHKNBFIHH")]
	public UISprite PLBJMGJFKGD;

	[Header("Left Up Corner Amount Part")]
	[FormerlySerializedAs("GLGFIMOMGJN")]
	public GameObject LIGFALGMJKN;

	[FormerlySerializedAs("BGCAJDMGEGN")]
	public UILabel DAMGNCHFPMK;

	[FormerlySerializedAs("CDAMBPGLKIA")]
	...
	[FormerlySerializedAs("FNJAAKPOIOK")]
	[Header("Bottom Buttons")]
	public GameObject CIKFGCJABCL;

	[FormerlySerializedAs("NPLBCKKKKJJ")]
	public UILabel AHFAAIJGPFO;

	[FormerlySerializedAs("FMLJFDJGIIH")]
	public GameObject JOPKBJMEIOB;

	[FormerlySerializedAs("CLPNANKNNGC")]
	[Header("Bottom Countdown")]
	public GameObject GPKNHEHAPNP;

	[FormerlySerializedAs("DDMMGDLEACC")]
	public UISprite AFEDBPKAJFG;

	[FormerlySerializedAs("HJKKAGIAMED")]
	...
	[FormerlySerializedAs("OMCEELCBKJJ")]
	public UISprite CLPJOBOOEAK;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private Card _003CBPDIAPPIFGP_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private bool _003CPGBELEAFDBF_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private MKIOKBMLHEO _003CPGHKBIDDJLI_003Ek__BackingField;
	...
	public Card card
	{
		...
		get
		{
			return _003CBPDIAPPIFGP_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			_003CBPDIAPPIFGP_003Ek__BackingField = value;
		}
	}

	public bool isAvailable => POAMPPJOGEG;

	public bool isAnimatingCard => JCKOBELDCGD;
	...
	public bool cardFlipped
	{
		...
		private set
		{
			_003CPGBELEAFDBF_003Ek__BackingField = value;
		}
	}
	...
	public MKIOKBMLHEO behaviour
	{
		...
		set
		{
			_003CPGHKBIDDJLI_003Ek__BackingField = value;
		}
	}
	...
	public void NOHMGIOHOPM()
	{
		...
		SetHighlight(NABOFKMBMKH: false);
	...
	public void HideCardInEndScreen()
	{
		...
		TweenPosition.Begin(base.gameObject, 0.2f, GuiScreenSingle<EndScreen>.instance.PLHEDGFGMBM.transform.position, useLocal: false).onFinished = delegate
		{
			if (!FFNGLFMCJEL())
			{
	...
	private void OJDKJDJOGGP()
	{
		...
		if (num < 0)
		{
			Initialize(card, MKIOKBMLHEO.Deposit, IDOKGAOAGAL: false);
		}
		else
		{
	...
	private void OnPress(bool DGOOLMFNBFB)
	{
		if (behaviour != MKIOKBMLHEO.Other && base.enabled)
		{
			...
			else if (NGOFFGCGONH)
			{
				...
				AKKOEPGGEHP.SetActive(value: false);
				NGOFFGCGONH = false;
	...
	public void InitBigCardLook()
	{
		...
		if (card.iconName == string.Empty)
		{
			...
			KPBPIGONFDI.SetActive(value: false);
		...
		else
		{
			...
			{
				KPBPIGONFDI.SetActive(value: true);
	...
	private void OnDrag(Vector2 AELNHFHAIHO)
	{
		...
		case IAOAHCIDOCE.Move:
		{
			...
			{
				AKKOEPGGEHP.SetActive(value: true);
	...
	internal void LBHJJJGBADD()
	{
		...
		{
			JOPKBJMEIOB.SetActive(value: true);
		}
	...
	private void DGPHCKIJAOM(UITweener GMCNLNOEJPP)
	{
		...
		TweenPosition.Begin(base.gameObject, 1408f, Vector3.zero, useLocal: false).onFinished = delegate
		{
			JCKOBELDCGD = false;
			if (!FFNGLFMCJEL())
			{
	...
	private void HGFPMEHBLAI(UITweener ALOMHALCMNH)
	{
		...
		TweenRotation tweenRotation = TweenRotation.Begin(base.gameObject, 1990f, Quaternion.Euler(1164f, 1962f, 852f), useAbsolute: true);
	...
	public void SetUnAvailable()
	{
		...
		if (behaviour == MKIOKBMLHEO.Deposit)
		{
			JOPKBJMEIOB.SetActive(value: false);
		}
		if (behaviour == MKIOKBMLHEO.CountDownBuddy)
		{
			TweenAlpha component = GPKNHEHAPNP.GetComponent<TweenAlpha>();
	...
	public void SetInvisible()
	{
		...
		EHGOBKNHGNA.SetActive(value: false);
		LIGFALGMJKN.SetActive(value: false);
		SetHighlight(NABOFKMBMKH: false);
	}
