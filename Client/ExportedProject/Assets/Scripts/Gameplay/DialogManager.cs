...
public class DialogManager : InGameSerializedObjectGeneric<DialogManager.DialogData>
{
	...
	public static DialogManager instance
	{
		get
		{
			mInstance = mInstance ?? ((DialogManager)SingletonSupport.FindOrCreate(typeof(DialogManager)));
			return mInstance;
		}
	}
	...
	protected override void Awake()
	{
		...
		mDialogs = Singleton<GuiManager>.instance.IJMDOGNBGIL.gameObject.GetComponentsInChildren<PAIIOKBBHBC>(includeInactive: true);
		mInstance = this;
	}
	...
	{
		string text = $"9 VIP REMINDER\tIs vip {Singleton<VipManager>.instance.NOGEIPHFNPK()}";
