...
public class ArmyPreviewCamera : Singleton<ArmyPreviewCamera>
{
	private sealed class IFDPBDPGLGG : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool PIAOIBJMLCC()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.JIPKECFGPOP(NOBOBPMMHCE: true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 171f), bought: false, mine: true, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
			...
			case 1u:
				...
				{
					BJGCPDNMHDH.PJKKMBBPILB(NOBOBPMMHCE: true);
		...
		public bool CCOPPEKLJOB()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.HPKCPHNLLNI = false;
				BJGCPDNMHDH.JOJLCHMOKMG(NOBOBPMMHCE: true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 267f), bought: false, mine: true, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool FCJCLBMPBFK()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.HPKCPHNLLNI = false;
				BJGCPDNMHDH.IAMMOGENHAD(NOBOBPMMHCE: true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 647f), bought: true, mine: false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool LLOCENNFFFJ()
		{
			...
			case 0u:
				...
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1293f), bought: true, mine: false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
			...
			case 1u:
				...
				if (BJGCPDNMHDH.GNICEGBOGOL.enabled)
				{
					BJGCPDNMHDH.IBNEIKFHJML(NOBOBPMMHCE: false);
		...
		public bool NIGJJBALHDN()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.HPKCPHNLLNI = false;
				BJGCPDNMHDH.DNEFJHHMGIL(NOBOBPMMHCE: false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1826f), bought: false, mine: true, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool MOFPMNMAOND()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = false;
				BJGCPDNMHDH.JOJLCHMOKMG(NOBOBPMMHCE: true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1009f), bought: true, mine: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
			...
			case 1u:
				...
				if (BJGCPDNMHDH.GNICEGBOGOL.enabled)
				{
					BJGCPDNMHDH.IBNEIKFHJML(NOBOBPMMHCE: true);
		...
		public bool JPBGJLDMOPO()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = true;
				BJGCPDNMHDH.CNEADELKALM(NOBOBPMMHCE: true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1589f), bought: true, mine: false, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool LPCBKGKFNFD()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.HPKCPHNLLNI = false;
				BJGCPDNMHDH.JOJLCHMOKMG(NOBOBPMMHCE: false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 413f), bought: false, mine: false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool OOECALAHCFK()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = false;
				BJGCPDNMHDH.DNEFJHHMGIL(NOBOBPMMHCE: false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 91f), bought: true, mine: false, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool PPOPGFELIDA()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = true;
				BJGCPDNMHDH.JOJLCHMOKMG(NOBOBPMMHCE: false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1286f), bought: false, mine: true, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool HMLAEHJKPJE()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = true;
				BJGCPDNMHDH.CNEADELKALM(NOBOBPMMHCE: false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 511f), bought: true, mine: false, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
			...
			case 1u:
				...
				if (BJGCPDNMHDH.GNICEGBOGOL.enabled)
				{
					BJGCPDNMHDH.IAMMOGENHAD(NOBOBPMMHCE: false);
					DOGHDHGLCDF = Singleton<LevelBehaviourManager>.instance.FAMDCPGBOFJ(EFHPOHNNGGH);
					if (DOGHDHGLCDF != null && DOGHDHGLCDF.prefab != null)
					{
						DOGHDHGLCDF.LCDBACDIODH = true;
		...
		public bool BEIABOJAIFM()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.HPKCPHNLLNI = true;
				BJGCPDNMHDH.PJKKMBBPILB(NOBOBPMMHCE: false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1269f), bought: false, mine: false, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool IDBCKIPOEEI()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = true;
				BJGCPDNMHDH.PJKKMBBPILB(NOBOBPMMHCE: false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1802f), bought: true, mine: true, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool IJEDIDEJIII()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = false;
				BJGCPDNMHDH.CNEADELKALM(NOBOBPMMHCE: true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1088f), bought: true, mine: false, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool PMBOHHPPJAC()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = false;
				BJGCPDNMHDH.PJKKMBBPILB(NOBOBPMMHCE: false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1992f), bought: true, mine: false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool LMNIKLKKIDN()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = false;
				BJGCPDNMHDH.CNEADELKALM(NOBOBPMMHCE: false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 704f), bought: false, mine: true, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool BIGKCFMEBJE()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = false;
				BJGCPDNMHDH.IBNEIKFHJML(NOBOBPMMHCE: false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 74f), bought: false, mine: true, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool GBLFIBDBMGE()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = false;
				BJGCPDNMHDH.JOJLCHMOKMG(NOBOBPMMHCE: true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 693f), bought: false, mine: false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool HOOHJGPHHGN()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = true;
				BJGCPDNMHDH.JIPKECFGPOP(NOBOBPMMHCE: true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 368f), bought: true, mine: false, unloadWeapon: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool DKJMOPNHIAB()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.HPKCPHNLLNI = true;
				BJGCPDNMHDH.DNEFJHHMGIL(NOBOBPMMHCE: true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 576f), bought: true, mine: true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool NEMOAIBCODB()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.HPKCPHNLLNI = false;
				BJGCPDNMHDH.JOJLCHMOKMG(NOBOBPMMHCE: true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 315f), bought: true, mine: false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool PGOBEIMCPGA()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.HPKCPHNLLNI = true;
				BJGCPDNMHDH.JIPKECFGPOP(NOBOBPMMHCE: false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 896f), bought: true, mine: false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
	...
	private sealed class NLCCAKIBMON : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool DDLMLOJGJMA()
		{
			...
			case 1u:
				...
				else
				{
					...
					BJGCPDNMHDH.MBHKGFFKGPC.gameObject.SetActive(value: true);
					...
					BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: false);
					BJGCPDNMHDH.MGMBKDJJLLG.targetTexture = BJGCPDNMHDH.FCEIGDLFOMH;
					BJGCPDNMHDH.DHCMAFEPGMP.SetActive(value: true);
			...
			case 2u:
				...
				BJGCPDNMHDH.DHCMAFEPGMP.SetActive(value: false);
				BJGCPDNMHDH.KMFGCJEGJJK.SetActive(value: true);
				BJGCPDNMHDH.BEKPEIKCJNM = false;
		...
		public bool CCOPPEKLJOB()
		{
			...
			case 1u:
				...
				else
				{
					BJGCPDNMHDH.BEKPEIKCJNM = false;
					BJGCPDNMHDH.MGMBKDJJLLG.enabled = false;
					BJGCPDNMHDH.MBHKGFFKGPC.gameObject.SetActive(value: false);
		...
		public bool MHNPBDBGBLK()
		{
			...
			case 1u:
				...
				else
				{
					...
					CamosManager.instance.ApplyVisuals(BJGCPDNMHDH.MBHKGFFKGPC, FHPICFHABBJ.playerVisuals, useHighRes: true);
					BJGCPDNMHDH.MBHKGFFKGPC.HideWeapon();
					BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: true);
					BJGCPDNMHDH.MGMBKDJJLLG.targetTexture = BJGCPDNMHDH.FCEIGDLFOMH;
					BJGCPDNMHDH.DHCMAFEPGMP.SetActive(value: true);
					BJGCPDNMHDH.KMFGCJEGJJK.SetActive(PNDNEMDPFHC);
					PHDOCKCBJOF = new WaitForEndOfFrame();
		...
		public bool BGOEENAEBNO()
		{
			...
			case 2u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.KPIGIEPMLLC = false;
				BJGCPDNMHDH.DHCMAFEPGMP.SetActive(value: true);
				BJGCPDNMHDH.KMFGCJEGJJK.SetActive(value: false);
				BJGCPDNMHDH.BEKPEIKCJNM = false;
				BJGCPDNMHDH.MGMBKDJJLLG.enabled = true;
				CLPPIAGLCJJ = -1;
				break;
		...
		public bool JFPOOBJNEPF()
		{
			...
			case 1u:
				...
				else
				{
					...
					BJGCPDNMHDH.MBHKGFFKGPC.gameObject.SetActive(value: false);
					BJGCPDNMHDH.GIHEJGJOPBI(FJLBLLLEELD);
					CamosManager.instance.ApplyVisuals(BJGCPDNMHDH.MBHKGFFKGPC, AMPMNLIKMIF, useHighRes: true);
					BJGCPDNMHDH.MBHKGFFKGPC.BBLBLLCMBJG();
					BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: true);
					BJGCPDNMHDH.MGMBKDJJLLG.targetTexture = BJGCPDNMHDH.FCEIGDLFOMH;
					BJGCPDNMHDH.DHCMAFEPGMP.SetActive(value: true);
	...
	private sealed class JAIAGHOBDGK : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool CIIHKFDLDKN()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.BEIIOAIJMFK().LJELEJEJIEB().gameObject.SetActive(value: false);
		...
		public bool FBMLBIOKKBE()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.JLMDEMFIHCA().JKHKBGPKFFF().gameObject.SetActive(value: true);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: true);
		...
		public bool MOFPMNMAOND()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.BEIIOAIJMFK().JKHKBGPKFFF().gameObject.SetActive(value: false);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: true);
		...
		public bool PMCFLKAJNHO()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.EHHHBEMKGOE.GGKGGMNIDMI = KHLGDCHJJPB.EHHHBEMKGOE.OGFGBNNKCDM();
				BJGCPDNMHDH.MBHKGFFKGPC.weaponInventory.JKHKBGPKFFF().gameObject.SetActive(value: true);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: false);
		...
		public bool IJEDIDEJIII()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.EHHHBEMKGOE.LPGACOBNHOH(KHLGDCHJJPB.EHHHBEMKGOE.PCOLKKBLBOI());
				BJGCPDNMHDH.MBHKGFFKGPC.BEIIOAIJMFK().currentWeapon.gameObject.SetActive(value: true);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: false);
		...
		public bool FIBKLKNDFDO()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.FMKGGADDHJK().MFHBEJOLGLC().gameObject.SetActive(value: false);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: true);
		...
		public bool BJIPDEICIML()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.FMKGGADDHJK().JECOEJBGKDF().gameObject.SetActive(value: false);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: false);
		...
		public bool MoveNext()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.weaponInventory.currentWeapon.gameObject.SetActive(value: true);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: false);
		...
		public bool HDGDKCMIOGK()
		{
			...
			case 1u:
				...
				CamosManager.instance.ApplyVisuals(BJGCPDNMHDH.MBHKGFFKGPC, KHLGDCHJJPB.EHHHBEMKGOE.CBBDICBLHMM, FJLBLLLEELD == PlayerTexturePool.DFJJOANIJID.Card);
				BJGCPDNMHDH.MBHKGFFKGPC.EHHHBEMKGOE.LPGACOBNHOH(KHLGDCHJJPB.EHHHBEMKGOE.OGFGBNNKCDM());
				BJGCPDNMHDH.MBHKGFFKGPC.FMKGGADDHJK().OLHICLNCPNA().gameObject.SetActive(value: true);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: true);
		...
		public bool GPIPJIDGCKM()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.FMKGGADDHJK().CILCMCDCKKE().gameObject.SetActive(value: true);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: true);
		...
		public bool ECPGMIIEFDP()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.weaponInventory.JNFHKEJCIIA().gameObject.SetActive(value: true);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: true);
		...
		public bool DMPHMFDEINI()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.weaponInventory.APLKMLDHMDL().gameObject.SetActive(value: false);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: false);
		...
		public bool OOECALAHCFK()
		{
			...
			case 1u:
				...
				CamosManager.instance.ApplyVisuals(BJGCPDNMHDH.MBHKGFFKGPC, KHLGDCHJJPB.EHHHBEMKGOE.CBBDICBLHMM, FJLBLLLEELD == PlayerTexturePool.DFJJOANIJID.Card);
				BJGCPDNMHDH.MBHKGFFKGPC.EHHHBEMKGOE.GGKGGMNIDMI = KHLGDCHJJPB.EHHHBEMKGOE.OGFGBNNKCDM();
				BJGCPDNMHDH.MBHKGFFKGPC.BEIIOAIJMFK().JKHKBGPKFFF().gameObject.SetActive(value: true);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: true);
		...
		public bool BGOEENAEBNO()
		{
			...
			case 1u:
				...
				CamosManager.instance.ApplyVisuals(BJGCPDNMHDH.MBHKGFFKGPC, KHLGDCHJJPB.EHHHBEMKGOE.CBBDICBLHMM, FJLBLLLEELD == (PlayerTexturePool.DFJJOANIJID)4);
				BJGCPDNMHDH.MBHKGFFKGPC.EHHHBEMKGOE.LPGACOBNHOH(KHLGDCHJJPB.EHHHBEMKGOE.PCOLKKBLBOI());
				BJGCPDNMHDH.MBHKGFFKGPC.FMKGGADDHJK().APLKMLDHMDL().gameObject.SetActive(value: false);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: true);
		...
		public bool PGOBEIMCPGA()
		{
			...
			case 1u:
				...
				CamosManager.instance.ApplyVisuals(BJGCPDNMHDH.MBHKGFFKGPC, KHLGDCHJJPB.EHHHBEMKGOE.CBBDICBLHMM, FJLBLLLEELD == PlayerTexturePool.DFJJOANIJID.Classic);
				BJGCPDNMHDH.MBHKGFFKGPC.EHHHBEMKGOE.GNGLDJHHIHM(KHLGDCHJJPB.EHHHBEMKGOE.PCOLKKBLBOI());
				BJGCPDNMHDH.MBHKGFFKGPC.BEIIOAIJMFK().currentWeapon.gameObject.SetActive(value: false);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: false);
		...
		public bool KCEAGNMILMA()
		{
			...
			case 1u:
				...
				CamosManager.instance.ApplyVisuals(BJGCPDNMHDH.MBHKGFFKGPC, KHLGDCHJJPB.EHHHBEMKGOE.CBBDICBLHMM, FJLBLLLEELD == (PlayerTexturePool.DFJJOANIJID)3);
				BJGCPDNMHDH.MBHKGFFKGPC.EHHHBEMKGOE.GNGLDJHHIHM(KHLGDCHJJPB.EHHHBEMKGOE.GGKGGMNIDMI);
				BJGCPDNMHDH.MBHKGFFKGPC.FMKGGADDHJK().JNFHKEJCIIA().gameObject.SetActive(value: false);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: true);
		...
		public bool HMLAEHJKPJE()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.JLMDEMFIHCA().LJELEJEJIEB().gameObject.SetActive(value: true);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: true);
		...
		public bool FNIOOIGJPAM()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.BEIIOAIJMFK().CILCMCDCKKE().gameObject.SetActive(value: true);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: false);
		...
		public bool FGAFKEKGPHF()
		{
			...
			case 1u:
				...
				BJGCPDNMHDH.MBHKGFFKGPC.weaponInventory.PDLFJEDGLAO().gameObject.SetActive(value: true);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: false);
		...
		public bool DFMKKFMEBON()
		{
			...
			case 1u:
				...
				CamosManager.instance.ApplyVisuals(BJGCPDNMHDH.MBHKGFFKGPC, KHLGDCHJJPB.EHHHBEMKGOE.CBBDICBLHMM, FJLBLLLEELD == (PlayerTexturePool.DFJJOANIJID)5);
				BJGCPDNMHDH.MBHKGFFKGPC.EHHHBEMKGOE.GNGLDJHHIHM(KHLGDCHJJPB.EHHHBEMKGOE.PCOLKKBLBOI());
				BJGCPDNMHDH.MBHKGFFKGPC.weaponInventory.currentWeapon.gameObject.SetActive(value: false);
				BJGCPDNMHDH.MBHKGFFKGPC.SelectPrimary();
				BJGCPDNMHDH.MBHKGFFKGPC.Preview(HDBKFKKAJLF: false);
	...
	private sealed class EKBDAFJLEKI : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MKLIDMNLNPN()
		{
			...
			case 2u:
				...
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 257f), bought: true, mine: false));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 1;
					}
		...
		public bool FCJCLBMPBFK()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 656f), bought: false, mine: true, unloadWeapon: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 6;
					}
		...
		public bool OKELILGDPLJ()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 1099f), bought: false, mine: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 5;
					}
		...
		public bool CONJMMKAAGH()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 1157f), bought: true, mine: false, unloadWeapon: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 7;
					}
		...
		public bool BJIPDEICIML()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 109f), bought: true, mine: false, unloadWeapon: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 7;
					}
		...
		public bool HEHJAEIGHDN()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 1595f), bought: false, mine: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 8;
					}
		...
		public bool MoveNext()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM), bought: true, mine: true, unloadWeapon: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 3;
					}
		...
		public bool BPHPJKKHNNG()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 268f), bought: false, mine: false));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 6;
					}
		...
		public bool GBLFIBDBMGE()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 547f), bought: true, mine: true, unloadWeapon: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 5;
					}
		...
		public bool BKJCILLNJLG()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 790f), bought: false, mine: true, unloadWeapon: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 6;
					}
		...
		public bool KHNDCDGBFJH()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 980f), bought: true, mine: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 6;
					}
		...
		public bool ILNBJIJONKD()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 1282f), bought: true, mine: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 2;
					}
		...
		public bool BJOHOCFKMJO()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 1299f), bought: false, mine: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 7;
					}
		...
		public bool DKIKFMODFJF()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 765f), bought: false, mine: false, unloadWeapon: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 5;
					}
		...
		public bool IEDGDDDADFM()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 1083f), bought: false, mine: false));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 2;
					}
		...
		public bool MPKAJACHAIC()
		{
			...
			case 2u:
				if (BJGCPDNMHDH.BJHPKLAEFCI != null)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(BJGCPDNMHDH.BJHPKLAEFCI.IAJJBAJOGDM, 1880f), bought: true, mine: false));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 3;
					}
	...
	public bool isLoadingPreview => HPKCPHNLLNI;
	...
	public void LCIFJLNADFP(PlayerController KHLGDCHJJPB, bool PNDNEMDPFHC, PlayerTexturePool.DFJJOANIJID AEEELCCAMBH = PlayerTexturePool.DFJJOANIJID.Small)
	{
		...
		StartCoroutine(RadicalRoutine.Run(IIODOPODKLA(KHLGDCHJJPB, null, DNCMDLDABHK: false, PNDNEMDPFHC, AEEELCCAMBH)));
	}
	...
	{
		NCMHGPNPEJM.gameObject.SetActive(value: true);
		NCMHGPNPEJM.KLFFMPINIPB();
		NCMHGPNPEJM.SelectPrimary();
		NCMHGPNPEJM.Preview(HDBKFKKAJLF: true);
		...
		DHCMAFEPGMP.SetActive(value: true);
	}
	...
	{
		MBHKGFFKGPC.gameObject.SetActive(value: false);
		...
		MBHKGFFKGPC.gameObject.SetActive(value: true);
	}
	...
	{
		base.gameObject.SetActive(value: false);
		StartCoroutine(RadicalRoutine.Run(IIODOPODKLA(KHLGDCHJJPB, null, DNCMDLDABHK: true, PNDNEMDPFHC, AEEELCCAMBH)));
	}
	...
	{
		NCMHGPNPEJM.gameObject.SetActive(value: false);
	...
	{
		GNICEGBOGOL.enabled = true;
		DHCMAFEPGMP.SetActive(value: false);
		NCMHGPNPEJM.gameObject.SetActive(value: false);
	...
	public void MDCPOGFDCPC(PlayerController KHLGDCHJJPB, bool PNDNEMDPFHC, PlayerTexturePool.DFJJOANIJID AEEELCCAMBH = PlayerTexturePool.DFJJOANIJID.Small)
	{
		...
		StartCoroutine(RadicalRoutine.Run(GHDHBPDGONH(KHLGDCHJJPB, null, DNCMDLDABHK: true, PNDNEMDPFHC, AEEELCCAMBH)));
	}
	...
	public void FAPKNHMIJOP(PlayerController NCMHGPNPEJM)
	{
		...
		NCMHGPNPEJM.KLFFMPINIPB();
		NCMHGPNPEJM.SelectPrimary();
		NCMHGPNPEJM.Preview(HDBKFKKAJLF: false);
		NCMHGPNPEJM.transform.parent = IGMMGPKPHFF;
		NCMHGPNPEJM.transform.localRotation = Quaternion.identity;
	...
	{
		base.gameObject.SetActive(value: true);
		StartCoroutine(RadicalRoutine.Run(PDEJFMNCNLC(KHLGDCHJJPB, null, DNCMDLDABHK: false, PNDNEMDPFHC, AEEELCCAMBH)));
	}
	...
	public void KHPPCEHONHE(LevelBehaviour NCMHGPNPEJM)
	{
		...
		if (BJHPKLAEFCI != null && BJHPKLAEFCI.ACLDFHJKBLI.GetType() == NCMHGPNPEJM.GetType())
		{
			...
			BJHPKLAEFCI.gameObject.SetActive(value: true);
			GNICEGBOGOL.enabled = true;
			DHCMAFEPGMP.SetActive(value: false);
			HKDNKJOBIND();
		}
	...
	public void HOMGMNFOGDK(LevelBehaviour NCMHGPNPEJM)
	{
		...
		if (BJHPKLAEFCI != null && BJHPKLAEFCI.ACLDFHJKBLI.GetType() == NCMHGPNPEJM.GetType())
		{
			...
			BJHPKLAEFCI.gameObject.SetActive(value: false);
			GNICEGBOGOL.enabled = true;
			DHCMAFEPGMP.SetActive(value: false);
			HKDNKJOBIND();
		}
