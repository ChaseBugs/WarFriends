...
public class GuiManager : Singleton<GuiManager>
{
	...
	[FormerlySerializedAs("JHEMNDAGMBM")]
	...
	[FormerlySerializedAs("EDMIHDCBIHJ")]
	public Camera KPDAPFBIPAI;

	[FormerlySerializedAs("AJGEHJENNOC")]
	...
	public SwitchableGui toBeShowedUp => GGMNHMMHELJ;
	...
	public void POHMFFFEIED(SwitchableGui BPPNAEGLGFG)
	{
		...
		{
			BPPNAEGLGFG.AnimateShow(JODEPBNLLAO: false);
		}
		else
		{
	...
	public void MEOFKPMJKIO(SwitchableGui IBLLGAGMDBL)
	{
		...
		{
			IBLLGAGMDBL.HDJMPFMIACJ(EAKEFLLCHCJ: true);
		}
	}
	...
	public void FadeOut(SwitchableGui IBLLGAGMDBL)
	{
		...
		{
			IBLLGAGMDBL.AnimateHide(EAKEFLLCHCJ: true);
		}
	}
	...
	{
		base.Start();
		SwitchableGui[] componentsInChildren = IJMDOGNBGIL.GetComponentsInChildren<SwitchableGui>(includeInactive: true);
	...
	public void JPLLGFNECAG(SwitchableGui BPPNAEGLGFG)
	{
		...
		{
			BPPNAEGLGFG.NNFAKNLMAJK(JODEPBNLLAO: true);
		}
		else
		{
	...
	public void FadeIn(SwitchableGui BPPNAEGLGFG)
	{
		...
		{
			BPPNAEGLGFG.AnimateShow(JODEPBNLLAO: true);
		}
		else
		{
	...
	public void BOFPJDBPHLP(SwitchableGui IBLLGAGMDBL)
	{
		...
		if (IBLLGAGMDBL.readyToHide)
		{
			IBLLGAGMDBL.GDLGEMLBJGB(EAKEFLLCHCJ: false);
		}
	}
}
