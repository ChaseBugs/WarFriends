...
public class IntroductionDealsItem : MonoBehaviour
{
	...
	[Header("Core")]
	[FormerlySerializedAs("BMAIGAAIMGJ")]
	public List<WidgetAlpha> LPEIOHAMKJJ;

	[FormerlySerializedAs("LHDDBMOBGOE")]
	public float MEHFCECFLHP = 3f;

	[FormerlySerializedAs("KEKBLIDAAAK")]
	public Color CKOECFCJBJE;

	[FormerlySerializedAs("ONHDJIAPGAD")]
	...
	[FormerlySerializedAs("PELCIHLLFLH")]
