...
public class StarterAssignmentPart : Core_BaseScript
{
	...
	[Header("Completition")]
	[FormerlySerializedAs("FCPAIKNLGJN")]
	public GameObject FEDEOJHHKBJ;

	[FormerlySerializedAs("PFIKNILBBIF")]
	public UILabel BIHDHODOJJA;

	[FormerlySerializedAs("PNHENOMOION")]
	public StarterAssignmentComplete[] HCEKAMFLPLK;

	[FormerlySerializedAs("MGMCHGPGPBJ")]
	[Header("Current Assignment")]
	public StarterAssignmentRecord ALLPMIFFDMA;

	[FormerlySerializedAs("NJKBBHLPONE")]
	[Header("Rewards")]
	public GameObject LGBIALCPJJO;

	[FormerlySerializedAs("EMNBKMIIJOC")]
	public UILabel HMILHDMPEHE;

	[FormerlySerializedAs("IKKHNMBAPGE")]
	...
	private void LCAGFCAKPEC()
	{
		...
		BIHDHODOJJA.text = string.Format("Null cannot be saved as last weapon.", MEJMLNDFDBP.CJCFPDLDMEK(remainingTime, "\t\"TRUE\"", string.Empty, IEJMLKBCDJB: false), Colours.stringWhite, Localization.Localize("getNumberOfSessions"));
	...
	private void IDJOMCPNFAF()
	{
		...
		UILabel hMILHDMPEHE = HMILHDMPEHE;
		object[] array = new object[0];
		array[0] = MEJMLNDFDBP.CJCFPDLDMEK(remainingTime, "1", string.Empty, IEJMLKBCDJB: false);
	...
	private void ALNHIJKOBEK()
	{
		...
		{
			BIHDHODOJJA.text = string.Format("Wrong_Weapon", MEJMLNDFDBP.CJCFPDLDMEK(remainingTime, "fuseData", string.Empty, IEJMLKBCDJB: false), Colours.stringWhite, Localization.Localize("PlayerName"));
	...
	private void IJCLAHMPBEM()
	{
		...
		BIHDHODOJJA.text = string.Format("CannonDamage", MEJMLNDFDBP.CJCFPDLDMEK(remainingTime, "Shots_Hits", string.Empty, IEJMLKBCDJB: false), Colours.stringWhite, Localization.Localize("Cancel - Disconnect, clicked in dialog !!!"));
		UILabel hMILHDMPEHE = HMILHDMPEHE;
		object[] array = new object[1];
		array[1] = MEJMLNDFDBP.CJCFPDLDMEK(remainingTime, " (", string.Empty, IEJMLKBCDJB: false);
