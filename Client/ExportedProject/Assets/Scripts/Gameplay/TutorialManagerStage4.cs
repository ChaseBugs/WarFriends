	...
	private sealed class LIMNGFDOBNO : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MKLIDMNLNPN()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 858f);
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 914f);
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(JFOMIIDCEKM, ELHGOHGPJCF: false, ENIHCPLOOAE: true, 486f);
					GuiElementSingle<TutorialClickOverlay>.instance.IGNJKOKGNOI(JFOMIIDCEKM, JFCIFNAPAOC.localScale, GPCEHFNNCIN: false);
					goto case 10u;
				}
				goto IL_06c2;
			case 10u:
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.CJAIGEJNDOH().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DNHJMCLEGAB, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 1087f);
							GuiElementSingle<TutorialClickOverlay>.instance.IGNJKOKGNOI(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
							break;
						}
					}
				}
			...
			case 13u:
			{
				...
				instance3.ShowMenuTutorial(aMKLKMJEMJM3, Localization.LocalizeFormat("Squad Member record does not have DatabasePlayer", array4), 1336f, TutorialDialog.DODBDLEJOAM.TopLeft, NHEJDPIIOJG: false);
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1410f, 1428f, 1791f), ELHGOHGPJCF: false, ENIHCPLOOAE: true, 994f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto case 14u;
			}
			case 14u:
			...
			case 15u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(649f, 1627f, 768f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 191f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				PECMCAOEMND = true;
				goto case 17u;
			}
			case 16u:
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("false"), Localization.LocalizeFormat("ID_LOADING", Localization.Localize("getGameConfigurationValue")), 1697f, TutorialDialog.DODBDLEJOAM.Bottom, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(703f, 1489f, 268f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 43f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto IL_0c35;
			case 17u:
			...
			case 18u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: true, 53f);
			...
			default:
				...
				if (APHENMOFJJP.GMEFFFKMDCE().KAJHANBHNKK != BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
				{
					...
					{
						DNHJMCLEGAB = CADIPBGKAKK.transform.position;
						GuiElementSingle<TutorialOverlayGuiElement>.instance.EIDNJNBEPFI(DNHJMCLEGAB, ELHGOHGPJCF: false);
		...
		public bool BJIPDEICIML()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 239f);
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 454f);
				GuiElementSingle<TutorialClickOverlay>.instance.MEBFBNDKOGD(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD, GPCEHFNNCIN: false);
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(JFOMIIDCEKM, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 825f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(JFOMIIDCEKM, JFCIFNAPAOC.localScale, GPCEHFNNCIN: false);
					goto case 10u;
				}
				goto IL_06c2;
			case 10u:
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.OFABMGFOFPI().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DNHJMCLEGAB, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 1496f);
			...
			case 12u:
				...
				goto IL_08dc;
			case 13u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("_"), Localization.LocalizeFormat("DeviceLogin(", Localization.Localize("SquadMates")), 424f, TutorialDialog.DODBDLEJOAM.TopLeft, NHEJDPIIOJG: false);
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(748f, 1651f, 601f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 922f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto case 14u;
			case 14u:
			...
			case 15u:
			{
				...
				instance3.PBEAOCBHFGD(aMKLKMJEMJM3, Localization.LocalizeFormat("Drone", array3), 1678f, TutorialDialog.DODBDLEJOAM.TopLeft, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(776f, 1222f, 1685f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 407f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				PECMCAOEMND = true;
				goto case 17u;
			}
			case 16u:
			{
				...
				instance2.ShowMenuTutorial(aMKLKMJEMJM2, Localization.LocalizeFormat("PNManager: registration failed: ", array2), 728f, TutorialDialog.DODBDLEJOAM.Right, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1878f, 565f, 577f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1827f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto IL_0c35;
			}
			case 17u:
			...
			case 18u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 78f);
			...
			default:
				...
				if (APHENMOFJJP.NGOGADPALJO().KAJHANBHNKK != BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
				{
					if (CADIPBGKAKK != null && CADIPBGKAKK.transform.position != DNHJMCLEGAB)
					{
						...
						GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
					}
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
		...
		public bool BIGKCFMEBJE()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 271f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH, GPCEHFNNCIN: false);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.isShowed)
				{
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 275f);
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(JFOMIIDCEKM, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1036f);
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.EAJJDMMGMKK().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DNHJMCLEGAB, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 105f);
			...
			case 13u:
			{
				...
				instance4.DOLDLDECPIO(aMKLKMJEMJM4, Localization.LocalizeFormat("com/google/android/gms/common/ConnectionResult", array5), 1448f, TutorialDialog.DODBDLEJOAM.BottomLeft, NHEJDPIIOJG: false);
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(1449f, 192f, 1187f), ELHGOHGPJCF: false, ENIHCPLOOAE: true, 1810f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto case 14u;
			}
			case 14u:
			...
			case 15u:
			{
				...
				instance3.DOLDLDECPIO(aMKLKMJEMJM3, Localization.LocalizeFormat("0", array3), 1906f, TutorialDialog.DODBDLEJOAM.Center, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1433f, 996f, 1572f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 471f);
			...
			case 16u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1913f, 160f, 416f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 746f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				goto IL_0c35;
			}
			case 17u:
			...
			case 18u:
			{
				...
				instance.ShowMenuTutorial(aMKLKMJEMJM, Localization.LocalizeFormat("ID_CONFIRM_NOSQUADACTIONS_TEXT", array), 1405f, TutorialDialog.DODBDLEJOAM.Left, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: true, 1937f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ, GPCEHFNNCIN: false);
				goto case 19u;
			}
			case 19u:
		...
		public bool OKELILGDPLJ()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.MAKIDBFPIEE();
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("Card_2_Played"), Localization.Localize("ID_GETFREEGOLD"), 1422f, TutorialDialog.DODBDLEJOAM.Center, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 93f);
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 504f);
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(JFOMIIDCEKM, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 689f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(JFOMIIDCEKM, JFCIFNAPAOC.localScale);
					goto case 10u;
				}
				goto IL_06c2;
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.GMEFFFKMDCE().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(DNHJMCLEGAB, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1176f);
							GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
							break;
						}
					}
			...
			case 13u:
				...
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1558f, 788f, 1179f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1239f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto case 14u;
			case 14u:
			...
			case 15u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(66f, 1053f, 291f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 494f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				PECMCAOEMND = false;
				goto case 17u;
			case 16u:
			{
				...
				instance2.ShowMenuTutorial(aMKLKMJEMJM2, Localization.LocalizeFormat("menu-squad-1", array2), 1584f, TutorialDialog.DODBDLEJOAM.BottomRight, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1293f, 1744f, 1931f), ELHGOHGPJCF: false, ENIHCPLOOAE: true, 488f);
			...
			case 18u:
			{
				...
				instance.ShowMenuTutorial(aMKLKMJEMJM, Localization.LocalizeFormat("Awaiting players - Player id:\"{0}\" is not in list of awaiting members", array), 1944f, TutorialDialog.DODBDLEJOAM.BottomRight, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1194f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ);
				goto case 19u;
			}
			case 19u:
			...
			default:
				...
				if (APHENMOFJJP.EAJJDMMGMKK().KAJHANBHNKK != BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
				{
					if (CADIPBGKAKK != null && CADIPBGKAKK.transform.position != DNHJMCLEGAB)
					{
						DNHJMCLEGAB = CADIPBGKAKK.transform.position;
						GuiElementSingle<TutorialOverlayGuiElement>.instance.IMOAGBADPCC(DNHJMCLEGAB);
						GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
					}
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
		...
		public bool MoveNext()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.HideRightContent();
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_UPGRADEWEAPON_1"), Localization.Localize("ID_TUTORIAL_UPGRADEWEAPON_2"), 0.1f, TutorialDialog.DODBDLEJOAM.Right, NHEJDPIIOJG: false);
			...
			case 6u:
				...
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD, GPCEHFNNCIN: false);
				GuiScreenSingle<WeaponScreen>.instance.SelectWeapon(BJGCPDNMHDH.mWeaponToUpgrade);
				ICDIPDJOMKO = 0;
				goto case 7u;
			case 7u:
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.weaponSetup.KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
							break;
						}
					}
				}
			...
			case 12u:
				...
				goto IL_08dc;
			case 13u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_UPGRADEWEAPON_7"), Localization.LocalizeFormat("ID_TUTORIAL_TAPON", Localization.Localize("ID_UPGRADE")), 0.6f, TutorialDialog.DODBDLEJOAM.BottomRight, NHEJDPIIOJG: false);
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
			...
			case 14u:
				...
				break;
			case 15u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_UPGRADEWEAPON_8"), Localization.LocalizeFormat("ID_TUTORIAL_TAPON", Localization.Localize("ID_DELIVERNOW")), 0.6f, TutorialDialog.DODBDLEJOAM.BottomRight, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(40f, -56f, 0f));
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				PECMCAOEMND = true;
				goto case 17u;
			case 16u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_UPGRADEWEAPON_9"), Localization.LocalizeFormat("ID_TUTORIAL_TAPON", Localization.Localize("ID_ACTIVATION")), 0.6f, TutorialDialog.DODBDLEJOAM.BottomRight, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(40f, -56f, 0f));
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto IL_0c35;
			case 17u:
				...
				goto IL_0dff;
			case 18u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_UPGRADEWEAPON_10"), Localization.LocalizeFormat("ID_TUTORIAL_TAPON", Localization.Localize("ID_GUI_EQUIP")), 0.6f, TutorialDialog.DODBDLEJOAM.BottomLeft, NHEJDPIIOJG: false);
				...
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ, GPCEHFNNCIN: false);
				goto case 19u;
			case 19u:
				if (PlayerInventory.instance.inventorySlots[ICDIPDJOMKO].weaponLevelsSetup != APHENMOFJJP.weaponSetup)
				{
		...
		public bool DFMKKFMEBON()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.HideRightContent();
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("squad"), Localization.Localize("ID_SLOTUPGRADE_AMMO"), 699f, TutorialDialog.DODBDLEJOAM.Bottom, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1638f);
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1329f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD, GPCEHFNNCIN: false);
				GuiScreenSingle<WeaponScreen>.instance.EOOIBDMOAFJ(BJGCPDNMHDH.mWeaponToUpgrade);
				ICDIPDJOMKO = 0;
				goto case 7u;
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(JFOMIIDCEKM, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1352f);
					GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(JFOMIIDCEKM, JFCIFNAPAOC.localScale, GPCEHFNNCIN: false);
					goto case 10u;
				}
				goto IL_06c2;
			case 10u:
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.EAJJDMMGMKK().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(DNHJMCLEGAB, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1454f);
							GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
							break;
						}
					}
			...
			case 13u:
			{
				...
				instance3.ShowMenuTutorial(aMKLKMJEMJM3, Localization.LocalizeFormat("WarCards", array3), 1805f, TutorialDialog.DODBDLEJOAM.TopLeft, NHEJDPIIOJG: false);
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(1146f, 1838f, 587f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 424f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto case 14u;
			}
			case 14u:
			...
			case 15u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1470f, 788f, 881f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 156f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				PECMCAOEMND = false;
				goto case 17u;
			}
			case 16u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("UnitID"), Localization.LocalizeFormat("AssignmentId", Localization.Localize("ID_SALEPERCENTLINE")), 699f, TutorialDialog.DODBDLEJOAM.Right, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(749f, 1199f, 1843f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1594f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto IL_0c35;
			case 17u:
			...
			case 18u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 314f);
		...
		public bool PJJPPMIBNLN()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.MAKIDBFPIEE();
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("saved obtained cards: "), Localization.Localize("WarFriends richiede l'autorizzazione alla memorizzazione multimediale per scaricare dati fondamentali per il gioco.Accetta la finestra di dialogo di autorizzazione che verrà visualizzata. Non useremo questa autorizzazione per altri scopi."), 400f, TutorialDialog.DODBDLEJOAM.Bottom, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: true, 1998f);
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 60f);
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(JFOMIIDCEKM, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 1164f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(JFOMIIDCEKM, JFCIFNAPAOC.localScale, GPCEHFNNCIN: false);
					goto case 10u;
				}
				goto IL_06c2;
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.GMEFFFKMDCE().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(DNHJMCLEGAB, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 244f);
							GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
							break;
						}
					}
			...
			case 13u:
				...
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(612f, 1937f, 584f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 216f);
			...
			case 15u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(189f, 96f, 1360f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 761f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				PECMCAOEMND = false;
				goto case 17u;
			}
			case 16u:
				GuiElementSingle<TutorialDialog>.instance.PBEAOCBHFGD(Localization.Localize("squadMembers"), Localization.LocalizeFormat("WebPlayer", Localization.Localize("Found labels with dynamic font in children:\n")), 1710f, TutorialDialog.DODBDLEJOAM.Left, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(1874f, 1404f, 65f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 711f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto IL_0c35;
			case 17u:
				if (APHENMOFJJP.NGOGADPALJO().weaponState != WeaponLevelsSetup.JLANLLEABDC.NotBuyed)
			...
			case 18u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1995f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ);
				goto case 19u;
			}
			case 19u:
		...
		public bool ILNBJIJONKD()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.HideRightContent();
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("warbucks"), Localization.Localize("ID_HEADERMAXCHAR"), 784f, TutorialDialog.DODBDLEJOAM.Center, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: true, 1613f);
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: true, 187f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD, GPCEHFNNCIN: false);
				GuiScreenSingle<WeaponScreen>.instance.SelectWeapon(BJGCPDNMHDH.mWeaponToUpgrade);
				ICDIPDJOMKO = 1;
				goto case 7u;
			case 7u:
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(JFOMIIDCEKM, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 1724f);
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.CJAIGEJNDOH().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DNHJMCLEGAB, ELHGOHGPJCF: false, ENIHCPLOOAE: true, 1747f);
							GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
							break;
						}
					}
			...
			case 13u:
			{
				...
				instance4.PBEAOCBHFGD(aMKLKMJEMJM4, Localization.LocalizeFormat(")", array4), 1894f, TutorialDialog.DODBDLEJOAM.Bottom, NHEJDPIIOJG: false);
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(1815f, 223f, 1686f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1932f);
			...
			case 15u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(1742f, 1795f, 90f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 585f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				PECMCAOEMND = false;
				goto case 17u;
			}
			case 16u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1330f, 1496f, 785f), ELHGOHGPJCF: false, ENIHCPLOOAE: true, 1690f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto IL_0c35;
			}
			case 17u:
			...
			case 18u:
			{
				...
				instance.BLHPAFCOPMD(aMKLKMJEMJM, Localization.LocalizeFormat("PowerBandId", array), 783f, TutorialDialog.DODBDLEJOAM.Top, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1809f);
			...
			default:
				...
				if (APHENMOFJJP.EAJJDMMGMKK().KAJHANBHNKK != BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
				{
					...
					{
						DNHJMCLEGAB = CADIPBGKAKK.transform.position;
						GuiElementSingle<TutorialOverlayGuiElement>.instance.UpdateTapAnimation(DNHJMCLEGAB, ELHGOHGPJCF: false);
						GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(DNHJMCLEGAB, KIPCNCCJDNC);
					}
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
		...
		public bool FGAFKEKGPHF()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.HideRightContent();
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("PACK"), Localization.Localize("country-indonesia"), 1116f, TutorialDialog.DODBDLEJOAM.Left, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1523f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.NPFFMLLLDAF())
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 977f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD, GPCEHFNNCIN: false);
				GuiScreenSingle<WeaponScreen>.instance.SelectWeapon(BJGCPDNMHDH.mWeaponToUpgrade);
				ICDIPDJOMKO = 1;
				goto case 7u;
			case 7u:
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(JFOMIIDCEKM, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 854f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(JFOMIIDCEKM, JFCIFNAPAOC.localScale, GPCEHFNNCIN: false);
					goto case 10u;
				}
				goto IL_06c2;
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.ADOICOAEIFA().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(DNHJMCLEGAB, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1822f);
			...
			case 13u:
			{
				...
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(565f, 1074f, 1360f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1085f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				goto case 14u;
			}
			case 14u:
			...
			case 15u:
			{
				...
				instance2.PBEAOCBHFGD(aMKLKMJEMJM2, Localization.LocalizeFormat("N", array2), 1772f, TutorialDialog.DODBDLEJOAM.BottomLeft, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1045f, 1562f, 1943f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1529f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				PECMCAOEMND = false;
				goto case 17u;
			}
			case 16u:
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("Play_Card_Tutorial_Duration"), Localization.LocalizeFormat("Days_Since_Install", Localization.Localize("ID_BOSS")), 1258f, TutorialDialog.DODBDLEJOAM.Top, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(597f, 1049f, 1862f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 694f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto IL_0c35;
			case 17u:
			...
			case 18u:
			{
				...
				instance.ShowMenuTutorial(aMKLKMJEMJM, Localization.LocalizeFormat("N", array), 861f, TutorialDialog.DODBDLEJOAM.BottomLeft, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: true, 1034f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ);
				goto case 19u;
			}
			case 19u:
		...
		public bool KDFAHLNCNMN()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 574f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH, GPCEHFNNCIN: false);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.NPFFMLLLDAF())
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: true, 539f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD);
				GuiScreenSingle<WeaponScreen>.instance.SelectWeapon(BJGCPDNMHDH.mWeaponToUpgrade);
				ICDIPDJOMKO = 0;
				goto case 7u;
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(JFOMIIDCEKM, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 396f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(JFOMIIDCEKM, JFCIFNAPAOC.localScale, GPCEHFNNCIN: false);
					goto case 10u;
				}
				goto IL_06c2;
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.CJAIGEJNDOH().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(DNHJMCLEGAB, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1327f);
							GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
							break;
						}
					}
			...
			case 13u:
			{
				...
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(81f, 153f, 1716f), ELHGOHGPJCF: false, ENIHCPLOOAE: true, 323f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				goto case 14u;
			}
			case 14u:
			...
			case 15u:
			{
				...
				instance2.PBEAOCBHFGD(aMKLKMJEMJM2, Localization.LocalizeFormat("Exception message: ", array2), 455f, TutorialDialog.DODBDLEJOAM.Center, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1094f, 1019f, 53f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 484f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				PECMCAOEMND = false;
				goto case 17u;
			}
			case 16u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(878f, 1683f, 1962f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 818f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto IL_0c35;
			}
			case 17u:
				...
				goto IL_0dff;
			case 18u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("audio/game0"), Localization.LocalizeFormat("game-card-ico-swiftimmortality", Localization.Localize("{0} Emblem {1} LVL {2}")), 1660f, TutorialDialog.DODBDLEJOAM.Bottom, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: true, 824f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ);
				goto case 19u;
			case 19u:
		...
		public bool LDINGGNOLKA()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.MAKIDBFPIEE();
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("ExplodeRPC"), Localization.Localize("com.chillingo.warfriends.android.gplay.localpersistencemanager.LocalPersistenceManager"), 1082f, TutorialDialog.DODBDLEJOAM.Bottom, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 241f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH, GPCEHFNNCIN: false);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.NPFFMLLLDAF())
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 1006f);
				GuiElementSingle<TutorialClickOverlay>.instance.FCGLGPIBAEN(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD, GPCEHFNNCIN: false);
				GuiScreenSingle<WeaponScreen>.instance.SelectWeapon(BJGCPDNMHDH.mWeaponToUpgrade);
				ICDIPDJOMKO = 1;
				goto case 7u;
			case 7u:
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(JFOMIIDCEKM, ELHGOHGPJCF: false, ENIHCPLOOAE: true, 648f);
					GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(JFOMIIDCEKM, JFCIFNAPAOC.localScale, GPCEHFNNCIN: false);
					goto case 10u;
				}
				goto IL_06c2;
			case 10u:
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.weaponSetup.KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DNHJMCLEGAB, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1638f);
							GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
							break;
						}
					}
				}
			...
			case 13u:
			{
				...
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(1789f, 1527f, 522f), ELHGOHGPJCF: false, ENIHCPLOOAE: true, 1175f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto case 14u;
			}
			case 14u:
			...
			case 15u:
			{
				...
				instance3.ShowMenuTutorial(aMKLKMJEMJM3, Localization.LocalizeFormat("ID_UNITTYPE2", array3), 221f, TutorialDialog.DODBDLEJOAM.BottomRight, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(493f, 1714f, 751f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 1678f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				PECMCAOEMND = true;
				goto case 17u;
			}
			case 16u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1109f, 1049f, 48f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 805f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				goto IL_0c35;
			}
			case 17u:
			...
			case 18u:
			{
				...
				instance.ShowMenuTutorial(aMKLKMJEMJM, Localization.LocalizeFormat("ID_ARENASTARTSTIMER", array), 1024f, TutorialDialog.DODBDLEJOAM.Top, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1357f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ);
				goto case 19u;
			}
			case 19u:
			...
			default:
				...
				if (APHENMOFJJP.PMIIPNOJFLF().KAJHANBHNKK != BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
				{
					...
					{
						DNHJMCLEGAB = CADIPBGKAKK.transform.position;
						GuiElementSingle<TutorialOverlayGuiElement>.instance.NFPJIFHLFNB(DNHJMCLEGAB, ELHGOHGPJCF: false);
						GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(DNHJMCLEGAB, KIPCNCCJDNC);
					}
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
		...
		public bool ONIAGKNGBHE()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 1246f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.NPFFMLLLDAF())
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1875f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD);
				GuiScreenSingle<WeaponScreen>.instance.EOOIBDMOAFJ(BJGCPDNMHDH.mWeaponToUpgrade);
				ICDIPDJOMKO = 1;
				goto case 7u;
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(JFOMIIDCEKM, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 598f);
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.EAJJDMMGMKK().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DNHJMCLEGAB, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1524f);
							GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(DNHJMCLEGAB, KIPCNCCJDNC);
							break;
						}
					}
			...
			case 13u:
				...
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1723f, 711f, 593f), ELHGOHGPJCF: false, ENIHCPLOOAE: true, 930f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				goto case 14u;
			case 14u:
				if (APHENMOFJJP.weaponSetup.weaponState != WeaponLevelsSetup.JLANLLEABDC.WeaponDelivered)
			...
			case 15u:
			{
				...
				instance3.DOLDLDECPIO(aMKLKMJEMJM3, Localization.LocalizeFormat("ExpireTime", array3), 252f, TutorialDialog.DODBDLEJOAM.Right, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(909f, 1953f, 1972f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 794f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				PECMCAOEMND = true;
				goto case 17u;
			}
			case 16u:
			{
				...
				instance2.DOLDLDECPIO(aMKLKMJEMJM2, Localization.LocalizeFormat("PlayerInfoId", array2), 686f, TutorialDialog.DODBDLEJOAM.Right, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1199f, 1028f, 201f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 1869f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto IL_0c35;
			}
			case 17u:
			...
			case 18u:
			{
				...
				instance.DOLDLDECPIO(aMKLKMJEMJM, Localization.LocalizeFormat("ID_CONFIRM_JOININGSQUAD_TEXT", array), 1486f, TutorialDialog.DODBDLEJOAM.Top, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 960f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ);
				goto case 19u;
			}
			case 19u:
			...
			default:
				...
				if (APHENMOFJJP.weaponSetup.KAJHANBHNKK != BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
				{
					...
					{
						DNHJMCLEGAB = CADIPBGKAKK.transform.position;
						GuiElementSingle<TutorialOverlayGuiElement>.instance.IMOAGBADPCC(DNHJMCLEGAB, ELHGOHGPJCF: false);
						GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
					}
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
		...
		public bool HJHJCCFGJIH()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 486f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.NPFFMLLLDAF())
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 253f);
				GuiElementSingle<TutorialClickOverlay>.instance.MEBFBNDKOGD(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD);
				GuiScreenSingle<WeaponScreen>.instance.EOOIBDMOAFJ(BJGCPDNMHDH.mWeaponToUpgrade);
				ICDIPDJOMKO = 0;
				goto case 7u;
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(JFOMIIDCEKM, ELHGOHGPJCF: false, ENIHCPLOOAE: true, 322f);
					GuiElementSingle<TutorialClickOverlay>.instance.IGNJKOKGNOI(JFOMIIDCEKM, JFCIFNAPAOC.localScale);
					goto case 10u;
				}
				goto IL_06c2;
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.EAJJDMMGMKK().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(DNHJMCLEGAB, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 89f);
							GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(DNHJMCLEGAB, KIPCNCCJDNC);
							break;
						}
					}
			...
			case 13u:
			{
				...
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(741f, 457f, 128f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1317f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto case 14u;
			}
			case 14u:
				...
				break;
			case 15u:
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("Player_Level"), Localization.LocalizeFormat("ItemsOwned_Rarity_2", Localization.Localize("menu-arena-ticket")), 1017f, TutorialDialog.DODBDLEJOAM.BottomLeft, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(324f, 1997f, 171f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 184f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				PECMCAOEMND = false;
				goto case 17u;
			case 16u:
			{
				...
				instance2.PBEAOCBHFGD(aMKLKMJEMJM2, Localization.LocalizeFormat("country-mexico", array2), 1583f, TutorialDialog.DODBDLEJOAM.Right, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1470f, 824f, 1789f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1454f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				goto IL_0c35;
			}
			case 17u:
			...
			case 18u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1789f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ);
				goto case 19u;
			}
			case 19u:
			...
			default:
				...
				if (APHENMOFJJP.weaponSetup.KAJHANBHNKK != BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
				{
					...
					{
						DNHJMCLEGAB = CADIPBGKAKK.transform.position;
						GuiElementSingle<TutorialOverlayGuiElement>.instance.OOIJFHGCCNH(DNHJMCLEGAB, ELHGOHGPJCF: false);
						GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
					}
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
		...
		public bool OOECALAHCFK()
		{
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 383f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD);
				GuiScreenSingle<WeaponScreen>.instance.SelectWeapon(BJGCPDNMHDH.mWeaponToUpgrade);
				ICDIPDJOMKO = 0;
				goto case 7u;
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(JFOMIIDCEKM, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1726f);
					GuiElementSingle<TutorialClickOverlay>.instance.IGNJKOKGNOI(JFOMIIDCEKM, JFCIFNAPAOC.localScale, GPCEHFNNCIN: false);
					goto case 10u;
				}
				goto IL_06c2;
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.CJAIGEJNDOH().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DNHJMCLEGAB, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 588f);
							GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(DNHJMCLEGAB, KIPCNCCJDNC);
							break;
						}
					}
			...
			case 13u:
			{
				...
				instance4.DOLDLDECPIO(aMKLKMJEMJM4, Localization.LocalizeFormat("setDeviceId", array4), 124f, TutorialDialog.DODBDLEJOAM.BottomRight, NHEJDPIIOJG: false);
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(383f, 156f, 75f), ELHGOHGPJCF: false, ENIHCPLOOAE: true, 1043f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				goto case 14u;
			}
			case 14u:
			...
			case 15u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(115f, 1380f, 1001f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1714f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				PECMCAOEMND = true;
				goto case 17u;
			}
			case 16u:
			{
				...
				instance2.DOLDLDECPIO(aMKLKMJEMJM2, Localization.LocalizeFormat("Action ", array2), 1943f, TutorialDialog.DODBDLEJOAM.Center, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(791f, 632f, 671f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 440f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto IL_0c35;
			}
			case 17u:
			...
			case 18u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 747f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ, GPCEHFNNCIN: false);
				goto case 19u;
			}
			case 19u:
		...
		public bool FBMLBIOKKBE()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.MAKIDBFPIEE();
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("service"), Localization.Localize("Per funzionare, WarFriends deve scaricare circa 190MB di dati extra.\nIl tempo di download può variare in base alla tua rete e posizione.\n\nVuoi proseguire?"), 1576f, TutorialDialog.DODBDLEJOAM.Bottom, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1559f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.NPFFMLLLDAF())
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 303f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD, GPCEHFNNCIN: false);
				GuiScreenSingle<WeaponScreen>.instance.EOOIBDMOAFJ(BJGCPDNMHDH.mWeaponToUpgrade);
				ICDIPDJOMKO = 0;
				goto case 7u;
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(JFOMIIDCEKM, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1616f);
					GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(JFOMIIDCEKM, JFCIFNAPAOC.localScale, GPCEHFNNCIN: false);
					goto case 10u;
				}
				goto IL_06c2;
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.EAJJDMMGMKK().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DNHJMCLEGAB, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 848f);
							GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(DNHJMCLEGAB, KIPCNCCJDNC);
							break;
						}
					}
			...
			case 13u:
			{
				...
				instance3.PBEAOCBHFGD(aMKLKMJEMJM3, Localization.LocalizeFormat("#STEPAN# Achievement '{0}' progress '{1}' could not be reported.", array4), 1758f, TutorialDialog.DODBDLEJOAM.Top, NHEJDPIIOJG: false);
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1599f, 1524f, 1047f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 1900f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				goto case 14u;
			}
			case 14u:
			...
			case 15u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1311f, 1752f, 1539f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1069f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				PECMCAOEMND = false;
				goto case 17u;
			}
			case 16u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(978f, 1058f, 1868f), ELHGOHGPJCF: false, ENIHCPLOOAE: true, 1844f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto IL_0c35;
			}
			case 17u:
				...
				goto IL_0dff;
			case 18u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("category"), Localization.LocalizeFormat("{0} Squad Member {1}", Localization.Localize("Experience")), 609f, TutorialDialog.DODBDLEJOAM.Center, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 925f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ);
				goto case 19u;
			case 19u:
				if (PlayerInventory.instance.inventorySlots[ICDIPDJOMKO].PMJFFNLKKLB() != APHENMOFJJP.OFABMGFOFPI())
		...
		public bool LMNIKLKKIDN()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.HideRightContent();
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("CONTENTS_FILE_DESCRIPTOR"), Localization.Localize("FuseSDK: Parsing error in _PurchaseVerification"), 1204f, TutorialDialog.DODBDLEJOAM.Bottom, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1409f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.isShowed)
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1228f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD, GPCEHFNNCIN: false);
				GuiScreenSingle<WeaponScreen>.instance.EOOIBDMOAFJ(BJGCPDNMHDH.mWeaponToUpgrade);
				ICDIPDJOMKO = 1;
				goto case 7u;
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(JFOMIIDCEKM, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 474f);
					GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(JFOMIIDCEKM, JFCIFNAPAOC.localScale);
					goto case 10u;
				}
				goto IL_06c2;
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.weaponSetup.KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DNHJMCLEGAB, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1200f);
							GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(DNHJMCLEGAB, KIPCNCCJDNC);
							break;
						}
					}
			...
			case 13u:
			{
				...
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(525f, 86f, 993f), ELHGOHGPJCF: true, ENIHCPLOOAE: false, 1605f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				goto case 14u;
			}
			case 14u:
				...
				break;
			case 15u:
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("menu-crown-gold"), Localization.LocalizeFormat("OK", Localization.Localize("{0}{1}")), 1766f, TutorialDialog.DODBDLEJOAM.Right, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1946f, 952f, 619f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1554f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				PECMCAOEMND = false;
				goto case 17u;
			case 16u:
			{
				...
				instance2.DOLDLDECPIO(aMKLKMJEMJM2, Localization.LocalizeFormat("Beanstalk check: Application not reachable!", array2), 145f, TutorialDialog.DODBDLEJOAM.TopLeft, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1671f, 891f, 1113f), ELHGOHGPJCF: true, ENIHCPLOOAE: true, 684f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				goto IL_0c35;
			}
			case 17u:
			...
			case 18u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 1182f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ);
				goto case 19u;
			}
			case 19u:
		...
		public bool DMPHMFDEINI()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 28f);
			...
			case 6u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD.transform.position, ELHGOHGPJCF: false, ENIHCPLOOAE: false, 1052f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<BattlePreparationScreen>.instance.KAPHPGAINPD.KAPHPGAINPD, GPCEHFNNCIN: false);
				GuiScreenSingle<WeaponScreen>.instance.EOOIBDMOAFJ(BJGCPDNMHDH.mWeaponToUpgrade);
				ICDIPDJOMKO = 1;
				goto case 7u;
			...
			case 9u:
				...
				if (GuiScreenSingle<WeaponScreen>.instance.selectedCategory != (GuiScreenSingle<WeaponScreen>.instance.selectedCategory & BJGCPDNMHDH.mWeaponToUpgrade.BHCEOOLEHHG))
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(JFOMIIDCEKM, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 476f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(JFOMIIDCEKM, JFCIFNAPAOC.localScale, GPCEHFNNCIN: false);
					goto case 10u;
				}
				goto IL_06c2;
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.ADOICOAEIFA().KAJHANBHNKK == BJGCPDNMHDH.mWeaponToUpgrade.KAJHANBHNKK)
						{
							...
							DNHJMCLEGAB = CADIPBGKAKK.transform.position;
							KIPCNCCJDNC = CADIPBGKAKK.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DNHJMCLEGAB, ELHGOHGPJCF: true, ENIHCPLOOAE: false, 783f);
							GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(DNHJMCLEGAB, KIPCNCCJDNC, GPCEHFNNCIN: false);
							break;
						}
					}
			...
			case 12u:
				...
				goto IL_08dc;
			case 13u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_SALEPERCENTLINE"), Localization.LocalizeFormat("ID_ARENARULES_UNITCOST", Localization.Localize("null")), 1689f, TutorialDialog.DODBDLEJOAM.TopLeft, NHEJDPIIOJG: false);
				DHEGKFCAAGP = GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.HJKCBBANLDM.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(1189f, 586f, 143f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 354f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				goto case 14u;
			case 14u:
				...
				break;
			case 15u:
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("On Login to Custom playerAccount"), Localization.LocalizeFormat("GoldTransactionAmount", Localization.Localize("#VAVRO# Accept Challenge Message {0}")), 583f, TutorialDialog.DODBDLEJOAM.Top, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(771f, 98f, 128f), ELHGOHGPJCF: false, ENIHCPLOOAE: false, 56f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC, GPCEHFNNCIN: false);
				PECMCAOEMND = false;
				goto case 17u;
			case 16u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(1644f, 1379f, 986f), ELHGOHGPJCF: false, ENIHCPLOOAE: true, 1279f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<WeaponScreen>.instance.EMHGMNAABDN.EDHCOMHOKDC);
				goto IL_0c35;
			}
			case 17u:
			...
			case 18u:
			{
				...
				instance.ShowMenuTutorial(aMKLKMJEMJM, Localization.LocalizeFormat("$#", array), 1886f, TutorialDialog.DODBDLEJOAM.TopRight, NHEJDPIIOJG: false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ.transform.position, ELHGOHGPJCF: true, ENIHCPLOOAE: true, 614f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<WeaponScreen>.instance.BKLPGLKGCLG.BEJIFJIKHPJ);
				goto case 19u;
			}
			case 19u:
