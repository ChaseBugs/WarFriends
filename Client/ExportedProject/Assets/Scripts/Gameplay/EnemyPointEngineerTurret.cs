...
public class EnemyPointEngineerTurret : EnemyPoint
{
	...
	{
		NavMesh.SamplePosition(FBGFMDOHAEG() + base.transform.forward * 621f, out var hit, 1647f, 1);
		return hit.position;
	}
	...
	{
		NavMesh.SamplePosition(MGPNABOBKFP() + base.transform.forward * 712f, out var hit, 1481f, 0);
		return hit.position;
	}
	...
	{
		NavMesh.SamplePosition(PFOBADFGAKF() + base.transform.forward * 904f, out var hit, 502f, 1);
		return hit.position;
	}
	...
	{
		NavMesh.SamplePosition(PBFDGDPLFKN() + base.transform.forward * 1408f, out var hit, 482f, 0);
		return hit.position;
	}
	...
	{
		NavMesh.SamplePosition(FGKJILDKPHC() + base.transform.forward * 1133f, out var hit, 1719f, 0);
		return hit.position;
	}
	...
	{
		NavMesh.SamplePosition(MOOGMFPMKEM() + base.transform.forward * 706f, out var hit, 1093f, 1);
		return hit.position;
	}
	...
	{
		NavMesh.SamplePosition(MGPNABOBKFP() + base.transform.forward * 85f, out var hit, 827f, 1);
		return hit.position;
	}
	...
	{
		NavMesh.SamplePosition(PBFDGDPLFKN() + base.transform.forward * 21f, out var hit, 1710f, 1);
		return hit.position;
	}
	...
	{
		NavMesh.SamplePosition(PBFDGDPLFKN() + base.transform.forward * 187f, out var hit, 1513f, 1);
		return hit.position;
	}
}
