...
{
	public override string name => Localization.Localize("ID_FEATURE_ACCURACY");

	public override string fancyName => Localization.Localize("ID_FEATURE_ACCURACY-FANCY");

	public override string icon => "menu-weaponstats-accuracy";

	public override string description => Localization.Localize("ID_FEATURE_ACCURACY-DESCRIPTION");

	public override string statisticIncrease => MEJMLNDFDBP.DPAFFLMAFJG(base.value);

	public override string weaponPrefix => Localization.Localize("ID_FEATURE_ACCURACY-WEAPONPREFIX");

	public override float accuracyCoef => 1f + (float)base.value;
