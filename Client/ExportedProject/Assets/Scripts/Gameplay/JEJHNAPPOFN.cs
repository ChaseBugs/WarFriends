...
public class JEJHNAPPOFN : HHFHFANGCEJ
{
	...
	public virtual void ILFJPOOMFDO()
	{
		...
		if (flag)
		{
			...
			{
				GuiElementSingle<ChatGuiElement>.instance.FNNHCGMNDKN.GDDDOGFCHFH(this, OAEECIAFLMC: false);
			}
			if (flag2)
			{
	...
	public override void LACLELOOKHD()
	{
		...
		if (!flag || flag2)
		{
			...
			array[0] = MEJMLNDFDBP.CJCFPDLDMEK(KJCKFGCLGLG, "ID_CONFIRM_EXITINGCOOP_TEXT", string.Empty, IEJMLKBCDJB: false);
			array[1] = MEJMLNDFDBP.CJCFPDLDMEK(Singleton<BeanstalkServerManager>.instance.AHEDBCHBDMN(), "ArenaVisualMessage", string.Empty, IEJMLKBCDJB: false);
			array[5] = flag;
	...
	public virtual void JOCFHKJPEPO()
	{
		...
		if (!flag || flag2)
		{
			...
			array[0] = MEJMLNDFDBP.CJCFPDLDMEK(Singleton<BeanstalkServerManager>.instance.BKJJGHIODNF(), "ID_TUTORIAL_SWIPE_UP2", string.Empty, IEJMLKBCDJB: false);
			array[8] = flag;
	...
	public virtual void IEEENGDDELF()
	{
		...
		if (!flag || flag2)
		{
			...
			array[1] = MEJMLNDFDBP.CJCFPDLDMEK(KJCKFGCLGLG, "ID_WARNING_CANNOTCREATESQUAD", string.Empty, IEJMLKBCDJB: false);
			array[0] = MEJMLNDFDBP.CJCFPDLDMEK(Singleton<BeanstalkServerManager>.instance.currentTimestamp, "s", string.Empty, IEJMLKBCDJB: false);
			array[7] = flag;
	...
	public virtual void LCCEEAMLHDD()
	{
		...
		if (flag)
		{
			if (Singleton<Chat>.instance.shouldChat)
			{
				GuiElementSingle<ChatGuiElement>.instance.FNNHCGMNDKN.GCFGHDLENAL(this, OAEECIAFLMC: false);
			}
			if (flag2)
			{
	...
	public virtual void ONCKKJFAMKF()
	{
		...
		if (flag)
		{
			if (Singleton<Chat>.instance.shouldChat)
			{
				GuiElementSingle<ChatGuiElement>.instance.FNNHCGMNDKN.BGOHKEGGHMH(this, OAEECIAFLMC: false);
			}
			if (flag2)
			{
				Singleton<BeanstalkServerManager>.instance.JKJOCCOGLAI(squadName, FHKKPEIDDJN: true);
	...
	public virtual void PFNBDPFAKBN()
	{
		...
		if (flag)
		{
			if (Singleton<Chat>.instance.shouldChat)
			{
				GuiElementSingle<ChatGuiElement>.instance.FNNHCGMNDKN.HKGAPGAKFHA(this, OAEECIAFLMC: false);
			}
			if (flag2)
			{
				Singleton<BeanstalkServerManager>.instance.IIFBHBOKGKA(squadName);
