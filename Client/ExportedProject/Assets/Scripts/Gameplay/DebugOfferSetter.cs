...
{
	[FormerlySerializedAs("EHLOMGKJLGG")]
	public GameObject FEGLHNIALBB;

	[FormerlySerializedAs("OKFHGJPHNGD")]
	public UIInput COEOMHLOGBD;

	[FormerlySerializedAs("GPBNLAODMEB")]
	public UIInput HKKMLHIPFJH;

	[FormerlySerializedAs("LBPEHNBHDGL")]
	public UIInput HOGEDDANFBG;

	[FormerlySerializedAs("IPEDHKJJLFF")]
	public UIInput DBOLKNNJGMH;

	[FormerlySerializedAs("COMDJAOKALP")]
	public GameObject NDOKGDIEGOM;

	[FormerlySerializedAs("LGGNNKCHGKE")]
	public GameObject OKGHAHGODOB;

	[FormerlySerializedAs("NJOHDILNLMB")]
