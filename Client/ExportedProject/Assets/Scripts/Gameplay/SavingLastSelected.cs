...
public class SavingLastSelected : InGameSerializedObjectGeneric<SavingLastSelected.SaveData>
{
	...
	private sealed class CGHMODDLONI
	{
		internal int FMILJCONBIL;

		internal SavingLastSelected BJGCPDNMHDH;

		internal bool NCLMPCCHDAM(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool CIFEDFPPPOK(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool FDKEAJLEMCM(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool CMDLGJKIBLL(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool POGDLLFCOKO(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool EGJBKFPHCNF(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool HHNEBNHCGMO(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool BDCAFHOHEGM(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool FDKMOFHAEFN(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool OKNCFDMEFGJ(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool INFLOOLPOBK(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool DFAGLMPEDIH(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool KLJNEGDLOMG(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool OFJDLANHAMD(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool KPHEPHDFCKK(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool CHOIECFFEMH(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool MCFGAFBEJDK(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool JGEMIBIJMJC(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool LJCDGJKCNEC(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool MPHECHCFCAN(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool CFDNMILGDLG(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool DGELDDJAEEF(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool HHLMDAKDHFK(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool FIBGJHCGHJH(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool LGJCNCHBFDA(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool EMKPBGFBPFI(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool JMEBCMMIPAF(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool ILNPANOCHIH(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool PEFOCGECECP(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool LIMGPKFEALB(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool AMIJFGBOCLC(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool ILOFOILFGMA(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool PANKBNOCEAM(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool OHLGKFGIPCC(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool ECPMEMNKMCB(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool CFJHDIHLIML(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool GMFJFMHNDMC(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool DDHOKNIEACI(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool NAJNECOMDDN(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool KJIFNOJILDB(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}

		internal bool JGHLGHMJJDG(WeaponLevelsSetup MBNLFKHLDBH)
		{
			return MBNLFKHLDBH.KAJHANBHNKK == BJGCPDNMHDH.data.selectedWeapons[FMILJCONBIL];
		}
	}
	...
	public static SavingLastSelected instance
	{
		get
		{
			mInstance = mInstance ?? ((SavingLastSelected)SingletonSupport.FindOrCreate(typeof(SavingLastSelected)));
			return mInstance;
		}
	}
	...
	public void SaveSelectedCards()
	{
		...
		foreach (Card item in Singleton<GameController>.instance.GMNKFFNFEHG.cardsForGame)
		{
			data.selectedCards.Add(item.id);
		}
		foreach (Card item2 in Singleton<GameController>.instance.MBPKLMKBJAB.cardsForGame)
		{
	...
	{
		Singleton<GameController>.instance.GMNKFFNFEHG.cardsForGame = new List<Card>();
		foreach (string selectedCard in data.selectedCards)
		{
			Card cardInstance = CardManager.instance.GetCardInstance(selectedCard);
			if (cardInstance != null)
			{
				Singleton<GameController>.instance.GMNKFFNFEHG.cardsForGame.Add(cardInstance);
			}
		}
		Singleton<GameController>.instance.MBPKLMKBJAB.cardsForGame = new List<Card>();
		foreach (string item in data.selectedCardsWarArena)
		{
			...
			{
				Singleton<GameController>.instance.MBPKLMKBJAB.cardsForGame.Add(cardInstance2);
			}
		}
	}
	...
	public void SaveLastWeapon(WeaponLevelsSetup setup)
	{
		...
		if (setup.BHCEOOLEHHG == (setup.BHCEOOLEHHG & WeaponCategory.Primary))
		{
			data.lastCategoryIndex = 0;
		}
		else if (setup.BHCEOOLEHHG == (setup.BHCEOOLEHHG & WeaponCategory.Special))
		{
			data.lastCategoryIndex = 1;
		}
		else if (setup.BHCEOOLEHHG == (setup.BHCEOOLEHHG & WeaponCategory.Explosive))
		{
		...
		data.selectedWeapons[data.lastCategoryIndex] = setup.KAJHANBHNKK;
		Save();
	}
	...
	public WeaponLevelsSetup GetLastWeapon()
	{
		...
		int num = LevelManager.instance.weaponLevelsSetups.FindIndex((WeaponLevelsSetup setup) => setup.KAJHANBHNKK == data.selectedWeapons[data.lastCategoryIndex]);
		if (num == -1)
		{
			return null;
		}
	...
	{
		CGHMODDLONI cGHMODDLONI = new CGHMODDLONI();
		cGHMODDLONI.FMILJCONBIL = categ;
		cGHMODDLONI.BJGCPDNMHDH = this;
		if (data.selectedWeapons == null || cGHMODDLONI.FMILJCONBIL < 0 || cGHMODDLONI.FMILJCONBIL >= data.selectedWeapons.Count)
		{
			return null;
		}
		int num = LevelManager.instance.weaponLevelsSetups.FindIndex(cGHMODDLONI.LJCDGJKCNEC);
		if (num == -1)
		{
			return null;
		}
		data.lastCategoryIndex = cGHMODDLONI.FMILJCONBIL;
		Save();
		return LevelManager.instance.weaponLevelsSetups[num];
	}
	...
	public void AddUsedBotName(string botName)
	{
		...
		foreach (Tuple<int, string> usedBotName in data.usedBotNames)
		{
			DateTime dateTime = MEJMLNDFDBP.LAEDFBJFGBP(usedBotName.Value1);
