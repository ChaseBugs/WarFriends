...
namespace UnityStandardAssets.ImageEffects
{
	...
	{
		[FormerlySerializedAs("OIKEPGONIIJ")]
		public Color LADMOMJBEII;

		[FormerlySerializedAs("FMBGLNEFECM")]
		public float HOCADCCOKBH;

		[FormerlySerializedAs("DLFDFNMELBE")]
		public FogMode HJINPFPEOEH;

		[FormerlySerializedAs("FHNGJMDDIDG")]
		public float KIFAFIFHCNE;

		[FormerlySerializedAs("NFPOEGFMGDE")]
		public float EBJOMHODDJI;

		[FormerlySerializedAs("MFLHJMINHFK")]
		[Tooltip("Apply distance-based fog?")]
		public bool LGKHCDAELJI = true;

		[FormerlySerializedAs("FFHFBPEMJFG")]
		[Tooltip("Distance fog is based on radial distance from camera when checked")]
		public bool LFDAOGMOIPK;

		[Tooltip("Apply height-based fog?")]
		[FormerlySerializedAs("MBEFNPBMJEJ")]
		...
		[FormerlySerializedAs("FEDIPEPCKGD")]
		[Range(0.001f, 10f)]
