...
public class CardHealMeNowBig : CardHealMeNow
{
	...
	protected override string mBonusName => $"{MEJMLNDFDBP.JJOJLCBJBAJ(amountOfHealMin)}-{MEJMLNDFDBP.JJBMMICPIIG(amountOfHealMax)}";
	...
	{
		return $"{MEJMLNDFDBP.JJOJLCBJBAJ(IHJGJHPCFEF())} {MEJMLNDFDBP.JJBMMICPIIG(LMHAHEOAHLB())}";
	}
