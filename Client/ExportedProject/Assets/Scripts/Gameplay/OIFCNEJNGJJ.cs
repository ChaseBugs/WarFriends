...
public class OIFCNEJNGJJ
{
	...
	[CompilerGenerated]
	private int _003CMPBHIMECDNI_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private int _003CNDLIINKCHPB_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private int _003CKPNIJKPANCO_003Ek__BackingField;
	...
	public int KGMEJILKIHG
	{
		...
		private set
		{
			_003CMPBHIMECDNI_003Ek__BackingField = value;
		}
	}

	public int HFAGLEGDCPL
	{
		[CompilerGenerated]
		get
		{
		...
		private set
		{
			_003CNDLIINKCHPB_003Ek__BackingField = value;
		}
	}

	public int BDPLOPBMHAB
	{
		[CompilerGenerated]
		get
		{
		...
		set
		{
			_003CKPNIJKPANCO_003Ek__BackingField = value;
		}
	}
	...
	private int BIFCCNNPCME(int ONKHFFGNNOE, int NNKDKBKGGEG)
	{
		...
		if (ONKHFFGNNOE <= num)
		{
			UnityEngine.Debug.Log("Evaluation is old! " + ONKHFFGNNOE + ", current = " + num + ", interval = " + NNKDKBKGGEG);
			while (ONKHFFGNNOE <= num)
			{
				ONKHFFGNNOE += NNKDKBKGGEG;
			}
