...
internal class AGPANDBMDLC : HHFHFANGCEJ
{
		...
		: base("RewardMessage", NKHJBLBAAEB.RewardMessage)
	{
		...
		NHHGDIDEIMM += $"-{FJLBLLLEELD}-{Singleton<BeanstalkServerManager>.instance.currentTimestamp}";
	...
	public virtual void PEBHGOMEKME()
	{
		...
		case IHFDGLMHHBE.Lootboxes:
			GuiElementSingle<LootBoxDialog>.instance.MLJDDKKPIBE(LDDKEHKEJBI, AEAONENNNOJ: false);
			break;
	...
	public override void GEKIMGFKNHC()
	{
		...
		case IHFDGLMHHBE.CardPack:
			...
			break;
		case IHFDGLMHHBE.Lootboxes:
			GuiElementSingle<LootBoxDialog>.instance.ShowDialogMoreBoxes(LDDKEHKEJBI, AEAONENNNOJ: false);
			break;
		case IHFDGLMHHBE.Dogtag:
			if (MCFHJNNGKIB < StatsManager.instance.totalGames)
			{
