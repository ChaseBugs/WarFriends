...
public class PlayerController : MainGameEntity, TimeScaleIgnorable, NKMKCCDCHCL, KMNCIJPDFPJ, KMHCMCBGFFC
{
	...
	[FormerlySerializedAs("AHCFJLPHLCE")]
	public List<AimTarget> FMLNJGIHJOK;

	[FormerlySerializedAs("CIJJKCCALAD")]
	public DestroyableObjectPlayer FOCIOKMPCAG;

	[FormerlySerializedAs("CJPHFLKKIPD")]
	public bool KPIGIEPMLLC;

	private Material DNBEAILMLLJ;

	[FormerlySerializedAs("IBBJLFJLAFA")]
	...
	[FormerlySerializedAs("ABJFGBPIPIM")]
	public int NAGAHNHAKBJ;

	public CHEIFOOIMEH EHHHBEMKGOE = new CHEIFOOIMEH();

	[FormerlySerializedAs("FBDMDOJKEHK")]
	public AimTarget JEHDCCKBPPD;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private WeaponInventory _003CDNCJBNMAECH_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private SoldierAnimationController _003CGOMKGFGHBMP_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private GameShootableEntity _003CMANBIJGEGFF_003Ek__BackingField;

	[FormerlySerializedAs("LPEJLMHKFLH")]
	public KinematicRagdoll KCGNHJOLNKD;

	[SerializeField]
	private SoldierMeshChanger mMeshChanger;

	[FormerlySerializedAs("NAEFLHAPMBO")]
	public PlayerBot JPMHIGNOPBL;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private bool _003CFLPJGOOPELI_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private Action<KKPHPLOEACG> KCECODPHBLE;

	[FormerlySerializedAs("BDPGDOEGBDC")]
	public float AGOGEJNFGEL;

	private static readonly List<PlayerController> PCPBIGOAFPL = new List<PlayerController>();

	[FormerlySerializedAs("EFAFAPLIDMD")]
	public bool JODNNABEFDH;

	[FormerlySerializedAs("OOCJOKMEDJB")]
	public bool COHFDCGJECK;

	[FormerlySerializedAs("FKIHJANCLKF")]
	...
	[FormerlySerializedAs("MEBKPOBJDPB")]
	public bool JFECKJEDJNJ;

	[FormerlySerializedAs("KHKPEOEGDMI")]
	public float EAOOLOIHKPP = 1f;

	[FormerlySerializedAs("BHEOGIAOOHF")]
	public bool KIIHLIPAGIH;

	[FormerlySerializedAs("HOGCBLALCAH")]
	public bool CDBNKOPKCJB;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private float _003CDADDCEIAJPH_003Ek__BackingField;

	[FormerlySerializedAs("MDHPLJFLAKI")]
	public float OPCGNNFGFOD = 1f;

	[FormerlySerializedAs("MGAJJAPNCBP")]
	...
	[FormerlySerializedAs("ELLDDENCLHG")]
	...
	public WeaponInventory weaponInventory
	{
		...
		private set
		{
			_003CDNCJBNMAECH_003Ek__BackingField = value;
		}
	}
	...
	public SoldierAnimationController soldierAnimator
	{
		...
		private set
		{
			_003CGOMKGFGHBMP_003Ek__BackingField = value;
		}
	}
	...
	public GameShootableEntity gameShootableEntity
	{
		...
		private set
		{
			_003CMANBIJGEGFF_003Ek__BackingField = value;
		}
	}
	...
	public bool clicked
	{
		...
		private set
		{
			_003CFLPJGOOPELI_003Ek__BackingField = value;
		}
	}
	...
	public float weaponReloadCoef
	{
		...
		get
		{
			return _003CDADDCEIAJPH_003Ek__BackingField;
		}
		[CompilerGenerated]
		set
		{
			_003CDADDCEIAJPH_003Ek__BackingField = value;
		}
	}
	...
	public Vector3 position => NGCDDPCAGJB.position;
	...
	public bool isCurrentPlayer => OGMBJPKOPCB == this;
	...
	public override DestroyableObject destroyableObj => FOCIOKMPCAG;
	...
	{
		if (NavMesh.SamplePosition(MPHCNMDIPAI, out var hit, 997f, 1))
		{
			return hit.position;
		}
		return MPHCNMDIPAI;
	...
	{
		int fractionBulletLayer = Singleton<TagsAndLayers>.instance.GetFractionBulletLayer(CIOPAKLHFIL, MNFCGHNFFFF: false);
	...
	public void InitPlayer()
	{
		...
		EFFIOHJHFHI.OFBEAKDOCIO.gameObject.SetActive(value: true);
		EFFIOHJHFHI.DGHPFMPMAFC.Swap(MOMOMPGBCKH: false);
		...
		CamosManager.instance.ApplyVisuals(this, EHHHBEMKGOE.CBBDICBLHMM, useHighRes: true);
	...
	public void PBDOMHCOGKM(byte JMMJHCOKCGG, bool DNDCODMGGEE)
	{
		if (BIEONCCPBIL() == KKPHPLOEACG.HidingBehindShield)
		{
			...
			case 0:
				...
				break;
			case 8:
				GFCDMMGDFJK().ShootFromBazoka(DNDCODMGGEE, DLMKHPAJKDJ: true, 503f);
				break;
			default:
				GFCDMMGDFJK().ShotFromCover(DNDCODMGGEE, 1748f, 720f, DLMKHPAJKDJ: true, (Weapon.IGGFMJAKLGO)JMMJHCOKCGG);
				break;
			}
		}
	...
	public void EIMEBEABDHF(Weapon.IGGFMJAKLGO JMMJHCOKCGG, bool DNDCODMGGEE, Vector3 PLEBANKIBPP)
	{
		...
		if (BIEONCCPBIL() == KKPHPLOEACG.HidingBehindShield)
		{
			...
			case Weapon.IGGFMJAKLGO.Riffle:
				soldierAnimator.GDCFMBNGOBL(!DNDCODMGGEE, PAFEIGKCJPJ: true);
				GFCDMMGDFJK().LookAt(PLEBANKIBPP, 396f);
				break;
			case Weapon.IGGFMJAKLGO.SwatPistol:
				soldierAnimator.ShootFromBazoka(DNDCODMGGEE, DLMKHPAJKDJ: false, 1967f);
				GFCDMMGDFJK().LookAt(PLEBANKIBPP, 1879f);
				break;
			default:
				soldierAnimator.ShotFromCover(DNDCODMGGEE, 1034f, 664f, DLMKHPAJKDJ: true, JMMJHCOKCGG);
		...
		if (playerState == KKPHPLOEACG.HidingBehindShield)
		{
			...
			case Weapon.IGGFMJAKLGO.Tool:
				...
				break;
			default:
				soldierAnimator.ShootStandAdditive(1606f, FEGLHNIALBB: false);
	...
	protected virtual void JFDOGLFMHAE()
	{
		...
		PhotonView[] componentsInChildren = GetComponentsInChildren<PhotonView>(includeInactive: false);
	...
	public static PlayerController FindPlayerWithUserId(string BNFJCGPPAII)
	{
		...
		UnityEngine.Debug.LogError($"Player with playerId {BNFJCGPPAII} doesnt exists ! ");
		return null;
	}
	...
	public void Preview(bool HDBKFKKAJLF)
	{
		...
		EFFIOHJHFHI.SetAllRigidBodiesToKinematic(IDEBKDPMPGM: true);
		EFFIOHJHFHI.OFBEAKDOCIO.SetActive(value: false);
		soldierAnimator.Reset();
	...
	protected virtual void JBGDAOIDBGF()
	{
		...
		if (FHPMANHKAIO != 1361f && Time.time > FHPMANHKAIO + 982f)
		{
			...
			KJMFJFCDEDH.Show("NONE WARCARDS TO ADD FROM CARDPOOL", IDEBKDPMPGM: true, HudObjectIndicator.NPPEJJKFCON.CardIco);
			FHPMANHKAIO = 430f;
		}
		if (KFLMDLBIMHG && Time.time > BJAPCEOFJBJ)
		{
			KFLMDLBIMHG = true;
			KJMFJFCDEDH.Show("globalPlayerLeaderboard", IDEBKDPMPGM: true, HudObjectIndicator.NPPEJJKFCON.CardIco);
		}
		...
		if (Singleton<GameController>.instance.gameIsRunning && FEHCCGEGPLH.isMine && base.isAlive && Singleton<GameController>.instance.GHKPKDPOGHF())
		{
			...
			if (JDNNOGPNJLO == KKPHPLOEACG.Walking && LJPNJJFBMCD != null && NGCDDPCAGJB.position.PlanarDistance(LJPNJJFBMCD.point.transform.position) < 1103f)
			{
				...
				TweenPosition.Begin(base.gameObject, 1893f, NGCDDPCAGJB.position, toPos, useLocal: false);
				EAJMOAFGJJM(KKPHPLOEACG.HidingBehindShield);
				TweenRotation.Begin(base.gameObject, 1232f, LJPNJJFBMCD.point.transform.rotation, useAbsolute: true);
	...
	private void AKHFCLCBPAE(DestroyableObject.CJLNCMMNPBM OHJPPHFEAFI)
	{
		...
		TimeManager.instance.SetupPhysicsTiming(KCGNHJOLNKD: true);
		GFCDMMGDFJK().Stop();
	...
	public void KLFFMPINIPB()
	{
		...
		EFFIOHJHFHI.DGHPFMPMAFC.MAGLHAOFGHL(MOMOMPGBCKH: false);
		soldierAnimator.Reset();
		SelectPrimary();
	...
	{
		if (NavMesh.SamplePosition(MPHCNMDIPAI, out var hit, 10f, 1))
		{
			return hit.position;
		}
		return MPHCNMDIPAI;
	...
	private void FGNOMDJPILO(DestroyableObject OJIHGNJFPFM, DestroyableObject.CJLNCMMNPBM OHJPPHFEAFI)
	{
		...
		{
			KJMFJFCDEDH.GGHDIAFACAH("Card ID \"{0}\" is not pressent in card dictionary.", IDEBKDPMPGM: false, HudObjectIndicator.NPPEJJKFCON.InfoIco);
			FHPMANHKAIO = Time.time;
		}
		if ((UnityEngine.Random.value < AGOGEJNFGEL || OHJPPHFEAFI.HNFNINFCBEJ == this) && !OHJPPHFEAFI.KLOJNPBGFIG && !isImmortal)
		{
	...
	public void ANNFPEBGBAF(float KBJEOEEOEFG)
	{
		...
		KJMFJFCDEDH.GGHDIAFACAH("ID_CONFIRM_EXITINGCOOP_TEXT", IDEBKDPMPGM: false, HudObjectIndicator.NPPEJJKFCON.CardIco);
		KFLMDLBIMHG = true;
	...
	public void PlayShotAnimationNetwork(byte JMMJHCOKCGG, bool DNDCODMGGEE)
	{
		if (playerState == KKPHPLOEACG.HidingBehindShield)
		{
			...
			case 1:
				...
				break;
			case 2:
				soldierAnimator.ShootFromBazoka(DNDCODMGGEE, DLMKHPAJKDJ: true);
				break;
			default:
				soldierAnimator.ShotFromCover(!DNDCODMGGEE, 4f, 0.4f, DLMKHPAJKDJ: true, (Weapon.IGGFMJAKLGO)JMMJHCOKCGG);
				break;
			}
		}
		if (playerState == KKPHPLOEACG.Walking)
	...
	protected override void Awake()
	{
		...
		HFKEGLEPEFD = GetComponentInChildren<SkinnedMeshRenderer>();
		LMIHBNGHEHM = new CKDIHNEIHKL(this);
		JPMHIGNOPBL = (PlayerBot)SingletonSupport.FirstOrDefault((UnityEngine.Object[])GetComponentsInChildren<PlayerBot>());
	}
	...
	public void Uncover(bool DNDCODMGGEE, bool LCPAAFNLHOD)
	{
		...
		if (playerState == KKPHPLOEACG.HidingBehindShield)
		{
			...
			{
				soldierAnimator.ShotFromCover(!DNDCODMGGEE, 4f, 0.25f, DLMKHPAJKDJ: true, DFBBJMKMBNK: true, LCPAAFNLHOD, weaponInventory.currentWeapon.weapon.BEACDIILBEG);
			}
		}
		if (playerState == KKPHPLOEACG.Walking)
		{
	...
	public void MakeBlind(float KBJEOEEOEFG)
	{
		...
		KJMFJFCDEDH.Show("game-ico-blind", IDEBKDPMPGM: true, HudObjectIndicator.NPPEJJKFCON.InfoIco);
		KFLMDLBIMHG = true;
		BJAPCEOFJBJ = Time.time + KBJEOEEOEFG;
	}
	...
	{
		JFGDAKMCJAM.TryGetValue(FDGEHEHCGEE, out var value);
		if (value == null)
		{
	...
	protected override void Update()
	{
		...
		{
			KFLMDLBIMHG = false;
			KJMFJFCDEDH.Show("game-ico-blind", IDEBKDPMPGM: false, HudObjectIndicator.NPPEJJKFCON.InfoIco);
		}
		bool flag = fraction == OGMBJPKOPCB.fraction;
		...
		if (Singleton<GameController>.instance.gameIsRunning && FEHCCGEGPLH.isMine && base.isAlive && Singleton<GameController>.instance.gameIsRunning)
		{
			...
			if (JDNNOGPNJLO == KKPHPLOEACG.Walking && LJPNJJFBMCD != null && NGCDDPCAGJB.position.PlanarDistance(LJPNJJFBMCD.point.transform.position) < 0.05f)
			{
				Vector3 toPos = LJPNJJFBMCD.point.transform.position;
				toPos.y = NGCDDPCAGJB.position.y;
				TweenPosition.Begin(base.gameObject, 0.3f, NGCDDPCAGJB.position, toPos, useLocal: false);
				playerState = KKPHPLOEACG.HidingBehindShield;
	...
	{
		BEIIOAIJMFK().OLHICLNCPNA().gameObject.SetActive(value: false);
	}
	...
	public void KAHNLANBMKE(float KBJEOEEOEFG)
	{
		...
		array[2] = Time.time;
		UnityEngine.Debug.Log(string.Concat(array));
		KJMFJFCDEDH.Show("reached max depth!", IDEBKDPMPGM: false, HudObjectIndicator.NPPEJJKFCON.CardIco);
		KFLMDLBIMHG = true;
		BJAPCEOFJBJ = Time.time + KBJEOEEOEFG;
	}
	...
	public void DMHKCCPPODF()
	{
		...
		base.isAlive = true;
		EFFIOHJHFHI.GDKNBDKAANE(IDEBKDPMPGM: true);
		KCGNHJOLNKD.HCOMKJPBDIO();
		soldierAnimator.Enable();
		soldierAnimator.Reset();
		soldierAnimator.Idle(Weapon.IGGFMJAKLGO.Grenade, IAFJJMFIPCG: true);
		soldierAnimator.lookBack = false;
		CDBNKOPKCJB = false;
		JODNNABEFDH = false;
		FAOHFEPIFGJ = true;
		...
		{
			item2.FMAMBKLFDKH(IDEBKDPMPGM: true);
		}
		foreach (AimTarget item3 in FMLNJGIHJOK)
		{
			item3.gameObject.SetActive(!isCurrentPlayer);
		...
		FOCIOKMPCAG.healthbarColor = ((OGMBJPKOPCB.fraction == fraction) ? Color.green : Color.red);
		EEJMNMHBFEN = 1998f;
		KJMFJFCDEDH.IJPAEHAGPFK(IDEBKDPMPGM: true);
		AGOGEJNFGEL = 1131f;
		isImmortal = true;
		base.isAlive = false;
		...
		JFECKJEDJNJ = false;
		COHFDCGJECK = false;
		LMIHBNGHEHM.BJIAOHPEDAP(IDEBKDPMPGM: true);
	...
	public void BCOGCFNLPCI(byte JMMJHCOKCGG, bool DNDCODMGGEE)
	{
		if (CLFDBFPKCBJ() == KKPHPLOEACG.HidingBehindShield)
		{
			...
			case 0:
				...
				break;
			case 1:
				soldierAnimator.ShootFromBazoka(DNDCODMGGEE, DLMKHPAJKDJ: true, 1693f);
				break;
			default:
				GFCDMMGDFJK().ShotFromCover(!DNDCODMGGEE, 1865f, 1900f, DLMKHPAJKDJ: true, (Weapon.IGGFMJAKLGO)JMMJHCOKCGG);
				break;
			}
		}
		if (playerState == KKPHPLOEACG.Walking)
	...
	public void PlayShotAnimation(Weapon.IGGFMJAKLGO JMMJHCOKCGG, bool DNDCODMGGEE, Vector3 PLEBANKIBPP)
	{
		...
		if (playerState == KKPHPLOEACG.HidingBehindShield)
		{
			...
			case Weapon.IGGFMJAKLGO.Grenade:
				soldierAnimator.ThrowGrenadeFromCover(!DNDCODMGGEE, PAFEIGKCJPJ: true);
			...
			case Weapon.IGGFMJAKLGO.Bazooka:
				...
				break;
			default:
				soldierAnimator.ShotFromCover(!DNDCODMGGEE, 4f, 0.4f, DLMKHPAJKDJ: true, JMMJHCOKCGG);
				soldierAnimator.LookAt(PLEBANKIBPP);
				break;
			}
		}
	...
	public static PlayerController JDFMHAGLBOE(string BNFJCGPPAII)
	{
		...
		UnityEngine.Debug.LogError($"Setting squad icon: {BNFJCGPPAII}");
		return null;
	}
	...
	public static PlayerController GetPlayer(int FDGEHEHCGEE)
	{
		...
		if (value == null)
		{
			UnityEngine.Debug.LogError($"Player with id {FDGEHEHCGEE} doesnt exists ! ");
		}
		return value;
	}
	...
	private void DOGLPIFJNBJ(DestroyableObject OJIHGNJFPFM, DestroyableObject.CJLNCMMNPBM OHJPPHFEAFI)
	{
		...
		{
			KJMFJFCDEDH.GGHDIAFACAH("Managers", IDEBKDPMPGM: true, HudObjectIndicator.NPPEJJKFCON.InfoIco);
			FHPMANHKAIO = Time.time;
		}
		if ((UnityEngine.Random.value < AGOGEJNFGEL || OHJPPHFEAFI.HNFNINFCBEJ == this) && !OHJPPHFEAFI.KLOJNPBGFIG && !isImmortal)
		{
	...
	public void MNLDBAHNIJN(float KBJEOEEOEFG)
	{
		...
		array[2] = Time.time;
		UnityEngine.Debug.Log(string.Concat(array));
		KJMFJFCDEDH.GGHDIAFACAH("Reward", IDEBKDPMPGM: true, HudObjectIndicator.NPPEJJKFCON.CardIco);
		KFLMDLBIMHG = true;
		BJAPCEOFJBJ = Time.time + KBJEOEEOEFG;
	}
	...
	private void MHEIPDIINEH(DestroyableObject.CJLNCMMNPBM OHJPPHFEAFI)
	{
		...
		SetLayerRecursively(KCGNHJOLNKD.gameObject, TagsAndLayers.KFLGCPACECP);
		TimeManager.instance.SetupPhysicsTiming(KCGNHJOLNKD: false);
		soldierAnimator.Stop();
