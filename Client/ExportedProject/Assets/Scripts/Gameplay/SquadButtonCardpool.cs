...
public class SquadButtonCardpool : SquadButton
{
	...
	[FormerlySerializedAs("ELGHJBANPKI")]
	public GameObject IOEFCBCCOJM;

	[FormerlySerializedAs("FIDKIAFOMFB")]
	public UILabel JBAAKANDCMM;

	[FormerlySerializedAs("POMGODDBNKF")]
	public UIPanel POOGFPBBHNE;

	[FormerlySerializedAs("JOAFLONOGLO")]
	public UISprite GJIMEOLAAHJ;

	[FormerlySerializedAs("HFCDFDELJLO")]
	...
	public void DCOBJGDBFAK(bool HMMDCOMIDMI)
	{
		...
		if (MLNJPOJKKHB)
		{
			InstantAnimate(PAPEDLBKBGM: false);
		}
	}
	...
	public void IKDGDDMADEL(bool HMMDCOMIDMI)
	{
		...
		if (MLNJPOJKKHB)
		{
			InstantAnimate(PAPEDLBKBGM: true);
		}
	}
