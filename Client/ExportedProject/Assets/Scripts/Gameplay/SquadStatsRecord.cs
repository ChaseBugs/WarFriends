...
public class SquadStatsRecord : PoolableObject
{
	...
	[FormerlySerializedAs("ALLHCKEGHOJ")]
	public GameObject BHDCJPAHPHD;

	[FormerlySerializedAs("HODFPHKGCME")]
	public UISprite EHDNCFHNLHF;

	[FormerlySerializedAs("BPIGMHNFKHE")]
	...
	public void EDHNPKCJDGM()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.BPEHHBALINP(MBIAKMPDOPG.id, PNDNEMDPFHC: false, CJONGDEPJHC: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public void APPLFGCKAGM(SquadStatsContent.KKEGNGNLNMD PAIAHOCNENA)
	{
		...
		if (flag)
		{
			...
			Singleton<PlayerTexturePool>.instance.CCMGACIMGMF(MBIAKMPDOPG, PNDNEMDPFHC: false, PlayerTexturePool.DFJJOANIJID.Card);
			IAMPPFMEDBL.color = PAIAHOCNENA.JGJCCJDFHEM;
			switch (PAIAHOCNENA.FJLBLLLEELD)
			{
	...
	public void IMNPOBPMLBN(SquadStatsContent.KKEGNGNLNMD PAIAHOCNENA)
	{
		...
		if (flag)
		{
			...
			Singleton<PlayerTexturePool>.instance.APIIPFCGDBO(MBIAKMPDOPG, PNDNEMDPFHC: false, PlayerTexturePool.DFJJOANIJID.Card);
			IAMPPFMEDBL.color = PAIAHOCNENA.JGJCCJDFHEM;
			switch (PAIAHOCNENA.FJLBLLLEELD)
			{
			case SquadStatsContent.KKEGNGNLNMD.AAICHFHEIGB.PlayerInt:
	...
	public void GAFLCMBJLKE(SquadStatsContent.KKEGNGNLNMD PAIAHOCNENA)
	{
		...
		if (flag)
		{
			...
			Singleton<PlayerTexturePool>.instance.MFKFEHJBEPA(MBIAKMPDOPG, PNDNEMDPFHC: true, PlayerTexturePool.DFJJOANIJID.Card);
			IAMPPFMEDBL.color = PAIAHOCNENA.JGJCCJDFHEM;
			switch (PAIAHOCNENA.FJLBLLLEELD)
			{
	...
	public void OAJIMNNLPAD()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.FNHIOAADLFN(MBIAKMPDOPG.id, PNDNEMDPFHC: false);
		}
		MBIAKMPDOPG = null;
	}
	...
	public void PEMKDLDHOFI()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.PIKHCIHPMCE(MBIAKMPDOPG.id, PNDNEMDPFHC: true, CJONGDEPJHC: false, BCHINGHDGEF: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public void ECLLPCMBGNC()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.LBKLINGCPBA(MBIAKMPDOPG.id, PNDNEMDPFHC: false, CJONGDEPJHC: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public void AGJHLCCHNFE()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.FreePlayerTexture(MBIAKMPDOPG.id, PNDNEMDPFHC: false, CJONGDEPJHC: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public void IEGPGPNBDBN()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.LBKLINGCPBA(MBIAKMPDOPG.id, PNDNEMDPFHC: true, CJONGDEPJHC: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public void LPLMOPJGHAP(SquadStatsContent.KKEGNGNLNMD PAIAHOCNENA)
	{
		...
		if (flag)
		{
			...
			Singleton<PlayerTexturePool>.instance.CCMGACIMGMF(MBIAKMPDOPG, PNDNEMDPFHC: false);
			IAMPPFMEDBL.color = PAIAHOCNENA.JGJCCJDFHEM;
			switch (PAIAHOCNENA.FJLBLLLEELD)
			{
			case (SquadStatsContent.KKEGNGNLNMD.AAICHFHEIGB)8:
	...
	public void NJCENLJGFDF()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.BPEHHBALINP(MBIAKMPDOPG.id, PNDNEMDPFHC: false, CJONGDEPJHC: true, BCHINGHDGEF: true);
		}
		MBIAKMPDOPG = null;
	}
	...
	public void PJAFOIPPCNJ()
	{
		...
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.LBKLINGCPBA(MBIAKMPDOPG.id, PNDNEMDPFHC: true, CJONGDEPJHC: true, BCHINGHDGEF: true);
		}
		MBIAKMPDOPG = null;
	}
