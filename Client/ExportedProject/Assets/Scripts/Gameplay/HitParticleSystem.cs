...
{
	[FormerlySerializedAs("NKNOPNBKHIE")]
	public SpawnPool OKKEOCKELAF;

	[FormerlySerializedAs("AKAENDDHFEC")]
	public SpawnPool DANFGIIMPDJ;

	[FormerlySerializedAs("CGKLKLMJBLM")]
	public List<HitParticles> AMLJAOJNKHC;

	[FormerlySerializedAs("PMJJGIHGGPD")]
	public List<HitParticles> AOJADOBAGFA;

	[FormerlySerializedAs("KLCBPKINKGL")]
	...
	protected virtual void FOIKLCECNBL()
	{
		...
		INIKDOLKDDD.gameObject.SetActive(value: true);
	...
	protected virtual void HMMKNCDDDLH()
	{
		...
		INIKDOLKDDD.gameObject.SetActive(value: false);
		NHGEBOKILLJ = new Dictionary<string, int>();
