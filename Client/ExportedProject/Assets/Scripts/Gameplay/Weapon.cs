...
public abstract class Weapon : PoolableObject, TimeScaleIgnorable, KMHCMCBGFFC
{
	...
	[FormerlySerializedAs("FCJJOOMKHBG")]
	public ObscuredFloat JMDLKIAKOIE = 0.5f;

	[FormerlySerializedAs("IHEODOGNPJM")]
	public ObscuredInt FIMMGPLLLCL = 20;

	[FormerlySerializedAs("HEIIGCCOKNE")]
	public ObscuredFloat AMGFJFPKOED = 5f;

	[FormerlySerializedAs("LMGNJEIFPBP")]
	public bool MEFJOGAOKDP = true;

	[FormerlySerializedAs("FKEOIMGIGBH")]
	public bool HOGINLIFMLN;

	[FormerlySerializedAs("EGLMIGGHLBG")]
	public bool NAIKLJKNLAE;

	[FormerlySerializedAs("IKNHKCKCIOM")]
	public bool OLLIJPKAIFC;

	[FormerlySerializedAs("JFMPMODLNNN")]
	public Transform GHPBMCAKMMB;

	[FormerlySerializedAs("JLNKLJLNGII")]
	public ObscuredInt LCKNGBAEFCL;

	[FormerlySerializedAs("LHGCDLBAOOA")]
	...
	[FormerlySerializedAs("NNAKKJKOBLF")]
	...
	[FormerlySerializedAs("LLLJACAOIMI")]
	...
	private PlayerWeapon _003CDMGLJAHHFDF_003Ek__BackingField;
	...
	public PlayerWeapon playerWeapon
	{
		...
		get
		{
			return _003CDMGLJAHHFDF_003Ek__BackingField;
		}
		[CompilerGenerated]
		set
		{
			_003CDMGLJAHHFDF_003Ek__BackingField = value;
		}
	}
	...
	public AmmoSetup ammoSetup => BDNJEAKNGOM ?? (BDNJEAKNGOM = GetComponent<AmmoSetup>());
	...
	public virtual bool hasAmmo => ammoLeft > 0 || HOGINLIFMLN;
	...
	public virtual bool hasLowAmmo => NAIKLJKNLAE && (float)(ammoLeft + ammoLeftInClip) / (float)(int)LCKNGBAEFCL < Singleton<GameVariables>.instance.bonussesDefinitions.GetRow(BonussesDefinitions.rowIds.LowAmmoRatio).FLOATVALUE;
	...
	public float lastShotTime => NOFDHHLCEGM;
	...
	public virtual Ammo Fire(Vector3 IIMDKHJAJGO)
	{
		...
		if (willShoot)
		{
			ammo = MDKABJDCKBI(IIMDKHJAJGO, CAKABHIPCDF: false);
			if (ammo != null)
			{
	...
	public virtual void FireNetworkRPC(Vector3 IIMDKHJAJGO, bool HALDMAOGEOE, byte FJLBLLLEELD)
	{
		...
		MDKABJDCKBI(IIMDKHJAJGO, CAKABHIPCDF: true);
	}
