...
public class DailyMissionBoss : DailyMissionG<DailyMissionBoss.BossMissionConfig>
{
	...
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private float _003CbossSpawnTime_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private float _003CbossWaitForSpawnTime_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private float _003Ctime_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private float _003CbossHealthRatio_003Ek__BackingField;
	...
	public float bossSpawnTime
	{
		...
		get
		{
			return _003CbossSpawnTime_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			_003CbossSpawnTime_003Ek__BackingField = value;
		}
	}

	public float bossWaitForSpawnTime
	{
		[CompilerGenerated]
		get
		{
			return _003CbossWaitForSpawnTime_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			_003CbossWaitForSpawnTime_003Ek__BackingField = value;
		}
	}
	...
	public float bossHealthRatio
	{
		...
		get
		{
			return _003CbossHealthRatio_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			_003CbossHealthRatio_003Ek__BackingField = value;
		}
	}
	...
	public float bossWaitProgress => (bossSpawnTime != bossWaitForSpawnTime) ? ((time - bossWaitForSpawnTime) / (bossSpawnTime - bossWaitForSpawnTime)) : 0f;

	public override string objective => Localization.LocalizeFormat("ID_MISSION_BOSS", base.missionColor, MEJMLNDFDBP.GMIPFLIEOHD(2));
