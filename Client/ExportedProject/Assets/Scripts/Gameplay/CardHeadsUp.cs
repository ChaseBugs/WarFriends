...
public class CardHeadsUp : Card
{
	...
	private void EEBJCEEELBG(AIObject KLHPCPKJGOC)
	{
		if (KLHPCPKJGOC.fraction != GHPGNELIDBM.None)
		{
			...
			if (enemyController != null)
			{
				...
				enemyController.cardIconIndicator.JOGFDHFOOBC("ID_MAXSTAT", BHABHIDDBLH, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
	}
	...
	private void NCNFGBAIIFD(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in list)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.JHJJKEBNGEN() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.JOGFDHFOOBC("WaitForGameEndResponse Try {0} action {1}", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1822f, 1);
		enemyOf.cardIconIndicator.AMFEDOOPGCL("ID_GUI_EQUIPPED", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
		enemyOf = PlayerController.CCPHMCAIJNA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(993f, 0);
		enemyOf.cardIconIndicator.Show("D2", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
	}
	...
	private void MFOABFGCMDF(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in objectsMadeOfPrefab)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.PLPBGNOCCPI() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.FFMLINMFADM("Fuseboxx: virtual goods offer accepted wtih object ", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(821f, 0);
		enemyOf.cardIconIndicator.FCANLIOLJNH("Hide reconnect dialog", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
		enemyOf = PlayerController.CCPHMCAIJNA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(332f, 1);
		enemyOf.cardIconIndicator.BELBLFGCCLJ("PlayerArmyPower", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
	}
	...
	private void JCOEDIKPJBO(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in list)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.PLPBGNOCCPI() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.ODDNDGAAOCH("SpecialOffers", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(598f, 0);
		enemyOf.cardIconIndicator.LOFMDBHAFAO("Name", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
		enemyOf = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1413f, 0);
		enemyOf.cardIconIndicator.AMFEDOOPGCL("game-label-won", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
	}
	...
	private void ONFPHFLLFFO(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in list)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.JHJJKEBNGEN() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.FFMLINMFADM("metalExplosion", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1709f, 0);
		enemyOf.cardIconIndicator.BELBLFGCCLJ("Note:", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
		enemyOf = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1753f, 0);
		enemyOf.cardIconIndicator.Show("AdZone", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	}
	...
	private void HAIABCMEKCP(AIObject KLHPCPKJGOC)
	{
		if (KLHPCPKJGOC.fraction != GHPGNELIDBM.None)
		{
			...
			if (enemyController != null)
			{
				...
				enemyController.cardIconIndicator.AMFEDOOPGCL("+{0}%", BHABHIDDBLH, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
	}
	...
	private void OPLNOCMDCLI(AIObject KLHPCPKJGOC)
	{
		if (KLHPCPKJGOC.fraction != GHPGNELIDBM.None)
		{
			...
			if (enemyController != null)
			{
				...
				enemyController.cardIconIndicator.JOGFDHFOOBC("WENEEDTO", BHABHIDDBLH, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
	}
	...
	private void FMIAGFNDJML(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in list)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.PPHLEDLNGIN() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.EEBNPGOCKFD("ShotFrequencyMaxCannon", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(711f, 1);
		enemyOf.cardIconIndicator.JEDGCOMDEKM("registerAge", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
		enemyOf = PlayerController.CCPHMCAIJNA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1285f, 1);
		enemyOf.cardIconIndicator.ODDNDGAAOCH("KEYBOARD DONNNEEEE, was canceled: ", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	}
	...
	private void IOMBHMBMFFB(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in objectsMadeOfPrefab)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.PLPBGNOCCPI() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.JOGFDHFOOBC("S", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1629f, 0);
		enemyOf.cardIconIndicator.JOGFDHFOOBC("An object of the desired type does not exist: ", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
		enemyOf = PlayerController.CCPHMCAIJNA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(260f, 1);
		enemyOf.cardIconIndicator.JEDGCOMDEKM("()Ljava/lang/String;", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	}
	...
	private void MHPMELBCCMB(AIObject KLHPCPKJGOC)
	{
		if (KLHPCPKJGOC.fraction != GHPGNELIDBM.None)
		{
			...
			if (enemyController != null)
			{
				...
				enemyController.cardIconIndicator.FCANLIOLJNH("DepositedCards", BHABHIDDBLH, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
	}
	...
	private void EDJLCAAKFED(AIObject KLHPCPKJGOC)
	{
		if (KLHPCPKJGOC.fraction != GHPGNELIDBM.None)
		{
			...
			if (enemyController != null)
			{
				...
				enemyController.cardIconIndicator.FFMLINMFADM("NULL WARCARD", BHABHIDDBLH, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
	}
	...
	private void ONPDLDBODGD(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in list)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.PPHLEDLNGIN() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.FFMLINMFADM("Enemy Card {0} {1}", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(934f, 0);
		enemyOf.cardIconIndicator.BELBLFGCCLJ("Updating squad emblem from: {0} to: {1}", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
		enemyOf = PlayerController.CCPHMCAIJNA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(683f, 0);
		enemyOf.cardIconIndicator.JBMCFEMBPKE("RUN ON CHILDREN OF OBJECT \"", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	}
	...
	private void DCHKHMMCIJE(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in objectsMadeOfPrefab)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.isInstantiated && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.JEDGCOMDEKM("CARDS_MIN", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(73f, 1);
		enemyOf.cardIconIndicator.FCANLIOLJNH("ID_TWITTER_GAIN_AGAIN_TEXT", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
		enemyOf = PlayerController.CCPHMCAIJNA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(397f, 1);
		enemyOf.cardIconIndicator.JBMCFEMBPKE("M", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
	}
	...
	private void NECFJNNKBEM(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in list)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.PPHLEDLNGIN() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.AMFEDOOPGCL("No connection.", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1633f, 1);
		enemyOf.cardIconIndicator.BELBLFGCCLJ("RATE APP REMINDER\tVersion: {0}\tShown Times in this version: {1}/{2}", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
		enemyOf = PlayerController.MAJOCMGOFII(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1799f, 0);
		enemyOf.cardIconIndicator.EEBNPGOCKFD("NOT REMOVING FACEBOOK FROM CURRENTPLAYER", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	}
	...
	private void EHDCLHPLIHJ(AIObject KLHPCPKJGOC)
	{
		if (KLHPCPKJGOC.fraction != GHPGNELIDBM.None)
		{
			...
			if (enemyController != null)
			{
				...
				enemyController.cardIconIndicator.FFMLINMFADM("ACD: Phone jail braked", BHABHIDDBLH, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
	}
	...
	private void HHAPEBHKBFI(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in objectsMadeOfPrefab)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.isInstantiated && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.JOGFDHFOOBC("Gui Manager: Starting Messages Coroutine for: ", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1451f, 0);
		enemyOf.cardIconIndicator.AMFEDOOPGCL("ID_YOUNEEDMONEYTOBUY", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
		enemyOf = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(118f, 0);
		enemyOf.cardIconIndicator.FCANLIOLJNH("ID_CONFIRM_INFO", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	}
	...
	private void MOJIGLDKPCC(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in objectsMadeOfPrefab)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.PLPBGNOCCPI() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.JEDGCOMDEKM("DecalManagerData", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1849f, 1);
		enemyOf.cardIconIndicator.JOGFDHFOOBC("ID_TABLE_AP", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
		enemyOf = PlayerController.MAJOCMGOFII(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(972f, 1);
		enemyOf.cardIconIndicator.BELBLFGCCLJ("GameGold", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
	}
	...
	private void KAPGNNMBFKI(AIObject KLHPCPKJGOC)
	{
		if (KLHPCPKJGOC.fraction != GHPGNELIDBM.None)
		{
			...
			if (enemyController != null)
			{
				...
				enemyController.cardIconIndicator.JBMCFEMBPKE("SoldierHP", BHABHIDDBLH, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
	}
	...
	private void DOMKPAADIGJ(AIObject KLHPCPKJGOC)
	{
		if (KLHPCPKJGOC.fraction != GHPGNELIDBM.None)
		{
			...
			if (enemyController != null)
			{
				...
				enemyController.cardIconIndicator.FCANLIOLJNH("Warbucks", BHABHIDDBLH, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
	}
	...
	private void COMCNMOMILO(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in objectsMadeOfPrefab)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.PPHLEDLNGIN() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.FCANLIOLJNH("SciFi", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1865f, 1);
		enemyOf.cardIconIndicator.EEBNPGOCKFD(" S:", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
		enemyOf = PlayerController.CCPHMCAIJNA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(517f, 1);
		enemyOf.cardIconIndicator.FCANLIOLJNH("GO TO OFFER", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	}
	...
	private void KALGLGDOOLN(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in objectsMadeOfPrefab)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.isInstantiated && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.Show("game-card-ico-headsup", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1.5f, 1);
		enemyOf.cardIconIndicator.Show("game-card-ico-headsup", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	...
	private void NMBIPNICPOO(AIObject KLHPCPKJGOC)
	{
		if (KLHPCPKJGOC.fraction != GHPGNELIDBM.None)
		{
			...
			{
				enemyController.ChangeWeightForDestroyablePart(1.5f, 1);
				enemyController.cardIconIndicator.Show("game-card-ico-headsup", BHABHIDDBLH, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
	}
	...
	private void FDIOFGGOOGI(AIObject KLHPCPKJGOC)
	{
		if (KLHPCPKJGOC.fraction != GHPGNELIDBM.None)
		{
			...
			if (enemyController != null)
			{
				...
				enemyController.cardIconIndicator.ODDNDGAAOCH("\t\"TRUE\"", BHABHIDDBLH, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
	}
	...
	private void NPEIIEDKHCC(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in objectsMadeOfPrefab)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.PLPBGNOCCPI() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.ODDNDGAAOCH("Terms: On Age Verification Criteria Not Met ", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1392f, 0);
		enemyOf.cardIconIndicator.FCANLIOLJNH("FacebookId", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
		enemyOf = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(858f, 1);
		enemyOf.cardIconIndicator.BELBLFGCCLJ("Id", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	}
	...
	private void FENJHHAJPEI(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in objectsMadeOfPrefab)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.isInstantiated && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.JBMCFEMBPKE("ID_SALEPERCENTLINE", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(791f, 1);
		enemyOf.cardIconIndicator.JBMCFEMBPKE("rental for unexist unit: {0}", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
		enemyOf = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1658f, 1);
		enemyOf.cardIconIndicator.ODDNDGAAOCH("Prefabs to go through: {0} + {1}\n", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	}
	...
	private void FEIKLKCDCLO(AIObject KLHPCPKJGOC)
	{
		if (KLHPCPKJGOC.fraction != GHPGNELIDBM.None)
		{
			...
			if (enemyController != null)
			{
				...
				enemyController.cardIconIndicator.Show("S", BHABHIDDBLH, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
	}
	...
	private void AKDPAEDPLIJ(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in list)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.PPHLEDLNGIN() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.FFMLINMFADM("ID_READYTIME", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1362f, 1);
		enemyOf.cardIconIndicator.EEBNPGOCKFD("#PETER# Weapon Screen - RIGHT BUTTON - should not happen", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
		enemyOf = PlayerController.CCPHMCAIJNA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(878f, 1);
		enemyOf.cardIconIndicator.ODDNDGAAOCH("There is no definition for card {0}", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	}
	...
	private void AMGNPLCNJMC(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in list)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.PPHLEDLNGIN() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.FCANLIOLJNH("ID_VISUALRARITY4", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(842f, 0);
		enemyOf.cardIconIndicator.FFMLINMFADM("Buy_Upgrade_For_Army_Unit", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
		enemyOf = PlayerController.GetPlayerOld(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(825f, 0);
		enemyOf.cardIconIndicator.FCANLIOLJNH("PlayerLevel", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
	}
	...
	private void BOOIDBMIHDB(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in list)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.PLPBGNOCCPI() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.FCANLIOLJNH("testingideventtierreward", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1998f, 1);
		enemyOf.cardIconIndicator.FFMLINMFADM(" TOTAL MEMORY (GC): ", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
		enemyOf = PlayerController.MAJOCMGOFII(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(323f, 1);
		enemyOf.cardIconIndicator.FFMLINMFADM("Visual", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
	}
	...
	private void FDDGDDHMBCL(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in list)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.JHJJKEBNGEN() && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.JEDGCOMDEKM("Squad", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: false);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1005f, 1);
		enemyOf.cardIconIndicator.LOFMDBHAFAO("WarArenaId with ID {0} not found in DB!", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
		enemyOf = PlayerController.GetPlayerOld(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1748f, 0);
		enemyOf.cardIconIndicator.LOFMDBHAFAO("HELMETS_SANTA", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	}
	...
	private void FALGGBAODEN(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		foreach (PoolableObject item in objectsMadeOfPrefab)
		{
			...
			if (enemyController != null && enemyController.fraction != GHPGNELIDBM.None && enemyController.isInstantiated && enemyController.isAlive)
			{
				...
				enemyController.cardIconIndicator.LOFMDBHAFAO("ID_STAT_WINS", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
			}
		}
		PlayerController enemyOf = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1728f, 1);
		enemyOf.cardIconIndicator.Show("WarFriends richiede l'autorizzazione alla memorizzazione multimediale per scaricare dati fondamentali per il gioco.Accetta la finestra di dialogo di autorizzazione che verrà visualizzata. Non useremo questa autorizzazione per altri scopi.", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
		enemyOf = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		enemyOf.ChangeWeightForDestroyablePart(1174f, 1);
		enemyOf.cardIconIndicator.EEBNPGOCKFD("\t\"TRUE\"", CDMKEBONMKG, CDMKEBONMKG, GBJOJBKCEKN: true);
	}
