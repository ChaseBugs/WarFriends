...
public class CardManager : DatabaseSerializedObjectGeneric<CardManager.CardManagerData>, GDCLLGDCODD
{
	...
	private Card _003CwithdrawingCard_003Ek__BackingField;
	...
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private PlayerWeapon _003CgrenadeSaved_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private PlayerWeapon _003CsavedWeapon_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private float _003CtimeLockWeaponSwitch_003Ek__BackingField;

	private CardBuddy mBuddyCard;

	public List<Card> cardsForGame => Singleton<GameController>.instance.mainController.cardsForGame;

	public Card withdrawingCard
	{
		[CompilerGenerated]
		get
		{
			return _003CwithdrawingCard_003Ek__BackingField;
		}
		[CompilerGenerated]
		set
		{
			_003CwithdrawingCard_003Ek__BackingField = value;
		}
	}
	...
	public static CardManager instance
	{
		get
		{
			mInstance = mInstance ?? ((CardManager)SingletonSupport.FindOrCreate(typeof(CardManager)));
			return mInstance;
		}
	}
	...
	public PlayerWeapon grenadeSaved
	{
		...
		get
		{
			return _003CgrenadeSaved_003Ek__BackingField;
		}
		[CompilerGenerated]
		set
		{
			_003CgrenadeSaved_003Ek__BackingField = value;
		}
	}
	...
	public PlayerWeapon savedWeapon
	{
		...
		get
		{
			return _003CsavedWeapon_003Ek__BackingField;
		}
		[CompilerGenerated]
		set
		{
			_003CsavedWeapon_003Ek__BackingField = value;
		}
	}
	...
	public float timeLockWeaponSwitch
	{
		...
		get
		{
			return _003CtimeLockWeaponSwitch_003Ek__BackingField;
		}
		[CompilerGenerated]
		set
		{
			_003CtimeLockWeaponSwitch_003Ek__BackingField = value;
		}
	}
	...
	public Card AddRandomCard(CardType guaranteedRarity = CardType.Bronze, CardType maxRarity = CardType.Gold)
	{
		...
		UnityEngine.Debug.Log($"Add RANDOM warcard - min {guaranteedRarity} max {maxRarity} - {card.rarity} {card.cardName}");
		card.AddCard();
		return card;
	}
	...
	public Card AddRarityCard(CardType rarity)
	{
		...
		mIdLastGainedCard = card.id;
		card.AddCard();
		UnityEngine.Debug.Log($"Add RARITY {rarity} warcard - {card.cardName}");
		return card;
	}
	...
	{
		UnityEngine.Debug.Log($"CardManager: Added {num}x card {cardId}");
		if (mCardDictionary.ContainsKey(cardId))
		{
		...
		{
			UnityEngine.Debug.LogError($"failed add card {cardId} - not exit?");
		}
	}
	...
	internal Card[] BuyCardPack(NGNPIOOAHEH cardTypePack, int warbucks, int gold, int discount)
	{
		...
		string text2 = $"BUYING CARD PACK: type:{text} -> cardType:{typeCardpack.ToString()}";
	...
	public Card[] GetCardsFromCardpack(CardType typeCardpack)
	{
		...
		UnityEngine.Debug.Log($"According to XLS Configuration -> Constants generating:\n{num2.ToString()} {rarity.ToString()}\n{(num - num2).ToString()} minimaly {guaranteedRarity.ToString()} maximaly {maxRarity.ToString()}");
	...
	private void InitCards()
	{
		...
		foreach (Card card2 in cards)
		{
			...
			if (row == null)
			{
				UnityEngine.Debug.LogError($"There is no definition for card {card2.id}");
			}
			card2.Init(row);
		...
		foreach (Card card in array)
		{
			...
			if (row2 == null)
			{
				UnityEngine.Debug.LogError($"There is no definition for card {card.id}");
			}
		}
	...
	public Card GetSquadCardInstance(string cardId, BuddyCardData buddyCardData = null)
	{
		if (buddyCardData == null)
		{
			...
			UnityEngine.Debug.LogError($"Squad Card ID \"{cardId}\" is not pressent");
			return null;
		}
