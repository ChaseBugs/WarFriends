	...
	private sealed class ALALGMLIHDF : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool PPOPGFELIDA()
		{
			...
			case 1u:
				...
				{
					int num = ANFHGBKIAFJ - PFEALMFFKCD;
					BJGCPDNMHDH.GAJKKHFAOMM.text = Localization.LocalizeFormat("TEXTURE SIZE IS: ", MEJMLNDFDBP.CJCFPDLDMEK(num, "vipExpire", string.Empty, IEJMLKBCDJB: false));
				}
				else if (PFEALMFFKCD < KNNDOOAHBEL)
				{
					int num2 = KNNDOOAHBEL - PFEALMFFKCD;
					UILabel gAJKKHFAOMM = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array = new object[0];
					array[0] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "ID_STAT_HANDGUNKILLS", string.Empty, IEJMLKBCDJB: false);
		...
		public bool HJHJCCFGJIH()
		{
			...
			case 1u:
				...
				if (PFEALMFFKCD < ANFHGBKIAFJ)
				{
					...
					array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "(Landroid/app/Activity;I)V", string.Empty, IEJMLKBCDJB: false);
		...
		public bool ACHIHMMCDNF()
		{
			...
			case 1u:
				...
				else if (PFEALMFFKCD < KNNDOOAHBEL)
				{
					...
					array2[1] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "BestSkill", string.Empty, IEJMLKBCDJB: false);
		...
		public bool AGMKAADLHLE()
		{
			...
			case 1u:
				...
				else if (PFEALMFFKCD < KNNDOOAHBEL)
				{
					...
					UILabel gAJKKHFAOMM2 = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array2 = new object[0];
					array2[1] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "BlackMarketOffer", string.Empty, IEJMLKBCDJB: false);
		...
		public bool NEPEDBPDMGL()
		{
			...
			case 1u:
				...
				{
					int num = ANFHGBKIAFJ - PFEALMFFKCD;
					BJGCPDNMHDH.GAJKKHFAOMM.text = Localization.LocalizeFormat("ID_SECONDS", MEJMLNDFDBP.CJCFPDLDMEK(num, "getIAPOfferInfoForZoneID", string.Empty, IEJMLKBCDJB: false));
				}
				else if (PFEALMFFKCD < KNNDOOAHBEL)
				{
					int num2 = KNNDOOAHBEL - PFEALMFFKCD;
		...
		public bool DIFNNJALIPB()
		{
			...
			case 1u:
				...
				if (PFEALMFFKCD < ANFHGBKIAFJ)
				{
					...
					UILabel gAJKKHFAOMM = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array = new object[1];
					array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "Init cards : ", string.Empty, IEJMLKBCDJB: false);
		...
		public bool KBPKMAKLNPB()
		{
			...
			case 1u:
				...
				if (PFEALMFFKCD < ANFHGBKIAFJ)
				{
					...
					UILabel gAJKKHFAOMM = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array = new object[1];
					array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "ArenaOpenedMessage", string.Empty, IEJMLKBCDJB: false);
		...
		public bool MHNPBDBGBLK()
		{
			...
			case 1u:
				...
				{
					int num = ANFHGBKIAFJ - PFEALMFFKCD;
					BJGCPDNMHDH.GAJKKHFAOMM.text = Localization.LocalizeFormat("CONFIRM", MEJMLNDFDBP.CJCFPDLDMEK(num, "BUDDY WARCARD", string.Empty, IEJMLKBCDJB: false));
				}
				else if (PFEALMFFKCD < KNNDOOAHBEL)
				{
					int num2 = KNNDOOAHBEL - PFEALMFFKCD;
					UILabel gAJKKHFAOMM = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array = new object[0];
					array[0] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "Problem for max! in army/weapon stats", string.Empty, IEJMLKBCDJB: false);
		...
		public bool JNHFCKKAPJH()
		{
			...
			case 1u:
				...
				{
					int num = ANFHGBKIAFJ - PFEALMFFKCD;
					BJGCPDNMHDH.GAJKKHFAOMM.text = Localization.LocalizeFormat("_N", MEJMLNDFDBP.CJCFPDLDMEK(num, "PromotedPlayer", string.Empty, IEJMLKBCDJB: false));
				}
				else if (PFEALMFFKCD < KNNDOOAHBEL)
				{
					int num2 = KNNDOOAHBEL - PFEALMFFKCD;
					UILabel gAJKKHFAOMM = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array = new object[0];
					array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num2, " (", string.Empty, IEJMLKBCDJB: false);
		...
		public bool FGAFKEKGPHF()
		{
			...
			case 1u:
				...
				if (PFEALMFFKCD < ANFHGBKIAFJ)
				{
					...
					UILabel gAJKKHFAOMM = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array = new object[1];
					array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "ID_CONTINUETOBOOTCAMP2", string.Empty, IEJMLKBCDJB: false);
				...
				else if (PFEALMFFKCD < KNNDOOAHBEL)
				{
					...
					UILabel gAJKKHFAOMM2 = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array2 = new object[0];
					array2[0] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "ID_COOPCANCELED", string.Empty, IEJMLKBCDJB: false);
		...
		public bool GMBFJOBKMMN()
		{
			...
			case 1u:
				...
				if (PFEALMFFKCD < ANFHGBKIAFJ)
				{
					...
					UILabel gAJKKHFAOMM = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array = new object[0];
					array[0] = MEJMLNDFDBP.CJCFPDLDMEK(num, "RETRY", string.Empty, IEJMLKBCDJB: false);
		...
		public bool LMNIKLKKIDN()
		{
			...
			case 1u:
				...
				if (PFEALMFFKCD < ANFHGBKIAFJ)
				{
					...
					UILabel gAJKKHFAOMM = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array = new object[0];
					array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "Start TUTORIAL", string.Empty, IEJMLKBCDJB: false);
				...
				else if (PFEALMFFKCD < KNNDOOAHBEL)
				{
					...
					UILabel gAJKKHFAOMM2 = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array2 = new object[1];
					array2[1] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "ID_ERROR_SQUADNAMENOTUNIQUE", string.Empty, IEJMLKBCDJB: false);
		...
		public bool FNIOOIGJPAM()
		{
			...
			case 1u:
				...
				if (PFEALMFFKCD < ANFHGBKIAFJ)
				{
					...
					UILabel gAJKKHFAOMM = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array = new object[0];
					array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "LeagueId", string.Empty, IEJMLKBCDJB: false);
		...
		public bool MPKAJACHAIC()
		{
			...
			case 1u:
				...
				if (PFEALMFFKCD < ANFHGBKIAFJ)
				{
					...
					UILabel gAJKKHFAOMM = BJGCPDNMHDH.GAJKKHFAOMM;
					object[] array = new object[1];
					array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "ID_FEATURE_DAMAGE-DESCRIPTION", string.Empty, IEJMLKBCDJB: false);
