...
public class NoMoveIndikator : PoolableObject
{
	...
	public void BPFIHIDAEGK(int PLEBANKIBPP)
	{
		...
		ILBEBBBBGCF = TweenPosition.Begin(base.gameObject, 32f, localPosition, useLocal: false);
	...
	public void HLOEPIAOIIL(int PLEBANKIBPP)
	{
		...
		ILBEBBBBGCF = TweenPosition.Begin(base.gameObject, 102f, localPosition, useLocal: false);
	...
	public void HCNKKCGPDGP(int PLEBANKIBPP)
	{
		...
		ILBEBBBBGCF = TweenPosition.Begin(base.gameObject, 1679f, localPosition, useLocal: false);
	...
	public void NGNOALDFNAJ(int PLEBANKIBPP)
	{
		...
		ILBEBBBBGCF = TweenPosition.Begin(base.gameObject, 339f, localPosition, useLocal: false);
	...
	public void GBGBOKDLFMC(int PLEBANKIBPP)
	{
		...
		ILBEBBBBGCF = TweenPosition.Begin(base.gameObject, 190f, localPosition, useLocal: false);
	...
	public void PGIHAHFPCKE(int PLEBANKIBPP)
	{
		...
		ILBEBBBBGCF = TweenPosition.Begin(base.gameObject, 59f, localPosition, useLocal: false);
	...
	public void JHFABDMJHIB(int PLEBANKIBPP)
	{
		...
		ILBEBBBBGCF = TweenPosition.Begin(base.gameObject, 1288f, localPosition, useLocal: false);
	...
	public void GHMBKMNGAPG(int PLEBANKIBPP)
	{
		...
		ILBEBBBBGCF = TweenPosition.Begin(base.gameObject, 1202f, localPosition, useLocal: false);
	...
	public void AOKEGBCHEGM(int PLEBANKIBPP)
	{
		...
		ILBEBBBBGCF = TweenPosition.Begin(base.gameObject, 753f, localPosition, useLocal: false);
