...
public abstract class BulletBase : Ammo
{
	...
	[FormerlySerializedAs("HNKGONHGBJL")]
	...
	[FormerlySerializedAs("PMGJFBOKOHD")]
	public bool NOLLONIMIGF;

	protected Transform NGCDDPCAGJB;

	[FormerlySerializedAs("FECDHCANLHG")]
	...
	public void AnimateShot(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO, bool DCGHNDLLFHH)
	{
		...
		if (!GGJPNLDIGGM)
		{
			TweenPosition tweenPosition = TweenPosition.Begin(base.gameObject, num3, OEIICEJPGKI, toPos, useLocal: false);
		...
		{
			TweenPosition tweenPosition2 = TweenPosition.Begin(base.gameObject, num3 * 2f, OEIICEJPGKI, IIMDKHJAJGO + AKPHKLGJBBB, useLocal: false);
	...
	protected virtual void IMCKKOEINGI()
	{
		...
		if (MOLKFKLJIIH.HasValue)
		{
			...
			if (!(MOLKFKLJIIH.Value.collider != null) || !DoDamage(MOLKFKLJIIH.Value.collider.gameObject, MOLKFKLJIIH.Value, AKPHKLGJBBB.normalized * JGGGDHJEIKB, DLKHGAHBIMB: false, out CMNFMDJEOIK))
			{
