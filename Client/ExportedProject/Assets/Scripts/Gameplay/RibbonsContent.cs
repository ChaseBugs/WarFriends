...
public class RibbonsContent : Core_BaseScript
{
	...
	[FormerlySerializedAs("OEGJNCADEPD")]
	...
	private bool MGEIBLLKKGH => Singleton<GameController>.instance.isCampaign || Singleton<GameController>.instance.isCoop;
	...
	public void BANJHACMCMO()
	{
		...
		{
			AKFLKJBMBAJ.AlignToPos(instant: true);
		};
	}

	private void ODCGAABEHKN()
	{
		AKFLKJBMBAJ.AlignToPos(instant: true, UIDraggablePanel.Alingment.BottomRight);
	}
	...
	private void HIBFMIHCPFL(GameObject KHAHPAKDIKE)
	{
		if (Singleton<GameController>.instance.isBattle)
		{
			...
			{
				GuiElementSingle<PlayerProfileDialog>.instance.ShowDialog(NOLLGINLBAB.PKHHKJLGHFM.text, CHOMNKDIJLL, BNNKPKDPLPP: false);
			}
		}
	}
	...
	private void GLOGJCBDEBF(GameObject KHAHPAKDIKE)
	{
		if (Singleton<GameController>.instance.isBattle)
		{
			...
			{
				GuiElementSingle<PlayerProfileDialog>.instance.EGLMNBKMBAM(NOLLGINLBAB.PKHHKJLGHFM.text, CHOMNKDIJLL, BNNKPKDPLPP: false);
			}
		}
	}
	...
	{
		SoundsManager.Instance.PlayButtonClickedSound();
		GuiElementSingle<PlayerProfileDialog>.instance.EGLMNBKMBAM(GameLoginManager.currentPlayer.name, GameLoginManager.currentPlayer.id, BNNKPKDPLPP: false);
	}
	...
	{
		AKFLKJBMBAJ.AlignToPos(instant: false, UIDraggablePanel.Alingment.TopLeft, onePanelDisabledAfterAlign: true);
	}
	...
	private void LBGJIKJLFHE(GameObject KHAHPAKDIKE)
	{
		if (Singleton<GameController>.instance.isBattle)
		{
			...
			{
				GuiElementSingle<PlayerProfileDialog>.instance.CMOEFABLABI(NOLLGINLBAB.PKHHKJLGHFM.text, CHOMNKDIJLL, BNNKPKDPLPP: false);
			}
		}
	}
	...
	{
		AKFLKJBMBAJ.AlignToPos(instant: false);
	}
	...
	{
		AKFLKJBMBAJ.AlignToPos(instant: true, UIDraggablePanel.Alingment.BottomRight, onePanelDisabledAfterAlign: true);
	}
