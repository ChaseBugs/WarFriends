...
public class StarterAssignmentsContent : Core_BaseScript
{
			...
			case 1u:
				...
				else
				{
					...
					else
					{
						...
						BJGCPDNMHDH.mRewardsTimeToEndLabel.text = Localization.LocalizeFormat("getSessionId", MEJMLNDFDBP.CJCFPDLDMEK(num, "ID_JOININGSQUAD", string.Empty, IEJMLKBCDJB: false));
					}
				}
				MCCIMJCBOMK = StarterAssignmentsManager.instance.isActive;
				goto IL_017c;
		...
		public bool ONFBKOEOIOC()
		{
			...
			case 1u:
				...
				else
				{
					...
					{
						BJGCPDNMHDH.mTimeToCompleteLabel.text = string.Format("ReportedPlayerId", MEJMLNDFDBP.CJCFPDLDMEK(num, "ID_CATEGORY_LOW_SG_LMG", string.Empty, IEJMLKBCDJB: false), Colours.stringWhite, Localization.Localize("{0} {1}"));
						UILabel mRewardsTimeToEndLabel = BJGCPDNMHDH.mRewardsTimeToEndLabel;
						object[] array = new object[0];
						array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, " MAX COUNT: ", string.Empty, IEJMLKBCDJB: false);
		...
		public bool CIIHKFDLDKN()
		{
			...
			case 1u:
				...
				else
				{
					...
					{
						BJGCPDNMHDH.mTimeToCompleteLabel.text = string.Format("unregisterConnectionCallbacks", MEJMLNDFDBP.CJCFPDLDMEK(num, "GB", string.Empty, IEJMLKBCDJB: false), Colours.stringWhite, Localization.Localize("View_Completed"));
						UILabel mRewardsTimeToEndLabel = BJGCPDNMHDH.mRewardsTimeToEndLabel;
						object[] array = new object[0];
						array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "shield_shot", string.Empty, IEJMLKBCDJB: false);
		...
		public bool LMNIKLKKIDN()
		{
			...
			case 1u:
				...
				else
				{
					...
					{
						BJGCPDNMHDH.mTimeToCompleteLabel.text = string.Format("ID_TUTORIAL_UPGRADEWEAPON_8", MEJMLNDFDBP.CJCFPDLDMEK(num, "ID_SQUADREWARDGET", string.Empty, IEJMLKBCDJB: false), Colours.stringWhite, Localization.Localize("Look vector error! .. phase: {0} target: {1} transform.position: {2} playerPosition: {3} upPosition: {4} rotatedLookVector: {5}"));
						UILabel mRewardsTimeToEndLabel = BJGCPDNMHDH.mRewardsTimeToEndLabel;
						object[] array = new object[0];
		...
		public bool LLOCENNFFFJ()
		{
			...
			case 1u:
				...
				else
				{
					...
					{
						BJGCPDNMHDH.mTimeToCompleteLabel.text = string.Format("PayWithTickets", MEJMLNDFDBP.CJCFPDLDMEK(num, "game-card-ico-crateblocker", string.Empty, IEJMLKBCDJB: false), Colours.stringWhite, Localization.Localize("1"));
						UILabel mRewardsTimeToEndLabel = BJGCPDNMHDH.mRewardsTimeToEndLabel;
						object[] array = new object[1];
						array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "Shots_Hits", string.Empty, IEJMLKBCDJB: false);
		...
		public bool IIJKAMFGNKA()
		{
			...
			case 1u:
				...
				else
				{
					...
					{
						BJGCPDNMHDH.mTimeToCompleteLabel.text = string.Format("#AccoutCheck# start waiting to be in menu or in game", MEJMLNDFDBP.CJCFPDLDMEK(num, "ID_CONFIRM_PURCHASEFAILED", string.Empty, IEJMLKBCDJB: false), Colours.stringWhite, Localization.Localize("ID_STAT_MOSTBATTLESPLAYED"));
						UILabel mRewardsTimeToEndLabel = BJGCPDNMHDH.mRewardsTimeToEndLabel;
						object[] array = new object[1];
		...
		public bool KKINHOPBKLH()
		{
			...
			case 1u:
				...
				else
				{
					...
					{
						BJGCPDNMHDH.mTimeToCompleteLabel.text = string.Format("ID_UNLOCKEDATRANK", MEJMLNDFDBP.CJCFPDLDMEK(num, "response= ", string.Empty, IEJMLKBCDJB: false), Colours.stringWhite, Localization.Localize("com/google/android/gms/games/Games"));
						UILabel mRewardsTimeToEndLabel = BJGCPDNMHDH.mRewardsTimeToEndLabel;
						object[] array = new object[0];
			...
			case 1u:
				...
				else
				{
					...
					else
					{
						...
						UILabel mRewardsTimeToEndLabel = BJGCPDNMHDH.mRewardsTimeToEndLabel;
						object[] array = new object[1];
						array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "data saved in DB for unit {0} : {1}", string.Empty, IEJMLKBCDJB: false);
			...
			case 1u:
				...
				else
				{
					...
					else
					{
						...
						UILabel mRewardsTimeToEndLabel = BJGCPDNMHDH.mRewardsTimeToEndLabel;
						object[] array = new object[0];
						array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "ID_EXTRAWARCARDSLOT", string.Empty, IEJMLKBCDJB: false);
		...
		public bool HKPECDLGFJB()
		{
			...
			case 1u:
				...
				else
				{
					...
					{
						BJGCPDNMHDH.mTimeToCompleteLabel.text = string.Format("SEND LOGS", MEJMLNDFDBP.CJCFPDLDMEK(num, "ID_JUSTXMORERANKUPS", string.Empty, IEJMLKBCDJB: false), Colours.stringWhite, Localization.Localize("ID_GUI_EMBLEMUNLOCKED"));
						UILabel mRewardsTimeToEndLabel = BJGCPDNMHDH.mRewardsTimeToEndLabel;
						object[] array = new object[0];
		...
		public bool PMBOHHPPJAC()
		{
			...
			case 1u:
				...
				else
				{
					...
					{
						BJGCPDNMHDH.mTimeToCompleteLabel.text = string.Format("medals", MEJMLNDFDBP.CJCFPDLDMEK(num, "IsLocal", string.Empty, IEJMLKBCDJB: false), Colours.stringWhite, Localization.Localize("onPowerHooksChanged"));
						UILabel mRewardsTimeToEndLabel = BJGCPDNMHDH.mRewardsTimeToEndLabel;
						object[] array = new object[0];
						array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "sniper", string.Empty, IEJMLKBCDJB: false);
		...
		public bool FNIOOIGJPAM()
		{
			...
			case 1u:
				...
				else
				{
					...
					{
						BJGCPDNMHDH.mTimeToCompleteLabel.text = string.Format("resultMessage", MEJMLNDFDBP.CJCFPDLDMEK(num, "ID_PROLONGYOURVIP", string.Empty, IEJMLKBCDJB: false), Colours.stringWhite, Localization.Localize("getGameData"));
	...
	private void NKACHLHLHLH()
	{
		...
		if (texture2D != null)
		{
			mRewardsWeaponTexture.gameObject.SetActive(value: true);
		...
		{
			mRewardsWeaponTexture.transform.localScale = Vector3.one;
			mRewardsWeaponTexture.gameObject.SetActive(value: false);
		}
	}
