...
public class CraftCardOverlay : Core_BaseScript
{
	private sealed class KJOODJKNNBI
	{
		...
		internal void JGHLGHMJJDG(UITweener MGDJMGHCAAI)
		{
			...
			{
				BJGCPDNMHDH.MJIIPGJIKCA.Initialize(GFGKDAOBCJC, CardRecord.MKIOKBMLHEO.Withdraw, IDOKGAOAGAL: false);
		...
		internal void EGJBKFPHCNF(UITweener MGDJMGHCAAI)
		{
			...
			if (BJGCPDNMHDH.MJIIPGJIKCA != null)
			{
				...
				TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.MJIIPGJIKCA.gameObject, duration, Vector3.zero, useLocal: false);
		...
		internal void EMKPBGFBPFI(UITweener MGDJMGHCAAI)
		{
			...
			if (BJGCPDNMHDH.MJIIPGJIKCA != null)
			{
				BJGCPDNMHDH.MJIIPGJIKCA.IGPOLIPPGBP(GFGKDAOBCJC, CardRecord.MKIOKBMLHEO.Deposit, IDOKGAOAGAL: false);
				BJGCPDNMHDH.MJIIPGJIKCA.OMOFBFEMGPM();
				BJGCPDNMHDH.MJIIPGJIKCA.NJEAMAHEMHP.enabled = false;
				BJGCPDNMHDH.MJIIPGJIKCA.transform.position = BJGCPDNMHDH.IMIJCJGPIAC.transform.position;
				float duration = 608f;
		...
		internal void LGJCNCHBFDA(UITweener MGDJMGHCAAI)
		{
			...
			if (BJGCPDNMHDH.MJIIPGJIKCA != null)
			{
				BJGCPDNMHDH.MJIIPGJIKCA.IGPOLIPPGBP(GFGKDAOBCJC, CardRecord.MKIOKBMLHEO.Other, IDOKGAOAGAL: false);
				BJGCPDNMHDH.MJIIPGJIKCA.PrepareBuyAnimation();
				BJGCPDNMHDH.MJIIPGJIKCA.NJEAMAHEMHP.enabled = false;
				BJGCPDNMHDH.MJIIPGJIKCA.transform.position = BJGCPDNMHDH.IMIJCJGPIAC.transform.position;
		...
		internal void JDEJHLLIONG(UITweener MGDJMGHCAAI)
		{
			...
			if (BJGCPDNMHDH.MJIIPGJIKCA != null)
			{
				BJGCPDNMHDH.MJIIPGJIKCA.CKOIIPAGCNO(GFGKDAOBCJC, CardRecord.MKIOKBMLHEO.Withdraw, IDOKGAOAGAL: false);
				BJGCPDNMHDH.MJIIPGJIKCA.OMOFBFEMGPM();
				BJGCPDNMHDH.MJIIPGJIKCA.NJEAMAHEMHP.enabled = true;
				BJGCPDNMHDH.MJIIPGJIKCA.transform.position = BJGCPDNMHDH.IMIJCJGPIAC.transform.position;
		...
		internal void JEDCBCPMJGI(UITweener MGDJMGHCAAI)
		{
			...
			if (BJGCPDNMHDH.MJIIPGJIKCA != null)
			{
				BJGCPDNMHDH.MJIIPGJIKCA.IGPOLIPPGBP(GFGKDAOBCJC, CardRecord.MKIOKBMLHEO.CountDownBuddy, IDOKGAOAGAL: false);
				BJGCPDNMHDH.MJIIPGJIKCA.OMOFBFEMGPM();
				BJGCPDNMHDH.MJIIPGJIKCA.NJEAMAHEMHP.enabled = false;
				BJGCPDNMHDH.MJIIPGJIKCA.transform.position = BJGCPDNMHDH.IMIJCJGPIAC.transform.position;
				float duration = 218f;
		...
		internal void HHLMDAKDHFK(UITweener MGDJMGHCAAI)
		{
			...
			if (BJGCPDNMHDH.MJIIPGJIKCA != null)
			{
				BJGCPDNMHDH.MJIIPGJIKCA.IGPOLIPPGBP(GFGKDAOBCJC, CardRecord.MKIOKBMLHEO.MyWarcards, IDOKGAOAGAL: false);
				BJGCPDNMHDH.MJIIPGJIKCA.PrepareBuyAnimation();
				BJGCPDNMHDH.MJIIPGJIKCA.NJEAMAHEMHP.enabled = false;
				BJGCPDNMHDH.MJIIPGJIKCA.transform.position = BJGCPDNMHDH.IMIJCJGPIAC.transform.position;
				float duration = 756f;
		...
		internal void PANKBNOCEAM(UITweener MGDJMGHCAAI)
		{
			...
			if (BJGCPDNMHDH.MJIIPGJIKCA != null)
			{
				BJGCPDNMHDH.MJIIPGJIKCA.CKOIIPAGCNO(GFGKDAOBCJC, CardRecord.MKIOKBMLHEO.CountDownBuddy, IDOKGAOAGAL: false);
				BJGCPDNMHDH.MJIIPGJIKCA.PrepareBuyAnimation();
				BJGCPDNMHDH.MJIIPGJIKCA.NJEAMAHEMHP.enabled = false;
				BJGCPDNMHDH.MJIIPGJIKCA.transform.position = BJGCPDNMHDH.IMIJCJGPIAC.transform.position;
		...
		internal void BBPKDMPNEDG(UITweener MGDJMGHCAAI)
		{
			...
			if (BJGCPDNMHDH.MJIIPGJIKCA != null)
			{
				BJGCPDNMHDH.MJIIPGJIKCA.IGPOLIPPGBP(GFGKDAOBCJC, CardRecord.MKIOKBMLHEO.Lobby, IDOKGAOAGAL: false);
				BJGCPDNMHDH.MJIIPGJIKCA.PrepareBuyAnimation();
				BJGCPDNMHDH.MJIIPGJIKCA.NJEAMAHEMHP.enabled = false;
				BJGCPDNMHDH.MJIIPGJIKCA.transform.position = BJGCPDNMHDH.IMIJCJGPIAC.transform.position;
		...
		internal void BMCMDMKGHHO(UITweener MGDJMGHCAAI)
		{
			...
			if (BJGCPDNMHDH.MJIIPGJIKCA != null)
			{
				BJGCPDNMHDH.MJIIPGJIKCA.CKOIIPAGCNO(GFGKDAOBCJC, CardRecord.MKIOKBMLHEO.MyWarcards, IDOKGAOAGAL: false);
				BJGCPDNMHDH.MJIIPGJIKCA.PrepareBuyAnimation();
				BJGCPDNMHDH.MJIIPGJIKCA.NJEAMAHEMHP.enabled = true;
				BJGCPDNMHDH.MJIIPGJIKCA.transform.position = BJGCPDNMHDH.IMIJCJGPIAC.transform.position;
		...
		internal void JGEMIBIJMJC(UITweener MGDJMGHCAAI)
		{
			...
			if (BJGCPDNMHDH.MJIIPGJIKCA != null)
			{
				BJGCPDNMHDH.MJIIPGJIKCA.Initialize(GFGKDAOBCJC, CardRecord.MKIOKBMLHEO.Lobby, IDOKGAOAGAL: false);
				BJGCPDNMHDH.MJIIPGJIKCA.PrepareBuyAnimation();
				BJGCPDNMHDH.MJIIPGJIKCA.NJEAMAHEMHP.enabled = true;
				BJGCPDNMHDH.MJIIPGJIKCA.transform.position = BJGCPDNMHDH.IMIJCJGPIAC.transform.position;
				float duration = 360f;
		...
		internal void ANAGFGHGPJA(UITweener MGDJMGHCAAI)
		{
			...
			if (BJGCPDNMHDH.MJIIPGJIKCA != null)
			{
				BJGCPDNMHDH.MJIIPGJIKCA.CKOIIPAGCNO(GFGKDAOBCJC, (CardRecord.MKIOKBMLHEO)8, IDOKGAOAGAL: false);
				BJGCPDNMHDH.MJIIPGJIKCA.OMOFBFEMGPM();
				BJGCPDNMHDH.MJIIPGJIKCA.NJEAMAHEMHP.enabled = false;
				BJGCPDNMHDH.MJIIPGJIKCA.transform.position = BJGCPDNMHDH.IMIJCJGPIAC.transform.position;
		...
		internal void OFJDLANHAMD(UITweener MGDJMGHCAAI)
		{
			...
			if (BJGCPDNMHDH.MJIIPGJIKCA != null)
			{
				BJGCPDNMHDH.MJIIPGJIKCA.Initialize(GFGKDAOBCJC, CardRecord.MKIOKBMLHEO.MyWarcards, IDOKGAOAGAL: false);
				BJGCPDNMHDH.MJIIPGJIKCA.PrepareBuyAnimation();
				BJGCPDNMHDH.MJIIPGJIKCA.NJEAMAHEMHP.enabled = false;
				BJGCPDNMHDH.MJIIPGJIKCA.transform.position = BJGCPDNMHDH.IMIJCJGPIAC.transform.position;
				float duration = 533f;
	...
	[FormerlySerializedAs("FEFKMNJEOHB")]
	public GameObject IMIJCJGPIAC;

	[FormerlySerializedAs("HPMHNLOPEOK")]
	...
	public void AFGKJKKLGDN(Card GFGKDAOBCJC)
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(CCFFNAKFPPE.gameObject, 499f, new Vector3(1332f, 1805f, 700f), useLocal: false);
	...
	public void DLELCOCINEH(Card GFGKDAOBCJC)
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(CCFFNAKFPPE.gameObject, 812f, new Vector3(1009f, 1066f, 1581f), useLocal: false);
		tweenPosition.delay = delay;
		tweenPosition.animationCurve = MBAKGBDJABD;
	}
	...
	public void FKHPPIDMJLK(Card GFGKDAOBCJC)
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(CCFFNAKFPPE.gameObject, 1301f, new Vector3(1723f, 969f, 108f), useLocal: false);
		tweenPosition.delay = delay;
		tweenPosition.animationCurve = MBAKGBDJABD;
	}
	...
	public void OKDPCPHJAJH(Card GFGKDAOBCJC)
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(CCFFNAKFPPE.gameObject, 454f, new Vector3(231f, 532f, 742f), useLocal: false);
		tweenPosition.delay = delay;
		tweenPosition.animationCurve = MBAKGBDJABD;
	}
	...
	public void IFFHAHNNKGA(Card GFGKDAOBCJC)
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(CCFFNAKFPPE.gameObject, 1948f, new Vector3(1876f, 550f, 1036f), useLocal: false);
		tweenPosition.delay = delay;
		tweenPosition.animationCurve = MBAKGBDJABD;
	}
	...
	public void OPEGELBFAMN(Card GFGKDAOBCJC)
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(CCFFNAKFPPE.gameObject, 922f, new Vector3(394f, 485f, 1889f), useLocal: false);
		tweenPosition.delay = delay;
		tweenPosition.animationCurve = MBAKGBDJABD;
	}
	...
	public void EKHPBJCCHJB(Card GFGKDAOBCJC)
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(CCFFNAKFPPE.gameObject, 189f, new Vector3(1801f, 1674f, 760f), useLocal: false);
		tweenPosition.delay = delay;
		tweenPosition.animationCurve = MBAKGBDJABD;
	}
	...
	public void DBHFJIAILMJ(Card GFGKDAOBCJC)
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(CCFFNAKFPPE.gameObject, 1002f, new Vector3(975f, 258f, 440f), useLocal: false);
		tweenPosition.delay = delay;
		tweenPosition.animationCurve = MBAKGBDJABD;
	}
