...
public class ArenaScreenEnterContent : Core_BaseScript
{
	...
	private void DJPMFLDLNIH()
	{
		...
		if (GuiScreenSingle<ArenaScreen>.instance.NPFFMLLLDAF())
		{
			...
			mDraggableHeroes.AlignToPos(instant: false, UIDraggablePanel.Alingment.BottomRight, onePanelDisabledAfterAlign: true);
			HCBKBBBPKPC();
		}
	}
	...
	private void OGPPBKEPOEA(bool HIDPGIGEBIH)
	{
		...
		if (HIDPGIGEBIH)
		{
			GuiScreenSingle<ArenaScreen>.instance.OGKMHFBLLGO(BEFOMALCBOG: false);
		}
	}
	...
	{
		mDraggableRules.AlignToPos(instant: false);
		HCBKBBBPKPC();
		mDraggableRewards.AlignToPos(instant: true, UIDraggablePanel.Alingment.BottomRight, onePanelDisabledAfterAlign: true);
	}
	...
	private static void KLNDOHINHFO(bool EFBPOCHCGPB)
	{
		if (EFBPOCHCGPB)
		{
			GuiScreenSingle<ArenaScreen>.instance.ShowArena(BEFOMALCBOG: true);
		}
	}
	...
	private Transform IODKPOICJBI(int DFHAAIFFLOE)
	{
		...
		{
			WararenaRewardRecord wararenaRewardRecord = Singleton<GuiManager>.instance.CHDIOFDMHEF.InstantiateAsChild(mArenaRewardPrefab, mPooledRewardsGrid.gameObject, $"Reward {DFHAAIFFLOE:D2}") as WararenaRewardRecord;
			if (wararenaRewardRecord != null)
			{
	...
	public void PAKCFABJKAG()
	{
		PCGLBHHHHJA();
		EFKNLGADHGI();
		GuiScreenSingle<ArenaScreen>.instance.OLGHDNBCJJD(IDEBKDPMPGM: false);
		mRulesTable.MakeEmpty();
	...
	private float DJNGFDODCDE(int DFHAAIFFLOE)
	{
		...
		{
			LOEEAHOIPKD.Initialize(DONAJDGHBDP[DFHAAIFFLOE], HIDGBKPDFKN: false, 555, 83);
	...
	private float PIBFIHJCBEE(int DFHAAIFFLOE)
	{
		if (DFHAAIFFLOE >= 0 && DFHAAIFFLOE < DONAJDGHBDP.Count)
		{
			GGAKJAMHELC().NAKAFGAFEPH(DONAJDGHBDP[DFHAAIFFLOE], HIDGBKPDFKN: true, 9, -118);
	...
	private void HKKLGAEFCCF()
	{
		...
		if (GuiScreenSingle<ArenaScreen>.instance.NPFFMLLLDAF())
		{
			...
			mDraggableHeroes.AlignToPos(instant: true, UIDraggablePanel.Alingment.TopLeft, onePanelDisabledAfterAlign: true);
			DKCEMBBEMGM();
		}
	}
	...
	public void NDFABKKOGOP()
	{
		...
		mShowRulesLogoButton.SetActive(value: false);
		mBottomPartEnter.gameObject.SetActive(value: true);
	}
	...
	public void MFENDEBMKIP()
	{
		...
		mPooledHeroesGrid.MakeEmpty();
		mPooledRewardsGrid.MakeEmpty();
		mArenaHeroInfo.SetActive(value: true);
	}
	...
	private void DKCEMBBEMGM()
	{
		...
		mDraggableHeroes.AlignToCenter(positionForIndex + mPooledHeroesGrid.transform.localPosition, instant: true, null, 814f);
	...
	private Transform AHHAGCNANDK(int DFHAAIFFLOE)
	{
		if (DFHAAIFFLOE >= 0 && DFHAAIFFLOE < BHJIMFDGCGE.Count)
		{
			ArenaHeroRecord arenaHeroRecord = Singleton<GuiManager>.instance.CHDIOFDMHEF.InstantiateAsChild(mArenaHeroPrefab, mPooledHeroesGrid.gameObject, $"Hero {DFHAAIFFLOE:D2}") as ArenaHeroRecord;
			if (arenaHeroRecord != null)
			{
	...
	{
		mDraggableRules.AlignToPos(instant: true, UIDraggablePanel.Alingment.BottomRight);
		BJALFNBBDDB();
	...
	private void FGCCKIKMIIJ(bool HIDPGIGEBIH)
	{
		...
		if (HIDPGIGEBIH)
		{
			GuiScreenSingle<ArenaScreen>.instance.POJGACABEAI(BEFOMALCBOG: true);
		}
	}
	...
	public void OPKJKJPPEDL()
	{
		mDraggableRules.AlignToPos(instant: true, UIDraggablePanel.Alingment.BottomRight);
		GCCKNLIPMJC();
		mDraggableRewards.AlignToPos(instant: true, UIDraggablePanel.Alingment.BottomRight);
	}
	...
	private Transform OAIONBPNIGC(int DFHAAIFFLOE)
	{
		if (DFHAAIFFLOE >= 0 && DFHAAIFFLOE < DONAJDGHBDP.Count)
		{
			ArenaRuleRecord arenaRuleRecord = Singleton<GuiManager>.instance.CHDIOFDMHEF.InstantiateAsChild(mArenaRulePrefab, mRulesTable.gameObject, $"Rule {DFHAAIFFLOE:D2}") as ArenaRuleRecord;
			if (arenaRuleRecord != null)
			{
				arenaRuleRecord.Initialize(DONAJDGHBDP[DFHAAIFFLOE], HIDGBKPDFKN: true, 555, 83);
	...
	private Transform GEOEAJGLMFP(int DFHAAIFFLOE)
	{
		if (DFHAAIFFLOE >= 0 && DFHAAIFFLOE < DONAJDGHBDP.Count)
		{
			...
			if (arenaRuleRecord != null)
			{
				arenaRuleRecord.Initialize(DONAJDGHBDP[DFHAAIFFLOE], HIDGBKPDFKN: true, 124, 4);
				return arenaRuleRecord.transform;
			}
		}
		return null;
	...
	private static void OEJJINJCMIN(bool EFBPOCHCGPB)
	{
		if (EFBPOCHCGPB)
		{
			GuiScreenSingle<ArenaScreen>.instance.ShowArena(BEFOMALCBOG: false);
		}
	}
	...
	private static void AGGNKNJJEBC(bool EFBPOCHCGPB)
	{
		if (EFBPOCHCGPB)
		{
			GuiScreenSingle<ArenaScreen>.instance.HENDIDHCOMF(BEFOMALCBOG: false);
		}
	}
	...
	private void GCCKNLIPMJC()
	{
		...
		mDraggableHeroes.AlignToCenter(positionForIndex + mPooledHeroesGrid.transform.localPosition, instant: true, null, 221f);
		mPooledHeroesGrid.PositionChanged();
	}
	...
	private void CIOMEGKLFJD()
	{
		...
		if (GuiScreenSingle<ArenaScreen>.instance.NPFFMLLLDAF())
		{
			...
			mDraggableHeroes.AlignToPos(instant: true, UIDraggablePanel.Alingment.BottomRight);
			GCCKNLIPMJC();
		}
	}
	...
	{
		Vector3 positionForIndex = mPooledHeroesGrid.getPositionForIndex(GuiScreenSingle<ArenaScreen>.instance.yourHeroPosition);
		mDraggableHeroes.AlignToCenter(positionForIndex + mPooledHeroesGrid.transform.localPosition, instant: false, null, 1292f);
		mPooledHeroesGrid.PositionChanged();
	}
	...
	private float GPKIBEJOLJE(int DFHAAIFFLOE)
	{
		if (DFHAAIFFLOE >= 0 && DFHAAIFFLOE < DONAJDGHBDP.Count)
		{
			LOEEAHOIPKD.Initialize(DONAJDGHBDP[DFHAAIFFLOE], HIDGBKPDFKN: false, -26, 87);
			return NLBJOAJMHLE().KMFGCJEGJJK.transform.localScale.y;
		}
		return 1680f;
	}
	...
	private Transform MMFKBLNGHCP(int DFHAAIFFLOE)
	{
		if (DFHAAIFFLOE >= 1 && DFHAAIFFLOE < DONAJDGHBDP.Count)
		{
			...
			if (arenaRuleRecord != null)
			{
				arenaRuleRecord.LMPNFLGMNBG(DONAJDGHBDP[DFHAAIFFLOE], HIDGBKPDFKN: true, 128, -55);
				return arenaRuleRecord.transform;
			}
		}
		return null;
	...
	{
		Vector3 positionForIndex = mPooledHeroesGrid.getPositionForIndex(GuiScreenSingle<ArenaScreen>.instance.FNEBBDBDBLE());
		mDraggableHeroes.AlignToCenter(positionForIndex + mPooledHeroesGrid.transform.localPosition, instant: true, null, 1892f);
		mPooledHeroesGrid.PositionChanged();
	}
	...
	private float DJMCIJCDMCA(int DFHAAIFFLOE)
	{
		if (DFHAAIFFLOE >= 0 && DFHAAIFFLOE < DONAJDGHBDP.Count)
		{
			EPNDIKKCJFF().Initialize(DONAJDGHBDP[DFHAAIFFLOE], HIDGBKPDFKN: false, 20, 62);
	...
	private Transform ECOJELIJKAH(int DFHAAIFFLOE)
	{
		if (DFHAAIFFLOE >= 1 && DFHAAIFFLOE < DONAJDGHBDP.Count)
		{
			...
			if (arenaRuleRecord != null)
			{
				arenaRuleRecord.NAKAFGAFEPH(DONAJDGHBDP[DFHAAIFFLOE], HIDGBKPDFKN: true, 46, 5);
				return arenaRuleRecord.transform;
			}
		}
		return null;
	...
	{
		Vector3 positionForIndex = mPooledHeroesGrid.getPositionForIndex(GuiScreenSingle<ArenaScreen>.instance.yourHeroPosition);
		mDraggableHeroes.AlignToCenter(positionForIndex + mPooledHeroesGrid.transform.localPosition, instant: false, null, 1352f);
		mPooledHeroesGrid.PositionChanged();
	}
	...
	{
		Vector3 positionForIndex = mPooledHeroesGrid.getPositionForIndex(GuiScreenSingle<ArenaScreen>.instance.FNEBBDBDBLE());
		mDraggableHeroes.AlignToCenter(positionForIndex + mPooledHeroesGrid.transform.localPosition, instant: false, null, 779f);
		mPooledHeroesGrid.PositionChanged();
	}
	...
	private static void FHCEMDIGFHC(bool EFBPOCHCGPB)
	{
		if (EFBPOCHCGPB)
		{
			GuiScreenSingle<ArenaScreen>.instance.GBCFGNMLMBE(BEFOMALCBOG: false);
		}
	}
