...
{
	public override float shotDamage => Convert.ToSingle(LIEFNEPEIJO.GetValue(MGAGEKAAJOL.boughtIndex, "damage")) * base.weaponFeature.damageCoef;
	...
	public virtual List<Tuple<string, float[]>> NINIIBGAJCN(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_READYTIME", "response for {0}", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "v", "Level", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_ELITEPACK_WEAPONDESCRIPTION", "Fuseboxx Config Value = ", base.weaponFeature.clipSizeCoef));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Master", "ID_DAILYMISSIONSUNLOCKED", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Total_Battles", "ID_CONFIRM_ERROR", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "123456789123456", "()Lcom/google/android/gms/games/stats/PlayerStats;", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_YOUNEEDMONEYTOUPGRADEELITE", "Action ", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Gold", "ID_CONFIRM_GAMELAREADYENDED", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ShotFrequencyMax", "ID_SLOTUPGRADE_ROF", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	public virtual List<Tuple<string, float[]>> EKBIICIJIBG(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_CONFIRM_SQUADEVENT_TEXT", "{0}-{1}", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Google2u.DBUpgradeSlotsShotgunner", "DPS", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Omitting object: ", "N", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	public virtual List<Tuple<string, float[]>> LEGEPDLIOLJ(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_PURCHASED", "Sessions", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	public virtual List<Tuple<string, float[]>> EMIPCHOMJGF(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Dictionary filled and contains {0} ids", "Spend_Warbucks_On_Army", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "special", "ID_GETFORREWARD2", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_MEMBERSHIP_HINT3", "LevelExperience", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "com/google/android/gms/games/Games", "ID_GOLD", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_GETFORNUMBERONE2", "ID_STARTERASSIGNMENTSEXPIRED", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "KickedPlayerId", "[^\\d]", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "com/google/android/gms/common/ConnectionResult", "lastWeeksPlayerLeague", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, ")", "BeginnersLeague", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
	...
	public virtual List<Tuple<string, float[]>> CFPIJLPBPIJ(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Assignment: DestroyEnemyCratesAssignment Constructor", "PlayerName", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Pack: Gold Cards ", "ID_WAITINGFORFRIENDCARDS", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "getAverageSessionLength", "menu-assignments-type-deploy", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Can not find boss", "NetworkReInstantiate", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "WENEEDTO", "Action ", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "NO", "RegisterBirthday()", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "DailyMissionsCompletionRewardCards", "ID_ISALREADYMEMBEROFANOTHERSQUAD", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_STARTERASSIGNMENT5", "U", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_CONFIRM_EXITINGMATCH", "Still waiting for server\nBe patient :-)", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, " OK!", "DOWNLOAD", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_MINUTES", "ID_READYTIME", base.weaponFeature.clipSizeCoef));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_PLAYERLEAGUEENDSIN", "squadCreationsCnt", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Yes_Clicked", "Clearing Waitlist cache...", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_WARNING_CANTSENDINVITE_TEXT", "getCustomProfileString", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Cancel - Disconnect, clicked in dialog !!!", "Number", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
	...
	public virtual List<Tuple<string, float[]>> JKFJCGGJJKC(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "kr", "Arena Lives: ", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_SECONDWEAPONDAMAGE", "Bad player statistics, data= ", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "menu-weaponstats-criticalchance", "ID_CONFIRM_SERVERCOULDNOTCOMPLETED", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_NA", "ObtainedCards", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Level", "ID_GETFORNUMBERONE1", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "OnApplicationResumed", "lapsed_player_2", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "primary", "LeagueId", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "WarbucksAdded", "ID_HOURS", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "discount", "ID_TUTORIAL_KILLING_SCOPE_DOWN", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "shootAdditive", "ID_RANK", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, " Standard", "ID_JOINSQUADDESCRIPTION3", base.weaponFeature.clipSizeCoef));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "damage", "Server error during ", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ios", "battleID", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "About to show Name Change Reminder", "PlayerName", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	public virtual List<Tuple<string, float[]>> LJKGEOMLMFM(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "game-card-ico-bulletsponge-full", "menu-button-promote-ico", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Dictionary created/cleared.\n", "You probably assigned bad type of AmmoSetup to gun", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> JIFPIHMLAGA(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "PNManager: Local Notification extraData='{0}'", "^[0-9]*-", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "On Debug Add Scraps Request: ", "null", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, " succesfully joined squad ", "/AssetBundles/", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "no AI object for: ", "ID_CONFIRM_FORFEITARENA", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "{0} {1}/{2} {3}", "Wrong_Category", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> EIIPDLCPJCB(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Total_Assignment_Completed", "ID_CLOSESIN", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_UPGRADE", " {0} - {1} in {2}\n", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "#PETER# Weapon Screen - LEFT BUTTON - weapon state: SLOT DELIVERED\t\tbutton type: ACTIVATE", "Buy_Lootboxes", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "getConnectionResult", "ID_CONFIRM_NOSUCHPACK", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "WarCards", "withAttribute5", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "SoldierBehaviourBuddy ChangeEquippedWeapons: Prim: {0} Sec: {1}", "ID_SQUADSIZEINCREASEATSQUADRANK", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "AssignmentIndex", "#PETER# Weapon Screen - RIGHT BUTTON - unit state: UNIT DELIVERING\t\tbutton type: INSTANT UNIT DELIVER", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "{0} {1}", "PromotedPlayer", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Wrong_Weapon", "\"", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "lastWeeksPlayerLeague", "ID_MEMBERSHIP_HINT5TRIAL", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "DogTagLastUpdate", "ID_CONFIRM_SERVERDIDNTRESPONDAFTER", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Click on the ground to spawn the selected effect", "Play_Card_Tutorial", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "RewardMessage", "ID_SEARCHRESULTSFOR", base.weaponFeature.clipSizeCoef));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, " ", "ID_UNITMAXUPGRADED", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> NJFKIKMLIJO(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Gold Spent ", "ApplyVisuals Error, indices are null!", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "LootboxType", "HeroicMissionsCompletionRewardScraps", base.weaponFeature.attackCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, ")", "Ranks/", base.weaponFeature.clipSizeCoef, CLFOOLKGCEO: true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "/AssetBundles/", "ID_DEMOTEDTODIVISION", base.weaponFeature.reloadCoef, CLFOOLKGCEO: true));
		return list;
	}
