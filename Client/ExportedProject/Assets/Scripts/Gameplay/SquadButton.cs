...
public class SquadButton : Core_BaseScript
{
	...
	[FormerlySerializedAs("KEIMGPMBION")]
	...
	protected virtual float KBLPGHGPLJC => Mathf.Max(PDGCOBOCPBH, KLMFIBIIALC.relativeSize.x * KLMFIBIIALC.transform.localScale.x);
