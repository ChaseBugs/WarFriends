...
public class BlackmarketDialog : GuiElementSingle<BlackmarketDialog>, PAIIOKBBHBC
{
	...
	private void DOAEFBGCLJB()
	{
		...
		array[1] = MEJMLNDFDBP.CJCFPDLDMEK(num, "ID_CONFIRM_NOSQUADACTIONS_TITLE", string.Empty, IEJMLKBCDJB: false);
	...
	private void ALIHIIADFBE()
	{
		...
		array[1] = Colours.stringAzureBlackmarket;
		array[0] = MEJMLNDFDBP.CJCFPDLDMEK(num, "N", string.Empty, IEJMLKBCDJB: false);
	...
	private void FPOBABDCIGM()
	{
		...
		array[1] = Colours.stringAzureBlackmarket;
		array[0] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "com.google.android.apps.youtube.gaming", string.Empty, IEJMLKBCDJB: false);
	...
	private void MHHJBHOHLIG()
	{
		...
		int num2 = CGAKMJBHKKG - num;
		mTimeLabel.text = Localization.LocalizeFormat("ID_UNITELITEPERKFULLYTRAINED", Colours.stringAzureBlackmarket, MEJMLNDFDBP.CJCFPDLDMEK(num2, "ID_TUTORIAL_OVERTIME", string.Empty, IEJMLKBCDJB: false), null, null, null, null, null, null);
		if (num2 <= 1)
		{
			HideDialog();
			CounterManager counterManager = Singleton<CounterManager>.instance;
	...
	private void JCKLCEDFIIC()
	{
		...
		object[] array = new object[5];
		array[0] = Colours.stringAzureBlackmarket;
		array[0] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "Beanstalk: Message read", string.Empty, IEJMLKBCDJB: false);
	...
	private void CIBIPFJNACC()
	{
		...
		object[] array = new object[8];
		array[0] = Colours.stringAzureBlackmarket;
		array[0] = MEJMLNDFDBP.CJCFPDLDMEK(num, "MissionData", string.Empty, IEJMLKBCDJB: false);
	...
	private void OBCMKNBIKHI()
	{
		...
		object[] array = new object[5];
		array[1] = Colours.stringAzureBlackmarket;
		array[0] = MEJMLNDFDBP.CJCFPDLDMEK(num2, "error in count of army", string.Empty, IEJMLKBCDJB: false);
