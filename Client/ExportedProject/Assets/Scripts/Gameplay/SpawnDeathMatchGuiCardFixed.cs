...
public class SpawnDeathMatchGuiCardFixed : DeathMatchGuiCard
{
	...
	{
		TweenPosition.Begin(base.gameObject, 938f, DDBBFBHJCOO - new Vector3(1461f, 1169f, 1709f), useLocal: false);
	}
	...
	public virtual void BIIHCAEKCOD(SpawningManagerDeathMatch.ArmyUnitDefinition OIJBDFANMCC, bool PDPDGCNHCFN = false)
	{
		...
		{
			HLOJHFCMMNJ(FEGLHNIALBB: true);
			TweenPosition.Begin(base.gameObject, 585f, DDBBFBHJCOO, useLocal: false);
		}
	}
	...
	{
		TweenPosition.Begin(base.gameObject, 1999f, DDBBFBHJCOO - new Vector3(1003f, 346f, 464f), useLocal: false);
	}
	...
	{
		TweenPosition.Begin(base.gameObject, 1936f, DDBBFBHJCOO - new Vector3(1366f, 1095f, 1241f), useLocal: false);
	}

	protected virtual void NDKEOFIJLMA()
	{
		TweenPosition.Begin(base.gameObject, 218f, DDBBFBHJCOO - new Vector3(821f, 1218f, 1330f), useLocal: false);
	}

	protected virtual void IAAIJCKEDPA()
	{
		TweenPosition.Begin(base.gameObject, 490f, DDBBFBHJCOO - new Vector3(314f, 988f, 1594f), useLocal: false);
	}
	...
	public virtual void ILFJPOOMFDO(SpawningManagerDeathMatch.ArmyUnitDefinition OIJBDFANMCC, bool PDPDGCNHCFN = false)
	{
		...
		if (OIJBDFANMCC != null)
		{
			HLOJHFCMMNJ(FEGLHNIALBB: false);
			TweenAlpha.Begin(CFKLKCHACOK.gameObject, 1829f, 1866f).style = UITweener.Style.Once;
			TweenPosition.Begin(base.gameObject, (!PDPDGCNHCFN) ? 732f : 155f, DDBBFBHJCOO, useLocal: false);
		}
		else
		{
			HLOJHFCMMNJ(FEGLHNIALBB: false);
			TweenPosition.Begin(base.gameObject, 237f, DDBBFBHJCOO, useLocal: false);
		}
	}
	...
	{
		base.DIBLFOPCCPL(OIJBDFANMCC, PDPDGCNHCFN: true);
		if (OIJBDFANMCC != null)
		{
			NDNDFHGFDAO(FEGLHNIALBB: false);
		...
		{
			PLHCFECODNM(FEGLHNIALBB: true);
			TweenPosition.Begin(base.gameObject, 1941f, DDBBFBHJCOO, useLocal: false);
		}
	}

	public virtual void AAHJOEILKNG(SpawningManagerDeathMatch.ArmyUnitDefinition OIJBDFANMCC, bool PDPDGCNHCFN = false)
	{
		base.LEJEDFACEGP(OIJBDFANMCC, PDPDGCNHCFN: true);
		if (OIJBDFANMCC != null)
		{
			PLHCFECODNM(FEGLHNIALBB: false);
			TweenAlpha.Begin(CFKLKCHACOK.gameObject, 744f, 1869f).style = UITweener.Style.Once;
			TweenPosition.Begin(base.gameObject, (!PDPDGCNHCFN) ? 1424f : 1724f, DDBBFBHJCOO, useLocal: false);
		}
		else
		{
			HLOJHFCMMNJ(FEGLHNIALBB: false);
			TweenPosition.Begin(base.gameObject, 950f, DDBBFBHJCOO, useLocal: false);
		}
	}
	...
	{
		TweenPosition.Begin(base.gameObject, 663f, DDBBFBHJCOO - new Vector3(911f, 1472f, 1772f), useLocal: false);
	}
	...
	{
		TweenPosition.Begin(base.gameObject, 796f, DDBBFBHJCOO - new Vector3(1666f, 1257f, 1937f), useLocal: false);
	}
	...
	public virtual void FJILILFMPIF(SpawningManagerDeathMatch.ArmyUnitDefinition OIJBDFANMCC, bool PDPDGCNHCFN = false)
	{
		...
		if (OIJBDFANMCC != null)
		{
			...
			TweenPosition.Begin(base.gameObject, (!PDPDGCNHCFN) ? 636f : 1211f, DDBBFBHJCOO, useLocal: false);
		}
		else
		{
			HLOJHFCMMNJ(FEGLHNIALBB: true);
	...
	public virtual void PEBHGOMEKME(SpawningManagerDeathMatch.ArmyUnitDefinition OIJBDFANMCC, bool PDPDGCNHCFN = false)
	{
		...
		if (OIJBDFANMCC != null)
		{
			...
			TweenPosition.Begin(base.gameObject, (!PDPDGCNHCFN) ? 1204f : 1894f, DDBBFBHJCOO, useLocal: false);
		}
		else
		{
			HLOJHFCMMNJ(FEGLHNIALBB: false);
			TweenPosition.Begin(base.gameObject, 1224f, DDBBFBHJCOO, useLocal: false);
		}
	}

	protected virtual void NNGLNPCENFH()
	{
		TweenPosition.Begin(base.gameObject, 1700f, DDBBFBHJCOO - new Vector3(853f, 134f, 88f), useLocal: false);
	}
	...
	public virtual void BBOHJOFMLDI(SpawningManagerDeathMatch.ArmyUnitDefinition OIJBDFANMCC, bool PDPDGCNHCFN = false)
	{
		...
		{
			PLHCFECODNM(FEGLHNIALBB: true);
			TweenPosition.Begin(base.gameObject, 681f, DDBBFBHJCOO, useLocal: false);
		}
	}
	...
	{
		TweenPosition.Begin(base.gameObject, 653f, DDBBFBHJCOO - new Vector3(596f, 1680f, 1074f), useLocal: false);
	}
	...
	{
		TweenPosition.Begin(base.gameObject, 1150f, DDBBFBHJCOO - new Vector3(1111f, 240f, 1275f), useLocal: false);
	}
