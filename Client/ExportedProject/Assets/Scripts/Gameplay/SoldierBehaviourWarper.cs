...
public class SoldierBehaviourWarper : SoldierBehaviourRusher<SoldierBehaviourDefinititonFlamethrower>
{
	...
	[FormerlySerializedAs("DOOMPGELGIL")]
	...
	public override void DestroyBehaviour()
	{
		...
		if (LCJJDKHALGI != null)
		{
			LCJJDKHALGI.ODGFIDEAMAD.gameObject.SetActive(value: false);
			LCJJDKHALGI.CDGCLLJKCBO.gameObject.SetActive(value: false);
		}
		if (LMNPOINIJBD != null)
		{
	...
	public virtual void GODEFCHEEJG()
	{
		...
		if (LCJJDKHALGI != null)
		{
			LCJJDKHALGI.ODGFIDEAMAD.gameObject.SetActive(value: true);
			LCJJDKHALGI.CDGCLLJKCBO.gameObject.SetActive(value: true);
		}
		if (LMNPOINIJBD != null)
		{
	...
	public void ChangeToNormalMat()
	{
		...
		KHKAAGCIJPO.gameObject.SetActive(value: true);
	...
	public void ChangeToTransparent()
	{
		...
		KHKAAGCIJPO.gameObject.SetActive(value: false);
		if (LCJJDKHALGI != null)
		{
			LCJJDKHALGI.ODGFIDEAMAD.gameObject.SetActive(value: true);
			LCJJDKHALGI.CDGCLLJKCBO.gameObject.SetActive(value: true);
