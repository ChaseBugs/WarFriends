...
public class EndScreen : GuiScreenSingle<EndScreen>
{
	...
	[Header("Left Content")]
	[FormerlySerializedAs("BCILANAOCCI")]
	public GameObject EBJKNDMODOP;

	[FormerlySerializedAs("EOGEEAIEIJF")]
	public List<EndScreenButton> PJCHHCCCCFB;

	[Header("Center Content")]
	[FormerlySerializedAs("DECDCDIPIEK")]
	public List<GameObject> BMANEHNHPGC;

	[FormerlySerializedAs("HNMMPMDJCOK")]
	public ResultsContent KNOAGNHKDIM;

	[FormerlySerializedAs("MDBEFDOOIGJ")]
	...
	[FormerlySerializedAs("HEILPAPPHKJ")]
	public CardsContent HGPGKHLOHEF;

	[FormerlySerializedAs("HBMCNMFAELD")]
	public RibbonsContent NDJCNHDBJMM;

	[Header("Bottom Content")]
	[FormerlySerializedAs("JECCCGOBDGL")]
	public ButtonsContent MPLELHEKGHO;

	[FormerlySerializedAs("OHBBOLNDNFD")]
	...
	[Header("Debug")]
	[FormerlySerializedAs("IIIIFELBHPI")]
	public GameObject FFGAOOAICAH;

	[FormerlySerializedAs("AJPKLKLPHCK")]
	public UIButton DIKOLBOGDIC;

	[FormerlySerializedAs("AFCAPAKCGLE")]
	public UIButton LEFEKKMGKGB;

	[FormerlySerializedAs("GNKBFGNGJGK")]
	public readonly float EOPGDDCOKAM = 0.8f;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private List<CCNAEIGGMNK> _003CBBIJNDANGKP_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private bool _003CJBHIAPLHHGK_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private bool _003CEIONENKINEC_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private bool _003CHGFKHFIPOMC_003Ek__BackingField;

	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[CompilerGenerated]
	private bool _003CHFGAMBFLHKO_003Ek__BackingField;
	...
	public List<CCNAEIGGMNK> videoRewardLootbox
	{
		[CompilerGenerated]
		get
		{
		...
		set
		{
			_003CBBIJNDANGKP_003Ek__BackingField = value;
		}
	}
	...
	public bool shouldGetLootboxForAd
	{
		...
		get
		{
			return _003CJBHIAPLHHGK_003Ek__BackingField;
		}
		[CompilerGenerated]
		set
		{
			_003CJBHIAPLHHGK_003Ek__BackingField = value;
		}
	}
	...
	public bool isEndScreenLootboxAnimations
	{
		...
		set
		{
			_003CEIONENKINEC_003Ek__BackingField = value;
		}
	}
	...
	public bool isEnteredBeginnersLeague
	{
		...
		set
		{
			_003CHGFKHFIPOMC_003Ek__BackingField = value;
		}
	}

	public bool OILKNBFJLHE
	{
		[CompilerGenerated]
		private get
		{
			return _003CHFGAMBFLHKO_003Ek__BackingField;
		}
		[CompilerGenerated]
		set
		{
			_003CHFGAMBFLHKO_003Ek__BackingField = value;
		}
	}

	public bool isSinglePlayer => Singleton<GameController>.instance.isTutorial || Singleton<GameController>.instance.isMission;

	public bool canShowLvlUp => (isSinglePlayer && KLGINBGMGDB.showLevelUp) || (!isSinglePlayer && KNOAGNHKDIM.showLevelUp);

	public bool buttonsEnabled => !canShowLvlUp && !JEGNECDPAFK.gameObject.activeSelf;

	public override bool dialogsEnabled => base.dialogsEnabled && !OILKNBFJLHE;
	...
	private void OPAEGKCLGFK(GameObject KHAHPAKDIKE)
	{
		if (!JEGNECDPAFK.gameObject.activeSelf && FIMOPHPNBNM != MPJAFCCIOEO.Results)
		{
			...
			DHNNCMHLOEM.UpdateAssignments(AJPFDGEKDCO: true);
			if (!GDICADMMAKE[0])
			{
	...
	private void HCOPBKPIINA(GameObject KHAHPAKDIKE)
	{
		if (!JEGNECDPAFK.gameObject.activeSelf && FIMOPHPNBNM != MPJAFCCIOEO.Ribbons)
		{
			...
			NDJCNHDBJMM.AKFLKJBMBAJ.AlignToPos(instant: true);
			if (!GDICADMMAKE[4])
			{
	...
	{
		PJCHHCCCCFB[1].IDKGDFDFECC(EIPHAAGCHCP: true);
		if (PJCHHCCCCFB[0].gameObject.activeSelf)
		{
			PJCHHCCCCFB[0].BBCDHJLBEIJ(EIPHAAGCHCP: false);
		}
		if (PJCHHCCCCFB[8].gameObject.activeSelf)
		{
			PJCHHCCCCFB[6].PKEIIFMJDKO(EIPHAAGCHCP: true);
		}
		if (PJCHHCCCCFB[5].gameObject.activeSelf)
		{
			PJCHHCCCCFB[5].NECPEMBFGHE(EIPHAAGCHCP: false);
		}
		if (PJCHHCCCCFB[8].gameObject.activeSelf)
		{
			PJCHHCCCCFB[1].SetButton(EIPHAAGCHCP: false);
		}
	}
	...
	public override void InitGUIValues()
	{
		...
		{
			UnityEngine.Debug.LogError($"END SUBSCREEN OBJECT: {base.gameObject.name}\nERROR: {ex.Message}\nSTACKTRACE: {ex.StackTrace}");
		...
		BMANEHNHPGC[0].SetActive(value: false);
		BMANEHNHPGC[1].SetActive(value: false);
		BMANEHNHPGC[2].SetActive(value: false);
		BMANEHNHPGC[3].SetActive(value: false);
		BMANEHNHPGC[4].SetActive(value: false);
		BMANEHNHPGC[5].SetActive(value: false);
		MPLELHEKGHO.gameObject.SetActive(value: false);
		IBFKCMDILHL();
		NHMNCEFNGIB();
	...
	protected virtual void GHHNNIKGJFG()
	{
		...
		GDICADMMAKE.Add(item: true);
		GDICADMMAKE.Add(item: false);
		GDICADMMAKE.Add(item: true);
		GDICADMMAKE.Add(item: true);
		GDICADMMAKE.Add(item: false);
	...
	private void BHPLMLBPHIH()
	{
		...
		if (PJCHHCCCCFB[0].gameObject.activeSelf)
		{
			PJCHHCCCCFB[0].EHNCFEMHLKN(EIPHAAGCHCP: false);
		}
		if (PJCHHCCCCFB[0].gameObject.activeSelf)
		{
			PJCHHCCCCFB[3].BPLJMMILNEE(EIPHAAGCHCP: true);
		}
		if (PJCHHCCCCFB[4].gameObject.activeSelf)
		{
			PJCHHCCCCFB[8].HBFCFHCLGCE(EIPHAAGCHCP: true);
		}
		if (PJCHHCCCCFB[3].gameObject.activeSelf)
		{
			PJCHHCCCCFB[5].NONHNDDCBPI(EIPHAAGCHCP: false);
		}
	}
	...
	private void NHMNCEFNGIB()
	{
		for (int i = 0; i < PJCHHCCCCFB.Count; i++)
		{
			PJCHHCCCCFB[i].gameObject.SetActive(value: true);
			GDICADMMAKE[i] = false;
			PJCHHCCCCFB[i].InitializeLeftButton();
		}
		if (isSinglePlayer)
		{
			PJCHHCCCCFB[2].gameObject.SetActive(value: false);
			GDICADMMAKE[2] = true;
		}
		if (LevelManager.instance.isWarcardsLocked)
		{
			PJCHHCCCCFB[3].gameObject.SetActive(value: false);
			GDICADMMAKE[3] = true;
		}
		if (Singleton<GameController>.instance.isChallenge)
		{
			PJCHHCCCCFB[0].gameObject.SetActive(value: false);
			GDICADMMAKE[0] = true;
			PJCHHCCCCFB[3].gameObject.SetActive(value: false);
			GDICADMMAKE[3] = true;
		}
	...
	{
		PJCHHCCCCFB[0].SetButton(EIPHAAGCHCP: false);
		...
		{
			PJCHHCCCCFB[2].SetButton(EIPHAAGCHCP: false);
		}
		if (PJCHHCCCCFB[3].gameObject.activeSelf)
		{
			PJCHHCCCCFB[3].SetButton(EIPHAAGCHCP: false);
		}
		if (PJCHHCCCCFB[4].gameObject.activeSelf)
		{
			PJCHHCCCCFB[4].SetButton(EIPHAAGCHCP: false);
		}
	}
	...
	private void GKDDMCEODCD(GameObject KHAHPAKDIKE)
	{
		if (!JEGNECDPAFK.gameObject.activeSelf && FIMOPHPNBNM != (MPJAFCCIOEO)8)
		{
			CNOOENELODC(FIMOPHPNBNM);
			BHKFICKPPPL(MPJAFCCIOEO.Enemy);
			NDJCNHDBJMM.AKFLKJBMBAJ.AlignToPos(instant: true, UIDraggablePanel.Alingment.BottomRight);
			if (!GDICADMMAKE[6])
			{
