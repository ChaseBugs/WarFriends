...
internal class PDIHEPGNPCA : HHFHFANGCEJ
{
	...
	public virtual void PEBHGOMEKME()
	{
		...
		if (flag)
		{
			...
			{
				Singleton<Wallet>.instance.COLJGNLBEII(EOHOJBOGNAO);
				Singleton<MessageManager>.instance.AddMessage(new AGPANDBMDLC(IHFDGLMHHBE.Dogtag, EOHOJBOGNAO), LJMMJDNNIFH: true);
				PlayerAnalytics.instance.AddOneTimeReward(dBKEY);
			}
		}
		if (shouldChat)
	...
	public virtual void FJILILFMPIF()
	{
		...
		if (flag)
		{
			...
			{
				Singleton<Wallet>.instance.COLJGNLBEII(EOHOJBOGNAO, AJNINHIKAFC: false);
				Singleton<MessageManager>.instance.AddMessage(new AGPANDBMDLC(IHFDGLMHHBE.Gold, EOHOJBOGNAO), LJMMJDNNIFH: true);
				PlayerAnalytics.instance.AddOneTimeReward(dBKEY);
			}
		}
		if (flag4)
	...
	public virtual void CCGAHAHKEKF()
	{
		...
		if (!flag || flag2)
		{
			...
			array[1] = MEJMLNDFDBP.CJCFPDLDMEK(Singleton<BeanstalkServerManager>.instance.currentTimestamp, "Changed country to {0} from {1}.", string.Empty, IEJMLKBCDJB: false);
			array[0] = flag;
	...
	public virtual void ALKFOHIAKOM()
	{
		...
		if (flag)
		{
			...
			if (EOHOJBOGNAO > 0 && !PlayerAnalytics.instance.WasOneTimeRewardAdded(dBKEY))
			{
				Singleton<Wallet>.instance.BKFOPCDLPCJ(EOHOJBOGNAO, AJNINHIKAFC: false);
				Singleton<MessageManager>.instance.AddMessage(new AGPANDBMDLC(IHFDGLMHHBE.Gold, EOHOJBOGNAO), LJMMJDNNIFH: true);
				PlayerAnalytics.instance.AddOneTimeReward(dBKEY);
			}
		}
	...
	public virtual void PEDMMNGPBGO()
	{
		...
		if (!flag || flag2)
		{
			...
			array[0] = MEJMLNDFDBP.CJCFPDLDMEK(Singleton<BeanstalkServerManager>.instance.BKJJGHIODNF(), "#PETER# League Arc ", string.Empty, IEJMLKBCDJB: false);
			array[2] = flag;
	...
	public virtual void JOCFHKJPEPO()
	{
		...
		if (!flag || flag2)
		{
			...
			array[1] = MEJMLNDFDBP.CJCFPDLDMEK(KJCKFGCLGLG, "ID_RANDOMWARCARDS", string.Empty, IEJMLKBCDJB: false);
