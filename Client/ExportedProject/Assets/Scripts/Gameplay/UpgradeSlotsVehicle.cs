	...
	private sealed class PKIINPFKGDD : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool KBPKMAKLNPB()
		{
			...
			case 0u:
				...
				if (EFBPOCHCGPB)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(FAJOCOIFFOA.PrepareVisualsForCardCoroutine(mine: true, opponent: false));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 1;
					}
				...
				goto case 1u;
			case 1u:
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(((UpgradeSlots)BJGCPDNMHDH).LoadMineVisualsCoroutine(PFGLIAHPMCK, EFBPOCHCGPB));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 5;
				}
		...
		public bool IDBCKIPOEEI()
		{
			...
			case 0u:
				...
				if (EFBPOCHCGPB)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(FAJOCOIFFOA.PrepareVisualsForCardCoroutine(mine: false, opponent: false));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 0;
					}
		...
		public bool KDFAHLNCNMN()
		{
			...
			case 0u:
				...
				if (EFBPOCHCGPB)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(FAJOCOIFFOA.PrepareVisualsForCardCoroutine(mine: true, opponent: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 0;
					}
		...
		public bool HDGDKCMIOGK()
		{
			...
			case 0u:
				...
				if (EFBPOCHCGPB)
				{
					PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(FAJOCOIFFOA.PrepareVisualsForCardCoroutine(mine: false, opponent: true));
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 1;
					}
	...
	private sealed class EEHPCJJABDC : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool DMPHMFDEINI()
		{
			...
			case 0u:
				...
				goto case 1u;
			case 1u:
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(((UpgradeSlots)BJGCPDNMHDH).LoadOponentVisualsCoroutine(PFGLIAHPMCK, EFBPOCHCGPB));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 5;
				}
