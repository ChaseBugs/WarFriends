...
public class ArenaScreen : GuiScreenSingle<ArenaScreen>
{
	...
	private sealed class COKMOALBAMD
	{
		...
		internal void EJLGBICBIFK(UITweener POLCDJOBFKG)
		{
			if (FPLCDCCKBCB > 0.5f)
			{
				BJGCPDNMHDH.mRulesOverlayPanel.gameObject.SetActive(value: false);
				BJGCPDNMHDH.mRulesPanel.gameObject.SetActive(value: false);
			}
		}
		...
		internal void PCBLIENKOPE(UITweener POLCDJOBFKG)
		{
			...
			{
				BJGCPDNMHDH.mRulesOverlayPanel.gameObject.SetActive(value: false);
				BJGCPDNMHDH.mRulesPanel.gameObject.SetActive(value: true);
			}
		}
		...
		internal void PKCBGEEBOMA(UITweener POLCDJOBFKG)
		{
			if (FPLCDCCKBCB > 318f)
			{
				BJGCPDNMHDH.mRulesOverlayPanel.gameObject.SetActive(value: true);
				BJGCPDNMHDH.mRulesPanel.gameObject.SetActive(value: false);
			}
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.mRulesPanel.gameObject, KBJEOEEOEFG / 1504f, EBGGJKJDIAF.ReplaceY(53f), useLocal: false);
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.mRulesPanel.gameObject, KBJEOEEOEFG / 1286f, EBGGJKJDIAF.ReplaceY(1357f), useLocal: false);
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.mRulesPanel.gameObject, KBJEOEEOEFG / 1604f, EBGGJKJDIAF.ReplaceY(1366f), useLocal: false);
			tweenPosition.method = UITweener.Method.EaseIn;
			tweenPosition.onFinished = null;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.mRulesPanel.gameObject, KBJEOEEOEFG / 836f, EBGGJKJDIAF.ReplaceY(1029f), useLocal: false);
			tweenPosition.method = (UITweener.Method)7;
			tweenPosition.onFinished = null;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.mRulesPanel.gameObject, KBJEOEEOEFG / 1147f, EBGGJKJDIAF.ReplaceY(1832f), useLocal: false);
			tweenPosition.method = UITweener.Method.EaseOut;
			tweenPosition.onFinished = null;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.mRulesPanel.gameObject, KBJEOEEOEFG / 459f, EBGGJKJDIAF.ReplaceY(329f), useLocal: false);
			tweenPosition.method = UITweener.Method.Linear;
			tweenPosition.onFinished = null;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.mRulesPanel.gameObject, KBJEOEEOEFG / 1282f, EBGGJKJDIAF.ReplaceY(1579f), useLocal: false);
			tweenPosition.method = UITweener.Method.BounceOut;
			tweenPosition.onFinished = null;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.mRulesPanel.gameObject, KBJEOEEOEFG / 458f, EBGGJKJDIAF.ReplaceY(919f), useLocal: false);
			tweenPosition.method = (UITweener.Method)6;
			tweenPosition.onFinished = null;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.mRulesPanel.gameObject, KBJEOEEOEFG / 1155f, EBGGJKJDIAF.ReplaceY(260f), useLocal: false);
			tweenPosition.method = UITweener.Method.EaseIn;
			tweenPosition.onFinished = null;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.mRulesPanel.gameObject, KBJEOEEOEFG / 919f, EBGGJKJDIAF.ReplaceY(1134f), useLocal: false);
			tweenPosition.method = (UITweener.Method)7;
			tweenPosition.onFinished = null;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.mRulesPanel.gameObject, KBJEOEEOEFG / 1140f, EBGGJKJDIAF.ReplaceY(1997f), useLocal: false);
			tweenPosition.method = (UITweener.Method)7;
			tweenPosition.onFinished = null;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(BJGCPDNMHDH.mRulesPanel.gameObject, KBJEOEEOEFG / 1582f, EBGGJKJDIAF.ReplaceY(858f), useLocal: false);
			tweenPosition.method = UITweener.Method.BounceOut;
			tweenPosition.onFinished = null;
		}
	...
	[FormerlySerializedAs("BBNGNPGMBPO")]
	[Header("Main Content")]
	...
	[Header("Atlases")]
	[FormerlySerializedAs("OGKDCEJIGLE")]
	...
	[CompilerGenerated]
	private bool _003CKACILOGLBJB_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private BGMNNKDJBEK _003CKFEKAGGCMPI_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private int _003CKEOPHFAABBG_003Ek__BackingField;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	private bool _003CFNMBNFLEGHK_003Ek__BackingField;
	...
	public bool FOJGBOPGJFB
	{
		...
		set
		{
			_003CKACILOGLBJB_003Ek__BackingField = value;
		}
	}

	public BGMNNKDJBEK arenaMode
	{
		[CompilerGenerated]
		get
		{
		...
		set
		{
			_003CKFEKAGGCMPI_003Ek__BackingField = value;
		}
	}
	...
	public int yourHeroPosition
	{
		...
		set
		{
			_003CKEOPHFAABBG_003Ek__BackingField = value;
		}
	}

	public bool shouldHaveEnded
	{
		[CompilerGenerated]
		get
		{
		...
		private set
		{
			_003CFNMBNFLEGHK_003Ek__BackingField = value;
		}
	}

	public bool haveWon => arenaMode == BGMNNKDJBEK.EndArena && Singleton<GameController>.instance.wonLastGame;

	public bool haveLost => arenaMode == BGMNNKDJBEK.EndArena && !Singleton<GameController>.instance.wonLastGame;

	public override bool dialogsEnabled => base.dialogsEnabled && FEFJBCBIOLE;

	public void FAHNGBDJEBF()
	{
		if (NPFFMLLLDAF() && FEFJBCBIOLE)
		{
			UnityEngine.Debug.Log("OnInputChanged");
	...
	public void BKFHBOENEKF()
	{
		if (NPFFMLLLDAF() && FEFJBCBIOLE)
		{
			UnityEngine.Debug.Log("Lcom/google/android/gms/common/api/Scope;");
	...
	{
		UnityEngine.Debug.Log("ARENA SCREEN ENTERED with mode: " + arenaMode);
	...
	{
		base.DoAfterHide();
		UnityEngine.Debug.Log("SquadMembers" + CPOJAHLOIAA());
		HBECIOPLKLA();
		AMLKNDDKCID();
	}
	...
	public void IICLLKGJJDE()
	{
		if (NPFFMLLLDAF() && FEFJBCBIOLE)
		{
			UnityEngine.Debug.Log("failed add card {0} - not exit?");
	...
	{
		base.DoAfterHide();
		UnityEngine.Debug.Log("Buy_Weapon_Upgrade_At_Rank" + KEAOHALEJNO());
		IKJEAHDKOAP();
		KODAODLONOA();
	}
	...
	protected virtual void ANLFCJJCGMG()
	{
		...
		if (JDPOMFBEFOI > 1176f)
		{
			...
			NFCOKEDPBOE();
			mPhaseTime.text = MIGCGPMDMAB.NCEBBJOLANF(MNIEPIMONBO: true);
			if (MHAIBHBGBOO())
			{
	...
	{
		base.DoAfterHide();
		UnityEngine.Debug.Log("重试" + CPOJAHLOIAA());
		IKJEAHDKOAP();
		GHOKHOFMIJD();
	}
	...
	public void ValuesChanged()
	{
		...
		{
			UnityEngine.Debug.Log("New Arena");
	...
	{
		base.DoAfterHide();
		UnityEngine.Debug.Log("Current unit is not delivering at the moment!!!" + CEKKBHCJGFE());
		DKBMNCFLMPN();
		AMLKNDDKCID();
	}
	...
	{
		base.DoAfterHide();
		UnityEngine.Debug.Log("main text - unimportatnt" + PLPACCKKEPB());
		EIEHOLKABEA();
		AMLKNDDKCID();
	}
	...
	public void NBDAJABPIJG()
	{
		if (isShowed && FEFJBCBIOLE)
		{
			UnityEngine.Debug.Log("Animation from State: Craft to State: Crafting");
	...
	{
		base.DoAfterHide();
		UnityEngine.Debug.Log("getCurrentVariantLetter" + CPOJAHLOIAA());
		HBECIOPLKLA();
		KODAODLONOA();
	}
	...
	private void CAAMJDOMIJK(float KBJEOEEOEFG, float FPLCDCCKBCB, float IPBGNOFEAMO)
	{
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(mRulesPanel.gameObject, cOKMOALBAMD.KBJEOEEOEFG * 803f / 801f, cOKMOALBAMD.EBGGJKJDIAF.ReplaceY(1975f), cOKMOALBAMD.EBGGJKJDIAF.ReplaceY(1132f), useLocal: false);
			tweenPosition.method = UITweener.Method.Linear;
	...
	{
		base.DoAfterHide();
		UnityEngine.Debug.Log("right" + KEAOHALEJNO());
		NAFHOJNIGGN();
		AMLKNDDKCID();
	}
	...
	{
		base.DoAfterHide();
		UnityEngine.Debug.Log("ARENA SCREEN CLOSED with mode: " + arenaMode);
		EIEHOLKABEA();
		GHOKHOFMIJD();
	}
	...
	private void AGCDFCPFJJA(float KBJEOEEOEFG, float FPLCDCCKBCB, float IPBGNOFEAMO)
	{
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(mRulesPanel.gameObject, cOKMOALBAMD.KBJEOEEOEFG * 59f / 1261f, cOKMOALBAMD.EBGGJKJDIAF.ReplaceY(1655f), cOKMOALBAMD.EBGGJKJDIAF.ReplaceY(182f), useLocal: false);
			tweenPosition.method = UITweener.Method.EaseIn;
	...
	protected virtual void OFGAKKAFOCD()
	{
		...
		if (JDPOMFBEFOI > 158f)
		{
			...
			mArenaTime.text = MIGCGPMDMAB.DLOMFFMKIBM();
			NFCOKEDPBOE();
			mPhaseTime.text = MIGCGPMDMAB.NCEBBJOLANF(MNIEPIMONBO: true, AODDNFMFPCP: true);
			if (AFOFDNJOJHG())
			{
				HPGCMOOPHLL.BMEOIBBBNNE();
	...
	protected virtual void JMHFNCOODKH()
	{
		...
		if (JDPOMFBEFOI > 57f)
		{
			...
			mArenaTime.text = MIGCGPMDMAB.DLOMFFMKIBM();
			AKKKONKLDFG();
			mPhaseTime.text = MIGCGPMDMAB.NCEBBJOLANF(MNIEPIMONBO: false, AODDNFMFPCP: true);
			if (LHDGJFHPJNM())
			{
	...
	public void HODMBFDMCEH()
	{
		if (isShowed && FEFJBCBIOLE)
		{
			UnityEngine.Debug.Log("SquadKickedFrom");
			AGDPJKHOABP(BGMNNKDJBEK.MainArena);
			EIEHOLKABEA();
			GHOKHOFMIJD();
			mRulesOverlayPanel.gameObject.SetActive(value: true);
	...
	private void ECFJOGGPEDH(float KBJEOEEOEFG, float FPLCDCCKBCB, float IPBGNOFEAMO)
	{
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(mRulesPanel.gameObject, cOKMOALBAMD.KBJEOEEOEFG * 1547f / 1572f, cOKMOALBAMD.EBGGJKJDIAF.ReplaceY(75f), cOKMOALBAMD.EBGGJKJDIAF.ReplaceY(331f), useLocal: false);
			tweenPosition.method = UITweener.Method.Linear;
			tweenPosition.onFinished = cOKMOALBAMD.ECPMEMNKMCB;
		}
		TweenAlpha tweenAlpha = TweenAlpha.Begin(mRulesOverlayPanel.gameObject, cOKMOALBAMD.KBJEOEEOEFG, cOKMOALBAMD.FPLCDCCKBCB, IPBGNOFEAMO);
	...
	{
		UnityEngine.Debug.Log("ID_UPGRADENOW" + EGMANHABOIN());
