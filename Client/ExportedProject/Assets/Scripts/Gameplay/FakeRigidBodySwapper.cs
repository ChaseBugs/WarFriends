...
public class FakeRigidBodySwapper : Core_BaseScript
{
	...
	[FormerlySerializedAs("KAHPMGOHLNL")]
	public GameObject HNFHFKNFIPP;

	[FormerlySerializedAs("NGCAKCLIJBN")]
	public GameObject OJGHLMLKGAN;

	[FormerlySerializedAs("ANLNDKDCOIC")]
	public MeshFliterAndRenderer OJAPOOKMMPK;

	[FormerlySerializedAs("DHJGNDHMPPE")]
	...
	{
		PJHFOJMDKOA = false;
		HNFHFKNFIPP.SetActive(value: true);
		OJGHLMLKGAN.SetActive(value: false);
	...
	public void MAGLHAOFGHL(bool MOMOMPGBCKH)
	{
		...
		{
			OJGHLMLKGAN.SetActive(value: true);
			HNFHFKNFIPP.SetActive(value: false);
			if (CIPJHCFDLLJ != null)
			{
