...
internal class PhotonHandler : MonoBehaviour
{
	...
	{
		if (sendThreadShouldRun && PhotonNetwork.networkingPeer != null && PhotonNetwork.networkingPeer.ConnectionTime - PhotonNetwork.networkingPeer.LastSendOutgoingTime > 200)
		{
