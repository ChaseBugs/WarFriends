...
namespace Org.BouncyCastle.Crypto.Digests
{
	public sealed class WhirlpoolDigest : IDigest, IMemoable
	{
		...
		{
			return (long)((((ulong)(int)buffer[startPos] & 0xFFuL) << 56) | (((ulong)(int)buffer[startPos + 1] & 0xFFuL) << 48) | (((ulong)(int)buffer[startPos + 2] & 0xFFuL) << 40) | (((ulong)(int)buffer[startPos + 3] & 0xFFuL) << 32) | (((ulong)(int)buffer[startPos + 4] & 0xFFuL) << 24) | (((ulong)(int)buffer[startPos + 5] & 0xFFuL) << 16) | (((ulong)(int)buffer[startPos + 6] & 0xFFuL) << 8) | ((ulong)(int)buffer[startPos + 7] & 0xFFuL));
		}
