	...
	public struct ObscuredVector2
	{
		...
		public float x
		{
			get
			{
				...
				if (ObscuredCheatingDetector.IsRunning && !fakeValue.Equals((object)initialFakeValue) && Math.Abs(num - fakeValue.x) > ObscuredCheatingDetector.Instance.vector2Epsilon)
				{
		...
		public float y
		{
			get
			{
				...
				if (ObscuredCheatingDetector.IsRunning && !fakeValue.Equals((object)initialFakeValue) && Math.Abs(num - fakeValue.y) > ObscuredCheatingDetector.Instance.vector2Epsilon)
				{
					ObscuredCheatingDetector.Instance.OnCheatingDetected();
				}
				return num;
		...
		private Vector2 InternalDecrypt()
		{
			...
			if (ObscuredCheatingDetector.IsRunning && !fakeValue.Equals((object)initialFakeValue) && !CompareVectorsWithTolerance(vector, fakeValue))
			{
				ObscuredCheatingDetector.Instance.OnCheatingDetected();
			}
			return vector;
