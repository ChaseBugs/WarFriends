...
public class Localization : MonoBehaviour
{
	...
	public static string LocalizeFormat(string keyFormat, params object[] args)
	{
		...
		if (text == keyFormat)
		{
			AnalyticsHelper.LeaveBreadcrumb($"Localization do not exists or is the same as key: {keyFormat}");
			return keyFormat;
		}
		try
		{
		...
		{
			AnalyticsHelper.LeaveBreadcrumb($"Translation ID {keyFormat} contains errors ({text}).");
