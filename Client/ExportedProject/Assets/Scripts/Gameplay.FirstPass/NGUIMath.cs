...
public static class NGUIMath
{
	...
	public static Vector3 ApplyHalfPixelOffset(Vector3 pos)
	{
		...
		// WindowsWebPlayer was removed before Unity 2018. Keep the half-pixel correction for
		// the still-supported desktop/editor targets without referencing the retired enum.
	...
	public static Vector2 ConstrainRectTopLeft(Vector2 minRect, Vector2 maxRect, Vector2 minArea, Vector2 maxArea)
	{
		Vector2 zero = Vector2.zero;
		float num = maxRect.x - minRect.x;
		float num2 = maxRect.y - minRect.y;
