...
public class EveryplayRecButtons : MonoBehaviour
{
	...
	{
		public Rect atlasRect = new Rect(0f, 0f, 0f, 0f);

		public Rect normalizedAtlasRect = new Rect(0f, 0f, 0f, 0f);
	...
	private void Awake()
	{
		...
		SetButtonVisible(startRecordingButton, visible: true);
		SetButtonVisible(openEveryplayButton, visible: true);
		SetButtonVisible(faceCamToggleButton, visible: true);
	...
	private void RecordingStarted()
	{
		...
		SetButtonVisible(shareVideoButton, visible: false);
		SetButtonVisible(editVideoButton, visible: false);
		SetButtonVisible(faceCamToggleButton, visible: false);
	}

	private void RecordingStopped()
	{
		ReplaceVisibleButton(stopRecordingButton, startRecordingButton);
		SetButtonVisible(shareVideoButton, visible: true);
		SetButtonVisible(editVideoButton, visible: true);
		SetButtonVisible(faceCamToggleButton, visible: true);
	}
	...
	private void DrawTexture(float x, float y, float width, float height, Texture2D texture, Rect uvRect)
	{
		x += containerOffset.x;
		y += containerOffset.y;
		GUI.DrawTextureWithTexCoords(new Rect(x, y, width, height), texture, uvRect, alphaBlend: true);
	}
