...
public class EveryplayThumbnailPool : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		{
			SingletonSupport.DontDestroyOnLoadIfPlaying((Object)base.gameObject);
		}
	...
	private void Initialize()
	{
		if (!initialized && Everyplay.IsRecordingSupported())
		{
			...
			{
				thumbnailTextures[i] = new Texture2D((!npotSupported) ? num : thumbnailWidth, (!npotSupported) ? num2 : thumbnailHeight, textureFormat, mipChain: false);
