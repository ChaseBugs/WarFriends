...
namespace Google2u
{
	public class DBUpgradeSlotsGrennader : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public string[] rowNames = new string[136]
		{
			...
			"ROW_91", "ROW_92", "ROW_93", "ROW_94", "ROW_95", "ROW_96", "ROW_97", "ROW_98", "ROW_99", "ROW_100",
			"ROW_101", "SPECIAL_0", "SPECIAL_1", "SPECIAL_2", "SPECIAL_3", "SPECIAL_4", "SPECIAL_5", "SPECIAL_6", "SPECIAL_7", "SPECIAL_8",
			"SPECIAL_9", "SPECIAL_10", "SPECIAL_11", "SPECIAL_12", "SPECIAL_13", "SPECIAL_14", "SPECIAL_15", "SPECIAL_16", "SPECIAL_17", "SPECIAL_18",
			"SPECIAL_19", "SPECIAL_20", "SPECIAL_21", "SPECIAL_22", "SPECIAL_23", "SPECIAL_24", "SPECIAL_25", "ELITE_0", "ELITE_1", "ELITE_2",
		...
		public List<DBUpgradeSlotsGrennaderRow> Rows = new List<DBUpgradeSlotsGrennaderRow>();

		public override bool haveDictionary => true;

		public override int getColumnCount => 17;
		...
		{
			Rows.Add(new DBUpgradeSlotsGrennaderRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15], input[16], input[17]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new DBUpgradeSlotsGrennaderRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public DBUpgradeSlotsGrennaderRow GetRow(rowIds in_RowID)
		{
			DBUpgradeSlotsGrennaderRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public DBUpgradeSlotsGrennaderRow GetRow(string in_RowString)
		{
			DBUpgradeSlotsGrennaderRow result = null;
