...
{
	[Serializable]
	public class AssaultRifle_M16BMRow : IGoogle2uRow
	{
		...
		public AssaultRifle_M16BMRow()
		{
		}

		public AssaultRifle_M16BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
