...
namespace Google2u
{
	public class GrenadeLauncher_DP64 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<GrenadeLauncher_DP64Row> Rows = new List<GrenadeLauncher_DP64Row>();
		...
		{
			Rows.Add(new GrenadeLauncher_DP64Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new GrenadeLauncher_DP64Row());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public GrenadeLauncher_DP64Row GetRow(rowIds in_RowID)
		{
			GrenadeLauncher_DP64Row result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public GrenadeLauncher_DP64Row GetRow(string in_RowString)
		{
			GrenadeLauncher_DP64Row result = null;
