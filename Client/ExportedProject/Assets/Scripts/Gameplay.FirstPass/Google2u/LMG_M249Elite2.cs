...
namespace Google2u
{
	public class LMG_M249Elite2 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<LMG_M249Elite2Row> Rows = new List<LMG_M249Elite2Row>();
		...
		{
			Rows.Add(new LMG_M249Elite2Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new LMG_M249Elite2Row());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public LMG_M249Elite2Row GetRow(rowIds in_RowID)
		{
			LMG_M249Elite2Row result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public LMG_M249Elite2Row GetRow(string in_RowString)
		{
			LMG_M249Elite2Row result = null;
