...
namespace Google2u
{
	public class GrenadeLauncher_MGLBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public string[] rowNames = new string[56]
		{
			...
			"ROW_51", "ROW_52", "ROW_53", "ROW_54", "ROW_55", "WARARENA"
		};
		...
		public List<GrenadeLauncher_MGLBMRow> Rows = new List<GrenadeLauncher_MGLBMRow>();
		...
		{
			Rows.Add(new GrenadeLauncher_MGLBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new GrenadeLauncher_MGLBMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public GrenadeLauncher_MGLBMRow GetRow(rowIds in_RowID)
		{
			GrenadeLauncher_MGLBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public GrenadeLauncher_MGLBMRow GetRow(string in_RowString)
		{
			GrenadeLauncher_MGLBMRow result = null;
