...
namespace Google2u
{
	public class GrenadeLauncher_DP64BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public string[] rowNames = new string[46]
		{
			...
			"ROW_41", "ROW_42", "ROW_43", "ROW_44", "ROW_45", "WARARENA"
		};
		...
		public List<GrenadeLauncher_DP64BMRow> Rows = new List<GrenadeLauncher_DP64BMRow>();
		...
		{
			Rows.Add(new GrenadeLauncher_DP64BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new GrenadeLauncher_DP64BMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public GrenadeLauncher_DP64BMRow GetRow(rowIds in_RowID)
		{
			GrenadeLauncher_DP64BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public GrenadeLauncher_DP64BMRow GetRow(string in_RowString)
		{
			GrenadeLauncher_DP64BMRow result = null;
