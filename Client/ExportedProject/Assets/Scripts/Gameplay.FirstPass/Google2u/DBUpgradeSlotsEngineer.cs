...
namespace Google2u
{
	public class DBUpgradeSlotsEngineer : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsEngineerRow> Rows = new List<DBUpgradeSlotsEngineerRow>();

		public override bool haveDictionary => true;

		public override int getColumnCount => 16;
		...
		{
			Rows.Add(new DBUpgradeSlotsEngineerRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15], input[16]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new DBUpgradeSlotsEngineerRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public DBUpgradeSlotsEngineerRow GetRow(rowIds in_RowID)
		{
			DBUpgradeSlotsEngineerRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public DBUpgradeSlotsEngineerRow GetRow(string in_RowString)
		{
			DBUpgradeSlotsEngineerRow result = null;
