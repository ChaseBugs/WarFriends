...
{
	[Serializable]
	public class SniperRifle_DragunovEliteRow : IGoogle2uRow
	{
		...
		public SniperRifle_DragunovEliteRow()
		{
		}

		public SniperRifle_DragunovEliteRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
