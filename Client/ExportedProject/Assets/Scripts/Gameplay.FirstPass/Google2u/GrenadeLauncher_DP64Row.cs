...
{
	[Serializable]
	public class GrenadeLauncher_DP64Row : IGoogle2uRow
	{
		...
		public GrenadeLauncher_DP64Row()
		{
		}

		public GrenadeLauncher_DP64Row(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _DEADRADIUS, string _ATTACK)
		{
