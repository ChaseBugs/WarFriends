...
namespace Google2u
{
	public class Pistol_M1911 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Pistol_M1911Row> Rows = new List<Pistol_M1911Row>();
		...
		{
			Rows.Add(new Pistol_M1911Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public Pistol_M1911Row GetRow(rowIds in_RowID)
		{
			Pistol_M1911Row result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Pistol_M1911Row GetRow(string in_RowString)
		{
			Pistol_M1911Row result = null;
