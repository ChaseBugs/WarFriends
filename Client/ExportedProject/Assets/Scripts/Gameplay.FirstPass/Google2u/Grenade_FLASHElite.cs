...
namespace Google2u
{
	public class Grenade_FLASHElite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Grenade_FLASHEliteRow> Rows = new List<Grenade_FLASHEliteRow>();
		...
		{
			Rows.Add(new Grenade_FLASHEliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Grenade_FLASHEliteRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Grenade_FLASHEliteRow GetRow(rowIds in_RowID)
		{
			Grenade_FLASHEliteRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Grenade_FLASHEliteRow GetRow(string in_RowString)
		{
			Grenade_FLASHEliteRow result = null;
