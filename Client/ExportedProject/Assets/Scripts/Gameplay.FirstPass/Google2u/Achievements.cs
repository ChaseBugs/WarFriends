...
namespace Google2u
{
	public class Achievements : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			...
			winArenaBattles_2,
			winArenaBattles_3,
			becomeAFlawlessHero_1,
			becomeAFlawlessHero_2,
			becomeAFlawlessHero_3,
			completeMissions_1,
			completeMissions_2,
			completeMissions_3,
			deploySoldierUnits_1,
			deploySoldierUnits_2,
			deploySoldierUnits_3,
			deployVehicles_1,
			deployVehicles_2,
			deployVehicles_3,
			playWarcards_1,
			playWarcards_2,
			playWarcards_3,
			trainSoldierUnitsTimes_1,
			trainSoldierUnitsTimes_2,
			trainSoldierUnitsTimes_3,
			upgradeVehiclesTimes_1,
			upgradeVehiclesTimes_2,
			upgradeVehiclesTimes_3,
			upgradeWeaponsTimes_1,
			upgradeWeaponsTimes_2,
			upgradeWeaponsTimes_3,
			completeAssignments_1,
			completeAssignments_2,
			completeAssignments_3,
			getToLeague_1,
			getToLeague_2,
			getToLeague_3,
			earnSquadPoints_1,
			earnSquadPoints_2,
			earnSquadPoints_3,
			collectCosmeticItems_1,
			collectCosmeticItems_2,
			collectCosmeticItems_3,
			claimDailyRewards_1,
			claimDailyRewards_2,
			claimDailyRewards_3,
