...
namespace Google2u
{
	public class Shotgun_StrikerBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_StrikerBMRow> Rows = new List<Shotgun_StrikerBMRow>();
		...
		{
			Rows.Add(new Shotgun_StrikerBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Shotgun_StrikerBMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Shotgun_StrikerBMRow GetRow(rowIds in_RowID)
		{
			Shotgun_StrikerBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Shotgun_StrikerBMRow GetRow(string in_RowString)
		{
			Shotgun_StrikerBMRow result = null;
