...
namespace Google2u
{
	public class Versions : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			photonVersioniOS,
			photonVersionAndroid,
			photonVersioniOSMatchMaking,
			photonVersionAndroidMatchMaking
		}

		public string[] rowNames = new string[4] { "photonVersioniOS", "photonVersionAndroid", "photonVersioniOSMatchMaking", "photonVersionAndroidMatchMaking" };

		public Dictionary<string, int> namesToIndex = new Dictionary<string, int>
		{
			{ "photonVersioniOS", 0 },
			{ "photonVersionAndroid", 1 },
			{ "photonVersioniOSMatchMaking", 2 },
			{ "photonVersionAndroidMatchMaking", 3 }
		};

		public List<VersionsRow> Rows = new List<VersionsRow>();
		...
		{
			Rows.Add(new VersionsRow(input[0], input[1]));
		}
		...
		public VersionsRow GetRow(rowIds in_RowID)
		{
			VersionsRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public VersionsRow GetRow(string in_RowString)
		{
			VersionsRow result = null;
