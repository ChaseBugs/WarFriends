...
namespace Google2u
{
	public class AssaultRifle_AKS47U : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<AssaultRifle_AKS47URow> Rows = new List<AssaultRifle_AKS47URow>();
		...
		{
			Rows.Add(new AssaultRifle_AKS47URow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new AssaultRifle_AKS47URow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public AssaultRifle_AKS47URow GetRow(rowIds in_RowID)
		{
			AssaultRifle_AKS47URow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public AssaultRifle_AKS47URow GetRow(string in_RowString)
		{
			AssaultRifle_AKS47URow result = null;
