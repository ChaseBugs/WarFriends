...
namespace Google2u
{
	public class Shotgun_Saiga : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_SaigaRow> Rows = new List<Shotgun_SaigaRow>();
		...
		{
			Rows.Add(new Shotgun_SaigaRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public Shotgun_SaigaRow GetRow(rowIds in_RowID)
		{
			Shotgun_SaigaRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Shotgun_SaigaRow GetRow(string in_RowString)
		{
			Shotgun_SaigaRow result = null;
