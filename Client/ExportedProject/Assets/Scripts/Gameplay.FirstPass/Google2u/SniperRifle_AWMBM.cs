...
namespace Google2u
{
	public class SniperRifle_AWMBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<SniperRifle_AWMBMRow> Rows = new List<SniperRifle_AWMBMRow>();
		...
		{
			Rows.Add(new SniperRifle_AWMBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new SniperRifle_AWMBMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public SniperRifle_AWMBMRow GetRow(rowIds in_RowID)
		{
			SniperRifle_AWMBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public SniperRifle_AWMBMRow GetRow(string in_RowString)
		{
			SniperRifle_AWMBMRow result = null;
