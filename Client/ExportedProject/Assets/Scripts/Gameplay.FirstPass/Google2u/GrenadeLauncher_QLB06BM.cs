...
namespace Google2u
{
	public class GrenadeLauncher_QLB06BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<GrenadeLauncher_QLB06BMRow> Rows = new List<GrenadeLauncher_QLB06BMRow>();
		...
		{
			Rows.Add(new GrenadeLauncher_QLB06BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new GrenadeLauncher_QLB06BMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public GrenadeLauncher_QLB06BMRow GetRow(rowIds in_RowID)
		{
			GrenadeLauncher_QLB06BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public GrenadeLauncher_QLB06BMRow GetRow(string in_RowString)
		{
			GrenadeLauncher_QLB06BMRow result = null;
