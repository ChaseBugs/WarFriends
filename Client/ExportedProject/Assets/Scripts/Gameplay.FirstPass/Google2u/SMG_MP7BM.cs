...
namespace Google2u
{
	public class SMG_MP7BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<SMG_MP7BMRow> Rows = new List<SMG_MP7BMRow>();
		...
		{
			Rows.Add(new SMG_MP7BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public SMG_MP7BMRow GetRow(rowIds in_RowID)
		{
			SMG_MP7BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public SMG_MP7BMRow GetRow(string in_RowString)
		{
			SMG_MP7BMRow result = null;
