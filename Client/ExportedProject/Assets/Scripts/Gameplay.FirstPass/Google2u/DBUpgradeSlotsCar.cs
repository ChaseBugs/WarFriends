...
namespace Google2u
{
	public class DBUpgradeSlotsCar : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsCarRow> Rows = new List<DBUpgradeSlotsCarRow>();
		...
		{
			Rows.Add(new DBUpgradeSlotsCarRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new DBUpgradeSlotsCarRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public DBUpgradeSlotsCarRow GetRow(rowIds in_RowID)
		{
			DBUpgradeSlotsCarRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public DBUpgradeSlotsCarRow GetRow(string in_RowString)
		{
			DBUpgradeSlotsCarRow result = null;
