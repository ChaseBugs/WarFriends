...
{
	[Serializable]
	public class SMG_VectorRow : IGoogle2uRow
	{
		...
		public SMG_VectorRow()
		{
		}

		public SMG_VectorRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
