...
namespace Google2u
{
	public class Shotgun_SaigaBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_SaigaBMRow> Rows = new List<Shotgun_SaigaBMRow>();
		...
		{
			Rows.Add(new Shotgun_SaigaBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Shotgun_SaigaBMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Shotgun_SaigaBMRow GetRow(rowIds in_RowID)
		{
			Shotgun_SaigaBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Shotgun_SaigaBMRow GetRow(string in_RowString)
		{
			Shotgun_SaigaBMRow result = null;
