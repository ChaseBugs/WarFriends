...
{
	[Serializable]
	public class GrenadeLauncher_DP64BMRow : IGoogle2uRow
	{
		...
		public GrenadeLauncher_DP64BMRow()
		{
		}

		public GrenadeLauncher_DP64BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _DEADRADIUS, string _ATTACK, string _WEAPONPRICE)
		{
