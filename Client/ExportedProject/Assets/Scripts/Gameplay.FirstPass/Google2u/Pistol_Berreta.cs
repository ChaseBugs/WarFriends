...
namespace Google2u
{
	public class Pistol_Berreta : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Pistol_BerretaRow> Rows = new List<Pistol_BerretaRow>();
		...
		{
			Rows.Add(new Pistol_BerretaRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Pistol_BerretaRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Pistol_BerretaRow GetRow(rowIds in_RowID)
		{
			Pistol_BerretaRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Pistol_BerretaRow GetRow(string in_RowString)
		{
			Pistol_BerretaRow result = null;
