...
{
	[Serializable]
	public class SniperRifle_DragunovBMRow : IGoogle2uRow
	{
		...
		public SniperRifle_DragunovBMRow()
		{
		}

		public SniperRifle_DragunovBMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
