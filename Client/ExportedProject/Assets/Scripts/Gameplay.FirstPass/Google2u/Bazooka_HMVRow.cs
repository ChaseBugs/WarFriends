...
{
	[Serializable]
	public class Bazooka_HMVRow : IGoogle2uRow
	{
		...
		public Bazooka_HMVRow()
		{
		}

		public Bazooka_HMVRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
