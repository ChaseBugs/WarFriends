...
{
	[Serializable]
	public class GrenadeLauncher_QLB06BMRow : IGoogle2uRow
	{
		...
		public GrenadeLauncher_QLB06BMRow()
		{
		}

		public GrenadeLauncher_QLB06BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _DEADRADIUS, string _ATTACK, string _WEAPONPRICE)
		{
