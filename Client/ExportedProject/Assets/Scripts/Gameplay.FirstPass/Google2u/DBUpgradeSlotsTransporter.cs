...
namespace Google2u
{
	public class DBUpgradeSlotsTransporter : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public string[] rowNames = new string[89]
		{
			...
			"ROW_71", "SPECIAL_0", "SPECIAL_1", "SPECIAL_2", "SPECIAL_3", "SPECIAL_4", "SPECIAL_5", "SPECIAL_6", "SPECIAL_7", "SPECIAL_8",
			"SPECIAL_9", "SPECIAL_10", "ELITE_0", "ELITE_1", "ELITE_2", "ELITE_3", "ELITE_4", "ELITE_5", "WARARENA"
		};
		...
		public List<DBUpgradeSlotsTransporterRow> Rows = new List<DBUpgradeSlotsTransporterRow>();
		...
		{
			Rows.Add(new DBUpgradeSlotsTransporterRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15], input[16], input[17]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new DBUpgradeSlotsTransporterRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public DBUpgradeSlotsTransporterRow GetRow(rowIds in_RowID)
		{
			DBUpgradeSlotsTransporterRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public DBUpgradeSlotsTransporterRow GetRow(string in_RowString)
		{
			DBUpgradeSlotsTransporterRow result = null;
