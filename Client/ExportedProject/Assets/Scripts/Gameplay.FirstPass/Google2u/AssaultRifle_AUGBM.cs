...
namespace Google2u
{
	public class AssaultRifle_AUGBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<AssaultRifle_AUGBMRow> Rows = new List<AssaultRifle_AUGBMRow>();
		...
		{
			Rows.Add(new AssaultRifle_AUGBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new AssaultRifle_AUGBMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public AssaultRifle_AUGBMRow GetRow(rowIds in_RowID)
		{
			AssaultRifle_AUGBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public AssaultRifle_AUGBMRow GetRow(string in_RowString)
		{
			AssaultRifle_AUGBMRow result = null;
