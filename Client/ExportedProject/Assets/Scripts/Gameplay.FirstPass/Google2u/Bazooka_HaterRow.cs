...
{
	[Serializable]
	public class Bazooka_HaterRow : IGoogle2uRow
	{
		...
		public Bazooka_HaterRow()
		{
		}

		public Bazooka_HaterRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
