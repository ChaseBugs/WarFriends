...
namespace Google2u
{
	...
	public class ArenaLootboxesRow : IGoogle2uRow
	{
		...
		{
			NAME = _NAME.Trim();
			if (int.TryParse(_ELITEPARTSMIN, out var result))
			{
			...
			if (int.TryParse(_ELITEPARTSMAX, out var result2))
			{
			...
			if (int.TryParse(_TICKETSMIN, out var result3))
			{
				TICKETSMIN = result3;
			}
			else
			...
			if (int.TryParse(_TICKETSMAX, out var result4))
			{
				TICKETSMAX = result4;
			}
			else
			...
			if (int.TryParse(_SCRAPSMIN, out var result5))
			{
				SCRAPSMIN = result5;
			}
			else
			...
			if (int.TryParse(_SCRAPSMAX, out var result6))
			{
				SCRAPSMAX = result6;
			}
			else
			...
			if (int.TryParse(_GOLDMIN, out var result7))
			{
				GOLDMIN = result7;
			}
			else
			...
			if (int.TryParse(_GOLDMAX, out var result8))
			{
				GOLDMAX = result8;
			}
			else
			...
			if (int.TryParse(_WARBUCKS, out var result9))
			{
				WARBUCKS = result9;
			}
			else
