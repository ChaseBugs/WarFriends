...
namespace Google2u
{
	...
	public class MissionsSettingsRow : IGoogle2uRow
	{
		...
		{
			if (float.TryParse(_DAILY1, out var result))
			{
				DAILY1 = result;
			}
			else
			...
			if (float.TryParse(_DAILY2, out var result2))
			{
				DAILY2 = result2;
			}
			else
			...
			if (float.TryParse(_DAILY3, out var result3))
			{
				DAILY3 = result3;
			}
			else
			...
			if (float.TryParse(_HEROIC1, out var result4))
			{
				HEROIC1 = result4;
			}
			else
			...
			if (float.TryParse(_HEROIC2, out var result5))
			{
				HEROIC2 = result5;
			}
			else
			...
			if (float.TryParse(_HEROIC3, out var result6))
			{
				HEROIC3 = result6;
			}
			else
			...
			if (float.TryParse(_HEROIC4, out var result7))
			{
				HEROIC4 = result7;
			}
			else
			...
			if (float.TryParse(_HEROIC5, out var result8))
			{
				HEROIC5 = result8;
			}
			else
