...
{
	[Serializable]
	public class GrenadeLauncher_MGLRow : IGoogle2uRow
	{
		...
		public GrenadeLauncher_MGLRow()
		{
		}

		public GrenadeLauncher_MGLRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _DEADRADIUS, string _ATTACK)
		{
