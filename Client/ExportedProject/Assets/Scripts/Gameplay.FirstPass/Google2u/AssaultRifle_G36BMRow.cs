...
{
	[Serializable]
	public class AssaultRifle_G36BMRow : IGoogle2uRow
	{
		...
		public AssaultRifle_G36BMRow()
		{
		}

		public AssaultRifle_G36BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
