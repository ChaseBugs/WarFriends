...
{
	[Serializable]
	public class DBUpgradeSlotsMinigunnerRow : IGoogle2uRow
	{
		public int TIER;
		...
		public float Get_SHIELDRECHARGERATE
		{
			get
			{
		...
		public DBUpgradeSlotsMinigunnerRow()
		{
		}

		public DBUpgradeSlotsMinigunnerRow(string _GOOGLEFU_ID, string _TIER, string _HP, string _DAMAGE, string _BATCHSIZEMIN, string _BATCHSIZEMAX, string _SHOTFREQUENCYMIN, string _SHOTFREQUENCYMAX, string _REALSHOTPROBABILITY, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ARMYPOWER, string _SPECIAL, string _SHIELDRECHARGERATE, string _ELITE)
		{
			...
			if (float.TryParse(_SHIELDRECHARGERATE, out var result15))
			{
				SHIELDRECHARGERATE = result15;
			}
			else
			{
				Debug.LogError("Failed To Convert SHIELDRECHARGERATE string: " + _SHIELDRECHARGERATE + " to float");
			}
		...
		public string GetStringDataByIndex(int index)
		{
			...
			case 13:
				...
				break;
			case 14:
				result = SHIELDRECHARGERATE.ToString();
				break;
			case 15:
		...
		public override string ToString()
		{
			...
			empty = empty + "{SHIELDRECHARGERATE : " + SHIELDRECHARGERATE + "} ";
			return empty + "{ELITE : " + ELITE + "} ";
		}
	}
}
