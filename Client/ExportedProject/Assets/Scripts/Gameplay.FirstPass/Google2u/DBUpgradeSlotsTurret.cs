...
namespace Google2u
{
	public class DBUpgradeSlotsTurret : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public string[] rowNames = new string[89]
		{
			...
			"ROW_81", "ROW_82", "ROW_83", "ROW_84", "ROW_85", "ROW_86", "CARDS_MIN", "CARDS_MAX", "WARARENA"
		};
		...
		public List<DBUpgradeSlotsTurretRow> Rows = new List<DBUpgradeSlotsTurretRow>();
		...
		{
			Rows.Add(new DBUpgradeSlotsTurretRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new DBUpgradeSlotsTurretRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public DBUpgradeSlotsTurretRow GetRow(rowIds in_RowID)
		{
			DBUpgradeSlotsTurretRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public DBUpgradeSlotsTurretRow GetRow(string in_RowString)
		{
			DBUpgradeSlotsTurretRow result = null;
