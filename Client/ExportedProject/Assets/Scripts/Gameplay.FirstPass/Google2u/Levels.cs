...
namespace Google2u
{
	public class Levels : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ID_0,
		...
		public string[] rowNames = new string[43]
		{
		...
		public List<LevelsRow> Rows = new List<LevelsRow>();
		...
		{
			Rows.Add(new LevelsRow(input[0], input[1], input[2], input[3], input[4], input[5]));
		}
