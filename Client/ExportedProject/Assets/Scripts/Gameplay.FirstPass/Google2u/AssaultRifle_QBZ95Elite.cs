...
namespace Google2u
{
	public class AssaultRifle_QBZ95Elite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<AssaultRifle_QBZ95EliteRow> Rows = new List<AssaultRifle_QBZ95EliteRow>();
		...
		{
			Rows.Add(new AssaultRifle_QBZ95EliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new AssaultRifle_QBZ95EliteRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public AssaultRifle_QBZ95EliteRow GetRow(rowIds in_RowID)
		{
			AssaultRifle_QBZ95EliteRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public AssaultRifle_QBZ95EliteRow GetRow(string in_RowString)
		{
			AssaultRifle_QBZ95EliteRow result = null;
