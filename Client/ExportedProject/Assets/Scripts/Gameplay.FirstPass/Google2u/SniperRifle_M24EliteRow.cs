...
{
	[Serializable]
	public class SniperRifle_M24EliteRow : IGoogle2uRow
	{
		...
		public SniperRifle_M24EliteRow()
		{
		}

		public SniperRifle_M24EliteRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
