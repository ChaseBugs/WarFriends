...
namespace Google2u
{
	public class GrenadeLauncher_QLZ87BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public string[] rowNames = new string[66]
		{
			...
			"ROW_61", "ROW_62", "ROW_63", "ROW_64", "ROW_65", "WARARENA"
		};
		...
		public List<GrenadeLauncher_QLZ87BMRow> Rows = new List<GrenadeLauncher_QLZ87BMRow>();

		public override bool haveDictionary => true;

		public override int getColumnCount => 11;
		...
		{
			Rows.Add(new GrenadeLauncher_QLZ87BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new GrenadeLauncher_QLZ87BMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public GrenadeLauncher_QLZ87BMRow GetRow(rowIds in_RowID)
		{
			GrenadeLauncher_QLZ87BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public GrenadeLauncher_QLZ87BMRow GetRow(string in_RowString)
		{
			GrenadeLauncher_QLZ87BMRow result = null;
