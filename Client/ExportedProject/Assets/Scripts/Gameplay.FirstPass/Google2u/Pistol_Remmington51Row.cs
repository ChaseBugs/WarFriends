...
{
	[Serializable]
	public class Pistol_Remmington51Row : IGoogle2uRow
	{
		...
		public Pistol_Remmington51Row()
		{
		}

		public Pistol_Remmington51Row(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
