...
{
	[Serializable]
	public class Bazooka_M202BMRow : IGoogle2uRow
	{
		...
		public Bazooka_M202BMRow()
		{
		}

		public Bazooka_M202BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
