...
{
	[Serializable]
	public class GrenadeLauncher_M79BMRow : IGoogle2uRow
	{
		...
		public GrenadeLauncher_M79BMRow()
		{
		}

		public GrenadeLauncher_M79BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _DEADRADIUS, string _ATTACK, string _WEAPONPRICE)
		{
