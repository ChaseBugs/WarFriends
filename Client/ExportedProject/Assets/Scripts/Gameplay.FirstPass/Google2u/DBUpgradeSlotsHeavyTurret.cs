...
namespace Google2u
{
	public class DBUpgradeSlotsHeavyTurret : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			CARDS_MIN,
		...
		public List<DBUpgradeSlotsHeavyTurretRow> Rows = new List<DBUpgradeSlotsHeavyTurretRow>();
		...
		{
			Rows.Add(new DBUpgradeSlotsHeavyTurretRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new DBUpgradeSlotsHeavyTurretRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public DBUpgradeSlotsHeavyTurretRow GetRow(rowIds in_RowID)
		{
			DBUpgradeSlotsHeavyTurretRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public DBUpgradeSlotsHeavyTurretRow GetRow(string in_RowString)
		{
			DBUpgradeSlotsHeavyTurretRow result = null;
