...
namespace Google2u
{
	public class Shotgun_SPAS : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_SPASRow> Rows = new List<Shotgun_SPASRow>();
		...
		{
			Rows.Add(new Shotgun_SPASRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public Shotgun_SPASRow GetRow(rowIds in_RowID)
		{
			Shotgun_SPASRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Shotgun_SPASRow GetRow(string in_RowString)
		{
			Shotgun_SPASRow result = null;
