...
namespace Google2u
{
	public class Bazooka_PanzerfaustBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Bazooka_PanzerfaustBMRow> Rows = new List<Bazooka_PanzerfaustBMRow>();
		...
		{
			Rows.Add(new Bazooka_PanzerfaustBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Bazooka_PanzerfaustBMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Bazooka_PanzerfaustBMRow GetRow(rowIds in_RowID)
		{
			Bazooka_PanzerfaustBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Bazooka_PanzerfaustBMRow GetRow(string in_RowString)
		{
			Bazooka_PanzerfaustBMRow result = null;
