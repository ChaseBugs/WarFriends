...
{
	[Serializable]
	public class AssaultRifle_AUGBMRow : IGoogle2uRow
	{
		...
		public AssaultRifle_AUGBMRow()
		{
		}

		public AssaultRifle_AUGBMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
