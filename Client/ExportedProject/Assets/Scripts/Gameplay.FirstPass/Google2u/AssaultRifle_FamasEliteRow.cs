...
{
	[Serializable]
	public class AssaultRifle_FamasEliteRow : IGoogle2uRow
	{
		...
		public AssaultRifle_FamasEliteRow()
		{
		}

		public AssaultRifle_FamasEliteRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
