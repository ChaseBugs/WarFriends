...
namespace Google2u
{
	public class AssaultRifle_SteyrAUG : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<AssaultRifle_SteyrAUGRow> Rows = new List<AssaultRifle_SteyrAUGRow>();
		...
		{
			Rows.Add(new AssaultRifle_SteyrAUGRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new AssaultRifle_SteyrAUGRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public AssaultRifle_SteyrAUGRow GetRow(rowIds in_RowID)
		{
			AssaultRifle_SteyrAUGRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public AssaultRifle_SteyrAUGRow GetRow(string in_RowString)
		{
			AssaultRifle_SteyrAUGRow result = null;
