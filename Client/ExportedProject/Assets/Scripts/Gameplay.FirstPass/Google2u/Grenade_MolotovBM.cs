...
namespace Google2u
{
	public class Grenade_MolotovBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Grenade_MolotovBMRow> Rows = new List<Grenade_MolotovBMRow>();
		...
		{
			Rows.Add(new Grenade_MolotovBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Grenade_MolotovBMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Grenade_MolotovBMRow GetRow(rowIds in_RowID)
		{
			Grenade_MolotovBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Grenade_MolotovBMRow GetRow(string in_RowString)
		{
			Grenade_MolotovBMRow result = null;
