...
{
	[Serializable]
	public class DBUpgradeSlotsTankRow : IGoogle2uRow
	{
		public int TIER;
		...
		public float SHOTFREQUENCYMINCANNON;

		public float SHOTFREQUENCYMAXCANNON;
		...
		public float Get_SHOTFREQUENCYMINCANNON
		{
			get
			{
		...
		public float Get_SHOTFREQUENCYMAXCANNON
		{
			get
			{
		...
		public override string ToString()
		{
			...
			empty = empty + "{SHOTFREQUENCYMINCANNON : " + SHOTFREQUENCYMINCANNON + "} ";
			empty = empty + "{SHOTFREQUENCYMAXCANNON : " + SHOTFREQUENCYMAXCANNON + "} ";
