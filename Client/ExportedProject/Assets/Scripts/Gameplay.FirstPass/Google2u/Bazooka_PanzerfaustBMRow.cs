...
{
	[Serializable]
	public class Bazooka_PanzerfaustBMRow : IGoogle2uRow
	{
		...
		public Bazooka_PanzerfaustBMRow()
		{
		}

		public Bazooka_PanzerfaustBMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
			...
			if (int.TryParse(_WEAPONPRICE, out var result10))
			{
