...
{
	[Serializable]
	public class SniperRifle_M110BMRow : IGoogle2uRow
	{
		...
		public SniperRifle_M110BMRow()
		{
		}

		public SniperRifle_M110BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
