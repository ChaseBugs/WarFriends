...
namespace Google2u
{
	public class Grenade_Molotov : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Grenade_MolotovRow> Rows = new List<Grenade_MolotovRow>();
		...
		{
			Rows.Add(new Grenade_MolotovRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Grenade_MolotovRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Grenade_MolotovRow GetRow(rowIds in_RowID)
		{
			Grenade_MolotovRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Grenade_MolotovRow GetRow(string in_RowString)
		{
			Grenade_MolotovRow result = null;
