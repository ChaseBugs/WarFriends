...
namespace Google2u
{
	public class AssaultRifle_G36BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<AssaultRifle_G36BMRow> Rows = new List<AssaultRifle_G36BMRow>();
		...
		{
			Rows.Add(new AssaultRifle_G36BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new AssaultRifle_G36BMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public AssaultRifle_G36BMRow GetRow(rowIds in_RowID)
		{
			AssaultRifle_G36BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public AssaultRifle_G36BMRow GetRow(string in_RowString)
		{
			AssaultRifle_G36BMRow result = null;
