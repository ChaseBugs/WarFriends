...
{
	[Serializable]
	public class AssaultRifle_M16Row : IGoogle2uRow
	{
		...
		public AssaultRifle_M16Row()
		{
		}

		public AssaultRifle_M16Row(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
