...
namespace Google2u
{
	public class PlayerBotDiffculties : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ID_1,
		...
		public string[] rowNames = new string[32]
		{
		...
		public List<PlayerBotDiffcultiesRow> Rows = new List<PlayerBotDiffcultiesRow>();

		public override bool haveDictionary => true;

		public override int getColumnCount => 29;
		...
		{
			Rows.Add(new PlayerBotDiffcultiesRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15], input[16], input[17], input[18], input[19], input[20], input[21], input[22], input[23], input[24], input[25], input[26], input[27], input[28], input[29]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new PlayerBotDiffcultiesRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public PlayerBotDiffcultiesRow GetRow(rowIds in_RowID)
		{
			PlayerBotDiffcultiesRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public PlayerBotDiffcultiesRow GetRow(string in_RowString)
		{
			PlayerBotDiffcultiesRow result = null;
