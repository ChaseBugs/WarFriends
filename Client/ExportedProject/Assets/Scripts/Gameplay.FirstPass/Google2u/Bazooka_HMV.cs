...
namespace Google2u
{
	public class Bazooka_HMV : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Bazooka_HMVRow> Rows = new List<Bazooka_HMVRow>();
		...
		{
			Rows.Add(new Bazooka_HMVRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public Bazooka_HMVRow GetRow(rowIds in_RowID)
		{
			Bazooka_HMVRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Bazooka_HMVRow GetRow(string in_RowString)
		{
			Bazooka_HMVRow result = null;
