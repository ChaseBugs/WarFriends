...
namespace Google2u
{
	public class DBUpgradeSlotsMinigunner : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public string[] rowNames = new string[66]
		{
			...
			"ROW_51", "SPECIAL_0", "SPECIAL_1", "SPECIAL_2", "SPECIAL_3", "SPECIAL_4", "SPECIAL_5", "ELITE_0", "ELITE_1", "ELITE_2",
		...
		public List<DBUpgradeSlotsMinigunnerRow> Rows = new List<DBUpgradeSlotsMinigunnerRow>();
		...
		{
			Rows.Add(new DBUpgradeSlotsMinigunnerRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15], input[16]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new DBUpgradeSlotsMinigunnerRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public DBUpgradeSlotsMinigunnerRow GetRow(rowIds in_RowID)
		{
			DBUpgradeSlotsMinigunnerRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public DBUpgradeSlotsMinigunnerRow GetRow(string in_RowString)
		{
			DBUpgradeSlotsMinigunnerRow result = null;
