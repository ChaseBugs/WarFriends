...
namespace Google2u
{
	public class MatchMakingConstants : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			...
			DamageModifierMatches,
			DamageModifierHP,
			DamageModifierMinValue,
			DamageModifierMaxValue
		}

		public string[] rowNames = new string[37]
		{
			...
			"CardsChoosingTime", "MaxMatchMakingRegionsiOS", "MaxMatchMakingRegionsAndroid", "DamageModifierMatches", "DamageModifierHP", "DamageModifierMinValue", "DamageModifierMaxValue"
		};
		...
		public Dictionary<string, int> namesToIndex = new Dictionary<string, int>
		{
			...
			{ "DamageModifierMatches", 33 },
			{ "DamageModifierHP", 34 },
			{ "DamageModifierMinValue", 35 },
			{ "DamageModifierMaxValue", 36 }
		};
