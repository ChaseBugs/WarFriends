...
{
	[Serializable]
	public class AssaultRifle_FamasBMRow : IGoogle2uRow
	{
		...
		public AssaultRifle_FamasBMRow()
		{
		}

		public AssaultRifle_FamasBMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
