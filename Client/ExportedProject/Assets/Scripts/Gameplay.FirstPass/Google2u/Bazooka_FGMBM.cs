...
namespace Google2u
{
	public class Bazooka_FGMBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Bazooka_FGMBMRow> Rows = new List<Bazooka_FGMBMRow>();
		...
		{
			Rows.Add(new Bazooka_FGMBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public Bazooka_FGMBMRow GetRow(rowIds in_RowID)
		{
			Bazooka_FGMBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Bazooka_FGMBMRow GetRow(string in_RowString)
		{
			Bazooka_FGMBMRow result = null;
