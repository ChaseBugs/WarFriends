...
namespace Google2u
{
	public class LMG_MG4 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<LMG_MG4Row> Rows = new List<LMG_MG4Row>();
		...
		{
			Rows.Add(new LMG_MG4Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public LMG_MG4Row GetRow(rowIds in_RowID)
		{
			LMG_MG4Row result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public LMG_MG4Row GetRow(string in_RowString)
		{
			LMG_MG4Row result = null;
