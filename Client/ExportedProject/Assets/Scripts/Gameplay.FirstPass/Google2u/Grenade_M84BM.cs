...
namespace Google2u
{
	public class Grenade_M84BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Grenade_M84BMRow> Rows = new List<Grenade_M84BMRow>();
		...
		{
			Rows.Add(new Grenade_M84BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public Grenade_M84BMRow GetRow(rowIds in_RowID)
		{
			Grenade_M84BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Grenade_M84BMRow GetRow(string in_RowString)
		{
			Grenade_M84BMRow result = null;
