...
namespace Google2u
{
	public class DBUpgradeSlotsAssaulter : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsAssaulterRow> Rows = new List<DBUpgradeSlotsAssaulterRow>();
		...
		{
			Rows.Add(new DBUpgradeSlotsAssaulterRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new DBUpgradeSlotsAssaulterRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public DBUpgradeSlotsAssaulterRow GetRow(rowIds in_RowID)
		{
			DBUpgradeSlotsAssaulterRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public DBUpgradeSlotsAssaulterRow GetRow(string in_RowString)
		{
			DBUpgradeSlotsAssaulterRow result = null;
