...
{
	[Serializable]
	public class SniperRifle_M24BMRow : IGoogle2uRow
	{
		...
		public SniperRifle_M24BMRow()
		{
		}

		public SniperRifle_M24BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
