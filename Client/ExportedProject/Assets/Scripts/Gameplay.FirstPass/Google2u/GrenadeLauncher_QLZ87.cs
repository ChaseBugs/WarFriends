...
namespace Google2u
{
	public class GrenadeLauncher_QLZ87 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<GrenadeLauncher_QLZ87Row> Rows = new List<GrenadeLauncher_QLZ87Row>();
		...
		{
			Rows.Add(new GrenadeLauncher_QLZ87Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new GrenadeLauncher_QLZ87Row());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public GrenadeLauncher_QLZ87Row GetRow(rowIds in_RowID)
		{
			GrenadeLauncher_QLZ87Row result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public GrenadeLauncher_QLZ87Row GetRow(string in_RowString)
		{
			GrenadeLauncher_QLZ87Row result = null;
