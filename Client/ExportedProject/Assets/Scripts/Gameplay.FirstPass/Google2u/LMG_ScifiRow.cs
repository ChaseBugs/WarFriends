...
{
	[Serializable]
	public class LMG_ScifiRow : IGoogle2uRow
	{
		...
		public LMG_ScifiRow(string _GOOGLEFU_ID, string _HEATTIME, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
