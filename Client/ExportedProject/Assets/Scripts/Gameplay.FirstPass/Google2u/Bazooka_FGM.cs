...
namespace Google2u
{
	public class Bazooka_FGM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Bazooka_FGMRow> Rows = new List<Bazooka_FGMRow>();
		...
		{
			Rows.Add(new Bazooka_FGMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public Bazooka_FGMRow GetRow(rowIds in_RowID)
		{
			Bazooka_FGMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Bazooka_FGMRow GetRow(string in_RowString)
		{
			Bazooka_FGMRow result = null;
