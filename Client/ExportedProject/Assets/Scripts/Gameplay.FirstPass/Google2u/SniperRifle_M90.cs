...
namespace Google2u
{
	public class SniperRifle_M90 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<SniperRifle_M90Row> Rows = new List<SniperRifle_M90Row>();
		...
		{
			Rows.Add(new SniperRifle_M90Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new SniperRifle_M90Row());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public SniperRifle_M90Row GetRow(rowIds in_RowID)
		{
			SniperRifle_M90Row result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public SniperRifle_M90Row GetRow(string in_RowString)
		{
			SniperRifle_M90Row result = null;
