...
namespace Google2u
{
	public class LMG_PKMachinegun : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<LMG_PKMachinegunRow> Rows = new List<LMG_PKMachinegunRow>();
		...
		{
			Rows.Add(new LMG_PKMachinegunRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new LMG_PKMachinegunRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public LMG_PKMachinegunRow GetRow(rowIds in_RowID)
		{
			LMG_PKMachinegunRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public LMG_PKMachinegunRow GetRow(string in_RowString)
		{
			LMG_PKMachinegunRow result = null;
