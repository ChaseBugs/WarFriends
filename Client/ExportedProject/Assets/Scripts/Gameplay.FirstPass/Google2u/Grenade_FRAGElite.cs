...
namespace Google2u
{
	public class Grenade_FRAGElite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Grenade_FRAGEliteRow> Rows = new List<Grenade_FRAGEliteRow>();
		...
		{
			Rows.Add(new Grenade_FRAGEliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Grenade_FRAGEliteRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Grenade_FRAGEliteRow GetRow(rowIds in_RowID)
		{
			Grenade_FRAGEliteRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Grenade_FRAGEliteRow GetRow(string in_RowString)
		{
			Grenade_FRAGEliteRow result = null;
