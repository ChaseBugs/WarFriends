...
namespace Google2u
{
	public class GrenadeLauncher_M320BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public string[] rowNames = new string[36]
		{
			...
			"ROW_31", "ROW_32", "ROW_33", "ROW_34", "ROW_35", "WARARENA"
		};
		...
		public List<GrenadeLauncher_M320BMRow> Rows = new List<GrenadeLauncher_M320BMRow>();
		...
		{
			Rows.Add(new GrenadeLauncher_M320BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new GrenadeLauncher_M320BMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public GrenadeLauncher_M320BMRow GetRow(rowIds in_RowID)
		{
			GrenadeLauncher_M320BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public GrenadeLauncher_M320BMRow GetRow(string in_RowString)
		{
			GrenadeLauncher_M320BMRow result = null;
