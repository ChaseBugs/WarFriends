...
namespace Google2u
{
	public class MissionsRewards : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ID_1,
		...
		public string[] rowNames = new string[9] { "ID_1", "ID_2", "ID_3", "ID_4", "ID_5", "ID_6", "ID_7", "ID_8", "ID_9" };
		...
		public List<MissionsRewardsRow> Rows = new List<MissionsRewardsRow>();
		...
		{
			Rows.Add(new MissionsRewardsRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new MissionsRewardsRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public MissionsRewardsRow GetRow(rowIds in_RowID)
		{
			MissionsRewardsRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public MissionsRewardsRow GetRow(string in_RowString)
		{
			MissionsRewardsRow result = null;
