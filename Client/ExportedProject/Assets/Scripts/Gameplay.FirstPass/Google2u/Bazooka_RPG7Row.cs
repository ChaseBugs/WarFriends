...
{
	[Serializable]
	public class Bazooka_RPG7Row : IGoogle2uRow
	{
		...
		public Bazooka_RPG7Row()
		{
		}

		public Bazooka_RPG7Row(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
