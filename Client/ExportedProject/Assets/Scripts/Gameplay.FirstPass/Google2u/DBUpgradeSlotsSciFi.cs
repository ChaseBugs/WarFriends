...
namespace Google2u
{
	public class DBUpgradeSlotsSciFi : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsSciFiRow> Rows = new List<DBUpgradeSlotsSciFiRow>();
		...
		{
			Rows.Add(new DBUpgradeSlotsSciFiRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15], input[16], input[17]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new DBUpgradeSlotsSciFiRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public DBUpgradeSlotsSciFiRow GetRow(rowIds in_RowID)
		{
			DBUpgradeSlotsSciFiRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public DBUpgradeSlotsSciFiRow GetRow(string in_RowString)
		{
			DBUpgradeSlotsSciFiRow result = null;
