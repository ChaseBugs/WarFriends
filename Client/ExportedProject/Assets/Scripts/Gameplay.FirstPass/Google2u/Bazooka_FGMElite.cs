...
namespace Google2u
{
	public class Bazooka_FGMElite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Bazooka_FGMEliteRow> Rows = new List<Bazooka_FGMEliteRow>();
		...
		{
			Rows.Add(new Bazooka_FGMEliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Bazooka_FGMEliteRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Bazooka_FGMEliteRow GetRow(rowIds in_RowID)
		{
			Bazooka_FGMEliteRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Bazooka_FGMEliteRow GetRow(string in_RowString)
		{
			Bazooka_FGMEliteRow result = null;
