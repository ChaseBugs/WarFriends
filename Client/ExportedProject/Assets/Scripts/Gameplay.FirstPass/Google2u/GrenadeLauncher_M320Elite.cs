...
namespace Google2u
{
	public class GrenadeLauncher_M320Elite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<GrenadeLauncher_M320EliteRow> Rows = new List<GrenadeLauncher_M320EliteRow>();
		...
		{
			Rows.Add(new GrenadeLauncher_M320EliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new GrenadeLauncher_M320EliteRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public GrenadeLauncher_M320EliteRow GetRow(rowIds in_RowID)
		{
			GrenadeLauncher_M320EliteRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public GrenadeLauncher_M320EliteRow GetRow(string in_RowString)
		{
			GrenadeLauncher_M320EliteRow result = null;
