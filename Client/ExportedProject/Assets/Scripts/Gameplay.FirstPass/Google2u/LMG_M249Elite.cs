...
namespace Google2u
{
	public class LMG_M249Elite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<LMG_M249EliteRow> Rows = new List<LMG_M249EliteRow>();
		...
		{
			Rows.Add(new LMG_M249EliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public LMG_M249EliteRow GetRow(rowIds in_RowID)
		{
			LMG_M249EliteRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public LMG_M249EliteRow GetRow(string in_RowString)
		{
			LMG_M249EliteRow result = null;
