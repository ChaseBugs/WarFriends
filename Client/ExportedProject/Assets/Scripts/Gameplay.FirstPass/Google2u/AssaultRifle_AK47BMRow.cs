...
{
	[Serializable]
	public class AssaultRifle_AK47BMRow : IGoogle2uRow
	{
		...
		public AssaultRifle_AK47BMRow()
		{
		}

		public AssaultRifle_AK47BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
