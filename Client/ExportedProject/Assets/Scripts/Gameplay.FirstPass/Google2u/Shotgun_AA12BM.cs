...
namespace Google2u
{
	public class Shotgun_AA12BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_AA12BMRow> Rows = new List<Shotgun_AA12BMRow>();
		...
		{
			Rows.Add(new Shotgun_AA12BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Shotgun_AA12BMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Shotgun_AA12BMRow GetRow(rowIds in_RowID)
		{
			Shotgun_AA12BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Shotgun_AA12BMRow GetRow(string in_RowString)
		{
			Shotgun_AA12BMRow result = null;
