...
namespace Google2u
{
	public class Bazooka_RPG7Elite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Bazooka_RPG7EliteRow> Rows = new List<Bazooka_RPG7EliteRow>();
		...
		{
			Rows.Add(new Bazooka_RPG7EliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Bazooka_RPG7EliteRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Bazooka_RPG7EliteRow GetRow(rowIds in_RowID)
		{
			Bazooka_RPG7EliteRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Bazooka_RPG7EliteRow GetRow(string in_RowString)
		{
			Bazooka_RPG7EliteRow result = null;
