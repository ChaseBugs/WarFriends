...
{
	[Serializable]
	public class Shotgun_BenelliSPRow : IGoogle2uRow
	{
		...
		public Shotgun_BenelliSPRow()
		{
		}

		public Shotgun_BenelliSPRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _MINDAMAGE, string _MAXDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
