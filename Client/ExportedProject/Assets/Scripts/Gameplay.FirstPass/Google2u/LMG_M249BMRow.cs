...
{
	[Serializable]
	public class LMG_M249BMRow : IGoogle2uRow
	{
		...
		public LMG_M249BMRow()
		{
		}

		public LMG_M249BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
