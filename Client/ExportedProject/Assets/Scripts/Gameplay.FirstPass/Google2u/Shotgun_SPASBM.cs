...
namespace Google2u
{
	public class Shotgun_SPASBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_SPASBMRow> Rows = new List<Shotgun_SPASBMRow>();
		...
		{
			Rows.Add(new Shotgun_SPASBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Shotgun_SPASBMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Shotgun_SPASBMRow GetRow(rowIds in_RowID)
		{
			Shotgun_SPASBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Shotgun_SPASBMRow GetRow(string in_RowString)
		{
			Shotgun_SPASBMRow result = null;
