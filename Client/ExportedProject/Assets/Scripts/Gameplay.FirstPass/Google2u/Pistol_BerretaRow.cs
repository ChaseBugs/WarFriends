...
{
	[Serializable]
	public class Pistol_BerretaRow : IGoogle2uRow
	{
		...
		public Pistol_BerretaRow()
		{
		}

		public Pistol_BerretaRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
