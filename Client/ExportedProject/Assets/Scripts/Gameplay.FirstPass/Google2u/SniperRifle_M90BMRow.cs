...
{
	[Serializable]
	public class SniperRifle_M90BMRow : IGoogle2uRow
	{
		...
		public SniperRifle_M90BMRow()
		{
		}

		public SniperRifle_M90BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
