...
public static class NGUITools
{
	...
	// Unity 2018 removed both WebPlayer enum values with compile-time errors. WarFriends 4.9.5
	// targets Android and the Unity Editor, where local file access is available, so the old
	// WebPlayer exclusion reduces to true for every platform this recovered project supports.
	...
	public static Camera FindCameraForLayer(int layer)
	{
		...
		{
			return UICamera.instance.cachedCamera;
		}
		int num = 1 << layer;
