...
{
	[Serializable]
	public class SMG_ApolloRow : IGoogle2uRow
	{
		...
		public SMG_ApolloRow()
		{
		}

		public SMG_ApolloRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
		}
