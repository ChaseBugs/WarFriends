...
namespace Google2u
{
	public class GrenadeLauncher_GLT9 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<GrenadeLauncher_GLT9Row> Rows;
		...
		public GrenadeLauncher_GLT9Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public GrenadeLauncher_GLT9Row GetRow(string in_RowString)
		{
			return null;
		}
	}
