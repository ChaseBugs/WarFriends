...
namespace Google2u
{
	public class DBUpgradeSlotsInstinct : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsInstinctRow> Rows;
		...
		public DBUpgradeSlotsInstinctRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsInstinctRow GetRow(string in_RowString)
		{
			return null;
		}
	}
