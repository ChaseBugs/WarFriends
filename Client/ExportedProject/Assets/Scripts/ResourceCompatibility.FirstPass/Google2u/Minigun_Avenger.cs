...
namespace Google2u
{
	public class Minigun_Avenger : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Minigun_AvengerRow> Rows;
		...
		public Minigun_AvengerRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Minigun_AvengerRow GetRow(string in_RowString)
		{
			return null;
		}
	}
