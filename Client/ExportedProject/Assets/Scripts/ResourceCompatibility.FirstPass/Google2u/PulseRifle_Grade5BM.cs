...
namespace Google2u
{
	public class PulseRifle_Grade5BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_Grade5BMRow> Rows;
		...
		public PulseRifle_Grade5BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_Grade5BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
