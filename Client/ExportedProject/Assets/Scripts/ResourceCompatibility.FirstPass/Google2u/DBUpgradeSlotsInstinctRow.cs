...
{
	[Serializable]
	public class DBUpgradeSlotsInstinctRow : IGoogle2uRow
	{
		public int TIER;
		...
		public float LASERVISIBILITYDURATION;

		public float DELAYBEFORELASERDAMAGE;
		...
		public float Get_LASERVISIBILITYDURATION
		{
			get
			{
				return 0f;
		...
		public float Get_DELAYBEFORELASERDAMAGE
		{
			get
			{
				return 0f;
		...
		public DBUpgradeSlotsInstinctRow()
		{
		}

		public DBUpgradeSlotsInstinctRow(string _GOOGLEFU_ID, string _TIER, string _HP, string _DAMAGE, string _BATCHSIZEMIN, string _BATCHSIZEMAX, string _SHOTFREQUENCYMIN, string _SHOTFREQUENCYMAX, string _REALSHOTPROBABILITY, string _LASERVISIBILITYDURATION, string _DELAYBEFORELASERDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ARMYPOWER, string _SPECIAL, string _ELITE)
		{
		}
