...
namespace Google2u
{
	public class AugmentationCrates : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			basic,
		...
		public List<AugmentationCratesRow> Rows;
		...
		public AugmentationCratesRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public AugmentationCratesRow GetRow(string in_RowString)
		{
			return null;
		}
	}
