...
namespace Google2u
{
	public class Bazooka_JuggernautElite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Bazooka_JuggernautEliteRow> Rows;
		...
		public Bazooka_JuggernautEliteRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Bazooka_JuggernautEliteRow GetRow(string in_RowString)
		{
			return null;
		}
	}
