...
namespace Google2u
{
	public class PulseRifle_Grade1 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_Grade1Row> Rows;
		...
		public PulseRifle_Grade1Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_Grade1Row GetRow(string in_RowString)
		{
			return null;
		}
	}
