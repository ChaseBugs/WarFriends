...
namespace Google2u
{
	public class Shotgun_SGT9BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_SGT9BMRow> Rows;
		...
		public Shotgun_SGT9BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Shotgun_SGT9BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
