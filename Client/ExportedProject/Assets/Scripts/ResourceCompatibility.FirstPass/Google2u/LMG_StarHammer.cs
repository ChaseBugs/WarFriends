...
namespace Google2u
{
	public class LMG_StarHammer : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<LMG_StarHammerRow> Rows;
		...
		public LMG_StarHammerRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public LMG_StarHammerRow GetRow(string in_RowString)
		{
			return null;
		}
	}
