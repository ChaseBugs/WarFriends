...
namespace Google2u
{
	public class SniperRifle_3EyesBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<SniperRifle_3EyesBMRow> Rows;
		...
		public SniperRifle_3EyesBMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SniperRifle_3EyesBMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
