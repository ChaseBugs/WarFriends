...
{
	[Serializable]
	public class DBUpgradeSlotsSpecterRow : IGoogle2uRow
	{
		public int TIER;
		...
		public ObscuredFloat GHOSTTHRESHOLD;
		...
		public ObscuredFloat Get_GHOSTTHRESHOLD
		{
			get
			{
				return default(ObscuredFloat);
