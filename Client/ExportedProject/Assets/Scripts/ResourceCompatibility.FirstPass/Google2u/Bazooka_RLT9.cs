...
namespace Google2u
{
	public class Bazooka_RLT9 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Bazooka_RLT9Row> Rows;
		...
		public Bazooka_RLT9Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Bazooka_RLT9Row GetRow(string in_RowString)
		{
			return null;
		}
	}
