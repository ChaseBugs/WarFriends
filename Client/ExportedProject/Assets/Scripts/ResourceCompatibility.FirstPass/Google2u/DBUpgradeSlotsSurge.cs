...
namespace Google2u
{
	public class DBUpgradeSlotsSurge : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsSurgeRow> Rows;
		...
		public DBUpgradeSlotsSurgeRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsSurgeRow GetRow(string in_RowString)
		{
			return null;
		}
	}
