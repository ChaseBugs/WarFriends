...
{
	[Serializable]
	public class DBUpgradeSlotsSilverstrikeRow : IGoogle2uRow
	{
		public int TIER;
		...
		public ObscuredFloat SWORDDAMAGE;
		...
		public ObscuredFloat Get_SWORDDAMAGE
		{
			get
			{
				return default(ObscuredFloat);
