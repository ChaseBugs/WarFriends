...
namespace Google2u
{
	public class Bazooka_JuggernautBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Bazooka_JuggernautBMRow> Rows;
		...
		public Bazooka_JuggernautBMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Bazooka_JuggernautBMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
