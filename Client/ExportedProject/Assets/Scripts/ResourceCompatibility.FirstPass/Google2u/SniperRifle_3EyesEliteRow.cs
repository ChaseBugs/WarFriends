...
{
	[Serializable]
	public class SniperRifle_3EyesEliteRow : IGoogle2uRow
	{
		...
		public SniperRifle_3EyesEliteRow()
		{
		}

		public SniperRifle_3EyesEliteRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
		}
