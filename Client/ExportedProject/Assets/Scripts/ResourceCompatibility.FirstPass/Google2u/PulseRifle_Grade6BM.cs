...
namespace Google2u
{
	public class PulseRifle_Grade6BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_Grade6BMRow> Rows;
		...
		public PulseRifle_Grade6BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_Grade6BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
