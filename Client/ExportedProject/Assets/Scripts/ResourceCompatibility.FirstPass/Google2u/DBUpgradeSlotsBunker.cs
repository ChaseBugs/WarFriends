...
namespace Google2u
{
	public class DBUpgradeSlotsBunker : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsBunkerRow> Rows;
		...
		public DBUpgradeSlotsBunkerRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsBunkerRow GetRow(string in_RowString)
		{
			return null;
		}
	}
