...
namespace Google2u
{
	public class AdBoosterWeights : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ID_1,
		...
		public List<AdBoosterWeightsRow> Rows;
		...
		public AdBoosterWeightsRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public AdBoosterWeightsRow GetRow(string in_RowString)
		{
			return null;
		}
	}
