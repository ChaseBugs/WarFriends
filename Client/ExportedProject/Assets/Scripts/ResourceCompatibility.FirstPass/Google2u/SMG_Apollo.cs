...
namespace Google2u
{
	public class SMG_Apollo : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<SMG_ApolloRow> Rows;
		...
		public SMG_ApolloRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SMG_ApolloRow GetRow(string in_RowString)
		{
			return null;
		}
	}
