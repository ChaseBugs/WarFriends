...
namespace Google2u
{
	public class LMG_StarHammerBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<LMG_StarHammerBMRow> Rows;
		...
		public LMG_StarHammerBMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public LMG_StarHammerBMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
