...
namespace Google2u
{
	public class LMG_T9BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public LMG_T9BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public LMG_T9BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
