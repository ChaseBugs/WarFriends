...
namespace Google2u
{
	public class GrenadeLauncher_GLT8 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<GrenadeLauncher_GLT8Row> Rows;
		...
		public GrenadeLauncher_GLT8Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public GrenadeLauncher_GLT8Row GetRow(string in_RowString)
		{
			return null;
		}
	}
