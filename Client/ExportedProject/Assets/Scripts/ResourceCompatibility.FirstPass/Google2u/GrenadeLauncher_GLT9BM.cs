...
namespace Google2u
{
	public class GrenadeLauncher_GLT9BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<GrenadeLauncher_GLT9BMRow> Rows;
		...
		public GrenadeLauncher_GLT9BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public GrenadeLauncher_GLT9BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
