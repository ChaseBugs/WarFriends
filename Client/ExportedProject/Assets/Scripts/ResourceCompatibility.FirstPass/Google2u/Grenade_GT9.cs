...
namespace Google2u
{
	public class Grenade_GT9 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Grenade_GT9Row> Rows;
		...
		public Grenade_GT9Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Grenade_GT9Row GetRow(string in_RowString)
		{
			return null;
		}
	}
