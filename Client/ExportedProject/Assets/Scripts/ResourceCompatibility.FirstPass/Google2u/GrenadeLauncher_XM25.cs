...
namespace Google2u
{
	public class GrenadeLauncher_XM25 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<GrenadeLauncher_XM25Row> Rows;
		...
		public GrenadeLauncher_XM25Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public GrenadeLauncher_XM25Row GetRow(string in_RowString)
		{
			return null;
		}
	}
