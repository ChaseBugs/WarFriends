...
namespace Google2u
{
	public class PulseRifle_Grade7 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_Grade7Row> Rows;
		...
		public PulseRifle_Grade7Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_Grade7Row GetRow(string in_RowString)
		{
			return null;
		}
	}
