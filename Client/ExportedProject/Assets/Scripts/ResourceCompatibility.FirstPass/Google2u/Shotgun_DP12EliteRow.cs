...
{
	[Serializable]
	public class Shotgun_DP12EliteRow : IGoogle2uRow
	{
		...
		public Shotgun_DP12EliteRow()
		{
		}

		public Shotgun_DP12EliteRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _MINDAMAGE, string _MAXDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
		}
