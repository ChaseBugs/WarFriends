...
namespace Google2u
{
	public class Bazooka_Juggernaut : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Bazooka_JuggernautRow> Rows;
		...
		public Bazooka_JuggernautRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Bazooka_JuggernautRow GetRow(string in_RowString)
		{
			return null;
		}
	}
