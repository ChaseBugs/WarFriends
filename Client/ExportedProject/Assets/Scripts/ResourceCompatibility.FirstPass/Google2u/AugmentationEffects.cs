...
namespace Google2u
{
	public class AugmentationEffects : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ID_0,
		...
		public List<AugmentationEffectsRow> Rows;
		...
		public AugmentationEffectsRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public AugmentationEffectsRow GetRow(string in_RowString)
		{
			return null;
		}
	}
