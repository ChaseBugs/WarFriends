...
namespace Google2u
{
	public class PulseRifle_Grade8 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_Grade8Row> Rows;
		...
		public PulseRifle_Grade8Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_Grade8Row GetRow(string in_RowString)
		{
			return null;
		}
	}
