...
namespace Google2u
{
	public class AugmentationLevels : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ID_0,
		...
		public List<AugmentationLevelsRow> Rows;
		...
		public AugmentationLevelsRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public AugmentationLevelsRow GetRow(string in_RowString)
		{
			return null;
		}
	}
