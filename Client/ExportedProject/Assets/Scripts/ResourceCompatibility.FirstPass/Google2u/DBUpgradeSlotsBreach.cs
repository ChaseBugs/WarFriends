...
namespace Google2u
{
	public class DBUpgradeSlotsBreach : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsBreachRow> Rows;
		...
		public DBUpgradeSlotsBreachRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsBreachRow GetRow(string in_RowString)
		{
			return null;
		}
	}
