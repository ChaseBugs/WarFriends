...
namespace Google2u
{
	public class WeaponAugLevels : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ID_0,
		...
		public List<WeaponAugLevelsRow> Rows;
		...
		public WeaponAugLevelsRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public WeaponAugLevelsRow GetRow(string in_RowString)
		{
			return null;
		}
	}
