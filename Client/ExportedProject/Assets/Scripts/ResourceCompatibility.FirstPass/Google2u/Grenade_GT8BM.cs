...
namespace Google2u
{
	public class Grenade_GT8BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Grenade_GT8BMRow> Rows;
		...
		public Grenade_GT8BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Grenade_GT8BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
