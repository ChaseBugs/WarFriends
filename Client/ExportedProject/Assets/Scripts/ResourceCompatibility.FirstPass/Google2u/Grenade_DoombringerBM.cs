...
namespace Google2u
{
	public class Grenade_DoombringerBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Grenade_DoombringerBMRow> Rows;
		...
		public Grenade_DoombringerBMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Grenade_DoombringerBMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
