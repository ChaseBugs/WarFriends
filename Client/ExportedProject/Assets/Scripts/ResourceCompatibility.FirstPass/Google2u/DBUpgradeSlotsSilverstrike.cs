...
namespace Google2u
{
	public class DBUpgradeSlotsSilverstrike : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsSilverstrikeRow> Rows;
		...
		public DBUpgradeSlotsSilverstrikeRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsSilverstrikeRow GetRow(string in_RowString)
		{
			return null;
		}
	}
