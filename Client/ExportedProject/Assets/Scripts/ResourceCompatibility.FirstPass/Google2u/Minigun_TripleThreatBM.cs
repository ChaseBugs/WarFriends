...
namespace Google2u
{
	public class Minigun_TripleThreatBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Minigun_TripleThreatBMRow> Rows;
		...
		public Minigun_TripleThreatBMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Minigun_TripleThreatBMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
