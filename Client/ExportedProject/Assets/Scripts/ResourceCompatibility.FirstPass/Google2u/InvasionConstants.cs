...
namespace Google2u
{
	public class InvasionConstants : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			...
			maxNumOfDogtags,
			dogtagRefillTime,
			invaderSpawnDelayMin,
			invaderSpawnDelayMax,
			invaderShieldDurability,
			invaderShieldReplenishTime,
			unitSpawnDelayMin,
			unitSpawnDelayMax,
			battleDurationMax,
			maxUnitsOnField,
		...
		public List<InvasionConstantsRow> Rows;
		...
		public InvasionConstantsRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public InvasionConstantsRow GetRow(string in_RowString)
		{
			return null;
		}
	}
