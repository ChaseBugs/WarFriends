...
namespace Google2u
{
	public class Pistol_P320 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Pistol_P320Row> Rows;
		...
		public Pistol_P320Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Pistol_P320Row GetRow(string in_RowString)
		{
			return null;
		}
	}
