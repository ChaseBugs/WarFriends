...
namespace Google2u
{
	public class Shotgun_SGT8 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_SGT8Row> Rows;
		...
		public Shotgun_SGT8Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Shotgun_SGT8Row GetRow(string in_RowString)
		{
			return null;
		}
	}
