...
namespace Google2u
{
	public class LMG_T9 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public LMG_T9Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public LMG_T9Row GetRow(string in_RowString)
		{
			return null;
		}
	}
