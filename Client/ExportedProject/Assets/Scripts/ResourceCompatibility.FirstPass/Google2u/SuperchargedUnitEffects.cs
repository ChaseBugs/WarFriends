...
namespace Google2u
{
	public class SuperchargedUnitEffects : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ID_0,
		...
		public List<SuperchargedUnitEffectsRow> Rows;
		...
		public SuperchargedUnitEffectsRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SuperchargedUnitEffectsRow GetRow(string in_RowString)
		{
			return null;
		}
	}
