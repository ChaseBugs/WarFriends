...
{
	[Serializable]
	public class Bazooka_RLT9Row : IGoogle2uRow
	{
		...
		public Bazooka_RLT9Row()
		{
		}

		public Bazooka_RLT9Row(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
		}
