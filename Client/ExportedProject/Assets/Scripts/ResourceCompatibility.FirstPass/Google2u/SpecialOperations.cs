...
namespace Google2u
{
	public class SpecialOperations : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ID_0,
		...
		public List<SpecialOperationsRow> Rows;
		...
		public SpecialOperationsRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SpecialOperationsRow GetRow(string in_RowString)
		{
			return null;
		}
	}
