...
namespace Google2u
{
	public class Grenade_GT8 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Grenade_GT8Row> Rows;
		...
		public Grenade_GT8Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Grenade_GT8Row GetRow(string in_RowString)
		{
			return null;
		}
	}
