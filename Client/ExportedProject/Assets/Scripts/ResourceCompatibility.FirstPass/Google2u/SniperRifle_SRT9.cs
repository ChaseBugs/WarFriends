...
namespace Google2u
{
	public class SniperRifle_SRT9 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<SniperRifle_SRT9Row> Rows;
		...
		public SniperRifle_SRT9Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SniperRifle_SRT9Row GetRow(string in_RowString)
		{
			return null;
		}
	}
