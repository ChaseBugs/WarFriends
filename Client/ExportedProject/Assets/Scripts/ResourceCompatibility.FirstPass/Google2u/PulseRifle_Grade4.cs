...
namespace Google2u
{
	public class PulseRifle_Grade4 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_Grade4Row> Rows;
		...
		public PulseRifle_Grade4Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_Grade4Row GetRow(string in_RowString)
		{
			return null;
		}
	}
