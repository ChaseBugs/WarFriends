...
namespace Google2u
{
	public class Shotgun_DP12 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_DP12Row> Rows;
		...
		public Shotgun_DP12Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Shotgun_DP12Row GetRow(string in_RowString)
		{
			return null;
		}
	}
