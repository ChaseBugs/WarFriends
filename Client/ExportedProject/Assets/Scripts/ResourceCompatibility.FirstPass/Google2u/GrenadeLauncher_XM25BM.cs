...
namespace Google2u
{
	public class GrenadeLauncher_XM25BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<GrenadeLauncher_XM25BMRow> Rows;
		...
		public GrenadeLauncher_XM25BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public GrenadeLauncher_XM25BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
