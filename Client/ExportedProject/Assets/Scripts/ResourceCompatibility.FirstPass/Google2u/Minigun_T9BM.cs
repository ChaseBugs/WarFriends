...
namespace Google2u
{
	public class Minigun_T9BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Minigun_T9BMRow> Rows;
		...
		public Minigun_T9BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Minigun_T9BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
