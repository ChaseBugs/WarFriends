...
{
	[Serializable]
	public class GrenadeLauncher_XM25BMRow : IGoogle2uRow
	{
		...
		public GrenadeLauncher_XM25BMRow()
		{
		}

		public GrenadeLauncher_XM25BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _DEADRADIUS, string _ATTACK, string _WEAPONPRICE)
		{
		}
