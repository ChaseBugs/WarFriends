...
namespace Google2u
{
	public class Shotgun_DP12BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_DP12BMRow> Rows;
		...
		public Shotgun_DP12BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Shotgun_DP12BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
