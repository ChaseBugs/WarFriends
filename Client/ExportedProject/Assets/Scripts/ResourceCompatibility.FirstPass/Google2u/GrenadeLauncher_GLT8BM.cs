...
namespace Google2u
{
	public class GrenadeLauncher_GLT8BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<GrenadeLauncher_GLT8BMRow> Rows;
		...
		public GrenadeLauncher_GLT8BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public GrenadeLauncher_GLT8BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
