...
namespace Google2u
{
	public class AssaultRifle_ART9BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<AssaultRifle_ART9BMRow> Rows;
		...
		public AssaultRifle_ART9BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public AssaultRifle_ART9BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
