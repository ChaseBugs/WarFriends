...
namespace Google2u
{
	public class SMG_ST9 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public SMG_ST9Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SMG_ST9Row GetRow(string in_RowString)
		{
			return null;
		}
	}
