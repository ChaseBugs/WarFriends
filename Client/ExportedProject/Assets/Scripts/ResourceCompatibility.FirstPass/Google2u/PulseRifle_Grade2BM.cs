...
namespace Google2u
{
	public class PulseRifle_Grade2BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_Grade2BMRow> Rows;
		...
		public PulseRifle_Grade2BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_Grade2BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
