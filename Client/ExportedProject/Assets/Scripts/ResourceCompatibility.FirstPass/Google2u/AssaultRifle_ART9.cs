...
namespace Google2u
{
	public class AssaultRifle_ART9 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<AssaultRifle_ART9Row> Rows;
		...
		public AssaultRifle_ART9Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public AssaultRifle_ART9Row GetRow(string in_RowString)
		{
			return null;
		}
	}
