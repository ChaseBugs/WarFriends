...
namespace Google2u
{
	public class SMG_Apollo_elite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<SMG_Apollo_eliteRow> Rows;
		...
		public SMG_Apollo_eliteRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SMG_Apollo_eliteRow GetRow(string in_RowString)
		{
			return null;
		}
	}
