...
{
	[Serializable]
	public class Pistol_P320Row : IGoogle2uRow
	{
		...
		public Pistol_P320Row()
		{
		}

		public Pistol_P320Row(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
		}
