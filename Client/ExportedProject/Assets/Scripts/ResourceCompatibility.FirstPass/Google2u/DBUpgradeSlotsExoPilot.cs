...
namespace Google2u
{
	public class DBUpgradeSlotsExoPilot : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsExoPilotRow> Rows;
		...
		public DBUpgradeSlotsExoPilotRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsExoPilotRow GetRow(string in_RowString)
		{
			return null;
		}
	}
