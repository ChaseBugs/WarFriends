...
namespace Google2u
{
	public class SniperRifle_3EyesElite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<SniperRifle_3EyesEliteRow> Rows;
		...
		public SniperRifle_3EyesEliteRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SniperRifle_3EyesEliteRow GetRow(string in_RowString)
		{
			return null;
		}
	}
