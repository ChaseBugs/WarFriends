...
namespace Google2u
{
	public class PulseRifle_Grade3 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_Grade3Row> Rows;
		...
		public PulseRifle_Grade3Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_Grade3Row GetRow(string in_RowString)
		{
			return null;
		}
	}
