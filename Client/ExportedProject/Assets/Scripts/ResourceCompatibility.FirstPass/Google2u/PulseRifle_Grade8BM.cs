...
namespace Google2u
{
	public class PulseRifle_Grade8BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_Grade8BMRow> Rows;
		...
		public PulseRifle_Grade8BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_Grade8BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
