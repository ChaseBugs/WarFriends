...
{
	[Serializable]
	public class AssaultRifle_ART8Row : IGoogle2uRow
	{
		...
		public AssaultRifle_ART8Row()
		{
		}

		public AssaultRifle_ART8Row(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
		}
