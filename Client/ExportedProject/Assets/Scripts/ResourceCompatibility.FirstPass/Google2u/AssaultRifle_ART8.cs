...
namespace Google2u
{
	public class AssaultRifle_ART8 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<AssaultRifle_ART8Row> Rows;
		...
		public AssaultRifle_ART8Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public AssaultRifle_ART8Row GetRow(string in_RowString)
		{
			return null;
		}
	}
