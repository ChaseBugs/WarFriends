...
namespace Google2u
{
	public class Minigun_Vindicator : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Minigun_VindicatorRow> Rows;
		...
		public Minigun_VindicatorRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Minigun_VindicatorRow GetRow(string in_RowString)
		{
			return null;
		}
	}
