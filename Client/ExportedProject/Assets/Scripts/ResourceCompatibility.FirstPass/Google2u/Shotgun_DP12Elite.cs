...
namespace Google2u
{
	public class Shotgun_DP12Elite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_DP12EliteRow> Rows;
		...
		public Shotgun_DP12EliteRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Shotgun_DP12EliteRow GetRow(string in_RowString)
		{
			return null;
		}
	}
