...
namespace Google2u
{
	public class Shotgun_SGT9 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_SGT9Row> Rows;
		...
		public Shotgun_SGT9Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Shotgun_SGT9Row GetRow(string in_RowString)
		{
			return null;
		}
	}
