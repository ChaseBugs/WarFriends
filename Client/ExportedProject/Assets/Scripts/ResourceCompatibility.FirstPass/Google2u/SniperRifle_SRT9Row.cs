...
{
	[Serializable]
	public class SniperRifle_SRT9Row : IGoogle2uRow
	{
		...
		public SniperRifle_SRT9Row()
		{
		}

		public SniperRifle_SRT9Row(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
		}
