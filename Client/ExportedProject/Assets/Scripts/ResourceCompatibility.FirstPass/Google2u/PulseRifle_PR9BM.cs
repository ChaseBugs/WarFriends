...
namespace Google2u
{
	public class PulseRifle_PR9BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_PR9BMRow> Rows;
		...
		public PulseRifle_PR9BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_PR9BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
