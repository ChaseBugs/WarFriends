...
namespace Google2u
{
	public class DBUpgradeSlotsExoMech : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsExoMechRow> Rows;
		...
		public DBUpgradeSlotsExoMechRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsExoMechRow GetRow(string in_RowString)
		{
			return null;
		}
	}
