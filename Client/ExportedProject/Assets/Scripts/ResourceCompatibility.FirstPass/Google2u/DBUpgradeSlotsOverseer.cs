...
namespace Google2u
{
	public class DBUpgradeSlotsOverseer : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsOverseerRow> Rows;
		...
		public DBUpgradeSlotsOverseerRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsOverseerRow GetRow(string in_RowString)
		{
			return null;
		}
	}
