...
{
	[Serializable]
	public class DBUpgradeSlotsExoMechRow : IGoogle2uRow
	{
		public int TIER;

		public ObscuredFloat HP;

		public ObscuredFloat GLASSHP;

		public ObscuredFloat ROCKETDAMAGE;
		...
		public ObscuredFloat Get_GLASSHP
		{
			get
			{
				return default(ObscuredFloat);
		...
		public ObscuredFloat Get_ROCKETDAMAGE
		{
			get
			{
				return default(ObscuredFloat);
