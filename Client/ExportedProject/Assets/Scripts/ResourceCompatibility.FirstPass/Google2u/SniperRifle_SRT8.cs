...
namespace Google2u
{
	public class SniperRifle_SRT8 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<SniperRifle_SRT8Row> Rows;
		...
		public SniperRifle_SRT8Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SniperRifle_SRT8Row GetRow(string in_RowString)
		{
			return null;
		}
	}
