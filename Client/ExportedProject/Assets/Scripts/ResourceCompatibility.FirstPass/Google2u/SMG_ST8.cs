...
namespace Google2u
{
	public class SMG_ST8 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public SMG_ST8Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SMG_ST8Row GetRow(string in_RowString)
		{
			return null;
		}
	}
