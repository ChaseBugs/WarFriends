...
{
	[Serializable]
	public class AssaultRifle_ART8BMRow : IGoogle2uRow
	{
		...
		public AssaultRifle_ART8BMRow()
		{
		}

		public AssaultRifle_ART8BMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
		}
