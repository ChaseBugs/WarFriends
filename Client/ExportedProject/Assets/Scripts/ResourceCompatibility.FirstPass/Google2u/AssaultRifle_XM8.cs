...
namespace Google2u
{
	public class AssaultRifle_XM8 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<AssaultRifle_XM8Row> Rows;
		...
		public AssaultRifle_XM8Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public AssaultRifle_XM8Row GetRow(string in_RowString)
		{
			return null;
		}
	}
