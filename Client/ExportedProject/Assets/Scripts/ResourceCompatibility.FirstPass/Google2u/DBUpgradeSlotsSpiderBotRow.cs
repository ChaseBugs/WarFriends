...
{
	[Serializable]
	public class DBUpgradeSlotsSpiderBotRow : IGoogle2uRow
	{
		public int TIER;
		...
		public ObscuredFloat SPIDERLINGHP;

		public ObscuredFloat SPIDERLINGDAMAGE;

		public float SPAWNPROBABILITY;

		public int SHOTSAFTERSPAWN;

		public int FORCESPAWNAFTERSHOTS;
		...
		public ObscuredFloat Get_SPIDERLINGHP
		{
			get
			{
				return default(ObscuredFloat);
		...
		public ObscuredFloat Get_SPIDERLINGDAMAGE
		{
			get
			{
				return default(ObscuredFloat);
		...
		public float Get_SPAWNPROBABILITY
		{
			get
			{
				return 0f;
		...
		public int Get_SHOTSAFTERSPAWN
		{
			get
			{
				return 0;
		...
		public int Get_FORCESPAWNAFTERSHOTS
		{
			get
			{
				return 0;
		...
		public DBUpgradeSlotsSpiderBotRow()
		{
		}

		public DBUpgradeSlotsSpiderBotRow(string _GOOGLEFU_ID, string _TIER, string _HP, string _DAMAGE, string _BATCHSIZEMIN, string _BATCHSIZEMAX, string _SHOTFREQUENCYMIN, string _SHOTFREQUENCYMAX, string _REALSHOTPROBABILITY, string _SPIDERLINGHP, string _SPIDERLINGDAMAGE, string _SPAWNPROBABILITY, string _SHOTSAFTERSPAWN, string _FORCESPAWNAFTERSHOTS, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ARMYPOWER, string _SPECIAL, string _ELITE)
		{
		}
