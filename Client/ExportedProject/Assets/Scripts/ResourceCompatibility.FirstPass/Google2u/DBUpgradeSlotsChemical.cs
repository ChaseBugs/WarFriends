...
namespace Google2u
{
	public class DBUpgradeSlotsChemical : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsChemicalRow> Rows;
		...
		public DBUpgradeSlotsChemicalRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsChemicalRow GetRow(string in_RowString)
		{
			return null;
		}
	}
