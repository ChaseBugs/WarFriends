...
namespace Google2u
{
	public class DBUpgradeSlotsBackbone : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsBackboneRow> Rows;
		...
		public DBUpgradeSlotsBackboneRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsBackboneRow GetRow(string in_RowString)
		{
			return null;
		}
	}
