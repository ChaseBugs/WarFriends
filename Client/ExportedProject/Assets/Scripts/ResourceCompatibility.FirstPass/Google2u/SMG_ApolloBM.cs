...
namespace Google2u
{
	public class SMG_ApolloBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<SMG_ApolloBMRow> Rows;
		...
		public SMG_ApolloBMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SMG_ApolloBMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
