...
namespace Google2u
{
	public class DBUpgradeSlotsRiko : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsRikoRow> Rows;
		...
		public DBUpgradeSlotsRikoRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsRikoRow GetRow(string in_RowString)
		{
			return null;
		}
	}
