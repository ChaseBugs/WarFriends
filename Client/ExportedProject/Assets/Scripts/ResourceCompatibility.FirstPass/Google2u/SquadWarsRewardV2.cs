...
namespace Google2u
{
	public class SquadWarsRewardV2 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ID_0,
		...
		public List<SquadWarsRewardV2Row> Rows;
		...
		public SquadWarsRewardV2Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SquadWarsRewardV2Row GetRow(string in_RowString)
		{
			return null;
		}
	}
