...
namespace Google2u
{
	public class PulseRifle_Grade7BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_Grade7BMRow> Rows;
		...
		public PulseRifle_Grade7BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_Grade7BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
