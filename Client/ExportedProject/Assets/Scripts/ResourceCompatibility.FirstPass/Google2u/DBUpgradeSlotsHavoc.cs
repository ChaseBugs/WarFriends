...
namespace Google2u
{
	public class DBUpgradeSlotsHavoc : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsHavocRow> Rows;
		...
		public DBUpgradeSlotsHavocRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsHavocRow GetRow(string in_RowString)
		{
			return null;
		}
	}
