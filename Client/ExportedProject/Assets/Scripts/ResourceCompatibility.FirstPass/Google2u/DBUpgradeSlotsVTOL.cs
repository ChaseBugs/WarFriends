...
namespace Google2u
{
	public class DBUpgradeSlotsVTOL : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsVTOLRow> Rows;
		...
		public DBUpgradeSlotsVTOLRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsVTOLRow GetRow(string in_RowString)
		{
			return null;
		}
	}
