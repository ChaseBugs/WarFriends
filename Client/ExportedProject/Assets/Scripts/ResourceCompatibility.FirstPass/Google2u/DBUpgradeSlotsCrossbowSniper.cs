...
namespace Google2u
{
	public class DBUpgradeSlotsCrossbowSniper : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsCrossbowSniperRow> Rows;
		...
		public DBUpgradeSlotsCrossbowSniperRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsCrossbowSniperRow GetRow(string in_RowString)
		{
			return null;
		}
	}
