...
namespace Google2u
{
	public class SniperRifle_3Eyes : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<SniperRifle_3EyesRow> Rows;
		...
		public SniperRifle_3EyesRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SniperRifle_3EyesRow GetRow(string in_RowString)
		{
			return null;
		}
	}
