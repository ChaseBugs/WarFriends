...
namespace Google2u
{
	public class DBUpgradeSlotsRenegade : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<DBUpgradeSlotsRenegadeRow> Rows;
		...
		public DBUpgradeSlotsRenegadeRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public DBUpgradeSlotsRenegadeRow GetRow(string in_RowString)
		{
			return null;
		}
	}
