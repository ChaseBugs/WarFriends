...
namespace Google2u
{
	public class Bazooka_RLT8BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Bazooka_RLT8BMRow> Rows;
		...
		public Bazooka_RLT8BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Bazooka_RLT8BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
