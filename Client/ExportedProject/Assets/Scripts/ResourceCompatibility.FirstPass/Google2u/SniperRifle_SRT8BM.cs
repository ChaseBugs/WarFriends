...
namespace Google2u
{
	public class SniperRifle_SRT8BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<SniperRifle_SRT8BMRow> Rows;
		...
		public SniperRifle_SRT8BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public SniperRifle_SRT8BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
