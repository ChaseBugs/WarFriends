...
namespace Google2u
{
	public class PulseRifle_PR9 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_PR9Row> Rows;
		...
		public PulseRifle_PR9Row GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_PR9Row GetRow(string in_RowString)
		{
			return null;
		}
	}
