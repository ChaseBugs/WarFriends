...
namespace Google2u
{
	public class Shotgun_SGT8BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Shotgun_SGT8BMRow> Rows;
		...
		public Shotgun_SGT8BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Shotgun_SGT8BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
