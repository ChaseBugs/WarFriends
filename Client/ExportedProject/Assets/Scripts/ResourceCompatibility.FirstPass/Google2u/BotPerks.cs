...
namespace Google2u
{
	public class BotPerks : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ID_0,
		...
		public BotPerksRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public BotPerksRow GetRow(string in_RowString)
		{
			return null;
		}
	}
