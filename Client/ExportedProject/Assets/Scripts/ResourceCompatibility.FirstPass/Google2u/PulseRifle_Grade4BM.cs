...
namespace Google2u
{
	public class PulseRifle_Grade4BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<PulseRifle_Grade4BMRow> Rows;
		...
		public PulseRifle_Grade4BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public PulseRifle_Grade4BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
