...
namespace Google2u
{
	public class AugmentationEffectMultipliers : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ID_0,
		...
		public List<AugmentationEffectMultipliersRow> Rows;
		...
		public AugmentationEffectMultipliersRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public AugmentationEffectMultipliersRow GetRow(string in_RowString)
		{
			return null;
		}
	}
