...
namespace Google2u
{
	public class Grenade_GT9BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Grenade_GT9BMRow> Rows;
		...
		public Grenade_GT9BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Grenade_GT9BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
