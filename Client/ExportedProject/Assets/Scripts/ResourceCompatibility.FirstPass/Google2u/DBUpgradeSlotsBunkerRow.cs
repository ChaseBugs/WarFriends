...
{
	[Serializable]
	public class DBUpgradeSlotsBunkerRow : IGoogle2uRow
	{
		public int TIER;
		...
		public ObscuredFloat SPECIALPROBABILITY;

		public ObscuredFloat SPECIALDURATION;
		...
		public ObscuredFloat Get_SPECIALPROBABILITY
		{
			get
			{
				return default(ObscuredFloat);
		...
		public ObscuredFloat Get_SPECIALDURATION
		{
			get
			{
				return default(ObscuredFloat);
		...
		public DBUpgradeSlotsBunkerRow()
		{
		}

		public DBUpgradeSlotsBunkerRow(string _GOOGLEFU_ID, string _TIER, string _HP, string _DAMAGE, string _BATCHSIZEMIN, string _BATCHSIZEMAX, string _SHOTFREQUENCYMIN, string _SHOTFREQUENCYMAX, string _REALSHOTPROBABILITY, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ARMYPOWER, string _SOLDIERHP, string _SPECIALPROBABILITY, string _SPECIALDURATION, string _ELITE)
		{
		}
