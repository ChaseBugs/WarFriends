...
namespace Google2u
{
	public class AssaultRifle_XM8BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<AssaultRifle_XM8BMRow> Rows;
		...
		public AssaultRifle_XM8BMRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public AssaultRifle_XM8BMRow GetRow(string in_RowString)
		{
			return null;
		}
	}
