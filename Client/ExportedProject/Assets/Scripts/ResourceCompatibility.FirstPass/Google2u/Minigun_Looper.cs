...
namespace Google2u
{
	public class Minigun_Looper : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1,
		...
		public List<Minigun_LooperRow> Rows;
		...
		public Minigun_LooperRow GetRow(rowIds in_RowID)
		{
			return null;
		}

		public Minigun_LooperRow GetRow(string in_RowString)
		{
			return null;
		}
	}
