...
{
	[Serializable]
	public class Grenade_GT9Row : IGoogle2uRow
	{
		...
		public Grenade_GT9Row()
		{
		}

		public Grenade_GT9Row(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _MINDAMAGE, string _EXPLODEDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
		}
