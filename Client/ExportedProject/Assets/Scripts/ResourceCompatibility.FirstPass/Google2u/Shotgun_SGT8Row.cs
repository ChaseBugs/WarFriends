...
{
	[Serializable]
	public class Shotgun_SGT8Row : IGoogle2uRow
	{
		...
		public Shotgun_SGT8Row()
		{
		}

		public Shotgun_SGT8Row(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _MINDAMAGE, string _MAXDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
		}
