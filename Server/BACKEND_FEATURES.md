...
- **Game Center now has an explicit live ownership-proof path for a patched client.** The stock
  ...
  persisted. Facebook and Google Play live provider proof remain explicit unresolved integrations.
