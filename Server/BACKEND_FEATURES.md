...
- **Remote configuration targeting no longer widens malformed stock requests.** Recovered action
  ...
  or replaced with wildcard selectors that could choose a signed balancing release.
