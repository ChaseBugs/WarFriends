...
public class UICamera : MonoBehaviour
{
	...
	public static bool allowMultiTouch = false;

	public static bool useKeyboard = true;

	public static bool useController = true;

	public static bool mStickyPress = false;
	...
	public static bool stickyPress
	{
		get
		{
			return mStickyPress;
	...
	public static GameObject selectedObject
	{
		...
		set
		{
			...
			{
				Debug.Log("The fuck? " + mList.Count);
			}
		}
	}
	...
	private void Awake()
	{
		...
		float pixelSizeAdjustment = uIRoot.GetPixelSizeAdjustment(Screen.height, Screen.width);
		mouseClickThreshold = 80f / pixelSizeAdjustment;
		mouseDragThreshold = 80f / pixelSizeAdjustment;
		touchDragThreshold = 80f / pixelSizeAdjustment;
		touchClickThreshold = 80f / pixelSizeAdjustment;
	}
	...
	public void ProcessTouch(bool pressed, bool unpressed)
	{
		...
		if (currentTouch.pressed != null)
		{
			...
			else if (currentTouch.dragged != null)
			{
