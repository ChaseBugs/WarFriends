...
{
	[Serializable]
	public class SniperRifle_AWMFRow : IGoogle2uRow
	{
		...
		public SniperRifle_AWMFRow()
		{
		}

		public SniperRifle_AWMFRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
			float result;
