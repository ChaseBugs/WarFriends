...
namespace Google2u
{
	...
	public class MissionsRow : IGoogle2uRow
	{
		...
		public MissionsRow(string _ID, string _LEVEL, string _MAP_STAGE, string _MISSIONTYPE, string _OBJECTIVE, string _TIME, string _SCORE1, string _SCORE2, string _SCORE3, string _MAX_UNITS_AT_ONCE, string _REWARD_WARBUCKS, string _REWARD_GOLD, string _REWARD_XP, string _BOT_NUMBER_DIFFICULTY, string _BOTLEVEL, string _BOTHPREDUCTION, string _TUTORIALS, string _CRATES, string _DATA, string _HPTARGET, string _TIMETARGET, string _RECOMMENDEDARMYPOWER)
		{
			...
			int result2;
			if (int.TryParse(_MAP_STAGE, out result2))
			{
				MAP_STAGE = result2;
			}
			else
			...
			int result3;
			if (int.TryParse(_TIME, out result3))
			{
				TIME = result3;
			}
			else
			...
			int result4;
			if (int.TryParse(_SCORE1, out result4))
			{
				SCORE1 = result4;
			}
			else
			...
			int result5;
			if (int.TryParse(_SCORE2, out result5))
			{
				SCORE2 = result5;
			}
			else
			...
			int result6;
			if (int.TryParse(_SCORE3, out result6))
			{
				SCORE3 = result6;
			}
			else
			...
			int result7;
			if (int.TryParse(_MAX_UNITS_AT_ONCE, out result7))
			{
			...
			int result8;
			if (int.TryParse(_REWARD_WARBUCKS, out result8))
			{
			...
			int result9;
			if (int.TryParse(_REWARD_GOLD, out result9))
			{
				REWARD_GOLD = result9;
			}
			else
			...
			int result10;
			if (int.TryParse(_REWARD_XP, out result10))
			{
				REWARD_XP = result10;
			}
			else
			...
			int result11;
			if (int.TryParse(_BOT_NUMBER_DIFFICULTY, out result11))
			{
			...
			int result12;
			if (int.TryParse(_BOTLEVEL, out result12))
			{
				BOTLEVEL = result12;
			}
			else
			...
			float result13;
			if (float.TryParse(_BOTHPREDUCTION, out result13))
			{
			...
			DATA = _DATA.Trim();
			float result14;
			if (float.TryParse(_HPTARGET, out result14))
			{
				HPTARGET = result14;
			}
			else
			...
			float result15;
			if (float.TryParse(_TIMETARGET, out result15))
			{
				TIMETARGET = result15;
			}
			else
			...
			int result16;
			if (int.TryParse(_RECOMMENDEDARMYPOWER, out result16))
			{
