...
namespace Google2u
{
	public class Bazooka_RPG7 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<Bazooka_RPG7Row> Rows = new List<Bazooka_RPG7Row>();
		...
		{
			Rows.Add(new Bazooka_RPG7Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public Bazooka_RPG7Row GetRow(rowIds in_RowID)
		{
			Bazooka_RPG7Row result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Bazooka_RPG7Row GetRow(string in_RowString)
		{
			Bazooka_RPG7Row result = null;
