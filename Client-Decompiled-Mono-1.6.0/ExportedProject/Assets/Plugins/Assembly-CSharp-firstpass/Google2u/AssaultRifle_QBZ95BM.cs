...
namespace Google2u
{
	public class AssaultRifle_QBZ95BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<AssaultRifle_QBZ95BMRow> Rows = new List<AssaultRifle_QBZ95BMRow>();
		...
		{
			Rows.Add(new AssaultRifle_QBZ95BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new AssaultRifle_QBZ95BMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public AssaultRifle_QBZ95BMRow GetRow(rowIds in_RowID)
		{
			AssaultRifle_QBZ95BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public AssaultRifle_QBZ95BMRow GetRow(string in_RowString)
		{
			AssaultRifle_QBZ95BMRow result = null;
