...
{
	[Serializable]
	public class Grenade_FLASHRow : IGoogle2uRow
	{
		...
		public Grenade_FLASHRow()
		{
		}

		public Grenade_FLASHRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _MINDAMAGE, string _EXPLODEDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
			float result;
