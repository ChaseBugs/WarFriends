...
namespace Google2u
{
	public class DBUpgradeSlotsRockyTurret : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			CARDS_MIN = 0,
		...
		public string[] rowNames = new string[2] { "CARDS_MIN", "CARDS_MAX" };
		...
		public List<DBUpgradeSlotsRockyTurretRow> Rows = new List<DBUpgradeSlotsRockyTurretRow>();
		...
		{
			Rows.Add(new DBUpgradeSlotsRockyTurretRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new DBUpgradeSlotsRockyTurretRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public DBUpgradeSlotsRockyTurretRow GetRow(rowIds in_RowID)
		{
			DBUpgradeSlotsRockyTurretRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public DBUpgradeSlotsRockyTurretRow GetRow(string in_RowString)
		{
			DBUpgradeSlotsRockyTurretRow result = null;
