...
{
	[Serializable]
	public class Grenade_FRAGEliteRow : IGoogle2uRow
	{
		...
		public Grenade_FRAGEliteRow()
		{
		}

		public Grenade_FRAGEliteRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _MINDAMAGE, string _EXPLODEDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
			float result;
