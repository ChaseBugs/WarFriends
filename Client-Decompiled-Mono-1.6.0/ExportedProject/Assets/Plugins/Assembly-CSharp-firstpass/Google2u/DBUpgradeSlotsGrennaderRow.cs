...
namespace Google2u
{
	...
	public class DBUpgradeSlotsGrennaderRow : IGoogle2uRow
	{
		...
		public DBUpgradeSlotsGrennaderRow(string _GOOGLEFU_ID, string _TIER, string _HP, string _DAMAGE, string _GRENADEMINDAMAGE, string _GRENADEEXPLODEDAMAGE, string _BATCHSIZEMIN, string _BATCHSIZEMAX, string _SHOTFREQUENCYMIN, string _SHOTFREQUENCYMAX, string _REALSHOTPROBABILITY, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ARMYPOWER, string _SPECIAL, string _ELITE)
		{
			...
			float result4;
			if (float.TryParse(_GRENADEMINDAMAGE, out result4))
			{
			...
			float result5;
			if (float.TryParse(_GRENADEEXPLODEDAMAGE, out result5))
			{
			...
			int result11;
			if (int.TryParse(_NEXTUPGRADEPRICE, out result11))
			{
			...
			int result12;
			if (int.TryParse(_NEXTUPGRADEPRICEGOLD, out result12))
			{
			...
			float result13;
			if (float.TryParse(_DELIVERYTIME, out result13))
			{
			...
			float result14;
			if (float.TryParse(_DPS, out result14))
			{
				DPS = result14;
			}
			else
			...
			float result15;
			if (float.TryParse(_ARMYPOWER, out result15))
			{
				ARMYPOWER = result15;
			}
			else
			...
			float result16;
			if (float.TryParse(_SPECIAL, out result16))
			{
				SPECIAL = result16;
			}
			else
			...
			float result17;
			if (float.TryParse(_ELITE, out result17))
			{
				ELITE = result17;
			}
			else
