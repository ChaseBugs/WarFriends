...
namespace Google2u
{
	public class GrenadeLauncher_M79 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<GrenadeLauncher_M79Row> Rows = new List<GrenadeLauncher_M79Row>();
		...
		{
			Rows.Add(new GrenadeLauncher_M79Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new GrenadeLauncher_M79Row());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public GrenadeLauncher_M79Row GetRow(rowIds in_RowID)
		{
			GrenadeLauncher_M79Row result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public GrenadeLauncher_M79Row GetRow(string in_RowString)
		{
			GrenadeLauncher_M79Row result = null;
