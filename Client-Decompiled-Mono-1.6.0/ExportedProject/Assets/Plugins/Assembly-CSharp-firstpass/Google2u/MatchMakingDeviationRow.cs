...
namespace Google2u
{
	...
	public class MatchMakingDeviationRow : IGoogle2uRow
	{
		...
		{
			int result;
			if (int.TryParse(_STEP1, out result))
			{
				STEP1 = result;
			}
			else
			...
			int result2;
			if (int.TryParse(_STEP2, out result2))
			{
				STEP2 = result2;
			}
			else
			...
			int result3;
			if (int.TryParse(_STEP3, out result3))
			{
				STEP3 = result3;
			}
			else
			...
			int result4;
			if (int.TryParse(_STEP4, out result4))
			{
				STEP4 = result4;
			}
			else
			...
			int result5;
			if (int.TryParse(_STEP5, out result5))
			{
				STEP5 = result5;
			}
			else
			...
			int result6;
			if (int.TryParse(_STEP6, out result6))
			{
				STEP6 = result6;
			}
			else
			...
			int result7;
			if (int.TryParse(_STEP7, out result7))
			{
				STEP7 = result7;
			}
			else
			...
			int result8;
			if (int.TryParse(_STEP8, out result8))
			{
				STEP8 = result8;
			}
			else
			...
			int result9;
			if (int.TryParse(_STEP9, out result9))
			{
				STEP9 = result9;
			}
			else
			...
			int result10;
			if (int.TryParse(_STEP10, out result10))
			{
				STEP10 = result10;
			}
			else
