...
namespace Google2u
{
	...
	public class WeaponUpgradesRow : IGoogle2uRow
	{
		...
		public WeaponUpgradesRow(string _ID, string _NAME, string _UNLOCKLEVEL, string _CANBEBOUGHT, string _PRICE, string _PRICEGOLD, string _NSLOTS, string _RATEOFFIRE, string _CRITICAL, string _BURSTSIZE, string _BURSTLOCKTIME, string _ACCURACY, string _DELIVERTIME, string _PURCHASABLE, string _WEAPONCATEGORY, string _SPEED, string _DAMAGETOPLAYER, string _DAMAGETOPLAYEROVERTIME, string _DAMAGETOPLAYERBEHINDSHIELD, string _DAMAGETOSHIELD)
		{
			...
			int result2;
			if (int.TryParse(_CANBEBOUGHT, out result2))
			{
				CANBEBOUGHT = result2;
			}
			else
			...
			int result3;
			if (int.TryParse(_PRICE, out result3))
			{
				PRICE = result3;
			}
			else
			...
			int result5;
			if (int.TryParse(_NSLOTS, out result5))
			{
				NSLOTS = result5;
			}
			else
			...
			float result6;
			if (float.TryParse(_RATEOFFIRE, out result6))
			{
				RATEOFFIRE = result6;
			}
			else
			...
			float result7;
			if (float.TryParse(_CRITICAL, out result7))
			{
				CRITICAL = result7;
			}
			else
			...
			int result8;
			if (int.TryParse(_BURSTSIZE, out result8))
			{
				BURSTSIZE = result8;
			}
			else
			...
			float result9;
			if (float.TryParse(_BURSTLOCKTIME, out result9))
			{
			...
			float result10;
			if (float.TryParse(_ACCURACY, out result10))
			{
				ACCURACY = result10;
			}
			else
			...
			int result11;
			if (int.TryParse(_DELIVERTIME, out result11))
			{
			...
			int result12;
			if (int.TryParse(_WEAPONCATEGORY, out result12))
			{
			...
			float result13;
			if (float.TryParse(_SPEED, out result13))
			{
				SPEED = result13;
			}
			else
			...
			float result14;
			if (float.TryParse(_DAMAGETOPLAYER, out result14))
			{
			...
			float result15;
			if (float.TryParse(_DAMAGETOPLAYEROVERTIME, out result15))
			{
			...
			float result16;
			if (float.TryParse(_DAMAGETOPLAYERBEHINDSHIELD, out result16))
			{
			...
			float result17;
			if (float.TryParse(_DAMAGETOSHIELD, out result17))
			{
