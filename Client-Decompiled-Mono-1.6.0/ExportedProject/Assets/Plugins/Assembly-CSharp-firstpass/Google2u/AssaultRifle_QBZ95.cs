...
namespace Google2u
{
	public class AssaultRifle_QBZ95 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<AssaultRifle_QBZ95Row> Rows = new List<AssaultRifle_QBZ95Row>();
		...
		{
			Rows.Add(new AssaultRifle_QBZ95Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new AssaultRifle_QBZ95Row());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public AssaultRifle_QBZ95Row GetRow(rowIds in_RowID)
		{
			AssaultRifle_QBZ95Row result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public AssaultRifle_QBZ95Row GetRow(string in_RowString)
		{
			AssaultRifle_QBZ95Row result = null;
