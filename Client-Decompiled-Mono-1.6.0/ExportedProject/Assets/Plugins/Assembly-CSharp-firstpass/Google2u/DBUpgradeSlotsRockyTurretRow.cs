...
{
	[Serializable]
	public class DBUpgradeSlotsRockyTurretRow : IGoogle2uRow
	{
		public int TIER;
		...
		public DBUpgradeSlotsRockyTurretRow()
		{
		}

		public DBUpgradeSlotsRockyTurretRow(string _GOOGLEFU_ID, string _TIER, string _HP, string _DAMAGE, string _BATCHSIZEMIN, string _BATCHSIZEMAX, string _SHOTFREQUENCYMIN, string _SHOTFREQUENCYMAX, string _REALSHOTPROBABILITY)
		{
			int result;
