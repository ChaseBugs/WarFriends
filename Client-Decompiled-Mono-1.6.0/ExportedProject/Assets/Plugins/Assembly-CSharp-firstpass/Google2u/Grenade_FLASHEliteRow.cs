...
{
	[Serializable]
	public class Grenade_FLASHEliteRow : IGoogle2uRow
	{
		...
		public Grenade_FLASHEliteRow()
		{
		}

		public Grenade_FLASHEliteRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _MINDAMAGE, string _EXPLODEDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
			float result;
