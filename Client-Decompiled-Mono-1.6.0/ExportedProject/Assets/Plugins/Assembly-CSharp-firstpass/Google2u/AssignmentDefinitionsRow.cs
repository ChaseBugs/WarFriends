...
namespace Google2u
{
	...
	public class AssignmentDefinitionsRow : IGoogle2uRow
	{
		...
		public AssignmentDefinitionsRow(string _ID, string _DESCRIPTION, string _DESCRIPTIONSTRING, string _PLAYERONLY, string _TARGET, string _TARGETMIN, string _TARGETMAX, string _SECONDTARGET, string _SECONDTARGETPARAMETER, string _SECONDTARGETMIN, string _SECONDTARGETMAX, string _GROUPTYPE, string _REWARD, string _REWARDWPMIN, string _REWARDWBMAX, string _REWARDGOLDMIN, string _REWARDGOLDMAX, string _GENERICMISSIONSTEPVALUE, string _SECONDGENERICMISSIONSTEPVALUE, string _GENERICMISSIONSTEPREWARD, string _GENERICMISSIONSTEPREWARDGOLD, string _REMEMBERCOMPLETION, string _STRINGSTATUS, string _TYPE)
		{
			...
			bool result;
			if (bool.TryParse(_PLAYERONLY, out result))
			{
				PLAYERONLY = result;
			}
			else
			...
			TARGET = _TARGET.Trim();
			int result2;
			if (int.TryParse(_TARGETMIN, out result2))
			{
				TARGETMIN = result2;
			}
			else
			...
			int result3;
			if (int.TryParse(_TARGETMAX, out result3))
			{
				TARGETMAX = result3;
			}
			else
			...
			int result4;
			if (int.TryParse(_SECONDTARGETMIN, out result4))
			{
			...
			int result5;
			if (int.TryParse(_SECONDTARGETMAX, out result5))
			{
			...
			int result6;
			if (int.TryParse(_GROUPTYPE, out result6))
			{
				GROUPTYPE = result6;
			}
			else
			...
			REWARD = _REWARD.Trim();
			int result7;
			if (int.TryParse(_REWARDWPMIN, out result7))
			{
				REWARDWPMIN = result7;
			}
			else
			...
			int result8;
			if (int.TryParse(_REWARDWBMAX, out result8))
			{
				REWARDWBMAX = result8;
			}
			else
			...
			int result9;
			if (int.TryParse(_REWARDGOLDMIN, out result9))
			{
			...
			int result10;
			if (int.TryParse(_REWARDGOLDMAX, out result10))
			{
			...
			int result11;
			if (int.TryParse(_GENERICMISSIONSTEPVALUE, out result11))
			{
			...
			int result12;
			if (int.TryParse(_SECONDGENERICMISSIONSTEPVALUE, out result12))
			{
			...
			int result13;
			if (int.TryParse(_GENERICMISSIONSTEPREWARD, out result13))
			{
			...
			int result14;
			if (int.TryParse(_GENERICMISSIONSTEPREWARDGOLD, out result14))
			{
			...
			bool result15;
			if (bool.TryParse(_REMEMBERCOMPLETION, out result15))
			{
