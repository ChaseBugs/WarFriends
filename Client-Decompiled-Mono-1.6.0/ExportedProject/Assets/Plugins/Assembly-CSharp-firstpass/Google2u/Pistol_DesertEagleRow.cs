...
{
	[Serializable]
	public class Pistol_DesertEagleRow : IGoogle2uRow
	{
		...
		public Pistol_DesertEagleRow()
		{
		}

		public Pistol_DesertEagleRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
			float result;
