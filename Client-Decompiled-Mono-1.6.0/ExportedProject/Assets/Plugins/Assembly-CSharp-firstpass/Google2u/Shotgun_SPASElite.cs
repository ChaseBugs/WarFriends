...
namespace Google2u
{
	public class Shotgun_SPASElite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<Shotgun_SPASEliteRow> Rows = new List<Shotgun_SPASEliteRow>();
		...
		{
			Rows.Add(new Shotgun_SPASEliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Shotgun_SPASEliteRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Shotgun_SPASEliteRow GetRow(rowIds in_RowID)
		{
			Shotgun_SPASEliteRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Shotgun_SPASEliteRow GetRow(string in_RowString)
		{
			Shotgun_SPASEliteRow result = null;
