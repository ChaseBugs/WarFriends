...
{
	[Serializable]
	public class Shotgun_BenelliRow : IGoogle2uRow
	{
		...
		public Shotgun_BenelliRow()
		{
		}

		public Shotgun_BenelliRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _MINDAMAGE, string _MAXDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
			float result;
