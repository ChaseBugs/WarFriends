...
namespace Google2u
{
	public class Grenade_M34BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<Grenade_M34BMRow> Rows = new List<Grenade_M34BMRow>();
		...
		{
			Rows.Add(new Grenade_M34BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public Grenade_M34BMRow GetRow(rowIds in_RowID)
		{
			Grenade_M34BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Grenade_M34BMRow GetRow(string in_RowString)
		{
			Grenade_M34BMRow result = null;
