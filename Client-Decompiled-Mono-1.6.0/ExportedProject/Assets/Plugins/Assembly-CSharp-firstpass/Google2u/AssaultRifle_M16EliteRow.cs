...
{
	[Serializable]
	public class AssaultRifle_M16EliteRow : IGoogle2uRow
	{
		...
		public AssaultRifle_M16EliteRow()
		{
		}

		public AssaultRifle_M16EliteRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
			float result;
