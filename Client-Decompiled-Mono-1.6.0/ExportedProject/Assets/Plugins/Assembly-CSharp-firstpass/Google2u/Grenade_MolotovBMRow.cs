...
{
	[Serializable]
	public class Grenade_MolotovBMRow : IGoogle2uRow
	{
		...
		public Grenade_MolotovBMRow()
		{
		}

		public Grenade_MolotovBMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _MINDAMAGE, string _EXPLODEDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
			float result;
			...
			float result3;
			if (float.TryParse(_MINDAMAGE, out result3))
			{
				MINDAMAGE = result3;
			}
			else
			...
			float result4;
			if (float.TryParse(_EXPLODEDAMAGE, out result4))
			{
			...
			int result10;
			if (int.TryParse(_WEAPONPRICE, out result10))
			{
				WEAPONPRICE = result10;
			}
			else
			{
