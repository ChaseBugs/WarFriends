...
namespace Google2u
{
	public class Bazooka_HMVBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<Bazooka_HMVBMRow> Rows = new List<Bazooka_HMVBMRow>();
		...
		{
			Rows.Add(new Bazooka_HMVBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public Bazooka_HMVBMRow GetRow(rowIds in_RowID)
		{
			Bazooka_HMVBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Bazooka_HMVBMRow GetRow(string in_RowString)
		{
			Bazooka_HMVBMRow result = null;
