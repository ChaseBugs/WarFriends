...
{
	[Serializable]
	public class AssignmentsConstantsRow : IGoogle2uRow
	{
		...
		public AssignmentsConstantsRow()
		{
		}

		public AssignmentsConstantsRow(string _NAME, string _FLOATVALUE, string _DBKEY)
		{
			float result;
