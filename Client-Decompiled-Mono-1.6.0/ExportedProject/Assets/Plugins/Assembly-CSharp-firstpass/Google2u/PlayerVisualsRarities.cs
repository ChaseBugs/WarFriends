...
namespace Google2u
{
	public class PlayerVisualsRarities : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			Common = 0,
		...
		public string[] rowNames = new string[5] { "Common", "Uncommon", "Rare", "Epic", "Legendary" };
		...
		public List<PlayerVisualsRaritiesRow> Rows = new List<PlayerVisualsRaritiesRow>();
		...
		{
			Rows.Add(new PlayerVisualsRaritiesRow(input[0], input[1], input[2]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new PlayerVisualsRaritiesRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public PlayerVisualsRaritiesRow GetRow(rowIds in_RowID)
		{
			PlayerVisualsRaritiesRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public PlayerVisualsRaritiesRow GetRow(string in_RowString)
		{
			PlayerVisualsRaritiesRow result = null;
