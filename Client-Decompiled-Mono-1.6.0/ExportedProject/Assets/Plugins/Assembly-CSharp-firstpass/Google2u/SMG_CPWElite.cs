...
namespace Google2u
{
	public class SMG_CPWElite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<SMG_CPWEliteRow> Rows = new List<SMG_CPWEliteRow>();
		...
		{
			Rows.Add(new SMG_CPWEliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public SMG_CPWEliteRow GetRow(rowIds in_RowID)
		{
			SMG_CPWEliteRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public SMG_CPWEliteRow GetRow(string in_RowString)
		{
			SMG_CPWEliteRow result = null;
