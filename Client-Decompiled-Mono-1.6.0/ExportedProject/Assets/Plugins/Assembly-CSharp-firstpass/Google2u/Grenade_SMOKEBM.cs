...
namespace Google2u
{
	public class Grenade_SMOKEBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<Grenade_SMOKEBMRow> Rows = new List<Grenade_SMOKEBMRow>();
		...
		{
			Rows.Add(new Grenade_SMOKEBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Grenade_SMOKEBMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Grenade_SMOKEBMRow GetRow(rowIds in_RowID)
		{
			Grenade_SMOKEBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Grenade_SMOKEBMRow GetRow(string in_RowString)
		{
			Grenade_SMOKEBMRow result = null;
