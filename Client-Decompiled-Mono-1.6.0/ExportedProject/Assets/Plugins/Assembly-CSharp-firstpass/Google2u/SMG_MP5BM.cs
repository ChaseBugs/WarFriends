...
namespace Google2u
{
	public class SMG_MP5BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<SMG_MP5BMRow> Rows = new List<SMG_MP5BMRow>();
		...
		{
			Rows.Add(new SMG_MP5BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public SMG_MP5BMRow GetRow(rowIds in_RowID)
		{
			SMG_MP5BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public SMG_MP5BMRow GetRow(string in_RowString)
		{
			SMG_MP5BMRow result = null;
