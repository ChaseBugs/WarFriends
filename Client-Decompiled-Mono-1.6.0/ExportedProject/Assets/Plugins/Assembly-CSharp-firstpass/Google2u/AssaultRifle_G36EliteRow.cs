...
{
	[Serializable]
	public class AssaultRifle_G36EliteRow : IGoogle2uRow
	{
		...
		public AssaultRifle_G36EliteRow()
		{
		}

		public AssaultRifle_G36EliteRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
			float result;
