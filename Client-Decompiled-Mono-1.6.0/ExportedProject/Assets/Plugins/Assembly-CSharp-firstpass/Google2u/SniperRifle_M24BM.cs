...
namespace Google2u
{
	public class SniperRifle_M24BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<SniperRifle_M24BMRow> Rows = new List<SniperRifle_M24BMRow>();
		...
		{
			Rows.Add(new SniperRifle_M24BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new SniperRifle_M24BMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public SniperRifle_M24BMRow GetRow(rowIds in_RowID)
		{
			SniperRifle_M24BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public SniperRifle_M24BMRow GetRow(string in_RowString)
		{
			SniperRifle_M24BMRow result = null;
