...
namespace Google2u
{
	public class StringConstants : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			AppID = 0,
			TutorialCards = 1,
			TutorialRewardCards = 2,
			BeginnersLeagues = 3,
			BeginnersPromotion = 4,
			BeginnersRewards = 5,
			WarArenaConfig = 6
		}

		public string[] rowNames = new string[7] { "AppID", "TutorialCards", "TutorialRewardCards", "BeginnersLeagues", "BeginnersPromotion", "BeginnersRewards", "WarArenaConfig" };
		...
		public List<StringConstantsRow> Rows = new List<StringConstantsRow>();
		...
		{
			Rows.Add(new StringConstantsRow(input[0], input[1], input[2]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new StringConstantsRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public StringConstantsRow GetRow(rowIds in_RowID)
		{
			StringConstantsRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public StringConstantsRow GetRow(string in_RowString)
		{
			StringConstantsRow result = null;
