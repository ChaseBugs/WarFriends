...
{
	[Serializable]
	public class SMG_MP5_eliteRow : IGoogle2uRow
	{
		...
		public SMG_MP5_eliteRow()
		{
		}

		public SMG_MP5_eliteRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
			float result;
