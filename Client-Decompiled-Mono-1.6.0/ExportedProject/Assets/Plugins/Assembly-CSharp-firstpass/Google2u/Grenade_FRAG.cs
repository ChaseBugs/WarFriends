...
namespace Google2u
{
	public class Grenade_FRAG : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<Grenade_FRAGRow> Rows = new List<Grenade_FRAGRow>();
		...
		{
			Rows.Add(new Grenade_FRAGRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public Grenade_FRAGRow GetRow(rowIds in_RowID)
		{
			Grenade_FRAGRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Grenade_FRAGRow GetRow(string in_RowString)
		{
			Grenade_FRAGRow result = null;
