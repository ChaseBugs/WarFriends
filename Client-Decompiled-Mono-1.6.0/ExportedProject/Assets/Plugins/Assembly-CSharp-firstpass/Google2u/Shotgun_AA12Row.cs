...
{
	[Serializable]
	public class Shotgun_AA12Row : IGoogle2uRow
	{
		...
		public Shotgun_AA12Row()
		{
		}

		public Shotgun_AA12Row(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _MINDAMAGE, string _MAXDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
			float result;
