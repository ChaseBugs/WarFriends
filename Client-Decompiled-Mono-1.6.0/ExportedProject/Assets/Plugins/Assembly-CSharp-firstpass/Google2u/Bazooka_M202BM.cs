...
namespace Google2u
{
	public class Bazooka_M202BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<Bazooka_M202BMRow> Rows = new List<Bazooka_M202BMRow>();
		...
		{
			Rows.Add(new Bazooka_M202BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Bazooka_M202BMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Bazooka_M202BMRow GetRow(rowIds in_RowID)
		{
			Bazooka_M202BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Bazooka_M202BMRow GetRow(string in_RowString)
		{
			Bazooka_M202BMRow result = null;
