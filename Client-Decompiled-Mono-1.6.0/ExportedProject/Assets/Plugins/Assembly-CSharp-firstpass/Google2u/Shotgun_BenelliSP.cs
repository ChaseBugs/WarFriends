...
namespace Google2u
{
	public class Shotgun_BenelliSP : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<Shotgun_BenelliSPRow> Rows = new List<Shotgun_BenelliSPRow>();
		...
		{
			Rows.Add(new Shotgun_BenelliSPRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Shotgun_BenelliSPRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Shotgun_BenelliSPRow GetRow(rowIds in_RowID)
		{
			Shotgun_BenelliSPRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Shotgun_BenelliSPRow GetRow(string in_RowString)
		{
			Shotgun_BenelliSPRow result = null;
