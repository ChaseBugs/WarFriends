...
{
	[Serializable]
	public class Grenade_MolotovRow : IGoogle2uRow
	{
		...
		public Grenade_MolotovRow()
		{
		}

		public Grenade_MolotovRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _MINDAMAGE, string _EXPLODEDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
			float result;
