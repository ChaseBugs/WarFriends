...
namespace Google2u
{
	public class AssaultRifle_AKS47UBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<AssaultRifle_AKS47UBMRow> Rows = new List<AssaultRifle_AKS47UBMRow>();
		...
		{
			Rows.Add(new AssaultRifle_AKS47UBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new AssaultRifle_AKS47UBMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public AssaultRifle_AKS47UBMRow GetRow(rowIds in_RowID)
		{
			AssaultRifle_AKS47UBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public AssaultRifle_AKS47UBMRow GetRow(string in_RowString)
		{
			AssaultRifle_AKS47UBMRow result = null;
