...
namespace Google2u
{
	public class LMG_MG4BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<LMG_MG4BMRow> Rows = new List<LMG_MG4BMRow>();
		...
		{
			Rows.Add(new LMG_MG4BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public LMG_MG4BMRow GetRow(rowIds in_RowID)
		{
			LMG_MG4BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public LMG_MG4BMRow GetRow(string in_RowString)
		{
			LMG_MG4BMRow result = null;
