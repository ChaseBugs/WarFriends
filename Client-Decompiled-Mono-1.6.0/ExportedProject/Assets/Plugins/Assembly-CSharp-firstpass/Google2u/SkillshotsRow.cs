...
namespace Google2u
{
	...
	public class SkillshotsRow : IGoogle2uRow
	{
		...
		{
			int result;
			if (int.TryParse(_SCOREMP, out result))
			{
				SCOREMP = result;
			}
			else
			...
			int result2;
			if (int.TryParse(_SCORESINGLE, out result2))
			{
				SCORESINGLE = result2;
			}
			else
			...
			int result3;
			if (int.TryParse(_RIBBONCOUNT, out result3))
			{
				RIBBONCOUNT = result3;
			}
			else
			...
			int result4;
			if (int.TryParse(_RIBBONREWARDMINWB, out result4))
			{
			...
			int result5;
			if (int.TryParse(_RIBBONREWARDMAXWB, out result5))
			{
