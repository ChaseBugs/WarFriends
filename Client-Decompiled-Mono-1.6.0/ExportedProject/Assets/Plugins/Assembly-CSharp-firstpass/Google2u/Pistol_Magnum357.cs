...
namespace Google2u
{
	public class Pistol_Magnum357 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<Pistol_Magnum357Row> Rows = new List<Pistol_Magnum357Row>();
		...
		{
			Rows.Add(new Pistol_Magnum357Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Pistol_Magnum357Row());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Pistol_Magnum357Row GetRow(rowIds in_RowID)
		{
			Pistol_Magnum357Row result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Pistol_Magnum357Row GetRow(string in_RowString)
		{
			Pistol_Magnum357Row result = null;
