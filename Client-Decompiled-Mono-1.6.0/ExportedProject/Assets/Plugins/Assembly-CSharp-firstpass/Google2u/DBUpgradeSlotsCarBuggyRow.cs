...
namespace Google2u
{
	...
	public class DBUpgradeSlotsCarBuggyRow : IGoogle2uRow
	{
		...
		public DBUpgradeSlotsCarBuggyRow(string _GOOGLEFU_ID, string _TIER, string _HP, string _DAMAGE, string _BATCHSIZEMIN, string _BATCHSIZEMAX, string _SHOTFREQUENCYMIN, string _SHOTFREQUENCYMAX, string _REALSHOTPROBABILITY, string _CANNONDAMAGE, string _SHOTFREQUENCYMINCANNON, string _SHOTFREQUENCYMAXCANNON, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ARMYPOWER, string _SPECIAL, string _SOLDIERHP)
		{
			...
			float result9;
			if (float.TryParse(_CANNONDAMAGE, out result9))
			{
			...
			float result10;
			if (float.TryParse(_SHOTFREQUENCYMINCANNON, out result10))
			{
			...
			float result11;
			if (float.TryParse(_SHOTFREQUENCYMAXCANNON, out result11))
			{
			...
			int result12;
			if (int.TryParse(_NEXTUPGRADEPRICE, out result12))
			{
			...
			int result13;
			if (int.TryParse(_NEXTUPGRADEPRICEGOLD, out result13))
			{
			...
			float result14;
			if (float.TryParse(_DELIVERYTIME, out result14))
			{
			...
			float result15;
			if (float.TryParse(_DPS, out result15))
			{
				DPS = result15;
			}
			else
			...
			float result16;
			if (float.TryParse(_ARMYPOWER, out result16))
			{
				ARMYPOWER = result16;
			}
			else
			...
			float result17;
			if (float.TryParse(_SPECIAL, out result17))
			{
				SPECIAL = result17;
			}
			else
			...
			float result18;
			if (float.TryParse(_SOLDIERHP, out result18))
			{
				SOLDIERHP = result18;
			}
			else
