...
namespace Google2u
{
	public class Grenade_SMOKEElite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<Grenade_SMOKEEliteRow> Rows = new List<Grenade_SMOKEEliteRow>();
		...
		{
			Rows.Add(new Grenade_SMOKEEliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new Grenade_SMOKEEliteRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public Grenade_SMOKEEliteRow GetRow(rowIds in_RowID)
		{
			Grenade_SMOKEEliteRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public Grenade_SMOKEEliteRow GetRow(string in_RowString)
		{
			Grenade_SMOKEEliteRow result = null;
