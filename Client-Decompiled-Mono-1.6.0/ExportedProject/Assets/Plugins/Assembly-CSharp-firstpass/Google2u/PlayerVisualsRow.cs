...
namespace Google2u
{
	...
	public class PlayerVisualsRow : IGoogle2uRow
	{
		...
		public PlayerVisualsRow(string _ID, string _NAME, string _UNLOCKLEVEL, string _PRICEWARBUCKS, string _PRICEGOLD, string _TIME, string _DECALTYPE, string _DECALVALUE, string _CATEGORYID, string _ONLYFORVIP, string _PURCHASABLE, string _CATEGORY, string _PARTS, string _DUPLICATEWARBUCKS)
		{
			...
			int result2;
			if (int.TryParse(_PRICEWARBUCKS, out result2))
			{
			...
			int result3;
			if (int.TryParse(_PRICEGOLD, out result3))
			{
				PRICEGOLD = result3;
			}
			else
			...
			int result4;
			if (int.TryParse(_TIME, out result4))
			{
				TIME = result4;
			}
			else
			...
			int result5;
			if (int.TryParse(_DECALTYPE, out result5))
			{
				DECALTYPE = result5;
			}
			else
			...
			float result6;
			if (float.TryParse(_DECALVALUE, out result6))
			{
				DECALVALUE = result6;
			}
			else
			...
			int result7;
			if (int.TryParse(_CATEGORYID, out result7))
			{
				CATEGORYID = result7;
			}
			else
			...
			bool result8;
			if (bool.TryParse(_ONLYFORVIP, out result8))
			{
				ONLYFORVIP = result8;
			}
			else
			...
			int result9;
			if (int.TryParse(_CATEGORY, out result9))
			{
				CATEGORY = result9;
			}
			else
			...
			int result10;
			if (int.TryParse(_PARTS, out result10))
			{
				PARTS = result10;
			}
			else
			...
			int result11;
			if (int.TryParse(_DUPLICATEWARBUCKS, out result11))
			{
