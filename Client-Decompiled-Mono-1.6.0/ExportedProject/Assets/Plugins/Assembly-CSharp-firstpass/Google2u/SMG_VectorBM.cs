...
namespace Google2u
{
	public class SMG_VectorBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<SMG_VectorBMRow> Rows = new List<SMG_VectorBMRow>();
		...
		{
			Rows.Add(new SMG_VectorBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public SMG_VectorBMRow GetRow(rowIds in_RowID)
		{
			SMG_VectorBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public SMG_VectorBMRow GetRow(string in_RowString)
		{
			SMG_VectorBMRow result = null;
