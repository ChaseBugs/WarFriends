...
{
	[Serializable]
	public class DBUpgradeSlotsMortarRow : IGoogle2uRow
	{
		public int TIER;
		...
		public ObscuredFloat MORTARBUILDTIME;
		...
		public ObscuredFloat Get_MORTARBUILDTIME
		{
			get
			{
		...
		public DBUpgradeSlotsMortarRow()
		{
		}

		public DBUpgradeSlotsMortarRow(string _GOOGLEFU_ID, string _TIER, string _HP, string _DAMAGE, string _BATCHSIZEMIN, string _BATCHSIZEMAX, string _SHOTFREQUENCYMIN, string _SHOTFREQUENCYMAX, string _REALSHOTPROBABILITY, string _MORTARBUILDTIME, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ARMYPOWER, string _SPECIAL, string _ELITE)
		{
			int result;
			...
			float result9;
			if (float.TryParse(_MORTARBUILDTIME, out result9))
			{
				MORTARBUILDTIME = result9;
			}
			else
			{
				Debug.LogError("Failed To Convert MORTARBUILDTIME string: " + _MORTARBUILDTIME + " to float");
			}
			int result10;
			...
			float result16;
			if (float.TryParse(_ELITE, out result16))
			{
				ELITE = result16;
			}
			else
		...
		public string GetStringDataByIndex(int index)
		{
			...
			case 7:
				...
				break;
			case 8:
				result = MORTARBUILDTIME.ToString();
				break;
			case 9:
		...
		public override string ToString()
		{
			...
			empty = empty + "{MORTARBUILDTIME : " + MORTARBUILDTIME.ToString() + "} ";
