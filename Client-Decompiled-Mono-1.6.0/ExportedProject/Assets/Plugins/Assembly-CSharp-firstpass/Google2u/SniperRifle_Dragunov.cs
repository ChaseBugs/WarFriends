...
namespace Google2u
{
	public class SniperRifle_Dragunov : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<SniperRifle_DragunovRow> Rows = new List<SniperRifle_DragunovRow>();
		...
		{
			Rows.Add(new SniperRifle_DragunovRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new SniperRifle_DragunovRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public SniperRifle_DragunovRow GetRow(rowIds in_RowID)
		{
			SniperRifle_DragunovRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public SniperRifle_DragunovRow GetRow(string in_RowString)
		{
			SniperRifle_DragunovRow result = null;
