...
{
	[Serializable]
	public class Grenade_SMOKEBMRow : IGoogle2uRow
	{
		...
		public Grenade_SMOKEBMRow()
		{
		}

		public Grenade_SMOKEBMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _MINDAMAGE, string _EXPLODEDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
			float result;
