...
{
	[Serializable]
	public class Grenade_FRAGBMRow : IGoogle2uRow
	{
		...
		public Grenade_FRAGBMRow()
		{
		}

		public Grenade_FRAGBMRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _MINDAMAGE, string _EXPLODEDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK, string _WEAPONPRICE)
		{
			float result;
