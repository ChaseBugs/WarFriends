...
namespace Google2u
{
	public class SMG_P90BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<SMG_P90BMRow> Rows = new List<SMG_P90BMRow>();
		...
		{
			Rows.Add(new SMG_P90BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public SMG_P90BMRow GetRow(rowIds in_RowID)
		{
			SMG_P90BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public SMG_P90BMRow GetRow(string in_RowString)
		{
			SMG_P90BMRow result = null;
