...
{
	[Serializable]
	public class LMG_M249Elite2Row : IGoogle2uRow
	{
		...
		public LMG_M249Elite2Row()
		{
		}

		public LMG_M249Elite2Row(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
		{
			float result;
