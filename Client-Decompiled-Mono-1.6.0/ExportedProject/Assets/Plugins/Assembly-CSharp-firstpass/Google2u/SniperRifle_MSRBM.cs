...
namespace Google2u
{
	public class SniperRifle_MSRBM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<SniperRifle_MSRBMRow> Rows = new List<SniperRifle_MSRBMRow>();
		...
		{
			Rows.Add(new SniperRifle_MSRBMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new SniperRifle_MSRBMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public SniperRifle_MSRBMRow GetRow(rowIds in_RowID)
		{
			SniperRifle_MSRBMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public SniperRifle_MSRBMRow GetRow(string in_RowString)
		{
			SniperRifle_MSRBMRow result = null;
