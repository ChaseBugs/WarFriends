...
namespace Google2u
{
	public class VIP : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			VIP_1 = 0,
		...
		public string[] rowNames = new string[4] { "VIP_1", "VIP_2", "VIP_3", "VIP_4" };
		...
		public List<VIPRow> Rows = new List<VIPRow>();
		...
		{
			Rows.Add(new VIPRow(input[0], input[1], input[2], input[3]));
		}
		...
		public VIPRow GetRow(rowIds in_RowID)
		{
			VIPRow result = null;
			try
			{
		...
		public VIPRow GetRow(string in_RowString)
		{
			VIPRow result = null;
