...
namespace Google2u
{
	public class LMG_M249PARABM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<LMG_M249PARABMRow> Rows = new List<LMG_M249PARABMRow>();
		...
		{
			Rows.Add(new LMG_M249PARABMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new LMG_M249PARABMRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public LMG_M249PARABMRow GetRow(rowIds in_RowID)
		{
			LMG_M249PARABMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public LMG_M249PARABMRow GetRow(string in_RowString)
		{
			LMG_M249PARABMRow result = null;
