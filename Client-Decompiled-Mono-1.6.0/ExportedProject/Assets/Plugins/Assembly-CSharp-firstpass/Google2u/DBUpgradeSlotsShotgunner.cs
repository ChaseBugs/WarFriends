...
namespace Google2u
{
	public class DBUpgradeSlotsShotgunner : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<DBUpgradeSlotsShotgunnerRow> Rows = new List<DBUpgradeSlotsShotgunnerRow>();
		...
		{
			Rows.Add(new DBUpgradeSlotsShotgunnerRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new DBUpgradeSlotsShotgunnerRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public DBUpgradeSlotsShotgunnerRow GetRow(rowIds in_RowID)
		{
			DBUpgradeSlotsShotgunnerRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public DBUpgradeSlotsShotgunnerRow GetRow(string in_RowString)
		{
			DBUpgradeSlotsShotgunnerRow result = null;
