...
namespace Google2u
{
	public class DBUpgradeSlotsSwat : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public string[] rowNames = new string[111]
		{
			...
			"SPECIAL_14", "SPECIAL_15", "ELITE_0", "ELITE_1", "ELITE_2", "ELITE_3", "ELITE_4", "ELITE_5", "CARDS_MIN", "CARDS_MAX",
			"WARARENA"
		};
		...
		public List<DBUpgradeSlotsSwatRow> Rows = new List<DBUpgradeSlotsSwatRow>();
		...
		{
			Rows.Add(new DBUpgradeSlotsSwatRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new DBUpgradeSlotsSwatRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public DBUpgradeSlotsSwatRow GetRow(rowIds in_RowID)
		{
			DBUpgradeSlotsSwatRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public DBUpgradeSlotsSwatRow GetRow(string in_RowString)
		{
			DBUpgradeSlotsSwatRow result = null;
