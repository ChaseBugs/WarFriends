...
namespace Google2u
{
	public class LMG_M60BM : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<LMG_M60BMRow> Rows = new List<LMG_M60BMRow>();
		...
		{
			Rows.Add(new LMG_M60BMRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
		}
		...
		public LMG_M60BMRow GetRow(rowIds in_RowID)
		{
			LMG_M60BMRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public LMG_M60BMRow GetRow(string in_RowString)
		{
			LMG_M60BMRow result = null;
