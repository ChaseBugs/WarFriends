...
namespace Google2u
{
	...
	public class AchievementsRow : IGoogle2uRow
	{
		...
		public AchievementsRow(string _ID, string _CLASS, string _VALUE, string _REWARDWB, string _REWARDGOLD, string _REWARDSCRAPS, string _REWARDTICKETS, string _GROUPID, string _ANDROIDID, string _ANDROIDIDCHILL, string _IOSID, string _DESCRIPTION, string _GUITITLE, string _GUIDESCRIPTION)
		{
			...
			int result2;
			if (int.TryParse(_REWARDWB, out result2))
			{
				REWARDWB = result2;
			}
			else
			...
			int result3;
			if (int.TryParse(_REWARDGOLD, out result3))
			{
				REWARDGOLD = result3;
			}
			else
			...
			int result4;
			if (int.TryParse(_REWARDSCRAPS, out result4))
			{
			...
			int result5;
			if (int.TryParse(_REWARDTICKETS, out result5))
			{
			...
			int result6;
			if (int.TryParse(_GROUPID, out result6))
			{
				GROUPID = result6;
			}
			else
