...
namespace Google2u
{
	public class AssaultRifle_AK47Elite : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<AssaultRifle_AK47EliteRow> Rows = new List<AssaultRifle_AK47EliteRow>();
		...
		{
			Rows.Add(new AssaultRifle_AK47EliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public override int AddBlanckRowGeneric(string rowId)
		{
			...
			Rows.Add(new AssaultRifle_AK47EliteRow());
			mRows = null;
			return namesToIndex[rowId];
		}
		...
		public AssaultRifle_AK47EliteRow GetRow(rowIds in_RowID)
		{
			AssaultRifle_AK47EliteRow result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public AssaultRifle_AK47EliteRow GetRow(string in_RowString)
		{
			AssaultRifle_AK47EliteRow result = null;
