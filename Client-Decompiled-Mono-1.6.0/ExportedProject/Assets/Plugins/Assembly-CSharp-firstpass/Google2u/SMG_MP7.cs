...
namespace Google2u
{
	public class SMG_MP7 : Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds
		{
			ROW_1 = 0,
		...
		public List<SMG_MP7Row> Rows = new List<SMG_MP7Row>();
		...
		{
			Rows.Add(new SMG_MP7Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
		}
		...
		public SMG_MP7Row GetRow(rowIds in_RowID)
		{
			SMG_MP7Row result = null;
			try
			{
				result = Rows[(int)in_RowID];
			}
		...
		public SMG_MP7Row GetRow(string in_RowString)
		{
			SMG_MP7Row result = null;
