	...
	public sealed class TwofishEngine : IBlockCipher
	{
		...
		private void EncryptBlock(byte[] src, int srcIndex, byte[] dst, int dstIndex)
		{
			...
			for (int i = 0; i < 16; i += 2)
			{
				...
				num4 = (int)((uint)(num4 << 1) | ((uint)num4 >> 31)) ^ (num6 + 2 * num7 + gSubKeys[num5++]);
				num6 = Fe32_0(num3);
				num7 = Fe32_3(num4);
				num ^= num6 + num7 + gSubKeys[num5++];
				num = (int)((uint)num >> 1) | (num << 31);
				num2 = (int)((uint)(num2 << 1) | ((uint)num2 >> 31)) ^ (num6 + 2 * num7 + gSubKeys[num5++]);
			}
		...
		private void DecryptBlock(byte[] src, int srcIndex, byte[] dst, int dstIndex)
		{
			...
			for (int i = 0; i < 16; i += 2)
			{
				...
				num3 = (int)((uint)(num3 << 1) | ((uint)num3 >> 31)) ^ (num6 + num7 + gSubKeys[num5--]);
				num4 = (int)((uint)num4 >> 1) | (num4 << 31);
				num6 = Fe32_0(num3);
				num7 = Fe32_3(num4);
				num2 ^= num6 + 2 * num7 + gSubKeys[num5--];
				num = (int)((uint)(num << 1) | ((uint)num >> 31)) ^ (num6 + num7 + gSubKeys[num5--]);
		...
		private int RS_rem(int x)
		{
			...
			int num3 = (int)(((uint)num >> 1) ^ (uint)(((num & 1) != 0) ? 166 : 0)) ^ num2;
