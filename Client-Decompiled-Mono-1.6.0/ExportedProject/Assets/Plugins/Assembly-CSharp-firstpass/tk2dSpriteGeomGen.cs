		...
		for (int i = 0; i < num2; i++)
		{
			...
			for (int j = 0; j < num; j++)
			{
				...
				if (num4 != 1f || num5 != 1f)
				{
					...
					pos[offset + num3] = vector5 + new Vector3(vector7.x, vector7.y, vector7.z);
					pos[offset + num3 + 1] = vector5 + new Vector3(vector8.x, vector7.y, vector7.z);
					pos[offset + num3 + 2] = vector5 + new Vector3(vector7.x, vector8.y, vector7.z);
					pos[offset + num3 + 3] = vector5 + new Vector3(vector8.x, vector8.y, vector7.z);
					if (spriteDef.flipped == tk2dSpriteDefinition.FlipMode.Tk2d)
					{
				...
				{
					pos[offset + num3] = vector5 + Vector3.Scale(spriteDef.positions[0], scale);
					pos[offset + num3 + 1] = vector5 + Vector3.Scale(spriteDef.positions[1], scale);
					pos[offset + num3 + 2] = vector5 + Vector3.Scale(spriteDef.positions[2], scale);
					pos[offset + num3 + 3] = vector5 + Vector3.Scale(spriteDef.positions[3], scale);
