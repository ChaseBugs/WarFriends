...
public class PlayerLeagueRecord : PoolableObject
{
	...
	public void AFEDNJFMGEO(LeagueContent.KJNEDPOJJOC CHELCBJKLFK, float CEHFMMJHCKC)
	{
		...
		if (CHELCBJKLFK.FJLBLLLEELD == LeagueContent.NKHJBLBAAEB.Header)
		{
			...
			Singleton<PlayerTexturePool>.instance.RequestPlayerTexture(MBIAKMPDOPG, true, PlayerTexturePool.DFJJOANIJID.Card);
		...
		else
		{
			...
			{
				EIDJHKHJBII.gameObject.SetActive(true);
	...
	public void PAKLIFNHMAI(LeagueContent.KJNEDPOJJOC CHELCBJKLFK, float CEHFMMJHCKC)
	{
		...
		else
		{
			...
			{
				EIDJHKHJBII.gameObject.SetActive(false);
				if (CHELCBJKLFK.MPHCNMDIPAI <= CHELCBJKLFK.OKHCCAIPHEG)
				{
	...
	public void BANIBDDJPCE()
	{
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.PIKHCIHPMCE(MBIAKMPDOPG.id, false, false, true);
			MBIAKMPDOPG = null;
		}
	}
	...
	public void DNLMHBKDMBF()
	{
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.MDANAEPCCHK(MBIAKMPDOPG.id, false);
			MBIAKMPDOPG = null;
		}
	}
	...
	public void KPANCIFIOFC()
	{
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.BPEHHBALINP(MBIAKMPDOPG.id, true, true, true);
			MBIAKMPDOPG = null;
		}
	}
	...
	public void PMKFODAHHAA()
	{
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.IEPBDAHEKCL(MBIAKMPDOPG.id, false, false, true);
			MBIAKMPDOPG = null;
		}
	}
	...
	public void NKBFDKBOOAK()
	{
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.DAGIACKCPKH(MBIAKMPDOPG.id, true, true, true);
			MBIAKMPDOPG = null;
		}
	}
	...
	public void IKLOOMDCCGJ(LeagueContent.KJNEDPOJJOC CHELCBJKLFK, float CEHFMMJHCKC)
	{
		...
		if (CHELCBJKLFK.FJLBLLLEELD == LeagueContent.NKHJBLBAAEB.Header)
		{
			...
			Singleton<PlayerTexturePool>.instance.RequestPlayerTexture(MBIAKMPDOPG, false, PlayerTexturePool.DFJJOANIJID.Card);
			string text = GameVariables.IEDGPHEPJEK(MBIAKMPDOPG.country);
			bool flag2 = string.IsNullOrEmpty(text);
			OOECKDBCHKL.gameObject.SetActive(flag2);
			if (flag2)
	...
	public void IHJICFANFDJ()
	{
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.MDANAEPCCHK(MBIAKMPDOPG.id, false, true);
			MBIAKMPDOPG = null;
		}
	}
	...
	public void CNOEPDMAIEG()
	{
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.DAGIACKCPKH(MBIAKMPDOPG.id, false, true);
			MBIAKMPDOPG = null;
		}
	}
	...
	public void NNFHBKCBADE()
	{
		if (MBIAKMPDOPG != null)
		{
			Singleton<PlayerTexturePool>.instance.LBKLINGCPBA(MBIAKMPDOPG.id, false, false, true);
			MBIAKMPDOPG = null;
		}
	}
