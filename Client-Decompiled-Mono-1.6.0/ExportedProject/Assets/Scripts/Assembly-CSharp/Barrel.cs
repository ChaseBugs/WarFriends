...
public class Barrel : PoolableObject
{
	...
	protected virtual void KODJIPJGFPB()
	{
		...
		base.Awake();
		GFOMNMGLLOP.gameObject.SetActive(true);
	...
	protected virtual void OHHLNKPIHBH()
	{
		...
		base.Awake();
		GFOMNMGLLOP.gameObject.SetActive(false);
		if (FEHCCGEGPLH.isMine)
		{
