...
public class WinStreakCounter : Core_BaseScript
{
	...
	private void FLDEAGICEHF()
	{
		...
		{
			CLEGBKAFDFF = DKHAPGCCCBE - num;
			KGNGFHMBHMJ.text = MEJMLNDFDBP.CJCFPDLDMEK(CLEGBKAFDFF, "ShieldRechargeRate", string.Empty, false);
			if (FINAFBAHMLD != null)
			{
				FINAFBAHMLD();
			}
	...
	{
		return MEJMLNDFDBP.CJCFPDLDMEK(CLEGBKAFDFF, "OK", string.Empty, false);
	}
	...
	private void BPKEJPGJOLN()
	{
		...
		{
			CLEGBKAFDFF = DKHAPGCCCBE - num;
			KGNGFHMBHMJ.text = MEJMLNDFDBP.CJCFPDLDMEK(CLEGBKAFDFF, "ChangeWeaponsRPC", string.Empty, false);
			if (FINAFBAHMLD != null)
			{
				FINAFBAHMLD();
			}
	...
	private void CMFPPJLKNBJ()
	{
		...
		{
			CLEGBKAFDFF = DKHAPGCCCBE - num;
			KGNGFHMBHMJ.text = MEJMLNDFDBP.CJCFPDLDMEK(CLEGBKAFDFF, "unlockLevel", string.Empty, false);
			if (FINAFBAHMLD != null)
			{
				FINAFBAHMLD();
			}
	...
	private void PLOJBNKCOGO()
	{
		...
		{
			CLEGBKAFDFF = DKHAPGCCCBE - num;
			KGNGFHMBHMJ.text = MEJMLNDFDBP.CJCFPDLDMEK(CLEGBKAFDFF, "ID_INVITATIONDENIED", string.Empty, false);
			if (FINAFBAHMLD != null)
			{
				FINAFBAHMLD();
			}
	...
	private void LFHPGHOHMGK()
	{
		...
		{
			CLEGBKAFDFF = DKHAPGCCCBE - currentTimestamp;
			KGNGFHMBHMJ.text = MEJMLNDFDBP.CJCFPDLDMEK(CLEGBKAFDFF, "GameLauncher.Async done", string.Empty, false);
			if (FINAFBAHMLD != null)
			{
				FINAFBAHMLD();
			}
	...
	private void JKHKNOIFFFC()
	{
		...
		{
			CLEGBKAFDFF = DKHAPGCCCBE - currentTimestamp;
			KGNGFHMBHMJ.text = MEJMLNDFDBP.CJCFPDLDMEK(CLEGBKAFDFF, "-[0-9]*$", string.Empty, false);
			if (FINAFBAHMLD != null)
			{
				FINAFBAHMLD();
			}
	...
	{
		return MEJMLNDFDBP.CJCFPDLDMEK(CLEGBKAFDFF, "#AccoutCheck# GPGS login during tutorial", string.Empty, false);
	}
