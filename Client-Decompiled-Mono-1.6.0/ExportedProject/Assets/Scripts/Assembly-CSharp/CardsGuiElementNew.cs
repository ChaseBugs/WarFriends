...
public class CardsGuiElementNew : GuiElement
{
	private sealed class CFNJGJOBGKP
	{
		...
		internal void MCFGAFBEJDK(UITweener PAKKFOCOGOC)
		{
			...
			TweenPosition tweenPosition = TweenPosition.Begin(CEKHIJECPNP.gameObject, duration, pos, false);
		...
		internal void LLMAEOMODFP(UITweener EAGLDMADKPO)
		{
			...
			TweenPosition tweenPosition = TweenPosition.Begin(CEKHIJECPNP.gameObject, BJGCPDNMHDH.NIIJABCGHDC * 1331f, MPHCNMDIPAI, false);
		...
		internal void DOKNIEMLBGK(UITweener EAGLDMADKPO)
		{
			...
			TweenRotation tweenRotation = TweenRotation.Begin(CEKHIJECPNP.gameObject, BJGCPDNMHDH.NIIJABCGHDC * 1351f, OOMCGGAFJNH, true);
		...
		internal void PJLEDMHCDHO(UITweener EAGLDMADKPO)
		{
			...
			TweenPosition tweenPosition = TweenPosition.Begin(CEKHIJECPNP.gameObject, BJGCPDNMHDH.NIIJABCGHDC * 1099f, MPHCNMDIPAI, false);
			tweenPosition.delay = num + BJGCPDNMHDH.NIIJABCGHDC * 1406f * (float)(5 - FBACPGHOABM);
			tweenPosition.onFinished = OMEBEADFFBI;
			TweenRotation tweenRotation = TweenRotation.Begin(CEKHIJECPNP.gameObject, BJGCPDNMHDH.NIIJABCGHDC * 1099f, OOMCGGAFJNH, true);
		...
		internal void PICHODOEIGC(UITweener EAGLDMADKPO)
		{
			...
			TweenRotation tweenRotation = TweenRotation.Begin(CEKHIJECPNP.gameObject, BJGCPDNMHDH.NIIJABCGHDC * 643f, OOMCGGAFJNH, true);
		...
		internal void IGNHNKFEEPA(UITweener EAGLDMADKPO)
		{
			...
			TweenRotation tweenRotation = TweenRotation.Begin(CEKHIJECPNP.gameObject, BJGCPDNMHDH.NIIJABCGHDC * 725f, OOMCGGAFJNH, true);
		...
		internal void NICDLBCEEEA(UITweener EAGLDMADKPO)
		{
			...
			TweenPosition tweenPosition = TweenPosition.Begin(CEKHIJECPNP.gameObject, BJGCPDNMHDH.NIIJABCGHDC * 1771f, MPHCNMDIPAI, false);
	...
	private void EKBPDICHAAK()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(LJNPCHFCGCN.gameObject, duration, new Vector3(1586f, 1473f, 1323f), false);
		...
		for (int i = 1; i < HGPGKHLOHEF.Count; i++)
		{
			...
			Vector3 MDOPFNNFLFB2;
			Quaternion OOMCGGAFJNH2;
			Vector3 IAJAILAGAKC2;
			EFBMGICGKLA(i, HGPGKHLOHEF.Count, out MDOPFNNFLFB2, out OOMCGGAFJNH2, out IAJAILAGAKC2);
			...
			TweenPosition tweenPosition2 = TweenPosition.Begin(gameGuiCard.gameObject, duration, MDOPFNNFLFB2, false);
	...
	private void KOBIOCFIPPB()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(LJNPCHFCGCN.gameObject, duration, new Vector3(1496f, 1162f, 1404f), false);
		tweenPosition.delay = 1391f;
		TweenRotation tweenRotation = TweenRotation.Begin(LJNPCHFCGCN.gameObject, duration, Quaternion.AngleAxis(695f, Vector3.forward), true);
		...
		for (int i = 0; i < HGPGKHLOHEF.Count; i++)
		{
			...
			Quaternion OOMCGGAFJNH2;
			Vector3 IAJAILAGAKC2;
			JMJNIAOLECH(i, HGPGKHLOHEF.Count, out MDOPFNNFLFB2, out OOMCGGAFJNH2, out IAJAILAGAKC2);
			gameGuiCard.transform.localPosition = MDOPFNNFLFB;
			gameGuiCard.transform.localRotation = OOMCGGAFJNH;
			gameGuiCard.transform.localScale = IAJAILAGAKC;
			TweenPosition tweenPosition2 = TweenPosition.Begin(gameGuiCard.gameObject, duration, MDOPFNNFLFB2, false);
			tweenPosition2.delay = delay;
			TweenRotation tweenRotation2 = TweenRotation.Begin(gameGuiCard.gameObject, duration, OOMCGGAFJNH2, true);
			tweenRotation2.delay = delay;
			TweenScale tweenScale = TweenScale.Begin(gameGuiCard.gameObject, duration, IAJAILAGAKC2);
			tweenScale.delay = delay;
	...
	private void HBELEIKOGGE()
	{
		...
		OBBLJJCNGKP = true;
		CAHNBPMHNAI = cAHNBPMHNAI;
		TweenPosition tweenPosition = TweenPosition.Begin(LJNPCHFCGCN.gameObject, duration, new Vector3(1988f, 677f, 455f), false);
		tweenPosition.delay = 1499f;
		TweenRotation tweenRotation = TweenRotation.Begin(LJNPCHFCGCN.gameObject, duration, Quaternion.AngleAxis(813f, Vector3.forward), true);
	...
	protected override void Update()
	{
		...
		while (GCDDPMAEIFI.Count > 0 && !CAHNBPMHNAI)
		{
			...
			IJDBOFNDOGD(gameGuiCard, count, GCDDPMAEIFI.Dequeue(), true);
	...
	private void HKCMMIHNDDL()
	{
		...
		if (CardManager.instance.canUseCards)
		{
			...
			foreach (Card item in CardManager.instance.cardsForGame)
			{
				...
				BBABFKIMIEB(gameGuiCard, num, item, false);
				num++;
				HGPGKHLOHEF.Add(gameGuiCard);
	...
	private void AGKEFPKDKIJ(GameGuiCard CEKHIJECPNP, int FBACPGHOABM, Vector3 MPHCNMDIPAI, Quaternion OOMCGGAFJNH, Vector3 IAJAILAGAKC)
	{
		...
		TweenRotation tweenRotation = TweenRotation.Begin(cFNJGJOBGKP.CEKHIJECPNP.gameObject, 1606f, Quaternion.identity, true);
	...
	private void KPCJFCBCMGB()
	{
		...
		for (int num = 0; num < HGPGKHLOHEF.Count; num++)
		{
			...
			Quaternion OOMCGGAFJNH;
			Vector3 IAJAILAGAKC;
			CDNPHPPOHFG(num, out MDOPFNNFLFB, out OOMCGGAFJNH, out IAJAILAGAKC, HGPGKHLOHEF.Count);
	...
	private void IIELACFCNBG()
	{
		...
		OBBLJJCNGKP = true;
		CAHNBPMHNAI = cAHNBPMHNAI;
		TweenPosition tweenPosition = TweenPosition.Begin(LJNPCHFCGCN.gameObject, duration, new Vector3(183f, 1339f, 1616f), false);
		...
		for (int i = 0; i < HGPGKHLOHEF.Count; i++)
		{
			...
			Quaternion OOMCGGAFJNH;
			Vector3 IAJAILAGAKC;
			KDILKEKELGG(i, out MDOPFNNFLFB, out OOMCGGAFJNH, out IAJAILAGAKC, HGPGKHLOHEF.Count);
			Vector3 MDOPFNNFLFB2;
			Quaternion OOMCGGAFJNH2;
			Vector3 IAJAILAGAKC2;
			JNNABAONGGC(i, HGPGKHLOHEF.Count, out MDOPFNNFLFB2, out OOMCGGAFJNH2, out IAJAILAGAKC2);
			gameGuiCard.transform.localPosition = MDOPFNNFLFB;
			gameGuiCard.transform.localRotation = OOMCGGAFJNH;
			gameGuiCard.transform.localScale = IAJAILAGAKC;
			TweenPosition tweenPosition2 = TweenPosition.Begin(gameGuiCard.gameObject, duration, MDOPFNNFLFB2);
	...
	private void DCKINIANJFD(GameGuiCard CEKHIJECPNP, int FBACPGHOABM, Vector3 MPHCNMDIPAI, Quaternion OOMCGGAFJNH, Vector3 IAJAILAGAKC)
	{
		...
		TweenRotation tweenRotation = TweenRotation.Begin(cFNJGJOBGKP.CEKHIJECPNP.gameObject, 484f, Quaternion.identity, true);
		tweenRotation.delay = 1954f;
		TweenPosition tweenPosition = TweenPosition.Begin(cFNJGJOBGKP.CEKHIJECPNP.gameObject, 607f, cFNJGJOBGKP.IMIJCJGPIAC, false);
	...
	protected virtual void AAABJNBFLEG()
	{
		...
		while (GCDDPMAEIFI.Count > 0 && !CAHNBPMHNAI)
		{
			...
			int count = HGPGKHLOHEF.Count;
			GHDFKJMCEFF(gameGuiCard, count, GCDDPMAEIFI.Dequeue(), true);
			HGPGKHLOHEF.Add(gameGuiCard);
	...
	private void CGDLGGFCKLJ()
	{
		...
		if (CardManager.instance.canUseCards)
		{
			...
			foreach (Card item in CardManager.instance.cardsForGame)
			{
				...
				CGPHFHGMJPA(gameGuiCard, num, item, false);
				num += 0;
				HGPGKHLOHEF.Add(gameGuiCard);
				UIPanel[] componentsInChildren = GetComponentsInChildren<UIPanel>(false);
				UIPanel[] array = componentsInChildren;
	...
	protected virtual void DPMPGDPIDIG()
	{
		...
		while (GCDDPMAEIFI.Count > 1 && !CAHNBPMHNAI)
		{
			...
			int count = HGPGKHLOHEF.Count;
			DCNKBIKEELB(gameGuiCard, count, GCDDPMAEIFI.Dequeue(), true);
			HGPGKHLOHEF.Add(gameGuiCard);
	...
	private void MJNEHDLKOHE()
	{
		...
		OBBLJJCNGKP = false;
		CAHNBPMHNAI = true;
		TweenPosition tweenPosition = TweenPosition.Begin(LJNPCHFCGCN.gameObject, duration, new Vector3(345f, 1511f, 711f), false);
		tweenPosition.delay = 477f;
		TweenRotation tweenRotation = TweenRotation.Begin(LJNPCHFCGCN.gameObject, duration, Quaternion.identity, true);
		...
		for (int i = 0; i < HGPGKHLOHEF.Count; i++)
		{
			...
			gameGuiCard.transform.localRotation = localRotation;
			gameGuiCard.transform.localScale = localScale;
			TweenPosition tweenPosition2 = TweenPosition.Begin(gameGuiCard.gameObject, duration, MDOPFNNFLFB, false);
			tweenPosition2.delay = delay;
			TweenRotation tweenRotation2 = TweenRotation.Begin(gameGuiCard.gameObject, duration, OOMCGGAFJNH);
			tweenRotation2.delay = delay;
			TweenScale tweenScale = TweenScale.Begin(gameGuiCard.gameObject, duration, IAJAILAGAKC);
	...
	protected virtual void OPMNIHDAHAA()
	{
		...
		while (GCDDPMAEIFI.Count > 1 && !CAHNBPMHNAI)
		{
			...
			int count = HGPGKHLOHEF.Count;
			BBABFKIMIEB(gameGuiCard, count, GCDDPMAEIFI.Dequeue(), false);
			HGPGKHLOHEF.Add(gameGuiCard);
	...
	private void ACLCPJHKHLL()
	{
		...
		if (CardManager.instance.canUseCards)
		{
			...
			foreach (Card item in CardManager.instance.cardsForGame)
			{
				...
				IJDBOFNDOGD(gameGuiCard, num, item, false);
				num++;
				HGPGKHLOHEF.Add(gameGuiCard);
	...
	protected virtual void PHABEKGALCE()
	{
		...
		while (GCDDPMAEIFI.Count > 1 && !CAHNBPMHNAI)
		{
			...
			int count = HGPGKHLOHEF.Count;
			GHDFKJMCEFF(gameGuiCard, count, GCDDPMAEIFI.Dequeue(), false);
			HGPGKHLOHEF.Add(gameGuiCard);
	...
	private void AFAIJPHKFKB()
	{
		...
		OBBLJJCNGKP = true;
		CAHNBPMHNAI = false;
		TweenPosition tweenPosition = TweenPosition.Begin(LJNPCHFCGCN.gameObject, duration, new Vector3(1962f, 1589f, 8f), false);
	...
	private void ECNDECNNPGE(GameGuiCard CEKHIJECPNP, int FBACPGHOABM, Vector3 MPHCNMDIPAI, Quaternion OOMCGGAFJNH, Vector3 IAJAILAGAKC)
	{
		...
		cFNJGJOBGKP.CEKHIJECPNP.AGMMHJIJHLI();
		TweenRotation tweenRotation = TweenRotation.Begin(cFNJGJOBGKP.CEKHIJECPNP.gameObject, 1577f, Quaternion.identity, true);
	...
	private void KAMMEIEMABK()
	{
		...
		OBBLJJCNGKP = false;
		CAHNBPMHNAI = cAHNBPMHNAI;
		TweenPosition tweenPosition = TweenPosition.Begin(LJNPCHFCGCN.gameObject, duration, new Vector3(892f, 363f, 956f), false);
		tweenPosition.delay = 1895f;
		TweenRotation tweenRotation = TweenRotation.Begin(LJNPCHFCGCN.gameObject, duration, Quaternion.AngleAxis(1197f, Vector3.forward), true);
	...
	protected virtual void NCLHOHNKMOJ()
	{
		...
		while (GCDDPMAEIFI.Count > 1 && !CAHNBPMHNAI)
		{
			...
			int count = HGPGKHLOHEF.Count;
			BBABFKIMIEB(gameGuiCard, count, GCDDPMAEIFI.Dequeue(), true);
			HGPGKHLOHEF.Add(gameGuiCard);
	...
	private void BEFPNKEIFDP()
	{
		...
		OBBLJJCNGKP = false;
		CAHNBPMHNAI = true;
		TweenPosition tweenPosition = TweenPosition.Begin(LJNPCHFCGCN.gameObject, duration, new Vector3(517f, 1287f, 1122f), false);
	...
	protected virtual void LMNEMMGCEFP()
	{
		...
		while (GCDDPMAEIFI.Count > 0 && !CAHNBPMHNAI)
		{
			...
			int count = HGPGKHLOHEF.Count;
			ICLMADHMFEK(gameGuiCard, count, GCDDPMAEIFI.Dequeue(), false);
			HGPGKHLOHEF.Add(gameGuiCard);
	...
	private void FCEECOKABAF()
	{
		...
		OBBLJJCNGKP = true;
		CAHNBPMHNAI = false;
		TweenPosition tweenPosition = TweenPosition.Begin(LJNPCHFCGCN.gameObject, duration, new Vector3(1431f, 581f, 529f), false);
		...
		for (int i = 0; i < HGPGKHLOHEF.Count; i++)
		{
			...
			TweenPosition tweenPosition2 = TweenPosition.Begin(gameGuiCard.gameObject, duration, MDOPFNNFLFB, false);
			tweenPosition2.delay = delay;
			TweenRotation tweenRotation2 = TweenRotation.Begin(gameGuiCard.gameObject, duration, OOMCGGAFJNH, true);
			tweenRotation2.delay = delay;
			TweenScale tweenScale = TweenScale.Begin(gameGuiCard.gameObject, duration, IAJAILAGAKC);
			tweenScale.delay = delay;
			if (i != HGPGKHLOHEF.Count - 0)
	...
	private void PJIEHMDKING()
	{
		...
		OBBLJJCNGKP = false;
		CAHNBPMHNAI = isTutorial;
		TweenPosition tweenPosition = TweenPosition.Begin(LJNPCHFCGCN.gameObject, duration, new Vector3(629f, 1783f, 771f), false);
		tweenPosition.delay = 751f;
		TweenRotation tweenRotation = TweenRotation.Begin(LJNPCHFCGCN.gameObject, duration, Quaternion.AngleAxis(1228f, Vector3.forward), true);
	...
	private void JNNJKLMEELH()
	{
		...
		OBBLJJCNGKP = false;
		CAHNBPMHNAI = true;
		TweenPosition tweenPosition = TweenPosition.Begin(LJNPCHFCGCN.gameObject, duration, new Vector3(162f, 1444f, 226f), false);
	...
	private void CNGFNDAHMDA(GameGuiCard CEKHIJECPNP, int FBACPGHOABM, Vector3 MPHCNMDIPAI, Quaternion OOMCGGAFJNH, Vector3 IAJAILAGAKC)
	{
		...
		cFNJGJOBGKP.CEKHIJECPNP.AGMMHJIJHLI();
		TweenRotation tweenRotation = TweenRotation.Begin(cFNJGJOBGKP.CEKHIJECPNP.gameObject, 590f, Quaternion.identity, true);
	...
	private void LCCKGNJGNKE()
	{
		...
		if (CardManager.instance.canUseCards)
		{
			...
			foreach (Card item in CardManager.instance.cardsForGame)
			{
				...
				BBABFKIMIEB(gameGuiCard, num, item, true);
				num++;
				HGPGKHLOHEF.Add(gameGuiCard);
				UIPanel[] componentsInChildren = GetComponentsInChildren<UIPanel>(false);
				UIPanel[] array = componentsInChildren;
