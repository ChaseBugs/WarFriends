...
public class InventoryItem : PoolableObject
{
	...
	private bool MKPNKCGLJJP
	{
		...
		set
		{
			if (value != IHJGEFJOFKH)
			{
				...
				if (value)
				{
					JCBIFONBAIF.gameObject.SetActive(true);
					CMIBPCAHILH.gameObject.SetActive(true);
				}
				else
				{
					JCBIFONBAIF.gameObject.SetActive(false);
					CMIBPCAHILH.gameObject.SetActive(false);
				}
			}
		}
	}
	...
	protected void CIFBCMKDGIE()
	{
		...
		{
			EJJCBDIPCGC(false, "InstantBattleEnded: REWARD WARBUCKS: ", 0);
		}
		...
		if (MDAJJIAMDGH.weapon.NAIKLJKNLAE)
		{
			...
			{
				PGCFPMJHMBN.gameObject.SetActive(true);
			...
			{
				PGCFPMJHMBN.gameObject.SetActive(false);
				BHCBAEHFIDM = false;
			}
		}
	}
	...
	private void OCIMPNFGBCL()
	{
		...
		PGCFPMJHMBN.gameObject.SetActive(false);
		KPMENKGPHMI.gameObject.SetActive(false);
	...
	{
		DDHPKAEEMNI.gameObject.SetActive(false);
	}
	...
	protected void NKGLGNEJIOA()
	{
		...
		{
			MAPIDEPJDPP(false, "videoAdRewardTimes", 6);
		}
	...
	private void IBPMEHALEBH()
	{
		...
		PGCFPMJHMBN.gameObject.SetActive(false);
		KPMENKGPHMI.gameObject.SetActive(true);
	...
	protected void LMNEMMGCEFP()
	{
		...
		{
			JIFCMBCICBJ(true, "ID_TUTORIAL_GO_BUY_ARMY_3", 4);
		}
	...
	public void FDJLFPLGJGP(int KKIBAPKPEMN)
	{
		...
		DDHPKAEEMNI.gameObject.SetActive(true);
	}
	...
	public void KFEMHFNNEDP(int KKIBAPKPEMN)
	{
		...
		TweenPosition.Begin(DDHPKAEEMNI.gameObject, 948f, localPosition, false);
	...
	public void HEHAPCPPHJA(int KKIBAPKPEMN)
	{
		...
		TweenPosition.Begin(DDHPKAEEMNI.gameObject, 1922f, localPosition, false);
	...
	protected void INDEGJKHMNL()
	{
		...
		{
			EJJCBDIPCGC(true, "\\D*(?<num>[\\d\\s\\.,]+?)(?<dec>([\\.,]\\s*\\d?\\d?)?)\\D*$", 8);
		}
	...
	protected void Update()
	{
		...
		{
			SetIcoProgress(false, "game-card-ico-disarmed", 2);
		}
	...
	public void EGOJLBPPMJC(int KKIBAPKPEMN)
	{
		...
		TweenPosition.Begin(DDHPKAEEMNI.gameObject, 1085f, localPosition, false);
