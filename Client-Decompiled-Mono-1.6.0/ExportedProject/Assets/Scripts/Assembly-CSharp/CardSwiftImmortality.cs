...
public class CardSwiftImmortality : Card
{
	...
	public float buffTime
	{
		get
		{
			return Singleton<GameVariables>.instance.cardConstants.GetRow(CardConstants.rowIds.SwiftImmortalityTime).FLOATVALUE;
		}
	}
	...
	protected void EKPBOMOMMFB()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 326f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.NNPILDOKNJO("SendUnitRPC", false);
		}
	}
	...
	public override void UseCard(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-swiftimmortality", true);
	...
	protected void Update()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 0f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-swiftimmortality", false);
		}
	}
	...
	public virtual void DBAPEPJHJMH(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.PEBHGOMEKME("S", false, true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void IGJJHCKMDBK(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH("WarningDialog - Can send logs: ", true, true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	protected void OPMNIHDAHAA()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1664f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.LDGKPCDJPLA("ID_STAT_WINS", true, true);
		}
	}
}
