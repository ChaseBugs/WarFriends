...
public class ActiveUnitsIcon : Core_BaseScript
{
	...
	public ActiveUnitsManager.LDJGKDAGPLG state
	{
		get
		{
			return DAHCKIBAPFP;
	...
	{
		MLKAMPJNAKO(Singleton<ActiveUnitsManager>.instance.GetState(IFFDIHCPKFE, true));
	}
	...
	{
		DBPBOKJHOEA(Singleton<ActiveUnitsManager>.instance.GetState(IFFDIHCPKFE, false));
	}
