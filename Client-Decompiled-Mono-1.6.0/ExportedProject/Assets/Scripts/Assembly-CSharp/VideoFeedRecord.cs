...
public class VideoFeedRecord : PoolableObject
{
	...
	public VideoFeedManager.VideoFeed video
	{
		get
		{
			return AGLCHFLACPL;
	...
	{
		GuiScreenSingle<VideoFeedScreen>.instance.BPCNLKOFKMM(false, this);
	}
	...
	{
		GuiScreenSingle<VideoFeedScreen>.instance.SelectVideo(true, this);
	}
	...
	{
		GuiScreenSingle<VideoFeedScreen>.instance.FOEBLIINLFE(true, this);
	}

	private void OHLFDFEJKIL(GameObject KHAHPAKDIKE)
	{
		GuiScreenSingle<VideoFeedScreen>.instance.FOEBLIINLFE(false, this);
	}
	...
	{
		GuiScreenSingle<VideoFeedScreen>.instance.BPCNLKOFKMM(true, this);
	}
	...
	{
		GuiScreenSingle<VideoFeedScreen>.instance.KIFDPFEMLGH(true, this);
	}
	...
	{
		GuiScreenSingle<VideoFeedScreen>.instance.SelectVideo(false, this);
	}
