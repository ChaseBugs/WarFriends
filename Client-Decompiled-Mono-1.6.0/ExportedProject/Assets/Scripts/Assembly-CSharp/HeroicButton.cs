...
public class HeroicButton : Core_BaseScript
{
	...
	private sealed class HGCJHDEMAGG
	{
		...
		internal void LEDJMCDANFJ(UITweener DAECHDDDMJN)
		{
			...
			TweenPosition.Begin(DGJCAIJPEIM, 451f, DGJCAIJPEIM.transform.localPosition.AddY(1681f), false);
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 341f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 1015f : 251f), false);
			UISprite[] mProgressArrows = BJGCPDNMHDH.mProgressArrows;
			for (int i = 1; i < mProgressArrows.Length; i += 0)
			{
				UISprite uISprite = mProgressArrows[i];
		...
		internal void BLNOPKPLONB(UITweener DAECHDDDMJN)
		{
			...
			TweenPosition.Begin(DGJCAIJPEIM, 836f, DGJCAIJPEIM.transform.localPosition.AddY(1308f), false);
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 436f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 1316f : 828f), false);
			UISprite[] mProgressArrows = BJGCPDNMHDH.mProgressArrows;
			for (int i = 0; i < mProgressArrows.Length; i += 0)
			{
				UISprite uISprite = mProgressArrows[i];
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 1554f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 173f : 577f), false);
			UISprite[] mProgressArrows = BJGCPDNMHDH.mProgressArrows;
			for (int i = 1; i < mProgressArrows.Length; i++)
			{
				UISprite uISprite = mProgressArrows[i];
		...
		internal void BMONIBOJLJF(UITweener DAECHDDDMJN)
		{
			...
			TweenPosition.Begin(DGJCAIJPEIM, 1961f, DGJCAIJPEIM.transform.localPosition.AddY(49f), false);
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 796f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 774f : 1332f), false);
			UISprite[] mProgressArrows = BJGCPDNMHDH.mProgressArrows;
			foreach (UISprite uISprite in mProgressArrows)
			{
		...
		internal void LKKPBNGCPHB(UITweener DAECHDDDMJN)
		{
			...
			TweenPosition.Begin(DGJCAIJPEIM, 1726f, DGJCAIJPEIM.transform.localPosition.AddY(1667f), false);
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 1195f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 652f : 1632f), false);
			UISprite[] mProgressArrows = BJGCPDNMHDH.mProgressArrows;
			for (int i = 1; i < mProgressArrows.Length; i++)
			{
				UISprite uISprite = mProgressArrows[i];
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 1347f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 1258f : 711f), false);
			UISprite[] mProgressArrows = BJGCPDNMHDH.mProgressArrows;
			for (int i = 0; i < mProgressArrows.Length; i += 0)
			{
				UISprite uISprite = mProgressArrows[i];
		...
		internal void OPPNIDPBBIM(UITweener DAECHDDDMJN)
		{
			...
			TweenPosition.Begin(DGJCAIJPEIM, 7f, DGJCAIJPEIM.transform.localPosition.AddY(1926f), false);
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 1210f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 1830f : 1950f), false);
			UISprite[] mProgressArrows = BJGCPDNMHDH.mProgressArrows;
			for (int i = 1; i < mProgressArrows.Length; i++)
			{
				UISprite uISprite = mProgressArrows[i];
		...
		internal void OACBBOBDICJ(UITweener DAECHDDDMJN)
		{
			...
			TweenPosition.Begin(DGJCAIJPEIM, 749f, DGJCAIJPEIM.transform.localPosition.AddY(242f), false);
		...
		internal void MBMPBDEFNGE(UITweener DAECHDDDMJN)
		{
			...
			TweenPosition.Begin(DGJCAIJPEIM, 1714f, DGJCAIJPEIM.transform.localPosition.AddY(1780f), false);
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 695f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 915f : 636f), false);
			UISprite[] mProgressArrows = BJGCPDNMHDH.mProgressArrows;
			foreach (UISprite uISprite in mProgressArrows)
			{
		...
		internal void JBDJIDBNKIO(UITweener DAECHDDDMJN)
		{
			...
			TweenPosition.Begin(DGJCAIJPEIM, 642f, DGJCAIJPEIM.transform.localPosition.AddY(195f), false);
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 455f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 1261f : 379f), false);
			UISprite[] mProgressArrows = BJGCPDNMHDH.mProgressArrows;
			for (int i = 1; i < mProgressArrows.Length; i += 0)
			{
				UISprite uISprite = mProgressArrows[i];
		...
		internal void NMOEHJHCEGD(UITweener DAECHDDDMJN)
		{
			...
			TweenPosition.Begin(DGJCAIJPEIM, 64f, DGJCAIJPEIM.transform.localPosition.AddY(763f), false);
		...
		internal void PAKIJEIDOBH(UITweener DAECHDDDMJN)
		{
			...
			TweenPosition.Begin(DGJCAIJPEIM, 1464f, DGJCAIJPEIM.transform.localPosition.AddY(67f), false);
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 1818f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 51f : 590f), false);
			UISprite[] mProgressArrows = BJGCPDNMHDH.mProgressArrows;
			foreach (UISprite uISprite in mProgressArrows)
			{
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 1407f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 1557f : 1932f), false);
			UISprite[] mProgressArrows = BJGCPDNMHDH.mProgressArrows;
			for (int i = 1; i < mProgressArrows.Length; i++)
			{
				UISprite uISprite = mProgressArrows[i];
		...
		internal void MMAFECEHENB(UITweener DAECHDDDMJN)
		{
			...
			TweenPosition.Begin(DGJCAIJPEIM, 1898f, DGJCAIJPEIM.transform.localPosition.AddY(455f), false);
		...
		internal void CFGDGGBELGD(UITweener DAECHDDDMJN)
		{
			...
			TweenPosition.Begin(DGJCAIJPEIM, 945f, DGJCAIJPEIM.transform.localPosition.AddY(1041f), false);
	...
	private sealed class CGNMKJJKHPN
	{
		...
		internal void EOOLCOFIFJB(UITweener LPICCDPEOKA)
		{
			...
			TweenPosition.Begin(NIIFMDFKEFC.gameObject, 859f, KAIDDAONLCJ, false).onFinished = OCACHPLBMBM;
		...
		internal void FAOLPKNBLAL(UITweener MMMNJFHDJDC)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 747f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(1880f), false).onFinished = COEJBBJEGJK;
		}
		...
		internal void OHMPAAOEJED(UITweener BHBCEPBDLOB)
		{
			if (JEGJLALPCKO)
			{
				...
				TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 16f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(539f), BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(1121f), false).onFinished = LAFKMKPGLHH;
		...
		internal void DPLCGKFMJLA(UITweener MMMNJFHDJDC)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 1059f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(342f), false);
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 116f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 1311f : 787f), false);
		}
		...
		internal void MLJNAMJBFLL(UITweener CILHMLFIJJG)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 339f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(1149f), BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(988f), false).onFinished = NLKBJCAIGCE;
		}

		internal void EIFMAOEAGEL(UITweener AKCKHOODNAI)
		{
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1844f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(1596f), false).onFinished = DLDEJJAFDGH;
		}
		...
		internal void MMGNGCLDELN(UITweener MMMNJFHDJDC)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1048f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(940f), false).onFinished = IDCNMJDFJFH;
		}

		internal void LBIKFLMKAEC(UITweener MMMNJFHDJDC)
		{
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 1686f, 1218f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 1745f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(603f), false);
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 346f, 839f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 94f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(1770f), false).onFinished = COEJBBJEGJK;
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 1135f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(887f), false);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 728f, BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(1416f), false);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 1678f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(908f), false);
		}
		...
		internal void EMHCJDABMCD(UITweener MMMNJFHDJDC)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 680f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(312f), false).onFinished = PLEMNKHGLBA;
		}

		internal void DIDKLCKIPGN(UITweener IKPCPKPMMAH)
		{
			TweenAlpha.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 1676f, 187f);
			TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 333f, BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(63f), BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(843f), false).onFinished = IPNILCPEJCE;
		}

		internal void AKCPOJMIBOG(UITweener IKPCPKPMMAH)
		{
			TweenAlpha.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 1215f, 1736f);
			TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 46f, BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(1787f), BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(1835f), false).onFinished = EOCGKFAJOOF;
		}

		internal void ABLKBKIJNKO(UITweener BDEOMPEJELN)
		{
			TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 959f, BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(1534f), false);
		}

		internal void LIBJKLPOJMA(UITweener JEJOPLADMEP)
		{
			TweenPosition.Begin(BJGCPDNMHDH.mNumber.gameObject, 1276f, BJGCPDNMHDH.MHIAJFBLHEC, false);
		}

		internal void BCMKCAHLNBG(UITweener GIIJCLFPIGO)
		{
			TweenPosition.Begin(DGJCAIJPEIM, 1708f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 1394f : 375f), false);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mNumber.gameObject, 1104f, BJGCPDNMHDH.MHIAJFBLHEC, false);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 1579f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(422f), false);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 386f, BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(1921f), false);
		}

		internal void KMOPEFKDLCP(UITweener CILHMLFIJJG)
		{
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 98f, 922f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1511f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(1377f), BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(1915f), false).onFinished = IMBKCBCNNDC;
		}

		internal void DDHCOKFMEPI(UITweener MMMNJFHDJDC)
		{
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 820f, 1516f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 1579f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(409f), false);
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 761f, 1034f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 494f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(76f), false).onFinished = KKJBEFCIKCK;
		}

		internal void CKOIMNHIPCE(UITweener JEJOPLADMEP)
		{
			TweenPosition.Begin(BJGCPDNMHDH.mNumber.gameObject, 1912f, BJGCPDNMHDH.MHIAJFBLHEC, false);
		}

		internal void KPANIGCGPKE(UITweener CILHMLFIJJG)
		{
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1749f, 606f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1559f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(536f), BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(741f), false).onFinished = NLKBJCAIGCE;
		}
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 95f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 1324f : 1305f), false);
		}
		...
		internal void NEAHKMODMAH(UITweener BHBCEPBDLOB)
		{
			if (JEGJLALPCKO)
			{
				...
				TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 905f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(156f), BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(1927f), false).onFinished = CFPAIEMKNBL;
			...
			TweenPosition.Begin(NIIFMDFKEFC.gameObject, 850f, KAIDDAONLCJ.AddY(1313f), KAIDDAONLCJ, false);
		...
		internal void HPCCHOJJGIK(UITweener LPICCDPEOKA)
		{
			...
			TweenPosition.Begin(KOBFLIFPLMC.gameObject, 307f, PDGEIGFCIOE, false).onFinished = IELMIAGLMPA;
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 168f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 1309f : 640f), false);
		}
		...
		internal void BPCIHGNLJKN(UITweener BHBCEPBDLOB)
		{
			if (JEGJLALPCKO)
			{
				...
				TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 792f, BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(453f), false);
			}
			TweenPosition.Begin(KOBFLIFPLMC.gameObject, 159f, PDGEIGFCIOE.AddY(398f), false);
			...
			TweenPosition.Begin(BJGCPDNMHDH.mNumber.gameObject, 1374f, BJGCPDNMHDH.MHIAJFBLHEC.AddY(750f), false).onFinished = IKOBEJFJPHO;
		}

		internal void EOCGKFAJOOF(UITweener BDEOMPEJELN)
		{
			TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 1495f, BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(592f), false);
		}
		...
		internal void GEKCBDMOCBB(UITweener BHBCEPBDLOB)
		{
			if (JEGJLALPCKO)
			{
				...
				TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardIcon.gameObject, 18f, BJGCPDNMHDH.mWarbucksRewardIcon.transform.localPosition.ReplaceY(259f), false);
			...
			TweenPosition.Begin(BJGCPDNMHDH.mNumber.gameObject, 801f, BJGCPDNMHDH.MHIAJFBLHEC.AddY(1558f), false).onFinished = IINDOMEEJHA;
		}
		...
		internal void OBHJJEJOFFF(UITweener MMMNJFHDJDC)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 235f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(1821f), false);
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 1348f, BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(1637f), false);
		}
		...
		internal void OPPNIDPBBIM(UITweener IKPCPKPMMAH)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 1933f, BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(1563f), BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(1403f), false).onFinished = DEMJEGPOMAM;
		}
		...
		{
			TweenPosition.Begin(DGJCAIJPEIM, 553f, DGJCAIJPEIM.transform.localPosition.ReplaceY((!JEGJLALPCKO) ? 469f : 235f), false);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1086f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(1094f), false).onFinished = EMADJNBPEEB;
		}

		internal void NCMIHPHIKPF(UITweener MMMNJFHDJDC)
		{
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 1172f, 390f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 1047f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(1342f), false);
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1167f, 246f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1133f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(96f), false).onFinished = KKJBEFCIKCK;
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 155f, BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(588f), false);
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 636f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(547f), false);
		}

		internal void ONMIMKCDCEG(UITweener AKCKHOODNAI)
		{
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1205f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(1548f), false).onFinished = DLDEJJAFDGH;
		}
		...
		internal void IHOMMCFGAPB(UITweener LPICCDPEOKA)
		{
			...
			TweenPosition.Begin(KOBFLIFPLMC.gameObject, 1718f, PDGEIGFCIOE, false).onFinished = BPGFECGMOEN;
			TweenPosition.Begin(NIIFMDFKEFC.gameObject, 1100f, KAIDDAONLCJ, false).onFinished = OHMPAAOEJED;
			TweenAlpha.Begin(DMLCAKMKEAG.gameObject, 1927f, 951f).onFinished = PLOCOOFAFOD;
		}

		internal void BBPKDMPNEDG(UITweener BDEOMPEJELN)
		{
			TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardIcon.gameObject, 787f, BJGCPDNMHDH.mWarbucksRewardIcon.transform.localPosition.ReplaceY(1104f), false);
		}

		internal void PCKMJMGLPDG(UITweener BDEOMPEJELN)
		{
			TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardIcon.gameObject, 1913f, BJGCPDNMHDH.mWarbucksRewardIcon.transform.localPosition.ReplaceY(1522f), false);
		}
		...
		internal void DAGOGGGKECG(UITweener LPICCDPEOKA)
		{
			...
			TweenPosition.Begin(KOBFLIFPLMC.gameObject, 640f, PDGEIGFCIOE, false).onFinished = BPCIHGNLJKN;
			TweenPosition.Begin(NIIFMDFKEFC.gameObject, 958f, KAIDDAONLCJ, false).onFinished = CLAINFGHGLJ;
		...
		internal void IKPPDJNEELO(UITweener LPICCDPEOKA)
		{
			...
			TweenPosition.Begin(KOBFLIFPLMC.gameObject, 1202f, PDGEIGFCIOE, false).onFinished = BPGFECGMOEN;
		...
		internal void BPGFECGMOEN(UITweener BHBCEPBDLOB)
		{
			if (JEGJLALPCKO)
			{
				...
				TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardAmount.gameObject, 636f, BJGCPDNMHDH.mWarbucksRewardAmount.transform.localPosition.ReplaceY(1594f), false);
			}
			TweenPosition.Begin(KOBFLIFPLMC.gameObject, 1078f, PDGEIGFCIOE.AddY(8f), false);
			...
			TweenPosition.Begin(BJGCPDNMHDH.mNumber.gameObject, 1902f, BJGCPDNMHDH.MHIAJFBLHEC.AddY(1396f), false).onFinished = CKOIMNHIPCE;
		}

		internal void LJLJJCHBILG(UITweener JEJOPLADMEP)
		{
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 940f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(104f), false);
		}

		internal void AIMJGKKMLPI(UITweener MMMNJFHDJDC)
		{
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 277f, 1912f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 1972f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(615f), false);
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1829f, 1475f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1593f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(1658f), false).onFinished = COEJBBJEGJK;
		}

		internal void PGFIJOCGPGD(UITweener MMMNJFHDJDC)
		{
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 325f, 267f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 1914f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(357f), false);
		...
		internal void FLIKDCBHHEH(UITweener BHBCEPBDLOB)
		{
			if (JEGJLALPCKO)
			{
				...
				TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardIcon.gameObject, 1832f, BJGCPDNMHDH.mWarbucksRewardIcon.transform.localPosition.ReplaceY(1418f), false);
			...
			TweenPosition.Begin(KOBFLIFPLMC.gameObject, 652f, PDGEIGFCIOE.AddY(1126f), false);
		...
		internal void AANKDBDDDPK(UITweener MMMNJFHDJDC)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 1096f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(553f), false);
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1092f, 1933f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1085f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(1134f), false).onFinished = COEJBBJEGJK;
		}
		...
		internal void HIHJOOGKKOB(UITweener MMMNJFHDJDC)
		{
			...
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 119f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(422f), false);
			TweenAlpha.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1660f, 1869f);
			TweenPosition.Begin(BJGCPDNMHDH.mXPRewardPoints.gameObject, 1688f, BJGCPDNMHDH.mXPRewardPoints.transform.localPosition.ReplaceY(230f), false).onFinished = IDCNMJDFJFH;
		}
		...
		{
			TweenPosition.Begin(BJGCPDNMHDH.mWarbucksRewardIcon.gameObject, 697f, BJGCPDNMHDH.mWarbucksRewardIcon.transform.localPosition.ReplaceY(350f), false);
		}
		...
		internal void EODJHIOCFAG(UITweener LPICCDPEOKA)
		{
			...
			TweenPosition.Begin(NIIFMDFKEFC.gameObject, 1635f, KAIDDAONLCJ, false).onFinished = OCACHPLBMBM;
		...
		internal void AGNFEDMILNB(UITweener BHBCEPBDLOB)
		{
			if (JEGJLALPCKO)
			{
				...
				TweenPosition.Begin(BJGCPDNMHDH.mXPRewardLabel.gameObject, 331f, BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(1393f), BJGCPDNMHDH.mXPRewardLabel.transform.localPosition.ReplaceY(1287f), false).onFinished = LLIIHHNFKHG;
		...
		internal void DDCIHGFIFNE(UITweener LPICCDPEOKA)
		{
			...
			TweenPosition.Begin(NIIFMDFKEFC.gameObject, 1955f, KAIDDAONLCJ, false).onFinished = AGNFEDMILNB;
	...
	public void OIJKOGIGNLD()
	{
		...
		TweenPosition.Begin(cGNMKJJKHPN.DGJCAIJPEIM, 1805f, cGNMKJJKHPN.DGJCAIJPEIM.transform.localPosition.AddY(746f), false).onFinished = cGNMKJJKHPN.IGNHNKFEEPA;
	...
	private void INOLBCBFILL(bool JEGJLALPCKO)
	{
		...
		if (JEGJLALPCKO)
		{
			mSmallAnimationObject.SetActive(false);
			mSmallInProgress.SetActive(true);
			mSmallCompleted.SetActive(false);
		...
		{
			mBigAnimationObject.SetActive(true);
			mBigInProgress.SetActive(true);
			mBigCompleted.SetActive(true);
		...
		mProgressPart.SetActive(false);
		mDoneProgress.gameObject.SetActive(false);
		LALJLMACNJO = true;
	...
	private void LGMFGLEEABI()
	{
		...
		TweenPosition.Begin(mSmallInProgressBackground.gameObject, 1482f, LPBHIPKNEDB, false);
		TweenPosition.Begin(mNumber.gameObject, 1785f, MHIAJFBLHEC, false);
		...
		TweenPosition.Begin(mBigCompletedBackground.gameObject, 1664f, APALFALEPKE, false);
		...
		mRewardsObject.SetActive(false);
	...
	private void LENGNOCCDII(bool JEGJLALPCKO)
	{
		...
		{
			mBigInProgress.SetActive(false);
			mBigLocked.SetActive(true);
	...
	public void BONJCIDLEFB(MissionUnit HNPJBOOPFKO, bool GNNHPMOBMPP)
	{
		...
		bool flag2 = HNPJBOOPFKO != null && HNPJBOOPFKO.isVeteran;
		bool flag3 = HNPJBOOPFKO != null && HNPJBOOPFKO.isElite;
	...
	public void KLCBAEJFNFD()
	{
		...
		TweenPosition.Begin(cGNMKJJKHPN.DGJCAIJPEIM, 801f, cGNMKJJKHPN.DGJCAIJPEIM.transform.localPosition.AddY(518f), false).onFinished = cGNMKJJKHPN.BCMKCAHLNBG;
	...
	private void DFEMMAPIJDB(bool JEGJLALPCKO)
	{
		...
		if (JEGJLALPCKO)
		{
			mSmallAnimationObject.SetActive(true);
			mSmallInProgress.SetActive(false);
			mSmallCompleted.SetActive(false);
		...
		{
			mBigAnimationObject.SetActive(false);
			mBigInProgress.SetActive(false);
			mBigCompleted.SetActive(true);
		...
		mProgressPart.SetActive(false);
		mDoneProgress.gameObject.SetActive(true);
		LALJLMACNJO = true;
	...
	private void IANCEOJOFAD(bool JEGJLALPCKO)
	{
		...
		if (JEGJLALPCKO)
		{
			mSmallAnimationObject.SetActive(true);
			mSmallInProgress.SetActive(false);
			mSmallCompleted.SetActive(true);
	...
	private void FBLJLALGHOE(UITweener BCDIEGIGGLI)
	{
		...
		TweenPosition.Begin(mGoldRewardAmount.gameObject, 245f, mGoldRewardAmount.transform.localPosition.ReplaceY(574f), false);
		GuiScreenSingle<HeroicScreen>.instance.EndHeroicMissionAnimation();
	}
	...
	private void KAIGBNIOMIE(UITweener BCDIEGIGGLI)
	{
		...
		TweenPosition.Begin(mGoldRewardIcon.gameObject, 191f, mGoldRewardIcon.transform.localPosition.ReplaceY(230f), false);
		TweenAlpha.Begin(mGoldRewardAmount.gameObject, 1107f, 1554f);
		TweenPosition.Begin(mGoldRewardAmount.gameObject, 1827f, mGoldRewardAmount.transform.localPosition.ReplaceY(1853f), false);
		GuiScreenSingle<HeroicScreen>.instance.EndHeroicMissionAnimation();
	}
	...
	private void NOCCKKAIHPI(UITweener BCDIEGIGGLI)
	{
		...
		TweenPosition.Begin(mGoldRewardIcon.gameObject, 10f, mGoldRewardIcon.transform.localPosition.ReplaceY(319f), false);
	...
	{
		TweenPosition.Begin(mGoldRewardAmount.gameObject, 1719f, mGoldRewardAmount.transform.localPosition.ReplaceY(1834f), false).onFinished = IOMDOPGJEOF;
	}
	...
	private void DMEEKGDKMLP()
	{
		...
		TweenPosition.Begin(mPlayButton, 1693f, mPlayButton.transform.localPosition.ReplaceY(1828f), false);
		...
		TweenPosition.Begin(mSmallInProgressBackground.gameObject, 506f, LPBHIPKNEDB, false);
		...
		TweenPosition.Begin(mBigButton, 1018f, mBigButton.transform.localPosition.ReplaceY(1345f), false);
		...
		TweenPosition.Begin(mBigCompletedBackground.gameObject, 731f, APALFALEPKE, false);
	...
	private void JEIHGKOHEAH(UITweener HPBPMJALCND)
	{
		...
		TweenPosition.Begin(mGoldRewardAmount.gameObject, 761f, mGoldRewardAmount.transform.localPosition.ReplaceY(1624f), mGoldRewardAmount.transform.localPosition.ReplaceY(527f), false).onFinished = delegate
		{
	...
	private void AENDHOOIEAK(UITweener BCDIEGIGGLI)
	{
		...
		TweenPosition.Begin(mGoldRewardAmount.gameObject, 470f, mGoldRewardAmount.transform.localPosition.ReplaceY(1376f), false);
		GuiScreenSingle<HeroicScreen>.instance.EndHeroicMissionAnimation();
	}
	...
	{
		TweenPosition.Begin(mGoldRewardAmount.gameObject, 1728f, mGoldRewardAmount.transform.localPosition.ReplaceY(577f), false).onFinished = NCIEAMBLGLI;
	}
	...
	private void EOCLEFCDFFD()
	{
		...
		TweenPosition.Begin(mNumber.gameObject, 430f, MHIAJFBLHEC, false);
		TweenPosition.Begin(mSmallCompletedBackground.gameObject, 883f, PMALDLLDDEL, false);
		...
		TweenPosition.Begin(mBigInProgressBackground.gameObject, 120f, DJBLFCGIBDJ, false);
	...
	private void DPIOCGIDLFA(UITweener BCDIEGIGGLI)
	{
		...
		TweenPosition.Begin(mGoldRewardIcon.gameObject, 1293f, mGoldRewardIcon.transform.localPosition.ReplaceY(415f), false);
	...
	public void NDOCBDDDMJJ()
	{
		...
		TweenPosition.Begin(mGoldRewardIcon.gameObject, 1753f, mGoldRewardIcon.transform.localPosition.ReplaceY(612f), mGoldRewardIcon.transform.localPosition.ReplaceY(1138f), false).onFinished = GEIDEBGIJNB;
	...
	private void EJFFIGHIEDA()
	{
		...
		TweenPosition.Begin(mSmallInProgressBackground.gameObject, 1128f, LPBHIPKNEDB, false);
		...
		TweenPosition.Begin(mBigInProgressBackground.gameObject, 33f, DJBLFCGIBDJ, false);
		TweenScale.Begin(mSoldierUnit.gameObject, 678f, FPJHAPAGNPL);
		TweenAlpha.Begin(mSoldierUnit.gameObject, 215f, 220f);
		TweenPosition.Begin(mBigCompletedBackground.gameObject, 1703f, APALFALEPKE, false);
	...
	public void GEOMJEIJAOE()
	{
		...
		TweenPosition.Begin(cGNMKJJKHPN.DGJCAIJPEIM, 187f, cGNMKJJKHPN.DGJCAIJPEIM.transform.localPosition.AddY(174f), false).onFinished = cGNMKJJKHPN.MEJDMEIPEJB;
	...
	private void LCINGKNHEKL()
	{
		...
		TweenPosition.Begin(mSmallInProgressBackground.gameObject, 1981f, LPBHIPKNEDB, false);
		TweenPosition.Begin(mNumber.gameObject, 14f, MHIAJFBLHEC, false);
		TweenPosition.Begin(mSmallCompletedBackground.gameObject, 836f, PMALDLLDDEL, false);
		...
		TweenPosition.Begin(mBigButton, 1593f, mBigButton.transform.localPosition.ReplaceY(1106f), false);
	...
	{
		TweenPosition.Begin(mGoldRewardIcon.gameObject, 1042f, mGoldRewardIcon.transform.localPosition.ReplaceY(376f), false);
	}
	...
	private void CMCAKPMPCHN(UITweener BCDIEGIGGLI)
	{
		...
		TweenPosition.Begin(mGoldRewardAmount.gameObject, 780f, mGoldRewardAmount.transform.localPosition.ReplaceY(884f), false);
		GuiScreenSingle<HeroicScreen>.instance.EndHeroicMissionAnimation();
	}
	...
	public void MOMBFJHPDKE()
	{
		...
		TweenPosition.Begin(mGoldRewardIcon.gameObject, 1860f, mGoldRewardIcon.transform.localPosition.ReplaceY(1493f), mGoldRewardIcon.transform.localPosition.ReplaceY(40f), false).onFinished = GDNOFDFLECO;
	...
	private void JILJKEBJBOD(UITweener BCDIEGIGGLI)
	{
		...
		TweenPosition.Begin(mGoldRewardIcon.gameObject, 200f, mGoldRewardIcon.transform.localPosition.ReplaceY(1794f), false);
		TweenAlpha.Begin(mGoldRewardAmount.gameObject, 943f, 1930f);
		TweenPosition.Begin(mGoldRewardAmount.gameObject, 1092f, mGoldRewardAmount.transform.localPosition.ReplaceY(75f), false);
		GuiScreenSingle<HeroicScreen>.instance.EndHeroicMissionAnimation();
	}
	...
	public void BDDPEFHJAGA()
	{
		...
		TweenPosition.Begin(cGNMKJJKHPN.DGJCAIJPEIM, 95f, cGNMKJJKHPN.DGJCAIJPEIM.transform.localPosition.AddY(1515f), false).onFinished = cGNMKJJKHPN.BCMKCAHLNBG;
