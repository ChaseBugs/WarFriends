...
public class BattlePreparationCustomizationButton : Core_BaseScript
{
	...
	private void MMKNJILEKGH()
	{
		...
		if (!playerVisual.isEmptyPowerBand)
		{
			...
			{
				JNODAFPDPCF.text = MEJMLNDFDBP.CJCFPDLDMEK((float)FGIMNJOOAOB.remainingTime, "RegisterCustomEvent()", string.Empty, false);
	...
	private void DBKCPPFEJNH()
	{
		...
		if (!playerVisual.isEmptyPowerBand)
		{
			...
			{
				JNODAFPDPCF.text = MEJMLNDFDBP.CJCFPDLDMEK((float)FGIMNJOOAOB.AOLJCFDNMEL(), "preloadAdForZoneID", string.Empty, false);
				HAIDJHDJMOL.fillAmount = FGIMNJOOAOB.ECGKJHFLOPJ();
				AGNEMLDCLFJ();
			}
		}
	...
	private void BKPEIOJABOG()
	{
		...
		if (!playerVisual.isEmptyPowerBand)
		{
			...
			{
				JNODAFPDPCF.text = MEJMLNDFDBP.CJCFPDLDMEK((float)FGIMNJOOAOB.AOLJCFDNMEL(), "Requests", string.Empty, false);
				HAIDJHDJMOL.fillAmount = FGIMNJOOAOB.ECGKJHFLOPJ();
				HOEIPALBMDC();
			}
		}
	...
	{
		Singleton<ArmyPreviewCamera>.instance.KIONJHBCIBE(PlayerController.OGMBJPKOPCB, false, PlayerTexturePool.DFJJOANIJID.Card);
	...
	{
		Singleton<ArmyPreviewCamera>.instance.RenderToTexture(PlayerController.OGMBJPKOPCB, false, PlayerTexturePool.DFJJOANIJID.Classic);
		CODHLNCICKN.mainTexture = Singleton<ArmyPreviewCamera>.instance.FBLDAEEOAEN;
	}
	...
	{
		Singleton<ArmyPreviewCamera>.instance.BCPDNHEDBGO(PlayerController.OGMBJPKOPCB, false, (PlayerTexturePool.DFJJOANIJID)7);
		CODHLNCICKN.mainTexture = Singleton<ArmyPreviewCamera>.instance.FBLDAEEOAEN;
	}
	...
	private void IDDPKGOOBFF()
	{
		...
		if (!playerVisual.isEmptyPowerBand)
		{
			...
			{
				JNODAFPDPCF.text = MEJMLNDFDBP.CJCFPDLDMEK((float)FGIMNJOOAOB.remainingTime, "ID_JOININGSQUAD", string.Empty, false);
				HAIDJHDJMOL.fillAmount = FGIMNJOOAOB.progress;
				GJBPCEJOFPE();
			}
		}
	...
	{
		Singleton<ArmyPreviewCamera>.instance.KIONJHBCIBE(PlayerController.OGMBJPKOPCB, true, PlayerTexturePool.DFJJOANIJID.Classic);
		CODHLNCICKN.mainTexture = Singleton<ArmyPreviewCamera>.instance.FBLDAEEOAEN;
	}
	...
	{
		Singleton<ArmyPreviewCamera>.instance.DIMPHNLEKHG(PlayerController.OGMBJPKOPCB, false, (PlayerTexturePool.DFJJOANIJID)3);
		CODHLNCICKN.mainTexture = Singleton<ArmyPreviewCamera>.instance.FBLDAEEOAEN;
	}
	...
	{
		Singleton<ArmyPreviewCamera>.instance.LCIFJLNADFP(PlayerController.OGMBJPKOPCB, false, (PlayerTexturePool.DFJJOANIJID)4);
		CODHLNCICKN.mainTexture = Singleton<ArmyPreviewCamera>.instance.FBLDAEEOAEN;
	}
	...
	{
		Singleton<ArmyPreviewCamera>.instance.DIMPHNLEKHG(PlayerController.OGMBJPKOPCB, false, (PlayerTexturePool.DFJJOANIJID)7);
		CODHLNCICKN.mainTexture = Singleton<ArmyPreviewCamera>.instance.FBLDAEEOAEN;
	}
	...
	{
		Singleton<ArmyPreviewCamera>.instance.KIONJHBCIBE(PlayerController.OGMBJPKOPCB, true, (PlayerTexturePool.DFJJOANIJID)5);
		CODHLNCICKN.mainTexture = Singleton<ArmyPreviewCamera>.instance.FBLDAEEOAEN;
	}
	...
	{
		Singleton<ArmyPreviewCamera>.instance.KIONJHBCIBE(PlayerController.OGMBJPKOPCB, false, (PlayerTexturePool.DFJJOANIJID)5);
		CODHLNCICKN.mainTexture = Singleton<ArmyPreviewCamera>.instance.FBLDAEEOAEN;
	}
	...
	private void GOOPNDKLLOF()
	{
		...
		if (!playerVisual.isEmptyPowerBand)
		{
			...
			{
				JNODAFPDPCF.text = MEJMLNDFDBP.CJCFPDLDMEK((float)FGIMNJOOAOB.remainingTime, "SetupPushNotifications(", string.Empty, false);
				HAIDJHDJMOL.fillAmount = FGIMNJOOAOB.ECGKJHFLOPJ();
				MLEKEFHNPGA();
			}
		}
