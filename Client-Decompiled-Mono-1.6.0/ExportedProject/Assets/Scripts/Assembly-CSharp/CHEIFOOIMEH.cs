...
public class CHEIFOOIMEH
{
	...
	public Dictionary<string, UnitUpgradeDefinition> HDDPODGBNIC { get; private set; }

	public bool KMKHCNMIBFD { get; private set; }

	public int BCCDDJMPBLL { get; set; }

	public int AMFJHAPGIJN { get; set; }

	public PlayerInventory.JIMOKIIJHNA[] GGKGGMNIDMI { get; set; }

	public int IMOJCFKJKMN
	{
		get
		{
			return 10 * AMFJHAPGIJN;
		}
	}

	public bool DBIEDLPHCAI
	{
		get
		{
	...
	public PlayerVisualCategoryCamos.PlayerVisualCamo NHOJPACPJEO { get; set; }

	public PlayerVisualCategoryHelmets.PlayerVisualHelmet POHFJHBABAF { get; set; }

	public PlayerVisualCategoryHeadAccesories.PlayerVisualHeadAccesory IPJIPGILEHF { get; set; }

	public PlayerVisualCategoryPowerBands.PlayerVisualPowerBand EOHJMNFLAIK { get; set; }

	public bool KAOFEOJMDJH { get; set; }
	...
	public DatabasePlayerInfo FGDKPLIPFDA
	{
		get
		{
			return BJPFKEBIMCI;
	...
	public void NLIGDLHGDAK(bool BPOONJBFIHP)
	{
		...
		List<AANECPGDMGM> list = Singleton<ServerResultsCache>.instance.OOENALCOCBN(true);
	...
	public void NEFIMJICLLF(bool BPOONJBFIHP)
	{
		...
		List<AANECPGDMGM> list = Singleton<ServerResultsCache>.instance.MOCMGBJJAHB(true);
		if (list != null && list.Count > 1)
		{
			AANECPGDMGM aANECPGDMGM = null;
			do
