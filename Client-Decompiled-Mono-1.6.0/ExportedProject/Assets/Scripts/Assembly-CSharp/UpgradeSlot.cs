...
public class UpgradeSlot
{
	...
	public bool isTierFullUpgraded
	{
		get
		{
			return boughtIndex == maxRowForActualTier;
		}
	}
	...
	public int boughtIndexAbsolute
	{
		get
		{
			return boughtIndex + indexOffset;
		}
	}
	...
	public int upgradePrice
	{
		get
		{
			return (int)owner.excel.GetValue(boughtIndexAbsolute, "NextUpgradePrice");
		}
	}

	public virtual List<Tuple<string, float[]>> guiStatistics
	{
		get
		{
	...
	public virtual List<Tuple<string, float>> guiStatisticsStart
	{
		get
		{
	...
	public int minRowForActualTier
	{
		get
		{
			...
			{
				Debug.LogError(string.Format("Excel {0} dont have row Tier!!!", owner.excel.GetType()));
				return 0;
			}
	...
	public int maxIndexInExcel
	{
		get
		{
			return indexOffset + maxPower - 1;
		}
	}
	...
	public int deliveryTime
	{
		get
		{
			return (int)(float)owner.excel.GetValue(boughtIndexAbsolute, "DeliveryTime");
		}
	}
	...
	public int instantBuyPrice
	{
		get
		{
			...
			int num2 = Singleton<OfferManager>.instance.DiscountedUnityDeliveryCost(owner.owner.unitType, owner.owner, false);
			if (num2 > 0)
			{
	...
	public virtual int armyPowerX10
	{
		get
		{
			return LFNLPNEONEI(boughtIndexAbsolute);
		}
	}
