...
public class FFKMPLMLOEP : HHFHFANGCEJ
{
	...
	public FFKMPLMLOEP(LevelBehaviour IOIKKIIFOCB)
		: base(string.Format("UpgradeUnitReminder {0} {1}", IOIKKIIFOCB.unitName, Singleton<BeanstalkServerManager>.instance.currentTimestamp), NKHJBLBAAEB.UpgradeUnitReminder)
	{
