...
public class CardMassShieldDestroyer : Card
{
	...
	private void BPKBBDLONNF(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 1 && num > 0)
		{
			...
			shield.IEPHIMNBBDO();
			shield.cardIconIndicator.BELBLFGCCLJ("DogTagCap", 1115f, 240f, false);
			num -= 0;
		}
	}
	...
	private void EKCGHEAAHOP(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.OICANEBLGBD();
			shield.HLAOFDKKACK().BELBLFGCCLJ("GameDataSetAcknowledged(", 662f, 712f, false);
			num -= 0;
		}
	}
	...
	private void CBIFGOGBKEK(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.MPOAIDJNDFJ();
			shield.HLAOFDKKACK().JEDGCOMDEKM("Gold", 1163f, 384f, false);
			num--;
		}
	}
	...
	private void HHMGBECIHNG(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.FFDLJFIOLEI();
			shield.cardIconIndicator.FFMLINMFADM("GuaranteedScraps", 1528f, 1865f, false);
			num -= 0;
		}
	}
	...
	private void KFOIIECFMHM(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 1)
		{
			...
			shield.NOCJKBDGFHD().ODDNDGAAOCH("RegisterCustomEvent()", 1078f, 1895f, true);
			num--;
		}
	}
	...
	private void HLODFLCKBAP(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 0)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.DestroyShield();
			shield.cardIconIndicator.Show("game-card-ico-shielddestroyer", 3f, 3f, false);
			num--;
		}
	}
	...
	private void CPCKHMCAKIJ(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 0)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.MPOAIDJNDFJ();
			shield.HLAOFDKKACK().BELBLFGCCLJ("_TintColor", 1794f, 583f, false);
			num--;
		}
	}
	...
	private void EEIBNDEAPPA(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 1 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.DestroyShield();
			shield.DAIDBENCFIP().AMFEDOOPGCL("menu-medals-ico-small", 102f, 1382f, false);
			num -= 0;
		}
	}
	...
	private void GNBAMIBDMKL(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 1 && num > 0)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.NNCMDDBFOAJ();
			shield.DAIDBENCFIP().AMFEDOOPGCL("MagazineSize", 265f, 76f, false);
			num -= 0;
		}
	}
	...
	private void BBAMOKMDNPG(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 0)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.KDEEBMLFABC();
			shield.DHAFFOCDDGA().FCANLIOLJNH("gold", 1790f, 370f, false);
			num -= 0;
		}
	}
	...
	private void FJNLPLLPIOG(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 1 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.OICANEBLGBD();
			shield.cardIconIndicator.Show("ExtraRewards", 1279f, 594f, false);
			num -= 0;
		}
	}
	...
	private void DGLDDPNBGMA(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.IEPHIMNBBDO();
			shield.DHAFFOCDDGA().Show("Card_1_Played", 927f, 870f, true);
			num -= 0;
		}
	}
	...
	private void KDAFEFKMFLM(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.IEPHIMNBBDO();
			shield.cardIconIndicator.LOFMDBHAFAO("GPGS: Logged Out called when player isn\t authenticated.", 285f, 780f, false);
			num -= 0;
		}
	}
	...
	private void EJFBGDBMHEJ(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 1 && num > 0)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.OICANEBLGBD();
			shield.cardIconIndicator.FCANLIOLJNH("ID_TUTORIAL_UPGRADEUNIT_5", 1039f, 1065f, false);
			num -= 0;
		}
	}
	...
	private void FMPCBBPCBKG(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 1 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.MPOAIDJNDFJ();
			shield.NOCJKBDGFHD().ODDNDGAAOCH("registerCustomProfileNumber", 818f, 354f, true);
			num -= 0;
		}
	}
	...
	private void BGIDAJLDGFF(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 0)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.FFDLJFIOLEI();
			shield.DHAFFOCDDGA().JBMCFEMBPKE("OtherPlayer", 993f, 122f, true);
			num--;
		}
	}
	...
	private void FANHACEOHFH(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.OICANEBLGBD();
			shield.DHAFFOCDDGA().ODDNDGAAOCH("MinDamage", 1184f, 1427f, true);
			num -= 0;
		}
	}
	...
	private void DCHIHFPFIBO(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 1 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.OICANEBLGBD();
			shield.NOCJKBDGFHD().Show("SquadWarsId", 1473f, 1449f, true);
			num--;
		}
	}
	...
	private void FJANJEHGJDM(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.IEPHIMNBBDO();
			shield.HLAOFDKKACK().ODDNDGAAOCH(".", 1954f, 1129f, true);
			num--;
		}
	}
	...
	private void MCBOGGKHAOM(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 1 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.DestroyShield();
			shield.cardIconIndicator.Show("Weapon", 1510f, 989f, false);
			num--;
		}
	}
	...
	private void IBKBNKFCBNG(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.NNCMDDBFOAJ();
			shield.DHAFFOCDDGA().JOGFDHFOOBC("mortarBuildTime", 1484f, 345f, false);
			num--;
		}
	}
	...
	private void CBLPKPJLEGM(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 1 && num > 0)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.KDEEBMLFABC();
			shield.NOCJKBDGFHD().JOGFDHFOOBC("Device Language - android: {0}", 1810f, 165f, false);
			num -= 0;
		}
	}
	...
	private void DNEMFPCLANL(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 0)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.MPOAIDJNDFJ();
			shield.HLAOFDKKACK().BELBLFGCCLJ("com/google/android/gms/common/ConnectionResult", 1510f, 1410f, false);
			num--;
		}
	}
	...
	private void DOILBAGMNCM(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 0)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.MPOAIDJNDFJ();
			shield.cardIconIndicator.Show("Id", 105f, 1730f, false);
			num--;
		}
	}
	...
	private void DKBEFDDNNHB(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.NNCMDDBFOAJ();
			shield.cardIconIndicator.FFMLINMFADM("ID_FORFEIT", 1375f, 15f, false);
			num--;
		}
	}
	...
	private void PCOLFNJJJCI(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 0 && num > 0)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.DestroyShield();
			shield.NOCJKBDGFHD().BELBLFGCCLJ("ID_CONFIRM_ERROR", 1052f, 1233f, false);
			num--;
		}
	}
	...
	private void NLMNGILHBJI(GHPGNELIDBM IEIKEJDECIG)
	{
		...
		while (NMIADOEBBDH.Count > 1 && num > 1)
		{
			...
			NMIADOEBBDH.RemoveAt(index);
			shield.KDEEBMLFABC();
			shield.DHAFFOCDDGA().AMFEDOOPGCL("ID_DEBUG_GUIERROR", 418f, 1082f, true);
			num--;
		}
	}
}
