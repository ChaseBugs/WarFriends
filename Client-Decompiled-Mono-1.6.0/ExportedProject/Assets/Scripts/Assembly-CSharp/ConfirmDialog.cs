...
public class ConfirmDialog : GuiElementSingle<ConfirmDialog>, PAIIOKBBHBC
{
	private sealed class CGECFHFDEEH
	{
		...
		internal void CIFEDFPPPOK()
		{
			...
			JAGBOPMGIAA.LLILKCJKNPH.gameObject.SetActive(false);
			JAGBOPMGIAA.DDLOCLPOFAK.gameObject.SetActive(true);
			JAGBOPMGIAA.JLEFFOGPFGE.gameObject.SetActive(true);
			JAGBOPMGIAA.KGPGCCPMCIG.gameObject.SetActive(true);
		...
		internal void NNIJEDKBPGJ()
		{
			...
			JAGBOPMGIAA.LLILKCJKNPH.gameObject.SetActive(false);
			JAGBOPMGIAA.DDLOCLPOFAK.gameObject.SetActive(false);
			JAGBOPMGIAA.JLEFFOGPFGE.gameObject.SetActive(false);
			JAGBOPMGIAA.KGPGCCPMCIG.gameObject.SetActive(true);
		...
		internal void NDJOJHNIBFC()
		{
			...
			JAGBOPMGIAA.LLILKCJKNPH.gameObject.SetActive(true);
			JAGBOPMGIAA.DDLOCLPOFAK.gameObject.SetActive(false);
			JAGBOPMGIAA.JLEFFOGPFGE.gameObject.SetActive(true);
			JAGBOPMGIAA.KGPGCCPMCIG.gameObject.SetActive(false);
			JAGBOPMGIAA.DIPGLDIGFNF += 0;
	...
	public static void KKOOPJBADGJ(Action<ConfirmDialog, bool> AAPECJCHKKM, string OKMNFHNBMFA, string HOLNKOFHDNK)
	{
		...
		confirmDialog.LLILKCJKNPH.gameObject.SetActive(false);
		confirmDialog.DDLOCLPOFAK.gameObject.SetActive(true);
		confirmDialog.JLEFFOGPFGE.gameObject.SetActive(true);
		confirmDialog.KGPGCCPMCIG.gameObject.SetActive(false);
	...
	public static void DPGHIAPIAGC(Action<ConfirmDialog, bool> AAPECJCHKKM, string OKMNFHNBMFA, string HOLNKOFHDNK)
	{
		...
		confirmDialog.LLILKCJKNPH.gameObject.SetActive(false);
		confirmDialog.DDLOCLPOFAK.gameObject.SetActive(false);
		confirmDialog.JLEFFOGPFGE.gameObject.SetActive(true);
		confirmDialog.KGPGCCPMCIG.gameObject.SetActive(true);
	...
	public static void MNBOENNBBGK(Action<ConfirmDialog, bool> AAPECJCHKKM, string OKMNFHNBMFA, string HOLNKOFHDNK)
	{
		...
		confirmDialog.LLILKCJKNPH.gameObject.SetActive(false);
		confirmDialog.DDLOCLPOFAK.gameObject.SetActive(true);
		confirmDialog.JLEFFOGPFGE.gameObject.SetActive(false);
		confirmDialog.KGPGCCPMCIG.gameObject.SetActive(false);
	...
	private void ODINNCBLBOF()
	{
		...
		LLILKCJKNPH.gameObject.SetActive(false);
		DDLOCLPOFAK.gameObject.SetActive(true);
		JLEFFOGPFGE.gameObject.SetActive(true);
		KGPGCCPMCIG.gameObject.SetActive(false);
		DCIKANJJFIJ = 908f;
		HECFOEMLJCD = 987f;
	...
	public static void ShowAlert(Action<ConfirmDialog, bool> AAPECJCHKKM, string OKMNFHNBMFA, string HOLNKOFHDNK)
	{
		...
		confirmDialog.LLILKCJKNPH.gameObject.SetActive(true);
		confirmDialog.DDLOCLPOFAK.gameObject.SetActive(false);
		confirmDialog.JLEFFOGPFGE.gameObject.SetActive(false);
		confirmDialog.KGPGCCPMCIG.gameObject.SetActive(true);
	...
	private void ODACICLOMHJ()
	{
		...
		LLILKCJKNPH.gameObject.SetActive(true);
		DDLOCLPOFAK.gameObject.SetActive(true);
		JLEFFOGPFGE.gameObject.SetActive(false);
		KGPGCCPMCIG.gameObject.SetActive(true);
		DCIKANJJFIJ = 1824f;
		HECFOEMLJCD = 481f;
		UIEventListener.Get(JFCNMPHDKHC.gameObject).onClick = null;
	}
	...
	private void PAODBOEOFNF()
	{
		...
		LLILKCJKNPH.gameObject.SetActive(true);
		DDLOCLPOFAK.gameObject.SetActive(false);
		JLEFFOGPFGE.gameObject.SetActive(false);
		KGPGCCPMCIG.gameObject.SetActive(true);
		DCIKANJJFIJ = 440f;
		HECFOEMLJCD = 222f;
