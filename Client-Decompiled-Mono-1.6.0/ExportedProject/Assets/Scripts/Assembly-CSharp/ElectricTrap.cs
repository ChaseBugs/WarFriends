...
public class ElectricTrap : Core_BaseScript
{
	...
	private void CJKMCLNCGPB(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 270f, 1);
	...
	private void DJADMOOHKJO(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 345f, 0);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void IBFLEAFLOFJ(Collider APJKEKOEFHG)
	{
		if (TagsAndLayers.IsDestroyableObject(APJKEKOEFHG.transform.gameObject))
		{
			...
			{
				component.Shiver(component.health, Vector3.zero, null, JPBBAIGNBAP, false);
	...
	private void NBBPABNDMLB(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 724f, 0);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void GBFEANMHKPA(Collider APJKEKOEFHG)
	{
		if (TagsAndLayers.IsDestroyableObject(APJKEKOEFHG.transform.gameObject))
		{
			...
			if (component != null && JPBBAIGNBAP.fraction != component.fraction && component.owner is EnemyController && LAADDLGBFIG.isMine)
			{
				component.Shiver(component.health, Vector3.zero, null, JPBBAIGNBAP, true);
	...
	private void DCLAJPLAICE(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 525f, 1);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void DEOGNFLDONC(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 391f, 0);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void PJPFGJGLBNF(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 1193f, 0);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void CCJABONHOHF(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 1623f, 1);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void AMALADGJKCM(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 781f, 1);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void CAHCGAGJONJ(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 581f, 1);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void DNJBCOJJGJK(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 568f, 0);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void LDLPFOEDLGN(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 253f, 1);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void CDBOICPKGNB(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 10f, 1);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void MEDPBJMGHGP(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 1117f, 1);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void FDBCLHEOBNM(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 414f, 0);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void CONPLOGAHLF(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 1648f, 0);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void JFMOGEHANIB(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 488f, 1);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void GLALPOADGDI(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 881f, 0);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void GNOBDIMGANF(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 769f, 0);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void BOOPJDADNAG(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 1656f, 0);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void BENMCOJBKDL(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 1044f, 0);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void BDLOMOOAIPK(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 1512f, 1);
			BIGIABDIHJD.transform.position = hit.position;
	...
	private void IIODICICEAC(bool HMCNKNCEDMA)
	{
		...
		if (HMCNKNCEDMA)
		{
			...
			NavMeshHit hit;
			NavMesh.SamplePosition(BIGIABDIHJD.transform.position, out hit, 367f, 0);
			BIGIABDIHJD.transform.position = hit.position;
