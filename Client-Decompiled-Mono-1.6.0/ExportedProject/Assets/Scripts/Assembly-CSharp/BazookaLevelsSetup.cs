...
public class BazookaLevelsSetup : WeaponLevelsSetup
{
	...
	public virtual List<Tuple<string, float[]>> OENJGPIEIFM(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_SIGNIN", "ID_RANK", base.weaponFeature.attackCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "About to show Buy Cards Reminder", "requestId", base.weaponFeature.ammoCoef, true));
	...
	public virtual List<Tuple<string, float[]>> NINIIBGAJCN(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Card_1_Played", "game-card-ico-sickness", base.weaponFeature.ammoCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "null customization for: ", "open", base.weaponFeature.rateOfFireCoef, true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> OMCNBBABIHG(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, " NOT OK!\t\t\t\t\t\t", "arena", base.weaponFeature.ammoCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "C0", "ID_TUTORIAL_WARCARDS_STARTDOWN", base.weaponFeature.rateOfFireCoef, true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> JIFPIHMLAGA(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "S", "GR", base.weaponFeature.ammoCoef, true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_CLAIM", "Medals/", base.weaponFeature.attackCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "EDEFCFDDCJB", "ClientId", base.weaponFeature.ammoCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_CONFIRM_FORFEIT_TEXT", "Buy_Dogtags_With_Gold", base.weaponFeature.rateOfFireCoef, true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> CCJOGPPDIEM(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "121 MENU WEAPON SCREEN SHOWN", "#PETER# League Arc - stop ignore on ", base.weaponFeature.ammoCoef, true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "GoldBalance", "_Existing_User", base.weaponFeature.attackCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, " ", "125 MENU WEAPON SCREEN TUTORIAL WEAPON EQUIPPED", base.weaponFeature.ammoCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Rank", "ID_STARTERASSIGNMENTSEXPIRED", base.weaponFeature.rateOfFireCoef, true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> LGGEIGLAAFC(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_GETAPROMOTION2", "myLobby", base.weaponFeature.ammoCoef, true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Xp", "unit", base.weaponFeature.attackCoef, true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "shield_shot", "I", base.weaponFeature.attackCoef, true));
	...
	public virtual List<Tuple<string, float[]>> LEICHMNLNBD(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_DOYOUWANTTOBUYWARBUCKS", "FOUND", base.weaponFeature.ammoCoef, true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "[]", "AdminPlayerId", base.weaponFeature.attackCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Manual_Unit_Spawn", "Player_Waited_Till_Delivery_Ends", base.weaponFeature.ammoCoef));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "{0} {1}{2} {3}", "idle", base.weaponFeature.rateOfFireCoef, true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> GGGJIFMDNNJ(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "\t", "ID_ARENARULES_SLOWERRELOADING", base.weaponFeature.ammoCoef, true));
	...
	public virtual List<Tuple<string, float[]>> PNLFFLHJOEG(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "00", ", ", base.weaponFeature.ammoCoef, true));
	...
	public virtual List<Tuple<string, float[]>> BPDIHMEADHA(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "#Mission Rewards# 5 Heroic Missions completed. Gained {0} arena tickets", "ID_GUI_CHEATWARNING", base.weaponFeature.rateOfFireCoef, true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> LKHFKOENHHP(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_STAT_SQUADBEST", "#PETER# League Arc - stop ignore on ", base.weaponFeature.rateOfFireCoef, true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "\n", "BS: On Skip Assignemnt", base.weaponFeature.attackCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "SquadId", "PlayerId", base.weaponFeature.ammoCoef));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "extraWarBucks", "VipReward1", base.weaponFeature.rateOfFireCoef, true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> ECAEJMLOLGD(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "PackLocation", "game-card-silver", base.weaponFeature.ammoCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_FEATURE_SHOTSPEED-FANCY", "LevelName", base.weaponFeature.rateOfFireCoef, true));
		return list;
	}
