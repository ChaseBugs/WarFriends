...
public class GameControllerCampaign : IGameController
{
	...
	public bool shouldLooseDogtagWhenQuit
	{
		get
		{
			return false;
	...
	public virtual void APFFMDNNKNJ()
	{
		...
		Singleton<BeanstalkServerManager>.instance.GFHBHIJKMEE();
		LoadingDialog.SetLook(false);
		LoadingDialog.PGFBMJFLHPC(Localization.Localize("country-italy"), true, true);
	}
	...
	public virtual void KBBEMOGNFKD()
	{
		...
		DailyMissionsManager.instance.OCKCBFLKEGJ().EndMission(true);
	}
	...
	public virtual void GDGMBLMKKPN()
	{
		...
		DailyMissionsManager.instance.EEIJPIPFAMO().EndMission(true);
	}
