...
public class LootBoxCameraArena : Singleton<LootBoxCameraArena>
{
	private sealed class ANMLHPBIDOL : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool FBMLBIOKKBE()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.CFLJMCBNBNE(false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1017f), false, true, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool MKCOLOBIAAP()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.CIKIBEDFCNB(false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1681f), true, false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool HKPECDLGFJB()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.FHGPDJBGFIB(true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 74f), false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool IJEDIDEJIII()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.CNEADELKALM(true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 933f), false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool OOECALAHCFK()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.IFMFDOKEMHF(false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 491f), true, false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool AGMKAADLHLE()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.CIKIBEDFCNB(true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 158f), false, true, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool GCEBFCBBEKM()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.CIKIBEDFCNB(false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1301f), true, false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool ONIAGKNGBHE()
		{
			...
			case 0u:
				PlayerController.OGMBJPKOPCB.fraction = (GHPGNELIDBM)3;
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.FHGPDJBGFIB(false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1230f), false, true, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool HCONPNNPBAD()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.PNNDDKOCFNE(true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 901f), false, false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool MOFPMNMAOND()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.CIKIBEDFCNB(false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1242f), false, false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool APJNFAOFAFD()
		{
			...
			case 0u:
				PlayerController.OGMBJPKOPCB.fraction = (GHPGNELIDBM)5;
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.ALFLHPIEADC(true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 893f), true, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool HEHJAEIGHDN()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.IFMFDOKEMHF(true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1585f), false, false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool EOLNOFMPMHI()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.CIKIBEDFCNB(false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1762f), false, true, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool DKJMOPNHIAB()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.FHGPDJBGFIB(true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1072f), true, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool KIFNNJFJJCG()
		{
			...
			case 0u:
				PlayerController.OGMBJPKOPCB.fraction = GHPGNELIDBM.None;
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.CFLJMCBNBNE(true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1350f), false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool IIJKAMFGNKA()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.FHGPDJBGFIB(false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1602f), false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool PMLLPHFACBM()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.IFMFDOKEMHF(true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 679f), true, false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool HOOHJGPHHGN()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.CFLJMCBNBNE(false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1260f), false, false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool AELAICNOAPN()
		{
			...
			case 0u:
				PlayerController.OGMBJPKOPCB.fraction = (GHPGNELIDBM)6;
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.PNNDDKOCFNE(false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1237f), false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool LHNFELIIMGD()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.ALFLHPIEADC(true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1644f), false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool CJGDOJHLOII()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.FHGPDJBGFIB(true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1068f), false, false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
		...
		public bool LGOHLNFJKNL()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.CIKIBEDFCNB(false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 281f), true, false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool JMCPAKBLPML()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.CIKIBEDFCNB(false);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1249f), true, false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
				}
		...
		public bool CIIHKFDLDKN()
		{
			...
			case 0u:
				...
				HMEFCHGLFIF = null;
				BJGCPDNMHDH.CFLJMCBNBNE(true);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(EFHPOHNNGGH.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(EFHPOHNNGGH, 1857f), true, false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
				}
	...
	protected virtual void JFDOGLFMHAE()
	{
		...
		mDialogCamera.gameObject.SetActive(true);
	}
	...
	protected virtual void ECMMDCKONDK()
	{
		...
		mDialogCamera.gameObject.SetActive(false);
	}

	public void BOPCGMEACDJ()
	{
		mCharacterParent.gameObject.SetActive(false);
	}
	...
	private void CIMHOFHPKNJ(bool MBINJMOJOBG)
	{
		...
		GNILIFKCBKB.gameObject.SetActive(false);
		mCharacterParent.gameObject.SetActive(false);
	}
	...
	public void BEEFKBFEMIB(LevelBehaviour ACLDFHJKBLI, bool LBCMGKGLFPI)
	{
		...
		GNILIFKCBKB.gameObject.SetActive(true);
		mCharacterParent.gameObject.SetActive(true);
	...
	private void CNEADELKALM(bool NOBOBPMMHCE)
	{
		if (BJHPKLAEFCI != null)
		{
			...
			BJHPKLAEFCI.DestroyPooled(true);
			BJHPKLAEFCI = null;
		}
	}
