...
public class GuiTexureAssets : Singleton<GuiTexureAssets>
{
	...
	public float scale
	{
		get
		{
			return (!Singleton<PerformanceManager>.instance.isHD) ? 2f : 1f;
		}
	}
	...
	public WebTextureLoader videoFeedTextures
	{
		get
		{
	...
	public WebTextureLoader offerBigTextures
	{
		get
		{
	...
	public WebTextureLoader offerSmallTextures
	{
		get
		{
