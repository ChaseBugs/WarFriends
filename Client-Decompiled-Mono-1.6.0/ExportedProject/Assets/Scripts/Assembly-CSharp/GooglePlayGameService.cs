...
public class GooglePlayGameService : Singleton<GooglePlayGameService>
{
	...
	public void Init()
	{
		...
		PlayGamesPlatform.Instance.Authenticate(FMHONFAKNJA, true);
	}
	...
	public void KNJNFPHJOHI()
	{
		...
		PlayGamesPlatform.Instance.Authenticate(PJNOJIDOPHF, false);
	}
	...
	public void NGKCCBEFGDD()
	{
		...
		PlayGamesPlatform.Instance.Authenticate(MCGCGCHABID, false);
	}
	...
	public void AFLLCFMGKLH()
	{
		...
		PlayGamesPlatform.Instance.Authenticate(GKHAAKKKOLC, true);
	}
	...
	public void DMIFFOMMEMD()
	{
		...
		PlayGamesPlatform.Instance.Authenticate(CJOBALKNBEM, false);
	}
	...
	public void EOPOODDCKNJ()
	{
		...
		PlayGamesPlatform.Instance.Authenticate(HPAHLDHMMFK, true);
	}
	...
	public void FLCHMKHNLPO()
	{
		...
		PlayGamesPlatform.Instance.Authenticate(BGONLHJPPIL, true);
	}
	...
	public void MOILFBKMAEO()
	{
		...
		PlayGamesPlatform.Instance.Authenticate(HKIDDGCNMPL, true);
	}
