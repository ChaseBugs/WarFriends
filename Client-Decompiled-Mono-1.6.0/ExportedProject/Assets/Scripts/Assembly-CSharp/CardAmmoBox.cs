...
public class CardAmmoBox : Card
{
	...
	public float multiplierBullets
	{
		get
		{
	...
	public override string description
	{
		get
		{
			return Localization.LocalizeFormat(mDescriptionID, MEJMLNDFDBP.JJBMMICPIIG(multiplierBullets));
		}
	}
	...
	public virtual void BHNOANFEFJN(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		playerController.cardIconIndicator.FCANLIOLJNH(" on object ", 445f, 1547f, true);
	}
	...
	public virtual void ABMOHFELOFN(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
		playerController.cardIconIndicator.ODDNDGAAOCH("(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V", 214f, 804f, true);
	}
	...
	public virtual void PDAPJMGBOFF(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
		playerOld.cardIconIndicator.JBMCFEMBPKE("GameReward", 1100f, 98f, true);
	}
	...
	public virtual void JIHHEBGMCBB(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
		playerOld.cardIconIndicator.AMFEDOOPGCL("Skirmish", 1987f, 1036f, false);
	}
	...
	public override void UseCard(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
		playerOld.cardIconIndicator.Show("game-card-ico-ammobox", 3f, 3f, false);
	}
	...
	public virtual void CCODFGNHBOJ(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
		playerOld.cardIconIndicator.BELBLFGCCLJ("ID_GETITCHEAPERNOW", 549f, 88f, false);
	}
	...
	public virtual void ODIBFAFGJBP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
		playerOld.cardIconIndicator.LOFMDBHAFAO("BattleAnalytics", 1773f, 638f, false);
	}
	...
	public virtual void KDPIJNFDMKC(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
		playerOld.cardIconIndicator.JOGFDHFOOBC("US", 879f, 166f, false);
	}
	...
	public virtual void NEPIKOKDBHP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
		playerOld.cardIconIndicator.AMFEDOOPGCL("T", 472f, 1836f, true);
	}
