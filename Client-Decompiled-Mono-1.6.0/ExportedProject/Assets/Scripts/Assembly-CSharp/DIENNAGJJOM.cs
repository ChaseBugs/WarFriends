...
public class DIENNAGJJOM
{
	...
	public static void HIACCBBKKFJ(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
		case (IJEAJGCCHEF)(-67):
			WarningDialog.ShowError(Localization.Localize("QUIT"), Localization.Localize("isRandomMap"), 673f, CBLAKJKPBCC, string.Empty, false, true);
			break;
		case (IJEAJGCCHEF)(-175):
			WarningDialog.KHOMNBHMFGA(Localization.Localize("Should not happened"), Localization.Localize("^\\D*"), 1805f, NDAFLLMHIGH, string.Empty, true);
			break;
		case (IJEAJGCCHEF)(-89):
			Debug.LogError("\"");
			WarningDialog.ShowError(Localization.Localize("gold"), Localization.Localize("UseOnGetPlayerData"), 1472f, JOPFLHHONHG, string.Empty, true, true);
			break;
		}
	}
	...
	public static void KNCMJDBHMFB(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
		case (IJEAJGCCHEF)80:
			WarningDialog.JACKIDKHKAI(Localization.Localize("Lcom/google/android/gms/games/Players;"), Localization.Localize("GooglePlay"), 1714f, EKLBNLHMJCH, string.Empty, true);
			break;
		case (IJEAJGCCHEF)83:
			WarningDialog.ShowError(Localization.Localize("ScrapsGained"), Localization.Localize("SquadId"), 1256f, EAEEMFCGIML, string.Empty, true, true);
			break;
		case IJEAJGCCHEF.NotEnoughLevel:
			Debug.LogError(" Desc = ");
			WarningDialog.JACKIDKHKAI(Localization.Localize("ID_GUI_ACCEPT_PLAYER_WTJ"), Localization.Localize("'ID_MONTH_'0"), 369f, HPEGBLBDIEF, string.Empty, true);
			break;
		}
	}
	...
	public static void DHGINOPENOK(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
		case (IJEAJGCCHEF)(-31):
			WarningDialog.JACKIDKHKAI(Localization.Localize("hasConnectedApi"), Localization.Localize("UIReflectionEffect reference missing for index "), 406f, LOMAGLMFMAB, string.Empty, true);
			break;
		case (IJEAJGCCHEF)91:
			WarningDialog.JACKIDKHKAI(Localization.Localize("AchievementClaimed"), Localization.Localize("RETRYPERM"), 760f, EAEEMFCGIML, string.Empty, true);
			break;
	...
	public static void EHMCAPEINNC(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
		case (IJEAJGCCHEF)69:
			WarningDialog.ShowError(Localization.Localize("SetupRPC"), Localization.Localize("Automatic_Equip"), 874f, CNFDDOBMACB, string.Empty, false, true);
			break;
		case (IJEAJGCCHEF)(-26):
			WarningDialog.ShowError(Localization.Localize("rental for unexist visual: {0}"), Localization.Localize("ID_CATEGORY_LOW_SG_HANDGUN"), 608f, JBBAGFMCJND, string.Empty, true);
			break;
		case (IJEAJGCCHEF)(-67):
			Debug.LogError("ID_INSILVER1");
			WarningDialog.JACKIDKHKAI(Localization.Localize("Automatic_Equip"), Localization.Localize("Scraps"), 1979f, JOPFLHHONHG, string.Empty, true, true);
			break;
		}
	}
	...
	public static void CLCCAFPBHCP(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
		case (IJEAJGCCHEF)(-22):
			WarningDialog.JACKIDKHKAI(Localization.Localize("IosReceipt"), Localization.Localize("Buy_InstantBattle"), 1298f, GAPBBAHNBHF, string.Empty, false, true);
			break;
		case IJEAJGCCHEF.PlayerNameTaken:
			WarningDialog.KHOMNBHMFGA(Localization.Localize("ID_CONFIRM_MAXCCUREACHED"), Localization.Localize(", password = "), 458f, LBMOAPCHBGO, string.Empty, true);
			break;
		case (IJEAJGCCHEF)(-97):
	...
	public static void OBCJJGKJCID(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
		case (IJEAJGCCHEF)95:
			WarningDialog.JACKIDKHKAI(Localization.Localize("Chat: Channels "), Localization.Localize("ID_READYTIME"), 492f, BMJIEPKAGFI, string.Empty, false, true);
			break;
		case (IJEAJGCCHEF)59:
			WarningDialog.ShowError(Localization.Localize("StepId"), Localization.Localize("BAND_REWARD_HEALTH"), 324f, BEEGMMKGHDP, string.Empty, false, true);
			break;
		case (IJEAJGCCHEF)75:
			Debug.LogError("Rental");
			WarningDialog.ShowError(Localization.Localize("Price"), Localization.Localize("warbucks initialized"), 114f, HOOMDDGPNFE, string.Empty, false, true);
			break;
		}
	}
	...
	public static void AIJPOLMFJKL(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)150:
			WarningDialog.ShowError(Localization.Localize("{0} {1}{2}"), Localization.Localize("game-elite-debuff"), 463f, DHMMMKKNJOO, string.Empty, false, true);
			break;
		case (IJEAJGCCHEF)(-73):
			Debug.LogError("Medals/");
			WarningDialog.KHOMNBHMFGA(Localization.Localize("isLeft "), Localization.Localize("tempuser@tempcompany.com"), 753f, PNHJIHCEMHK, string.Empty, true, true);
			break;
		}
	}
	...
	public static void DEIBOPGEAOD(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case IJEAJGCCHEF.SameFacebookAlreadyCreated:
			WarningDialog.ShowError(Localization.Localize("dogTagTimerLock"), Localization.Localize("Cards on saved data: "), 1009f, CNDBOIMJLOB, string.Empty, true, true);
			break;
		case (IJEAJGCCHEF)(-143):
			WarningDialog.JACKIDKHKAI(Localization.Localize("Please add object to pool, before instanciing it ::: prefab name = "), Localization.Localize("SquadId"), 1871f, MNMNJBCDPOP, string.Empty, false, true);
			break;
	...
	public static void CHIHJNBIAPM(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
		case (IJEAJGCCHEF)83:
			WarningDialog.JACKIDKHKAI(Localization.Localize("game-card-ico-belovedenemy"), Localization.Localize("Freeze game:"), 375f, CNDBOIMJLOB, string.Empty, false, true);
			break;
		case (IJEAJGCCHEF)(-53):
			WarningDialog.ShowError(Localization.Localize("Omitting object: "), Localization.Localize("ID_REMINDER_GETVALUABLECARDPACKS"), 1696f, NBNOJMBCJPI, string.Empty, false, true);
			break;
		case (IJEAJGCCHEF)(-139):
			Debug.LogError("#VOJTA# Message Manager: Error previously ignored message arrived again from server! Id = ");
			WarningDialog.ShowError(Localization.Localize("Cards_Owned_Bronze"), Localization.Localize("groundBoxHit"), 785f, KDAGGCDDHHN, string.Empty, false, true);
			break;
		}
	}
	...
	public static void BJHMLPFBOOG(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-185):
			WarningDialog.KHOMNBHMFGA(Localization.Localize("Commando"), Localization.Localize("Logs sent to server\nWaiting for response"), 780f, MNMNJBCDPOP, string.Empty, true, true);
			break;
		case IJEAJGCCHEF.NotEnoughGold:
			Debug.LogError("Buy_Pack");
			WarningDialog.JACKIDKHKAI(Localization.Localize("Scraps"), Localization.Localize("1"), 469f, HPEGBLBDIEF, string.Empty, true, true);
			break;
		}
	}
	...
	public static void FANNAFLCNEL(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)165:
			WarningDialog.KHOMNBHMFGA(Localization.Localize("bazooka_uncover_left"), Localization.Localize("Landroid/os/Parcelable$Creator;"), 432f, MFHHAAPEIGN, string.Empty, true, true);
			break;
		case (IJEAJGCCHEF)129:
			Debug.LogError("ID_RENTAL_GRENADE");
			WarningDialog.JACKIDKHKAI(Localization.Localize("Lcom/google/android/gms/games/Notifications;"), Localization.Localize("Level"), 255f, NKDFBOAAHEH, string.Empty, true);
			break;
		}
	}
	...
	public static void MEOKAKNJDKE(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
		case (IJEAJGCCHEF)(-90):
			WarningDialog.KHOMNBHMFGA(Localization.Localize("menu-army-cat-rusher"), Localization.Localize("ID_NOTIFICATION_LAPSED_BASE"), 960f, CNDBOIMJLOB, string.Empty, false, true);
			break;
		case (IJEAJGCCHEF)54:
			WarningDialog.JACKIDKHKAI(Localization.Localize("PlacementMatchesRequired"), Localization.Localize("{0}{1}[-]"), 1239f, KLPEBADGENE, string.Empty, true, true);
			break;
		case (IJEAJGCCHEF)171:
			Debug.LogError("Post Parameters: ");
			WarningDialog.JACKIDKHKAI(Localization.Localize("Spend_Gold_On_Power_Bands"), Localization.Localize("ID_CONFIRM_PROMOTEDEMOTEERROR"), 1518f, HPEGBLBDIEF, string.Empty, true, true);
			break;
		}
	}
	...
	public static void BHGLILBIDBO(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
		case (IJEAJGCCHEF)(-48):
			WarningDialog.KHOMNBHMFGA(Localization.Localize("RETRY"), Localization.Localize("saved obtained cards: "), 23f, CNFDDOBMACB, string.Empty, true, true);
			break;
	...
	public static void AKNAFDNAJNJ(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
		case (IJEAJGCCHEF)(-64):
			WarningDialog.ShowError(Localization.Localize("{0} {1}"), Localization.Localize("WarBucks"), 1112f, KFKDNPFOMEJ, string.Empty, false, true);
			break;
		case (IJEAJGCCHEF)139:
		...
		case (IJEAJGCCHEF)(-65):
			...
			WarningDialog.ShowError(Localization.Localize("weapon"), Localization.Localize("N"), 1949f, EAFJNHDMCAO, string.Empty, false, true);
			break;
		}
	}
	...
	public static void CLCKDOJHIEO(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-162):
			WarningDialog.KHOMNBHMFGA(Localization.Localize("Player {0} {1}"), Localization.Localize("offerMult"), 101f, NHGCHPEAAJF, string.Empty, true);
			break;
		case (IJEAJGCCHEF)132:
			WarningDialog.KHOMNBHMFGA(Localization.Localize("504 MENU ARMY SCREEN UNIT SELECTED"), Localization.Localize("LeagueId"), 274f, MFHHAAPEIGN, string.Empty, true, true);
			break;
		case (IJEAJGCCHEF)190:
			Debug.LogError("Claim_Reward");
			WarningDialog.ShowError(Localization.Localize("bazooka_shoot_left"), Localization.Localize("nextGenerate"), 1649f, HPEGBLBDIEF, string.Empty, false, true);
			break;
		}
	}
	...
	public static void PHNAAJIHEIG(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)189:
			WarningDialog.ShowError(Localization.Localize("Buy_Player_Customizations_Gold"), Localization.Localize("auto"), 1688f, EPIKJABGGBJ, string.Empty, true, true);
			break;
		case (IJEAJGCCHEF)54:
			WarningDialog.JACKIDKHKAI(Localization.Localize("{0}{1}"), Localization.Localize("ru"), 392f, LPODPCBMBHA, string.Empty, true, true);
			break;
		case (IJEAJGCCHEF)(-9):
			Debug.LogError("country-egypt");
			WarningDialog.ShowError(Localization.Localize(" "), Localization.Localize("ScrapsGained"), 1217f, MNGFMOLBAGJ, string.Empty, false, true);
			break;
		}
	}
