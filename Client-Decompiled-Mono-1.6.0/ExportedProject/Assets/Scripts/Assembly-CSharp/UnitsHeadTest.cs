			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 948f), false, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 2;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 1521f), true, true, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 8;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 191f), false, true, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 2;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 749f), true, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 2;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 1180f), true, true, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 3;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 361f), false, true, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 7;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 1129f), true, true, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 2;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 761f), true, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 4;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 325f), false, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 7;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 765f), false, false, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 7;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 1864f), false, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 5;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 152f), false, false));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 5;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 1684f), true, false, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 4;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 273f), false, false));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 5;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 1463f), false, false, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 2;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 602f), true, false, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 2;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 1096f), false, true, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 3;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP), true, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 2;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 1391f), false, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 3;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 1836f), false, true, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 1;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 819f), false, true, true));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 0;
							}
			...
			case 2u:
				try
				{
					...
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (NBFFMCFEKOP is SoldierBehaviour)
						{
							PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(NBFFMCFEKOP.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(NBFFMCFEKOP, 1958f), true, false));
							if (!FDKOKMKIIMG)
							{
								CLPPIAGLCJJ = 6;
							}
