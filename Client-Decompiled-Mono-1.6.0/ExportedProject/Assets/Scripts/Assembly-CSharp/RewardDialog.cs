...
public class RewardDialog : GuiElementSingle<RewardDialog>, PAIIOKBBHBC
{
	...
	public void JLMDOEFBAPG(Card CEKHIJECPNP)
	{
		...
		{
			PJOFHIKENOI.IGPOLIPPGBP(CEKHIJECPNP, CardRecord.MKIOKBMLHEO.Other, false);
		}
	}
	...
	public virtual void PKEDKDBNFAP()
	{
		...
		{
			DJDABJKPKOF.MEODANEBGGL(OAKNNNMGEID, 1972f, false);
		}
	}
	...
	{
		MMLIIEIJOJD = FJLBLLLEELD;
		GHINGDGFNJC = ((CEKHIJECPNP != null) ? CardManager.instance.GetCardInstance(CEKHIJECPNP.ToString(), false) : null);
	...
	private void LHJGNEPNCHE(long IEALLELGOBM)
	{
		...
		if (CDPNOOGFKOF)
		{
			...
			NFPLGDHDGDE.text = string.Format("x{0}", MEJMLNDFDBP.GMIPFLIEOHD(num));
	...
	public void AHDPEFICJAP(Card CEKHIJECPNP)
	{
		...
		{
			PJOFHIKENOI.IGPOLIPPGBP(CEKHIJECPNP, CardRecord.MKIOKBMLHEO.MyWarcards, false);
		}
	}
	...
	public virtual void KFLMMJFLBEA()
	{
		...
		if (OAKNNNMGEID != null && OAKNNNMGEID.Length > 0)
		{
			DJDABJKPKOF.BKLMJCEPNMK(OAKNNNMGEID, 827f, false);
		}
	}
	...
	public void IJKKOFGPIOE(Card CEKHIJECPNP)
	{
		...
		{
			PJOFHIKENOI.IGPOLIPPGBP(CEKHIJECPNP, CardRecord.MKIOKBMLHEO.Deposit, false);
		}
	}
