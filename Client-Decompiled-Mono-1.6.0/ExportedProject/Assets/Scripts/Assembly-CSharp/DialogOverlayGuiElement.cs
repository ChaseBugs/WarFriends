...
public class DialogOverlayGuiElement : Core_BaseScript
{
	...
	public static DialogOverlayGuiElement instance
	{
		get
		{
			BJHPKLAEFCI = Singleton<GuiManager>.instance.IJMDOGNBGIL.GetComponentsInChildren<DialogOverlayGuiElement>(true)[0];
			if (BJHPKLAEFCI == null)
			{
	...
	{
		BJHPKLAEFCI = Singleton<GuiManager>.instance.IJMDOGNBGIL.GetComponentsInChildren<DialogOverlayGuiElement>(false)[0];
		if (BJHPKLAEFCI == null)
		{
	...
	{
		BJHPKLAEFCI = Singleton<GuiManager>.instance.IJMDOGNBGIL.GetComponentsInChildren<DialogOverlayGuiElement>(true)[1];
		if (BJHPKLAEFCI == null)
		{
	...
	{
		BJHPKLAEFCI = Singleton<GuiManager>.instance.IJMDOGNBGIL.GetComponentsInChildren<DialogOverlayGuiElement>(false)[1];
		if (BJHPKLAEFCI == null)
		{
