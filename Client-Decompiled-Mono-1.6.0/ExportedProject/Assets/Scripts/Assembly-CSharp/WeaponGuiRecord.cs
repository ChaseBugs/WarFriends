...
public class WeaponGuiRecord : PoolableObject
{
	...
	public WeaponLevelsSetup weaponSetup
	{
		get
		{
			return MDAJJIAMDGH;
	...
	public void DFOAGLGOEGC()
	{
		...
		GuiScreenSingle<WeaponScreen>.instance.selectedIcon.SetHighlight(false);
		APHECPIPBPK(false);
	...
	{
		SoundsManager.Instance.PlayButtonClickedSound();
		GuiScreenSingle<WeaponScreen>.instance.FMFHOPFBMOO().APHECPIPBPK(true);
		APHECPIPBPK(true);
		GuiScreenSingle<WeaponScreen>.instance.MCFPJFKFJPH(this);
	...
	{
		SoundsManager.Instance.PlayButtonClickedSound();
		GuiScreenSingle<WeaponScreen>.instance.PAAMHOJOFFP().JLDBLKLBCEG(true);
		SetHighlight(true);
		GuiScreenSingle<WeaponScreen>.instance.MCFPJFKFJPH(this);
	...
	{
		SoundsManager.Instance.PlayButtonClickedSound();
		GuiScreenSingle<WeaponScreen>.instance.selectedIcon.IBEDIAODLJD(true);
		JLDBLKLBCEG(false);
		GuiScreenSingle<WeaponScreen>.instance.MCFPJFKFJPH(this);
		GuiScreenSingle<WeaponScreen>.instance.MIIMDHKCINK();
		JHEOELIFKKA();
	...
	{
		SoundsManager.Instance.PlayButtonClickedSound();
		GuiScreenSingle<WeaponScreen>.instance.selectedIcon.PJEEJBPFNFA(false);
		LINPOIDDFGA(true);
	...
	{
		SoundsManager.Instance.PlayButtonClickedSound();
		GuiScreenSingle<WeaponScreen>.instance.FMFHOPFBMOO().IBEDIAODLJD(true);
		LPGHPNDKMLN(true);
		GuiScreenSingle<WeaponScreen>.instance.SetSelectedIcon(this);
		GuiScreenSingle<WeaponScreen>.instance.Select();
		OJBFKBHDOOI();
	...
	{
		SoundsManager.Instance.PlayButtonClickedSound();
		GuiScreenSingle<WeaponScreen>.instance.PAAMHOJOFFP().IIPCKKGBHIN(true);
		JLDBLKLBCEG(true);
		GuiScreenSingle<WeaponScreen>.instance.MCFPJFKFJPH(this);
		GuiScreenSingle<WeaponScreen>.instance.MIIMDHKCINK();
		PANNOJHHCCB();
