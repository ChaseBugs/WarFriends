...
public class MIFGKEHBPOK
{
	...
	public static void FDECGOMKMOF(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
			WarningDialog.ShowError(Localization.Localize("Password"), Localization.Localize("ID_CONFIRM_ERRORCLAIMREWARD_TEXT"), 1821f, PPGKOFBPCKH, string.Empty, false, true);
		}
	}
	...
	public static void CFHCHJLEMFB(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
			WarningDialog.ShowError(Localization.Localize("Wrong_Unit"), Localization.Localize("ID_CONFIRM_TUTORIALMATCH_TEXT"), 1730f, AEANMLPOOIP, string.Empty, false, true);
		}
	}
	...
	public static void FANNAFLCNEL(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
			WarningDialog.JACKIDKHKAI(Localization.Localize("country-france"), Localization.Localize("ADDING WEAPON ON CLIENT"), 142f, ALJBNEEDFBI, string.Empty, true, true);
		}
	}
	...
	public static void DAJCCCBFDFG(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
			WarningDialog.KHOMNBHMFGA(Localization.Localize("Cards_Owned_Gold"), Localization.Localize("VipReward2"), 630f, BMJIEPKAGFI, string.Empty, true);
		}
	}
	...
	public static void IAJHAJOILKL(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
			WarningDialog.KHOMNBHMFGA(Localization.Localize("' START"), Localization.Localize("ID_PLAYBATTLETOENTERBRONZELEAGUE"), 794f, FHBCKHPANHO, string.Empty, true, true);
		}
	}
