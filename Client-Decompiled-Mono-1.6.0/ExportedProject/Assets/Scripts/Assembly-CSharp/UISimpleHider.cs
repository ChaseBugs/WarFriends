...
public class UISimpleHider : MonoBehaviour
{
	...
	{
		PIKNPBAKFCO = true;
		KJNIPFCLEFL = new List<UIWidget>(GetComponentsInChildren<UIWidget>(true));
		...
		LFBKGKJJIEC = new List<UISimpleHider>(base.gameObject.GetComponentsInChildren<UISimpleHider>(true));
	...
	{
		PIKNPBAKFCO = true;
		KJNIPFCLEFL = new List<UIWidget>(GetComponentsInChildren<UIWidget>(false));
		if (KJNIPFCLEFL.Count == 0)
		{
			base.enabled = true;
			return;
		...
		LFBKGKJJIEC = new List<UISimpleHider>(base.gameObject.GetComponentsInChildren<UISimpleHider>(false));
		LFBKGKJJIEC.Remove(this);
		LGOHLFCIALJ();
	}
