...
public class BIEOKKFMMOL : JPCPNFFLMEH
{
	...
	private void GACLCDKGIIK(string ENCEFOOPBMK)
	{
		...
		WaitingDialog.Hide();
		WarningDialog.ShowError(Localization.Localize("ID_WARNING_FAILTORESTORE"), Localization.Localize("ID_WARNING_RESTOREERROR"), 0f, null, string.Empty, true);
	}
	...
	private void HGHPJNOIFGB(string ENCEFOOPBMK)
	{
		...
		WarningDialog.KHOMNBHMFGA(Localization.Localize("[FF0000]BLACKMARKET[-]"), Localization.Localize("LeagueEvaluation"), 1593f, null, string.Empty, false, true);
	}
	...
	private void DLCNHKCNLDN(string ENCEFOOPBMK)
	{
		...
		WarningDialog.KHOMNBHMFGA(Localization.Localize("ID_WARNING_ALREADYCRAFTING"), Localization.Localize("DepositedCards"), 1214f, null, string.Empty, false, true);
	}
	...
	private void JJLCGCPHGCG(string PNAKMCNGGHE)
	{
		...
		Singleton<EventTrackingManager>.instance.MLAMBLBINMK(CFGNKPBIBAD, false);
	}
	...
	private void CAEKKOHACEO(string ENCEFOOPBMK)
	{
		...
		Singleton<SessionManager>.instance.FinishInapp();
		WaitingDialog.KDLLKOJBGGO();
		WarningDialog.JACKIDKHKAI(Localization.Localize("ID"), Localization.Localize("isRandomMap"), 1222f, null, string.Empty, false, true);
	}
	...
	public void INAEGBMFMDL(string HOILIFMFLGG)
	{
		...
		if (this.GBILNGBAANO != null)
		{
			this.GBILNGBAANO(CFMMPLIBFHE(HOILIFMFLGG), HOILIFMFLGG, true, new List<Tuple<string, string>>());
		}
		Singleton<SessionManager>.instance.ELLIPLOAGMG();
	}
	...
	private void IEMPCNMLELN(string ENCEFOOPBMK)
	{
		...
		WarningDialog.ShowError(Localization.Localize("glassHP"), Localization.Localize("v"), 428f, null, string.Empty, false, true);
	}
	...
	private void GNFOPDBGNEP(string PNAKMCNGGHE)
	{
		...
		Singleton<EventTrackingManager>.instance.MLAMBLBINMK(CFGNKPBIBAD, true);
	}
	...
	private void IPLEAHAIHFK(string ENCEFOOPBMK)
	{
		...
		WarningDialog.KHOMNBHMFGA(Localization.Localize("ID_SQUADREWARDGET"), Localization.Localize("ID_CONFIRM_DOGTAGSAREFULL"), 966f, null, string.Empty, true);
	}
	...
	public void APLNKKDEJLN(string HOILIFMFLGG)
	{
		...
		if (this.GBILNGBAANO != null)
		{
			this.GBILNGBAANO(NAGPLEPKEKL(HOILIFMFLGG), HOILIFMFLGG, false, new List<Tuple<string, string>>());
		}
		Singleton<SessionManager>.instance.FinishInapp();
	}
	...
	private void PNGMLNAKIIA(string ENCEFOOPBMK)
	{
		...
		Singleton<SessionManager>.instance.NAABAIPACMP();
		WaitingDialog.Hide();
		WarningDialog.KHOMNBHMFGA(Localization.Localize("ID_CONFIRM_ERROR"), Localization.Localize("111-222-3333"), 1265f, null, string.Empty, true);
	}
