...
public class MechBehaviour : LevelBehaviour
{
	...
	public override BehaviourDefinititon baseBehaviourDefinititon
	{
		get
		{
			return IPKOPMEMPLJ;
	...
	public override void Unload()
	{
		if (base.unitModel != null)
		{
			...
			SkinnedMeshRenderer[] componentsInChildren = base.unitModel.GetComponentsInChildren<SkinnedMeshRenderer>(true);
	...
	public virtual void BAFAKPDFJFN()
	{
		...
		{
			List<string> list = new List<string>();
			SkinnedMeshRenderer[] componentsInChildren = base.unitModel.GetComponentsInChildren<SkinnedMeshRenderer>(false);
			SkinnedMeshRenderer[] array = componentsInChildren;
			foreach (SkinnedMeshRenderer skinnedMeshRenderer in array)
			{
				Resources.UnloadAsset(skinnedMeshRenderer.sharedMesh);
