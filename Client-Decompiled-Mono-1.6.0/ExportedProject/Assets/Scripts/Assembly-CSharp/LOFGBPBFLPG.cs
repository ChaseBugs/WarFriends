...
public static class LOFGBPBFLPG
{
	...
	private static object OICHLHHGAOK(StreamBuffer OFMCDEGFIGM, short IOIPJCICLFH)
	{
		...
		lock (IKDDHGOEOBF)
		{
			...
			short value;
			Protocol.Deserialize(out value, IKDDHGOEOBF, ref offset);
	...
	private static object OCDDHGGHCFM(StreamBuffer OFMCDEGFIGM, short IOIPJCICLFH)
	{
		...
		lock (BJIKLIEMBOJ)
		{
			...
			short value;
			Protocol.Deserialize(out value, BJIKLIEMBOJ, ref offset);
			short value2;
			Protocol.Deserialize(out value2, BJIKLIEMBOJ, ref offset);
