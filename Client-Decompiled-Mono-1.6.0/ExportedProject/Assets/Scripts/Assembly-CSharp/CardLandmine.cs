...
public class CardLandmine : Card
{
	...
	public virtual void LLFHEHHPMGL(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1096f, 0);
			...
			if (mineAmmo != null)
			{
				mineAmmo.IFKEKKPFIEF().GKAOMCGCDGE("ID_MOREINFO", true, true);
			}
			else
			{
				Debug.LogError("1.0");
	...
	public virtual void MEMDELDKFJI(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 145f, 1);
			Mine cOHKHNALDPH = playerController.BEIIOAIJMFK().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.MMCLHGEGOJO().GKAOMCGCDGE("S", false, true);
			}
			else
			{
	...
	public virtual void HGINJJNEEDB(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 545f, 0);
			...
			if (mineAmmo != null)
			{
				mineAmmo.GDBDMFCEGIB().GCLFBCIKNAH("ID_SALEPERCENTLINE", true, true);
			}
			else
			{
	...
	public virtual void IDAFLCICMKD(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1228f, 1);
			...
			if (mineAmmo != null)
			{
				mineAmmo.AOANMLBFHJA().BBJADAJPJHH("Player_Avoided_Grenade_On_First_Try", false);
			}
			else
			{
	...
	public virtual void NIODJFGIJNN(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1550f, 1);
			Mine cOHKHNALDPH = playerController.weaponInventory.COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.JHEBMKKODAE().JCJFMHGNIOF("#DANIEL# New Assignemnts Claimed Arrived: ", false, true);
			}
			else
			{
	...
	public virtual void IDLKDDEEALI(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 318f, 1);
			Mine cOHKHNALDPH = playerController.BEIIOAIJMFK().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.cardIconIndicator.FJILILFMPIF("Assignment: Error, task definition not found for id = ", true);
			}
			else
			{
	...
	public virtual void FEJKPDNPNOA(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1408f, 0);
			...
			if (mineAmmo != null)
			{
				mineAmmo.GDBDMFCEGIB().FJILILFMPIF("ID_READYTIME", false);
			}
			else
			{
	...
	public virtual void JPCPJELCHDA(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1126f, 1);
			Mine cOHKHNALDPH = playerController.weaponInventory.COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.AOANMLBFHJA().LJLDJOHAAMC("alwaysShittyPerformance", true);
			}
			else
			{
	...
	public virtual void DCGABENHDBH(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 34f, 0);
			Mine cOHKHNALDPH = playerController.JLMDEMFIHCA().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.IFKEKKPFIEF().LDGKPCDJPLA("country-england", true);
			}
			else
			{
	...
	public virtual void PDBKDBLENIG(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1387f, 0);
			Mine cOHKHNALDPH = playerOld.weaponInventory.COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.cardIconIndicator.LDGKPCDJPLA("Twitch", false, true);
			}
			else
			{
	...
	public virtual void JIHHEBGMCBB(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 544f, 0);
			Mine cOHKHNALDPH = playerController.weaponInventory.COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.IFKEKKPFIEF().NNPILDOKNJO("Gold", false);
			}
			else
			{
	...
	public virtual void JCCNJNMBKBO(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1214f, 0);
			Mine cOHKHNALDPH = playerController.BEIIOAIJMFK().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.AIDNEPBELFP().LJLDJOHAAMC("ID_WARNING_SERVERTIMEDOUT", false, true);
			}
			else
			{
	...
	public virtual void IHPNEPEBKCP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 627f, 1);
			...
			if (mineAmmo != null)
			{
				mineAmmo.GDBDMFCEGIB().GKAOMCGCDGE("AccountId", false);
			}
			else
			{
	...
	public virtual void NPNDHFIMPHE(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 255f, 0);
			Mine cOHKHNALDPH = playerController.FMKGGADDHJK().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.AIDNEPBELFP().OFPAGLLFPPK("ID_TIERX", false);
			}
			else
			{
	...
	public virtual void KKEPLAFJKOO(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 459f, 1);
			Mine cOHKHNALDPH = playerController.JLMDEMFIHCA().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.GDBDMFCEGIB().GGHDIAFACAH("Skipping instant battle notification", false, true);
			}
			else
			{
	...
	public override void UseCard(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 10f, 1);
			Mine cOHKHNALDPH = playerOld.weaponInventory.COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.cardIconIndicator.Show("game-card-ico-mineyourstep-full", true);
			}
			else
			{
	...
	public virtual void EKFKAICCHLI(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 519f, 1);
			Mine cOHKHNALDPH = playerController.weaponInventory.COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.AOANMLBFHJA().PEBHGOMEKME("SERVICE_VERSION_UPDATE_REQUIRED", true);
			}
			else
			{
	...
	public virtual void MLOJPAEBLBL(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1436f, 0);
			...
			if (mineAmmo != null)
			{
				mineAmmo.IFKEKKPFIEF().Show("Sniper_Tutorial_Played", true);
			}
			else
			{
	...
	public virtual void LEEFEJHDLGM(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1247f, 0);
			Mine cOHKHNALDPH = playerController.weaponInventory.COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.MMCLHGEGOJO().NNPILDOKNJO("ID_CONFIRM_ERROR", true, true);
			}
			else
			{
	...
	public virtual void IOKJMNMABHC(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1290f, 0);
			Mine cOHKHNALDPH = playerController.FMKGGADDHJK().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.AOANMLBFHJA().GGHDIAFACAH("ID_MISSION_UNITS_HUD", false);
			}
			else
			{
	...
	public virtual void LLMMIFJBLBD(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1002f, 1);
			Mine cOHKHNALDPH = playerController.weaponInventory.COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.MMCLHGEGOJO().OFPAGLLFPPK("Player_Avoided_Grenade_On_First_Try", false, true);
			}
			else
			{
	...
	public virtual void OFNENBNMMOO(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1197f, 0);
			Mine cOHKHNALDPH = playerOld.JLMDEMFIHCA().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.cardIconIndicator.JCJFMHGNIOF("ID_UNIT2TRAIN_UNIT1TRAIN", true, true);
			}
			else
			{
	...
	public virtual void EOODECJEMIE(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1051f, 1);
			...
			if (mineAmmo != null)
			{
				mineAmmo.JHEBMKKODAE().EOEDEJKJKMN(" abilityIcon:", true);
			}
			else
			{
	...
	public virtual void ACIOLBGILBP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 879f, 0);
			Mine cOHKHNALDPH = playerController.weaponInventory.COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.JHEBMKKODAE().JCJFMHGNIOF("ID_ARENARULES_RANDOMUNITS", true);
			}
			else
			{
	...
	public virtual void BHBDBJNOCMP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1696f, 1);
			Mine cOHKHNALDPH = playerController.weaponInventory.COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.IFKEKKPFIEF().Show("{0:D2}:{1:D2}", false);
			}
			else
			{
	...
	public virtual void BEDOCBBEGAK(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 264f, 0);
			Mine cOHKHNALDPH = playerController.FMKGGADDHJK().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.MMCLHGEGOJO().EOEDEJKJKMN("throw_grenade_left", true);
			}
			else
			{
				Debug.LogError("_#");
	...
	public virtual void LCHBPLMPGJP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1030f, 1);
			Mine cOHKHNALDPH = playerController.FMKGGADDHJK().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.AIDNEPBELFP().JCJFMHGNIOF("!!!!", true);
			}
			else
			{
	...
	public virtual void BDLHMMDHGMP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1712f, 0);
			Mine cOHKHNALDPH = playerController.weaponInventory.COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.IFKEKKPFIEF().Show("Automatic_Equip", true);
			}
			else
			{
	...
	public virtual void NLPMJPNEEOM(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1113f, 1);
			...
			if (mineAmmo != null)
			{
				mineAmmo.IFKEKKPFIEF().PEBHGOMEKME("ExplodeDamage", true);
			}
			else
			{
	...
	public virtual void BGLMKFDPDNB(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1669f, 1);
			Mine cOHKHNALDPH = playerController.FMKGGADDHJK().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.AOANMLBFHJA().GGHDIAFACAH("ID_NOTIFICATION_LAPSED_VIP", true, true);
			}
			else
			{
	...
	public virtual void MLEBPBFEOKC(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 645f, 0);
			Mine cOHKHNALDPH = playerController.FMKGGADDHJK().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.AIDNEPBELFP().PEBHGOMEKME("ID_EARLYUNLOCK2", false);
			}
			else
			{
	...
	public virtual void AGMKIMGHPAL(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 441f, 1);
			Mine cOHKHNALDPH = playerOld.JLMDEMFIHCA().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.AOANMLBFHJA().BIIHCAEKCOD("registerBirthday", false);
			}
			else
			{
	...
	public virtual void FHPAJBONKON(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1247f, 1);
			Mine cOHKHNALDPH = playerController.JLMDEMFIHCA().COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.cardIconIndicator.NNPILDOKNJO("DatabaseMessage - No long existing database message came from server!", false, true);
			}
			else
			{
	...
	public virtual void PFLGKCELNOM(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		{
			NavMeshHit hit;
			NavMesh.SamplePosition(item.transform.position, out hit, 1269f, 1);
			Mine cOHKHNALDPH = playerController.weaponInventory.COHKHNALDPH;
			...
			if (mineAmmo != null)
			{
				mineAmmo.cardIconIndicator.GGHDIAFACAH("ID_SALEPERCENTLINE", true);
			}
			else
			{
				Debug.LogError("{0} {1}");
