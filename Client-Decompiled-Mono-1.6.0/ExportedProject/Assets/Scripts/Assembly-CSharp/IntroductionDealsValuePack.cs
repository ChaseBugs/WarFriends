...
public class IntroductionDealsValuePack : IntroductionDealsItem
{
	...
	{
		GuiElementSingle<PackContentDialog>.instance.OHJEIGCJCLL(Singleton<GameVariables>.instance.KLMNEOAKMFB(), true);
	}
	...
	{
		GuiElementSingle<PackContentDialog>.instance.ShowDialog(Singleton<GameVariables>.instance.KLMNEOAKMFB(), true);
	}
	...
	{
		GuiElementSingle<PackContentDialog>.instance.MCCJIJKCOOH(Singleton<GameVariables>.instance.HFJGOIGLPCF(), true);
	}

	private void FABBPOFEHPL(GameObject KHAHPAKDIKE)
	{
		GuiElementSingle<PackContentDialog>.instance.ShowDialog(Singleton<GameVariables>.instance.BJDKLOCBNOJ(), true);
	}
	...
	{
		GuiElementSingle<PackContentDialog>.instance.KNBIBOINAKG(Singleton<GameVariables>.instance.HFJGOIGLPCF(), true);
	}
