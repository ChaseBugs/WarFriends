...
public class StarterAssignmentsManager : DatabaseSerializedObjectGeneric<StarterAssignmentsManager.StarterAssignmentsData>
{
	...
	public List<StarterAssignment> assignments
	{
		get
		{
			return mAssignments;
	...
	public bool isActive
	{
		get
		{
			return data.deadline > Singleton<BeanstalkServerManager>.instance.currentTimestamp;
		}
	}
	...
	public bool isAllCompleted
	{
		get
		{
			return assignments.Count != 0 && assignments[assignments.Count - 1].claimed;
		}
	}

	public bool isActiveAndNotCompleted
	{
		get
		{
			return isActive && !isAllCompleted;
		}
	}

	public bool isWBReward
	{
		get
		{
			return isActiveAndNotCompleted && currentAssignment.rewardWB > 0;
		}
	}
	...
	public int remainingTime
	{
		get
		{
			return Mathf.Max(data.deadline - Singleton<BeanstalkServerManager>.instance.currentTimestamp, 0);
		}
	}
	...
	{
		StarterAssignmentsData.StarterAssignmentData value;
		if (data.assignments.TryGetValue(id, out value))
		{
			return value;
		}
