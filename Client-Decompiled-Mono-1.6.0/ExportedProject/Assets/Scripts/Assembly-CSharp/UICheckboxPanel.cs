...
public class UICheckboxPanel : MonoBehaviour
{
	...
	private void IKGFFMLLNJH()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(CKIPHOLOHLK.gameObject, PNAICLCIHKB, (!NGECHGNDLMJ()) ? ACMGFFCGAEE : NNGMEGGKPPL, false);
	...
	{
		KBIAJMBBGJG = KBIAJMBBGJG;
		TweenPosition tweenPosition = TweenPosition.Begin(CKIPHOLOHLK.gameObject, PNAICLCIHKB, (!NMNJOPFIBCO()) ? ACMGFFCGAEE : NNGMEGGKPPL, false);
	...
	{
		KBIAJMBBGJG = !KBIAJMBBGJG;
		TweenPosition tweenPosition = TweenPosition.Begin(CKIPHOLOHLK.gameObject, PNAICLCIHKB, (!IsOn) ? ACMGFFCGAEE : NNGMEGGKPPL, false);
	...
	public void KOBOBOPIAEO(bool IDEBKDPMPGM)
	{
		if (KBIAJMBBGJG != IDEBKDPMPGM)
		{
			...
			TweenPosition.Begin(CKIPHOLOHLK.gameObject, 1055f, (!NGECHGNDLMJ()) ? ACMGFFCGAEE : NNGMEGGKPPL, false);
			if (OIHDDKGHAMD != null && PGIBDMBINKI != null)
			{
	...
	{
		KBIAJMBBGJG = KBIAJMBBGJG;
		TweenPosition tweenPosition = TweenPosition.Begin(CKIPHOLOHLK.gameObject, PNAICLCIHKB, (!JGONOFABIKL()) ? ACMGFFCGAEE : NNGMEGGKPPL, false);
		tweenPosition.method = UITweener.Method.EaseInOut;
		if (PBFFPFBDEBM != null)
		{
			PBFFPFBDEBM(IsOn);
	...
	public void BMJFFFHPAJE(bool IDEBKDPMPGM)
	{
		if (KBIAJMBBGJG != IDEBKDPMPGM)
		{
			KBIAJMBBGJG = IDEBKDPMPGM;
			CKIPHOLOHLK.transform.localPosition = ((!HEPOKPKOFNF()) ? ACMGFFCGAEE : NNGMEGGKPPL);
			TweenPosition.Begin(CKIPHOLOHLK.gameObject, 1697f, (!EKMGFNIMKND()) ? ACMGFFCGAEE : NNGMEGGKPPL, false);
			if (OIHDDKGHAMD != null && PGIBDMBINKI != null)
			{
	...
	public void IONFPMLIAJM(bool IDEBKDPMPGM)
	{
		if (KBIAJMBBGJG != IDEBKDPMPGM)
		{
			KBIAJMBBGJG = IDEBKDPMPGM;
			CKIPHOLOHLK.transform.localPosition = ((!CJFOLFNNDBH()) ? ACMGFFCGAEE : NNGMEGGKPPL);
			TweenPosition.Begin(CKIPHOLOHLK.gameObject, 720f, (!IsOn) ? ACMGFFCGAEE : NNGMEGGKPPL, false);
			if (OIHDDKGHAMD != null && PGIBDMBINKI != null)
			{
	...
	{
		KBIAJMBBGJG = KBIAJMBBGJG;
		TweenPosition tweenPosition = TweenPosition.Begin(CKIPHOLOHLK.gameObject, PNAICLCIHKB, (!DDENGJAGFEP()) ? ACMGFFCGAEE : NNGMEGGKPPL, false);
		tweenPosition.method = (UITweener.Method)7;
		if (PBFFPFBDEBM != null)
		{
	...
	public void EHIELIGLIEM(bool IDEBKDPMPGM)
	{
		if (KBIAJMBBGJG != IDEBKDPMPGM)
		{
			KBIAJMBBGJG = IDEBKDPMPGM;
			CKIPHOLOHLK.transform.localPosition = ((!IsOn) ? ACMGFFCGAEE : NNGMEGGKPPL);
			TweenPosition.Begin(CKIPHOLOHLK.gameObject, 1928f, (!EKMGFNIMKND()) ? ACMGFFCGAEE : NNGMEGGKPPL, false);
			if (OIHDDKGHAMD != null && PGIBDMBINKI != null)
			{
