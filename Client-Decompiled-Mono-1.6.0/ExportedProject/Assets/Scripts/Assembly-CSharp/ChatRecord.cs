...
public class ChatRecord : PoolableObject
{
	...
	{
		CIFLFDMACKG.SetActive(false);
		NLMJJFKDHCM.SetActive(false);
		FNDAHHEOEFF.SetActive(false);
	...
	{
		FDDNPECPBEE.SetActive(true);
		OOJLGEIEFHM.SetActive(true);
		IOODGADNFEN = 1047f;
	}
	...
	public void PPMPHKKHLNB(Chat.PBGFEDGFOPG NDPMDKGJAFH)
	{
		...
		else
		{
			...
			NDPMDKGJAFH.OJIANBAINDD.KINBBAFNJPG(true);
		}
	}
	...
	private void HBNDMLACBCJ(GameObject KHAHPAKDIKE)
	{
		if (!string.IsNullOrEmpty(FEIEGFFHJOG.MHPNDNJDPGE))
		{
			...
			GuiElementSingle<PlayerProfileDialog>.instance.EGLMNBKMBAM(FEIEGFFHJOG.MHPNDNJDPGE, FEIEGFFHJOG.EJBEDLHIKDG, false);
		}
	}
	...
	private void NEEPBGKJACK(GameObject KHAHPAKDIKE)
	{
		if (!string.IsNullOrEmpty(FEIEGFFHJOG.MHPNDNJDPGE))
		{
			...
			SoundsManager.Instance.PlayButtonClickedSound();
			GuiElementSingle<PlayerProfileDialog>.instance.ShowDialog(FEIEGFFHJOG.MHPNDNJDPGE, FEIEGFFHJOG.EJBEDLHIKDG, false);
		}
	}
	...
	public void InitializeForHeightOnly(Chat.PBGFEDGFOPG NDPMDKGJAFH)
	{
		...
		MHKKGFOEDOE(NDPMDKGJAFH.FOJAKFBCBPI == Chat.JMMPILGNALE.Message, false);
	}
	...
	{
		CIFLFDMACKG.SetActive(true);
		NLMJJFKDHCM.SetActive(true);
		FNDAHHEOEFF.SetActive(true);
	...
	private void MKGHHGEDHFB(GameObject KHAHPAKDIKE)
	{
		if (FEIEGFFHJOG.LIAFEPFJAKM != null && !string.IsNullOrEmpty(FEIEGFFHJOG.LIAFEPFJAKM.name))
		{
			...
			SoundsManager.Instance.PlayButtonClickedSound();
			GuiElementSingle<PlayerProfileDialog>.instance.EGLMNBKMBAM(FEIEGFFHJOG.LIAFEPFJAKM.name, FEIEGFFHJOG.LIAFEPFJAKM.id, false);
		}
	}
	...
	private void LLEAICGKPOL(GameObject KHAHPAKDIKE)
	{
		if (FEIEGFFHJOG.LIAFEPFJAKM != null && !string.IsNullOrEmpty(FEIEGFFHJOG.LIAFEPFJAKM.name))
		{
			...
			SoundsManager.Instance.PlayButtonClickedSound();
			GuiElementSingle<PlayerProfileDialog>.instance.ShowDialog(FEIEGFFHJOG.LIAFEPFJAKM.name, FEIEGFFHJOG.LIAFEPFJAKM.id, false);
		}
	}
	...
	public void MJCKPJPBDHE(Chat.PBGFEDGFOPG NDPMDKGJAFH)
	{
		...
		FLPDHCHEEFC(NDPMDKGJAFH.FOJAKFBCBPI == Chat.JMMPILGNALE.Timer, false);
	}
	...
	private void NNKCDCEIPLB(GameObject KHAHPAKDIKE)
	{
		if (!string.IsNullOrEmpty(FEIEGFFHJOG.MHPNDNJDPGE))
		{
			...
			SoundsManager.Instance.PlayButtonClickedSound();
			GuiElementSingle<PlayerProfileDialog>.instance.CMOEFABLABI(FEIEGFFHJOG.MHPNDNJDPGE, FEIEGFFHJOG.EJBEDLHIKDG, false);
		}
	}
	...
	public void MFIOFBJNELO(Chat.PBGFEDGFOPG NDPMDKGJAFH)
	{
		...
		JBADFANJJJP(NDPMDKGJAFH.FOJAKFBCBPI == Chat.JMMPILGNALE.Message, false);
	}
	...
	public void PLMCDKCDDKF(Chat.PBGFEDGFOPG NDPMDKGJAFH)
	{
		...
		else
		{
			...
			NDPMDKGJAFH.OJIANBAINDD.MFDNOBJDPDH(true);
		}
	}
	...
	public void CBLAPPHFDLB(Chat.PBGFEDGFOPG NDPMDKGJAFH)
	{
		...
		{
			IJDKENMPLIM(NDPMDKGJAFH.NBKCKIELMLK, NDPMDKGJAFH.EHLJCGEFAOL, NDPMDKGJAFH.LIAFEPFJAKM);
			NDPMDKGJAFH.OJIANBAINDD.HDMCKAMIMGM(false);
		}
	}
	...
	public void PLJJDOGILDG(Chat.PBGFEDGFOPG NDPMDKGJAFH)
	{
		...
		else
		{
			...
			NDPMDKGJAFH.OJIANBAINDD.ACCCCDEAFPP(false);
		}
	}
