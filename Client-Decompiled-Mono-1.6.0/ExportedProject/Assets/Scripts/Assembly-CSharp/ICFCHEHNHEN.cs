...
public class ICFCHEHNHEN : HHFHFANGCEJ
{
	...
	internal virtual Action KBNHKIHOGLD(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC.EKIPHEGKCGO(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, true, EMLLELGLJNO == GameController.ELDLECMNIME.DeathMatch, this);
	...
	internal virtual Action ENDLLPNJJEJ(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC = HDEGOGFCNAC;
		nHBOAPLIPNP.BJGCPDNMHDH = this;
		nHBOAPLIPNP.HDEGOGFCNAC.EKIPHEGKCGO(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, false, EMLLELGLJNO == GameController.ELDLECMNIME.DeathMatch, this);
	...
	public override void IMDBPLNFIKD()
	{
		...
		{
			Debug.Log(string.Format("Show {0} invitation dialog id: {1}", EMLLELGLJNO, NHHGDIDEIMM));
			DCEOEJIEFAH();
		}
		else
		{
	...
	internal virtual Action DJOHJFOHPAF(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC = HDEGOGFCNAC;
		nHBOAPLIPNP.BJGCPDNMHDH = this;
		nHBOAPLIPNP.HDEGOGFCNAC.EKIPHEGKCGO(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, false, EMLLELGLJNO == (GameController.ELDLECMNIME)1, this);
	...
	internal virtual Action BDKMGBLJKLJ(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC = HDEGOGFCNAC;
		nHBOAPLIPNP.BJGCPDNMHDH = this;
		nHBOAPLIPNP.HDEGOGFCNAC.EKIPHEGKCGO(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, true, EMLLELGLJNO == GameController.ELDLECMNIME.Campaign, this);
		return nHBOAPLIPNP.LJCDGJKCNEC;
	}
	...
	internal virtual Action GBFDOFLHHNA(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC = HDEGOGFCNAC;
		nHBOAPLIPNP.BJGCPDNMHDH = this;
		nHBOAPLIPNP.HDEGOGFCNAC.OPFABOGIICI(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, false, EMLLELGLJNO == GameController.ELDLECMNIME.Coop, this);
		return nHBOAPLIPNP.FIBGJHCGHJH;
	}
	...
	internal virtual Action INCNCFNCILK(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC = HDEGOGFCNAC;
		nHBOAPLIPNP.BJGCPDNMHDH = this;
		nHBOAPLIPNP.HDEGOGFCNAC.OPFABOGIICI(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, true, EMLLELGLJNO == (GameController.ELDLECMNIME)5, this);
		return nHBOAPLIPNP.LJCDGJKCNEC;
	}
	...
	internal virtual Action KLCMAALPAKG(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC = HDEGOGFCNAC;
		nHBOAPLIPNP.BJGCPDNMHDH = this;
		nHBOAPLIPNP.HDEGOGFCNAC.SetAppearance_Challenge(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, true, EMLLELGLJNO == (GameController.ELDLECMNIME.Campaign | GameController.ELDLECMNIME.Coop), this);
	...
	internal virtual Action DKIMCJONFDB(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC = HDEGOGFCNAC;
		nHBOAPLIPNP.BJGCPDNMHDH = this;
		nHBOAPLIPNP.HDEGOGFCNAC.OPFABOGIICI(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, false, EMLLELGLJNO == (GameController.ELDLECMNIME)0, this);
		return nHBOAPLIPNP.NNIJEDKBPGJ;
	}
	...
	internal virtual Action JCMGPABOPLE(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC = HDEGOGFCNAC;
		nHBOAPLIPNP.BJGCPDNMHDH = this;
		nHBOAPLIPNP.HDEGOGFCNAC.EKIPHEGKCGO(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, false, EMLLELGLJNO == (GameController.ELDLECMNIME)5, this);
	...
	internal virtual Action GCDJEALIMEC(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC = HDEGOGFCNAC;
		nHBOAPLIPNP.BJGCPDNMHDH = this;
		nHBOAPLIPNP.HDEGOGFCNAC.SetAppearance_Challenge(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, false, EMLLELGLJNO == GameController.ELDLECMNIME.Campaign, this);
		return nHBOAPLIPNP.FIBGJHCGHJH;
	}
	...
	internal virtual Action CKLKCKBLEGA(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC = HDEGOGFCNAC;
		nHBOAPLIPNP.BJGCPDNMHDH = this;
		nHBOAPLIPNP.HDEGOGFCNAC.FJEEAOJFKMI(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, false, EMLLELGLJNO == GameController.ELDLECMNIME.Campaign, this);
		return nHBOAPLIPNP.LJCDGJKCNEC;
	}
	...
	internal virtual Action PKGCMKFOOOA(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC = HDEGOGFCNAC;
		nHBOAPLIPNP.BJGCPDNMHDH = this;
		nHBOAPLIPNP.HDEGOGFCNAC.FJEEAOJFKMI(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, true, EMLLELGLJNO == (GameController.ELDLECMNIME)7, this);
		return nHBOAPLIPNP.FIBGJHCGHJH;
	}
	...
	internal override Action HDCCFKAHHOP(MessageCenterRecord HDEGOGFCNAC)
	{
		...
		nHBOAPLIPNP.HDEGOGFCNAC = HDEGOGFCNAC;
		nHBOAPLIPNP.BJGCPDNMHDH = this;
		nHBOAPLIPNP.HDEGOGFCNAC.SetAppearance_Challenge(HPGHHECHLAN, KJCKFGCLGLG, NCFFGKHPJLH, false, EMLLELGLJNO == GameController.ELDLECMNIME.Coop, this);
		return nHBOAPLIPNP.LJCDGJKCNEC;
	}
