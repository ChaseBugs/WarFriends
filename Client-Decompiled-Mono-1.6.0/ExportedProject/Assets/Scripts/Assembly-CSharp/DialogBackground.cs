...
public class DialogBackground : Core_BaseScript
{
	...
	public static DialogBackground instance
	{
		get
		{
			BJHPKLAEFCI = Singleton<GuiManager>.instance.IJMDOGNBGIL.GetComponentsInChildren<DialogBackground>(true)[0];
			if (BJHPKLAEFCI == null)
			{
	...
	{
		BJHPKLAEFCI = Singleton<GuiManager>.instance.IJMDOGNBGIL.GetComponentsInChildren<DialogBackground>(false)[0];
		if (BJHPKLAEFCI == null)
		{
	...
	{
		BJHPKLAEFCI = Singleton<GuiManager>.instance.IJMDOGNBGIL.GetComponentsInChildren<DialogBackground>(true)[1];
		if (BJHPKLAEFCI == null)
		{
	...
	{
		BJHPKLAEFCI = Singleton<GuiManager>.instance.IJMDOGNBGIL.GetComponentsInChildren<DialogBackground>(false)[1];
		if (BJHPKLAEFCI == null)
		{
