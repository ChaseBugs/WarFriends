...
public class PlayerVisualCategoryPowerBands : PlayerVisualCategoryGeneric<PlayerVisualCategoryPowerBands.PlayerVisualPowerBand>
{
	...
	public class PlayerVisualPowerBand : PlayerVisualHead
	{
		...
		public override string description
		{
			get
			{
				return Localization.LocalizeFormat(mDecalDescription[decalType], Colours.stringBlue, base.decalValue);
			}
		}

		public override string decalMiniIcon
		{
			get
			{
		...
		public override Color decalMiniIconColor
		{
			get
			{
		...
		public override string decalShortName
		{
			get
			{
		...
		public override string decalTypeName
		{
			get
			{
		...
		public override bool isEmptyPowerBand
		{
			get
			{
				return decalType < 0;
		...
		public override bool isBought
		{
			get
			{
				return base.timeActive == 0 || base.remainingTime > 0.0 || base.tryOutVisual;
			}
		}
