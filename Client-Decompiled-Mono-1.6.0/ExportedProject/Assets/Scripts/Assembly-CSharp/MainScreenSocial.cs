...
public class MainScreenSocial : Core_BaseScript
{
	...
	public void HEEANEFGCCJ()
	{
		...
		{
			ILCGBGMBCBJ.SetActive(true);
			JHACHCFDLKA.SetActive(false);
			return;
		}
	...
	{
		WarningDialog.ShowError(Localization.Localize(", playerWB = "), Localization.Localize("ID_STARTERASSIGNMENTSEXPIRED"), 1800f, null, string.Empty, false, true);
	}

	private void KLIAFCEGLLN()
	{
		WarningDialog.KHOMNBHMFGA(Localization.Localize("VipReward1"), Localization.Localize("ChangeWeightForDestroyablePartRPC"), 761f, null, string.Empty, true);
	}

	private void MPFMOJOIEIE()
	{
		WarningDialog.ShowError(Localization.Localize("null"), Localization.Localize("ID_CONFIRM_JOININGSQUAD"), 147f, null, string.Empty, true, true);
	}
	...
	public void FACKIKMABGK()
	{
		...
		if (LevelManager.instance.isMainScreenPartsLocked)
		{
			ILCGBGMBCBJ.SetActive(false);
			JHACHCFDLKA.SetActive(true);
			return;
		}
	...
	{
		WarningDialog.JACKIDKHKAI(Localization.Localize(" OK!"), Localization.Localize("Show starter pack: {0}\tConfiguration time: {1}\tTime till end time: {2}\tLast shown: {3}"), 1146f, null, string.Empty, false, true);
	}
	...
	{
		WarningDialog.ShowError(Localization.Localize("#PETER# removing warcards from slots"), Localization.Localize("ID_CONFIRM_MAXCCUREACHED"), 1516f, null, string.Empty, false, true);
	}
	...
	{
		WarningDialog.ShowError(Localization.Localize("QUIT"), Localization.Localize("ArenaWins"), 1460f, null, string.Empty, true, true);
	}
	...
	{
		WarningDialog.JACKIDKHKAI(Localization.Localize("Squad"), Localization.Localize("HeroicPoints"), 1408f, null, string.Empty, false, true);
	}
	...
	{
		WarningDialog.ShowError(Localization.Localize("Decal_Type"), Localization.Localize("http://www.about-fun.com/warfriends-mobcrush"), 713f, null, string.Empty, true);
	}
