...
public class UnitModelLoader : Core_BaseScript
{
	...
	public virtual void FOMMKOFKLMD(GameObject NBHFGEAPACG)
	{
		if (NBHFGEAPACG != null)
		{
			MeshFilter[] componentsInChildren = NBHFGEAPACG.GetComponentsInChildren<MeshFilter>(false);
			foreach (MeshFilter item in KIILDOGHBAI)
			{
		...
		SkinnedMeshRenderer[] componentsInChildren2 = NBHFGEAPACG.GetComponentsInChildren<SkinnedMeshRenderer>(false);
		foreach (SkinnedMeshRenderer item2 in BKKHCIHKEAA)
		{
	...
	public virtual void MALPIDBEMAK(GameObject NBHFGEAPACG)
	{
		if (NBHFGEAPACG != null)
		{
			MeshFilter[] componentsInChildren = NBHFGEAPACG.GetComponentsInChildren<MeshFilter>(true);
			foreach (MeshFilter item in KIILDOGHBAI)
			{
				string text = item.name;
				MeshFilter[] array = componentsInChildren;
		...
		SkinnedMeshRenderer[] componentsInChildren2 = NBHFGEAPACG.GetComponentsInChildren<SkinnedMeshRenderer>(true);
		foreach (SkinnedMeshRenderer item2 in BKKHCIHKEAA)
		{
			string text2 = item2.name;
			SkinnedMeshRenderer[] array2 = componentsInChildren2;
