...
public class MiniDrone : MainGameEntity
{
	...
	protected override void Update()
	{
		...
		if (FEHCCGEGPLH.isMine && (int)Time.time > IAGLMAMNMFH)
		{
			...
			if (transporterToRepair != null)
			{
				...
				transporterToRepair.destroyableObj.Heal(transporterToRepair.destroyableObj.maxHealth * num, false);
			}
		}
	}
	...
	protected virtual void GPLKEOAHFJI()
	{
		...
		if (FEHCCGEGPLH.isMine && (int)Time.time > IAGLMAMNMFH)
		{
			...
			{
				float num = repairRatioPerSec;
				transporterToRepair.destroyableObj.LNPKAAGJIGO(transporterToRepair.destroyableObj.maxHealth * num, true);
			}
		}
	}
