...
public class CardDisarmedAndLocked : Card
{
	...
	public float buffTime
	{
		get
		{
			return Singleton<GameVariables>.instance.cardConstants.GetRow(CardConstants.rowIds.DisarmedTime).FLOATVALUE;
		}
	}
	...
	public override string description
	{
		get
		{
			return Localization.LocalizeFormat(mDescriptionID, MEJMLNDFDBP.AIPKMDCJCOG(buffTime));
		}
	}
	...
	protected void IAPBHPLNNNO()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 1010f;
				NNDMKIACBBM = true;
				MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("http://", false, true);
			}
		}
	}
	...
	protected void NHEOMLPEBLC()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 24f;
				NNDMKIACBBM = false;
				MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH("OnRestartDrawing", false);
			}
		}
	}
	...
	protected void PKPIMPKNFJJ()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 688f;
				NNDMKIACBBM = false;
				MBIAKMPDOPG.cardIconIndicator.BIIHCAEKCOD("setRewardedVideoUserID", false, true);
			}
		}
	}
	...
	public virtual void ENAEPBAOONK(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH("Action ", false, true);
	}
	...
	protected void GFPPJNOENLE()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 718f;
				NNDMKIACBBM = true;
				MBIAKMPDOPG.cardIconIndicator.PEBHGOMEKME("starter", false);
			}
		}
	}
	...
	protected void LIMHNKKJODK()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 1131f;
				NNDMKIACBBM = false;
				MBIAKMPDOPG.cardIconIndicator.Show("N", true);
			}
		}
	}
	...
	protected void BBCOBMGHMGE()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 14f;
				NNDMKIACBBM = false;
				MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("100+.", true, true);
			}
		}
	}
	...
	protected void OFNEGNKMKKG()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 73f;
				NNDMKIACBBM = false;
				MBIAKMPDOPG.cardIconIndicator.EOEDEJKJKMN("Country", true);
			}
		}
	}
	...
	public virtual void CGALPALBIDJ(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("S", true);
	}
	...
	public virtual void OAJHAPCNJML(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.BIIHCAEKCOD("ID_ZEROSECONDS", true, true);
	}
	...
	public virtual void AEDODFGIJLN(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH("ChangeWeapon", true, true);
	}
	...
	public virtual void HLCFNFCMGFD(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.LJLDJOHAAMC("DogTagCap", true, true);
	}
	...
	protected void KBKILDENNLM()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 1063f;
				NNDMKIACBBM = false;
				MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("Action ", true);
			}
		}
	}
	...
	public virtual void CBJDBAKNBAG(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH("Player disconected 0002", false, true);
	}
	...
	protected void MNFDMKFLAKO()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 672f;
				NNDMKIACBBM = true;
				MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("ID_BRONZEPACK", true, true);
			}
		}
	}
	...
	public override void UseCardOnline(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-disarmed", true);
	}
	...
	public virtual void HLBAHDMEALA(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = CLJBDOPFJFJ();
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH("Start TUNE SDK clicked", true);
	}
	...
	protected void JBGDAOIDBGF()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 1855f;
				NNDMKIACBBM = true;
				MBIAKMPDOPG.cardIconIndicator.OFPAGLLFPPK("menu-assignments-bar-gold", true);
			}
		}
	}
	...
	public virtual void IFHKCJGBDAN(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("ID_READYTIME", false, true);
	}
	...
	public virtual void NHMADLLGPLC(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("game-card-ico-bulletsponge-full", false);
	}
	...
	protected void MGKCNLDGNEM()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 70f;
				NNDMKIACBBM = false;
				MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("MissionReward", false);
			}
		}
	}
	...
	public virtual void JEHJMHHHOCE(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = CCCNNJFKNNK();
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("Player_Had_To_Select_Grenade", false, true);
	}
	...
	public virtual void GJCKHJLEPKG(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = LOMIJKLEDIJ();
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("Manual_Unit_Spawn", false);
	}
	...
	protected void MGAIKDBOPKI()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 1219f;
				NNDMKIACBBM = true;
				MBIAKMPDOPG.cardIconIndicator.EOEDEJKJKMN("ID_REMINDER_YOURVIPMEMBERSHIP", false, true);
			}
		}
	}
	...
	protected void CJAHPFMAMKK()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 1723f;
				NNDMKIACBBM = true;
				MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("Problem for max! in army/weapon stats", true, true);
			}
		}
	}
	...
	protected void DIOAOBFDPMH()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 1940f;
				NNDMKIACBBM = true;
				MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("game-elite-debuff", false, true);
			}
		}
	}
	...
	protected void HDLDMGEFCEJ()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 756f;
				NNDMKIACBBM = true;
				MBIAKMPDOPG.cardIconIndicator.LDGKPCDJPLA("Player_Rank", false);
			}
		}
	}
	...
	protected void Update()
	{
		if (NNDMKIACBBM)
		{
			...
			else
			{
				...
				BHABHIDDBLH = 0f;
				NNDMKIACBBM = false;
				MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-disarmed", false);
			}
		}
	}
	...
	public virtual void KNEKFCFPHBK(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.PEBHGOMEKME("| time: ", true, true);
	}
}
