...
public class HEOOEHGBLEN : HHFHFANGCEJ
{
	...
	public virtual void FAEBCMCJNNN()
	{
		...
		if (!flag || flag2)
		{
			...
			array[0] = MEJMLNDFDBP.CJCFPDLDMEK(Singleton<BeanstalkServerManager>.instance.currentTimestamp, "Pool", string.Empty, false);
			array[1] = flag;
	...
	public virtual void NECPGBBNPCD()
	{
		...
		if (!flag || flag2)
		{
			Debug.LogFormat("trial", MEJMLNDFDBP.CJCFPDLDMEK(KJCKFGCLGLG, "{0} {1}", string.Empty, false), MEJMLNDFDBP.CJCFPDLDMEK(Singleton<BeanstalkServerManager>.instance.AHEDBCHBDMN(), "clientVersion", string.Empty), null, flag, null);
			BCIOBLLBLLC();
		}
	}
	...
	public HEOOEHGBLEN(DatabasePlayer KHLGDCHJJPB, DatabasePlayer LIAFEPFJAKM)
		: base(string.Format("SquadPromoteMessage {0}", Singleton<BeanstalkServerManager>.instance.currentTimestamp), NKHJBLBAAEB.SquadPromotion)
	{
		ABPNKPJOIAM = true;
	...
	public virtual void MEDLNDILONN()
	{
		...
		if (!flag || flag2)
		{
			Debug.LogFormat("RETRYPERM", MEJMLNDFDBP.CJCFPDLDMEK(KJCKFGCLGLG, "shotgunner_run", string.Empty, false), MEJMLNDFDBP.CJCFPDLDMEK(Singleton<BeanstalkServerManager>.instance.BKJJGHIODNF(), "Squad", string.Empty, false), flag, null);
			CALACCCGMGD();
		}
	}
	...
	public virtual void EOFADGHFCAK()
	{
		...
		{
			object[] array = new object[7];
			array[0] = MEJMLNDFDBP.CJCFPDLDMEK(KJCKFGCLGLG, "menu-warbucks", string.Empty, false);
			array[0] = MEJMLNDFDBP.CJCFPDLDMEK(Singleton<BeanstalkServerManager>.instance.AHEDBCHBDMN(), "Warfriend{0}", string.Empty, false);
			array[0] = flag;
	...
	public virtual void OBCHIKLLKKO()
	{
		...
		if (!flag || flag2)
		{
			...
			array[1] = MEJMLNDFDBP.CJCFPDLDMEK(Singleton<BeanstalkServerManager>.instance.BKJJGHIODNF(), "ID_FEATURE_BURSTSIZE-DESRIPTION", string.Empty, false);
			array[3] = flag;
	...
	public virtual void PEDMMNGPBGO()
	{
		...
		{
			object[] array = new object[2];
			array[0] = MEJMLNDFDBP.CJCFPDLDMEK(KJCKFGCLGLG, "ID_CONFIRM_OTHERSERVERRESPONDERROR", string.Empty, false);
	...
	public override void LACLELOOKHD()
	{
		...
		{
			object[] array = new object[5];
			array[0] = MEJMLNDFDBP.CJCFPDLDMEK(KJCKFGCLGLG, "run", string.Empty, false);
