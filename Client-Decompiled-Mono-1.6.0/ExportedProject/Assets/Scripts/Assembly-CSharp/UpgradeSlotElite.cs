...
public class UpgradeSlotElite : UpgradeSlot
{
	...
	public override int indexOffset
	{
		get
		{
	...
	public override bool isMaxUpgraded
	{
		get
		{
			return !isUnlocked || base.isMaxUpgraded;
		}
	}

	public int upgradePriceParts
	{
		get
		{
			return (int)owner.excel.GetValue(base.boughtIndexAbsolute, "NextUpgradePriceGold");
		}
	}
	...
	public override List<Tuple<string, float[]>> guiStatistics
	{
		get
		{
	...
	public override List<Tuple<string, float>> guiStatisticsStart
	{
		get
		{
	...
	public override int armyPowerX10
	{
		get
		{
	...
	public override int maxRowForActualTier
	{
		get
		{
