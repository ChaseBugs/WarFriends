...
public class MHEHGPLIFHF
{
	...
	public static void FBGJBBHFENO(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-23):
		{
			...
			WarningDialog.ShowError(Localization.Localize("{0} / [FECA21]{1}"), Localization.Localize("deviceName"), 1017f, null, string.Empty, true, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		case (IJEAJGCCHEF)188:
		{
			...
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, text);
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("SoldierHP"), Localization.Localize("Request Finished with Error! "), 1100f, null, string.Empty, true);
			break;
		}
		case (IJEAJGCCHEF)(-21):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "\"NEGINFINITY\"");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["\"NaN\""], 1);
			object[] array = new object[0];
			array[0] = num;
			WarningDialog.JACKIDKHKAI(Localization.LocalizeFormat("BeginnersLeague", array), Localization.Localize("libraryVersion"), 958f, null, string.Empty, true, true);
			break;
		}
		}
	}
	...
	public static void CJNAAOJMHOM(Dictionary<string, object> EENKJBCCPBG)
	{
		...
		Singleton<EventTrackingManager>.instance.VideoUploaded(false, text);
	...
	public static void DAJCCCBFDFG(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-157):
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.Localize("Session_start"), Localization.Localize("]"), 520f, null, string.Empty, true);
			break;
		}
		case (IJEAJGCCHEF)123:
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "stickers");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["Automatic_Equip"]);
			object[] array = new object[0];
			array[0] = num;
			WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("game-card-ico-bulletsponge-full", array), Localization.Localize("StartTime"), 1032f, null, string.Empty, false, true);
			break;
		}
		}
	}
	...
	public static void GOFFAOPEGAP(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)26:
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("ID_INVITEDYOUTOCOOP"), Localization.Localize("ID_CONFIRM_SUBSCRIPTION_TEXT"), 316f, null, string.Empty, true, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		...
		case (IJEAJGCCHEF)(-87):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "Cache: Removing ");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["GooglePlay"], 1);
			WarningDialog.ShowError(Localization.LocalizeFormat("App not installed", num), Localization.Localize(", "), 1507f, null, string.Empty, true);
			break;
		}
		}
	}
	...
	public static void OMANPLAFBKC(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)46:
		{
			...
			WarningDialog.ShowError(Localization.Localize("https://www.facebook.com/warfriendsgame/"), Localization.Localize("CONFIRM"), 1199f, null, string.Empty, false, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		case (IJEAJGCCHEF)49:
		{
			...
			WarningDialog.ShowError(Localization.Localize("ID_JOINSQUADDESCRIPTION3"), Localization.Localize("FinishGameMultiplayerRPC"), 764f, null, string.Empty, true, true);
			break;
		}
		case (IJEAJGCCHEF)(-92):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "registerEvent");
	...
	public static void KNCMJDBHMFB(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-110):
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("NO WAR ARENA CONFIG!!!"), Localization.Localize("elite2"), 1312f, null, string.Empty, true, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		...
		case (IJEAJGCCHEF)34:
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "_Color");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["SH: New message = "], 1);
			object[] array = new object[0];
			array[1] = num;
			WarningDialog.JACKIDKHKAI(Localization.LocalizeFormat(" TOTAL UNSUED RESERVED: ", array), Localization.Localize("game-card-ico-triggerhappy"), 1391f, null, string.Empty, true);
			break;
		}
		}
	}
	...
	public static void MDAPPNGJDJP(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-75):
		{
			...
			WarningDialog.ShowError(Localization.Localize("Loading assignment data after GAME!!"), Localization.Localize("qbz_reload"), 1931f, null, string.Empty, false, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		case (IJEAJGCCHEF)(-21):
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("Awaiting players - Player was removed from awaiting members."), Localization.Localize("SetupPushNotifications("), 1490f, null, string.Empty, true, true);
			break;
		}
		case (IJEAJGCCHEF)20:
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "damage");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["BOT"], 1);
			object[] array = new object[0];
			array[1] = num;
			WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("Exception message: ", array), Localization.Localize("Location"), 233f, null, string.Empty, true);
			break;
		}
		}
	}
	...
	public static void GBOCNHGKEDB(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "ID_AFFECTEDOWNUNITS");
	...
	public static void PHKNCEEHBPP(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)32:
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("116 STAGE 5 CONTINUE"), Localization.Localize("Squad rank updated from server, on client = "), 508f, null, string.Empty, true, true);
			break;
		}
		case (IJEAJGCCHEF)(-2):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "IsLocal");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["ID_INPROGRESS"], 1);
			WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("ID_OFFERENDSIN", num), Localization.Localize("WarFriends"), 616f, null, string.Empty, true, true);
			break;
		}
		}
	}
	...
	public static void PHNAAJIHEIG(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-157):
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("No connection."), Localization.Localize("FinishChoosingCardsRPC"), 1983f, null, string.Empty, false, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, text5);
			break;
		}
		case (IJEAJGCCHEF)(-151):
		{
			...
			WarningDialog.ShowError(Localization.Localize("ID_ARENARULES_EXPLOSIVESPROHIBITED"), Localization.Localize("PA: warbucks spent "), 182f, null, string.Empty, true, true);
			break;
		}
		case (IJEAJGCCHEF)(-147):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "{0} {1}");
	...
	public static void PBFNJOLIEOO(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)180:
		{
			...
			WarningDialog.ShowError(Localization.Localize("0"), Localization.Localize("CH"), 579f, null, string.Empty, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		...
		case (IJEAJGCCHEF)(-14):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "Play_Card_Tutorial_Duration");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["EventDefinition"]);
			WarningDialog.JACKIDKHKAI(Localization.LocalizeFormat("[Crashlytics Init] CrashlyticsService->Ctor->Initialize->After", num), Localization.Localize("InAppHandlerIos: On restore failed! "), 1463f, null, string.Empty, false, true);
			break;
		}
		}
	}
	...
	public static void ELOEPIMGBCN(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-197):
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("TimeOfMatch"), Localization.Localize("SetupPushNotifications("), 984f, null, string.Empty, true, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		case (IJEAJGCCHEF)163:
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("ServerResponseHandler.GetConfigurations DONE"), Localization.Localize("Google2u.DBUpgradeSlotsAssaulter"), 8f, null, string.Empty, true);
			break;
		}
		case IJEAJGCCHEF.AlreadyUpgrading:
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "ID_BRONZELOOTBOX");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["ID_CONFIRM_ERROR"]);
			object[] array = new object[0];
			array[1] = num;
			WarningDialog.JACKIDKHKAI(Localization.LocalizeFormat("ID_STAT_HANDGUNKILLS", array), Localization.Localize("ID_GETREWARDSFORSTARTERASSIGNMENTS"), 1979f, null, string.Empty, false, true);
			break;
		}
		}
	}
	...
	public static void FLEMJBCCFJA(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-13):
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("menu-squadpoint-ico"), Localization.Localize("ID_CLAIMED"), 1140f, null, string.Empty, false, true);
			break;
		}
		case (IJEAJGCCHEF)(-194):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "ID_SKILLSHOTHINT_LONGSHOT");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["{0}"], 1);
			object[] array = new object[1];
			array[1] = num;
			WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("warbucks", array), Localization.Localize("Yes_Clicked"), 196f, null, string.Empty, true, true);
			break;
		}
		}
	}
	...
	public static void IKJAGHACKFP(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)21:
		{
			...
			WarningDialog.ShowError(Localization.Localize("menu-sidetab-bg-box"), Localization.Localize("BS: player succesfully accepted to squad"), 1414f, null, string.Empty, true, true);
			break;
		}
		case (IJEAJGCCHEF)(-167):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "124 MENU WEAPON SCREEN TUTORIAL WEAPON ACTIVATED");
	...
	public static void DJBPOHNNLLD(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-165):
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.Localize("country-hong-kong"), Localization.Localize("Bronze"), 527f, null, string.Empty, true, true);
			break;
		}
		case (IJEAJGCCHEF)(-193):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "com.unity3d.player.UnityPlayer");
	...
	public static void PINCGNIJMEK(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)93:
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.Localize("()Lcom/google/android/gms/common/api/Status;"), Localization.Localize("ID_GOLDENLOOTBOXSMALL"), 1440f, null, string.Empty, false, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		case (IJEAJGCCHEF)(-92):
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("Panel \"{0}\" has ok Z"), Localization.Localize("PayWithTickets"), 601f, null, string.Empty, true, true);
			break;
		}
		case (IJEAJGCCHEF)(-197):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "Hiding CONFIRM dialog");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["Load assetBundle which is not cached !!!: "]);
			WarningDialog.ShowError(Localization.LocalizeFormat("AtlasPreparer.LoadTutorialCoroutine", num), Localization.Localize("ID_CONFIRM_ACCOUNTBANNED"), 1621f, null, string.Empty, true);
			break;
		}
		}
	}
	...
	public static void LPDEKCNMPLI(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)144:
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.Localize("Result for action:{0} on global:{1}"), Localization.Localize("BotWeaponPower"), 1405f, null, string.Empty, false, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, text5);
			break;
		}
		case (IJEAJGCCHEF)128:
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.Localize("ID_TUTORIAL_DELIVER"), Localization.Localize("Rank_up_4"), 796f, null, string.Empty, false, true);
			break;
		}
		case (IJEAJGCCHEF)(-3):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "Set isInMatch: ");
	...
	public static void NGFBCEKADPJ(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)6:
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("Setting performance to: "), Localization.Localize("DailyMissionsData"), 726f, null, string.Empty, false, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, text5);
			break;
		}
		case (IJEAJGCCHEF)(-49):
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("MaintenanceMessage"), Localization.Localize("Inactive player disconnected: "), 1696f, null, string.Empty, true);
			break;
		}
		case (IJEAJGCCHEF)(-109):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "Player_Level");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["Prefabs to go through: {0} + {1}"]);
			WarningDialog.JACKIDKHKAI(Localization.LocalizeFormat("country-egypt", num), Localization.Localize("ID_UNLOCKEDATRANK"), 472f, null, string.Empty, false, true);
			break;
		}
		}
	}
	...
	public static void HIACCBBKKFJ(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)40:
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.Localize("SkillShotManager.prefab"), Localization.Localize("DPS"), 242f, null, string.Empty, true, true);
			break;
		}
		case (IJEAJGCCHEF)19:
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "ID_YOUNEEDXTICKETSFOREXTRAHEART");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["SyncWarperRPC"], 1);
			WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("-1", num), Localization.Localize("OnConnectionFailed: 00"), 713f, null, string.Empty, false, true);
			break;
		}
		}
	}
	...
	public static void BDKKGKLLCNF(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)85:
		{
			...
			WarningDialog.ShowError(Localization.Localize("ID_WARNING_CONNECTIONERROR"), Localization.Localize("Yes_Clicked"), 1290f, null, string.Empty, false, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		case (IJEAJGCCHEF)(-184):
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize(")"), Localization.Localize("getAppId"), 1625f, null, string.Empty, true, true);
			break;
		}
		case (IJEAJGCCHEF)(-63):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "下載");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["newMember"], 1);
			object[] array = new object[0];
			array[1] = num;
			WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("cn", array), Localization.Localize("test_attribute5"), 132f, null, string.Empty, true, true);
			break;
		}
		}
	}
	...
	public static void BJOEEBJABGO(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-21):
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize(" abilityIcon:"), Localization.Localize("\"{0}\""), 1405f, null, string.Empty, false, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		case (IJEAJGCCHEF)185:
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.Localize("-1"), Localization.Localize("Card_1_Played"), 1204f, null, string.Empty, true);
			break;
		}
		case (IJEAJGCCHEF)159:
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "N0");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["ID_MONEYPACKINFORMATIONS"]);
			object[] array = new object[0];
			array[1] = num;
			WarningDialog.JACKIDKHKAI(Localization.LocalizeFormat("GoldCoefficient", array), Localization.Localize("ID_GUI_SQUADLEVELEDUP_CARDPOOLINC"), 1174f, null, string.Empty, false, true);
			break;
		}
		}
	}
	...
	public static void MDLALOJFJOG(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-74):
		{
			...
			WarningDialog.ShowError(Localization.Localize("GameLauncher.Async"), Localization.Localize("com/google/android/gms/games/Games"), 1607f, null, string.Empty, true, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, text5);
			break;
		}
		case (IJEAJGCCHEF)(-70):
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.Localize("{0} {1} {2}/ {3}[-]"), Localization.Localize("1"), 354f, null, string.Empty, true);
			break;
		}
		case (IJEAJGCCHEF)39:
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "ID_SALEPERCENTLINE");
	...
	public static void OBCJJGKJCID(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-37):
		{
			...
			WarningDialog.ShowError(Localization.Localize("Windows"), Localization.Localize("null"), 1000f, null, string.Empty, true, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, text5);
			break;
		}
		case (IJEAJGCCHEF)(-23):
		{
			...
			WarningDialog.ShowError(Localization.Localize("SquadId"), Localization.Localize("Gold"), 876f, null, string.Empty, true);
			break;
		}
		case (IJEAJGCCHEF)(-189):
		{
			...
			object[] array = new object[1];
			array[1] = num;
			WarningDialog.ShowError(Localization.LocalizeFormat("blackmarket", array), Localization.Localize("ArenaLootBox"), 1205f, null, string.Empty, false, true);
			break;
		}
		}
	}
	...
	public static void ACFGDEDKPAO(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "dailyLimit");
	...
	public static void NAKCECEJION(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "0\u00a0");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["ID_SALEPERCENT"]);
			object[] array = new object[0];
			array[0] = num;
			WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("SERVICE_DISABLED", array), Localization.Localize("ID_STARTERASSIGNMENT"), 168f, null, string.Empty, false, true);
			break;
		}
		}
	}
	...
	public static void CLCKDOJHIEO(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-193):
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.Localize("weapon1"), Localization.Localize("division changed!!!"), 1059f, null, string.Empty, true, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		case (IJEAJGCCHEF)(-78):
		...
		case (IJEAJGCCHEF)163:
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "WindowDuration");
	...
	public static void KLPFJPBMDGG(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)14:
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.Localize("ID_MIN"), Localization.Localize("after update GC still GC account, but no added or missing gcID or gcPassword"), 347f, null, string.Empty, false, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		case (IJEAJGCCHEF)(-197):
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("seconds"), Localization.Localize("menu-hub-multiplayer-vipico"), 838f, null, string.Empty, true);
			break;
		}
		case (IJEAJGCCHEF)74:
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "com.google.android.gms.common.api.PendingResult");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["ID_OK"], 1);
			WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("GooglePlay", num), Localization.Localize("N"), 1171f, null, string.Empty, false, true);
			break;
		}
		}
	}
	...
	public static void JBDDAMJMKGM(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)116:
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("ID_GETTOAVOIDRELEGATION1"), Localization.Localize("ID_WARNING_CANNOTCREATESQUAD_TEXT"), 1111f, null, string.Empty, true);
			break;
		}
		case (IJEAJGCCHEF)(-46):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "ID_TOCOMPLETE");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["SquadId"]);
			WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("BANDS_EMPTY", num), Localization.Localize("menu-arena-scrap-ico"), 928f, null, string.Empty, true, true);
			break;
		}
		}
	}
	...
	public static void FKANLBDBPGI(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-2):
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("S"), Localization.Localize("SquadWarWins"), 3f, null, string.Empty, true, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, text5);
			break;
		}
		case (IJEAJGCCHEF)89:
		{
			...
			WarningDialog.ShowError(Localization.Localize("isVIP"), Localization.Localize("discount"), 1268f, null, string.Empty, true, true);
			break;
		}
		case (IJEAJGCCHEF)(-162):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "ID_STAT_WINLOSSRATIO");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["LevelName"]);
			object[] array = new object[0];
			array[1] = num;
			WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("ExplodeRPC", array), Localization.Localize("Beanstalk: On Remove Login"), 1632f, null, string.Empty, false, true);
			break;
		}
		}
	}
	...
	public static void CNKNKBNNJAB(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)158:
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.Localize("Time"), Localization.Localize("Scraps"), 911f, null, string.Empty, false, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		case (IJEAJGCCHEF)160:
		{
			...
			WarningDialog.JACKIDKHKAI(Localization.Localize("Heroic"), Localization.Localize("{0} [9A9999]/[0BBCFF] {1}"), 1129f, null, string.Empty, true);
			break;
		}
		case (IJEAJGCCHEF)(-29):
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "missing UIRoot");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["{0} {1}"]);
			WarningDialog.JACKIDKHKAI(Localization.LocalizeFormat("ID_FEATURE_DAMAGE-DESCRIPTION", num), Localization.Localize("ShotFrequencyMax"), 1536f, null, string.Empty, false, true);
			break;
		}
		}
	}
	...
	public static void OOMNIBFFIGO(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)(-89):
		{
			...
			array3[1] = text5;
			Debug.LogFormat("-{0}-{1}", array3);
			WarningDialog.KHOMNBHMFGA(Localization.Localize("placement"), Localization.Localize("SERVICE_MISSING_PERMISSION"), 1629f, null, string.Empty, false, true);
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, text5);
			break;
		}
		case (IJEAJGCCHEF)(-197):
		...
		case (IJEAJGCCHEF)77:
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(true, "accountName");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["menu-army-cat-defender"], 1);
			object[] array = new object[1];
			array[1] = num;
			WarningDialog.JACKIDKHKAI(Localization.LocalizeFormat("LevelName", array), Localization.Localize("SDK_INT"), 219f, null, string.Empty, true);
			break;
		}
		}
	}
	...
	public static void HHMMAJANNEH(IJEAJGCCHEF CDLPMHEODBN, Dictionary<string, object> EENKJBCCPBG)
	{
		...
		case (IJEAJGCCHEF)6:
		{
			Singleton<EventTrackingManager>.instance.VideoUploaded(false, "ID_DOYOUWANTTOBUYWARBUCKS");
			int num = KHJJFPPACBP.PELILBMKGHE(EENKJBCCPBG["max"]);
			object[] array = new object[0];
			array[0] = num;
			WarningDialog.JACKIDKHKAI(Localization.LocalizeFormat("setAndroidIdSha1", array), Localization.Localize("RegisterAge()"), 254f, null, string.Empty, true);
			break;
		}
		}
	}
