...
public abstract class WeaponLevelsSetup : Core_BaseScript
{
	...
	public class UpgradeSlot
	{
		...
		public List<Tuple<string, float[]>> guiStatistics
		{
			get
			{
		...
		public int instantBuyPrice
		{
			get
			{
				...
				int num2 = Singleton<OfferManager>.instance.DiscountedWeaponDeliveryCost(owner.BHCEOOLEHHG, owner, false);
				if (num2 > 0 && num2 < 100)
				{
		...
		public int KDIHEKPKCJJ(int BMFAHPPCPBF)
		{
			...
			if (canUpgrade)
			{
				...
				Debug.LogFormat("Started delivering weapon upgrade for {0} {1}. It will be ready in {2} seconds.", owner.DHHKOKKDDDO(), boughtIndex, num);
			}
			return num;
		}
		...
		public int AFNEBEPHKGB()
		{
			...
			int num = MEJMLNDFDBP.BCEGIAODLCL(Convert.ToInt32(owner.remainingDeliveringSeconds));
			int num2 = Singleton<OfferManager>.instance.DiscountedWeaponDeliveryCost(owner.BHCEOOLEHHG, owner, true);
			if (num2 > 1 && num2 < 42)
			{
				num = num * (119 - num2) / 85;
			}
		...
		public int AIBGABNCKFI(int BMFAHPPCPBF)
		{
			...
			if (AMDMFOAPIME())
			{
				...
				array[1] = OFEJOLENCKI();
				array[0] = num;
				Debug.LogFormat("ItemRarity_1", array);
			}
			return num;
		}
		...
		public int PAKFACNGLPI(int BMFAHPPCPBF)
		{
			...
			if (ABLBELPECBP())
			{
				...
				array[0] = KMHMJEDDNOP();
				array[2] = num;
				Debug.LogFormat(" is selected: ", array);
			}
			return num;
		}
		...
		public void JFPJCGJOKKA()
		{
			if (canActivate)
			{
				...
				boughtIndex++;
				owner.deliveryActivationNeeded = false;
				Debug.Log("Weapon upgrade for " + owner.DHHKOKKDDDO() + " " + boughtIndex + " was activated.");
			}
		}
		...
		public int CHBLIODIDAL(int BMFAHPPCPBF)
		{
			...
			if (GEDLFJAJJBN())
			{
				...
				array[1] = boughtIndex;
				array[8] = num;
				Debug.LogFormat("exception message", array);
			}
			return num;
		}
		...
		public int IPHBJHMJGHF(int BMFAHPPCPBF)
		{
			...
			if (GPCKEMCNGAA())
			{
				...
				array[0] = EJHKOFFOFOA();
				array[5] = num;
				Debug.LogFormat("ID_ARENARULES_BUDDYWARCARDS", array);
			}
			return num;
		}
		...
		public int ILKBGNLIADJ(int BMFAHPPCPBF)
		{
			...
			if (HLONFLMCGIK())
			{
				...
				array[0] = boughtIndex;
				array[2] = num;
				Debug.LogFormat("-----BEGIN CERTIFICATE-----MIIDwDCCAqgCCQCAhUcHjX7uoDANBgkqhkiG9w0BAQUFADCBoTELMAkGA1UEBhMCQ1oxDzANBgNVBAgMBlByYWd1ZTEPMA0GA1UEBwwGUHJhZ3VlMRIwEAYDVQQKDAlBYm91dCBGdW4xCzAJBgNVBAsMAklUMSswKQYDVQQDDCJ3YXJmcmllbmRzLWV1LmVsYXN0aWNiZWFuc3RhbGsuY29tMSIwIAY", array);
			}
			return num;
		}
		...
		public void JCDBPPBDHBC()
		{
			...
			owner.deliveryActivationNeeded = false;
			Debug.Log("Weapon upgrade for " + owner.DHHKOKKDDDO() + " " + boughtIndex + " was activated (through fast activation).");
		}
		...
		public int MBBKOLENFPO(int BMFAHPPCPBF)
		{
			...
			if (GEDLFJAJJBN())
			{
				...
				array[1] = LHLGAAEEKID();
				array[7] = num;
				Debug.LogFormat("On Debug Add Scraps Request: ", array);
			}
			return num;
		}
		...
		public int NACFEBFOONF(int BMFAHPPCPBF)
		{
			...
			if (canUpgrade)
			{
				...
				array[1] = OBNOCCJIMPG();
				array[6] = num;
				Debug.LogFormat("AssignmentData", array);
			}
			return num;
		}
		...
		public int CGBAKKGAHOO(int BMFAHPPCPBF)
		{
			...
			if (NJHDEGCDJKK())
			{
				...
				array[0] = KMHMJEDDNOP();
				array[1] = num;
				Debug.LogFormat("buggy_idle", array);
			}
			return num;
		}
		...
		public int HLECIKNGJAA(int BMFAHPPCPBF)
		{
			...
			if (NJHDEGCDJKK())
			{
				...
				array[1] = AGKHAOLEHDE();
				array[2] = num;
				Debug.LogFormat("ID_ARENARULES", array);
			}
			return num;
		}
	...
	public string weaponName
	{
		get
		{
			return Localization.LocalizeFormat(KAJHANBHNKK, weaponFeature.weaponPrefix);
		}
	}

	public WeaponFeature weaponFeature { get; set; }

	public WeaponUpgradesRow HCICPDLJNCK { protected get; set; }

	public int indexInLevelManager { get; set; }
	...
	public string purchasableValue
	{
		get
		{
			return HCICPDLJNCK.PURCHASABLE;
		}
	}
	...
	public bool purchasableInBlackmarket
	{
		get
		{
			return purchasable == GILPPKMICCF.BlackMarket;
		}
	}
	...
	public bool canBeBought
	{
		get
		{
			return LevelManager.instance.currentLevel.index >= HCICPDLJNCK.CANBEBOUGHT - 1;
		}
	}
	...
	public float burstLockTime
	{
		get
		{
			return HCICPDLJNCK.BURSTLOCKTIME * weaponFeature.rateOfFireCoef;
		}
	}
	...
	public float accuracy
	{
		get
		{
			return Mathf.Round((float)HCICPDLJNCK.ACCURACY * weaponFeature.accuracyCoef * 1000f) / 1000f;
		}
	}
	...
	public float critical
	{
		get
		{
			return Mathf.Round((float)HCICPDLJNCK.CRITICAL * weaponFeature.criticalCoef * 1000f) / 1000f;
		}
	}
	...
	public float shotVelocity
	{
		get
		{
			return (float)HCICPDLJNCK.SPEED * weaponFeature.shotVelocityCoef;
		}
	}
	...
	public float rateOfFire
	{
		get
		{
			return (float)HCICPDLJNCK.RATEOFFIRE * weaponFeature.rateOfFireCoef;
		}
	}
	...
	public int priceGold
	{
		get
		{
			return HCICPDLJNCK.PRICEGOLD;
		}
	}

	public int weaponDeliveryTime
	{
		get
		{
			return HCICPDLJNCK.DELIVERTIME;
		}
	}

	public float damageToPlayerRatio
	{
		get
		{
			return HCICPDLJNCK.DAMAGETOPLAYER;
		}
	}

	public float damageToPlayerRatioOvertime
	{
		get
		{
			return HCICPDLJNCK.DAMAGETOPLAYEROVERTIME;
		}
	}

	public float damageToPlayerBehindShieldRatio
	{
		get
		{
			return HCICPDLJNCK.DAMAGETOPLAYERBEHINDSHIELD;
		}
	}
	...
	public float damageToShield
	{
		get
		{
			return HCICPDLJNCK.DAMAGETOSHIELD;
		}
	}
	...
	public int blackmarketPrice
	{
		get
		{
			return LIEFNEPEIJO.HasColumn("weaponprice") ? ((int)LIEFNEPEIJO.GetValue(MGAGEKAAJOL.boughtIndex, "weaponprice")) : 0;
		}
	}

	public float reloadGUI
	{
		get
		{
			return (!LIEFNEPEIJO.HasColumn("reloadTime")) ? 0f : ((float)LIEFNEPEIJO.GetValue(MGAGEKAAJOL.boughtIndex, "reloadTime") * weaponFeature.reloadCoef);
		}
	}

	public int magazineGUI
	{
		get
		{
			return LIEFNEPEIJO.HasColumn("clipSize") ? ((int)((float)(int)LIEFNEPEIJO.GetValue(MGAGEKAAJOL.boughtIndex, "clipSize") * weaponFeature.clipSizeCoef)) : 0;
		}
	}
	...
	public int unlockLevelIndex
	{
		get
		{
			return HCICPDLJNCK.UNLOCKLEVEL - 1;
		}
	}
	...
	public int instantWeaponDeliveryPrice
	{
		get
		{
			...
			int num2 = Singleton<OfferManager>.instance.DiscountedWeaponDeliveryCost(BHCEOOLEHHG, this, false);
			if (num2 > 0 && num2 < 100)
			{
				num = num * (100 - num2) / 100;
			}
	...
	public virtual int maxWeaponLevel
	{
		get
		{
			return LIEFNEPEIJO.RowsGeneric.Count - 1;
		}
	}
	...
	public PlayerWeapon playerWeapon
	{
		get
		{
			return weaponInventory.KCGKDDDNONB[LKFMMBMFFNB];
		}
	}
	...
	public virtual float rateOfFirePerMinute
	{
		get
		{
	...
	public bool unlocked
	{
		get
		{
			return unlockLevelIndex <= LevelManager.instance.currentLevel.index || bought;
		}
	}
	...
	public float upgradesProgress
	{
		get
		{
			return (float)weaponLevel / (float)maxWeaponLevel;
		}
	}
	...
	public Weapon weapon
	{
		get
		{
			return weaponInventory.KCGKDDDNONB[LKFMMBMFFNB].weapon;
		}
	}
	...
	public virtual int weaponLevel
	{
		get
		{
			return (bought || purchasableInBlackmarket) ? MGAGEKAAJOL.level : 0;
		}
	}
	...
	public float weaponPower
	{
		get
		{
			return LBDJFGDNKLA((MGAGEKAAJOL != null) ? MGAGEKAAJOL.boughtIndex : KPCFKKHJIGA().boughtIndex);
		}
	}
	...
	public int weaponPowerX10
	{
		get
		{
			return GetWeaponPowerX10(MGAGEKAAJOL.boughtIndex, weaponFeature);
		}
	}

	public int weaponPowerX10Next
	{
		get
		{
			return GetWeaponPowerX10(MGAGEKAAJOL.boughtIndex + 1, weaponFeature);
		}
	}

	public int weaponPowerX10Max
	{
		get
		{
			return GetWeaponPowerX10(FindLastRowForSlot(MGAGEKAAJOL), weaponFeature);
		}
	}
	...
	public virtual float shotDamage
	{
		get
		{
			return 0f;
	...
	public void Buy()
	{
		...
		Debug.Log("Started delivering |" + DHHKOKKDDDO() + "| time: " + weaponDeliveryTime + "s");
	}
	...
	public virtual List<Tuple<string, float[]>> GetGuiStats(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "clipSize", "ID_SLOTUPGRADE_CLIP_SIZE", weaponFeature.clipSizeCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "reloadTime", "ID_SLOTUPGRADE_ROF", weaponFeature.reloadCoef));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ammo", "ID_SLOTUPGRADE_AMMO", weaponFeature.ammoCoef, true));
		return list;
	}
	...
	private LevelManager.SavedWeaponSlots KPCFKKHJIGA()
	{
		...
		if (LevelManager.instance.data.savedWeapons.TryGetValue(key, out value))
		{
			return value;
		}
