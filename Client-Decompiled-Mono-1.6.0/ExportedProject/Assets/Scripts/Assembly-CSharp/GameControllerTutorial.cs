...
public class GameControllerTutorial : IGameController
{
	...
	private sealed class LIMGNABNMEG : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool GNFCLHDPPFP()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.LCIFJLNADFP(BJGCPDNMHDH.JJKLKPKMHJO(), false, PlayerTexturePool.DFJJOANIJID.Card);
				...
				else
				{
					...
					TutorialManagerStage1.instance.StartTutorial(true);
				}
				goto case 4u;
			case 2u:
		...
		public bool MKCOLOBIAAP()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.RenderToTexture(BJGCPDNMHDH.PLIGGFJCAPA(), true);
				PlayerController.JFGDAKMCJAM.Clear();
				...
				else
				{
					...
					TutorialManagerStage1.instance.StartTutorial(false);
				}
				goto case 4u;
			case 2u:
		...
		public bool DMPHMFDEINI()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.LCIFJLNADFP(BJGCPDNMHDH.JJKLKPKMHJO(), true);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool LPCBKGKFNFD()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.KIONJHBCIBE(BJGCPDNMHDH.AAIEPHNDCJP, false, PlayerTexturePool.DFJJOANIJID.Card);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool DLAPDOPMBNE()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.LCIFJLNADFP(BJGCPDNMHDH.PHCFJDNCHII(), false);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool NEMOAIBCODB()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.LCIFJLNADFP(BJGCPDNMHDH.PLIGGFJCAPA(), false, PlayerTexturePool.DFJJOANIJID.Card);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool GFIEJKOANFL()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.MDCPOGFDCPC(BJGCPDNMHDH.PLIGGFJCAPA(), true, PlayerTexturePool.DFJJOANIJID.Card);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool LHNFELIIMGD()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.BDHBFHGBDOK(BJGCPDNMHDH.JJKLKPKMHJO(), false, PlayerTexturePool.DFJJOANIJID.Card);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool JICHKPANPEE()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.RenderToTexture(BJGCPDNMHDH.PLIGGFJCAPA(), false);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool PMBOHHPPJAC()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.DIMPHNLEKHG(BJGCPDNMHDH.PLIGGFJCAPA(), true, PlayerTexturePool.DFJJOANIJID.Card);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool LLOCENNFFFJ()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.LCIFJLNADFP(BJGCPDNMHDH.AAIEPHNDCJP, true);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool NIGJJBALHDN()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.KIONJHBCIBE(BJGCPDNMHDH.PHCFJDNCHII(), false);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool FPOFCJOEAMO()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.MDCPOGFDCPC(BJGCPDNMHDH.PHCFJDNCHII(), false, PlayerTexturePool.DFJJOANIJID.Card);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool MoveNext()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.RenderToTexture(BJGCPDNMHDH.AAIEPHNDCJP, true);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool AELAICNOAPN()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.BCPDNHEDBGO(BJGCPDNMHDH.AAIEPHNDCJP, true, PlayerTexturePool.DFJJOANIJID.Card);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool LGLPPAENMGK()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.MANAHDDIFIO(BJGCPDNMHDH.AAIEPHNDCJP, true, PlayerTexturePool.DFJJOANIJID.Card);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool FADACBKMFGG()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.KIONJHBCIBE(BJGCPDNMHDH.AAIEPHNDCJP, true, PlayerTexturePool.DFJJOANIJID.Card);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool CCOPPEKLJOB()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.MANAHDDIFIO(BJGCPDNMHDH.PLIGGFJCAPA(), true, PlayerTexturePool.DFJJOANIJID.Card);
				PlayerController.JFGDAKMCJAM.Clear();
		...
		public bool IGKACECJBEB()
		{
			...
			case 0u:
				...
				break;
			case 1u:
				Singleton<ArmyPreviewCamera>.instance.KIONJHBCIBE(BJGCPDNMHDH.PLIGGFJCAPA(), true, PlayerTexturePool.DFJJOANIJID.Card);
				PlayerController.JFGDAKMCJAM.Clear();
	...
	protected PlayerController AAIEPHNDCJP
	{
		get
		{
	...
	public override bool canShowPause
	{
		get
		{
			return true;
	...
	public override bool pauseCountDown
	{
		get
		{
			return false;
	...
	public void MHIAOAMDIGC()
	{
		...
		catch (Exception ex)
		{
			...
			CPLFJCDIIPG.Add(CardManager.instance.GetCardInstance("Tutorial_Step_Complete", false));
			CPLFJCDIIPG.Add(CardManager.instance.GetCardInstance("menu-button-promote-ico", false));
			CPLFJCDIIPG.Add(CardManager.instance.GetCardInstance("App could not be run", false));
		}
	}
	...
	public void AGAPPAGMNIN()
	{
		...
		try
		{
			...
			foreach (string item in list)
			{
				CPLFJCDIIPG.Add(CardManager.instance.GetCardInstance(item, false));
			}
		}
		catch (Exception ex)
		{
			...
			AnalyticsHelper.LogHandledException(ex);
			CPLFJCDIIPG.Add(CardManager.instance.GetCardInstance("ID_BRONZEPACK", false));
			CPLFJCDIIPG.Add(CardManager.instance.GetCardInstance("ID_RETRY", false));
	...
	private void DOLLKNGDIEH()
	{
		...
		Singleton<ArmyPreviewCamera>.instance.RenderToTexture(NLAKCKMCOMN, true);
		jPMHIGNOPBL.enabled = true;
	}
	...
	public void HOAFLNJKMGO()
	{
		...
		TutorialManagerStage2.instance.EquipTutorialUnitAfterSkipTutorial();
		LevelManager.instance.SetLevelUpProgressForTutorial(0, 1993f, true);
	...
	public void IOPPHJNCABF()
	{
		...
		TutorialManagerStage1.instance.EquipTutorialWeaponAfterSkipTutorial();
		TutorialManagerStage2.instance.EquipTutorialUnitAfterSkipTutorial();
		LevelManager.instance.SetLevelUpProgressForTutorial(7, 1762f, false);
	...
	public override void LoadingStarted()
	{
		...
		LoadingDialog.ShowLoading(Localization.Localize("ID_TUTORIAL"), false, true, true);
		if (TutorialManagerStage2.instance.isTutorialRunning || TutorialManagerStage3.instance.data.started)
		{
	...
	public void JAHIEEFECEA()
	{
		...
		catch (Exception ex)
		{
			...
			AnalyticsHelper.LogHandledException(ex);
			CPLFJCDIIPG.Add(CardManager.instance.GetCardInstance("Weapon Power This: {0},   Equipped {1}: {2},   Difference: {3}", false));
			CPLFJCDIIPG.Add(CardManager.instance.GetCardInstance("width"));
			CPLFJCDIIPG.Add(CardManager.instance.GetCardInstance("FinishChoosingCardsRPC", false));
		}
	}
	...
	public void PCFMKGDANCA()
	{
		...
		TutorialManagerStage1.instance.EquipTutorialWeaponAfterSkipTutorial();
		TutorialManagerStage2.instance.EquipTutorialUnitAfterSkipTutorial();
		LevelManager.instance.SetLevelUpProgressForTutorial(0, 107f, true);
	...
	private void NPGBIJBIEOA()
	{
		...
		Singleton<ArmyPreviewCamera>.instance.RenderToTexture(NLAKCKMCOMN, true, PlayerTexturePool.DFJJOANIJID.Card);
		jPMHIGNOPBL.enabled = false;
	}

	public void SkipTutorial()
	{
		Singleton<EventTrackingManager>.instance.RegisterTutorialEvent(string.Format("SKIP TUTORIAL IN {0}", tutorialStageId.ToUpper()));
		foreach (TutorialManagerBase item in DEHPFPNPDOK)
		{
			item.FinishTutorial();
			item.data.started = true;
	...
	private void LOBICGBAIED()
	{
		...
		PlayerBot jPMHIGNOPBL = NLAKCKMCOMN.JPMHIGNOPBL;
		Singleton<BotManager>.instance.PrepareBotForTutorial(jPMHIGNOPBL);
		Singleton<ArmyPreviewCamera>.instance.KIONJHBCIBE(NLAKCKMCOMN, false);
		jPMHIGNOPBL.enabled = false;
	}
	...
	public void GDPJNMNMOMK()
	{
		...
		catch (Exception ex)
		{
			...
			AnalyticsHelper.LogHandledException(ex);
			CPLFJCDIIPG.Add(CardManager.instance.GetCardInstance("ID_CONFIRM_NOSQUADACTIONS_TEXT", false));
			CPLFJCDIIPG.Add(CardManager.instance.GetCardInstance("Scenes to go through: {0}", false));
			CPLFJCDIIPG.Add(CardManager.instance.GetCardInstance("StopShoot", false));
		}
	}
