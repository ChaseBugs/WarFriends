...
public class PlayerBotTutorial : Core_BaseScript
{
	...
	private bool HLMELNMHHDA
	{
		get
		{
			return playerController.weaponInventory.currentWeapon.weapon.BEACDIILBEG == Weapon.IGGFMJAKLGO.Bazooka || playerController.weaponInventory.currentWeapon.weapon.BEACDIILBEG == Weapon.IGGFMJAKLGO.Grenade;
		}
	}
