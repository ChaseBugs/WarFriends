...
public class BattlePreparationScreen : GuiScreenSingle<BattlePreparationScreen>
{
	...
	public void CFJGOIAIKGB(int EJEDANLAMBI, ref UILabel MOHOGIEKBIJ, bool PDPDGCNHCFN)
	{
		...
		case 2:
			...
			break;
		case 1:
			MOHOGIEKBIJ.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "Total_Gold_Spent", string.Empty, false);
	...
	private void BDMJKGFAICC()
	{
		...
		array2[0] = "id";
		array2[1] = MEJMLNDFDBP.CJCFPDLDMEK(586f, "Total_Gold_Earned", string.Empty, false);
		...
		FHMLOFAAPCK.text = Localization.LocalizeFormat("{0} {1}", "smallURL", MEJMLNDFDBP.CJCFPDLDMEK(1178f, "ID_EMPTYSQUADNAME", string.Empty, false), null, null, null);
		x = FHMLOFAAPCK.relativeSize.x;
		if (x > num)
		{
			num = x;
		...
		array3[1] = "N";
		array3[1] = MEJMLNDFDBP.CJCFPDLDMEK(1472f, "<", string.Empty, false);
