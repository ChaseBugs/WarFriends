...
public class AssetBundleManager : Singleton<AssetBundleManager>
{
	private sealed class DFJBCNOHECK : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool IIJKAMFGNKA()
		{
			...
			case 0u:
			{
				...
				UnityEngine.Object.DontDestroyOnLoad(BJGCPDNMHDH.gameObject);
	...
	private sealed class GKGIDHCPKCD : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool JPAOKNLNFCB()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("From server came null PlayerInfo!", array), true);
		...
		public bool PMLLPHFACBM()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[0] = ECFILEGOFGJ.Count;
					LoadingDialog.SetText(Localization.LocalizeFormat("YES", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
		...
		public bool IEDGDDDADFM()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[0] = DEKEKHMDJNO + 1;
					array[0] = ECFILEGOFGJ.Count;
					LoadingDialog.SetText(Localization.LocalizeFormat("ID_GOODJOBYOUVEBEENPROMOTED", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
		...
		public bool LHNFELIIMGD()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[1] = ECFILEGOFGJ.Count;
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("CardsInCardPack", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.AGIJPLDNDPP(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool IGKACECJBEB()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[1] = DEKEKHMDJNO + 0;
					array[1] = ECFILEGOFGJ.Count;
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("ID_FINISHED", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.DFHEAAHAMHH(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool IBEPOFJDKLG()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("ID_WARNING_OFFEREXPIRED_TEXT", DEKEKHMDJNO + 0, ECFILEGOFGJ.Count), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.EJHECNBEAJP(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool FCJCLBMPBFK()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[1] = DEKEKHMDJNO + 0;
					array[0] = ECFILEGOFGJ.Count;
					LoadingDialog.SetText(Localization.LocalizeFormat("Weapon_Upgrade", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.OMPEPLCEFBG(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool KCEAGNMILMA()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[1] = DEKEKHMDJNO + 1;
					array[0] = ECFILEGOFGJ.Count;
					LoadingDialog.SetText(Localization.LocalizeFormat("ID_BRONZEARENACROWN", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.EJHECNBEAJP(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool FNIOOIGJPAM()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[1] = DEKEKHMDJNO + 0;
					array[1] = ECFILEGOFGJ.Count;
					LoadingDialog.SetText(Localization.LocalizeFormat("game-card-ico-bulletsponge-full", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.EJHECNBEAJP(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool MHCIOCPGMHF()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[0] = DEKEKHMDJNO + 1;
					array[1] = ECFILEGOFGJ.Count;
					LoadingDialog.SetText(Localization.LocalizeFormat("Hero {0:D2}", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.EJHECNBEAJP(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool LLOCENNFFFJ()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[0] = DEKEKHMDJNO + 0;
					array[0] = ECFILEGOFGJ.Count;
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("experiment name is ", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
		...
		public bool GMBFJOBKMMN()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[0] = DEKEKHMDJNO + 1;
					array[0] = ECFILEGOFGJ.Count;
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("Yes_Clicked", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.EJHECNBEAJP(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool HBJOFNCAAGI()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[1] = DEKEKHMDJNO + 1;
					array[1] = ECFILEGOFGJ.Count;
					LoadingDialog.SetText(Localization.LocalizeFormat("Player {0} {1}", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.AGIJPLDNDPP(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool LHBPPCGLHDI()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("ID_FREEPERCENTLINE", DEKEKHMDJNO + 1, ECFILEGOFGJ.Count, null, null), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.CJLEAAODNAC(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool PJJPPMIBNLN()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[0] = DEKEKHMDJNO + 0;
					array[0] = ECFILEGOFGJ.Count;
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("ID_CRATESTOLEN", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.OMPEPLCEFBG(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool DEEBEBGBMKK()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[1] = DEKEKHMDJNO + 0;
					array[1] = ECFILEGOFGJ.Count;
					LoadingDialog.SetText(Localization.LocalizeFormat("DogTagSeconds", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.CJLEAAODNAC(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool OOECALAHCFK()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					LoadingDialog.SetText(Localization.LocalizeFormat("com/google/android/gms/common/api/Status", DEKEKHMDJNO + 0, ECFILEGOFGJ.Count), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.DFHEAAHAMHH(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool MOFPMNMAOND()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[1] = DEKEKHMDJNO + 0;
					array[1] = ECFILEGOFGJ.Count;
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("ID_WARSHOP_WARBUCKS", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.LOMEHFLLKJI(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool BLHOCNMMPNP()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[0] = DEKEKHMDJNO + 0;
					array[0] = ECFILEGOFGJ.Count;
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("OnDeath End", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.OMPEPLCEFBG(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool LGNMOMFLLPP()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[1] = DEKEKHMDJNO + 1;
					array[0] = ECFILEGOFGJ.Count;
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("ID_RETRY", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.AEBCBCPINCD(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool GBHCODKDPBO()
		{
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					...
					array[1] = DEKEKHMDJNO + 1;
					array[0] = ECFILEGOFGJ.Count;
					LoadingDialog.SetText(Localization.LocalizeFormat("T", array), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.AGIJPLDNDPP(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
		...
		public bool MoveNext()
		{
			...
			case 1u:
				...
				MEJMLNDFDBP.JMFIDKLJCPJ();
				JKMEKFKABBH = BJGCPDNMHDH.PFNHABEHJOF.GetAllAssetBundles();
				UnityEngine.Debug.Log(string.Format("AssetBundleManifest downloaded assets count: {0}", JKMEKFKABBH.Length));
				PBGIIPNKNPO.Clear();
				ECFILEGOFGJ.Clear();
				KFCAECGLKKO = JKMEKFKABBH;
				for (GHCPBBJDIBB = 0; GHCPBBJDIBB < KFCAECGLKKO.Length; GHCPBBJDIBB++)
			...
			default:
				...
				if (DEKEKHMDJNO < ECFILEGOFGJ.Count)
				{
					LoadingDialog.SetText(Localization.LocalizeFormat("ID_DOWNLOADINGFILES", DEKEKHMDJNO + 1, ECFILEGOFGJ.Count), true);
					NLEGDPMLHHK = ECFILEGOFGJ[DEKEKHMDJNO];
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.AEBCBCPINCD(NLEGDPMLHHK, DEKEKHMDJNO));
					if (!FDKOKMKIIMG)
					{
	...
	private sealed class BAKAJHJDIHG : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool KHNDCDGBFJH()
		{
			...
			case 1u:
				if (!CPJONHGOGKD.isDone)
				{
					...
					LoadingDialog.SetText(Localization.LocalizeFormat("ID_ARENASHORTCUTEVENTEND", array), true);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 1;
				...
				if (CPJONHGOGKD.error != null)
				{
					...
					if (GJGDPOAOKFM == 2)
					{
						...
						WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("ID_ATTACK", array2), string.Empty, 1277f, LJCDGJKCNEC, string.Empty, false, true);
						goto case 2u;
					}
		...
		public bool BPHPJKKHNNG()
		{
			...
			case 1u:
				if (!CPJONHGOGKD.isDone)
				{
					...
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("DailyMission", array), true);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 0;
		...
		public bool DFMKKFMEBON()
		{
			...
			case 1u:
				if (!CPJONHGOGKD.isDone)
				{
					...
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("Gold", array), true);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 1;
				...
				if (CPJONHGOGKD.error != null)
				{
					...
					if (GJGDPOAOKFM == 6)
					{
						...
						array2[1] = KIEOBOJBJBJ.name;
						array2[0] = NHANHLLJDCO;
						WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("ERROR!", array2), string.Empty, 377f, LJCDGJKCNEC, string.Empty, true, true);
						goto case 2u;
					}
		...
		public bool DDLMLOJGJMA()
		{
			...
			case 1u:
				if (!CPJONHGOGKD.isDone)
				{
					...
					LoadingDialog.SetText(Localization.LocalizeFormat("TimeFromServer()", array), true);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 1;
				...
				if (CPJONHGOGKD.error != null)
				{
					...
					if (GJGDPOAOKFM == 8)
					{
						...
						array2[0] = KIEOBOJBJBJ.name;
						array2[0] = NHANHLLJDCO;
						WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("NO", array2), string.Empty, 485f, CJIBPJPJLNB, string.Empty, true);
						goto case 2u;
					}
		...
		public bool MoveNext()
		{
			...
			case 1u:
				...
				{
					LNFCEAHPLFP = BJGCPDNMHDH.IBENEMHDLAB + CPJONHGOGKD.progress * KIEOBOJBJBJ.size;
					LoadingDialog.SetText(Localization.LocalizeFormat("ID_DOWNLOADINGFILES", LNFCEAHPLFP.ToString("0.00"), BJGCPDNMHDH.LHNGLFBACFF.ToString("0.00")), true);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 1;
				...
				{
					NHANHLLJDCO = CPJONHGOGKD.error;
					UnityEngine.Debug.LogError(string.Format("Downloading assetBundle {0} failed with error: {1}, depth: {2}", KIEOBOJBJBJ.name, NHANHLLJDCO, GJGDPOAOKFM));
					CPJONHGOGKD.Dispose();
					if (GJGDPOAOKFM == 5)
					{
			...
			case 1u:
				...
				if (CPJONHGOGKD.error != null)
				{
					...
					if (GJGDPOAOKFM == 3)
					{
						...
						array2[1] = KIEOBOJBJBJ.name;
						array2[0] = NHANHLLJDCO;
						WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("getKey", array2), string.Empty, 1346f, LKAHPHIEMEK, string.Empty, false, true);
						goto case 2u;
					}
		...
		public bool LGNMOMFLLPP()
		{
			...
			case 1u:
				...
				{
					LNFCEAHPLFP = BJGCPDNMHDH.IBENEMHDLAB + CPJONHGOGKD.progress * KIEOBOJBJBJ.size;
					LoadingDialog.SetText(Localization.LocalizeFormat("AssignmentData", LNFCEAHPLFP.ToString("nextDay"), BJGCPDNMHDH.LHNGLFBACFF.ToString("IsVip"), null, null), true);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 1;
				...
				if (CPJONHGOGKD.error != null)
				{
					...
					if (GJGDPOAOKFM == 3)
					{
						...
						array[0] = NHANHLLJDCO;
						WarningDialog.ShowError(Localization.LocalizeFormat("game-card-ico-bg-silver", array), string.Empty, 141f, FDKMOFHAEFN, string.Empty, true, true);
						goto case 2u;
					}
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.DBMCNLLMFKA(KIEOBOJBJBJ, DFHAAIFFLOE, GJGDPOAOKFM + 1));
					if (!FDKOKMKIIMG)
		...
		public bool NJBCJDFKGHO()
		{
			...
			case 1u:
				if (!CPJONHGOGKD.isDone)
				{
					...
					LoadingDialog.BKOEMIKFMHN(Localization.LocalizeFormat("M4B23N48RZF8CKPJ2QBR", array), true);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 0;
				...
				if (CPJONHGOGKD.error != null)
				{
					...
					if (GJGDPOAOKFM == 1)
					{
						...
						array2[0] = KIEOBOJBJBJ.name;
						array2[1] = NHANHLLJDCO;
						WarningDialog.ShowError(Localization.LocalizeFormat(".png", array2), string.Empty, 358f, JGHLGHMJJDG, string.Empty, true);
						goto case 2u;
					}
					PHDOCKCBJOF = Singleton<AssetBundleManager>.instance.StartCoroutine(BJGCPDNMHDH.AOOIJFDAALB(KIEOBOJBJBJ, DFHAAIFFLOE, GJGDPOAOKFM + 0));
					if (!FDKOKMKIIMG)
		...
		public bool FGAFKEKGPHF()
		{
			...
			case 1u:
				if (!CPJONHGOGKD.isDone)
				{
					...
					LoadingDialog.SetText(Localization.LocalizeFormat("ID_SAVEPERCENTLINE", array), true);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 0;
		...
		public bool GBLFIBDBMGE()
		{
			...
			case 1u:
				if (!CPJONHGOGKD.isDone)
				{
					...
					LoadingDialog.SetText(Localization.LocalizeFormat("WENEEDTO", array), true);
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
						CLPPIAGLCJJ = 1;
	...
	private KBABIPCFDBL EOMAALCCABH(string IMMNMGDBOOD, out string DEBFEDLKOBF)
	{
		...
		foreach (string key in array)
		{
			...
			KBABIPCFDBL value3;
			NLCHBEEDEKD.TryGetValue(key, out value3);
			if (value3 == null)
			{
				return null;
			}
	...
	{
		AssetBundleReference value;
		FDAHLGFPFFF.TryGetValue(FOLBNPDJELP, out value);
		return value;
	}
	...
	protected void MLNDMMGLILI(string IMMNMGDBOOD)
	{
		...
		if (allDependencies.Length != 0)
		{
			...
			{
				NDMIKOBHOPB(allDependencies[j], false);
			}
		}
	}
	...
	protected void DFFNBNOBFKA(string IMMNMGDBOOD)
	{
		...
		if (allDependencies.Length != 0)
		{
			...
			{
				NDMIKOBHOPB(allDependencies[j], true);
			}
		}
	}
	...
	private void Update()
	{
		...
		foreach (KeyValuePair<string, WWW> item in GLJHINKHCKJ)
		{
			...
			if (value.error != null)
			{
				BPDLLBDGFCI.Add(item.Key, value.error);
				list.Add(item.Key);
				UnityEngine.Debug.LogError(string.Format("Downloading assetBundle {0} failed with error: {1}", item.Key, value.error));
			}
			else if (value.isDone)
			{
				NLCHBEEDEKD.Add(item.Key, new KBABIPCFDBL(value.assetBundle));
	...
	protected void AAONMPBACOF(string IMMNMGDBOOD)
	{
		...
		if (allDependencies.Length != 0)
		{
			...
			{
				CILKLGHHKAC(allDependencies[j], false);
			}
		}
	}
