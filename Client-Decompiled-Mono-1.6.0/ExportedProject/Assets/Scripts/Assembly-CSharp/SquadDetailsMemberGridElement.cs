...
public class SquadDetailsMemberGridElement : PoolableObject
{
	...
	public void BEEFBNHPBKM(DatabasePlayer ALAJGOPHOAN, int MDOPFNNFLFB)
	{
		...
		Singleton<PlayerTexturePool>.instance.APIIPFCGDBO(ALAJGOPHOAN, false, PlayerTexturePool.DFJJOANIJID.Card);
		MPHCNMDIPAI.text = MEJMLNDFDBP.ACCGOIGJIAA(MDOPFNNFLFB);
		LevelManager.GameLevel levelDefinition = LevelManager.instance.GetLevelDefinition(ALAJGOPHOAN.level);
	...
	public virtual void EAFAMBKMLDJ()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.LBKLINGCPBA(EHHDLLGPNBG.id, true, true, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public virtual void IMBKPHGHFNI()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.PIKHCIHPMCE(EHHDLLGPNBG.id, false, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public virtual void KKMGMEKEPOD()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.FNHIOAADLFN(EHHDLLGPNBG.id, true, false, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public void GNLEOMDCMJL(DatabasePlayer ALAJGOPHOAN, int MDOPFNNFLFB)
	{
		...
		Singleton<PlayerTexturePool>.instance.IIMHJDIPNIA(ALAJGOPHOAN, true, PlayerTexturePool.DFJJOANIJID.Card);
		MPHCNMDIPAI.text = MEJMLNDFDBP.ACCGOIGJIAA(MDOPFNNFLFB);
		LevelManager.GameLevel levelDefinition = LevelManager.instance.GetLevelDefinition(ALAJGOPHOAN.level);
	...
	public virtual void LMMKHPNFJKK()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.LBKLINGCPBA(EHHDLLGPNBG.id, true, false, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public virtual void KIFFEEEDFPD()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.BPEHHBALINP(EHHDLLGPNBG.id, true, false, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	private void GKGNJAPFLIJ(GameObject KHAHPAKDIKE)
	{
		if (!string.IsNullOrEmpty(EHHDLLGPNBG.name))
		{
			...
			SoundsManager.Instance.PlayButtonClickedSound();
			GuiElementSingle<PlayerProfileDialog>.instance.ShowDialog(EHHDLLGPNBG.name, EHHDLLGPNBG.id, false);
		}
	}
	...
	public virtual void GICLKACEHJH()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.PIKHCIHPMCE(EHHDLLGPNBG.id, false, true, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public virtual void LJFBIDBACDI()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.IEPBDAHEKCL(EHHDLLGPNBG.id, true, false, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public virtual void OEMOOAENMHN()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.BPEHHBALINP(EHHDLLGPNBG.id, false, false, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public virtual void PBICPGAPNNH()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.PIKHCIHPMCE(EHHDLLGPNBG.id, false, false, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public void OCFFAINJBHL(DatabasePlayer ALAJGOPHOAN, int MDOPFNNFLFB)
	{
		...
		Singleton<PlayerTexturePool>.instance.AIBNEPFBFGB(ALAJGOPHOAN, true, PlayerTexturePool.DFJJOANIJID.Card);
		MPHCNMDIPAI.text = MEJMLNDFDBP.ACCGOIGJIAA(MDOPFNNFLFB);
		LevelManager.GameLevel levelDefinition = LevelManager.instance.GetLevelDefinition(ALAJGOPHOAN.level);
	...
	public override void OBCAIFMOPPA()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.PIKHCIHPMCE(EHHDLLGPNBG.id, true, true, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public void MOHGCGPHANE(DatabasePlayer ALAJGOPHOAN, int MDOPFNNFLFB)
	{
		...
		Singleton<PlayerTexturePool>.instance.IIMHJDIPNIA(ALAJGOPHOAN, false);
		MPHCNMDIPAI.text = MEJMLNDFDBP.ACCGOIGJIAA(MDOPFNNFLFB);
		LevelManager.GameLevel levelDefinition = LevelManager.instance.GetLevelDefinition(ALAJGOPHOAN.level);
	...
	public void JLEKOOCEDPC(DatabasePlayer ALAJGOPHOAN, int MDOPFNNFLFB)
	{
		...
		Singleton<PlayerTexturePool>.instance.AIBNEPFBFGB(ALAJGOPHOAN, false, PlayerTexturePool.DFJJOANIJID.Card);
		MPHCNMDIPAI.text = MEJMLNDFDBP.ACCGOIGJIAA(MDOPFNNFLFB);
		LevelManager.GameLevel levelDefinition = LevelManager.instance.GetLevelDefinition(ALAJGOPHOAN.level);
		GFKNLLCKJOG.spriteName = levelDefinition.EGNEDNBPOEF();
		GFKNLLCKJOG.MakePixelPerfect();
	...
	public virtual void GGDPJCEDGAA()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.MDANAEPCCHK(EHHDLLGPNBG.id, false);
		}
		EHHDLLGPNBG = null;
	}
	...
	public virtual void DKMEHOEOADL()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.FNHIOAADLFN(EHHDLLGPNBG.id, false, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public void KKIECDOFBEO(DatabasePlayer ALAJGOPHOAN, int MDOPFNNFLFB)
	{
		...
		Singleton<PlayerTexturePool>.instance.RequestPlayerTexture(ALAJGOPHOAN, true, PlayerTexturePool.DFJJOANIJID.Card);
		MPHCNMDIPAI.text = MEJMLNDFDBP.ACCGOIGJIAA(MDOPFNNFLFB);
		LevelManager.GameLevel levelDefinition = LevelManager.instance.GetLevelDefinition(ALAJGOPHOAN.level);
		GFKNLLCKJOG.spriteName = levelDefinition.EGNEDNBPOEF();
		GFKNLLCKJOG.MakePixelPerfect();
	...
	public void IMDBFKDHCAM(DatabasePlayer ALAJGOPHOAN, int MDOPFNNFLFB)
	{
		...
		Singleton<PlayerTexturePool>.instance.CCMGACIMGMF(ALAJGOPHOAN, false, PlayerTexturePool.DFJJOANIJID.Card);
		MPHCNMDIPAI.text = MEJMLNDFDBP.ACCGOIGJIAA(MDOPFNNFLFB);
		LevelManager.GameLevel levelDefinition = LevelManager.instance.GetLevelDefinition(ALAJGOPHOAN.level);
		GFKNLLCKJOG.spriteName = levelDefinition.KJFPCOMOLLD();
		GFKNLLCKJOG.MakePixelPerfect();
	...
	public virtual void HOCPBJGFEON()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.IEPBDAHEKCL(EHHDLLGPNBG.id, true, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public void DDLCKFECGNI(DatabasePlayer ALAJGOPHOAN, int MDOPFNNFLFB)
	{
		...
		Singleton<PlayerTexturePool>.instance.RequestPlayerTexture(ALAJGOPHOAN, false, PlayerTexturePool.DFJJOANIJID.Card);
		MPHCNMDIPAI.text = MEJMLNDFDBP.ACCGOIGJIAA(MDOPFNNFLFB);
		LevelManager.GameLevel levelDefinition = LevelManager.instance.GetLevelDefinition(ALAJGOPHOAN.level);
		GFKNLLCKJOG.spriteName = levelDefinition.GIEIIPBAIBK();
		GFKNLLCKJOG.MakePixelPerfect();
	...
	public virtual void GLGEJMMPGIF()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.DAGIACKCPKH(EHHDLLGPNBG.id, true, false, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public virtual void PCDBEEACOKN()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.DAGIACKCPKH(EHHDLLGPNBG.id, false, true, true);
		}
		EHHDLLGPNBG = null;
	}
	...
	public void DNGADMNKFAI(DatabasePlayer ALAJGOPHOAN, int MDOPFNNFLFB)
	{
		...
		Singleton<PlayerTexturePool>.instance.MFKFEHJBEPA(ALAJGOPHOAN, false, PlayerTexturePool.DFJJOANIJID.Card);
		MPHCNMDIPAI.text = MEJMLNDFDBP.ACCGOIGJIAA(MDOPFNNFLFB);
		LevelManager.GameLevel levelDefinition = LevelManager.instance.GetLevelDefinition(ALAJGOPHOAN.level);
		GFKNLLCKJOG.spriteName = levelDefinition.GIEIIPBAIBK();
		GFKNLLCKJOG.MakePixelPerfect();
	...
	public virtual void PDFILOJGOMM()
	{
		...
		if (EHHDLLGPNBG != null)
		{
			Singleton<PlayerTexturePool>.instance.PIKHCIHPMCE(EHHDLLGPNBG.id, true, true);
		}
		EHHDLLGPNBG = null;
	}
