...
public class LPDEOBOCICH
{
	...
	private void HJKFJJNJGLB(CKIENDMMJOG ENCEFOOPBMK)
	{
		...
		case MHNMOFPPKBN.LootBox:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("Lootbox", true);
			break;
		case MHNMOFPPKBN.Dogtag:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("DogTags", true);
			break;
		case MHNMOFPPKBN.RandomCard:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("WarCards", true);
			break;
		case MHNMOFPPKBN.GoldenSuitcase:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("Golden_Suitcase", true);
			break;
		}
	...
	private void IHECNCPHABK()
	{
		...
		{
		case MHNMOFPPKBN.Dogtag:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("extraDecal", false);
			break;
		case MHNMOFPPKBN.GoldenSuitcase:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("[{0}] {1}", false);
			break;
		case MHNMOFPPKBN.LootBox:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("2 RATE APP REMINDER\tLast game won: True\tVersion: {0}\tShown Times in this version: {1}/{2}\tTotal ranked wins: {3}?={4}\tIs level up: {5}\tLevel: {6}?={7}/{8}\tAfter update: {9}", false);
			break;
		case MHNMOFPPKBN.RandomCard:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("ID_CATEGORY_LOW_SG_SNIPER", false);
			break;
		}
		CONDGKMDFPJ = MHNMOFPPKBN.None;
	}
	...
	private void MHMHFOBCGNG()
	{
		...
		{
		case MHNMOFPPKBN.Dogtag:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("DogTags", false);
			break;
		case MHNMOFPPKBN.GoldenSuitcase:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("Golden_Suitcase", false);
			break;
		case MHNMOFPPKBN.LootBox:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("Lootbox", false);
			break;
		case MHNMOFPPKBN.RandomCard:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("WarCards", false);
			break;
		}
		CONDGKMDFPJ = MHNMOFPPKBN.None;
	}
	...
	private void OBMFMOBLPFO()
	{
		...
		{
		case MHNMOFPPKBN.RandomCard:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("Directory \"{0}\" does not exists", true);
			break;
		case MHNMOFPPKBN.Dogtag:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("The image effect ", true);
			break;
		case MHNMOFPPKBN.GoldenSuitcase:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("Done: {0} players", false);
			break;
		case MHNMOFPPKBN.None:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("Visual", true);
			break;
		}
		CONDGKMDFPJ = MHNMOFPPKBN.None;
	}
	...
	private void JEGKMLOAKCA()
	{
		...
		{
		case MHNMOFPPKBN.RandomCard:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("ЕЩЕ ПОПЫТКА", false);
			break;
		case MHNMOFPPKBN.Dogtag:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("SetUpKevlarNetwork", false);
			break;
		case MHNMOFPPKBN.GoldenSuitcase:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd("ID_X_CARDS", true);
			break;
		case MHNMOFPPKBN.None:
			Singleton<EventTrackingManager>.instance.RegisterWatchAd(";", true);
			break;
		}
		CONDGKMDFPJ = MHNMOFPPKBN.None;
	}
