...
public abstract class LevelBehaviour : Core_BaseScript
{
	...
	public string unitTypeName
	{
		get
		{
			return GameVariables.NAKDNAEPGOF[unitType].Value1;
		}
	}

	public string unitTypeNameHUD
	{
		get
		{
			return Localization.Localize(GameVariables.NAKDNAEPGOF[unitType].Value4);
		}
	}
	...
	public string unitTypeIcon
	{
		get
		{
			return GameVariables.NAKDNAEPGOF[unitType].Value2;
		}
	}
	...
	public string unitTypeDescription
	{
		get
		{
			return GameVariables.NAKDNAEPGOF[unitType].Value3;
		}
	}
	...
	public int totalPower
	{
		get
		{
			return Singleton<GameController>.instance.mainController.GetUnitPower(this);
		}
	}
	...
	public bool hasCardVariant
	{
		get
		{
			return upgradeSlots.excel.GetRowIndex("CARDS_MIN") > 0 && !string.IsNullOrEmpty(cardId);
		}
	}
	...
	public virtual void Unload()
	{
		if (unitModel != null)
		{
			MeshFilter[] componentsInChildren = unitModel.GetComponentsInChildren<MeshFilter>(true);
