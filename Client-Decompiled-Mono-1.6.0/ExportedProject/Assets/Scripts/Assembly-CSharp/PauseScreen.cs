...
public class PauseScreen : GuiElementSingle<PauseScreen>, PAIIOKBBHBC
{
	...
	{
		CCHDMDPGMJK.gameObject.SetActive(false);
	...
	{
		JMMAHFEOLGG.SetActive(true);
		GameLoginManager.instance.LogoutFromFacebook(true);
		NOHDFMODCEG.SetActive(true);
	}
	...
	{
		CCHDMDPGMJK.gameObject.SetActive(true);
