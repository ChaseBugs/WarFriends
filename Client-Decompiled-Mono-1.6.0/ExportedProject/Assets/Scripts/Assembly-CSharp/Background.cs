...
public class Background : GuiElementSingle<Background>
{
	...
	public virtual void JOEHMGCKEKE()
	{
		...
		if (IBCDMOOPLNN != null)
		{
			IBCDMOOPLNN.SetActive(false);
		}
		BFJNDDGKIHH.gameObject.SetActive(false);
	}
	...
	{
		GIOENEIKPCH.gameObject.SetActive(false);
		if (IBCDMOOPLNN != null)
		{
			IBCDMOOPLNN.SetActive(true);
		}
	...
	public void AMBPEPHNPEL(NKHJBLBAAEB LGMALHPGKOK)
	{
		if (KNCCEDFJKBK != LGMALHPGKOK)
		{
			if (LGMALHPGKOK == NKHJBLBAAEB.Classic)
			{
				...
				FFPLNCHHFDP.gameObject.SetActive(true);
				FFPLNCHHFDP.Play();
			}
			else
			{
	...
	public void BJEAELGNEGB(NKHJBLBAAEB LGMALHPGKOK)
	{
		if (KNCCEDFJKBK != LGMALHPGKOK)
		{
			if (LGMALHPGKOK == NKHJBLBAAEB.Classic)
			{
				...
				FFPLNCHHFDP.gameObject.SetActive(false);
				FFPLNCHHFDP.Play();
			}
			else
			{
	...
	{
		GIOENEIKPCH.gameObject.SetActive(true);
		if (IBCDMOOPLNN != null)
		{
			IBCDMOOPLNN.SetActive(true);
		}
	...
	public override void DoBeforeShowUp()
	{
		...
		BFJNDDGKIHH.gameObject.SetActive(true);
	}
