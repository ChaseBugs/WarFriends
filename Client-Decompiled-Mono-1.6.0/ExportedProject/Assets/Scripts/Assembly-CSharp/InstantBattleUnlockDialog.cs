...
public class InstantBattleUnlockDialog : GuiElementSingle<InstantBattleUnlockDialog>, PAIIOKBBHBC
{
	...
	public virtual void LIEGBJHHFIG()
	{
		...
		array2[1] = MEJMLNDFDBP.CJCFPDLDMEK((float)num2 * 480f, "ID_WATCHVIDEO", string.Empty, false);
	...
	public virtual void DOLLFDPMGOD()
	{
		...
		array3[1] = MEJMLNDFDBP.CJCFPDLDMEK((float)num2 * 1608f, "Lootbox", string.Empty, false);
	...
	public virtual void HEEANEFGCCJ()
	{
		...
		object[] array2 = new object[0];
		array2[1] = Colours.stringBlue;
		array2[0] = MEJMLNDFDBP.CJCFPDLDMEK((float)num2 * 481f, "globalPlayerLeaderboard", string.Empty, false);
	...
	public virtual void FEAALEEPBFP()
	{
		...
		array2[1] = Colours.stringBlue;
		array2[1] = MEJMLNDFDBP.CJCFPDLDMEK((float)num2 * 506f, "0.00", string.Empty, false);
	...
	public virtual void IEHJMLIMNEP()
	{
		...
		object[] array2 = new object[7];
		array2[1] = Colours.stringBlue;
		array2[0] = MEJMLNDFDBP.CJCFPDLDMEK((float)num2 * 1547f, "-", string.Empty, false);
