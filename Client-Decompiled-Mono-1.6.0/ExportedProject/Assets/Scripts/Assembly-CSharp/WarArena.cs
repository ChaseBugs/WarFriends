...
public class WarArena : DatabaseSerializedObjectGeneric<WarArena.WarArenaData>
{
	...
	public static WarArena instance
	{
		get
		{
			BJHPKLAEFCI = BJHPKLAEFCI ?? ((WarArena)UnityEngine.Object.FindObjectsOfType(typeof(WarArena))[0]);
			return BJHPKLAEFCI;
		}
	}

	public WarArenaParameters warArenaParameters
	{
		get
		{
			return PNEHGOINBBF;
	...
	public ArenaLootboxes arenaLootboxes
	{
		get
		{
	...
	public bool isArenaTicketBought
	{
		get
		{
	...
	public bool isGoodPing
	{
		get
		{
			return CKHHAAJEBBN.DAMNJODDMNA;
		}
	}
	...
	public int remainigTimeTillStart
	{
		get
		{
	...
	public int remainigTimeTillEnd
	{
		get
		{
			return Mathf.Max(0, FPLIPHCJGFO.NGPMJNJPNMB - Singleton<BeanstalkServerManager>.instance.currentTimestamp);
		}
	}

	public bool goldShieldsActive
	{
		get
		{
	...
	public int phaseNumber
	{
		get
		{
			return FPLIPHCJGFO.NBLGBIJJPNA;
		}
	}
	...
	public List<WarArenaRule> currenArenaRules
	{
		get
		{
			return NDIJMGCAJAO;
	...
	public List<WarArenaRule> DeserializeRules(string NGBOOPEALCG)
	{
		...
		foreach (KeyValuePair<string, JToken> item in dictionary)
		{
			...
			{
				UnityEngine.Debug.LogError(string.Format("cant deserialize rule {0}", item.Key));
			}
		}
		return list;
	}
	...
	public bool SetupRules()
	{
		...
		foreach (WarArenaRule item in NDIJMGCAJAO)
		{
			...
			UnityEngine.Debug.Log(string.Format("Mode with name {0} met criteria {1} ", item.GetType(), flag2));
			flag = flag && flag2;
		}
		return flag;
	}
