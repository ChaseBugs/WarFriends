...
public class ReportUserDialog : GuiElementSingle<ReportUserDialog>, PAIIOKBBHBC
{
	...
	private void JJIDIKGPDAP(GameObject KHAHPAKDIKE)
	{
		if (base.isFullyShowed)
		{
			...
			Debug.Log(string.Format("Submited: \"{0}\" for player: \"{1}\" rank:{2} AP:{3} and my rank:{4} AP:{5}. Match duration: {6}", OLOLINICHII, GCNLDDCMBEO, num2, MEJMLNDFDBP.GMIPFLIEOHD(num), displayNumber, MEJMLNDFDBP.GMIPFLIEOHD(armyPowerX), MEJMLNDFDBP.GGDHFCCNAND(matchTime)));
