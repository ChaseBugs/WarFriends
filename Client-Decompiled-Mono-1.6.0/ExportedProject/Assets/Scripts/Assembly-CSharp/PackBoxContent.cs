...
public class PackBoxContent : Core_BaseScript
{
	...
	{
		DOHKEJCIJMC.SetActive(true);
		OEBBKCIHDFF.SetActive(true);
		...
		DFOLKBGCIFL.gameObject.SetActive(false);
		EMIKKLKIPNJ.gameObject.SetActive(false);
		FIHDDPJFFDG.gameObject.SetActive(false);
		JBCBEOCNJBH.gameObject.SetActive(false);
		GDBGLCLOKPA.gameObject.SetActive(false);
		CODFFPODNEP.gameObject.SetActive(false);
		AGEEJIHGKID.gameObject.SetActive(false);
	}
	...
	public void EGPIGOALKKG(PlayerVisual LOKDBPPOLPM)
	{
		...
		DFOLKBGCIFL.gameObject.SetActive(true);
		...
		OEBBKCIHDFF.SetActive(false);
		EMIKKLKIPNJ.gameObject.SetActive(true);
		FIHDDPJFFDG.gameObject.SetActive(false);
		JBCBEOCNJBH.gameObject.SetActive(false);
		GDBGLCLOKPA.gameObject.SetActive(true);
		CODFFPODNEP.gameObject.SetActive(true);
		AGEEJIHGKID.gameObject.SetActive(false);
		DOHKEJCIJMC.SetActive(true);
	}
	...
	public void GFOCLFFCPMI(int IDLMJLCFMJG, bool FHCJJDGLHDJ = false)
	{
		...
		DFOLKBGCIFL.gameObject.SetActive(true);
		EMIKKLKIPNJ.gameObject.SetActive(false);
		FIHDDPJFFDG.gameObject.SetActive(true);
		JBCBEOCNJBH.gameObject.SetActive(true);
		GDBGLCLOKPA.gameObject.SetActive(false);
		CODFFPODNEP.gameObject.SetActive(true);
		AGEEJIHGKID.gameObject.SetActive(false);
	}
	...
	public void CBLALLLMDAE()
	{
		...
		GDBGLCLOKPA.gameObject.SetActive(false);
		CODFFPODNEP.gameObject.SetActive(false);
		AGEEJIHGKID.gameObject.SetActive(true);
		DOHKEJCIJMC.SetActive(false);
