...
public class ArmyPowerAnimation : Core_BaseScript
{
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(INOLIBMAEAN.gameObject, HAMKIKMJHDP * 1410f, OEFKMAKMIBP, false);
	...
	public void FJCEDOKNCCI()
	{
		...
		TweenPosition.Begin(FDDFBILDABL.gameObject, 800f, OEFKMAKMIBP, false).onFinished = null;
	...
	private void FHCMJMIEICE(int EEGALFIEINM)
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(INOLIBMAEAN.gameObject, HAMKIKMJHDP * 1265f, IBCFBIJILKI, PDJMCCPKHKI, false);
		tweenPosition.method = UITweener.Method.EaseIn;
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(FDDFBILDABL.gameObject, HAMKIKMJHDP * 1261f, new Vector3(OEFKMAKMIBP.x, OEFKMAKMIBP.y - OPPBAMHIDCI, ECICBNIKMHM.z), ECICBNIKMHM, false);
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(INOLIBMAEAN.gameObject, HAMKIKMJHDP * 1996f, OEFKMAKMIBP, false);
		tweenPosition.method = (UITweener.Method)8;
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(FDDFBILDABL.gameObject, HAMKIKMJHDP * 522f, CKMCPJAPGAI, false);
	...
	private void NGAKNOHHFLF(int EEGALFIEINM)
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(INOLIBMAEAN.gameObject, HAMKIKMJHDP * 718f, IBCFBIJILKI, PDJMCCPKHKI, false);
		tweenPosition.method = UITweener.Method.Linear;
		tweenPosition.onFinished = CEMJIHDEEEM;
	}
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(FDDFBILDABL.gameObject, HAMKIKMJHDP * 120f, CKMCPJAPGAI, false);
		tweenPosition.method = UITweener.Method.EaseIn;
		tweenPosition.onFinished = AODJGEDEBPM;
	}
	...
	private void CEMJIHDEEEM(UITweener JJKHNINFEJB)
	{
		...
		TweenPosition tweenPosition2 = TweenPosition.Begin(MCEABPKAIAD.gameObject, HAMKIKMJHDP * 1148f, LGHHDJMNLFL, CKMCPJAPGAI, false);
		tweenPosition2.onFinished = HBJJAGHEACP;
	}
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(INOLIBMAEAN.gameObject, HAMKIKMJHDP * 636f, OEFKMAKMIBP, false);
	...
	private void AOEHOMGMCEF()
	{
		...
		TweenPosition.Begin(FDDFBILDABL.gameObject, HAMKIKMJHDP * 150f, CKMCPJAPGAI, NPAGECEAPJJ, false).onFinished = null;
	...
	private void IHFADOMALOE()
	{
		...
		TweenPosition.Begin(FDDFBILDABL.gameObject, HAMKIKMJHDP * 514f, CKMCPJAPGAI, NPAGECEAPJJ, false).onFinished = null;
