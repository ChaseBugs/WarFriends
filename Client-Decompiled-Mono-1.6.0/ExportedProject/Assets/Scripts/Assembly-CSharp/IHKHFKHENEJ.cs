...
internal class IHKHFKHENEJ : HHFHFANGCEJ
{
	...
	public IHKHFKHENEJ(string KJBPJOMHNKB)
		: base(string.Format("WelcomeBackSoldierMessage {0} {1}", KJBPJOMHNKB, Singleton<BeanstalkServerManager>.instance.currentTimestamp), NKHJBLBAAEB.WelcomBackSoldierMessage)
	{
