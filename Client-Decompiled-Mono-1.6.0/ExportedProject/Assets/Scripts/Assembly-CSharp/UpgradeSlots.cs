...
public abstract class UpgradeSlots : Core_BaseScript
{
	...
	public string iconNameElite
	{
		get
		{
			return iconName + ((!upgradeSlotElite.isUnlocked) ? string.Empty : "-elite");
		}
	}

	public string iconNameVeteran
	{
		get
		{
			return iconName + "-veteran";
		}
	}
	...
	public int unlockLevelIndex
	{
		get
		{
			return armyUpgradesRow.UNLOCKLEVEL - 1;
		}
	}
	...
	public int priceGold
	{
		get
		{
			return armyUpgradesRow.PRICEGOLD;
		}
	}

	public int unitDeliveryTime
	{
		get
		{
			return armyUpgradesRow.DELIVERTIME;
		}
	}

	public int startUnitLevel
	{
		get
		{
			return (armyUpgradesRow != null) ? armyUpgradesRow.STARTINGLEVEL : 0;
		}
	}
	...
	public int startTier
	{
		get
		{
			return armyUpgradesRow.STARTINGTIER;
		}
	}
	...
	public float bulletSpeed
	{
		get
		{
			return armyUpgradesRow.BULLETSPEED;
		}
	}
	...
	public float playerBehindShieldDamageRatio
	{
		get
		{
			return armyUpgradesRow.PLAYERBEHINDSHIELDDMGRATIO;
		}
	}
	...
	public float playerDamageRatio
	{
		get
		{
			return armyUpgradesRow.PLAYERDAMAGERATIO;
		}
	}

	public float playerDamageOvertimeRatio
	{
		get
		{
			return armyUpgradesRow.PLAYERDAMAGEOVERTIMERATIO;
		}
	}
	...
	public int totalPower
	{
		get
		{
			return armyUpgradesRow.TOTALPOWER;
		}
	}
	...
	public float coolDown
	{
		get
		{
			return armyUpgradesRow.COOLDOWN;
		}
	}

	public float shieldHitProbability
	{
		get
		{
			return armyUpgradesRow.HITSHIELDPROB;
		}
	}
	...
	public string spawns
	{
		get
		{
			...
			return sPAWNS.Replace(" ", string.Format(" {0}/{1} ", Colours.stringGray, Colours.stringWhite));
		}
	}
	...
	public float movementSpeed
	{
		get
		{
			return armyUpgradesRow.MOVEMENTSPEED;
		}
	}

	public float soldierRespawnRate
	{
		get
		{
			return armyUpgradesRow.UNITINMECHANICALRESPAWN;
		}
	}

	public virtual string shotDamageName
	{
		get
		{
			return Localization.Localize("ID_SHOTDAMAGE");
		}
	}
	...
	public virtual List<Tuple<string, float>> unitSpecifics
	{
		get
		{
	...
	public virtual bool isSpecificTime
	{
		get
		{
			return false;
	...
	public int instantUnitDeliveryPrice
	{
		get
		{
			...
			int num2 = Singleton<OfferManager>.instance.DiscountedUnityDeliveryCost(owner.unitType, owner, false);
			if (num2 > 0)
			{
	...
	public bool canBeUpgraded
	{
		get
		{
			return actualUnitLevel < actualMaxUnitLevel;
		}
	}
	...
	public bool canBuy
	{
		get
		{
			return !delivering && !deliveryActivationNeeded;
		}
	}
	...
	public bool isDeliveringOrDelivered
	{
		get
		{
			return unitState == JLANLLEABDC.UnitDelivering || unitState == JLANLLEABDC.UnitDelivered || unitState == JLANLLEABDC.Delivering || unitState == JLANLLEABDC.Delivered;
		}
	}
	...
	public bool canBeBought
	{
		get
		{
			return LevelManager.instance.currentLevel.index >= armyUpgradesRow.CANBEBOUGHT - 1;
		}
	}
	...
	public int actualUnitLevel
	{
		get
		{
			return bought ? (upgradeSlot.boughtIndex + startUnitLevel) : 0;
		}
	}

	public int unlockTierLevel
	{
		get
		{
			return GetUnlockLevelForNextTier(actualTier);
		}
	}

	public bool isPromoteToNextTierLocked
	{
		get
		{
			return unlockTierLevel > LevelManager.instance.currentLevel.displayNumber;
		}
	}
	...
	public int actualMinUnitLevel
	{
		get
		{
			return upgradeSlot.minRowForActualTier + startUnitLevel;
		}
	}

	public int actualMaxUnitLevel
	{
		get
		{
			return upgradeSlot.maxRowForActualTier + startUnitLevel;
		}
	}

	public float actualUpgradeProgress
	{
		get
		{
			return (float)(actualUnitLevel - actualMinUnitLevel) / (float)(actualMaxUnitLevel - actualMinUnitLevel);
		}
	}

	public bool allUpgradesBought
	{
		get
		{
			return upgradeSlot.isMaxUpgraded && upgradeSlotSpecial.isMaxUpgraded && upgradeSlotElite.isMaxUpgraded;
		}
	}
	...
	public int numberOfUpgrades
	{
		get
		{
			return upgradeSlot.maxPower;
		}
	}

	public int maxLevelOfUnit
	{
		get
		{
			return upgradeSlot.maxPower + startUnitLevel - 1;
		}
	}
	...
	public float armyPower
	{
		get
		{
			return GetArmyPower(upgradeSlot.boughtIndex, upgradeSlotSpecial.boughtIndexAbsolute, actualTier, upgradeSlotElite.boughtIndexAbsolute, upgradeSlotElite.isBought);
		}
	}
	...
	public int armyPowerX10
	{
		get
		{
			return GetArmyPowerX10(upgradeSlot.boughtIndex, upgradeSlotSpecial.boughtIndexAbsolute, actualTier, upgradeSlotElite.boughtIndexAbsolute, upgradeSlotElite.isBought);
		}
	}

	public int armyPowerX10Max
	{
		get
		{
			return GetArmyPowerX10(upgradeSlot.maxIndexInExcel, upgradeSlotSpecial.maxIndexInExcel, 6, upgradeSlotElite.maxIndexInExcel, upgradeSlotElite.isUnlocked);
		}
	}

	public int armyPowerX10NextSlot
	{
		get
		{
			return GetArmyPowerX10(upgradeSlot.boughtIndex + 1, upgradeSlotSpecial.boughtIndexAbsolute, actualTier, upgradeSlotElite.boughtIndexAbsolute, upgradeSlotElite.isBought);
		}
	}

	public int armyPowerX10NextSpecialSlot
	{
		get
		{
			return GetArmyPowerX10(upgradeSlot.boughtIndex, upgradeSlotSpecial.boughtIndexAbsolute + 1, actualTier, upgradeSlotElite.boughtIndexAbsolute, upgradeSlotElite.isBought);
		}
	}

	public int armyPowerX10NextEliteSlot
	{
		get
		{
			return GetArmyPowerX10(upgradeSlot.boughtIndex, upgradeSlotSpecial.boughtIndexAbsolute, actualTier, upgradeSlotElite.boughtIndexAbsolute + 1, upgradeSlotElite.isBought);
		}
	}
	...
	public int boughtIndex
	{
		get
		{
			return upgradeSlot.boughtIndex;
		}
	}
	...
	public LevelManager.SavedArmySlots GetArmySlot()
	{
		...
		LevelManager.SavedArmySlots value;
		if (LevelManager.instance.data.savedArmies.TryGetValue(GetSheetName(), out value))
		{
			return value;
		}
	...
	public UnitUpgrades LoadDataForWarArena(LevelBehaviour behaviour)
	{
		...
		if (num < 0)
		{
			UnityEngine.Debug.LogError(string.Format("{0} doesn't contain data for wararena unit", excel.GetType()));
			num = 0;
		}
	...
	public void LoadDataForCard(LevelBehaviour behaviour, float progress)
	{
		...
		if (num < 0 || num2 < 0)
		{
			UnityEngine.Debug.LogError(string.Format("{0} doesn't contain data for card unit", excel.GetType()));
			num = 0;
			num2 = 0;
		}
		LoadData(behaviour, new UnitUpgrades(1f)
