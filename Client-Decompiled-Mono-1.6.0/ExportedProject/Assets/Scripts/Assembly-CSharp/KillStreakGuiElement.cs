...
public class KillStreakGuiElement : GuiElementSingle<KillStreakGuiElement>
{
	...
	private void EHAEEAGIBKL()
	{
		if (Singleton<ScoreManager>.instance.KFPGCFFPIJK && !AFLBIONHLKM)
		{
			...
			JIIIODFEBOO.gameObject.SetActive(false);
		}
		if (NHEKOBJPBGE)
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, 26f, Time.deltaTime * TimeManager.GetTimeScaledSpeed(1263f, true));
		}
		else
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, Singleton<ScoreManager>.instance.FJJPIMGNPHN(), Time.deltaTime * TimeManager.JIJLKEFLPGM(1002f, true));
		}
	...
	private void FBOOFNDODAM()
	{
		if (Singleton<ScoreManager>.instance.KFPGCFFPIJK && !AFLBIONHLKM)
		{
			...
			JIIIODFEBOO.gameObject.SetActive(true);
		}
		if (NHEKOBJPBGE)
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, 679f, Time.deltaTime * TimeManager.JIJLKEFLPGM(1152f, true));
		}
		else
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, Singleton<ScoreManager>.instance.FJJPIMGNPHN(), Time.deltaTime * TimeManager.GetTimeScaledSpeed(1056f, false));
		}
	...
	private void FBONAMCJOBK()
	{
		...
		if (NHEKOBJPBGE)
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, 1647f, Time.deltaTime * TimeManager.GetTimeScaledSpeed(1227f, true));
		}
		else
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, Singleton<ScoreManager>.instance.HENCANCBCBI(), Time.deltaTime * TimeManager.GetTimeScaledSpeed(778f, false));
		}
	...
	private void OFNMHNFHAON()
	{
		...
		if (NHEKOBJPBGE)
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, 100f, Time.deltaTime * TimeManager.GetTimeScaledSpeed(8f, true));
		}
		else
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, Singleton<ScoreManager>.instance.killStreakProgress, Time.deltaTime * TimeManager.GetTimeScaledSpeed(5f, true));
		}
	...
	private void BJICEFJGIDP()
	{
		...
		if (NHEKOBJPBGE)
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, 1703f, Time.deltaTime * TimeManager.GetTimeScaledSpeed(1861f, true));
		}
		else
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, Singleton<ScoreManager>.instance.JCNIABKCHGD(), Time.deltaTime * TimeManager.JIJLKEFLPGM(512f, false));
		}
	...
	private void HFPFGHKIJKA()
	{
		...
		if (NHEKOBJPBGE)
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, 12f, Time.deltaTime * TimeManager.GetTimeScaledSpeed(938f, true));
		}
		else
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, Singleton<ScoreManager>.instance.HENCANCBCBI(), Time.deltaTime * TimeManager.GDNKNLEDMGG(1209f, false));
		}
	...
	private void AAJAAABFBCJ()
	{
		...
		if (NHEKOBJPBGE)
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, 1592f, Time.deltaTime * TimeManager.GDNKNLEDMGG(1973f, false));
		}
		else
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, Singleton<ScoreManager>.instance.FJJPIMGNPHN(), Time.deltaTime * TimeManager.GDNKNLEDMGG(99f, true));
		}
	...
	private void KKAHLDFBANB()
	{
		...
		if (NHEKOBJPBGE)
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, 673f, Time.deltaTime * TimeManager.GetTimeScaledSpeed(743f, true));
		}
		else
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, Singleton<ScoreManager>.instance.JCNIABKCHGD(), Time.deltaTime * TimeManager.GetTimeScaledSpeed(170f, true));
		}
	...
	private void GGKHHKJCDDE()
	{
		...
		if (NHEKOBJPBGE)
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, 1876f, Time.deltaTime * TimeManager.GDNKNLEDMGG(1939f, false));
		}
		else
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, Singleton<ScoreManager>.instance.HENCANCBCBI(), Time.deltaTime * TimeManager.GDNKNLEDMGG(1210f, true));
		}
	...
	private void ENPAJKPFANI()
	{
		...
		if (NHEKOBJPBGE)
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, 1164f, Time.deltaTime * TimeManager.JIJLKEFLPGM(271f, false));
		}
		else
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, Singleton<ScoreManager>.instance.killStreakProgress, Time.deltaTime * TimeManager.GDNKNLEDMGG(742f, true));
		}
	...
	private void MKLKLIAGCOF()
	{
		...
		if (NHEKOBJPBGE)
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, 1558f, Time.deltaTime * TimeManager.GDNKNLEDMGG(1350f, true));
		}
		else
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, Singleton<ScoreManager>.instance.JCNIABKCHGD(), Time.deltaTime * TimeManager.JIJLKEFLPGM(711f, false));
		}
	...
	private void CCPLJMENBOF()
	{
		...
		if (NHEKOBJPBGE)
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, 1509f, Time.deltaTime * TimeManager.JIJLKEFLPGM(912f, true));
		}
		else
		{
			AHIBFODJEEG = Mathf.Lerp(AHIBFODJEEG, Singleton<ScoreManager>.instance.JCNIABKCHGD(), Time.deltaTime * TimeManager.JIJLKEFLPGM(1422f, false));
		}
