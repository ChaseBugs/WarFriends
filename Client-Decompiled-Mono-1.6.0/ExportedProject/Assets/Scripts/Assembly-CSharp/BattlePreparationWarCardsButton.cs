...
public class BattlePreparationWarCardsButton : Core_BaseScript
{
		...
		public bool FBMLBIOKKBE()
		{
			...
			case 1u:
				if (CardCraftingManager.instance.isCardCrafting)
				{
					BJGCPDNMHDH.FOGKJMNKLNF.fillAmount = CardCraftingManager.instance.craftingProgress;
					BJGCPDNMHDH.FOGKJMNKLNF.color = Colours.cyan;
					BJGCPDNMHDH.NPLOCDGAKEJ(CardCraftingManager.instance.remainingSeconds, true);
		...
		public bool IGOKEIDOCKB()
		{
			...
			case 1u:
				if (CardCraftingManager.instance.isCardCrafting)
				{
					BJGCPDNMHDH.FOGKJMNKLNF.fillAmount = CardCraftingManager.instance.craftingProgress;
					BJGCPDNMHDH.FOGKJMNKLNF.color = Colours.cyan;
					BJGCPDNMHDH.JPGLDMCAFKP(CardCraftingManager.instance.remainingSeconds, true);
		...
		public bool CONJMMKAAGH()
		{
			...
			case 1u:
				if (CardCraftingManager.instance.isCardCrafting)
				{
					BJGCPDNMHDH.FOGKJMNKLNF.fillAmount = CardCraftingManager.instance.craftingProgress;
					BJGCPDNMHDH.FOGKJMNKLNF.color = Colours.cyan;
					BJGCPDNMHDH.JIFMDPIKOON(CardCraftingManager.instance.remainingSeconds, true);
	...
	private void HEJFEENIKNI()
	{
		...
		else if (CardCraftingManager.instance.isCardCrafting)
		{
			...
			FOGKJMNKLNF.fillAmount = CardCraftingManager.instance.craftingProgress;
			FOGKJMNKLNF.color = Colours.cyan;
			JIFMDPIKOON(CardCraftingManager.instance.remainingSeconds, true);
			EGHIPAMABPN();
		}
		else if (CardCraftingManager.instance.isCardCrafted)
		{
	...
	private void NILJMMJNLHC()
	{
		...
		else if (CardCraftingManager.instance.isCardCrafting)
		{
			...
			FOGKJMNKLNF.fillAmount = CardCraftingManager.instance.craftingProgress;
			FOGKJMNKLNF.color = Colours.cyan;
			ADOCEKGAKMO(CardCraftingManager.instance.remainingSeconds, true);
			MDEKLFICNKI();
		}
		else if (CardCraftingManager.instance.isCardCrafted)
		{
	...
	private void EEJHMINCDLP()
	{
		...
		else if (CardCraftingManager.instance.isCardCrafting)
		{
			...
			FOGKJMNKLNF.fillAmount = CardCraftingManager.instance.craftingProgress;
			FOGKJMNKLNF.color = Colours.cyan;
			LIKBDHJEHHB(CardCraftingManager.instance.remainingSeconds, true);
			LEFECCLELFG();
		}
		else if (CardCraftingManager.instance.isCardCrafted)
		{
	...
	private void NLFPMJFHGBC()
	{
		...
		else if (CardCraftingManager.instance.isCardCrafting)
		{
			...
			FOGKJMNKLNF.fillAmount = CardCraftingManager.instance.craftingProgress;
			FOGKJMNKLNF.color = Colours.cyan;
			NPLOCDGAKEJ(CardCraftingManager.instance.remainingSeconds, true);
			NBBBBJEBCHM();
		}
		else if (CardCraftingManager.instance.isCardCrafted)
		{
	...
	private void KCCBKEBMDDH(int EJEDANLAMBI, bool PDPDGCNHCFN = false)
	{
		if (CEDPEBDCIFK > EJEDANLAMBI)
		{
			...
			case 2:
				...
				break;
			case 1:
				FEBPMPKCCFF.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, " doesnt contain ", string.Empty, false);
				TweenAlpha.Begin(FEBPMPKCCFF.gameObject, (!PDPDGCNHCFN) ? 460f : 1607f, 777f);
				break;
			case 0:
				FEBPMPKCCFF.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "Beanstalk: Change Name and Password", string.Empty, false);
				break;
			}
		}
	}
	...
	private void DKEABOFDGKB()
	{
		...
		else if (CardCraftingManager.instance.isCardCrafting)
		{
			...
			FOGKJMNKLNF.fillAmount = CardCraftingManager.instance.craftingProgress;
			FOGKJMNKLNF.color = Colours.cyan;
			OKNGIJHJLOO(CardCraftingManager.instance.remainingSeconds, true);
			IJOCKFLFOIB();
		}
		else if (CardCraftingManager.instance.isCardCrafted)
		{
	...
	private void DAOABOIFOJE(int EJEDANLAMBI, bool PDPDGCNHCFN = false)
	{
		if (CEDPEBDCIFK > EJEDANLAMBI)
		{
			...
			{
			case 5:
				FEBPMPKCCFF.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "SquadIsPrivate", string.Empty, false);
			...
			case 2:
				...
				break;
			case 1:
				FEBPMPKCCFF.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "ID_TOGAINPOINTS", string.Empty, false);
				TweenAlpha.Begin(FEBPMPKCCFF.gameObject, (!PDPDGCNHCFN) ? 1211f : 851f, 1909f);
				break;
			case 0:
				FEBPMPKCCFF.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "setGoogleUserId", string.Empty, false);
				break;
			}
		}
	}
	...
	private void JIFMDPIKOON(int EJEDANLAMBI, bool PDPDGCNHCFN = false)
	{
		if (CEDPEBDCIFK > EJEDANLAMBI)
		{
			...
			{
			case 5:
				FEBPMPKCCFF.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "{0} {1}", string.Empty, false);
	...
	private void NPLOCDGAKEJ(int EJEDANLAMBI, bool PDPDGCNHCFN = false)
	{
		if (CEDPEBDCIFK > EJEDANLAMBI)
		{
			...
			{
			case 5:
				FEBPMPKCCFF.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "ID_FB_LOGIN_TUTORIAL_TEXT", string.Empty, false);
			...
			case 2:
				...
				break;
			case 1:
				FEBPMPKCCFF.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "StarterPackDays", string.Empty, false);
	...
	private void EBDIEIHCPLI()
	{
		...
		else if (CardCraftingManager.instance.isCardCrafting)
		{
			...
			FOGKJMNKLNF.fillAmount = CardCraftingManager.instance.craftingProgress;
			FOGKJMNKLNF.color = Colours.cyan;
			FMGIJNDPABH(CardCraftingManager.instance.remainingSeconds, true);
			IJOCKFLFOIB();
		}
		else if (CardCraftingManager.instance.isCardCrafted)
		{
	...
	private void ADOCEKGAKMO(int EJEDANLAMBI, bool PDPDGCNHCFN = false)
	{
		if (CEDPEBDCIFK > EJEDANLAMBI)
		{
			...
			{
			case 5:
				FEBPMPKCCFF.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "Waiting for map set", string.Empty, false);
			...
			case 2:
				...
				break;
			case 1:
				FEBPMPKCCFF.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "Player chose to stay on his account", string.Empty, false);
	...
	private void OKNGIJHJLOO(int EJEDANLAMBI, bool PDPDGCNHCFN = false)
	{
		if (CEDPEBDCIFK > EJEDANLAMBI)
		{
			...
			{
			case 5:
				FEBPMPKCCFF.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "menu-weaponstats-totalammo", string.Empty, false);
			...
			case 1:
				...
				break;
			case 0:
				FEBPMPKCCFF.text = MEJMLNDFDBP.CJCFPDLDMEK(EJEDANLAMBI, "ID_TUTORIAL_UPGRADEWEAPON_3", string.Empty, false);
				break;
			}
		}
	}
	...
	private void BLOKONMLBMJ()
	{
		...
		else if (CardCraftingManager.instance.isCardCrafting)
		{
			...
			FOGKJMNKLNF.fillAmount = CardCraftingManager.instance.craftingProgress;
			FOGKJMNKLNF.color = Colours.cyan;
			JPGLDMCAFKP(CardCraftingManager.instance.remainingSeconds, true);
			MDEKLFICNKI();
		}
		else if (CardCraftingManager.instance.isCardCrafted)
		{
