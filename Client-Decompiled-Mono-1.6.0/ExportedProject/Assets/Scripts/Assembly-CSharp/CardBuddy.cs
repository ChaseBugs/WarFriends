...
public class CardBuddy : Card
{
	...
	public override CardManager.CardType rarity
	{
		get
		{
			return CardManager.CardType.Buddy;
		}
	}

	public override int newFromMission
	{
		get
		{
			return 1;
	...
	public override string cardName
	{
		get
		{
			return (buddyCardData != null && !string.IsNullOrEmpty(buddyCardData.buddyName)) ? buddyCardData.buddyName : string.Empty;
		}
	}
	...
	public override string description
	{
		get
		{
			return Localization.LocalizeFormat("ID_CARD_DESC_BUDDY", Localization.Localize(GameVariables.NAKDNAEPGOF[buddyCardData.unityType].Value1).ToUpper(), buddyCardData.buddyName);
		}
	}
	...
	public string createDescription
	{
		get
		{
			return Localization.LocalizeFormat("ID_CARD_DESC_BUDDYCREATE", buddyCardData.buddyName);
		}
	}
	...
	public override int amount
	{
		get
		{
			return (buddyCardData != null) ? buddyCardData.amount : 0;
		}
	}

	public override string unitTypeSpriteName
	{
		get
		{
	...
	private static SoldierBehaviourBuddy ACLDFHJKBLI
	{
		get
		{
	...
	public virtual void IINFNLKGNON()
	{
		...
		DatabasePlayer kHLGDCHJJPB = databasePlayer;
		int num = Singleton<PlayerTexturePool>.instance.FreePlayerTexture(kHLGDCHJJPB, false);
		if (DebugSettings.debugEnabled)
		{
	...
	public override void HideInMenu()
	{
		...
		if (DebugSettings.debugEnabled)
		{
			UnityEngine.Debug.Log(string.Format("CARD BUDDY - HIDE IN MENU - Player: {0} actual reference count: {1}", id, num));
		}
		if (num <= 0)
		{
	...
	{
		int num = Singleton<PlayerTexturePool>.instance.FreePlayerTexture(id, false);
		DatabasePlayer databasePlayer = new DatabasePlayer();
		databasePlayer.id = id;
		databasePlayer.playerVisuals = ((buddyCardData == null) ? null : buddyCardData.equippedVisuals);
		DatabasePlayer kHLGDCHJJPB = databasePlayer;
		while (num > 0)
		{
			num = Singleton<PlayerTexturePool>.instance.FreePlayerTexture(kHLGDCHJJPB, false);
		}
		base.iconTexture = null;
		id = "DESTROYED REFERENCE";
		if (DebugSettings.debugEnabled)
		{
			UnityEngine.Debug.Log(string.Format("CARD BUDDY - DESTROY CARD - Player: {0}", id));
		}
	}
	...
	{
		int num = Singleton<PlayerTexturePool>.instance.DAGIACKCPKH(id, true, true, true);
		DatabasePlayer databasePlayer = new DatabasePlayer();
		databasePlayer.id = id;
		...
		while (num > 0)
		{
			num = Singleton<PlayerTexturePool>.instance.LKMHBGGBOOC(kHLGDCHJJPB, true, true, true);
		}
		base.iconTexture = null;
	...
	private void OLABLNKFMMJ(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		AIObject aIObject = SpawningManager.instance.LNHOMHGOIMM(ACLDFHJKBLI, playerController.fraction, pAENPHMEMGC, Vector3.one * 1711f, false, id);
	...
	private void KDOAIEKMLMC(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		AIObject aIObject = SpawningManager.instance.SpawnCardBehaviour(ACLDFHJKBLI, playerOld.fraction, pAENPHMEMGC, Vector3.one * 9999f, false, id);
		EnemyController enemyController = (EnemyController)aIObject;
		SoldierBehaviourBuddy soldierBehaviourBuddy = (SoldierBehaviourBuddy)enemyController.soldierBehaviour;
	...
	public virtual void KMNMNADAEHF()
	{
		...
		int num = Singleton<PlayerTexturePool>.instance.RequestPlayerTexture(kHLGDCHJJPB, true, PlayerTexturePool.DFJJOANIJID.Card);
		if (DebugSettings.debugEnabled)
		{
	...
	public virtual void LKPFCPANGHP()
	{
		...
		int num = Singleton<PlayerTexturePool>.instance.AIBNEPFBFGB(kHLGDCHJJPB, true, PlayerTexturePool.DFJJOANIJID.Card);
		if (DebugSettings.debugEnabled)
		{
	...
	public virtual void HPAGJJODGEA()
	{
		...
		DatabasePlayer kHLGDCHJJPB = databasePlayer;
		int num = Singleton<PlayerTexturePool>.instance.OLDICNMJBHD(kHLGDCHJJPB, true, true);
		if (DebugSettings.debugEnabled)
		{
	...
	public virtual void KDNIEKDBHDG()
	{
		...
		int num = Singleton<PlayerTexturePool>.instance.RequestPlayerTexture(kHLGDCHJJPB, false, PlayerTexturePool.DFJJOANIJID.Card);
		if (DebugSettings.debugEnabled)
		{
	...
	private void FCJGFPPIJLC(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		AIObject aIObject = SpawningManager.LDGAKJJINEO().NFIPLCDLACG(HEGFPDFKGOI(), playerOld.fraction, pAENPHMEMGC, Vector3.one * 1418f, true, id);
		EnemyController enemyController = (EnemyController)aIObject;
		SoldierBehaviourBuddy soldierBehaviourBuddy = (SoldierBehaviourBuddy)enemyController.soldierBehaviour;
	...
	public override void ShowInMenu()
	{
		...
		if (DebugSettings.debugEnabled)
		{
			UnityEngine.Debug.Log(string.Format("CARD BUDDY - SHOW IN MENU - Player: {0} actual reference count: {1}", id, num));
		}
	}
	...
	public virtual void FMAGKJIIFFH()
	{
		...
		int num = Singleton<PlayerTexturePool>.instance.RequestPlayerTexture(kHLGDCHJJPB, false);
		if (DebugSettings.debugEnabled)
		{
