...
public class PackContentDialog : GuiElementSingle<PackContentDialog>, PAIIOKBBHBC
{
	...
	{
		NGDFLDKCNGC.gameObject.SetActive(false);
		MDOIBOKBEHO.gameObject.SetActive(false);
		LMGOAHCLDDH.gameObject.SetActive(true);
		BDDMIDHPDKF.gameObject.SetActive(false);
		BBMHNPCPPBD.gameObject.SetActive(true);
		DJKMIAOPMOC.gameObject.SetActive(true);
		LFIGCJLPJHN.gameObject.SetActive(true);
		LMJKDIDALPI.gameObject.SetActive(true);
		MIKGHDGKLED.gameObject.SetActive(false);
		HGKEBMOFJPB.gameObject.SetActive(false);
	...
	{
		NGDFLDKCNGC.gameObject.SetActive(false);
		MDOIBOKBEHO.gameObject.SetActive(true);
		LMGOAHCLDDH.gameObject.SetActive(true);
		BDDMIDHPDKF.gameObject.SetActive(true);
		BBMHNPCPPBD.gameObject.SetActive(true);
		DJKMIAOPMOC.gameObject.SetActive(true);
		LFIGCJLPJHN.gameObject.SetActive(false);
		LMJKDIDALPI.gameObject.SetActive(true);
		MIKGHDGKLED.gameObject.SetActive(false);
		HGKEBMOFJPB.gameObject.SetActive(true);
	...
	{
		NGDFLDKCNGC.gameObject.SetActive(true);
		MDOIBOKBEHO.gameObject.SetActive(true);
		LMGOAHCLDDH.gameObject.SetActive(false);
		BDDMIDHPDKF.gameObject.SetActive(true);
		BBMHNPCPPBD.gameObject.SetActive(false);
		DJKMIAOPMOC.gameObject.SetActive(false);
		LFIGCJLPJHN.gameObject.SetActive(false);
		LMJKDIDALPI.gameObject.SetActive(false);
		MIKGHDGKLED.gameObject.SetActive(true);
		HGKEBMOFJPB.gameObject.SetActive(true);
		NDIFONPJHCK();
		AHHBOOKDBDI(5);
		...
		EGICOCDAAIL[3].InitializeIcon("menu-gold", JBIKIJKOPAI, 184f, 0f, true);
	...
	private void LJMAMAGJJHP()
	{
		...
		EGICOCDAAIL[1].GHGBNKIMKJB("trial", KJKHMLGIDPE, 539f, 749f, true);
		EGICOCDAAIL[1].IPPOJGPDCOI();
		EGICOCDAAIL[0].EHGMOLJMBPK(false);
		EGICOCDAAIL[0].InitializeTexts(Localization.Localize("VipReward1"), Localization.Localize("ID_WAITINGFORFRIENDCARDS"));
		EGICOCDAAIL[0].HDBLKKNNKOO("ShootCopyRPC", DJANOPAECLJ, 658f, 933f, true);
		...
		EGICOCDAAIL[6].HDBLKKNNKOO("ID_YOUROPPONENTHASDENIED", DJANOPAECLJ, 1052f, 843f, true);
		EGICOCDAAIL[1].StopAnimation();
		...
		EGICOCDAAIL[5].ABNBAGBPBKA("ID_ARENABOXDESCRIPTION_ELITEPARTS", JBIKIJKOPAI, 614f, 1251f, true);
