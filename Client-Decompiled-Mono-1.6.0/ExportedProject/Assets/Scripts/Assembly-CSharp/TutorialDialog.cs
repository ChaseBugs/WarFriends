...
public class TutorialDialog : GuiElementSingle<TutorialDialog>, PAIIOKBBHBC
{
	...
	private sealed class ONBFMLMBMON
	{
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(JAGBOPMGIAA, 1132f, MPHCNMDIPAI, false);
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 575f, new Vector3(1086f, 31f, 533f), false);
			tweenPosition.method = UITweener.Method.EaseInOut;
		}

		internal void JHGBDMGHDMN(UITweener CKOINALCMFJ)
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 560f, new Vector3(996f, 698f, 606f), false);
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 1206f, new Vector3(1308f, 1221f, 1546f), false);
			tweenPosition.method = UITweener.Method.Linear;
		}

		internal void CKIDEOIKHJO(UITweener CKOINALCMFJ)
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 495f, new Vector3(315f, 1724f, 1402f), false);
			tweenPosition.method = (UITweener.Method)6;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(JAGBOPMGIAA, 1619f, MPHCNMDIPAI, false);
			tweenPosition.method = (UITweener.Method)6;
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(JAGBOPMGIAA, 1436f, MPHCNMDIPAI, false);
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(JAGBOPMGIAA, 1297f, MPHCNMDIPAI, false);
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 1086f, new Vector3(1699f, 571f, 571f), false);
			tweenPosition.method = UITweener.Method.Linear;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 1841f, new Vector3(1622f, 1690f, 1268f), false);
			tweenPosition.method = UITweener.Method.EaseInOut;
		}

		internal void PEOKGFIGIGH(UITweener CKOINALCMFJ)
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 1484f, new Vector3(1607f, 204f, 1535f), false);
			tweenPosition.method = UITweener.Method.BounceIn;
		}

		internal void BLNOPKPLONB(UITweener CKOINALCMFJ)
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 1529f, new Vector3(1328f, 1447f, 76f), false);
			tweenPosition.method = (UITweener.Method)7;
		}

		internal void NAJNECOMDDN(UITweener MGDJMGHCAAI)
		{
			TweenPosition tweenPosition = TweenPosition.Begin(JAGBOPMGIAA, 1974f, MPHCNMDIPAI, false);
			tweenPosition.method = UITweener.Method.BounceIn;
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(JAGBOPMGIAA, 286f, MPHCNMDIPAI, false);
			tweenPosition.method = (UITweener.Method)6;
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(JAGBOPMGIAA, 251f, MPHCNMDIPAI, false);
			tweenPosition.method = UITweener.Method.EaseInOut;
			tweenPosition.onFinished = NFKKLDFJFMG;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 1654f, new Vector3(1784f, 1045f, 572f), false);
			tweenPosition.method = UITweener.Method.BounceIn;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 945f, new Vector3(1506f, 1665f, 143f), false);
			tweenPosition.method = UITweener.Method.BounceIn;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 1933f, new Vector3(1059f, 1665f, 780f), false);
			tweenPosition.method = (UITweener.Method)6;
		}
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 1634f, new Vector3(542f, 653f, 1873f), false);
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(JAGBOPMGIAA, 724f, MPHCNMDIPAI, false);
			tweenPosition.method = UITweener.Method.BounceIn;
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(HOGFHALKPAD, 347f, new Vector3(555f, 1452f, 1987f), false);
		...
		{
			TweenPosition tweenPosition = TweenPosition.Begin(JAGBOPMGIAA, 1667f, MPHCNMDIPAI, false);
			tweenPosition.method = (UITweener.Method)8;
			tweenPosition.onFinished = HKNCGEMENDB;
		}
	...
	public override void DoBeforeShowUp()
	{
		...
		JLMKABJPDMK.gameObject.SetActive(false);
		ELMPAEGPCED();
		PEJCELEFNCB = false;
	}
	...
	public virtual void OGOAOPJNNEF()
	{
		...
		{
			TweenPosition.Begin(FPEPOGNFCAA, 1642f, FPEPOGNFCAA.transform.localPosition.AddY(1681f), false);
		}
		...
		{
			TweenPosition.Begin(OIKAIHFHPKC, 663f, OIKAIHFHPKC.transform.localPosition.AddY(1597f), false);
	...
	public void FEPJCDADLJA()
	{
		...
		if (ICFGNENEBAE)
		{
			Debug.Log("ID_YOUAREPREMIUMMEMBERWITHBENEFITS");
		}
		PEJCELEFNCB = true;
	}
	...
	public void DDFADDKPPDI(string AMKLKMJEMJM, string DIDDEFHOPGC, float NEEBBLOFHEF, DODBDLEJOAM PBEHMGKDJMH = DODBDLEJOAM.Center, bool BBGAMLLOING = false, bool BEBMEBEJIOB = false)
	{
		...
		HBNEPCEAGLH((!(AMKLKMJEMJM == string.Empty)) ? Localization.Localize(AMKLKMJEMJM) : AMKLKMJEMJM, (!(DIDDEFHOPGC == string.Empty)) ? Localization.Localize(DIDDEFHOPGC) : DIDDEFHOPGC, NEEBBLOFHEF, PBEHMGKDJMH, BBGAMLLOING, true);
	...
	private void EAFOIKCEFFE()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(oNBFMLMBMON.JAGBOPMGIAA, 49f, oNBFMLMBMON.MPHCNMDIPAI + new Vector3(672f, 651f, 1124f), false);
		tweenPosition.method = UITweener.Method.Linear;
		tweenPosition.onFinished = oNBFMLMBMON.KPHEPHDFCKK;
		TweenPosition tweenPosition2 = TweenPosition.Begin(oNBFMLMBMON.HOGFHALKPAD, 1443f, new Vector3(1999f, 637f, 1398f), new Vector3(528f, 1446f, 1539f), false);
	...
	public override void FKCKIFKLBAP()
	{
		...
		{
			TweenPosition.Begin(MIJJJBGPGAF, 275f, MIJJJBGPGAF.transform.localPosition.AddY(1334f), false);
		}
	...
	public virtual void HJFOKEOEMFL()
	{
		...
		JLMKABJPDMK.gameObject.SetActive(true);
		NFNCGIFOBLJ();
		PEJCELEFNCB = false;
	}
	...
	public virtual void PHNEOPBPLDG()
	{
		...
		{
			TweenPosition.Begin(MIJJJBGPGAF, 980f, MIJJJBGPGAF.transform.localPosition.AddY(1507f), false);
		}
		else if (GPABKIOEGKM == BKJIJOMNIPI.Game)
		{
			TweenPosition.Begin(OIKAIHFHPKC, 149f, OIKAIHFHPKC.transform.localPosition.AddY(182f), false);
	...
	public virtual void IEHJMLIMNEP()
	{
		...
		if (ICFGNENEBAE)
		{
			Debug.Log("Tutorial_Step_Complete");
		}
		AJPHIGNGEHJ.enabled = DHBEFJHJKOA;
	}
	...
	private void CJKBICEOBLK()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(oNBFMLMBMON.JAGBOPMGIAA, 775f, oNBFMLMBMON.MPHCNMDIPAI + new Vector3(961f, 1102f, 800f), false);
		tweenPosition.method = UITweener.Method.EaseIn;
	...
	private void CONKIBMHOBG()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(oNBFMLMBMON.JAGBOPMGIAA, 544f, oNBFMLMBMON.MPHCNMDIPAI + new Vector3(125f, 110f, 1269f), false);
		tweenPosition.method = UITweener.Method.EaseIn;
	...
	public virtual void LJALACMIDCP()
	{
		...
		if (GPABKIOEGKM == BKJIJOMNIPI.Game)
		{
			TweenPosition.Begin(FPEPOGNFCAA, 508f, FPEPOGNFCAA.transform.localPosition.AddY(159f), false);
		}
		else if (GPABKIOEGKM == BKJIJOMNIPI.Game)
		{
