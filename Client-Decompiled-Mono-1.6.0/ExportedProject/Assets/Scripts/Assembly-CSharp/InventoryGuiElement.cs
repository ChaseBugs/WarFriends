...
public class InventoryGuiElement : GuiElementSingle<InventoryGuiElement>
{
	...
	{
		EKCNBDBFEEE.gameObject.SetActive(false);
	}
	...
	{
		EKCNBDBFEEE.gameObject.SetActive(true);
	...
	private void EKDDMEICMOA()
	{
		...
		DGNDJIEPCDG();
		KPFECPIHKJG();
		CNMDFMGELLH.BEJGLDILNOA(true);
	}

	public void CDLMLBABPDG()
	{
		CNMDFMGELLH.EDHJIFMHAFE(false);
	}
