...
public class CardHeadAhead : Card
{
	...
	public float criticalChance
	{
		get
		{
			return Singleton<GameVariables>.instance.cardConstants.GetRow(CardConstants.rowIds.HeadAheadCritical).FLOATVALUE;
		}
	}

	private float GNCDFDFKHBO
	{
		get
		{
	...
	public override string description
	{
		get
		{
			return Localization.LocalizeFormat(mDescriptionID, MEJMLNDFDBP.AIPKMDCJCOG(GNCDFDFKHBO), MEJMLNDFDBP.JJBMMICPIIG(criticalChance));
		}
	}
