...
public class InstantBattleAnimation : Core_BaseScript
{
	...
	private sealed class GBBLMONGGIK : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool KDFAHLNCNMN()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				BJGCPDNMHDH.camera.gameObject.SetActive(false);
		...
		public bool MoveNext()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				BJGCPDNMHDH.camera.gameObject.SetActive(true);
				...
				try
				{
					...
					case 1u:
						...
						if (NEMLKKBGIKJ != null && NEMLKKBGIKJ.LELHDMOANJG() != null)
						{
							...
							enemyController.UpdatePreview(false);
							enemyController.EFFIOHJHFHI.ShadowSetActive(false);
					...
					if (KFCAECGLKKO.MoveNext())
					{
						...
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 410f), true, false, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 1;
						}
				...
				try
				{
					...
					case 1u:
						...
						if (NEMLKKBGIKJ != null && NEMLKKBGIKJ.LELHDMOANJG() != null)
						{
							...
							enemyController.transform.position = BMFHDLEHANM.position.position;
							enemyController.transform.rotation = Quaternion.LookRotation(BJGCPDNMHDH.mPlayerPoint.transform.position - BMFHDLEHANM.position.position);
							enemyController.UpdatePreview(true);
							enemyController.EFFIOHJHFHI.ShadowSetActive(false);
							BMFHDLEHANM.mInstance = enemyController;
							BMFHDLEHANM.mHits = 1;
						}
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 514f), true, true, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 0;
						}
			...
			case 1u:
				try
				{
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 582f), true, false, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 0;
						}
			...
			case 1u:
				try
				{
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 1052f), true, false, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 0;
						}
				...
				try
				{
					...
					case 0u:
						...
						if (NEMLKKBGIKJ != null && NEMLKKBGIKJ.LELHDMOANJG() != null)
						{
							...
							enemyController.transform.rotation = Quaternion.LookRotation(BJGCPDNMHDH.mPlayerPoint.transform.position - BMFHDLEHANM.position.position);
							enemyController.UpdatePreview(true);
							enemyController.EFFIOHJHFHI.EFGIPEIGGDK(true);
							BMFHDLEHANM.mInstance = enemyController;
							BMFHDLEHANM.mHits = 1;
						}
						break;
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 1124f), false, false, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 0;
						}
				...
				try
				{
					...
					case 0u:
						...
						if (NEMLKKBGIKJ != null && NEMLKKBGIKJ.LELHDMOANJG() != null)
						{
							...
							enemyController.transform.rotation = Quaternion.LookRotation(BJGCPDNMHDH.mPlayerPoint.transform.position - BMFHDLEHANM.position.position);
							enemyController.UpdatePreview(false);
							enemyController.EFFIOHJHFHI.ShadowSetActive(true);
							BMFHDLEHANM.mInstance = enemyController;
							BMFHDLEHANM.mHits = 1;
						}
						break;
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 1749f), false, false, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 0;
						}
			...
			case 1u:
				try
				{
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 1760f), true, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 1;
						}
			...
			case 1u:
				try
				{
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 1247f), true, false));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 1;
						}
				...
				try
				{
					...
					case 1u:
						...
						if (NEMLKKBGIKJ != null && NEMLKKBGIKJ.prefab != null)
						{
							...
							enemyController.transform.rotation = Quaternion.LookRotation(BJGCPDNMHDH.mPlayerPoint.transform.position - BMFHDLEHANM.position.position);
							enemyController.UpdatePreview(false);
							enemyController.EFFIOHJHFHI.EFGIPEIGGDK(false);
							BMFHDLEHANM.mInstance = enemyController;
							BMFHDLEHANM.mHits = 0;
						}
						break;
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 1954f), false, false));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 0;
						}
			...
			case 1u:
				try
				{
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 970f), true, true, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 0;
						}
			...
			case 1u:
				try
				{
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 614f), false, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 1;
						}
			...
			case 1u:
				try
				{
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 980f), false, false));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 0;
						}
			...
			case 1u:
				try
				{
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN), true, false));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 1;
						}
			...
			case 1u:
				try
				{
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 1873f), false, false, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 0;
						}
			...
			case 1u:
				try
				{
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 1453f), true, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 0;
						}
			...
			case 1u:
				try
				{
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 1952f), true, false, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 0;
						}
			...
			case 1u:
				try
				{
					...
					if (KFCAECGLKKO.MoveNext())
					{
						BMFHDLEHANM = KFCAECGLKKO.Current;
						DCIAJLJEHEN = BMFHDLEHANM.unitBehavior;
						PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(DCIAJLJEHEN.PrepareVisualsForGameCoroutine(UnitUpgradeDefinition.GetPreviewUpgrades(DCIAJLJEHEN, 733f), false, true, true));
						if (!FDKOKMKIIMG)
						{
							CLPPIAGLCJJ = 0;
						}
	...
	public void AJPBBLOKBFC()
	{
		foreach (EnemyDefinition enemy in enemies)
		{
			...
			{
				enemy.mInstance.DestroyPooled(false);
			}
	...
	private void BGIHCBGLPDF()
	{
		...
		mainPlayer.EFFIOHJHFHI.EFGIPEIGGDK(false);
		...
		mainPlayer.soldierAnimator.Idle(playerWeapon.weapon.BEACDIILBEG, true);
	}
	...
	private void GAGMBMKPGGI()
	{
		...
		CamosManager.instance.UpdateVisuals(mainPlayer);
		mainPlayer.EFFIOHJHFHI.ShadowSetActive(true);
		mainPlayer.transform.parent = base.transform;
		mainPlayer.transform.rotation = mPlayerPoint.transform.rotation;
		mainPlayer.transform.position = mPlayerPoint.transform.position;
		mainPlayer.transform.localScale = Vector3.one;
	...
	private void IKELMACGPNN()
	{
		...
		CamosManager.instance.UpdateVisuals(mainPlayer);
		mainPlayer.EFFIOHJHFHI.ShadowSetActive(false);
		mainPlayer.transform.parent = base.transform;
		mainPlayer.transform.rotation = mPlayerPoint.transform.rotation;
		mainPlayer.transform.position = mPlayerPoint.transform.position;
		mainPlayer.transform.localScale = Vector3.one;
		...
		Singleton<GameCamera>.instance.transform.rotation = mainPlayer.transform.rotation;
		mainPlayer.GFCDMMGDFJK().Idle(playerWeapon.weapon.BEACDIILBEG, true);
	}
	...
	public void EAPELDOEDIN()
	{
		foreach (EnemyDefinition enemy in enemies)
		{
			if (enemy.mInstance != null)
			{
				enemy.mInstance.CADILLCGODA(false);
			}
			if (enemy.unitBehavior != null)
			{
				enemy.unitBehavior.Unload();
	...
	private void LHGMJBJECBJ()
	{
		...
		Singleton<GameCamera>.instance.transform.rotation = mainPlayer.transform.rotation;
		mainPlayer.GFCDMMGDFJK().Idle(playerWeapon.HFNAMMBPJAJ().BEACDIILBEG, true);
	}
	...
	public void DestroyEnemies()
	{
		foreach (EnemyDefinition enemy in enemies)
		{
			if (enemy.mInstance != null)
			{
				enemy.mInstance.DestroyPooled(true);
			}
			if (enemy.unitBehavior != null)
			{
				enemy.unitBehavior.Unload();
	...
	private void IOFFBEIKMON()
	{
		...
		CamosManager.instance.UpdateVisuals(mainPlayer);
		mainPlayer.EFFIOHJHFHI.EFGIPEIGGDK(true);
		mainPlayer.transform.parent = base.transform;
		mainPlayer.transform.rotation = mPlayerPoint.transform.rotation;
		mainPlayer.transform.position = mPlayerPoint.transform.position;
		mainPlayer.transform.localScale = Vector3.one;
		...
		Singleton<GameCamera>.instance.transform.rotation = mainPlayer.transform.rotation;
		mainPlayer.soldierAnimator.Idle(playerWeapon.HFNAMMBPJAJ().BEACDIILBEG, true);
	}
