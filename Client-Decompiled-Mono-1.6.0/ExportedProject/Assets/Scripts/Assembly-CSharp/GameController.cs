...
public class GameController : Singleton<GameController>
{
	...
	private sealed class MMNJPPHAAGL : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool BIGKCFMEBJE()
		{
			...
			case 4u:
				...
				break;
			case 5u:
				GuiScreenSingle<HudScreen>.instance.gameObject.SetActive(false);
			...
			case 6u:
				...
				break;
			case 7u:
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(CardManager.instance.InitGameCards(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.AAOAKDPIEII, false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 4;
				}
			...
			case 9u:
				...
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(CardManager.instance.InitGameCards(BJGCPDNMHDH.JNFGIPOFKCF.EHHHBEMKGOE.AAOAKDPIEII, true, false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = -15;
				}
			...
			case 11u:
				...
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(CardManager.instance.InitGameCards(BJGCPDNMHDH.KKHKAJPNDEC.EHHHBEMKGOE.AAOAKDPIEII, false, false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = -86;
				}
		...
		public bool MoveNext()
		{
			...
			case 4u:
				...
				break;
			case 5u:
				GuiScreenSingle<HudScreen>.instance.gameObject.SetActive(true);
				GuiScreenSingle<HudScreen>.instance.SetTransparent();
				if (BJGCPDNMHDH.NIEFNMJIAHL != null)
				{
					BJGCPDNMHDH.NIEFNMJIAHL();
		...
		public bool FNIOOIGJPAM()
		{
			...
			case 6u:
				...
				break;
			case 7u:
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(CardManager.instance.InitGameCards(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.AAOAKDPIEII, true, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 6;
				}
			...
			case 9u:
				CardManager.instance.SetBuddyCardsOher(BJGCPDNMHDH.JNFGIPOFKCF.EHHHBEMKGOE.PHIGKPODHAN);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(CardManager.instance.InitGameCards(BJGCPDNMHDH.JNFGIPOFKCF.EHHHBEMKGOE.AAOAKDPIEII, false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = -96;
				}
			...
			case 11u:
				CardManager.instance.SetBuddyCardsOher(BJGCPDNMHDH.KKHKAJPNDEC.EHHHBEMKGOE.PHIGKPODHAN);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(CardManager.instance.InitGameCards(BJGCPDNMHDH.KKHKAJPNDEC.EHHHBEMKGOE.AAOAKDPIEII, true, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 74;
				}
		...
		public bool GCEBFCBBEKM()
		{
			...
			case 6u:
				...
				break;
			case 7u:
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(CardManager.instance.InitGameCards(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.AAOAKDPIEII, false, false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 8;
				}
			...
			case 9u:
				CardManager.instance.SetBuddyCardsOher(BJGCPDNMHDH.JNFGIPOFKCF.EHHHBEMKGOE.PHIGKPODHAN);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(CardManager.instance.InitGameCards(BJGCPDNMHDH.JNFGIPOFKCF.EHHHBEMKGOE.AAOAKDPIEII, false, false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 105;
				}
			...
			case 11u:
				CardManager.instance.SetBuddyCardsOher(BJGCPDNMHDH.KKHKAJPNDEC.EHHHBEMKGOE.PHIGKPODHAN);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(CardManager.instance.InitGameCards(BJGCPDNMHDH.KKHKAJPNDEC.EHHHBEMKGOE.AAOAKDPIEII, true, false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = -6;
				}
		...
		public bool FIBKLKNDFDO()
		{
			...
			case 6u:
				...
				break;
			case 7u:
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(CardManager.instance.InitGameCards(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.AAOAKDPIEII, true, false));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 5;
				}
			...
			case 9u:
				CardManager.instance.SetBuddyCardsOher(BJGCPDNMHDH.JNFGIPOFKCF.EHHHBEMKGOE.PHIGKPODHAN);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(CardManager.instance.InitGameCards(BJGCPDNMHDH.JNFGIPOFKCF.EHHHBEMKGOE.AAOAKDPIEII, true, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = -88;
				}
			...
			case 11u:
				CardManager.instance.SetBuddyCardsOher(BJGCPDNMHDH.KKHKAJPNDEC.EHHHBEMKGOE.PHIGKPODHAN);
				PHDOCKCBJOF = BJGCPDNMHDH.StartCoroutine(CardManager.instance.InitGameCards(BJGCPDNMHDH.KKHKAJPNDEC.EHHHBEMKGOE.AAOAKDPIEII, false, true));
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = -29;
				}
		...
		public bool CJGKHIPOBGP()
		{
			...
			case 0u:
				Singleton<Recording>.instance.FOJIDINENDK();
				Singleton<PerformanceManager>.instance.AOBNCIOGFKA(true);
				Singleton<GuiManager>.instance.KAGEFJEJOKE();
				ObjectPoolDatabase.DJBHEMBOCDC((!BJGCPDNMHDH.JLIBMLEFJFE()) ? NPNOIGHIALL.Tutorial : NPNOIGHIALL.Init);
		...
		public bool GPIPJIDGCKM()
		{
			...
			case 1u:
			{
				...
				if (gJFHKPIHDCH2 == true && !gJFHKPIHDCH2.HasValue)
				{
					...
					WarningDialog.ShowError(hOLNKOFHDNK, oKMNFHNBMFA, 982f, LGJCBPOPCPA, string.Empty, true, true);
		...
		public bool BGOEENAEBNO()
		{
			...
			case 1u:
			{
				...
				if (gJFHKPIHDCH2 == true && !gJFHKPIHDCH2.HasValue)
				{
					...
					WarningDialog.ShowError(hOLNKOFHDNK, oKMNFHNBMFA, 109f, LGJCBPOPCPA, string.Empty, true, true);
					BJGCPDNMHDH.TryStopLoading();
		...
		public bool FPMHODJKAKK()
		{
			...
			case 1u:
			{
				...
				if (BJGCPDNMHDH.GJFHKPIHDCH != false)
				{
					...
					WarningDialog.ShowError(hOLNKOFHDNK, oKMNFHNBMFA, 1613f, LGJCBPOPCPA, string.Empty, true);
					BJGCPDNMHDH.TryStopLoading();
					BJGCPDNMHDH.Quit();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool EKGEDEKHBME()
		{
			...
			case 1u:
			{
				...
				if (BJGCPDNMHDH.GJFHKPIHDCH != false)
				{
					...
					WarningDialog.JACKIDKHKAI(hOLNKOFHDNK, oKMNFHNBMFA, 127f, LGJCBPOPCPA, string.Empty, true);
		...
		public bool HMLAEHJKPJE()
		{
			...
			case 1u:
			{
				...
				if (gJFHKPIHDCH2 == true && !gJFHKPIHDCH2.HasValue)
				{
					...
					WarningDialog.ShowError(hOLNKOFHDNK, oKMNFHNBMFA, 837f, LGJCBPOPCPA, string.Empty, true, true);
					BJGCPDNMHDH.NOKJMDOPFHL();
					BJGCPDNMHDH.Quit();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool CJGKHIPOBGP()
		{
			...
			case 1u:
			{
				...
				if (BJGCPDNMHDH.GJFHKPIHDCH != false)
				{
					...
					WarningDialog.KHOMNBHMFGA(hOLNKOFHDNK, oKMNFHNBMFA, 1510f, LGJCBPOPCPA, string.Empty, false, true);
					BJGCPDNMHDH.TryStopLoading();
					BJGCPDNMHDH.HGBNEFDBFDC();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool AKFKBNAMOAI()
		{
			...
			case 1u:
			{
				...
				if (gJFHKPIHDCH2 == true && !gJFHKPIHDCH2.HasValue)
				{
					...
					WarningDialog.JACKIDKHKAI(hOLNKOFHDNK, oKMNFHNBMFA, 1880f, LGJCBPOPCPA, string.Empty, false, true);
					BJGCPDNMHDH.TryStopLoading();
					BJGCPDNMHDH.HGBNEFDBFDC();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool AIFKBHCOIKG()
		{
			...
			case 1u:
			{
				...
				if (BJGCPDNMHDH.GJFHKPIHDCH != false)
				{
					...
					WarningDialog.ShowError(hOLNKOFHDNK, oKMNFHNBMFA, 221f, LGJCBPOPCPA, string.Empty, false, true);
					BJGCPDNMHDH.NOKJMDOPFHL();
					BJGCPDNMHDH.Quit();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool MPKAJACHAIC()
		{
			...
			case 1u:
			{
				...
				if (gJFHKPIHDCH2 != true && !gJFHKPIHDCH2.HasValue)
				{
					...
					WarningDialog.JACKIDKHKAI(hOLNKOFHDNK, oKMNFHNBMFA, 886f, LGJCBPOPCPA, string.Empty, true);
					BJGCPDNMHDH.TryStopLoading();
					BJGCPDNMHDH.Quit();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool IEDGDDDADFM()
		{
			...
			case 1u:
			{
				...
				if (gJFHKPIHDCH2 != true && !gJFHKPIHDCH2.HasValue)
				{
					...
					WarningDialog.ShowError(hOLNKOFHDNK, oKMNFHNBMFA, 448f, LGJCBPOPCPA, string.Empty, false, true);
					BJGCPDNMHDH.TryStopLoading();
					BJGCPDNMHDH.HGBNEFDBFDC();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool LMNIKLKKIDN()
		{
			...
			case 1u:
			{
				...
				if (gJFHKPIHDCH2 != true && !gJFHKPIHDCH2.HasValue)
				{
					...
					WarningDialog.KHOMNBHMFGA(hOLNKOFHDNK, oKMNFHNBMFA, 1275f, LGJCBPOPCPA, string.Empty, true);
					BJGCPDNMHDH.NOKJMDOPFHL();
					BJGCPDNMHDH.HGBNEFDBFDC();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool OKELILGDPLJ()
		{
			...
			case 1u:
			{
				...
				if (BJGCPDNMHDH.GJFHKPIHDCH != true)
				{
					...
					WarningDialog.JACKIDKHKAI(hOLNKOFHDNK, oKMNFHNBMFA, 4f, LGJCBPOPCPA, string.Empty, false, true);
					BJGCPDNMHDH.TryStopLoading();
					BJGCPDNMHDH.Quit();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool PJJPPMIBNLN()
		{
			...
			case 1u:
			{
				...
				if (BJGCPDNMHDH.GJFHKPIHDCH != true)
				{
					...
					WarningDialog.KHOMNBHMFGA(hOLNKOFHDNK, oKMNFHNBMFA, 801f, LGJCBPOPCPA, string.Empty, false, true);
					BJGCPDNMHDH.TryStopLoading();
					BJGCPDNMHDH.HGBNEFDBFDC();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool HKPECDLGFJB()
		{
			...
			case 1u:
			{
				...
				if (gJFHKPIHDCH2 == true && !gJFHKPIHDCH2.HasValue)
				{
					...
					WarningDialog.JACKIDKHKAI(hOLNKOFHDNK, oKMNFHNBMFA, 543f, LGJCBPOPCPA, string.Empty, true, true);
					BJGCPDNMHDH.TryStopLoading();
					BJGCPDNMHDH.HGBNEFDBFDC();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool LPMIKEPIMCM()
		{
			...
			case 1u:
			{
				...
				if (BJGCPDNMHDH.GJFHKPIHDCH != false)
				{
					...
					WarningDialog.ShowError(hOLNKOFHDNK, oKMNFHNBMFA, 1162f, LGJCBPOPCPA, string.Empty, true, true);
					BJGCPDNMHDH.TryStopLoading();
					BJGCPDNMHDH.HGBNEFDBFDC();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool KEBEGEDKIKM()
		{
			...
			case 1u:
			{
				...
				if (gJFHKPIHDCH2 == true && !gJFHKPIHDCH2.HasValue)
				{
					...
					WarningDialog.ShowError(hOLNKOFHDNK, oKMNFHNBMFA, 1176f, LGJCBPOPCPA, string.Empty, true, true);
					BJGCPDNMHDH.TryStopLoading();
					BJGCPDNMHDH.HGBNEFDBFDC();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool MHNPBDBGBLK()
		{
			...
			case 1u:
			{
				...
				if (gJFHKPIHDCH2 == true && !gJFHKPIHDCH2.HasValue)
				{
					...
					WarningDialog.KHOMNBHMFGA(hOLNKOFHDNK, oKMNFHNBMFA, 1533f, LGJCBPOPCPA, string.Empty, false, true);
					BJGCPDNMHDH.NOKJMDOPFHL();
					BJGCPDNMHDH.Quit();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool CGOKGPGALLH()
		{
			...
			case 1u:
			{
				...
				if (gJFHKPIHDCH2 == true && !gJFHKPIHDCH2.HasValue)
				{
					...
					WarningDialog.KHOMNBHMFGA(hOLNKOFHDNK, oKMNFHNBMFA, 1742f, LGJCBPOPCPA, string.Empty, true, true);
					BJGCPDNMHDH.NOKJMDOPFHL();
					BJGCPDNMHDH.Quit();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
		...
		public bool FIBKLKNDFDO()
		{
			...
			case 1u:
			{
				...
				if (gJFHKPIHDCH2 == true && !gJFHKPIHDCH2.HasValue)
				{
					...
					WarningDialog.ShowError(hOLNKOFHDNK, oKMNFHNBMFA, 1893f, LGJCBPOPCPA, string.Empty, true);
					BJGCPDNMHDH.TryStopLoading();
					BJGCPDNMHDH.HGBNEFDBFDC();
					if ((bool)(BJGCPDNMHDH.mainController as GameControllerOnline))
					{
	...
	private sealed class CHEINCNDKIG : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool PMBOHHPPJAC()
		{
			...
			case 2u:
				...
				Time.timeScale = 137f;
				LoadingDialog.FDBHFJFKALH(Localization.Localize("LevelProgress"), false, true, true);
		...
		public bool HKPECDLGFJB()
		{
			...
			case 2u:
				...
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("Buy_Army_Unit"), false, true, true);
				PHDOCKCBJOF = new WaitForSeconds(1310f);
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 3;
		...
		public bool MoveNext()
		{
			...
			case 2u:
				...
				Time.timeScale = 1f;
				LoadingDialog.ShowLoading(Localization.Localize("ID_LOADING"), false, true);
		...
		public bool GAPIFMKNJBN()
		{
			...
			case 2u:
				...
				LoadingDialog.FDBHFJFKALH(Localization.Localize("Total_Warbucks_Spent"), true, true);
	...
	private sealed class KCPGHGNIGFP : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		{
			BJGCPDNMHDH.MNMLNIMFMJP = HKGHCIEPGEL.Killed;
			BJGCPDNMHDH.OJIENOPOBLO(false, true);
		}

		internal void OKNCFDMEFGJ()
		{
			BJGCPDNMHDH.MNMLNIMFMJP = (HKGHCIEPGEL)7;
			BJGCPDNMHDH.OJIENOPOBLO(true, true);
		}
		...
		public bool MoveNext()
		{
			...
			case 3u:
				...
				if (BJGCPDNMHDH.gameEndServerResponse == AHDGGJJAOEO.Error)
				{
					...
					LoadingDialog.ShowLoading(Localization.Localize("ID_LOADING"), false, true, true);
				}
				if (BJGCPDNMHDH.gameEndServerResponse == AHDGGJJAOEO.Success)
				{
					BJGCPDNMHDH.MKEGPEBGOGM(true);
				}
				CLPPIAGLCJJ = -1;
				goto default;
			default:
		...
		public bool MPKAJACHAIC()
		{
			...
			case 2u:
				...
				LoadingDialog.ShowLoading(Localization.Localize("いいえ"), false, false, true);
				if (DebugSettings.debugEnabled && BJGCPDNMHDH.HDBGBMPCMON != null)
				{
					LoadingDialog.BKOEMIKFMHN(BJGCPDNMHDH.HDBGBMPCMON, true);
				}
				goto case 3u;
			case 3u:
				if (BJGCPDNMHDH.gameEndServerResponse == AHDGGJJAOEO.None)
				...
				if (BJGCPDNMHDH.gameEndServerResponse == AHDGGJJAOEO.Error)
				{
					...
					WarningDialog.KHOMNBHMFGA(text, Localization.Localize("Mode"), 599f, NNIJEDKBPGJ, string.Empty, false, true);
					LoadingDialog.ShowLoading(Localization.Localize("canShow"));
				}
				if (BJGCPDNMHDH.gameEndServerResponse == AHDGGJJAOEO.Error)
				{
					BJGCPDNMHDH.OJIENOPOBLO(false);
				}
				CLPPIAGLCJJ = -1;
				goto default;
			default:
		...
		public bool JFPOOBJNEPF()
		{
			...
			case 2u:
				...
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("ID_GUI_ALL"), false, true, true);
				if (DebugSettings.debugEnabled && BJGCPDNMHDH.HDBGBMPCMON != null)
				{
					LoadingDialog.SetText(BJGCPDNMHDH.HDBGBMPCMON);
				}
			...
			case 3u:
				...
				if (BJGCPDNMHDH.gameEndServerResponse == AHDGGJJAOEO.None)
				{
					...
					WarningDialog.KHOMNBHMFGA(text, Localization.Localize("Pack_Type"), 638f, NNIJEDKBPGJ, string.Empty, true);
					LoadingDialog.FDBHFJFKALH(Localization.Localize("null card in reward dialog"), true, true, true);
				}
				if (BJGCPDNMHDH.gameEndServerResponse == AHDGGJJAOEO.Success)
				{
					BJGCPDNMHDH.OJIENOPOBLO(false, true);
		...
		public bool IGOKEIDOCKB()
		{
			...
			case 2u:
				...
				LoadingDialog.ShowLoading(Localization.Localize("Packs"), true, true, true);
				if (DebugSettings.debugEnabled && BJGCPDNMHDH.HDBGBMPCMON != null)
				{
					LoadingDialog.SetText(BJGCPDNMHDH.HDBGBMPCMON);
				}
			...
			case 3u:
				...
				if (BJGCPDNMHDH.gameEndServerResponse == AHDGGJJAOEO.Error)
				{
					...
					WarningDialog.ShowError(text, Localization.Localize("PrepareBotForDeathMatch 8"), 992f, CIFEDFPPPOK, string.Empty, true, true);
					LoadingDialog.ShowLoading(Localization.Localize("de"), false, true);
				}
		...
		public bool EKGEDEKHBME()
		{
			...
			case 2u:
				LoadingDialog.SetLook(false);
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("AdminPlayerId"), false, true);
				if (DebugSettings.debugEnabled && BJGCPDNMHDH.HDBGBMPCMON != null)
				{
			...
			case 3u:
				...
				if (BJGCPDNMHDH.gameEndServerResponse == (AHDGGJJAOEO)7)
				{
					BJGCPDNMHDH.MKEGPEBGOGM(true, true);
				}
				CLPPIAGLCJJ = -1;
				goto default;
			default:
		...
		public bool PGOBEIMCPGA()
		{
			...
			case 1u:
				...
				break;
			case 2u:
				LoadingDialog.NJHOCHGJICN(true);
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("maxMapId"), true, false, true);
				if (DebugSettings.debugEnabled && BJGCPDNMHDH.HDBGBMPCMON != null)
				{
					LoadingDialog.SetText(BJGCPDNMHDH.HDBGBMPCMON);
				}
			...
			case 3u:
				...
				if (BJGCPDNMHDH.gameEndServerResponse == AHDGGJJAOEO.None)
				{
					...
					WarningDialog.JACKIDKHKAI(text, Localization.Localize("shield_shot"), 1284f, CIFEDFPPPOK, string.Empty, true);
					LoadingDialog.PGFBMJFLHPC(Localization.Localize("seconds"), true);
				}
		...
		public bool KHNDCDGBFJH()
		{
			...
			case 2u:
				LoadingDialog.NJHOCHGJICN(true);
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("SetHitByPlayerRPC "), false, false, true);
				if (DebugSettings.debugEnabled && BJGCPDNMHDH.HDBGBMPCMON != null)
				{
					LoadingDialog.BKOEMIKFMHN(BJGCPDNMHDH.HDBGBMPCMON, true);
				}
			...
			case 3u:
				...
				if (BJGCPDNMHDH.gameEndServerResponse == AHDGGJJAOEO.Error)
				{
					...
					WarningDialog.ShowError(text, Localization.Localize("06"), 186f, PCKMJMGLPDG, string.Empty, true);
					LoadingDialog.PGFBMJFLHPC(Localization.Localize("Heroic"), false, true, true);
				}
				if (BJGCPDNMHDH.gameEndServerResponse == (AHDGGJJAOEO)7)
				{
					BJGCPDNMHDH.OJIENOPOBLO(false);
		...
		internal void PCKMJMGLPDG()
		{
			...
			BJGCPDNMHDH.MKEGPEBGOGM(false, true);
		}
	...
	private sealed class KGCALFKEMNC : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool HNCDLFFBMAA()
		{
			...
			case 2u:
				...
				CardManager.instance.ReleaseCards(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.AAOAKDPIEII, true, false);
				if (BJGCPDNMHDH.JNFGIPOFKCF != null)
				{
					CardManager.instance.ReleaseCards(BJGCPDNMHDH.JNFGIPOFKCF.EHHHBEMKGOE.AAOAKDPIEII, false, true);
				}
				if (BJGCPDNMHDH.KKHKAJPNDEC != null)
				{
					CardManager.instance.ReleaseCards(BJGCPDNMHDH.KKHKAJPNDEC.EHHHBEMKGOE.AAOAKDPIEII, true, false);
				}
		...
		public bool IDBCKIPOEEI()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.gameState = AEMPHGEIJNH.Playing;
				LoadingDialog.ShowLoading(Localization.Localize("vipId"), true);
				if (DebugSettings.debugEnabled && BJGCPDNMHDH.HDBGBMPCMON != null)
				{
					LoadingDialog.SetText(BJGCPDNMHDH.HDBGBMPCMON, true);
				}
			...
			case 2u:
				...
				CardManager.instance.ReleaseCards(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.AAOAKDPIEII, true, true);
				if (BJGCPDNMHDH.JNFGIPOFKCF != null)
				{
					CardManager.instance.ReleaseCards(BJGCPDNMHDH.JNFGIPOFKCF.EHHHBEMKGOE.AAOAKDPIEII, false, false);
				}
				if (BJGCPDNMHDH.KKHKAJPNDEC != null)
				{
					CardManager.instance.ReleaseCards(BJGCPDNMHDH.KKHKAJPNDEC.EHHHBEMKGOE.AAOAKDPIEII, true, false);
		...
		public bool OKELILGDPLJ()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.DIKIPEDCHCF(AEMPHGEIJNH.Menu);
				LoadingDialog.PGFBMJFLHPC(Localization.Localize("Reward {0:D2}"), false, false, true);
				if (DebugSettings.debugEnabled && BJGCPDNMHDH.HDBGBMPCMON != null)
				{
					LoadingDialog.BKOEMIKFMHN(BJGCPDNMHDH.HDBGBMPCMON);
				}
			...
			case 2u:
				...
				Singleton<SoundsManager3D>.instance.FJDJGKOGHDH();
				CardManager.instance.ReleaseCards(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.AAOAKDPIEII, false, false);
				if (BJGCPDNMHDH.JNFGIPOFKCF != null)
				{
					CardManager.instance.ReleaseCards(BJGCPDNMHDH.JNFGIPOFKCF.EHHHBEMKGOE.AAOAKDPIEII, true, true);
				}
				if (BJGCPDNMHDH.KKHKAJPNDEC != null)
				{
					CardManager.instance.ReleaseCards(BJGCPDNMHDH.KKHKAJPNDEC.EHHHBEMKGOE.AAOAKDPIEII, false, true);
				}
				TimeManager.instance.EndOfEndGame();
		...
		public bool MoveNext()
		{
			...
			case 2u:
				...
				CardManager.instance.ReleaseCards(PlayerController.OGMBJPKOPCB.EHHHBEMKGOE.AAOAKDPIEII, false, true);
				if (BJGCPDNMHDH.JNFGIPOFKCF != null)
				{
					CardManager.instance.ReleaseCards(BJGCPDNMHDH.JNFGIPOFKCF.EHHHBEMKGOE.AAOAKDPIEII, true, false);
				}
				if (BJGCPDNMHDH.KKHKAJPNDEC != null)
				{
					CardManager.instance.ReleaseCards(BJGCPDNMHDH.KKHKAJPNDEC.EHHHBEMKGOE.AAOAKDPIEII, false, false);
				}
				TimeManager.instance.EndOfEndGame();
				PHDOCKCBJOF = new WaitForRealSeconds(0.2f);
				if (!FDKOKMKIIMG)
		...
		public bool FNEPBDLIKOD()
		{
			...
			case 0u:
				...
				BJGCPDNMHDH.DIKIPEDCHCF(AEMPHGEIJNH.Menu);
				LoadingDialog.ShowLoading(Localization.Localize("Level"), false, true, true);
				if (DebugSettings.debugEnabled && BJGCPDNMHDH.HDBGBMPCMON != null)
				{
					LoadingDialog.SetText(BJGCPDNMHDH.HDBGBMPCMON);
				}
	...
	public AEMPHGEIJNH gameState { get; private set; }
	...
	public bool wonLastGame
	{
		get
		{
			return MNMLNIMFMJP == HKGHCIEPGEL.MissionSuccess || MNMLNIMFMJP == HKGHCIEPGEL.Win || MNMLNIMFMJP == HKGHCIEPGEL.WinByForfeit;
		}
	}
	...
	public bool isBattle
	{
		get
		{
			return isDeathMatch || isDeathMatchOffline;
		}
	}
	...
	public bool isPVP
	{
		get
		{
			return isDeathMatch || isDeathMatchOffline || isWarArena;
		}
	}
	...
	public bool isDeathMatchOffline
	{
		get
		{
	...
	public bool isWarArena
	{
		get
		{
			return object.Equals(mainController, MBPKLMKBJAB);
		}
	}
	...
	public bool isTutorialInProgressOrPlaned
	{
		get
		{
			return PBJPODPEHCB || isTutorial;
		}
	}

	public bool isNotTutorialEnded
	{
		get
		{
			return isTutorialInProgressOrPlaned && !TutorialManagerStage3.instance.isTutorialNearEnd;
		}
	}

	public bool isTutorialStage1
	{
		get
		{
	...
	public bool isTutorialStage2
	{
		get
		{
			return object.Equals(mainController, CBAPHFGNLLH) && TutorialManagerStage2.instance.isTutorialRunning;
		}
	}

	public bool isTutorialStage3
	{
		get
		{
			return object.Equals(mainController, CBAPHFGNLLH) && TutorialManagerStage3.instance.isTutorialRunning;
		}
	}

	public bool isFirstLoadingOfWarfriends
	{
		get
		{
	...
	public bool isInMenuOrWait
	{
		get
		{
			return gameState <= AEMPHGEIJNH.WaitingForResponse;
		}
	}

	public bool isLoadingOrPlaying
	{
		get
		{
			return gameState >= AEMPHGEIJNH.Loading;
		}
	}

	public AHDGGJJAOEO gameEndServerResponse { get; set; }

	public IJEAJGCCHEF errorReason { get; set; }
	...
	private void EPLLBNHACFJ()
	{
		try
		{
			LoadingDialog.FDBHFJFKALH(string.Empty, true, false, true);
	...
	private void EOJIIDEEOEE(DatabaseAction MHLAAHNPMFG, int NOCEDALFEJM, CAMPAFGONHH LLAOOPMGBAG)
	{
		...
		{
			HDBGBMPCMON = string.Format("WaitForGameEndResponse Try {0} action {1}", NOCEDALFEJM, LLAOOPMGBAG);
	...
	public bool GMFAFJHGFIH(HHFHFANGCEJ PNAKMCNGGHE)
	{
		...
		{
			WarningDialog.JACKIDKHKAI(Localization.LocalizeFormat("Card withdrawn", NGDKKFFCGCI.CBIOKPKJNPC, Singleton<CurrentBundleVersion>.instance.photonVersion, null), Localization.Localize("\"NEGINFINITY\""), 764f, null, string.Empty, true, true);
			return false;
		}
		return true;
	}
	...
	public bool DKFCCEEKACL(HHFHFANGCEJ PNAKMCNGGHE)
	{
		...
		if (NGDKKFFCGCI.CBIOKPKJNPC != Singleton<CurrentBundleVersion>.instance.JEEDKJKOPLI())
		{
			...
			WarningDialog.KHOMNBHMFGA(Localization.LocalizeFormat("CH", array), Localization.Localize("Player_Waited_Till_Delivery_Ends"), 532f, null, string.Empty, true);
			return true;
		}
		return false;
	}
	...
	private void AKDMOOGBMBC()
	{
		try
		{
			LoadingDialog.ShowLoading(string.Empty, false, false, true);
	...
	private void FMLAOABILMN()
	{
		try
		{
			LoadingDialog.ShowLoading(string.Empty, false, true, true);
			GameLoginManager.instance.RegisterOrLogin(SessionManager.MFGMKAJDCAI.None);
		}
		catch (Exception ex)
		{
