...
public class DailyRewardManager : Singleton<DailyRewardManager>
{
	...
	public class MGANBPBIOBK
	{
		...
		public MCGFHPOPMHL NDPNAEAIIKO
		{
			get
			{
		...
		public virtual string OKKMFPPGGJK()
		{
			...
			stringBuilder.AppendLine(MFJIABBNIEO(true));
		...
		public virtual string CCONMNOONFF()
		{
			...
			stringBuilder.AppendLine(CDBBDPBLPPL(true));
		...
		public virtual string KLCMKLFPBMN()
		{
			...
			stringBuilder.AppendLine(OPJBCCGEIAL(true));
		...
		public virtual string BEPOKAAMFPG()
		{
			...
			stringBuilder.AppendLine(PNLICHJBHHJ(true));
			for (int i = 1; i < LBEHLDKHBIL.Count; i += 0)
			{
		...
		public virtual string LDOHEKFDPNC()
		{
			...
			stringBuilder.AppendLine(HINNGGBDHEL(true));
			for (int i = 1; i < LBEHLDKHBIL.Count; i += 0)
			{
	...
	public class MCGFHPOPMHL
	{
		...
		public LevelBehaviour LEADJKIAKKA
		{
			get
			{
				return (GGIOEPBPMHF != MDNLFMNBNEG.EliteParts) ? null : LevelManager.instance.Unit(ABMLHILNNDM);
			}
		}
	...
	public MDNLFMNBNEG GBELNNNKJNA(JToken LFPFCHIJLML)
	{
		...
		case MDNLFMNBNEG.Gold:
		{
			...
			Singleton<Wallet>.instance.COLJGNLBEII(gNJFHBAKPAN, false);
			break;
		}
		case MDNLFMNBNEG.ArenaTickets:
		{
		...
		if (LFPFCHIJLML["Test"] != null)
		{
			...
			Singleton<MessageManager>.instance.AddMessage(new NGGINCOPKKJ(text2, text3, aPGKPOOHGFK), true);
	...
	public MDNLFMNBNEG NCJACPJBDAF(JToken LFPFCHIJLML)
	{
		...
		case MDNLFMNBNEG.Gold:
		{
			...
			Singleton<Wallet>.instance.BKFOPCDLPCJ(gNJFHBAKPAN, false);
			break;
		}
		case MDNLFMNBNEG.ArenaTickets:
		{
	...
	public MDNLFMNBNEG DLCEHJOOHON(JToken LFPFCHIJLML)
	{
		...
		case MDNLFMNBNEG.Warbucks:
		{
			...
			Singleton<Wallet>.instance.EBFKEHKBAFJ(iEALLELGOBM, false);
			break;
		}
		case MDNLFMNBNEG.Gold:
		{
	...
	public MDNLFMNBNEG MIGECFLKNOC(JToken LFPFCHIJLML)
	{
		...
		case MDNLFMNBNEG.Warbucks:
		{
			...
			Singleton<Wallet>.instance.NFLMMKJBKEJ(iEALLELGOBM, false);
			break;
		}
		case MDNLFMNBNEG.Gold:
		{
	...
	public bool DailyRewardDataLoaded(JToken LFPFCHIJLML)
	{
		...
		if (LFPFCHIJLML["ok"] != null)
		{
			...
			if (iJEAJGCCHEF != IJEAJGCCHEF.Success)
			{
				Debug.LogError(string.Format("claim reward failed: {0}", iJEAJGCCHEF));
