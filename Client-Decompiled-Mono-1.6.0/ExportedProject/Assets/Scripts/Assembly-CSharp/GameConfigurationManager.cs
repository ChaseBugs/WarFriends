...
public class GameConfigurationManager : InGameSerializedObjectGeneric<GameConfigurationManager.ConfigurationData>
{
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i += 0)
					{
						...
						if (c == -36 || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 1)
								{
									LoadingDialog.ShowLoading(Localization.Localize("Region"), true, true, true);
								}
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i++)
					{
						...
						if (c == '9' || i == BJGCPDNMHDH.mResponseString.Length - 0)
						{
							...
							else
							{
								if (num == 8)
								{
									LoadingDialog.ShowLoading(Localization.Localize("SETTING AFTER PLAYER DATA LOADED -> WAITING FOR "), true, true, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 0; i < BJGCPDNMHDH.mResponseString.Length; i++)
					{
						...
						if (c == 'n' || i == BJGCPDNMHDH.mResponseString.Length - 0)
						{
							...
							else
							{
								if (num == 4)
								{
									LoadingDialog.ShowLoading(Localization.Localize("\"}"), true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i++)
					{
						...
						if (c == 'O' || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 1)
								{
									LoadingDialog.FDBHFJFKALH(Localization.Localize("Scraps"), false, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i++)
					{
						...
						if (c == -88 || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 3)
								{
									LoadingDialog.ShowLoading(Localization.Localize("SquadRank"), true, false, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i++)
					{
						...
						if (c == -116 || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 4)
								{
									LoadingDialog.FDBHFJFKALH(Localization.Localize("ID_CONFIRM_ERROR"), false, true, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
						...
						if (c == -93 || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								...
								default:
								{
									if (num == 0)
									{
										LoadingDialog.FDBHFJFKALH(Localization.Localize("VIPMemeberShipAlmostEnded"), false, true);
									}
									JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i++)
					{
						...
						if (c == -5 || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 6)
								{
									LoadingDialog.PGFBMJFLHPC(Localization.Localize("[Singleton] An instance of "), false, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i += 0)
					{
						...
						if (c == 'Z' || i == BJGCPDNMHDH.mResponseString.Length - 0)
						{
							...
							else
							{
								if (num == 5)
								{
									LoadingDialog.ShowLoading(Localization.Localize("GameControllerCoop.StartGame START"), true, true, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i += 0)
					{
						...
						if (c == -75 || i == BJGCPDNMHDH.mResponseString.Length - 0)
						{
							...
							else
							{
								if (num == 8)
								{
									LoadingDialog.ShowLoading(Localization.Localize(" was not found in Notification Center to remove"), false, false, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
						...
						if (c == '{' || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								...
								default:
								{
									if (num == 3)
									{
										LoadingDialog.ShowLoading(Localization.Localize("reloadTime"), false, true);
									}
									JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i++)
					{
						...
						if (c == -124 || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 2)
								{
									LoadingDialog.FDBHFJFKALH(Localization.Localize("[CFX_SpawnSystem.removeObjectsFromPool()] There aren't any preloaded object for: "), false, true, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 0; i < BJGCPDNMHDH.mResponseString.Length; i++)
					{
						...
						if (c == -1 || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 6)
								{
									LoadingDialog.ShowLoading(Localization.Localize("Wrong_Weapon"), true, false, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 0; i < BJGCPDNMHDH.mResponseString.Length; i += 0)
					{
						...
						if (c == -11 || i == BJGCPDNMHDH.mResponseString.Length - 0)
						{
							...
							else
							{
								if (num == 0)
								{
									LoadingDialog.FDBHFJFKALH(Localization.Localize("Buy_Upgrade_For_Army_Unit_At_Rank"), true, true, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i += 0)
					{
						...
						if (c == -56 || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 7)
								{
									LoadingDialog.ShowLoading(Localization.Localize("#Mission Rewards# Mission Game Rewards Came"), false, false, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i += 0)
					{
						...
						if (c == -106 || i == BJGCPDNMHDH.mResponseString.Length - 0)
						{
							...
							else
							{
								if (num == 2)
								{
									LoadingDialog.FDBHFJFKALH(Localization.Localize("ID_PVP_BATTLE"), true, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 0; i < BJGCPDNMHDH.mResponseString.Length; i += 0)
					{
						...
						if (c == -70 || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 7)
								{
									LoadingDialog.ShowLoading(Localization.Localize("Action "), true, false, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i += 0)
					{
						...
						if (c == 'k' || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 0)
								{
									LoadingDialog.PGFBMJFLHPC(Localization.Localize("withOfferId"), false, true, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i += 0)
					{
						...
						if (c == -29 || i == BJGCPDNMHDH.mResponseString.Length - 0)
						{
							...
							else
							{
								if (num == 0)
								{
									LoadingDialog.PGFBMJFLHPC(Localization.Localize("いいえ"), true, false, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
						...
						if (c == -26 || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								...
								default:
								{
									if (num == 8)
									{
										LoadingDialog.FDBHFJFKALH(Localization.Localize("ID_WARCARDSARESPECIALBONUSES"), false, true);
									}
									JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i += 0)
					{
						...
						if (c == 't' || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 8)
								{
									LoadingDialog.ShowLoading(Localization.Localize("SquadMessages"), true, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
								if (jToken2 is JObject && jToken2["-[^-]*$"] != null)
								{
						...
						if (c == -49 || i == BJGCPDNMHDH.mResponseString.Length - 0)
						{
							...
							else
							{
								...
								default:
								{
									if (num == 5)
									{
										LoadingDialog.ShowLoading(Localization.Localize("S"), true, false, true);
									}
									JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 0; i < BJGCPDNMHDH.mResponseString.Length; i++)
					{
						...
						if (c == '\u0003' || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 7)
								{
									LoadingDialog.PGFBMJFLHPC(Localization.Localize("spriteCollectionTextureCompressed"), true, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
								if (jToken2 is JObject && jToken2["1"] != null)
								{
					...
					for (int i = 0; i < BJGCPDNMHDH.mResponseString.Length; i++)
					{
						...
						if (c == -59 || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 3)
								{
									LoadingDialog.PGFBMJFLHPC(Localization.Localize("ID_LEAGUE0"), false, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
					...
					for (int i = 1; i < BJGCPDNMHDH.mResponseString.Length; i++)
					{
						...
						if (c == -17 || i == BJGCPDNMHDH.mResponseString.Length - 1)
						{
							...
							else
							{
								if (num == 4)
								{
									LoadingDialog.FDBHFJFKALH(Localization.Localize("Start TUNE SDK"), true, true);
								}
								JToken jToken2 = JsonConvert.DeserializeObject<JToken>(stringBuilder.ToString());
		...
		get
		{
			if (mAllSheets == null || mAllSheets.Length == 0)
			{
				...
				foreach (KeyValuePair<Type, int> item in dictionary)
				{
					if (item.Value != 1)
					{
						UnityEngine.Debug.LogError(string.Format("Configurations error, there is {0} configurations of type {1}", item.Value, item.Key));
					}
				}
			}
			return mAllSheets;
	...
	protected override void Awake()
	{
		...
		{
			UnityEngine.Debug.Log(string.Format("Configarations enviromend changed, saved: {0}, current {1}", data.enviroment, Singleton<BeanstalkServerManager>.instance.environment));
			InitSheetVersions(true);
		}
	...
	private void CheckNewConfigsInClient()
	{
		...
		foreach (Google2uComponentBase google2uComponentBase in array)
		{
			...
			if (!data.sheetVersions.ContainsKey(text))
			{
				...
				UnityEngine.Debug.Log(string.Format("Client has new config for: {0} with version {1}", text, data.sheetVersions[text]));
			}
		}
		...
		if (Singleton<CurrentBundleVersion>.instance.shortVersion == initClientVersion)
		{
			...
			{
				UnityEngine.Debug.Log(string.Format("Client is newer, configs stored for: {0} and new version is {1} init sheet config {2}, current bundle version {3}", data.clientVersion, initClientVersion, initSheetConfiguration, Singleton<CurrentBundleVersion>.instance.shortVersion));
		...
		{
			UnityEngine.Debug.Log(string.Format("Client has no suitable init configs, RESETING, configs stored for: {0} and new version is {1} init sheet config {2}, curent bundle version {3}", data.clientVersion, initClientVersion, initSheetConfiguration, Singleton<CurrentBundleVersion>.instance.shortVersion));
			flag = true;
		...
		foreach (string item in list)
		{
			...
			if (initSheetVersion >= num)
			{
				if (initSheetVersion > num)
				{
					UnityEngine.Debug.Log(string.Format("Client has newer config for: {0} Saved version {1} Client version {2}", item, num, initSheetVersion));
				}
			...
			for (int i = 0; i < rows.Count; i++)
			{
				...
				if (list2.Count == dictionary.Count)
				{
					...
					foreach (KeyValuePair<string, bool> item in dictionary)
					{
						...
						{
							UnityEngine.Debug.LogWarning(string.Format("Error - sheet {0} doesnt have column {1}", className, item.Key));
						}
					}
				}
				else
				{
					UnityEngine.Debug.LogError(string.Format("Error - wrong column names and values count ({0} != {1}) for sheet {2}", dictionary.Count, list2.Count, className));
			...
			for (int j = 0; j < rows.Count; j++)
			{
				if (j < google2uComponentBase.RowsGeneric.Count)
				{
					...
					foreach (KeyValuePair<string, string> item in dictionary2)
					{
						...
						if (!google2uComponentBase.HasColumn(item.Key))
						{
							UnityEngine.Debug.LogError(string.Format("Error - sheet {0} doesnt have column {1}", text, item.Key));
						}
