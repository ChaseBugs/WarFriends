...
public class PLIABAOLHBE : JPCPNFFLMEH
{
	...
	public void MOMMOLBPJAI()
	{
		if (IKPIPKELFOG != null)
		{
			if (IILGAIJKADE)
			{
				GDBAPFIKEJN(IKPIPKELFOG.productId, false, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
			}
			else
			{
				GDBAPFIKEJN(IKPIPKELFOG.productId, true, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
			}
		}
	...
	private void CMBPIKNDJMJ(GooglePurchase IIIMLIABAAH)
	{
		...
		if (IIIMLIABAAH.purchaseState == GooglePurchase.GooglePurchaseState.Purchased)
		{
			...
			{
				GDBAPFIKEJN(IIIMLIABAAH.productId, false, IIIMLIABAAH.purchaseToken, IIIMLIABAAH.packageName, IIIMLIABAAH.orderId);
				return;
			}
			if (this.IKGEGHACJJD != null)
			{
	...
	private InAppsRow MEIIBAGJLKE(string OHDLEEDGFDI)
	{
		...
		{
			if (string.Compare(row.NAME, text, true) == 0)
			{
				return row;
			}
		}
	...
	private void OGDEKIPBHHE(GooglePurchase IIIMLIABAAH)
	{
		if (DLDMCGIPEIB.OIAGFJIBFHI(IIIMLIABAAH.developerPayload) || ENHKIPGOLDO > 0)
		{
			...
			OEMHIHDKDAK(IIIMLIABAAH.productId, false, IIIMLIABAAH.purchaseToken, IIIMLIABAAH.packageName, IIIMLIABAAH.orderId);
	...
	private InAppsRow KDCCBECAELK(string OHDLEEDGFDI)
	{
		...
		foreach (InAppsRow row in Singleton<GameVariables>.instance.inApps.Rows)
		{
			if (string.Compare(row.NAME, text, false) == 0)
			{
				return row;
			}
		}
	...
	private void HHFGPKOEDJI(GooglePurchase IIIMLIABAAH)
	{
		...
		if (IIIMLIABAAH.purchaseState == GooglePurchase.GooglePurchaseState.Purchased)
		{
			...
			if (IIIMLIABAAH.developerPayload == JAKNLAOBAEK)
			{
				AHLIMFOFFIJ(IIIMLIABAAH.productId, true, IIIMLIABAAH.purchaseToken, IIIMLIABAAH.packageName, IIIMLIABAAH.orderId);
				return;
			}
			if (this.IKGEGHACJJD != null)
			{
	...
	public void IFDCLIJJGFH()
	{
		if (IKPIPKELFOG != null)
		{
			if (IILGAIJKADE)
			{
				GHGNFCMGBPG(IKPIPKELFOG.productId, true, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
			}
			else
			{
				FBALOKPAHAC(IKPIPKELFOG.productId, true, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
			}
		}
		List<Dictionary<string, string>> list = new List<Dictionary<string, string>>();
		List<Dictionary<string, string>> list2 = new List<Dictionary<string, string>>();
	...
	private void OEDFCKAJMCD(GooglePurchase IIIMLIABAAH)
	{
		...
		if (IIIMLIABAAH.purchaseState == GooglePurchase.GooglePurchaseState.Purchased)
		{
			...
			if (IIIMLIABAAH.developerPayload == JAKNLAOBAEK)
			{
				DMEOGKOKAPG(IIIMLIABAAH.productId, true, IIIMLIABAAH.purchaseToken, IIIMLIABAAH.packageName, IIIMLIABAAH.orderId);
				return;
			}
			if (this.IKGEGHACJJD != null)
			{
	...
	public void ENBFDGEPOGF()
	{
		if (IKPIPKELFOG != null)
		{
			if (IILGAIJKADE)
			{
				MJFKBMONIPD(IKPIPKELFOG.productId, true, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
			}
			else
			{
				AHLIMFOFFIJ(IKPIPKELFOG.productId, false, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
			}
		}
		List<Dictionary<string, string>> list = new List<Dictionary<string, string>>();
		List<Dictionary<string, string>> list2 = new List<Dictionary<string, string>>();
	...
	public void NAHJEOEJJOJ()
	{
		if (IKPIPKELFOG != null)
		{
			if (IILGAIJKADE)
			{
				AHLIMFOFFIJ(IKPIPKELFOG.productId, true, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
			}
			else
			{
				AHLIMFOFFIJ(IKPIPKELFOG.productId, false, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
	...
	private void JAAPLODAMHB(GooglePurchase IIIMLIABAAH)
	{
		...
		if (IIIMLIABAAH.purchaseState == GooglePurchase.GooglePurchaseState.Purchased)
		{
			...
			if (IIIMLIABAAH.developerPayload == JAKNLAOBAEK)
			{
				GDBAPFIKEJN(IIIMLIABAAH.productId, true, IIIMLIABAAH.purchaseToken, IIIMLIABAAH.packageName, IIIMLIABAAH.orderId);
				return;
			}
			if (this.IKGEGHACJJD != null)
			{
	...
	public void OOIGDJEIDGF()
	{
		if (IKPIPKELFOG != null)
		{
			if (IILGAIJKADE)
			{
				GHGNFCMGBPG(IKPIPKELFOG.productId, false, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
			}
			else
			{
				GHGNFCMGBPG(IKPIPKELFOG.productId, false, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
	...
	private void GCPPOFBCJJP(GooglePurchase IIIMLIABAAH)
	{
		...
		if (IIIMLIABAAH.purchaseState == GooglePurchase.GooglePurchaseState.Purchased)
		{
			...
			if (IIIMLIABAAH.developerPayload == JAKNLAOBAEK)
			{
				OEMHIHDKDAK(IIIMLIABAAH.productId, true, IIIMLIABAAH.purchaseToken, IIIMLIABAAH.packageName, IIIMLIABAAH.orderId);
				return;
			}
			if (this.IKGEGHACJJD != null)
			{
	...
	private void KDDGKMHIIOB(GooglePurchase IIIMLIABAAH)
	{
		if (DLDMCGIPEIB.MIOAFIAMKLF(IIIMLIABAAH.developerPayload) || ENHKIPGOLDO > 1)
		{
			...
			DMEOGKOKAPG(IIIMLIABAAH.productId, false, IIIMLIABAAH.purchaseToken, IIIMLIABAAH.packageName, IIIMLIABAAH.orderId);
	...
	public void HEJPDFLCHIO()
	{
		if (IKPIPKELFOG != null)
		{
			if (IILGAIJKADE)
			{
				ICFJILDAOJC(IKPIPKELFOG.productId, false, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
			}
			else
			{
				OEMHIHDKDAK(IKPIPKELFOG.productId, true, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
			}
		}
		List<Dictionary<string, string>> list = new List<Dictionary<string, string>>();
		List<Dictionary<string, string>> list2 = new List<Dictionary<string, string>>();
	...
	{
		Debug.Log(string.Format("queryInventorySucceededEvent. total purchases: {0}, total skus: {1}", IFFLANPMJKO.Count, MKNHMANHHJE.Count));
		HJDMBMDACIK = false;
		foreach (GoogleSkuInfo item in MKNHMANHHJE)
		{
			IMCGFCIGAEF[item.productId] = item;
	...
	private void BLCBMJMCIJM(GooglePurchase IIIMLIABAAH)
	{
		...
		if (IIIMLIABAAH.purchaseState == GooglePurchase.GooglePurchaseState.Purchased)
		{
			...
			if (IIIMLIABAAH.developerPayload == JAKNLAOBAEK)
			{
				MJFKBMONIPD(IIIMLIABAAH.productId, true, IIIMLIABAAH.purchaseToken, IIIMLIABAAH.packageName, IIIMLIABAAH.orderId);
				return;
			}
			if (this.IKGEGHACJJD != null)
			{
	...
	private void JNEFCOKBAPJ(GooglePurchase IIIMLIABAAH)
	{
		...
		{
			DLDMCGIPEIB.ANIMPKAAFNN(IIIMLIABAAH.developerPayload);
			MJFKBMONIPD(IIIMLIABAAH.productId, false, IIIMLIABAAH.purchaseToken, IIIMLIABAAH.packageName, IIIMLIABAAH.orderId);
	...
	public void FKGGMJLPEAB(string HOILIFMFLGG)
	{
		...
		{
			GuiElementSingle<WaitingDialog>.instance.HideDialog();
			WarningDialog.ShowError(Localization.Localize("SquadId"), Localization.Localize("extraWarBucks"), 448f, KGLBPIFFMHI, string.Empty, true);
			Singleton<SessionManager>.instance.FinishInapp();
			GMJIMDPGBEK(text);
		}
	}
	...
	public void AFEGHGJGLND()
	{
		if (IKPIPKELFOG != null)
		{
			if (IILGAIJKADE)
			{
				DMEOGKOKAPG(IKPIPKELFOG.productId, true, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
			}
			else
			{
				AHLIMFOFFIJ(IKPIPKELFOG.productId, false, IKPIPKELFOG.purchaseToken, IKPIPKELFOG.packageName, IKPIPKELFOG.orderId);
