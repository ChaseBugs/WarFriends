...
public class UpgradeSlotSpecial : UpgradeSlot
{
	...
	public override bool isMaxUpgraded
	{
		get
		{
			return base.isMaxUpgraded || owner.startTier >= 6;
		}
	}
	...
	public string abilityStartValue
	{
		get
		{
	...
	public override int armyPowerX10
	{
		get
		{
			return LFNLPNEONEI(base.boughtIndexAbsolute, owner.actualTier);
		}
	}
