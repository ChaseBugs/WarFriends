...
public class CardTurret : Card
{
	...
	public virtual void NEPIKOKDBHP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		SpawningManager.instance.SpawnForCard(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void DCGABENHDBH(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		SpawningManager.BMNEPICFHNO().MGIDDHIPJBC(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void LLMMIFJBLBD(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.OEJKKJJFDFL() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.instance.OMANPOHJAGO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void NPGNJOGAEMK(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		SpawningManager.instance.EEOMJOEDAMO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void MLEBPBFEOKC(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.OEJKKJJFDFL() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.instance.JAMPFGHHAPP(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void OFNENBNMMOO(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.GetPlayerOld(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.BPNPPKPCFGN() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.OKBAIGKCPKA().OMANPOHJAGO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void MEMDELDKFJI(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.BCCDDJMPBLL / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.instance.GGBPHPOPCAM(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void DGCEELPOEHP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.GetPlayerOld(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.OCPEHLIIGML() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.instance.MGIDDHIPJBC(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void EKFKAICCHLI(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.ALJJMKANFNO() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.OKBAIGKCPKA().JAMPFGHHAPP(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void EEJJPCKLAMB(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.CCPHMCAIJNA(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.ALJJMKANFNO() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.instance.OMANPOHJAGO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void ABMOHFELOFN(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.MAJOCMGOFII(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.OCPEHLIIGML() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.BMNEPICFHNO().SpawnForCard(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void BKMGMNGKBMB(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.BPNPPKPCFGN() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.BMNEPICFHNO().GGBPHPOPCAM(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void LEEFEJHDLGM(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.GetPlayerOld(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.BCCDDJMPBLL / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.BMNEPICFHNO().SpawnForCard(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void JONIGCEPKLO(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.GetPlayerOld(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.BPNPPKPCFGN() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.instance.EEOMJOEDAMO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void GDHGFMCBDJI(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.BCCDDJMPBLL / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.BMNEPICFHNO().JAMPFGHHAPP(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void BHBDBJNOCMP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.MAJOCMGOFII(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.BCCDDJMPBLL / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.OKBAIGKCPKA().SpawnForCard(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void LOLJCEGGPMI(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.GetPlayerOld(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.BPNPPKPCFGN() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.LDGAKJJINEO().EEOMJOEDAMO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void DEAKMOJEFEK(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.OEJKKJJFDFL() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.BMNEPICFHNO().GGBPHPOPCAM(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void PNAGDNEPGHP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.GetPlayerOld(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.OEJKKJJFDFL() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.LDGAKJJINEO().OMANPOHJAGO(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void NPODFBNDOAK(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.MAJOCMGOFII(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.OCPEHLIIGML() / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.OKBAIGKCPKA().SpawnForCard(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 1, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void GDEHLDBGNHB(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		MBIAKMPDOPG = PlayerController.HEAGPACBLJA(CIOPAKLHFIL);
		float pAENPHMEMGC = (float)MBIAKMPDOPG.EHHHBEMKGOE.BCCDDJMPBLL / (float)LevelManager.instance.maxDisplayLevel;
		SpawningManager.BMNEPICFHNO().JAMPFGHHAPP(Singleton<ObjectPoolDatabase>.instance.KAEAMDOJMIF.IAJJBAJOGDM, 0, pAENPHMEMGC, MBIAKMPDOPG.fraction, Vector3.zero, false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
