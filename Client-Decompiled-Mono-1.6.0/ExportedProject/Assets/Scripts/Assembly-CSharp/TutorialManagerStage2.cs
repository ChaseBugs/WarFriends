...
public class TutorialManagerStage2 : TutorialManagerBase
{
	...
	private sealed class EBHCHMCIKFO : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MoveNext()
		{
			...
			case 1u:
				...
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, false);
				}
				...
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.UpdateHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, false);
				}
				PHDOCKCBJOF = null;
				if (!FDKOKMKIIMG)
				{
		...
		public bool KHNDCDGBFJH()
		{
			...
			case 1u:
				if (Input.GetMouseButtonUp(0))
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, true, 940f);
				}
		...
		public bool FNEPBDLIKOD()
		{
			...
			case 1u:
				...
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, true, 165f);
				}
				else if (Input.GetMouseButtonDown(0))
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.InstantStopHoldAnimation();
		...
		public bool NEMOAIBCODB()
		{
			...
			case 1u:
				if (Input.GetMouseButtonUp(0))
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, true, 486f);
				}
				else if (Input.GetMouseButtonDown(1))
				{
		...
		public bool JPBGJLDMOPO()
		{
			...
			case 1u:
				if (Input.GetMouseButtonUp(1))
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, false, 1735f);
				}
				else if (Input.GetMouseButtonDown(0))
				{
					GuiElementSingle<TutorialOverlayGuiElement>.instance.MGAEDHDIGFB();
	...
	private sealed class CMLLMGJMFKA : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MOFPMNMAOND()
		{
			...
			case 4u:
				...
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN(", name = ", "ID_CONFIRM_ERROR", 1f, TutorialDialog.DODBDLEJOAM.Right, true, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, false, 627f);
			...
			case 5u:
				...
				Singleton<TutorialProgressShower>.instance.BKGBNEAFCCC(0, false);
		...
		public bool HDGDKCMIOGK()
		{
			...
			case 2u:
				...
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("Network pool: InstantiatePooledObjects '", "Shots_Fired", 1770f, TutorialDialog.DODBDLEJOAM.Right, true);
				BCPOJIEKMJH = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[8].transform.position + 1251f * Vector3.up;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(BCPOJIEKMJH, true, false, 1971f);
				TimeManager.FODFANEEDFF();
				DeathMatchUnitsGuiElement.instance.DisableCardClick();
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().JADNIAFKNIF(false);
				BJGCPDNMHDH.mShowDeployHint = false;
				goto case 3u;
			case 3u:
			...
			case 4u:
				...
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("ID_CONFIRM_FBLOGINCANCELLED_TEXT", "ClientVersion", 1205f, TutorialDialog.DODBDLEJOAM.Top, false, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, true, 258f);
				EAKENBHDGMO = RadicalRoutine.Create(BJGCPDNMHDH.UpdateHoldSniperShoot());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(EAKENBHDGMO.enumerator));
				goto case 5u;
			case 5u:
		...
		public bool OKELILGDPLJ()
		{
			...
			case 2u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(BCPOJIEKMJH, true, false, 315f);
				TimeManager.FreezeGame();
				DeathMatchUnitsGuiElement.instance.DisableCardClick();
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().JADNIAFKNIF(true, false);
				BJGCPDNMHDH.mShowDeployHint = false;
				goto case 3u;
			case 3u:
			...
			case 4u:
				...
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("expiresOn", "OnDisconnectedFromPhoton", 1233f, TutorialDialog.DODBDLEJOAM.BottomRight, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, false, 1795f);
				EAKENBHDGMO = RadicalRoutine.Create(BJGCPDNMHDH.UpdateHoldSniperShoot());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(EAKENBHDGMO.enumerator));
				goto case 5u;
			case 5u:
				...
				Singleton<TutorialProgressShower>.instance.BMBAEDIOBKN(0, false);
				BJGCPDNMHDH.UnfreezeEnemies();
		...
		public bool LPCBKGKFNFD()
		{
			...
			case 2u:
				...
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("02", "BANDS_EMPTY", 1050f, TutorialDialog.DODBDLEJOAM.Top, true, true);
				BCPOJIEKMJH = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[6].transform.position + 436f * Vector3.up;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(BCPOJIEKMJH, false, false, 1422f);
				TimeManager.DCODDANOPCP();
				DeathMatchUnitsGuiElement.instance.DisableCardClick();
				DeathMatchUnitsGuiElement.BLHCFKIELCA().JADNIAFKNIF(true, false);
				BJGCPDNMHDH.mShowDeployHint = true;
				goto case 3u;
			case 3u:
			...
			case 4u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("GoldBonusCount", "ID_SQUADWAREND", 1299f, TutorialDialog.DODBDLEJOAM.Left, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, false, 1581f);
				EAKENBHDGMO = RadicalRoutine.Create(BJGCPDNMHDH.UpdateHoldSniperShoot());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(EAKENBHDGMO.enumerator));
				goto case 5u;
			case 5u:
				...
				Singleton<TutorialProgressShower>.instance.JPNBJLFCNKD(1, false);
				BJGCPDNMHDH.UnfreezeEnemies();
		...
		public bool KHNDCDGBFJH()
		{
			...
			case 2u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(BCPOJIEKMJH, false, false, 1014f);
				TimeManager.DCODDANOPCP();
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().DisableCardClick();
				DeathMatchUnitsGuiElement.BLHCFKIELCA().ShowHintText(false, false);
				BJGCPDNMHDH.mShowDeployHint = true;
				goto case 3u;
			case 3u:
			...
			case 4u:
				...
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("Buy_VIP", "Rewards", 858f, TutorialDialog.DODBDLEJOAM.TopRight, true, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, false, 1122f);
				EAKENBHDGMO = RadicalRoutine.Create(BJGCPDNMHDH.UpdateHoldSniperShoot());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(EAKENBHDGMO.enumerator));
				goto case 5u;
			case 5u:
		...
		public bool LLOCENNFFFJ()
		{
			...
			case 2u:
				...
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN(",", "ExperienceGained", 950f, TutorialDialog.DODBDLEJOAM.TopLeft, true, true);
				BCPOJIEKMJH = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[7].transform.position + 525f * Vector3.up;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(BCPOJIEKMJH, true, false, 1863f);
				TimeManager.FreezeGame();
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().DisableCardClick();
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().ShowHintText(true, false);
				BJGCPDNMHDH.mShowDeployHint = true;
				goto case 3u;
			case 3u:
			...
			case 4u:
				...
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("Node", "Current unit is not delivered at the moment!!!", 1569f, TutorialDialog.DODBDLEJOAM.Left, true, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, false, 1716f);
				EAKENBHDGMO = RadicalRoutine.Create(BJGCPDNMHDH.UpdateHoldSniperShoot());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(EAKENBHDGMO.enumerator));
				goto case 5u;
			case 5u:
		...
		public bool CCOPPEKLJOB()
		{
			...
			case 2u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("' already destroyed on application quit. Won't create again - returning null.", "TuneListener trackerDidEnqueueUrl: ", 30f, TutorialDialog.DODBDLEJOAM.Right, false, true);
				BCPOJIEKMJH = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[1].transform.position + 1955f * Vector3.up;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(BCPOJIEKMJH, false, false, 1772f);
				TimeManager.FreezeGame();
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().DisableCardClick();
				DeathMatchUnitsGuiElement.BLHCFKIELCA().ShowHintText(true, false);
				BJGCPDNMHDH.mShowDeployHint = true;
				goto case 3u;
			case 3u:
			...
			case 4u:
				...
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("SERVICE_MISSING", "menu-tilegfx-facebook", 748f, TutorialDialog.DODBDLEJOAM.BottomRight, true, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, true, 1434f);
				EAKENBHDGMO = RadicalRoutine.Create(BJGCPDNMHDH.UpdateHoldSniperShoot());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(EAKENBHDGMO.enumerator));
				goto case 5u;
			case 5u:
		...
		public bool FBMLBIOKKBE()
		{
			...
			case 2u:
				...
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("damage", "AddedCards", 390f, TutorialDialog.DODBDLEJOAM.Bottom, true, true);
				BCPOJIEKMJH = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[1].transform.position + 1735f * Vector3.up;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(BCPOJIEKMJH, false, true, 1031f);
				TimeManager.DCODDANOPCP();
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().DisableCardClick();
				DeathMatchUnitsGuiElement.instance.ShowHintText(true, false);
				BJGCPDNMHDH.mShowDeployHint = false;
				goto case 3u;
			case 3u:
			...
			case 4u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("Completed", "HeartPrice", 799f, TutorialDialog.DODBDLEJOAM.TopLeft, true, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, true, 1116f);
				EAKENBHDGMO = RadicalRoutine.Create(BJGCPDNMHDH.UpdateHoldSniperShoot());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(EAKENBHDGMO.enumerator));
				goto case 5u;
			case 5u:
				...
				Singleton<TutorialProgressShower>.instance.PPADPIDMPGN(1, false);
				BJGCPDNMHDH.UnfreezeEnemies();
		...
		public bool KDFAHLNCNMN()
		{
			...
			case 2u:
				...
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("com/google/android/gms/games/Games", "NO", 882f, TutorialDialog.DODBDLEJOAM.BottomRight, true, true);
				BCPOJIEKMJH = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[0].transform.position + 1748f * Vector3.up;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(BCPOJIEKMJH, true, false, 1232f);
				TimeManager.FreezeGame();
			...
			case 4u:
				...
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("UpdateFriendsListFromServer()", "ID_CONFIRM_NOTENOUGHMEDALSTOJOIN", 1233f, TutorialDialog.DODBDLEJOAM.Right, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, true, 1300f);
				EAKENBHDGMO = RadicalRoutine.Create(BJGCPDNMHDH.UpdateHoldSniperShoot());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(EAKENBHDGMO.enumerator));
				goto case 5u;
			case 5u:
		...
		public bool LPMIKEPIMCM()
		{
			...
			case 2u:
				...
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("SquadIcons/", "_CameraWS", 314f, TutorialDialog.DODBDLEJOAM.Center, false, true);
				BCPOJIEKMJH = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[7].transform.position + 1248f * Vector3.up;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(BCPOJIEKMJH, true, false, 1986f);
				TimeManager.DCODDANOPCP();
				DeathMatchUnitsGuiElement.instance.DisableCardClick();
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().JADNIAFKNIF(true);
				BJGCPDNMHDH.mShowDeployHint = false;
				goto case 3u;
			case 3u:
			...
			case 4u:
				...
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("null", "menu-armypower-ico", 1798f, TutorialDialog.DODBDLEJOAM.Left, true, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, false, 855f);
				EAKENBHDGMO = RadicalRoutine.Create(BJGCPDNMHDH.UpdateHoldSniperShoot());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(EAKENBHDGMO.enumerator));
				goto case 5u;
			case 5u:
		...
		public bool FADACBKMFGG()
		{
			...
			case 2u:
				...
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("Vip", "Cards_Owned_Bronze", 204f, TutorialDialog.DODBDLEJOAM.BottomRight, true, true);
				BCPOJIEKMJH = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[5].transform.position + 476f * Vector3.up;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(BCPOJIEKMJH, true, true, 467f);
				TimeManager.FODFANEEDFF();
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().DisableCardClick();
				DeathMatchUnitsGuiElement.instance.JADNIAFKNIF(false, false);
				BJGCPDNMHDH.mShowDeployHint = false;
				goto case 3u;
			case 3u:
			...
			case 4u:
				...
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("Play_Card_Tutorial_Duration", "ID_ONETIMESPECIALOFFER", 1171f, TutorialDialog.DODBDLEJOAM.Left, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, false, 1488f);
				EAKENBHDGMO = RadicalRoutine.Create(BJGCPDNMHDH.UpdateHoldSniperShoot());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(EAKENBHDGMO.enumerator));
				goto case 5u;
			case 5u:
		...
		public bool HMLAEHJKPJE()
		{
			...
			case 2u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(BCPOJIEKMJH, true, false, 641f);
				TimeManager.FODFANEEDFF();
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().DisableCardClick();
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().JADNIAFKNIF(false);
				BJGCPDNMHDH.mShowDeployHint = false;
				goto case 3u;
			case 3u:
			...
			case 4u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial(")", "Finish Game", 1129f, TutorialDialog.DODBDLEJOAM.Bottom, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartHoldAnimation(BJGCPDNMHDH.mParatrooperPosition, true, 41f);
				EAKENBHDGMO = RadicalRoutine.Create(BJGCPDNMHDH.UpdateHoldSniperShoot());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(EAKENBHDGMO.enumerator));
				goto case 5u;
			case 5u:
	...
	private sealed class EEBKAGLDPHL : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool BGOEENAEBNO()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().MDBPINJMNKO.GAODJMFOOHM(false);
		...
		public bool JPAOKNLNFCB()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().MDBPINJMNKO.PPGEPMHPNDB(false);
		...
		public bool ONFBKOEOIOC()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().MDBPINJMNKO.AHPJFHNNODC(true);
		...
		public bool CJGKHIPOBGP()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BLHCFKIELCA().MDBPINJMNKO.GAODJMFOOHM(true);
		...
		public bool HOOHJGPHHGN()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BLHCFKIELCA().MDBPINJMNKO.INGNIDHDLPD(false);
		...
		public bool IGOAJGEADPH()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BLHCFKIELCA().MDBPINJMNKO.PJFDIEGEGAC(false);
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().MDBPINJMNKO.OIADGFDOPJM();
		...
		public bool FPOFCJOEAMO()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().MDBPINJMNKO.GAODJMFOOHM(true);
		...
		public bool NEMOAIBCODB()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.instance.MDBPINJMNKO.LIOJDDABNKO(true);
		...
		public bool FOKKNCCLABE()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().MDBPINJMNKO.PFPLHOHDFFD(true);
		...
		public bool PGOBEIMCPGA()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.instance.MDBPINJMNKO.PJFDIEGEGAC(false);
		...
		public bool LAICPPPPIKL()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().MDBPINJMNKO.INGNIDHDLPD(false);
		...
		public bool EEJLFIHFDLK()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().MDBPINJMNKO.NHOKPBAKMKL(false);
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().MDBPINJMNKO.OIADGFDOPJM();
		...
		public bool GMBFJOBKMMN()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BLHCFKIELCA().MDBPINJMNKO.PJFDIEGEGAC(true);
		...
		public bool HEHJAEIGHDN()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BLHCFKIELCA().MDBPINJMNKO.NHOKPBAKMKL(false);
		...
		public bool PJJPPMIBNLN()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BLHCFKIELCA().MDBPINJMNKO.PPGEPMHPNDB(false);
				DeathMatchUnitsGuiElement.BLHCFKIELCA().MDBPINJMNKO.HDOFLJONIFH();
		...
		public bool GBHCODKDPBO()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BCDJJBAFLLG().MDBPINJMNKO.PPGEPMHPNDB(true);
				DeathMatchUnitsGuiElement.instance.MDBPINJMNKO.InstantUpdate();
		...
		public bool CGOKGPGALLH()
		{
			...
			case 4u:
				...
				DeathMatchUnitsGuiElement.BKLDAAPMMDI().MDBPINJMNKO.BDHPCMOGAHF(true);
	...
	private sealed class CCBNMMIKEHF : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool IEDGDDDADFM()
		{
			...
			case 2u:
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("Player connectionState {0} to player {1}", string.Empty, 1446f, TutorialDialog.DODBDLEJOAM.BottomLeft, true, true);
		...
		public bool MKLIDMNLNPN()
		{
			...
			case 2u:
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("level", string.Empty, 367f, TutorialDialog.DODBDLEJOAM.Bottom, false, true);
		...
		public bool LPCBKGKFNFD()
		{
			...
			case 2u:
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("com/google/android/gms/common/api/Status", string.Empty, 1062f, TutorialDialog.DODBDLEJOAM.Bottom, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
		...
		public bool HNCDLFFBMAA()
		{
			...
			case 2u:
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("Overtime_Was_Already_Explained", string.Empty, 691f, TutorialDialog.DODBDLEJOAM.Top, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool PKOMECFNPIP()
		{
			...
			case 2u:
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("GLM: current player is null while adding FB account!!", string.Empty, 567f, TutorialDialog.DODBDLEJOAM.Bottom, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool JICHKPANPEE()
		{
			...
			case 2u:
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("Skill", string.Empty, 356f, TutorialDialog.DODBDLEJOAM.BottomRight, true, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
				BJGCPDNMHDH.data.overtimeShowed = false;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool IIJKAMFGNKA()
		{
			...
			case 2u:
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("Beanstalk: That account already exists! Player will choose how to proceed, provider = ", string.Empty, 165f, TutorialDialog.DODBDLEJOAM.TopRight, true, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
				BJGCPDNMHDH.data.overtimeShowed = false;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool EBLHEEKHANA()
		{
			...
			case 2u:
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("C5", string.Empty, 841f, TutorialDialog.DODBDLEJOAM.BottomLeft, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool BKJCILLNJLG()
		{
			...
			case 2u:
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("Automatic_Equip", string.Empty, 1412f, TutorialDialog.DODBDLEJOAM.Top, false, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
				BJGCPDNMHDH.data.overtimeShowed = false;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool FBMLBIOKKBE()
		{
			...
			case 2u:
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("DogTagSeconds", string.Empty, 1312f, TutorialDialog.DODBDLEJOAM.BottomLeft, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool HDGDKCMIOGK()
		{
			...
			case 2u:
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("ID_FREEPERCENTLINE", string.Empty, 273f, TutorialDialog.DODBDLEJOAM.Left, false, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool CJGKHIPOBGP()
		{
			...
			case 2u:
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("ID_CONFIRM_SERVERERROR", string.Empty, 917f, TutorialDialog.DODBDLEJOAM.Bottom, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool EEJLFIHFDLK()
		{
			...
			case 2u:
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("com/google/android/gms/common/ConnectionResult", string.Empty, 852f, TutorialDialog.DODBDLEJOAM.Center, false, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool LMNIKLKKIDN()
		{
			...
			case 2u:
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("!!!ROTATED!!! ", string.Empty, 510f, TutorialDialog.DODBDLEJOAM.Right, true, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool FNIOOIGJPAM()
		{
			...
			case 2u:
				TimeManager.FODFANEEDFF();
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("Mortar", string.Empty, 1702f, TutorialDialog.DODBDLEJOAM.Left, false, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
		...
		public bool HOJKAHEGFEB()
		{
			...
			case 2u:
				TimeManager.DCODDANOPCP();
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("ID_GUI_REPORTABUSE_LISTITEM1", string.Empty, 1032f, TutorialDialog.DODBDLEJOAM.Top, false, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
				BJGCPDNMHDH.data.overtimeShowed = true;
				BJGCPDNMHDH.Save();
				goto case 3u;
	...
	private sealed class GHIEJKBFMGP : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MPKAJACHAIC()
		{
			...
			case 1u:
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("SetDepositedCards ", "null", 1527f, TutorialDialog.DODBDLEJOAM.Left, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = true;
		...
		public bool MoveNext()
		{
			...
			case 1u:
				TimeManager.FreezeGame();
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("ID_TUTORIAL_FULL_ARSENAL", "ID_TUTORIAL_FULL_ARSENAL_DOWN", 0.3f, TutorialDialog.DODBDLEJOAM.Center, true);
				PlayerController.OGMBJPKOPCB.CDBNKOPKCJB = false;
				GuiElementSingle<InventoryGuiElement>.instance.ShowHintText();
				goto case 2u;
			case 2u:
	...
	private sealed class CNMJNKEDIDL : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MoveNext()
		{
			...
			case 1u:
				HKBJMFKAINC = PlayerController.OGMBJPKOPCB.FOCIOKMPCAG.AMEELJHHGKP[1].transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.UpdateSwipeAnimation(HKBJMFKAINC, BJGCPDNMHDH.mGrenadeArea, false);
				PHDOCKCBJOF = null;
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 1;
		...
		public bool MPKAJACHAIC()
		{
			...
			case 1u:
				HKBJMFKAINC = PlayerController.OGMBJPKOPCB.FOCIOKMPCAG.AMEELJHHGKP[1].transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.IEGPPIEBKHO(HKBJMFKAINC, BJGCPDNMHDH.mGrenadeArea, false);
				PHDOCKCBJOF = null;
				if (!FDKOKMKIIMG)
				{
					CLPPIAGLCJJ = 0;
	...
	private sealed class PGEEEBOLBKB : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool LGNMOMFLLPP()
		{
			...
			case 2u:
				...
				{
					HHELJCBOLBK = true;
					GuiElementSingle<TutorialDialog>.instance.KOGOLIJLMDN("N", "isAdAvailableForZoneID", 267f, TutorialDialog.DODBDLEJOAM.Center, true, true);
					HHLJPFODNCN = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[0].transform.position + 1487f * Vector3.up;
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(HHLJPFODNCN, false, true, 1537f);
				...
				HHELJCBOLBK = true;
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("VipReward1", string.Empty, 556f, TutorialDialog.DODBDLEJOAM.Left, true, true);
				EGFCLDDDIEL = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[1].transform.position + 1101f * Vector3.up;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(EGFCLDDDIEL, true, true, 1366f);
				PlayerController.OGMBJPKOPCB.JODNNABEFDH = false;
				TimeManager.FreezeGame();
				PlayerController.OGMBJPKOPCB.FMKGGADDHJK().HKGLMFFAHFN = false;
				goto case 5u;
			...
			case 7u:
				...
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("ID_CONFIRM_STARTUPERROR", "Hide All Dialogs called", 209f, TutorialDialog.DODBDLEJOAM.BottomRight, true, true);
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartSwipeAnimation(OPLCMEMJBBO, BJGCPDNMHDH.mGrenadeArea, 944f, true, 1118f);
		...
		public bool MoveNext()
		{
			...
			case 2u:
				...
				HHELJCBOLBK = false;
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("ID_TUTORIAL_GRENADE_UP", string.Empty, 0f, TutorialDialog.DODBDLEJOAM.Center, true);
			...
			case 7u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartSwipeAnimation(OPLCMEMJBBO, BJGCPDNMHDH.mGrenadeArea, 0.3f, false, 1.3f);
				CGNJAHMKLMI = RadicalRoutine.Create(BJGCPDNMHDH.UpdateSwipeGrenadeThrow());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(CGNJAHMKLMI.enumerator));
				TimeManager.UnFreezeGame();
				BJGCPDNMHDH.FreezeEnemies();
		...
		public bool HKPECDLGFJB()
		{
			...
			case 2u:
				...
				{
					HHELJCBOLBK = false;
					GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("GameReward", "BeanstalkServerManager: PlayerDataLoaded", 40f, TutorialDialog.DODBDLEJOAM.BottomRight, true, true);
					HHLJPFODNCN = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[1].transform.position + 985f * Vector3.up;
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(HHLJPFODNCN, true, false, 897f);
					PlayerController.OGMBJPKOPCB.JODNNABEFDH = false;
					TimeManager.DCODDANOPCP();
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EGFCLDDDIEL, true, false, 856f);
				PlayerController.OGMBJPKOPCB.JODNNABEFDH = true;
				TimeManager.DCODDANOPCP();
				PlayerController.OGMBJPKOPCB.BEIIOAIJMFK().HKGLMFFAHFN = true;
				goto case 5u;
			...
			case 7u:
				...
				NIACJNHCAEK = (int)TimeManager.realTimeWithoutPauses;
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("S", "{0}{1}[-]", 755f, TutorialDialog.DODBDLEJOAM.BottomLeft, true);
				BJGCPDNMHDH.mGrenadeArea = ONCEGKNMJLM.IGEEPAPBDCP.transform.position;
				OPLCMEMJBBO = PlayerController.OGMBJPKOPCB.FOCIOKMPCAG.AMEELJHHGKP[1].transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartSwipeAnimation(OPLCMEMJBBO, BJGCPDNMHDH.mGrenadeArea, 1758f, false, 663f);
				CGNJAHMKLMI = RadicalRoutine.Create(BJGCPDNMHDH.UpdateSwipeGrenadeThrow());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(CGNJAHMKLMI.enumerator));
			...
			case 8u:
				...
				Singleton<TutorialProgressShower>.instance.GHDHGMBLGLE(1, false);
				PlayerController.OGMBJPKOPCB.JODNNABEFDH = true;
				PlayerController.OGMBJPKOPCB.JLMDEMFIHCA().HKGLMFFAHFN = true;
		...
		public bool DDLMLOJGJMA()
		{
			...
			case 2u:
				...
				{
					HHELJCBOLBK = false;
					GuiElementSingle<TutorialDialog>.instance.BLHEPOBPHPK("ArmyPower", "_D", 563f, TutorialDialog.DODBDLEJOAM.Left, false, true);
					HHLJPFODNCN = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[1].transform.position + 1725f * Vector3.up;
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(HHLJPFODNCN, true, true, 1738f);
					PlayerController.OGMBJPKOPCB.JODNNABEFDH = true;
					TimeManager.FODFANEEDFF();
					PHDOCKCBJOF = new WaitForRealSeconds(702f);
					if (!FDKOKMKIIMG)
				...
				HHELJCBOLBK = false;
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial(",", string.Empty, 1309f, TutorialDialog.DODBDLEJOAM.Bottom, true, true);
				EGFCLDDDIEL = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[1].transform.position + 248f * Vector3.up;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(EGFCLDDDIEL, true, true, 30f);
				PlayerController.OGMBJPKOPCB.JODNNABEFDH = true;
				TimeManager.FreezeGame();
				PlayerController.OGMBJPKOPCB.BEIIOAIJMFK().HKGLMFFAHFN = true;
				goto case 5u;
			...
			case 7u:
				...
				NIACJNHCAEK = (int)TimeManager.realTimeWithoutPauses;
				GuiElementSingle<TutorialDialog>.instance.ShowGameTutorial("stickers", "No connection.", 1520f, TutorialDialog.DODBDLEJOAM.TopLeft, false, true);
				BJGCPDNMHDH.mGrenadeArea = ONCEGKNMJLM.IGEEPAPBDCP.transform.position;
				OPLCMEMJBBO = PlayerController.OGMBJPKOPCB.FOCIOKMPCAG.AMEELJHHGKP[0].transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartSwipeAnimation(OPLCMEMJBBO, BJGCPDNMHDH.mGrenadeArea, 325f, true, 1863f);
				CGNJAHMKLMI = RadicalRoutine.Create(BJGCPDNMHDH.UpdateSwipeGrenadeThrow());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(CGNJAHMKLMI.enumerator));
			...
			case 8u:
				...
				Singleton<TutorialProgressShower>.instance.AJMCILHGLFA(1, false);
				PlayerController.OGMBJPKOPCB.JODNNABEFDH = true;
				PlayerController.OGMBJPKOPCB.BEIIOAIJMFK().HKGLMFFAHFN = false;
		...
		public bool JIIOHNFHPOI()
		{
			...
			case 2u:
				...
				if (PlayerController.OGMBJPKOPCB.FMKGGADDHJK().MFHBEJOLGLC() != PlayerController.OGMBJPKOPCB.weaponInventory.LAGONJMBJMM[3])
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(HHLJPFODNCN, false, true, 1179f);
					PlayerController.OGMBJPKOPCB.JODNNABEFDH = true;
					TimeManager.FreezeGame();
				...
				HHELJCBOLBK = true;
				GuiElementSingle<TutorialDialog>.instance.DDFADDKPPDI("rocketlauncher", string.Empty, 1974f, TutorialDialog.DODBDLEJOAM.BottomRight, false, true);
				EGFCLDDDIEL = GuiElementSingle<InventoryGuiElement>.instance.IGNHPMIDAGM[1].transform.position + 1845f * Vector3.up;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EGFCLDDDIEL, true, true, 1354f);
				PlayerController.OGMBJPKOPCB.JODNNABEFDH = false;
				TimeManager.DCODDANOPCP();
				PlayerController.OGMBJPKOPCB.BEIIOAIJMFK().HKGLMFFAHFN = false;
				goto case 5u;
			...
			case 7u:
				...
				BJGCPDNMHDH.mGrenadeArea = ONCEGKNMJLM.IGEEPAPBDCP.transform.position;
				OPLCMEMJBBO = PlayerController.OGMBJPKOPCB.FOCIOKMPCAG.AMEELJHHGKP[0].transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartSwipeAnimation(OPLCMEMJBBO, BJGCPDNMHDH.mGrenadeArea, 16f, true, 128f);
				CGNJAHMKLMI = RadicalRoutine.Create(BJGCPDNMHDH.UpdateSwipeGrenadeThrow());
				BJGCPDNMHDH.StartCoroutine(RadicalRoutine.Run(CGNJAHMKLMI.enumerator));
	...
	private sealed class MHHGEIJMPPB : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool CIIHKFDLDKN()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				GuiElementSingle<TutorialDialog>.instance.PBEAOCBHFGD(Localization.Localize("elite1"), Localization.Localize("menu-everyplay-ico"), 804f, TutorialDialog.DODBDLEJOAM.Bottom, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, false, false, 1482f);
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.PPMNNKANOEF() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, false, false, 1129f);
			...
			case 8u:
				if (GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().AIHMCHBCJDO() != BJGCPDNMHDH.mTutorialUnit)
				{
					if (GOBCHPOLPIE != null && GOBCHPOLPIE.transform.position != IODGHHFAHJH)
					{
						...
						GuiElementSingle<TutorialOverlayGuiElement>.instance.UpdateTapAnimation(IODGHHFAHJH, false);
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(480f, 902f, 504f), true, true, 1029f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().BNPKCKFMBLG().upgradeSlots.bought)
				{
					...
					instance2.PBEAOCBHFGD(aMKLKMJEMJM2, Localization.LocalizeFormat("OfflineRoom", array2), 1900f, TutorialDialog.DODBDLEJOAM.TopRight, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(234f, 1848f, 50f), true, false, 8f);
				...
				goto case 14u;
			case 12u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("Render player texture ERROR: Weapon load failed! (timeouted - 5 sec)"), Localization.LocalizeFormat("ProgressId", Localization.Localize("BUY: ")), 117f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1697f, 586f, 1509f), false, false, 1491f);
			...
			case 14u:
				...
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(355f, 267f, 561f), true, true, 321f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, false, 795f);
		...
		public bool LMNIKLKKIDN()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, true, false, 301f);
				GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.KHEOKHHDGPO() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, true, true, 665f);
			...
			case 8u:
				if (GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().PPMNNKANOEF() != BJGCPDNMHDH.mTutorialUnit)
				{
					if (GOBCHPOLPIE != null && GOBCHPOLPIE.transform.position != IODGHHFAHJH)
					{
						IODGHHFAHJH = GOBCHPOLPIE.transform.position;
						GuiElementSingle<TutorialOverlayGuiElement>.instance.UpdateTapAnimation(IODGHHFAHJH, false);
						GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(IODGHHFAHJH, CMIKGAOHHPH, false);
					}
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
			...
			case 9u:
			{
				...
				instance.DOLDLDECPIO(aMKLKMJEMJM, Localization.LocalizeFormat("ReSyncDisabledRPC", array), 1813f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(552f, 1681f, 1542f), false, true, 1497f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().KHEOKHHDGPO().upgradeSlots.bought)
				{
					...
					instance3.BLHPAFCOPMD(aMKLKMJEMJM3, Localization.LocalizeFormat("Attempt", array3), 823f, TutorialDialog.DODBDLEJOAM.BottomRight, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1895f, 895f, 782f), true, false, 1993f);
					GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
				goto case 14u;
			case 12u:
			{
				...
				instance2.BLHPAFCOPMD(aMKLKMJEMJM2, Localization.LocalizeFormat("goldShields", array2), 8f, TutorialDialog.DODBDLEJOAM.Right, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(746f, 479f, 1544f), false, true, 776f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 0;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1222f, 79f, 1393f), true, false, 1473f);
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("isVIP"), Localization.Localize("ID_CONFIRM_ERROR"), 1567f, TutorialDialog.DODBDLEJOAM.TopLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, false, 395f);
		...
		public bool EEJLFIHFDLK()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, true, false, 755f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.NPFFMLLLDAF())
				{
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.levelBehaviour == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, false, false, 536f);
							GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(IODGHHFAHJH, CMIKGAOHHPH);
							break;
						}
					}
			...
			case 8u:
				if (GuiScreenSingle<ArmyScreen>.instance.BDBKFBEIHNF().BNPKCKFMBLG() != BJGCPDNMHDH.mTutorialUnit)
				{
					...
					{
						IODGHHFAHJH = GOBCHPOLPIE.transform.position;
						GuiElementSingle<TutorialOverlayGuiElement>.instance.EIDNJNBEPFI(IODGHHFAHJH, false);
						GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(IODGHHFAHJH, CMIKGAOHHPH);
					}
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(403f, 1836f, 462f), false, false, 1152f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().BNPKCKFMBLG().upgradeSlots.bought)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(574f, 821f, 1024f), false, true, 706f);
					GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1404f, 1832f, 763f), true, true, 1301f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 0;
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1529f, 1359f, 381f), false, true, 1364f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
				GuiElementSingle<TutorialClickOverlay>.instance.EOBHJEGACCF();
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, true, 1841f);
		...
		public bool HKPECDLGFJB()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, true, true, 1415f);
				GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.isShowed)
				{
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.PPMNNKANOEF() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, false, false, 44f);
							GuiElementSingle<TutorialClickOverlay>.instance.IGNJKOKGNOI(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
				}
			...
			case 8u:
				if (GuiScreenSingle<ArmyScreen>.instance.GIMBEPIFBLA().AIHMCHBCJDO() != BJGCPDNMHDH.mTutorialUnit)
				{
					...
					{
						IODGHHFAHJH = GOBCHPOLPIE.transform.position;
						GuiElementSingle<TutorialOverlayGuiElement>.instance.OBNDALJCPHG(IODGHHFAHJH, false);
						GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(IODGHHFAHJH, CMIKGAOHHPH, false);
					}
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(900f, 1724f, 835f), true, false, 1811f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.GIMBEPIFBLA().AIHMCHBCJDO().upgradeSlots.bought)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(693f, 457f, 1265f), false, true, 141f);
			...
			case 12u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(113f, 439f, 1218f), false, true, 748f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 3;
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(243f, 1799f, 1919f), true, true, 841f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ);
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_DEPLOYAMOUNT"), Localization.Localize("Need add new bundle"), 434f, TutorialDialog.DODBDLEJOAM.TopLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, false, 1375f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.isShowed)
		...
		public bool PGOBEIMCPGA()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, true, false, 1191f);
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.PPMNNKANOEF() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, true, true, 913f);
							GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 8u:
				if (GuiScreenSingle<ArmyScreen>.instance.GIMBEPIFBLA().levelBehaviour != BJGCPDNMHDH.mTutorialUnit)
				{
					...
					{
						IODGHHFAHJH = GOBCHPOLPIE.transform.position;
						GuiElementSingle<TutorialOverlayGuiElement>.instance.IMOAGBADPCC(IODGHHFAHJH, false);
						GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(IODGHHFAHJH, CMIKGAOHHPH, false);
					}
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
					{
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(777f, 623f, 1014f), false, true, 485f);
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().AIHMCHBCJDO().upgradeSlots.bought)
				{
					...
					instance3.ShowMenuTutorial(aMKLKMJEMJM3, Localization.LocalizeFormat("SquadId = ", array3), 1585f, TutorialDialog.DODBDLEJOAM.TopLeft, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1572f, 1808f, 123f), false, false, 1313f);
					GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				instance2.BLHPAFCOPMD(aMKLKMJEMJM2, Localization.LocalizeFormat("These IDs have the same translations:\n", array2), 879f, TutorialDialog.DODBDLEJOAM.Left, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(91f, 864f, 1555f), true, false, 751f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 0;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1516f, 929f, 56f), false, false, 96f);
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("ID_GOOGLEPLAYLOGOUTTEXT"), Localization.Localize("DailyMissionsData"), 816f, TutorialDialog.DODBDLEJOAM.TopRight, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, false, 1323f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
				{
		...
		public bool JNHFCKKAPJH()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_DELIVEREDTIME"), Localization.Localize("Shotgunner"), 382f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, true, false, 1623f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.NPFFMLLLDAF())
				{
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.KHEOKHHDGPO() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, false, true, 1211f);
							GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
				}
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(1081f, 313f, 661f), false, true, 1041f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				...
				{
					FPHGINDBIDI = false;
					GuiElementSingle<TutorialDialog>.instance.PBEAOCBHFGD(Localization.Localize("recordingStartedEvent + mTryToSetRecording"), Localization.LocalizeFormat("ID_ALLAVAILABLEUNITSMUSTBESELECTED", Localization.Localize("Yes_Clicked")), 1782f, TutorialDialog.DODBDLEJOAM.TopLeft, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1772f, 1682f, 1551f), true, true, 1603f);
					GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(270f, 1782f, 464f), false, false, 1809f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 1;
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(686f, 256f, 1714f), false, true, 312f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, false, 283f);
				GuiElementSingle<TutorialClickOverlay>.instance.MLCGPAJJOMB(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
		...
		public bool IGOKEIDOCKB()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("throw_grenade_up"), Localization.Localize("Army upgrade for "), 1454f, TutorialDialog.DODBDLEJOAM.Top, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, false, true, 807f);
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.levelBehaviour == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, true, false, 869f);
							GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 8u:
				...
				goto IL_052e;
			case 9u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("height"), Localization.LocalizeFormat("ID_TUTORIAL_GO_TO_ARMORY_2_DOWN", Localization.Localize("ID_ISALREADYMEMBEROFANOTHERSQUAD")), 1842f, TutorialDialog.DODBDLEJOAM.TopLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(618f, 824f, 1520f), false, true, 1897f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.BDBKFBEIHNF().levelBehaviour.upgradeSlots.bought)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(738f, 683f, 1552f), true, false, 1629f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
				goto case 14u;
			case 12u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_SUBSCRIPTIODETAILS_HINT3TRAILGOOGLE"), Localization.LocalizeFormat("N", Localization.Localize("setCustomProfileNumber")), 1099f, TutorialDialog.DODBDLEJOAM.Top, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(568f, 1937f, 105f), true, false, 1035f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			case 13u:
				if (!GuiScreenSingle<ArmyScreen>.instance.selectedIcon.BNPKCKFMBLG().upgradeSlots.bought)
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 3;
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(140f, 78f, 865f), false, true, 565f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ);
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, false, 1337f);
		...
		public bool GBLFIBDBMGE()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("8 SQUAD REMINDER\tIs in squad: {0}\tLevel: {1}/{2}"), Localization.Localize("ID_CONFIRM_ERROR"), 1897f, TutorialDialog.DODBDLEJOAM.BottomRight, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, true, false, 1338f);
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.BNPKCKFMBLG() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, false, false, 1055f);
							GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(1098f, 1438f, 1861f), true, false, 1401f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.BDBKFBEIHNF().KHEOKHHDGPO().upgradeSlots.bought)
				{
					...
					instance2.DOLDLDECPIO(aMKLKMJEMJM2, Localization.LocalizeFormat("game-card-ico-shieldgenerator", array2), 1985f, TutorialDialog.DODBDLEJOAM.Bottom, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1342f, 1513f, 548f), false, false, 948f);
					GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
				goto case 14u;
			case 12u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("{0}{1}[-] {2}/[-] 3"), Localization.LocalizeFormat("-", Localization.Localize("SpentWarbucks")), 1902f, TutorialDialog.DODBDLEJOAM.Center, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1369f, 762f, 1928f), false, true, 861f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			case 13u:
				if (!GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().BNPKCKFMBLG().upgradeSlots.bought)
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 8;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1229f, 53f, 1537f), false, true, 1795f);
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, false, 1723f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
		...
		public bool DAKMHLEGICB()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, true, true, 316f);
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.KHEOKHHDGPO() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, false, false, 318f);
							GuiElementSingle<TutorialClickOverlay>.instance.IGNJKOKGNOI(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 9u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(417f, 1792f, 40f), true, false, 915f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto case 10u;
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.GIMBEPIFBLA().BNPKCKFMBLG().upgradeSlots.bought)
				{
					...
					instance.PBEAOCBHFGD(aMKLKMJEMJM, Localization.LocalizeFormat("<", array), 978f, TutorialDialog.DODBDLEJOAM.Top, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(156f, 1697f, 675f), true, false, 617f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
			...
			case 12u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1640f, 1886f, 1795f), true, false, 631f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto IL_088a;
			case 13u:
				if (!GuiScreenSingle<ArmyScreen>.instance.BDBKFBEIHNF().levelBehaviour.upgradeSlots.bought)
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 0;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1318f, 751f, 721f), false, true, 1186f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
				GuiElementSingle<TutorialClickOverlay>.instance.EOBHJEGACCF();
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, true, 622f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.isShowed)
		...
		public bool JIIOHNFHPOI()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, false, true, 1694f);
				GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.isShowed)
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.KHEOKHHDGPO() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, true, false, 895f);
							GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(1635f, 1741f, 866f), true, false, 712f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().BNPKCKFMBLG().upgradeSlots.bought)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(897f, 1119f, 1295f), false, false, 871f);
					GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
			...
			case 12u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1210f, 1061f, 1739f), true, false, 1412f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto IL_088a;
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 7;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(525f, 138f, 624f), true, false, 506f);
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("fr"), Localization.Localize("ID_ARENARULES_LESSCRATES"), 670f, TutorialDialog.DODBDLEJOAM.TopRight, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, false, 114f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
				{
		...
		public bool PMJICFJGOBE()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, false, false, 1018f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.NPFFMLLLDAF())
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.BNPKCKFMBLG() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, false, false, 1966f);
							GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 9u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(753f, 1588f, 1988f), true, false, 156f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			case 10u:
				if (GuiScreenSingle<ArmyScreen>.instance.GIMBEPIFBLA().PPMNNKANOEF().upgradeSlots.unitState == UpgradeSlots.JLANLLEABDC.NotBuyed)
			...
			case 11u:
				...
				{
					FPHGINDBIDI = false;
					GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("GameGold"), Localization.LocalizeFormat("《WarFriends》需要權限存取你的媒體存儲才能下載關鍵的遊戲資料。缺少此權限，遊戲就無法運作並會關閉。請重試或退出《WarFriends》。", Localization.Localize("ID_CONFIRM_OFFERTOOSHORTNAME")), 23f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1104f, 741f, 1195f), true, false, 1230f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(380f, 1996f, 1675f), true, true, 1639f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 7;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(152f, 233f, 1704f), true, true, 405f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ);
				GuiElementSingle<TutorialClickOverlay>.instance.JMPLMMANKMP();
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("#AccoutCheck# account exist"), Localization.Localize("ID_LEAGUETOPPOSITIONHINT"), 1577f, TutorialDialog.DODBDLEJOAM.BottomRight, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, false, 59f);
				GuiElementSingle<TutorialClickOverlay>.instance.MLCGPAJJOMB(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.isShowed)
		...
		public bool PJJPPMIBNLN()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, true, true, 1641f);
				GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].EPHBGCBAPAN.size);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.NPFFMLLLDAF())
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.levelBehaviour == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, false, true, 666f);
							GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(IODGHHFAHJH, CMIKGAOHHPH);
							break;
						}
					}
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(448f, 1443f, 1778f), false, true, 1957f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.selectedIcon.AIHMCHBCJDO().upgradeSlots.bought)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(199f, 1524f, 714f), false, false, 671f);
					GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				instance2.DOLDLDECPIO(aMKLKMJEMJM2, Localization.LocalizeFormat("Locale", array2), 558f, TutorialDialog.DODBDLEJOAM.TopRight, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(236f, 563f, 988f), false, false, 1051f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 7;
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1215f, 1487f, 575f), true, true, 46f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
				GuiElementSingle<TutorialClickOverlay>.instance.StartBorderAnimation();
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("Xp"), Localization.Localize("game-card-ico-bg-silver"), 1320f, TutorialDialog.DODBDLEJOAM.Top, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, false, 30f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
		...
		public bool HOJKAHEGFEB()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("D2"), Localization.Localize(", action = "), 1356f, TutorialDialog.DODBDLEJOAM.TopLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, false, true, 1901f);
				GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.NPFFMLLLDAF())
				{
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.levelBehaviour == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, false, false, 1195f);
							GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(489f, 1244f, 1537f), true, true, 571f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().levelBehaviour.upgradeSlots.bought)
				{
					...
					instance3.ShowMenuTutorial(aMKLKMJEMJM3, Localization.LocalizeFormat("TENTAR NOVAMENTE", array3), 1173f, TutorialDialog.DODBDLEJOAM.Left, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(992f, 210f, 1017f), false, false, 47f);
					GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				instance2.BLHPAFCOPMD(aMKLKMJEMJM2, Localization.LocalizeFormat("(Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;)V", array2), 1469f, TutorialDialog.DODBDLEJOAM.Left, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1393f, 1105f, 1423f), true, true, 530f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 3;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(807f, 1808f, 1928f), false, false, 817f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ);
				GuiElementSingle<TutorialClickOverlay>.instance.JMPLMMANKMP();
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("Message Id = "), Localization.Localize("NO"), 1317f, TutorialDialog.DODBDLEJOAM.Bottom, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, false, 1758f);
				GuiElementSingle<TutorialClickOverlay>.instance.MLCGPAJJOMB(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.isShowed)
				{
		...
		public bool FBMLBIOKKBE()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_SQUADEVENT"), Localization.Localize("ID_TUTORIAL_PLAY_CARD_DOWN"), 833f, TutorialDialog.DODBDLEJOAM.Top, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, false, true, 445f);
				GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.NPFFMLLLDAF())
				{
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.BNPKCKFMBLG() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, false, false, 1787f);
							GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 8u:
				...
				goto IL_052e;
			case 9u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("Bad player regiones, data= "), Localization.LocalizeFormat("com/google/android/gms/games/Games", Localization.Localize("1")), 1878f, TutorialDialog.DODBDLEJOAM.Right, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(1620f, 853f, 1630f), false, true, 556f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.GIMBEPIFBLA().PPMNNKANOEF().upgradeSlots.bought)
				{
					...
					instance2.ShowMenuTutorial(aMKLKMJEMJM2, Localization.LocalizeFormat("LootboxType", array2), 943f, TutorialDialog.DODBDLEJOAM.BottomRight, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1296f, 1733f, 455f), true, true, 1806f);
					GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				instance.PBEAOCBHFGD(aMKLKMJEMJM, Localization.LocalizeFormat("BattleId", array), 914f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(398f, 540f, 1668f), false, false, 854f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 1;
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1591f, 538f, 1501f), false, false, 1365f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
				GuiElementSingle<TutorialClickOverlay>.instance.EOBHJEGACCF();
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, true, 1883f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
				{
		...
		public bool BOENAMNMOAC()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, true, false, 1111f);
				GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.NPFFMLLLDAF())
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.PPMNNKANOEF() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, true, true, 2f);
							GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(1303f, 352f, 525f), true, false, 1658f);
			...
			case 11u:
				...
				{
					FPHGINDBIDI = true;
					GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("LevelName"), Localization.LocalizeFormat("localSquadLeaderboard", Localization.Localize("Awaiting players - Player id:\"{0}\" is not in list of awaiting members")), 742f, TutorialDialog.DODBDLEJOAM.Left, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(450f, 1030f, 1085f), true, true, 1007f);
					GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(755f, 1334f, 41f), true, true, 1626f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 6;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(815f, 351f, 96f), false, true, 1037f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ);
				GuiElementSingle<TutorialClickOverlay>.instance.KKCKBELEPHJ();
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, true, 664f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.isShowed)
		...
		public bool MoveNext()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_GO_BUY_ARMY_2"), Localization.Localize("ID_TUTORIAL_GO_BUY_ARMY_2_DOWN"), -0.2f, TutorialDialog.DODBDLEJOAM.Right, false);
			...
			case 8u:
				...
				goto IL_052e;
			case 9u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_GO_BUY_ARMY_4"), Localization.LocalizeFormat("ID_TUTORIAL_TAPON", Localization.Localize("ID_BUY")), 0.6f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
			...
			case 11u:
				...
				{
					FPHGINDBIDI = false;
					GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_DELIVER"), Localization.LocalizeFormat("ID_TUTORIAL_TAPON", Localization.Localize("ID_DELIVERNOW")), 0.6f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				...
				goto case 14u;
			case 12u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_DELIVERED_UNIT"), Localization.LocalizeFormat("ID_TUTORIAL_TAPON", Localization.Localize("ID_ACTIVATION")), 0.6f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_GO_BUY_ARMY_6"), Localization.Localize("ID_TUTORIAL_GO_BUY_ARMY_6_DOWN"), 0.1f, TutorialDialog.DODBDLEJOAM.Right, false);
		...
		public bool MOFPMNMAOND()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, true, true, 920f);
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.KHEOKHHDGPO() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, true, true, 1357f);
							GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 9u:
			{
				...
				instance.DOLDLDECPIO(aMKLKMJEMJM, Localization.LocalizeFormat("S", array), 791f, TutorialDialog.DODBDLEJOAM.Center, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(37f, 1839f, 494f), false, true, 151f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.BDBKFBEIHNF().BNPKCKFMBLG().upgradeSlots.bought)
				{
					...
					instance3.PBEAOCBHFGD(aMKLKMJEMJM3, Localization.LocalizeFormat(")", array3), 45f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(662f, 881f, 264f), true, true, 594f);
					GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(290f, 625f, 1082f), false, true, 441f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 4;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1133f, 1945f, 692f), false, true, 789f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
				GuiElementSingle<TutorialClickOverlay>.instance.JMPLMMANKMP();
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, false, 683f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.isShowed)
		...
		public bool NEPEDBPDMGL()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("STAG"), Localization.Localize("ID_ATTACK"), 371f, TutorialDialog.DODBDLEJOAM.Bottom, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, false, true, 6f);
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.PPMNNKANOEF() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, true, true, 1574f);
							GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(IODGHHFAHJH, CMIKGAOHHPH);
							break;
						}
					}
			...
			case 9u:
			{
				...
				instance.BLHPAFCOPMD(aMKLKMJEMJM, Localization.LocalizeFormat("ID_GUI_FOLLOWTWITTER_DESC", array), 1691f, TutorialDialog.DODBDLEJOAM.BottomRight, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(1910f, 1610f, 461f), true, false, 1638f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.GIMBEPIFBLA().levelBehaviour.upgradeSlots.bought)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1854f, 1128f, 40f), true, true, 392f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
			...
			case 12u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1573f, 1960f, 925f), true, false, 94f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto IL_088a;
			case 13u:
				if (!GuiScreenSingle<ArmyScreen>.instance.GIMBEPIFBLA().levelBehaviour.upgradeSlots.bought)
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 2;
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1608f, 317f, 746f), true, true, 118f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
				GuiElementSingle<TutorialClickOverlay>.instance.EDPNLNIPCGJ();
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("是"), Localization.Localize("PlayerUnits"), 725f, TutorialDialog.DODBDLEJOAM.TopRight, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, false, 1385f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
		...
		public bool ACHIHMMCDNF()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, true, false, 1514f);
				GuiElementSingle<TutorialClickOverlay>.instance.IGNJKOKGNOI(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.NPFFMLLLDAF())
				{
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.BNPKCKFMBLG() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, true, true, 1254f);
							GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(1643f, 552f, 54f), false, true, 1990f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.GIMBEPIFBLA().AIHMCHBCJDO().upgradeSlots.bought)
				{
					...
					instance3.BLHPAFCOPMD(aMKLKMJEMJM3, Localization.LocalizeFormat("error in count of army", array3), 1346f, TutorialDialog.DODBDLEJOAM.Right, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1648f, 839f, 254f), true, true, 1082f);
					GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1264f, 161f, 292f), true, true, 495f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 0;
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1680f, 1916f, 1331f), false, true, 426f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
				GuiElementSingle<TutorialClickOverlay>.instance.StartBorderAnimation();
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_CARD_DESC_BUDDY"), Localization.Localize("#PETER# removing warcards from slots"), 821f, TutorialDialog.DODBDLEJOAM.Right, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, false, 559f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
				{
		...
		public bool BPHPJKKHNNG()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, true, false, 248f);
				GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.isShowed)
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.PPMNNKANOEF() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, true, false, 873f);
							GuiElementSingle<TutorialClickOverlay>.instance.IGNJKOKGNOI(IODGHHFAHJH, CMIKGAOHHPH);
							break;
						}
					}
			...
			case 8u:
				...
				goto IL_052e;
			case 9u:
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("Source texture is null"), Localization.LocalizeFormat("Xp", Localization.Localize("SERVICE_DISABLED")), 1398f, TutorialDialog.DODBDLEJOAM.Center, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(321f, 142f, 1075f), true, true, 1951f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().levelBehaviour.upgradeSlots.bought)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1429f, 327f, 1389f), true, false, 1321f);
					GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1654f, 1115f, 521f), false, false, 915f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 4;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1005f, 1135f, 207f), false, false, 893f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ);
				GuiElementSingle<TutorialClickOverlay>.instance.EMEBKHJECFA();
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("game-revenge-indicator"), Localization.Localize("ID_TUTORIAL_OBJECTIVE"), 243f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, false, 1098f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.isShowed)
		...
		public bool FJKEEKBNKPN()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, false, true, 698f);
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.KHEOKHHDGPO() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, false, false, 1795f);
							GuiElementSingle<TutorialClickOverlay>.instance.IGNJKOKGNOI(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 8u:
				if (GuiScreenSingle<ArmyScreen>.instance.selectedIcon.AIHMCHBCJDO() != BJGCPDNMHDH.mTutorialUnit)
				{
					...
					{
						IODGHHFAHJH = GOBCHPOLPIE.transform.position;
						GuiElementSingle<TutorialOverlayGuiElement>.instance.OOIJFHGCCNH(IODGHHFAHJH, false);
						GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(IODGHHFAHJH, CMIKGAOHHPH);
					}
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
			...
			case 9u:
			{
				...
				instance.BLHPAFCOPMD(aMKLKMJEMJM, Localization.LocalizeFormat("ACD: Memory was tampered, cheater detected!", array), 517f, TutorialDialog.DODBDLEJOAM.Right, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(1821f, 1243f, 478f), true, true, 1030f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.BDBKFBEIHNF().levelBehaviour.upgradeSlots.bought)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1686f, 1605f, 603f), false, true, 507f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				instance2.DOLDLDECPIO(aMKLKMJEMJM2, Localization.LocalizeFormat(" has no SkillShotController", array2), 1751f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1675f, 846f, 1722f), true, true, 400f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 0;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1007f, 1701f, 634f), false, true, 1312f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ);
				GuiElementSingle<TutorialClickOverlay>.instance.KKCKBELEPHJ();
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, true, 863f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.isShowed)
		...
		public bool LAICPPPPIKL()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, false, false, 461f);
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.AIHMCHBCJDO() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, true, true, 1199f);
							GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(IODGHHFAHJH, CMIKGAOHHPH);
							break;
						}
					}
			...
			case 9u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(684f, 1634f, 1831f), true, true, 890f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			case 10u:
				if (GuiScreenSingle<ArmyScreen>.instance.GIMBEPIFBLA().PPMNNKANOEF().upgradeSlots.unitState == UpgradeSlots.JLANLLEABDC.Locked)
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.selectedIcon.levelBehaviour.upgradeSlots.bought)
				{
					...
					object[] array2 = new object[0];
					array2[1] = Localization.Localize(",");
					instance2.BLHPAFCOPMD(aMKLKMJEMJM2, Localization.LocalizeFormat("LevelName", array2), 675f, TutorialDialog.DODBDLEJOAM.Right, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(92f, 1632f, 1117f), false, true, 1323f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(827f, 1445f, 849f), true, true, 147f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 2;
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(151f, 985f, 1181f), true, true, 1683f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
				GuiElementSingle<TutorialClickOverlay>.instance.EOBHJEGACCF();
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, true, 465f);
		...
		public bool HMLAEHJKPJE()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("ID_CATEGORY_LOW_PL_SMG"), Localization.Localize("Setting unit delivery"), 1909f, TutorialDialog.DODBDLEJOAM.Center, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, true, false, 1534f);
				GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].EPHBGCBAPAN.size);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.isShowed)
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.levelBehaviour == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, false, true, 1734f);
							GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 8u:
				if (GuiScreenSingle<ArmyScreen>.instance.selectedIcon.BNPKCKFMBLG() != BJGCPDNMHDH.mTutorialUnit)
				{
					...
					{
						IODGHHFAHJH = GOBCHPOLPIE.transform.position;
						GuiElementSingle<TutorialOverlayGuiElement>.instance.NFPJIFHLFNB(IODGHHFAHJH, false);
						GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(IODGHHFAHJH, CMIKGAOHHPH);
					}
					PHDOCKCBJOF = null;
					if (!FDKOKMKIIMG)
			...
			case 9u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(654f, 1483f, 611f), false, true, 354f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.BDBKFBEIHNF().PPMNNKANOEF().upgradeSlots.bought)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1403f, 629f, 1231f), false, false, 1189f);
					GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1225f, 402f, 1100f), false, false, 1255f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 8;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1552f, 817f, 68f), true, false, 1458f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
				GuiElementSingle<TutorialClickOverlay>.instance.JMPLMMANKMP();
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("leagueMembers"), Localization.Localize("MX"), 1058f, TutorialDialog.DODBDLEJOAM.TopRight, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, true, 1591f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
		...
		public bool KCEAGNMILMA()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				GuiElementSingle<TutorialDialog>.instance.PBEAOCBHFGD(Localization.Localize("DamageEventPlayerShoot damage: {0} to {1} new HP {2}"), Localization.Localize("damage"), 1858f, TutorialDialog.DODBDLEJOAM.Center, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, false, true, 481f);
				GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.NPFFMLLLDAF())
				{
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.PPMNNKANOEF() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, false, false, 940f);
							GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(1552f, 116f, 771f), false, false, 1104f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().BNPKCKFMBLG().upgradeSlots.bought)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1433f, 1448f, 1241f), true, false, 218f);
					GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(189f, 1522f, 1380f), true, false, 1558f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 3;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1120f, 1263f, 764f), true, true, 986f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ);
				GuiElementSingle<TutorialClickOverlay>.instance.EDPNLNIPCGJ();
				PHDOCKCBJOF = new WaitForSeconds(850f);
				if (!FDKOKMKIIMG)
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.PBEAOCBHFGD(Localization.Localize("getExtrasPayload"), Localization.Localize("About to show unit categories reminder"), 1404f, TutorialDialog.DODBDLEJOAM.Center, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, true, 674f);
				GuiElementSingle<TutorialClickOverlay>.instance.MEBFBNDKOGD(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
		...
		public bool PMLLPHFACBM()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("ReSyncRPC"), Localization.Localize("Wood"), 1356f, TutorialDialog.DODBDLEJOAM.Right, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, false, false, 1507f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].EPHBGCBAPAN.size);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.NPFFMLLLDAF())
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.AIHMCHBCJDO() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, false, false, 1131f);
							GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 9u:
			{
				...
				instance.PBEAOCBHFGD(aMKLKMJEMJM, Localization.LocalizeFormat("NOT IN LEAGUE", array), 183f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(1357f, 1528f, 1806f), true, false, 317f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().BNPKCKFMBLG().upgradeSlots.bought)
				{
					...
					instance3.BLHPAFCOPMD(aMKLKMJEMJM3, Localization.LocalizeFormat("Game Rewards lootboxes contents:\n", array3), 449f, TutorialDialog.DODBDLEJOAM.Center, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(741f, 161f, 1562f), true, false, 1343f);
					GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				instance2.PBEAOCBHFGD(aMKLKMJEMJM2, Localization.LocalizeFormat("Google2u.AssaultRifle_AK47", array2), 1823f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1331f, 988f, 1246f), true, false, 171f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 7;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1127f, 1433f, 1337f), true, true, 0f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ);
				GuiElementSingle<TutorialClickOverlay>.instance.JMPLMMANKMP();
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, true, 1537f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
		...
		public bool MHNPBDBGBLK()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].NALOPNJHPLI.transform.position, true, true, 1350f);
				GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].EPHBGCBAPAN.size);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.isShowed)
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.AIHMCHBCJDO() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, true, true, 1475f);
							GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(773f, 1586f, 1836f), false, false, 1909f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				...
				{
					FPHGINDBIDI = true;
					GuiElementSingle<TutorialDialog>.instance.PBEAOCBHFGD(Localization.Localize("Medals requirement = "), Localization.LocalizeFormat("SetBeepRPC", Localization.Localize("ID_GUI_SQUADCHALLENGEENDED")), 331f, TutorialDialog.DODBDLEJOAM.TopLeft, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1764f, 381f, 1764f), true, true, 1779f);
					GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
				goto case 14u;
			case 12u:
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("DemotedPlayer"), Localization.LocalizeFormat("워프렌즈를 실행하려면 약 190MB의 추가 데이터를 다운로드 받아야 합니다.\n다운로드 시간은 네트워크 및 지역에 따라 달라질 수 있습니다.\n\n계속 진행하시겠습니까?", Localization.Localize("nR8WfJlIwkkqu9mTB81EUGaldBpyX3eE4ErTYxs41gs6uXM51v")), 329f, TutorialDialog.DODBDLEJOAM.Top, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(132f, 700f, 1465f), true, false, 672f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto IL_088a;
			case 13u:
				if (!GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().KHEOKHHDGPO().upgradeSlots.bought)
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 0;
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1892f, 1215f, 792f), false, true, 458f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
				GuiElementSingle<TutorialClickOverlay>.instance.EOBHJEGACCF();
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_CHALLENGEYOURFRIEND"), Localization.Localize("ID_READYTIME"), 482f, TutorialDialog.DODBDLEJOAM.TopRight, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, true, 186f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
		...
		public bool BGOEENAEBNO()
		{
			...
			case 2u:
				...
				break;
			case 3u:
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("menu-attack-ico"), Localization.Localize("ID_INELITE1"), 82f, TutorialDialog.DODBDLEJOAM.Right, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, true, false, 993f);
				GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.isShowed)
				{
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.AIHMCHBCJDO() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, true, false, 1347f);
							GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(IODGHHFAHJH, CMIKGAOHHPH);
							break;
						}
					}
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(499f, 1480f, 809f), true, false, 1372f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.MJKLLFPEKAJ().KHEOKHHDGPO().upgradeSlots.bought)
				{
					...
					instance3.ShowMenuTutorial(aMKLKMJEMJM3, Localization.LocalizeFormat(", current = ", array3), 749f, TutorialDialog.DODBDLEJOAM.Bottom, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1353f, 1760f, 1852f), true, false, 1288f);
					GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				object[] array2 = new object[1];
				array2[1] = Localization.Localize("\n</font>");
				instance2.PBEAOCBHFGD(aMKLKMJEMJM2, Localization.LocalizeFormat("N", array2), 1960f, TutorialDialog.DODBDLEJOAM.Center, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1994f, 320f, 1525f), true, false, 1450f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 1;
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1723f, 117f, 747f), true, true, 1460f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ);
				GuiElementSingle<TutorialClickOverlay>.instance.StartBorderAnimation();
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("Time"), Localization.Localize("Days_Since_Install"), 1342f, TutorialDialog.DODBDLEJOAM.Top, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, true, 1760f);
				GuiElementSingle<TutorialClickOverlay>.instance.FCGLGPIBAEN(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.isShowed)
				{
		...
		public bool HOOHJGPHHGN()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, false, true, 509f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetAndShow(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.NPFFMLLLDAF())
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.PPMNNKANOEF() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, false, false, 1662f);
							GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(IODGHHFAHJH, CMIKGAOHHPH);
							break;
						}
					}
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(1785f, 489f, 1318f), false, false, 1309f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.selectedIcon.KHEOKHHDGPO().upgradeSlots.bought)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(514f, 700f, 1866f), true, false, 1834f);
					GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
					JGPPKCAGAGC = true;
					goto case 13u;
				}
				goto case 14u;
			case 12u:
				GuiElementSingle<TutorialDialog>.instance.PBEAOCBHFGD(Localization.Localize("NAME"), Localization.LocalizeFormat("NO DISCOUNT FOUND!!! ", Localization.Localize("Waiting too long for all playersFinish to loading")), 383f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1444f, 134f, 136f), true, false, 444f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			case 13u:
				if (!GuiScreenSingle<ArmyScreen>.instance.BDBKFBEIHNF().PPMNNKANOEF().upgradeSlots.bought)
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 6;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(532f, 1807f, 592f), false, true, 398f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ);
			...
			case 17u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, true, 1108f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.isShowed)
		...
		public bool CCOPPEKLJOB()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, false, false, 1140f);
				GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[1].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.NPFFMLLLDAF())
				{
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.levelBehaviour == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, true, false, 1720f);
							GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 9u:
			{
				...
				instance.ShowMenuTutorial(aMKLKMJEMJM, Localization.LocalizeFormat("ID_ENDSINTIME", array), 523f, TutorialDialog.DODBDLEJOAM.TopRight, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(982f, 1570f, 638f), true, true, 645f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				if (!GuiScreenSingle<ArmyScreen>.instance.selectedIcon.AIHMCHBCJDO().upgradeSlots.bought)
				{
					...
					GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1598f, 564f, 581f), false, false, 1038f);
					GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
			...
			case 12u:
			{
				...
				instance2.BLHPAFCOPMD(aMKLKMJEMJM2, Localization.LocalizeFormat("-", array2), 15f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1142f, 858f, 1851f), true, false, 1019f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			}
			case 13u:
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 8;
				Singleton<GuiManager>.instance.TurnOffInputCompletly();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(77f, 290f, 589f), false, false, 189f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ);
				GuiElementSingle<TutorialClickOverlay>.instance.EDPNLNIPCGJ();
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("WeaponTutorial"), Localization.Localize("ID_NOTENOUGHWARBUCKS"), 292f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, true, true, 1453f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.isShowed)
		...
		public bool MKLIDMNLNPN()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].NALOPNJHPLI.transform.position, false, false, 1319f);
				GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].PAKNGGNNNDO.transform.position, GuiElementSingle<LevelUpDialog>.instance.PPFFOOLKNPI[0].EPHBGCBAPAN.size, false);
				goto case 4u;
			case 4u:
				if (GuiElementSingle<LevelUpDialog>.instance.isShowed)
				...
				if (OIBJCLOPOLG != null)
				{
					foreach (ArmyUpgradeIcon item in OIBJCLOPOLG)
					{
						if (item.KHEOKHHDGPO() == BJGCPDNMHDH.mTutorialUnit)
						{
							...
							IODGHHFAHJH = item.transform.position;
							CMIKGAOHHPH = item.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, true, false, 604f);
							GuiElementSingle<TutorialClickOverlay>.instance.EEMMKEMADFC(IODGHHFAHJH, CMIKGAOHHPH);
							break;
						}
					}
			...
			case 9u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.BGPBNIJPOKM.cachedTransform.position, new Vector3(1512f, 157f, 1961f), true, false, 21f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto case 10u;
			}
			case 10u:
			...
			case 11u:
				...
				{
					FPHGINDBIDI = false;
					GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("Weapons/"), Localization.LocalizeFormat("country-austria", Localization.Localize("Sniper_Tutorial_Played")), 581f, TutorialDialog.DODBDLEJOAM.BottomRight, false);
					GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.LNFLDPLGEJE.transform.position, new Vector3(1062f, 1806f, 1885f), true, true, 231f);
					GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL);
					JGPPKCAGAGC = false;
					goto case 13u;
				}
				goto case 14u;
			case 12u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_WATCHVIDEO"), Localization.LocalizeFormat("batchSizeMin", Localization.Localize("ID_ASSIGNMENTSSHORT")), 896f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.JPJLKKJJFDB.transform.position, new Vector3(1974f, 76f, 979f), true, false, 55f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KEFLEFIPLNJ.EPFODCCNGDL, false);
				goto IL_088a;
			case 13u:
				if (!GuiScreenSingle<ArmyScreen>.instance.GIMBEPIFBLA().KHEOKHHDGPO().upgradeSlots.bought)
			...
			case 14u:
				BJGCPDNMHDH.mUnitBoughtState = 8;
				Singleton<GuiManager>.instance.CMCCOCBIGBB();
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ.transform.position, new Vector3(1005f, 468f, 814f), false, true, 1250f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<ArmyScreen>.instance.FNOFLJEOHGJ, false);
				GuiElementSingle<TutorialClickOverlay>.instance.EMEBKHJECFA();
			...
			case 17u:
				...
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("VALUE PACK for $"), Localization.Localize("Total_Sessions"), 1841f, TutorialDialog.DODBDLEJOAM.Right, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.OMDKNOFNFBB.transform.position, false, false, 1375f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<BattlePreparationScreen>.instance.AIMNGAOAPPE.ECJHCGPGGDC, false);
				goto case 18u;
			case 18u:
				if (GuiScreenSingle<BattlePreparationScreen>.instance.NPFFMLLLDAF())
	...
	private void OnGameEnded(GameController.HKGHCIEPGEL obj)
	{
		if (base.isTutorialRunning)
		{
			...
			if (Singleton<GameController>.instance.MNMLNIMFMJP != GameController.HKGHCIEPGEL.Forfeit)
			{
				...
				LevelManager.instance.SetLevelUpProgressForTutorial(3, 0f, true);
	...
	public override void StartTutorial(bool isContinue)
	{
		...
		SetPlayerDefaultWeapons(true, true);
		PlayerController.OGMBJPKOPCB.weaponInventory.HKGLMFFAHFN = false;
		PlayerController.OGMBJPKOPCB.weaponInventory.LAGONJMBJMM[2].weapon.ammoLeft = 5;
	...
	{
		LevelManager.instance.SetLevelUpProgressForTutorial(2, 0f, false);
