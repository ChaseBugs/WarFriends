...
public class CardBelovedEnemy : Card
{
	...
	public override string description
	{
		get
		{
			return Localization.LocalizeFormat(mDescriptionID, MEJMLNDFDBP.JJBMMICPIIG(DFNMBEDLOCH), MEJMLNDFDBP.AIPKMDCJCOG(buffTime));
		}
	}
	...
	protected void Update()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 0f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-belovedenemy", false);
		}
	}
	...
	public virtual void EMGGMHONMCM(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("ID_REMINDER_GETPOWERBANDTOINCREASE", true, true);
	...
	{
		MBIAKMPDOPG = PlayerController.GetEnemyOf(CIOPAKLHFIL);
		MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-belovedenemy", true);
		CNOIHHLJLJO = MBIAKMPDOPG.speed;
