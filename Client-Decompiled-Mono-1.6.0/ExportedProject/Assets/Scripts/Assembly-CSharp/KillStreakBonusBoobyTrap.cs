...
public class KillStreakBonusBoobyTrap : KillStreakBonus
{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.Show("game-card-ico-boobytrap", 3f, 3f, false);
	...
	{
		KHLGDCHJJPB.cardIconIndicator.EEBNPGOCKFD("Chillingo: On Offers Released", 581f, 1898f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.FCANLIOLJNH("Null cannot be saved as last weapon.", 1001f, 1950f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.FCANLIOLJNH("UtcOffset", 895f, 955f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.FCANLIOLJNH("Dialog Manager: PN dialog does not need to be shown BUT NEEDS TO BE SENT, current players device token = ", 1298f, 1324f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.BELBLFGCCLJ("N", 861f, 581f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.JBMCFEMBPKE("Lcom/google/android/gms/games/multiplayer/turnbased/TurnBasedMultiplayer;", 1594f, 1593f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.JEDGCOMDEKM("ID_WINSTREAK", 54f, 1674f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.JBMCFEMBPKE("TryRecconnect TryRecconnectToPhotonCoroutine going to reconnect", 1392f, 1222f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.FFMLINMFADM("Setting weapon delivery", 1810f, 134f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.FFMLINMFADM("Clicked on subscription button", 1350f, 76f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.BELBLFGCCLJ("menu-armypower-ico", 1773f, 719f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.AMFEDOOPGCL("BeAdvisedPurchaseVIP", 1259f, 1033f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.BELBLFGCCLJ("N", 1507f, 715f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.BELBLFGCCLJ("Physical ammo is null !!!", 327f, 355f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.BELBLFGCCLJ("113 STAGE 4 SPAWN 1 DONE", 418f, 82f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.ODDNDGAAOCH("D5", 89f, 1382f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.JOGFDHFOOBC("AssignmentData", 1183f, 896f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.FCANLIOLJNH("ID_RANKEDBATTLE", 1550f, 1430f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.AMFEDOOPGCL("RewardedAdCompleted(", 1403f, 229f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.FFMLINMFADM("{0}{1}{2}", 1140f, 639f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.LOFMDBHAFAO("visuals: {0} {1} {2} {3}", 475f, 1214f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.LOFMDBHAFAO("ID_UNIT2UPGRADEABILITY_UNIT1UPGRADE", 228f, 402f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.LOFMDBHAFAO("ID_ARENASTARTSENTERTIMER", 1925f, 827f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.JOGFDHFOOBC("ID_VIDEOSERVICE", 1684f, 1697f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.BELBLFGCCLJ("'lapsedNot'0", 260f, 1511f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.FFMLINMFADM("com/google/android/gms/games/Games", 1678f, 1693f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.EEBNPGOCKFD(", response: ", 1416f, 1881f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.BELBLFGCCLJ("0", 501f, 621f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.FCANLIOLJNH("ID_CONFIRM_ERROR", 506f, 1120f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.Show("ID_ENDED", 878f, 682f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.FFMLINMFADM("ID_ARENABOXDESCRIPTIONFLAWLESS", 521f, 1368f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.JBMCFEMBPKE("lootboxesOfferAdd", 1859f, 1966f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.FCANLIOLJNH("ID_WAITINGTIME", 627f, 1927f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.LOFMDBHAFAO(" time: ", 1293f, 482f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.ODDNDGAAOCH("PA: transactions NULL", 1804f, 1077f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.AMFEDOOPGCL("ID_DAY_SMALL", 1750f, 472f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.EEBNPGOCKFD("Action ", 387f, 1494f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.AMFEDOOPGCL("Grenade_Throwing_Tutorial_Duration", 1104f, 1789f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
			EPDELOGPNAC = Singleton<GameVariables>.instance.cardConstants.GetRow((CardConstants.rowIds)(-75)).FLOATVALUE * KHLGDCHJJPB.FOCIOKMPCAG.maxHealth,
			KLOJNPBGFIG = false,
	...
	{
		KHLGDCHJJPB.cardIconIndicator.FFMLINMFADM("VisualTimestamp", 167f, 1489f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.JEDGCOMDEKM("ID_PLAYERLEAGUEPROCESSINGHINT", 1600f, 61f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.AMFEDOOPGCL("setResultCallback", 125f, 150f, false);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
	...
	{
		KHLGDCHJJPB.cardIconIndicator.LOFMDBHAFAO("RewardMessage", 1921f, 1850f, true);
		DestroyableObject.CJLNCMMNPBM kMJKKNFDFMM = new DestroyableObject.CJLNCMMNPBM
		{
