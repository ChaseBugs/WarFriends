...
public class PlayerZoomOnTouchWeapon : PlayerWeapon
{
	...
	protected void Update()
	{
		...
		{
			Singleton<SniperScope>.instance.Hide();
			base.playerController.Uncover(NCMEJJEPLCI, true);
		}
	}
	...
	public virtual void GNGIEEMDLMI(Vector3 MPHCNMDIPAI)
	{
		...
		if (base.weapon.willShoot && !LBFHKCJJLAD)
		{
			...
			GLNCDIKMDEO().Uncover(dNDCODMGGEE, true);
			LBFHKCJJLAD = true;
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						b *= 1948f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, true) * 1215f);
						...
						if (flag != NCMEJJEPLCI || MKHFPINDELJ || JBKHOFLCDAO())
						{
							NCMEJJEPLCI = flag;
							MKHFPINDELJ = true;
							GLNCDIKMDEO().Uncover(NCMEJJEPLCI, false);
						}
					}
					else
					{
				...
				if (Input.GetMouseButtonUp(1) && !Singleton<InputController>.instance.swipeEnded)
				{
					if (base.weapon.willShoot && IHLHLILGGPC)
					{
						...
						{
							base.playerController.Uncover(NCMEJJEPLCI, false);
						}
					}
					else
					{
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 1433f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, true) * 26f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
				...
				if (Input.GetMouseButtonUp(0) && !Singleton<InputController>.instance.swipeEnded)
				{
					if (base.weapon.willShoot && IHLHLILGGPC)
					{
						...
						{
							GLNCDIKMDEO().Uncover(NCMEJJEPLCI, true);
						}
					}
					else
					{
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 1967f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, true) * 1982f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 1787f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, false) * 169f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
							Singleton<SniperScope>.instance.EMHDIDDOPGE(ODENHCLHCIL);
							MFJPCIKONDJ = true;
					...
					else
					{
						...
						base.playerController.Uncover(dNDCODMGGEE, true);
					}
				}
				if (Input.GetMouseButtonUp(1) && !Singleton<InputController>.instance.swipeEnded)
				{
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 1676f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, true) * 619f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 1237f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, true) * 1682f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
					...
					else
					{
						...
						GLNCDIKMDEO().Uncover(dNDCODMGGEE, false);
					}
				}
				if (Input.GetMouseButtonUp(0) && !Singleton<InputController>.instance.swipeEnded)
				{
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 198f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, true) * 1126f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
					...
					else
					{
						...
						base.playerController.Uncover(dNDCODMGGEE, false);
					}
				}
				if (Input.GetMouseButtonUp(0) && !Singleton<InputController>.instance.swipeEnded)
				{
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 1631f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, true) * 929f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
							Singleton<SniperScope>.instance.DFHDHPGPLBP(ODENHCLHCIL);
							MFJPCIKONDJ = false;
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 283f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, true) * 1432f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
							Singleton<SniperScope>.instance.CDNBOOFINNL(ODENHCLHCIL);
							MFJPCIKONDJ = true;
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 100000f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, true) * 28f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
							Singleton<SniperScope>.instance.AnimFov(ODENHCLHCIL);
							MFJPCIKONDJ = true;
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 854f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, true) * 871f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
							Singleton<SniperScope>.instance.DFHDHPGPLBP(ODENHCLHCIL);
							MFJPCIKONDJ = true;
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 1199f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, false) * 1934f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
							Singleton<SniperScope>.instance.DFHDHPGPLBP(ODENHCLHCIL);
							MFJPCIKONDJ = false;
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 211f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, false) * 910f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 1207f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, true) * 1579f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
							Singleton<SniperScope>.instance.EMHDIDDOPGE(ODENHCLHCIL);
							MFJPCIKONDJ = false;
			...
			if (OCHNFNEEEME)
			{
				if (Singleton<InputController>.instance.isTapping)
				{
					...
					if (NBMPLHLIHOD)
					{
						...
						Vector3 b = vector - BGFJOCDHOGM;
						b *= 1189f;
						CMKBOEGOCFI = Vector3.Lerp(CMKBOEGOCFI, b, TimeManager.GetTimeScaledInterval(Time.deltaTime, false) * 347f);
						if (!MFJPCIKONDJ && Time.realtimeSinceStartup > MEMMHGNAMMJ + PJNILOICLJI && CMKBOEGOCFI.sqrMagnitude < CGDBFDJMMPC)
						{
							Singleton<SniperScope>.instance.NNJDPMOGPLK(ODENHCLHCIL);
							MFJPCIKONDJ = true;
