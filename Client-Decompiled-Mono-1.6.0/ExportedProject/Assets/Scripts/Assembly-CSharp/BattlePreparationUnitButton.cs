...
public class BattlePreparationUnitButton : Core_BaseScript
{
	...
	{
		NHAJIPFPKEH.SetActive(false);
		KOEOHMJILHJ.SetActive(false);
		MICLDOPLAPN(1);
	}
	...
	private void FKNEELOPFAF()
	{
		...
		{
			NHAJIPFPKEH.SetActive(true);
			KOEOHMJILHJ.SetActive(true);
			...
			else
			{
				...
				BNDEDBKKAKH((int)levelBehaviour.upgradeSlots.remainingDeliveringSeconds, true);
	...
	private void NFKJIGIOOLO()
	{
		...
		if (levelBehaviour != null)
		{
			...
			else
			{
				...
				NIGPNJJFFBE.fillAmount = levelBehaviour.upgradeSlots.progressDelivering;
				NIGPNJJFFBE.color = Colours.cyan;
				JCCOPBLMNLI((int)levelBehaviour.upgradeSlots.remainingDeliveringSeconds, true);
				HADEKFGCDFA = levelBehaviour;
				EEBLDNHFCNF();
			}
		}
	...
	private void JDEJMFKEICM()
	{
		...
		if (levelBehaviour != null)
		{
			...
			else
			{
				...
				NIGPNJJFFBE.fillAmount = levelBehaviour.upgradeSlots.progressDelivering;
				NIGPNJJFFBE.color = Colours.cyan;
				APHAKJCLMKN((int)levelBehaviour.upgradeSlots.remainingDeliveringSeconds, true);
				HADEKFGCDFA = levelBehaviour;
				EEBLDNHFCNF();
			}
		}
	...
	private void HDAOAKDNNGA()
	{
		...
		if (levelBehaviour != null)
		{
			...
			else
			{
				...
				NIGPNJJFFBE.fillAmount = levelBehaviour.upgradeSlots.progressDelivering;
				NIGPNJJFFBE.color = Colours.cyan;
				JLFECPABDFE((int)levelBehaviour.upgradeSlots.remainingDeliveringSeconds, true);
				HADEKFGCDFA = levelBehaviour;
				NPJBMJOLFAC();
			}
		}
