...
public class UIInputChat : UIInput
{
	...
	protected virtual void GCBGAAAOAKI(bool NCFKLBGOEEF)
	{
		...
		if (NCFKLBGOEEF)
		{
			...
			if (Application.platform == RuntimePlatform.OSXEditor || Application.platform == (RuntimePlatform)58)
			{
				if (isPassword)
				{
					mKeyboard = TouchScreenKeyboard.Open(mText, TouchScreenKeyboardType.ASCIICapable, true, false, false);
				}
				else
				{
	...
	protected virtual void JGFKIJNIPIE(bool NCFKLBGOEEF)
	{
		...
		if (NCFKLBGOEEF)
		{
			...
			if (Application.platform == RuntimePlatform.IPhonePlayer || Application.platform == (RuntimePlatform)108)
			{
				if (isPassword)
				{
					mKeyboard = TouchScreenKeyboard.Open(mText, TouchScreenKeyboardType.ASCIICapable, true, true, false);
				}
				else
				{
					mKeyboard = TouchScreenKeyboard.Open(mText, (TouchScreenKeyboardType)type, autoCorrect);
	...
	protected virtual void FFKIKFBECFE(bool NCFKLBGOEEF)
	{
		...
		if (NCFKLBGOEEF)
		{
			...
			if (Application.platform == RuntimePlatform.OSXWebPlayer || Application.platform == (RuntimePlatform)80)
			{
				if (isPassword)
				{
					mKeyboard = TouchScreenKeyboard.Open(mText, TouchScreenKeyboardType.ASCIICapable, true, true, true);
				}
				else
				{
					mKeyboard = TouchScreenKeyboard.Open(mText, (TouchScreenKeyboardType)type, autoCorrect);
	...
	protected virtual void MPJHLDGJEBN(bool NCFKLBGOEEF)
	{
		...
		if (NCFKLBGOEEF)
		{
			...
			if (Application.platform == (RuntimePlatform)6 || Application.platform == (RuntimePlatform)107)
			{
				if (isPassword)
				{
					mKeyboard = TouchScreenKeyboard.Open(mText, TouchScreenKeyboardType.ASCIICapable, false, false, true);
				}
				else
				{
					mKeyboard = TouchScreenKeyboard.Open(mText, (TouchScreenKeyboardType)type, autoCorrect);
