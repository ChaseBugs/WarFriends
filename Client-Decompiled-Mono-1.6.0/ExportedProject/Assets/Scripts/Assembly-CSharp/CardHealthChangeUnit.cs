...
public class CardHealthChangeUnit : Card
{
	...
	public virtual void BCBFENPIIMP()
	{
		if (KPBBNENJHPA)
		{
			...
			JAOOMCLDJFD = true;
			KPBBNENJHPA = true;
			MBIAKMPDOPG.cardIconIndicator.EOEDEJKJKMN(JGMNNPFBOMO, true);
		}
	}
	...
	private void CBHJEHCBLCG(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF(JGMNNPFBOMO, true);
	}
	...
	private void DHAHBJDIJHH(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE(JGMNNPFBOMO, false, true);
	}
	...
	private void FFHCOKEKNMD(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.NNPILDOKNJO(JGMNNPFBOMO, false);
	}
	...
	public virtual void BDBJJDHPJGM()
	{
		if (KPBBNENJHPA)
		{
			...
			JAOOMCLDJFD = false;
			KPBBNENJHPA = true;
			MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL(JGMNNPFBOMO, true, true);
		}
	}
	...
	public virtual void NMOKBODAKHB()
	{
		if (KPBBNENJHPA)
		{
			...
			JAOOMCLDJFD = true;
			KPBBNENJHPA = false;
			MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH(JGMNNPFBOMO, true);
		}
	}
	...
	public virtual void HNHKJDLIFJG()
	{
		if (KPBBNENJHPA)
		{
			...
			JAOOMCLDJFD = false;
			KPBBNENJHPA = false;
			MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE(JGMNNPFBOMO, false);
		}
	}
	...
	private void PMHBDFDNDKL(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH(JGMNNPFBOMO, true, true);
	}
	...
	private void DOAINAFDKJM(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.Show(JGMNNPFBOMO, true);
	}
	...
	private void OOEDPELGKHI(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH(JGMNNPFBOMO, true);
	}
	...
	private void AAPNCMLGCLK(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.NNPILDOKNJO(JGMNNPFBOMO, false, true);
	}
	...
	private void MAOGCCLPAGB(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.Show(JGMNNPFBOMO, true, true);
	}
	...
	public virtual void JCIPDJMFFDB()
	{
		if (KPBBNENJHPA)
		{
			...
			JAOOMCLDJFD = true;
			KPBBNENJHPA = true;
			MBIAKMPDOPG.cardIconIndicator.LDGKPCDJPLA(JGMNNPFBOMO, false, true);
		}
	}
	...
	private void PBLENIDHNDC(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL(JGMNNPFBOMO, true);
	}
	...
	private void CEKHLHHCONK(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.PEBHGOMEKME(JGMNNPFBOMO, false, true);
	}
	...
	public virtual void MOIEAEMCOID()
	{
		if (KPBBNENJHPA)
		{
			...
			JAOOMCLDJFD = false;
			KPBBNENJHPA = true;
			MBIAKMPDOPG.cardIconIndicator.OFPAGLLFPPK(JGMNNPFBOMO, false, true);
		}
	}
	...
	private void EJNMOHAPNFH(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.Show(JGMNNPFBOMO, false);
	}
	...
	public virtual void BKNCKLLMJHI()
	{
		if (KPBBNENJHPA)
		{
			...
			JAOOMCLDJFD = false;
			KPBBNENJHPA = false;
			MBIAKMPDOPG.cardIconIndicator.LJLDJOHAAMC(JGMNNPFBOMO, true);
		}
	}
	...
	private void OLAAJDLDBGP(GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF(JGMNNPFBOMO, false);
	}
	...
	public virtual void JBNMBMOJPAK()
	{
		if (KPBBNENJHPA)
		{
			...
			JAOOMCLDJFD = false;
			KPBBNENJHPA = true;
			MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH(JGMNNPFBOMO, false, true);
		}
	}
