...
public class ShotTrailRenderer : Singleton<ShotTrailRenderer>
{
	...
	public ShotTrail DIKJNMMJMFO(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO)
	{
		...
		if (shotTrail != null)
		{
			TweenPosition.Begin(shotTrail.gameObject, 1301f, OEIICEJPGKI, IIMDKHJAJGO, false);
	...
	public ShotTrail PPLOJOENHHG(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO)
	{
		...
		if (shotTrail != null)
		{
			TweenPosition.Begin(shotTrail.gameObject, 495f, OEIICEJPGKI, IIMDKHJAJGO, false);
	...
	public ShotTrail CCHECMPOOBA(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO)
	{
		...
		if (shotTrail != null)
		{
			TweenPosition.Begin(shotTrail.gameObject, 181f, OEIICEJPGKI, IIMDKHJAJGO, false);
			shotTrail.LMGELADPEHH();
			return shotTrail;
		}
		return null;
	...
	public ShotTrail PlayShot(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO)
	{
		...
		if (shotTrail != null)
		{
			TweenPosition.Begin(shotTrail.gameObject, 0.3f, OEIICEJPGKI, IIMDKHJAJGO, false);
			shotTrail.PlayShot();
			return shotTrail;
		}
		return null;
