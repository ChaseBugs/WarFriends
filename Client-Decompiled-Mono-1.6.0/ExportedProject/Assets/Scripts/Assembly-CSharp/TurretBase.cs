...
public class TurretBase<T, U> : MechanicalUnit<T> where T : TurretBaseBehaviourG<U> where U : VehicleBehaviourDefinititon
{
	...
	{
		NavMeshHit hit;
		NavMesh.SamplePosition(DHDPCBHLACO.transform.position, out hit, 13f, 0);
	...
	{
		NavMeshHit hit;
		NavMesh.SamplePosition(DHDPCBHLACO.transform.position, out hit, 10f, 1);
		Vector3 position = hit.position;
		base.transform.position = position;
	}
	...
	{
		NavMeshHit hit;
		NavMesh.SamplePosition(DHDPCBHLACO.transform.position, out hit, 128f, 0);
		Vector3 position = hit.position;
		base.transform.position = position;
	}
	...
	{
		NavMeshHit hit;
		NavMesh.SamplePosition(DHDPCBHLACO.transform.position, out hit, 1035f, 0);
		Vector3 position = hit.position;
		base.transform.position = position;
	}
