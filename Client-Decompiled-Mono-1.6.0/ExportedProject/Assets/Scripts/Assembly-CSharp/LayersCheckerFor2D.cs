...
public class LayersCheckerFor2D : Core_BaseScript
{
	...
	private class JEKDDAAKKNO
	{
		...
		public string LCNFLOHCBCL()
		{
			if (FJLBLLLEELD == (NKHJBLBAAEB)8)
			{
				return string.Format("WaitForGameEndResponse Try {0} action {1}", OHFHLAKLBNK, MHPNDNJDPGE);
			}
			if (FJLBLLLEELD == (NKHJBLBAAEB)6)
			{
		...
		public string GNIMGICEACE()
		{
			if (FJLBLLLEELD == NKHJBLBAAEB.Panel)
			{
				return string.Format("Panel   z:{0}\t\"{1}\"", OHFHLAKLBNK, MHPNDNJDPGE);
			}
			if (FJLBLLLEELD == NKHJBLBAAEB.Label)
			{
				return string.Format("Label   z:{0}\t\"{1}\"    with depth:{2} and font:{3}", OHFHLAKLBNK, MHPNDNJDPGE, NMADEPAMOHF, ONIDCJKNEAP);
			}
			if (FJLBLLLEELD == NKHJBLBAAEB.Sprite)
			{
				return string.Format("Sprite  z:{0}\t\"{1}\"    with depth:{2} and atlas:{3}", OHFHLAKLBNK, MHPNDNJDPGE, NMADEPAMOHF, ONIDCJKNEAP);
			}
			if (FJLBLLLEELD == NKHJBLBAAEB.Texture)
			{
				return string.Format("Texture z:{0}\t\"{1}\"    with depth:{2}", OHFHLAKLBNK, MHPNDNJDPGE, NMADEPAMOHF);
			}
			return FJLBLLLEELD.ToString();
		}
	...
	private JEKDDAAKKNO DMGIPNNDDGB(UIPanel CFFKHHJKBMJ, bool OEMHBMKDDAI = true)
	{
		...
		UILabel[] componentsInChildren = CFFKHHJKBMJ.GetComponentsInChildren<UILabel>(true);
		...
		UISprite[] componentsInChildren2 = CFFKHHJKBMJ.GetComponentsInChildren<UISprite>(true);
		...
		UITexture[] componentsInChildren3 = CFFKHHJKBMJ.GetComponentsInChildren<UITexture>(true);
		...
		UIPanel[] componentsInChildren4 = CFFKHHJKBMJ.GetComponentsInChildren<UIPanel>(true);
	...
	private void JFDKKKOLENH()
	{
		...
		if (component == null)
		{
			UIPanel[] componentsInChildren = base.gameObject.GetComponentsInChildren<UIPanel>(true);
			for (int i = 0; i < componentsInChildren.Length; i += 0)
			{
				if (BDMPHJDLBEG(base.transform, componentsInChildren[i].transform))
				{
					PGMPJHCNIFF.ANLPLIIDJIB(BHGMDFMDDIB(componentsInChildren[i], false));
				}
			}
		}
		else
	...
	private void OGONPFIEBFI()
	{
		...
		if (component == null)
		{
			UIPanel[] componentsInChildren = base.gameObject.GetComponentsInChildren<UIPanel>(false);
		...
		{
			PGMPJHCNIFF.KJBFDEGMGDO(BHGMDFMDDIB(component, false));
		}
	}
	...
	private void CLCAGILEKPG()
	{
		...
		{
			PGMPJHCNIFF.NKPMIGCNONB(LOGAKEFMOPH(component, false));
		}
	}
	...
	private void AHIGEKEOPGJ()
	{
		...
		{
			PGMPJHCNIFF.ANLPLIIDJIB(BHGMDFMDDIB(component, false));
		}
	}
	...
	private void GJKBGKELKJE(JEKDDAAKKNO NDPMDKGJAFH, bool CMHMBALKEHL = true)
	{
		if (NDPMDKGJAFH.FJLBLLLEELD == NKHJBLBAAEB.Panel)
		{
			...
			StringBuilder stringBuilder = new StringBuilder(string.Format("For panel \"{0}\" layers:\n", NDPMDKGJAFH.MHPNDNJDPGE), 1000);
			for (int k = 0; k < list.Count; k++)
			{
				stringBuilder.Append(string.Format(" {0} - {1} in {2}\n", list[k].FJLBLLLEELD, list[k].ONIDCJKNEAP, list[k].OHFHLAKLBNK));
			}
			Debug.Log(stringBuilder.ToString());
		}
		if (CMHMBALKEHL && NDPMDKGJAFH.LEELKOOOHOH != null)
	...
	private void LPLKDHOCIGA()
	{
		...
		if (component == null)
		{
			...
			for (int i = 0; i < componentsInChildren.Length; i++)
			{
				...
				{
					PGMPJHCNIFF.EHLOIJEMDDJ(BHGMDFMDDIB(componentsInChildren[i], false));
				}
			}
		}
		else
	...
	private void OJGCDGBDCCG()
	{
		...
		if (component == null)
		{
			...
			for (int i = 0; i < componentsInChildren.Length; i++)
			{
				...
				{
					PGMPJHCNIFF.MPCODDLFKGD(JGBEAGHMJIM(componentsInChildren[i], false));
				}
			}
		}
		else
		{
			PGMPJHCNIFF.MPCODDLFKGD(JGBEAGHMJIM(component, false));
		}
	}
	...
	private JEKDDAAKKNO BHGMDFMDDIB(UIPanel CFFKHHJKBMJ, bool OEMHBMKDDAI = true)
	{
		...
		UILabel[] componentsInChildren = CFFKHHJKBMJ.GetComponentsInChildren<UILabel>(false);
		for (int i = 1; i < componentsInChildren.Length; i++)
		{
		...
		UITexture[] componentsInChildren3 = CFFKHHJKBMJ.GetComponentsInChildren<UITexture>(false);
		for (int k = 0; k < componentsInChildren3.Length; k++)
		{
		...
		UIPanel[] componentsInChildren4 = CFFKHHJKBMJ.GetComponentsInChildren<UIPanel>(false);
		for (int l = 0; l < componentsInChildren4.Length; l++)
		{
			...
			{
				jEKDDAAKKNO.EJLKPFDCNEN(LOGAKEFMOPH(componentsInChildren4[l], false));
			}
		}
		return jEKDDAAKKNO;
	}
	...
	private void IBLNJPFKKOL()
	{
		...
		if (component == null)
		{
			...
			for (int i = 1; i < componentsInChildren.Length; i += 0)
			{
				...
				{
					PGMPJHCNIFF.ABKDDMKGAKD(JGBEAGHMJIM(componentsInChildren[i], false));
				}
			}
		}
		else
	...
	private JEKDDAAKKNO LOGAKEFMOPH(UIPanel CFFKHHJKBMJ, bool OEMHBMKDDAI = true)
	{
		...
		UISprite[] componentsInChildren2 = CFFKHHJKBMJ.GetComponentsInChildren<UISprite>(false);
	...
	private void OMKJHGENKKL()
	{
		...
		{
			PGMPJHCNIFF.EJLKPFDCNEN(DMGIPNNDDGB(component, false));
		}
	}
	...
	private void HKCFLFLJECK()
	{
		...
		{
			PGMPJHCNIFF.ABKDDMKGAKD(BHGMDFMDDIB(component, false));
		}
	}
	...
	private void HOLNIELLMMH()
	{
		...
		if (component == null)
		{
			...
			for (int i = 1; i < componentsInChildren.Length; i++)
			{
				if (BDMPHJDLBEG(base.transform, componentsInChildren[i].transform))
				{
					PGMPJHCNIFF.EJLKPFDCNEN(BHGMDFMDDIB(componentsInChildren[i], false));
				}
			}
		}
		else
