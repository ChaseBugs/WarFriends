...
public class ReminderManager : InGameSerializedObjectGeneric<ReminderManager.SaveData>
{
	public enum ReminderType
	{
		...
		ConnectFb = 7,
		VipPurchase = 8,
		MoneyPackRunningOut = 9,
		StarterPackRunningOut = 10,
		DailyAssignments = 11
	}
	...
	private bool isUpgradeTutorialRunning
	{
		get
		{
			return TutorialManagerStage4.instance.isTutorialRunning || TutorialManagerStage5.instance.isTutorialRunning;
		}
	}
	...
	public int vipRunningOutSeconds
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.VipRunningOutSeconds).FLOATVALUE;
		}
	}

	public int minTimeSinceLastWeaponUpgrade
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.MinTimeSinceLastWeaponUpgrade).FLOATVALUE;
		}
	}

	public int minTimeSinceLastUnitUpgrade
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.MinTimeSinceLastUnitUpgrade).FLOATVALUE;
		}
	}

	public int minLevelForCardsReminder
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.MinLevelForCardsReminder).FLOATVALUE;
		}
	}

	public int lowNumberOfCards
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.LowNumberOfCards).FLOATVALUE;
		}
	}

	public int minLevelForSquadJoinOrCreateReminder
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.MinLevelForSquadJoinOrCreateReminder).FLOATVALUE;
		}
	}

	public int minTimeSinceLastVipPurchase
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.MinTimeSinceLastVipPurchase).FLOATVALUE;
		}
	}

	public int rateAppMaxShow
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.RateAppMaxShow).FLOATVALUE;
		}
	}

	public int notificationAllowWinsNeed
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.NotificationAllowWinsNeed).FLOATVALUE;
		}
	}

	public int notificationAllowTimeBetween
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.NotificationAllowHoursBetween).FLOATVALUE * 3600;
		}
	}

	public int notificationAllowMaxShow
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.NotificationAllowMaxShow).FLOATVALUE * 3600;
		}
	}

	public int nameChangeReminderGamesAfterFbLogin
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.NameChangeReminderGamesAfterFbLogin).FLOATVALUE;
		}
	}

	public int facebookRemindDialogShow1After
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.FacebookLoginReminder1After).FLOATVALUE * 3600;
		}
	}

	public int facebookRemindDialogShow2After
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.FacebookLoginReminder2After).FLOATVALUE * 3600;
		}
	}

	public int facebookRemindDialogShow3After
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.FacebookLoginReminder3After).FLOATVALUE * 3600;
		}
	}

	public int vipReminderBetweenTime
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.TimeBetweenVIPreminderShown).FLOATVALUE * 3600;
		}
	}

	public int weaponReminderBetweenTime
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.TimeBetweenWeaponUpgradeReminderShown).FLOATVALUE * 3600;
		}
	}

	public int unitReminderBetweenTime
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.TimeBetweenUnitUpgradeReminderShown).FLOATVALUE * 3600;
		}
	}

	public int squadReminderBetweenTime
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.TimeBetweenSquadReminderShown).FLOATVALUE * 3600;
		}
	}

	public int unitCategoriesReminderAfterGames
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.UnitCategoriesReminderAfterGames).FLOATVALUE;
		}
	}

	public int moneyPackRunningOutSeconds
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.MoneyPackRunningOutSeconds).FLOATVALUE * 3600;
		}
	}

	public int rateAppShowAfterBattles
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.RateAppShowAfterBattles).FLOATVALUE;
		}
	}

	public int rateAppShowAfterLevel
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.RateAppShowAfterLevel).FLOATVALUE;
		}
	}

	public int rateAppShowSecondTimeAfterLevel
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.RateAppShowSecondTimeAfterLevel).FLOATVALUE;
		}
	}

	public int starterPackRunningOutSeconds
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.StarterPackRunningOutSeconds).FLOATVALUE * 3600;
		}
	}
	...
	private void OnAfterPlayerDataLoaded()
	{
		if (!Singleton<GameController>.instance.isTutorial)
		{
			Debug.Log(string.Format("Reminder Manager: CLIENT REMINDERS AFTER PLAYER DATA LOADED:\n{0}\n{1}\n{2}\n{3}", debugMoneyPackRunningOut, debugStarterPackRunningOut, debugVipRunningOut, debugVipExpired));
	...
	private void ShowStarterPackRunningOut()
	{
		...
		{
			Singleton<MessageManager>.instance.AddMessage(new GJJLHIIMGOP(true));
