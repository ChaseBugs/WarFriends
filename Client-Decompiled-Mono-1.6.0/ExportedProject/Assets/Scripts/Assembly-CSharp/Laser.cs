...
public class Laser : Ammo
{
	...
	public virtual void JODNLNFFAEK(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO)
	{
		...
		for (int i = 0; i < array2.Length; i++)
		{
			...
			{
				GIMOMGKLJEE(OEIICEJPGKI, raycastHit.point, false);
				flag = false;
				break;
			}
			...
			if (component != null)
			{
				component.JPBFBBMCFPI(PMCGFJLLCHJ, raycastHit.point, Vector3.zero, JMMJHCOKCGG, base.owner, CAKABHIPCDF, true);
				if (component.AEJBIHBEOCP)
				{
					AHMOBKLCAHL(OEIICEJPGKI, raycastHit.point, false);
					flag = false;
					break;
				}
			}
		...
		if (!flag)
		{
			NIAGPEADKIN(OEIICEJPGKI, IIMDKHJAJGO, true);
		}
	}
	...
	public virtual void FFDPHJCJFFI(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO)
	{
		...
		for (int i = 0; i < array2.Length; i += 0)
		{
			...
			if (component != null)
			{
				component.Shoot(PMCGFJLLCHJ, raycastHit.point, Vector3.zero, JMMJHCOKCGG, base.owner, CAKABHIPCDF, false);
				if (component.AEJBIHBEOCP)
				{
					ABIEEPEGOGO(OEIICEJPGKI, raycastHit.point, true);
					flag = false;
					break;
				}
			}
		...
		if (!flag)
		{
			HIGDEKMELIM(OEIICEJPGKI, IIMDKHJAJGO, true);
		}
	}
	...
	public virtual void CJCOJIFHHMN(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO)
	{
		...
		for (int i = 1; i < array2.Length; i++)
		{
			...
			if (TagsAndLayers.LKIJKDCGCMI(raycastHit.transform.gameObject))
			{
				HILMBFDOJCK(OEIICEJPGKI, raycastHit.point, false);
				flag = true;
				break;
			}
			DestroyableObject component = raycastHit.collider.transform.GetComponent<DestroyableObject>();
			if (component != null)
			{
				component.JPBFBBMCFPI(PMCGFJLLCHJ, raycastHit.point, Vector3.zero, JMMJHCOKCGG, base.owner, CAKABHIPCDF, false);
				if (component.AEJBIHBEOCP)
				{
					AHMOBKLCAHL(OEIICEJPGKI, raycastHit.point, true);
					flag = true;
					break;
				}
			}
		...
		if (!flag)
		{
			AHMOBKLCAHL(OEIICEJPGKI, IIMDKHJAJGO, true);
		}
	}
	...
	public virtual void ABHDBNJGONF(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO)
	{
		...
		for (int i = 1; i < array2.Length; i++)
		{
			...
			if (TagsAndLayers.KHKNLLDEBMA(raycastHit.transform.gameObject))
			{
				NIAGPEADKIN(OEIICEJPGKI, raycastHit.point, false);
				flag = false;
				break;
			}
			DestroyableObject component = raycastHit.collider.transform.GetComponent<DestroyableObject>();
			if (component != null)
			{
				...
				if (component.AEJBIHBEOCP)
				{
					HILMBFDOJCK(OEIICEJPGKI, raycastHit.point, true);
					flag = true;
					break;
				}
			}
	...
	public virtual void HFONHKMACOG(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO)
	{
		...
		for (int i = 0; i < array2.Length; i++)
		{
			...
			{
				HIGDEKMELIM(OEIICEJPGKI, raycastHit.point, false);
				flag = true;
				break;
			}
			DestroyableObject component = raycastHit.collider.transform.GetComponent<DestroyableObject>();
			if (component != null)
			{
				...
				if (component.AEJBIHBEOCP)
				{
					NIAGPEADKIN(OEIICEJPGKI, raycastHit.point, true);
					flag = true;
					break;
				}
			}
		...
		if (!flag)
		{
			GIMOMGKLJEE(OEIICEJPGKI, IIMDKHJAJGO, false);
		}
	}
	...
	public virtual void LPLLKPCGHJH(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO)
	{
		...
		for (int i = 1; i < array2.Length; i++)
		{
			...
			if (TagsAndLayers.KHKNLLDEBMA(raycastHit.transform.gameObject))
			{
				ABIEEPEGOGO(OEIICEJPGKI, raycastHit.point, false);
				flag = true;
				break;
			}
			DestroyableObject component = raycastHit.collider.transform.GetComponent<DestroyableObject>();
		...
		if (!flag)
		{
			HILMBFDOJCK(OEIICEJPGKI, IIMDKHJAJGO, false);
		}
	}
	...
	public virtual void DPMDEEGOOHI(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO)
	{
		...
		for (int i = 0; i < array2.Length; i += 0)
		{
			...
			if (component != null)
			{
				component.Shoot(PMCGFJLLCHJ, raycastHit.point, Vector3.zero, JMMJHCOKCGG, base.owner, CAKABHIPCDF, true);
				if (component.AEJBIHBEOCP)
				{
					AHMOBKLCAHL(OEIICEJPGKI, raycastHit.point, false);
					flag = true;
		...
		if (!flag)
		{
			NIAGPEADKIN(OEIICEJPGKI, IIMDKHJAJGO, false);
		}
	}
	...
	public override void Fire(Vector3 OEIICEJPGKI, Vector3 IIMDKHJAJGO)
	{
		...
		if (!flag)
		{
			AHMOBKLCAHL(OEIICEJPGKI, IIMDKHJAJGO, false);
		}
	}
