...
public class CardpoolTutorialDialog : GuiElementSingle<CardpoolTutorialDialog>, PAIIOKBBHBC
{
	...
	public virtual void DMBLJNMGLAH()
	{
		...
		if (FPGFALIMOOH != null)
		{
			...
			FPGFALIMOOH.Initialize(CardManager.instance.buddyCard, (CardRecord.MKIOKBMLHEO)7, false);
			FPGFALIMOOH.behaviour = CardRecord.MKIOKBMLHEO.Deposit;
			FPGFALIMOOH.GPKNHEHAPNP.SetActive(true);
		}
		KHNIGEPLEED = -1;
		...
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[1].POFHFNIDADF(CardManager.instance.GetCardInstance("Showing squad details dialog with SQUADNAME = "), false, false);
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[2].HPKNMDLFJPC();
		FALALANBDHJ[8].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(false);
	...
	public virtual void KPLOCMGDDAB()
	{
		...
		if (FPGFALIMOOH != null)
		{
			...
			FPGFALIMOOH.GPKNHEHAPNP.SetActive(false);
		}
		KHNIGEPLEED = -1;
		...
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[1].EAAFKLCOAJC(CardManager.instance.GetCardInstance("Memory_warnings", false));
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[4].HPKNMDLFJPC();
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[6].CDHLCGBCDGH.gameObject.SetActive(true);
	...
	public virtual void OJKCMCPJPGO()
	{
		...
		{
			CardManager.instance.InitializeBuddyWarcard();
			FPGFALIMOOH.Initialize(CardManager.instance.buddyCard, (CardRecord.MKIOKBMLHEO)8, false);
		...
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[0].GPGOBGHNOJC(CardManager.instance.GetCardInstance("Items"), true, false);
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[2].HPKNMDLFJPC();
	...
	public virtual void EGMFAHMCCBM()
	{
		...
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[1].DOFOLHEJGEJ(CardManager.instance.GetCardInstance("longValue"), false, false);
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[4].NMJAANNEMHN();
		FALALANBDHJ[2].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[5].CDHLCGBCDGH.gameObject.SetActive(false);
		Singleton<BeanstalkServerManager>.instance.JDKFJFALDOG();
	}
	...
	public virtual void OIGFBFFNNHH()
	{
		...
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[1].GPGOBGHNOJC(CardManager.instance.GetCardInstance("RETRY", false), false, false);
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[7].InitializeEmpty();
		FALALANBDHJ[8].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[4].CDHLCGBCDGH.gameObject.SetActive(false);
		Singleton<BeanstalkServerManager>.instance.JDKFJFALDOG();
	}
	...
	public virtual void HHJDKKFKKIL()
	{
		...
		{
			CardManager.instance.InitializeBuddyWarcard();
			FPGFALIMOOH.IGPOLIPPGBP(CardManager.instance.buddyCard, (CardRecord.MKIOKBMLHEO)7, false);
			FPGFALIMOOH.OFOPDHDHNHO(CardRecord.MKIOKBMLHEO.CraftCards);
			FPGFALIMOOH.GPKNHEHAPNP.SetActive(true);
		}
		KHNIGEPLEED = -1;
		...
		FALALANBDHJ[0].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[1].CCKJHIPIMDB(CardManager.instance.GetCardInstance("Hide poison"), true);
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(false);
	...
	public virtual void EHNFJGINHDJ()
	{
		...
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[1].GPGOBGHNOJC(CardManager.instance.GetCardInstance("elite", false), true, false);
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(false);
	...
	public virtual void IEHJMLIMNEP()
	{
		...
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[1].NNGCENCIGDE(CardManager.instance.GetCardInstance("ID_CONFIRM_ALREADYLEADER", false), true, false);
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[6].NMJAANNEMHN();
		FALALANBDHJ[4].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[3].CDHLCGBCDGH.gameObject.SetActive(true);
		Singleton<BeanstalkServerManager>.instance.GDLMOPCGPGD();
	}
	...
	public virtual void NDBAEHKKJMH()
	{
		...
		FALALANBDHJ[0].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[0].POFHFNIDADF(CardManager.instance.GetCardInstance("antialiasing", false), true);
		FALALANBDHJ[0].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(false);
	...
	public virtual void AFABKGHDPHB()
	{
		...
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[1].CCKJHIPIMDB(CardManager.instance.GetCardInstance("ID_GUI_LEAGUE", false), false, false);
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[3].NLIOGJLOOJB();
		FALALANBDHJ[0].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[4].CDHLCGBCDGH.gameObject.SetActive(true);
		Singleton<BeanstalkServerManager>.instance.GDLMOPCGPGD();
	}
	...
	public virtual void GPLNBGEDOLE()
	{
		...
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[1].InitializeCard(CardManager.instance.GetCardInstance("realShotProbability", false), false, false);
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(false);
	...
	public virtual void CAALKACDJEK()
	{
		...
		{
			CardManager.instance.InitializeBuddyWarcard();
			FPGFALIMOOH.CKOIIPAGCNO(CardManager.instance.buddyCard, CardRecord.MKIOKBMLHEO.CraftCards, false);
		...
		FALALANBDHJ[0].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[1].ONIDGNIBFAC(CardManager.instance.GetCardInstance("NextUpgradePrice", false));
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[4].InitializeEmpty();
		FALALANBDHJ[7].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[8].CDHLCGBCDGH.gameObject.SetActive(true);
		Singleton<BeanstalkServerManager>.instance.GDLMOPCGPGD();
	}
	...
	public override void InitGUIValues()
	{
		...
		FALALANBDHJ[2].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[2].CDHLCGBCDGH.gameObject.SetActive(false);
		Singleton<BeanstalkServerManager>.instance.GDLMOPCGPGD();
	}
	...
	public virtual void PDHNLAMPOBN()
	{
		...
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[1].DOFOLHEJGEJ(CardManager.instance.GetCardInstance("DeviceToken", false));
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[4].HPKNMDLFJPC();
		FALALANBDHJ[2].NJEAMAHEMHP.enabled = false;
	...
	public virtual void JBPMEEOHJIH()
	{
		...
		{
			CardManager.instance.InitializeBuddyWarcard();
			FPGFALIMOOH.Initialize(CardManager.instance.buddyCard, CardRecord.MKIOKBMLHEO.CountDownBuddy, false);
		...
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[1].InitializeCard(CardManager.instance.GetCardInstance("e695d3cf-1ed0-4989-89fe-e041e4ee7e2b"), true);
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[6].PDEAPJCGEBB();
		FALALANBDHJ[2].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[7].CDHLCGBCDGH.gameObject.SetActive(false);
		Singleton<BeanstalkServerManager>.instance.JDKFJFALDOG();
	}
	...
	public virtual void LEMNDNDGIOE()
	{
		...
		{
			CardManager.instance.InitializeBuddyWarcard();
			FPGFALIMOOH.IGPOLIPPGBP(CardManager.instance.buddyCard, (CardRecord.MKIOKBMLHEO)8, false);
		...
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[0].DOFOLHEJGEJ(CardManager.instance.GetCardInstance("SoftBody", false), false, false);
		FALALANBDHJ[0].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[0].NLIOGJLOOJB();
		FALALANBDHJ[5].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[7].CDHLCGBCDGH.gameObject.SetActive(true);
		Singleton<BeanstalkServerManager>.instance.GDLMOPCGPGD();
	}
	...
	public virtual void BFLHENDLPLK()
	{
		...
		FALALANBDHJ[1].NJEAMAHEMHP.enabled = false;
		FALALANBDHJ[1].CDHLCGBCDGH.gameObject.SetActive(false);
		FALALANBDHJ[1].GPGOBGHNOJC(CardManager.instance.GetCardInstance("HitListItem", false));
		FALALANBDHJ[0].NJEAMAHEMHP.enabled = true;
		FALALANBDHJ[0].CDHLCGBCDGH.gameObject.SetActive(true);
		FALALANBDHJ[7].InitializeEmpty();
