...
public class CamosManager : DatabaseSerializedObjectGeneric<CamosManager.DecalManagerData>
{
	...
	public PlayerVisualsRarities playerVisualsRarities
	{
		get
		{
			return mPlayerVisualsRarities ?? (mPlayerVisualsRarities = GetComponent<PlayerVisualsRarities>());
		}
	}

	public List<PlayerVisual> visualsSortedByLevel
	{
		get
		{
			return mVisualsSortedByLevel;
		}
	}
	...
	public void UpdateVisuals(KMNCIJPDFPJ playerController)
	{
		...
		bool helmetHidden;
		bool headAccesoryHidden;
		GetVisualVisibility(text, text2, out helmetHidden, out headAccesoryHidden);
	...
	{
		SavedPlayerVisual value;
		if (data.visuals.TryGetValue(visualId, out value))
		{
			return value;
		}
		return null;
