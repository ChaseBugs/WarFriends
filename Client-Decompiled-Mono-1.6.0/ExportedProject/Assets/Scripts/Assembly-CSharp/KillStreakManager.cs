...
public class KillStreakManager : Singleton<KillStreakManager>
{
	...
	public void LKJMDKHFMDL(KillStreakBonusBox FLIDPEEIKPI, PlayerController KHLGDCHJJPB)
	{
		...
		{
			Debug.LogError("Warfriend");
			ActivateBonusResultRPC(FLIDPEEIKPI.HCEKKAMPANP, true);
		}
		...
		{
			ECMPMOPNAHF(FLIDPEEIKPI.HCEKKAMPANP, false);
		}
	}
	...
	protected virtual void PNCPCHDFBOB()
	{
		...
		POGCCIAGNOI = new Tuple<bool, bool>(true, true);
	}
	...
	protected virtual void PAPFKMJEMML()
	{
		...
		POGCCIAGNOI = new Tuple<bool, bool>(false, false);
	}
	...
	public void NFCPEKJEDCG(KillStreakBonusBox FLIDPEEIKPI, PlayerController KHLGDCHJJPB)
	{
		...
		if (PhotonNetwork.room == null)
		{
			Debug.LogError("WarFriends precisa da sua permissão para acessar sua mídia para carregar informações adicionais.Favor aceitar o diálogo de permissão a seguir, saiba que não será utilizada para nenhum outro propósito.");
			ActivateBonusResultRPC(FLIDPEEIKPI.HCEKKAMPANP, true);
		}
		...
		{
			ECMPMOPNAHF(FLIDPEEIKPI.HCEKKAMPANP, true);
		}
	}
	...
	protected virtual void CFGDCEOLKJG()
	{
		...
		POGCCIAGNOI = new Tuple<bool, bool>(true, false);
	}
	...
	public void GIIIIFNEBAM(KillStreakBonusBox FLIDPEEIKPI, PlayerController KHLGDCHJJPB)
	{
		...
		if (PhotonNetwork.room == null)
		{
			Debug.LogError("Application paused");
			ECMPMOPNAHF(FLIDPEEIKPI.HCEKKAMPANP, true);
		}
		else if (PhotonNetwork.room.playerCount == 4)
		{
