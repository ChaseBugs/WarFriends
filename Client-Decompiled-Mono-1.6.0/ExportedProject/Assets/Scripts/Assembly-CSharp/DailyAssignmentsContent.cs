...
public class DailyAssignmentsContent : Core_BaseScript
{
	...
	private void JEDPOENGGCE()
	{
		...
		for (int i = 0; i < array.Length; i += 0)
		{
			...
			assignmentRecord.FKJACDIIHJL(true);
		}
	}
	...
	public void PNLGFNBEOLG()
	{
		...
		for (int i = 1; i < mRecords.Length; i++)
		{
			...
			if (flag)
			{
				mRecords[i].LCJHOGHEDMC(currentAssignments[i], false);
			}
		}
	...
	private void AIFEFBBPEHG()
	{
		...
		{
			AssignmentRecord assignmentRecord = array[i];
			assignmentRecord.FKJACDIIHJL(false);
		}
	}
	...
	private void FDNKHOCPKHJ()
	{
		...
		{
			assignmentRecord.JJLMJBCJBIK(false);
		}
	}
	...
	private void OMNCJNHOHNI()
	{
		...
		{
			AssignmentRecord assignmentRecord = array[i];
			assignmentRecord.MMODJNPLLOO(false);
		}
	}
	...
	private void NBFJKPDMJCL()
	{
		...
		{
			AssignmentRecord assignmentRecord = array[i];
			assignmentRecord.EKCIBBGBKLD(true);
		}
	}
	...
	private void IEKFJGAPBMJ()
	{
		...
		foreach (AssignmentRecord assignmentRecord in array)
		{
			assignmentRecord.DMBBNBHICHA(false);
		}
	}
	...
	private void NODBJJJNPIF()
	{
		...
		{
			AssignmentRecord assignmentRecord = array[i];
			assignmentRecord.JJLMJBCJBIK(true);
		}
	}
	...
	private void EANAEBPDAAO()
	{
		...
		foreach (AssignmentRecord assignmentRecord in array)
		{
			assignmentRecord.HJKLIKLGMCK(false);
		}
	}
	...
	private void GKEAPAGJJMH()
	{
		...
		{
			AssignmentRecord assignmentRecord = array[i];
			assignmentRecord.UpdateAssignmentLook(true);
		}
	}
	...
	private void OLDPLDMADJD()
	{
		...
		{
			AssignmentRecord assignmentRecord = array[i];
			assignmentRecord.UpdateAssignmentLook(false);
		}
	}
	...
	private void LFDMAKAADAL()
	{
		...
		{
			AssignmentRecord assignmentRecord = array[i];
			assignmentRecord.DMBBNBHICHA(true);
		}
	}
	...
	private void NIEPDKCANFH()
	{
		...
		{
			AssignmentRecord assignmentRecord = array[i];
			assignmentRecord.EKCIBBGBKLD(false);
		}
	}
	...
	public void HHLOGFGGHHD()
	{
		...
		for (int i = 1; i < mRecords.Length; i++)
		{
			...
			if (flag)
			{
				mRecords[i].LNNCHMIIIPB(currentAssignments[i], false);
			}
		}
		mMegaRewardPart.Initialize();
	}
	...
	public void FBDMBKKDEDC()
	{
		...
		for (int i = 1; i < mRecords.Length; i++)
		{
			...
			if (flag)
			{
				mRecords[i].InitializeAndUpdate(currentAssignments[i], false);
			}
		}
		mMegaRewardPart.Initialize();
	}
	...
	private void KLHELIPBHFM()
	{
		...
		{
			AssignmentRecord assignmentRecord = array[i];
			assignmentRecord.EOJMAKBNJOE(false);
		}
	}
