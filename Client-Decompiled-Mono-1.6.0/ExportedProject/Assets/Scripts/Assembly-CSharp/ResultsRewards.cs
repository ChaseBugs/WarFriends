...
public class ResultsRewards : Core_BaseScript
{
	...
	public TweenAnimator animatorMoney
	{
		get
		{
			return MLJBGAIFPIJ;
	...
	public TweenAnimator animatorOnlyWB
	{
		get
		{
			return DPFEHIAILED;
	...
	{
		MLJBGAIFPIJ = BCHDJNDIBGG(false, KEGGAOMKIAK);
		DPFEHIAILED = CAMJNJLADCC(false, KEGGAOMKIAK);
		return MLJBGAIFPIJ;
	}

	public virtual TweenAnimator NINGMLNMLLP(bool KEGGAOMKIAK = true)
	{
		MLJBGAIFPIJ = KAPINNGKHDL(false, KEGGAOMKIAK);
		DPFEHIAILED = ABMPGDCDJJO(false, KEGGAOMKIAK);
		return MLJBGAIFPIJ;
	}
	...
	{
		MLJBGAIFPIJ = BCHDJNDIBGG(true, KEGGAOMKIAK);
		DPFEHIAILED = BBGOKONLNPE(false, KEGGAOMKIAK);
		return MLJBGAIFPIJ;
	}
	...
	{
		MLJBGAIFPIJ = GDMPKECBENP(true, KEGGAOMKIAK);
		DPFEHIAILED = ILFKPKAKDPI(true, KEGGAOMKIAK);
		return MLJBGAIFPIJ;
	}
	...
	{
		MLJBGAIFPIJ = NBAJOILBHCA(true, KEGGAOMKIAK);
		DPFEHIAILED = GDMPKECBENP(false, KEGGAOMKIAK);
		return MLJBGAIFPIJ;
	}
	...
	{
		MLJBGAIFPIJ = ABMPGDCDJJO(true, KEGGAOMKIAK);
		DPFEHIAILED = KAPINNGKHDL(true, KEGGAOMKIAK);
		return MLJBGAIFPIJ;
	}
	...
	{
		MLJBGAIFPIJ = ILFKPKAKDPI(false, KEGGAOMKIAK);
		DPFEHIAILED = ABMPGDCDJJO(true, KEGGAOMKIAK);
		return MLJBGAIFPIJ;
	}
	...
	{
		MLJBGAIFPIJ = CAMJNJLADCC(true, KEGGAOMKIAK);
		DPFEHIAILED = CAMJNJLADCC(true, KEGGAOMKIAK);
		return MLJBGAIFPIJ;
	}
	...
	{
		MLJBGAIFPIJ = BCHDJNDIBGG(true, KEGGAOMKIAK);
		DPFEHIAILED = BCHDJNDIBGG(false, KEGGAOMKIAK);
		return MLJBGAIFPIJ;
	}
	...
	{
		MLJBGAIFPIJ = CAMJNJLADCC(true, KEGGAOMKIAK);
		DPFEHIAILED = LOHKKOJKKPI(true, KEGGAOMKIAK);
		return MLJBGAIFPIJ;
	}
	...
	{
		MLJBGAIFPIJ = BCHDJNDIBGG(true, KEGGAOMKIAK);
		DPFEHIAILED = BCGHAEDPAME(true, KEGGAOMKIAK);
		return MLJBGAIFPIJ;
	}
