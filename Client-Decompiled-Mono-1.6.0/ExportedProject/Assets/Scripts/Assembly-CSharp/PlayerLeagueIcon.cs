...
public class PlayerLeagueIcon : PoolableObject
{
	...
	public void OnClick()
	{
		GuiScreenSingle<LeaguesScreen>.instance.BMNDININJCE.EPNMOFNHJDB.SelectIcon(BAKGJEGCNCI, ALGBCPEGLCO, KNNEGKLGBKO, true);
		Highlight(true, true);
	}
	...
	{
		GuiScreenSingle<LeaguesScreen>.instance.BMNDININJCE.EPNMOFNHJDB.PDAEDHHCPJE(BAKGJEGCNCI, ALGBCPEGLCO, KNNEGKLGBKO, true);
		FPCMJEPFMNO(true);
	}
	...
	{
		GuiScreenSingle<LeaguesScreen>.instance.BMNDININJCE.EPNMOFNHJDB.EFLNBGDAHFK(BAKGJEGCNCI, ALGBCPEGLCO, KNNEGKLGBKO, true);
		DJLFGMAMNEN(false, true);
	}
	...
	{
		GuiScreenSingle<LeaguesScreen>.instance.BMNDININJCE.EPNMOFNHJDB.ILEKNDBLNFN(BAKGJEGCNCI, ALGBCPEGLCO, KNNEGKLGBKO, true);
		IGLMKKMKCGG(true);
	}
	...
	{
		GuiScreenSingle<LeaguesScreen>.instance.BMNDININJCE.EPNMOFNHJDB.FKCGLFHBCCN(BAKGJEGCNCI, ALGBCPEGLCO, KNNEGKLGBKO, true);
		BANCDJNFHIC(true);
	}
