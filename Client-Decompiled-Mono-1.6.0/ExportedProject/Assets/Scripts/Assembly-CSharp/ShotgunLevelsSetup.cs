...
public class ShotgunLevelsSetup : WeaponLevelsSetup
{
	...
	public override float shotDamage
	{
		get
		{
			return Convert.ToSingle(LIEFNEPEIJO.GetValue(MGAGEKAAJOL.boughtIndex, "maxDamage")) * base.weaponFeature.damageCoef;
		}
	}
	...
	public virtual List<Tuple<string, float[]>> LEICHMNLNBD(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "{0} Rookie {1}", "ID_ERROR_SQUADNAMENOTUNIQUE", base.weaponFeature.clipSizeCoef, true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Sniper_Tutorial_Played", "longValue", base.weaponFeature.attackCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "rental for unexist weapon: {0}", "LootBox_Purchase", base.weaponFeature.clipSizeCoef, true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "{0}{1}/{2}{3}", "com/google/android/gms/games/stats/PlayerStats", base.weaponFeature.attackCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "AtlasPreparer.LoadMenuCoroutine", "shield_unhide", base.weaponFeature.clipSizeCoef));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Show Loadout After Create Account", "Bad player visuals, data= ", base.weaponFeature.reloadCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "End Screen - button content - visual notification changed. End Screen active ", "VIPMembershipExpired", base.weaponFeature.ammoCoef, true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Deposited Warcards: ", "Started delivering |", base.weaponFeature.attackCoef, true));
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ammo", "ID_STATE_WAITINGFOROPPONENT", base.weaponFeature.ammoCoef, true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> GFJDKGGCDFK(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_NOTIFICATION_DAILYREWARD_TICKET", "Effect: ", base.weaponFeature.clipSizeCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_RANDOMMAP", "1\u00a0{0}", base.weaponFeature.reloadCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "BeanstalkServerManager: AfterPlayerDataLoaded", "ID_BONUS-EVENT_POINTS", base.weaponFeature.ammoCoef, true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> JNLDADKCANP(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Configurations hacked", "Configurations error, there is {0} configurations of type {1}", base.weaponFeature.clipSizeCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_EARLYUNLOCK2", "shotgunner_run", base.weaponFeature.reloadCoef, true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "\t\"FALSE\"", "HeroicPoints", base.weaponFeature.attackCoef, true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_ERROR_SQUADMESSAGE_PROFANITY", "ID_POISONDAMAGE", base.weaponFeature.attackCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_WARNING_PROMOTEERROR", "v", base.weaponFeature.clipSizeCoef, true));
	...
	public virtual List<Tuple<string, float[]>> EELEAGABDAI(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_VISUALRARITY5", "goldcardpack", base.weaponFeature.reloadCoef, true));
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_TIERX", "Card_2_Played", base.weaponFeature.attackCoef, true));
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Packs", "ShowRope", base.weaponFeature.reloadCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "HeroicMissionsCompletionRewardScraps", "!!!!", base.weaponFeature.ammoCoef, true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "shield_run", "ShotFrequencyMax", base.weaponFeature.attackCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "UnitTutorial", "-ABILITY", base.weaponFeature.clipSizeCoef, true));
	...
	public virtual List<Tuple<string, float[]>> JPNLNDEIBCM(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "\t\"TRUE\"", "ID_FREEPERCENTLINE", base.weaponFeature.clipSizeCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "doesnt exist", "RETRY", base.weaponFeature.reloadCoef));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "-", "shootAdditive", base.weaponFeature.ammoCoef, true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> FDJGKJMELLE(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "#VOJTA# LOADED DAILY MISSIONS AFTER LEVEL UP", "ObjectPool", base.weaponFeature.reloadCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "PlayerUnitPower", "__", base.weaponFeature.ammoCoef, true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> PKKGGPLAHFA(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "country-sweden", "#PETER# User was watching add - waiting for server reward - reward came", base.weaponFeature.reloadCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, " leveled up to ", "Gold", base.weaponFeature.ammoCoef, true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "playerVisuals", "Yes_Clicked", base.weaponFeature.attackCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "minigun_shot", "offers", base.weaponFeature.clipSizeCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Application focus changed to {0} and have created AWS mobile analytics {1}", "Weapon_ID", base.weaponFeature.reloadCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "width", "Shots_Fired", base.weaponFeature.ammoCoef, true));
		return list;
	}
	...
	public virtual List<Tuple<string, float[]>> MJCMHPKKKBI(UpgradeSlot ACHJJKCIBCN)
	{
		...
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "vibrator", "ID_NOW", base.weaponFeature.clipSizeCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "elite", "ID_VISUALCOMPLETED", base.weaponFeature.reloadCoef));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "NULL WARCARD", " (#", base.weaponFeature.ammoCoef, true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_UNIT2UPGRADEABILITY_UNIT1BUY", "ID_OVERTIME", base.weaponFeature.attackCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "subscription", "menu-cards-bronzepack", base.weaponFeature.clipSizeCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_STAT_MOSTWARCARDSPLAYED", "D2", base.weaponFeature.reloadCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "\t\t", "id", base.weaponFeature.ammoCoef, true));
		return list;
	}
	...
	{
		List<Tuple<string, float[]>> list = new List<Tuple<string, float[]>>();
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "ID_STAT_MOSTWINS", "banana", base.weaponFeature.attackCoef, true));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "*****   Bootcamp 3/3 Ended   *****", "BS: Update Army Power", base.weaponFeature.clipSizeCoef));
		list.Add(MMPLMBONDIJ(ACHJJKCIBCN, "Lcom/google/android/gms/games/snapshot/Snapshots;", "Player connectionState {0} to player {1}", base.weaponFeature.reloadCoef, true));
