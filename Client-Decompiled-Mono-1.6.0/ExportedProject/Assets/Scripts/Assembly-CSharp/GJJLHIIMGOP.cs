...
public class GJJLHIIMGOP : HHFHFANGCEJ
{
	...
	private static void FOKGBDDBJFM()
	{
		...
		{
			GuiElementSingle<CardsAndPacksDialog>.instance.ILFCOPPIOME(CardsAndPacksDialog.LJCNLBMEENL.VALUE_PACK, true);
		}
		else
		{
			Debug.Log(" (#");
	...
	private static void DJECJGEAHPM()
	{
		if (!PlayerAnalytics.instance.data.IsPackBought(NGNPIOOAHEH.Starter))
		{
			GuiElementSingle<CardsAndPacksDialog>.instance.ONHPOAIKLAO(CardsAndPacksDialog.LJCNLBMEENL.VALUE_PACK, true);
		}
		else
		{
	...
	private static void MDCDELBOBBN()
	{
		...
		{
			GuiElementSingle<CardsAndPacksDialog>.instance.ILFCOPPIOME(CardsAndPacksDialog.LJCNLBMEENL.STARTER_PACK, true);
		}
		else
		{
