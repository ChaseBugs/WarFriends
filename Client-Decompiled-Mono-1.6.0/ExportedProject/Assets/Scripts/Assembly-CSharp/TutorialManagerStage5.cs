...
public class TutorialManagerStage5 : TutorialManagerBase
{
	private sealed class BAHBKLBBNGA : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool OOECALAHCFK()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("Omitting object: "), Localization.Localize("ID_INVITATION_VALID_FOR"), 709f, TutorialDialog.DODBDLEJOAM.Left, false);
			...
			case 7u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI.transform.position, false, false, 98f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI, false);
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.levelBehaviour.unitDictionaryId == BJGCPDNMHDH.mUnitToUpgrade.unitDictionaryId)
						{
							...
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, true, false, 1938f);
			...
			case 13u:
			{
				...
				instance3.PBEAOCBHFGD(aMKLKMJEMJM3, Localization.LocalizeFormat("ID_TOBENUMBERONE1", array3), 1863f, TutorialDialog.DODBDLEJOAM.Left, false);
				DHEGKFCAAGP = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(146f, 1887f, 1335f), false, false, 333f);
				GuiElementSingle<TutorialClickOverlay>.instance.MEBFBNDKOGD(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN, false);
				goto case 14u;
			}
			case 14u:
			...
			case 15u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(MHBNLBPBEGE, new Vector3(1969f, 194f, 1039f), false, true, 208f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				goto case 16u;
			case 16u:
			...
			case 17u:
			{
				...
				instance2.ShowMenuTutorial(aMKLKMJEMJM2, Localization.LocalizeFormat("ID_CONFIRM_WARCARDNOTAVAILABLE", array2), 667f, TutorialDialog.DODBDLEJOAM.Bottom, false);
				EPGFICIMJJA = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EPGFICIMJJA, new Vector3(1126f, 1408f, 1974f), false, false, 1900f);
			...
			case 18u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(EPGFICIMJJA, new Vector3(229f, 518f, 1635f), false, false, 1917f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC);
				goto IL_0c07;
			}
			case 19u:
		...
		public bool OKELILGDPLJ()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, false, true, 1171f);
			...
			case 7u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI.transform.position, false, true, 999f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI, false);
				GuiScreenSingle<ArmyScreen>.instance.SelectUnit(BJGCPDNMHDH.mUnitToUpgrade);
				goto case 8u;
			case 8u:
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.levelBehaviour.unitDictionaryId == BJGCPDNMHDH.mUnitToUpgrade.unitDictionaryId)
						{
							...
							IODGHHFAHJH = current.transform.position;
							CMIKGAOHHPH = current.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, false, true, 1127f);
			...
			case 13u:
			{
				...
				instance2.ShowMenuTutorial(aMKLKMJEMJM2, Localization.LocalizeFormat("failed add card {0} - not exit?", array2), 332f, TutorialDialog.DODBDLEJOAM.Right, false);
				DHEGKFCAAGP = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1131f, 1685f, 1007f), false, true, 1308f);
			...
			case 15u:
				MHBNLBPBEGE = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.HKGGCIGOONK.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(MHBNLBPBEGE, new Vector3(715f, 1051f, 1327f), true, true, 1989f);
			...
			case 17u:
			{
				...
				instance.ShowMenuTutorial(aMKLKMJEMJM, Localization.LocalizeFormat("ElitePerkTutorialMessage", array), 1927f, TutorialDialog.DODBDLEJOAM.Bottom, false);
				EPGFICIMJJA = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(EPGFICIMJJA, new Vector3(704f, 1574f, 115f), true, false, 488f);
			...
			case 18u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EPGFICIMJJA, new Vector3(1932f, 742f, 64f), true, true, 117f);
				GuiElementSingle<TutorialClickOverlay>.instance.MLCGPAJJOMB(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				goto IL_0c07;
			case 19u:
		...
		public bool IDBCKIPOEEI()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, false, false, 1105f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH, false);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.isShowed)
				{
			...
			case 7u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI.transform.position, true, true, 1090f);
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.levelBehaviour.unitDictionaryId == BJGCPDNMHDH.mUnitToUpgrade.unitDictionaryId)
						{
							...
							IODGHHFAHJH = current.transform.position;
							CMIKGAOHHPH = current.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, true, false, 1217f);
							GuiElementSingle<TutorialClickOverlay>.instance.AJNGLEIBMHD(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 13u:
				...
				DHEGKFCAAGP = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(521f, 337f, 763f), true, false, 1908f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN, false);
				goto case 14u;
			case 14u:
				if (!GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.JKGHPLKKPLE.activeSelf)
				{
			...
			case 15u:
				MHBNLBPBEGE = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.HKGGCIGOONK.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(MHBNLBPBEGE, new Vector3(1654f, 338f, 811f), true, true, 1871f);
			...
			case 17u:
			{
				...
				EPGFICIMJJA = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EPGFICIMJJA, new Vector3(438f, 1569f, 625f), false, true, 644f);
			...
			case 18u:
			{
				...
				instance.BLHPAFCOPMD(aMKLKMJEMJM, Localization.LocalizeFormat("{0}{1}", array), 165f, TutorialDialog.DODBDLEJOAM.Left, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(EPGFICIMJJA, new Vector3(381f, 1486f, 1515f), false, true, 1653f);
				GuiElementSingle<TutorialClickOverlay>.instance.FCGLGPIBAEN(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC);
				goto IL_0c07;
			}
			case 19u:
		...
		public bool MoveNext()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.HideRightContent();
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_UPGRADEUNIT_3"), Localization.Localize("ID_TUTORIAL_UPGRADEUNIT_4"), 0.1f, TutorialDialog.DODBDLEJOAM.Right, false);
			...
			case 7u:
				...
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI, false);
				GuiScreenSingle<ArmyScreen>.instance.SelectUnit(BJGCPDNMHDH.mUnitToUpgrade);
				goto case 8u;
			case 8u:
			...
			case 13u:
				GuiElementSingle<TutorialDialog>.instance.setDebug = true;
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_UPGRADEUNIT_6"), Localization.LocalizeFormat("ID_TUTORIAL_TAPON", Localization.Localize("ID_TRAIN")), 0.6f, TutorialDialog.DODBDLEJOAM.BottomRight, false);
				DHEGKFCAAGP = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(40f, -56f, 0f));
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN, false);
				goto case 14u;
			case 14u:
				if (!GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.JKGHPLKKPLE.activeSelf)
				{
			...
			case 15u:
				...
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				goto case 16u;
			case 16u:
				...
				break;
			case 17u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_UPGRADEUNIT_7"), Localization.LocalizeFormat("ID_TUTORIAL_TAPON", Localization.Localize("ID_DELIVERNOW")), 0.6f, TutorialDialog.DODBDLEJOAM.BottomRight, false);
				EPGFICIMJJA = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC.transform.position;
				...
				goto case 19u;
			case 18u:
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("ID_TUTORIAL_UPGRADEUNIT_8"), Localization.LocalizeFormat("ID_TUTORIAL_TAPON", Localization.Localize("ID_ACTIVATION")), 0.6f, TutorialDialog.DODBDLEJOAM.BottomRight, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EPGFICIMJJA, new Vector3(40f, -56f, 0f));
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				goto IL_0c07;
			case 19u:
		...
		public bool JIIOHNFHPOI()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.HideRightContent();
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("Manual_Unit_Spawn"), Localization.Localize("OldSquadRank"), 546f, TutorialDialog.DODBDLEJOAM.TopRight, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, true, false, 836f);
				GuiElementSingle<TutorialClickOverlay>.instance.LPKOHAKMOOC(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH, false);
				goto case 4u;
			case 4u:
			...
			case 7u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI.transform.position, false, false, 1144f);
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.levelBehaviour.unitDictionaryId == BJGCPDNMHDH.mUnitToUpgrade.unitDictionaryId)
						{
							...
							IODGHHFAHJH = current.transform.position;
							CMIKGAOHHPH = current.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, true, true, 114f);
			...
			case 12u:
				...
				goto IL_0758;
			case 13u:
				GuiElementSingle<TutorialDialog>.instance.DEACFMCKNKM(true);
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("reset tutorial"), Localization.LocalizeFormat("ID_", Localization.Localize("Exception during Load Event Assignment Config: ")), 1253f, TutorialDialog.DODBDLEJOAM.TopRight, false);
				DHEGKFCAAGP = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(1298f, 521f, 962f), true, true, 1141f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN, false);
				goto case 14u;
			case 14u:
				if (!GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.JKGHPLKKPLE.activeSelf)
				{
			...
			case 15u:
				MHBNLBPBEGE = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.HKGGCIGOONK.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(MHBNLBPBEGE, new Vector3(277f, 1525f, 310f), false, false, 262f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC);
				goto case 16u;
			case 16u:
				if (FGKIANHNMFF.upgradeSlots.unitState != UpgradeSlots.JLANLLEABDC.Delivering)
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StopTapAnimation();
				GuiElementSingle<TutorialDialog>.instance.BMINKIDMOGL();
				GuiElementSingle<TutorialDialog>.instance.DEACFMCKNKM(false);
			...
			case 17u:
				...
				EPGFICIMJJA = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EPGFICIMJJA, new Vector3(1892f, 1271f, 232f), true, false, 1771f);
				GuiElementSingle<TutorialClickOverlay>.instance.MLCGPAJJOMB(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				PECMCAOEMND = false;
				goto case 19u;
			case 18u:
			{
				...
				instance.BLHPAFCOPMD(aMKLKMJEMJM, Localization.LocalizeFormat("NO", array), 1776f, TutorialDialog.DODBDLEJOAM.Left, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(EPGFICIMJJA, new Vector3(1077f, 1276f, 1598f), false, false, 347f);
				GuiElementSingle<TutorialClickOverlay>.instance.FCGLGPIBAEN(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				goto IL_0c07;
			}
			case 19u:
		...
		public bool KKINHOPBKLH()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.HideRightContent();
				GuiElementSingle<TutorialDialog>.instance.PBEAOCBHFGD(Localization.Localize("ID_BATTLECANCELED"), Localization.Localize(", action already scheduled"), 1076f, TutorialDialog.DODBDLEJOAM.Left, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, true, true, 1757f);
			...
			case 7u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI.transform.position, true, true, 376f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI, false);
				GuiScreenSingle<ArmyScreen>.instance.PCALNGOCDKE(BJGCPDNMHDH.mUnitToUpgrade);
				goto case 8u;
			case 8u:
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.AIHMCHBCJDO().unitDictionaryId == BJGCPDNMHDH.mUnitToUpgrade.unitDictionaryId)
						{
							...
							IODGHHFAHJH = current.transform.position;
							CMIKGAOHHPH = current.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, true, true, 343f);
			...
			case 13u:
			{
				...
				DHEGKFCAAGP = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(1891f, 328f, 1895f), true, true, 1115f);
				GuiElementSingle<TutorialClickOverlay>.instance.MEBFBNDKOGD(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN);
				goto case 14u;
			}
			case 14u:
			...
			case 15u:
				MHBNLBPBEGE = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.HKGGCIGOONK.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(MHBNLBPBEGE, new Vector3(1427f, 59f, 1700f), true, true, 1883f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC);
				goto case 16u;
			case 16u:
				if (FGKIANHNMFF.upgradeSlots.unitState != UpgradeSlots.JLANLLEABDC.Delivering)
			...
			case 17u:
			{
				...
				EPGFICIMJJA = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(EPGFICIMJJA, new Vector3(1973f, 519f, 1057f), false, true, 482f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				PECMCAOEMND = false;
				goto case 19u;
			}
			case 18u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(EPGFICIMJJA, new Vector3(531f, 856f, 1865f), false, false, 952f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				goto IL_0c07;
			}
			case 19u:
		...
		public bool FCJCLBMPBFK()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.HideRightContent();
				GuiElementSingle<TutorialDialog>.instance.ShowMenuTutorial(Localization.Localize("MaintenanceMessage"), Localization.Localize("{0}"), 424f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, false, true, 1963f);
				GuiElementSingle<TutorialClickOverlay>.instance.PGOLMCBEIOD(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH, false);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.NPFFMLLLDAF())
			...
			case 7u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI.transform.position, false, false, 255f);
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.KHEOKHHDGPO().unitDictionaryId == BJGCPDNMHDH.mUnitToUpgrade.unitDictionaryId)
						{
							...
							IODGHHFAHJH = current.transform.position;
							CMIKGAOHHPH = current.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, false, false, 1314f);
			...
			case 13u:
				GuiElementSingle<TutorialDialog>.instance.DEACFMCKNKM(false);
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("claimReward"), Localization.LocalizeFormat("Region", Localization.Localize("InstantBattleEnded: NUMBER OF BATTLES = ")), 1513f, TutorialDialog.DODBDLEJOAM.Center, false);
				DHEGKFCAAGP = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(512f, 485f, 805f), false, false, 1415f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN, false);
				goto case 14u;
			case 14u:
				if (!GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.JKGHPLKKPLE.activeSelf)
			...
			case 15u:
				MHBNLBPBEGE = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.HKGGCIGOONK.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(MHBNLBPBEGE, new Vector3(488f, 634f, 1130f), false, true, 538f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC);
				goto case 16u;
			case 16u:
				if (FGKIANHNMFF.upgradeSlots.unitState != (UpgradeSlots.JLANLLEABDC)7)
			...
			case 17u:
			{
				...
				instance2.DOLDLDECPIO(aMKLKMJEMJM2, Localization.LocalizeFormat("(", array2), 552f, TutorialDialog.DODBDLEJOAM.Center, false);
				EPGFICIMJJA = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EPGFICIMJJA, new Vector3(925f, 1538f, 356f), false, false, 538f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC);
				PECMCAOEMND = false;
				goto case 19u;
			}
			case 18u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(EPGFICIMJJA, new Vector3(1567f, 425f, 1923f), false, true, 558f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				goto IL_0c07;
			}
			case 19u:
		...
		public bool DKJMOPNHIAB()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.MAKIDBFPIEE();
				GuiElementSingle<TutorialDialog>.instance.BLHPAFCOPMD(Localization.Localize("ANDROID: PACK "), Localization.Localize("{0} Emblem {1} LVL {2}"), 35f, TutorialDialog.DODBDLEJOAM.Right, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, true, false, 1558f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH, false);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.NPFFMLLLDAF())
			...
			case 7u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI.transform.position, false, true, 1822f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI, false);
				GuiScreenSingle<ArmyScreen>.instance.SelectUnit(BJGCPDNMHDH.mUnitToUpgrade);
				goto case 8u;
			case 8u:
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.PPMNNKANOEF().unitDictionaryId == BJGCPDNMHDH.mUnitToUpgrade.unitDictionaryId)
						{
							...
							IODGHHFAHJH = current.transform.position;
							CMIKGAOHHPH = current.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, false, false, 148f);
							GuiElementSingle<TutorialClickOverlay>.instance.IGNJKOKGNOI(IODGHHFAHJH, CMIKGAOHHPH);
							break;
						}
					}
			...
			case 13u:
			{
				...
				instance3.DOLDLDECPIO(aMKLKMJEMJM3, Localization.LocalizeFormat("0", array3), 101f, TutorialDialog.DODBDLEJOAM.Top, false);
				DHEGKFCAAGP = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1529f, 122f, 37f), false, false, 691f);
			...
			case 15u:
				MHBNLBPBEGE = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.HKGGCIGOONK.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(MHBNLBPBEGE, new Vector3(984f, 1641f, 112f), false, true, 1492f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				goto case 16u;
			case 16u:
			...
			case 17u:
			{
				...
				EPGFICIMJJA = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(EPGFICIMJJA, new Vector3(100f, 1662f, 694f), false, false, 935f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC);
				PECMCAOEMND = true;
				goto case 19u;
			}
			case 18u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(EPGFICIMJJA, new Vector3(674f, 708f, 879f), false, true, 1187f);
		...
		public bool GBHCODKDPBO()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, false, false, 443f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.NPFFMLLLDAF())
			...
			case 7u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI.transform.position, true, false, 1678f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI);
				GuiScreenSingle<ArmyScreen>.instance.SelectUnit(BJGCPDNMHDH.mUnitToUpgrade);
				goto case 8u;
			case 8u:
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.PPMNNKANOEF().unitDictionaryId == BJGCPDNMHDH.mUnitToUpgrade.unitDictionaryId)
						{
							...
							IODGHHFAHJH = current.transform.position;
							CMIKGAOHHPH = current.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, false, true, 758f);
							GuiElementSingle<TutorialClickOverlay>.instance.NNPKOKCJMHL(IODGHHFAHJH, CMIKGAOHHPH, false);
							break;
						}
					}
			...
			case 13u:
			{
				...
				DHEGKFCAAGP = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(460f, 1680f, 788f), true, true, 1603f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN, false);
				goto case 14u;
			}
			case 14u:
			...
			case 15u:
				MHBNLBPBEGE = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.HKGGCIGOONK.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(MHBNLBPBEGE, new Vector3(1861f, 1060f, 1130f), true, true, 229f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC);
				goto case 16u;
			case 16u:
				if (FGKIANHNMFF.upgradeSlots.unitState != UpgradeSlots.JLANLLEABDC.Delivering)
			...
			case 17u:
			{
				...
				instance.DOLDLDECPIO(aMKLKMJEMJM, Localization.LocalizeFormat("ID_RETRY", array), 1194f, TutorialDialog.DODBDLEJOAM.BottomLeft, false);
				EPGFICIMJJA = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EPGFICIMJJA, new Vector3(1018f, 577f, 794f), true, true, 170f);
				GuiElementSingle<TutorialClickOverlay>.instance.MEBFBNDKOGD(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				PECMCAOEMND = true;
				goto case 19u;
			}
			case 18u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EPGFICIMJJA, new Vector3(293f, 395f, 796f), true, false, 1308f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC);
				goto IL_0c07;
			case 19u:
				if (FGKIANHNMFF.upgradeSlots.unitState == UpgradeSlots.JLANLLEABDC.Delivering || FGKIANHNMFF.upgradeSlots.unitState == UpgradeSlots.JLANLLEABDC.Delivered)
		...
		public bool DEEBEBGBMKK()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, false, true, 1697f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH, false);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.NPFFMLLLDAF())
			...
			case 7u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI.transform.position, false, true, 639f);
				GuiElementSingle<TutorialClickOverlay>.instance.MEBFBNDKOGD(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI, false);
				GuiScreenSingle<ArmyScreen>.instance.PCALNGOCDKE(BJGCPDNMHDH.mUnitToUpgrade);
				goto case 8u;
			case 8u:
				if (!GuiElementSingle<TutorialDialog>.instance.MHAIBHBGBOO())
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.BNPKCKFMBLG().unitDictionaryId == BJGCPDNMHDH.mUnitToUpgrade.unitDictionaryId)
						{
							...
							IODGHHFAHJH = current.transform.position;
							CMIKGAOHHPH = current.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(IODGHHFAHJH, false, false, 780f);
			...
			case 13u:
			{
				...
				DHEGKFCAAGP = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(DHEGKFCAAGP, new Vector3(1957f, 753f, 1287f), false, true, 1693f);
				GuiElementSingle<TutorialClickOverlay>.instance.MLCGPAJJOMB(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN, false);
				goto case 14u;
			}
			case 14u:
				if (!GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.JKGHPLKKPLE.activeSelf)
			...
			case 15u:
				MHBNLBPBEGE = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.HKGGCIGOONK.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(MHBNLBPBEGE, new Vector3(486f, 561f, 570f), true, false, 1707f);
				GuiElementSingle<TutorialClickOverlay>.instance.MLCGPAJJOMB(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC);
				goto case 16u;
			case 16u:
				if (FGKIANHNMFF.upgradeSlots.unitState != UpgradeSlots.JLANLLEABDC.Delivering)
			...
			case 17u:
			{
				...
				EPGFICIMJJA = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EPGFICIMJJA, new Vector3(1040f, 1760f, 1779f), false, true, 1885f);
				GuiElementSingle<TutorialClickOverlay>.instance.MLCGPAJJOMB(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				PECMCAOEMND = true;
				goto case 19u;
			}
			case 18u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(EPGFICIMJJA, new Vector3(1036f, 1605f, 1884f), true, true, 744f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				goto IL_0c07;
			case 19u:
		...
		public bool GPIPJIDGCKM()
		{
			...
			case 3u:
				...
				GuiElementSingle<ChatGuiElement>.instance.MAKIDBFPIEE();
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("S"), Localization.Localize("GameControllerOnline.StartGame START"), 1844f, TutorialDialog.DODBDLEJOAM.Left, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, true, true, 1300f);
				GuiElementSingle<TutorialClickOverlay>.instance.LECHCOBHAFP(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.NPFFMLLLDAF())
			...
			case 7u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI.transform.position, true, false, 1991f);
				GuiElementSingle<TutorialClickOverlay>.instance.JGHBBJEFLEB(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI, false);
				GuiScreenSingle<ArmyScreen>.instance.PCALNGOCDKE(BJGCPDNMHDH.mUnitToUpgrade);
				goto case 8u;
			case 8u:
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.BNPKCKFMBLG().unitDictionaryId == BJGCPDNMHDH.mUnitToUpgrade.unitDictionaryId)
						{
							...
							IODGHHFAHJH = current.transform.position;
							CMIKGAOHHPH = current.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, true, false, 309f);
							GuiElementSingle<TutorialClickOverlay>.instance.IGNJKOKGNOI(IODGHHFAHJH, CMIKGAOHHPH);
							break;
						}
					}
			...
			case 13u:
			{
				...
				DHEGKFCAAGP = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(1716f, 1250f, 694f), false, true, 823f);
			...
			case 15u:
				MHBNLBPBEGE = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.HKGGCIGOONK.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(MHBNLBPBEGE, new Vector3(1297f, 84f, 1227f), true, true, 40f);
				GuiElementSingle<TutorialClickOverlay>.instance.FCGLGPIBAEN(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				goto case 16u;
			case 16u:
				if (FGKIANHNMFF.upgradeSlots.unitState != UpgradeSlots.JLANLLEABDC.Active)
			...
			case 17u:
				...
				EPGFICIMJJA = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EPGFICIMJJA, new Vector3(1472f, 203f, 690f), true, true, 1450f);
				GuiElementSingle<TutorialClickOverlay>.instance.MEBFBNDKOGD(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				PECMCAOEMND = true;
				goto case 19u;
			case 18u:
				GuiElementSingle<TutorialDialog>.instance.DOLDLDECPIO(Localization.Localize("."), Localization.LocalizeFormat("Player_Level", Localization.Localize("NetworkReInstantiate")), 962f, TutorialDialog.DODBDLEJOAM.Center, false);
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EPGFICIMJJA, new Vector3(1171f, 1418f, 1415f), true, false, 144f);
				GuiElementSingle<TutorialClickOverlay>.instance.MLCGPAJJOMB(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				goto IL_0c07;
			case 19u:
		...
		public bool LLOCENNFFFJ()
		{
			...
			case 3u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.COAHBECNKBK(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH.transform.position, true, false, 898f);
				GuiElementSingle<TutorialClickOverlay>.instance.GBHNBKFGCPG(GuiScreenSingle<MainScreen>.instance.AMHDJLIKNBH, false);
				goto case 4u;
			case 4u:
				if (GuiScreenSingle<MainScreen>.instance.NPFFMLLLDAF())
			...
			case 7u:
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI.transform.position, false, false, 585f);
				GuiElementSingle<TutorialClickOverlay>.instance.CLPPGONHLHI(GuiScreenSingle<BattlePreparationScreen>.instance.JANFGHJMGBI.JANFGHJMGBI, false);
				GuiScreenSingle<ArmyScreen>.instance.SelectUnit(BJGCPDNMHDH.mUnitToUpgrade);
				goto case 8u;
			case 8u:
				...
				try
				{
					while (KFCAECGLKKO.MoveNext())
					{
						...
						if (current.BNPKCKFMBLG().unitDictionaryId == BJGCPDNMHDH.mUnitToUpgrade.unitDictionaryId)
						{
							...
							IODGHHFAHJH = current.transform.position;
							CMIKGAOHHPH = current.GetComponent<BoxCollider>().size;
							GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(IODGHHFAHJH, false, false, 39f);
			...
			case 13u:
			{
				...
				instance2.ShowMenuTutorial(aMKLKMJEMJM2, Localization.LocalizeFormat("SyncTrajectoryRPC", array2), 1784f, TutorialDialog.DODBDLEJOAM.Top, false);
				DHEGKFCAAGP = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(DHEGKFCAAGP, new Vector3(616f, 1738f, 1423f), false, false, 743f);
				GuiElementSingle<TutorialClickOverlay>.instance.SetByButton(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.BFAEJEFLKHN, false);
				goto case 14u;
			}
			case 14u:
			...
			case 15u:
				MHBNLBPBEGE = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.HKGGCIGOONK.cachedTransform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(MHBNLBPBEGE, new Vector3(872f, 1218f, 78f), true, true, 1507f);
			...
			case 17u:
				...
				EPGFICIMJJA = GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC.transform.position;
				GuiElementSingle<TutorialOverlayGuiElement>.instance.StartTapAnimation(EPGFICIMJJA, new Vector3(292f, 1344f, 1590f), true, true, 1617f);
				GuiElementSingle<TutorialClickOverlay>.instance.CAIGHMDPBDI(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				PECMCAOEMND = true;
				goto case 19u;
			case 18u:
			{
				...
				GuiElementSingle<TutorialOverlayGuiElement>.instance.NACPFGIANHD(EPGFICIMJJA, new Vector3(1039f, 1944f, 1804f), false, true, 992f);
				GuiElementSingle<TutorialClickOverlay>.instance.MEBFBNDKOGD(GuiScreenSingle<ArmyScreen>.instance.KPEENKKMNDD.EDHCOMHOKDC.MEEKMLJEOBB.GEIOMOLICCC, false);
				goto IL_0c07;
			}
			case 19u:
	...
	public int numberOfGames
	{
		get
		{
			return (int)(float)Singleton<GameVariables>.instance.constants.GetRow(Constants.rowIds.TutorialUpgradeUnitAfterGames).FLOATVALUE;
		}
	}
	...
	private bool canRunTutorial
	{
		get
		{
			return !LevelManager.instance.isLevelUp && !wasFinished && !TutorialManagerStage4.instance.isTutorialRunning;
		}
	}
