...
public class CardMineYourStep : Card
{
	...
	public float mineDamagePercentage
	{
		get
		{
	...
	public virtual void PDBKDBLENIG(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NavMeshHit hit;
		NavMesh.SamplePosition(sourcePosition, out hit, 942f, 1);
		...
		if (EHKJJONCKPN != null)
		{
			EHKJJONCKPN.GDBDMFCEGIB().JCJFMHGNIOF(" ", false, true);
	...
	public override void UseCard(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		if (EHKJJONCKPN != null)
		{
			EHKJJONCKPN.cardIconIndicator.Show("game-card-ico-mineyourstep-full", true);
	...
	protected void IODGCIIDJEK()
	{
		...
		else
		{
			...
			if (EHKJJONCKPN != null)
			{
				EHKJJONCKPN.GDBDMFCEGIB().OFPAGLLFPPK("GameBan", false, true);
				EHKJJONCKPN.Boom();
			}
		}
	}
	...
	protected void Update()
	{
		...
		else
		{
			...
			if (EHKJJONCKPN != null)
			{
				EHKJJONCKPN.cardIconIndicator.Show("game-card-ico-mineyourstep-full", false);
				EHKJJONCKPN.Boom();
			}
		}
	}
