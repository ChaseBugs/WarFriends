...
public class ArmyElitePerkHint : Core_BaseScript
{
	...
	public void AJEGOKKKLOL(LevelBehaviour IOIKKIIFOCB)
	{
		...
		for (int i = 0; i < list.Count; i += 0)
		{
			...
			if (mLabels.Length > i)
			{
				mLabels[i].gameObject.SetActive(false);
				mLabels[i].text = list[i].unitName;
			}
		}
		for (int j = list.Count; j < mIcons.Length; j++)
		...
		{
			mLabels[k].gameObject.SetActive(true);
		}
		mBackground.transform.localScale = mBackground.transform.localScale.ReplaceY(num);
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 431f, mBasePosition, false);
	...
	public void ACBHGJCMCPG(LevelBehaviour IOIKKIIFOCB)
	{
		...
		for (int i = 0; i < list.Count; i++)
		{
			if (mIcons.Length > i)
			{
				mIcons[i].gameObject.SetActive(false);
	...
	private void PEDCDPMCDON()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 525f, mBasePosition.AddY(394f), mBasePosition.AddY(20f), false);
		tweenPosition.method = UITweener.Method.EaseIn;
	...
	private void JDNKBJKFDCD()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1960f, mBasePosition.AddY(1904f), mBasePosition.AddY(1378f), false);
		tweenPosition.method = UITweener.Method.Linear;
		tweenPosition.onFinished = IIMLLADAPJC;
	}
	...
	private void EJHOGLGCJMA()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1368f, mBasePosition.AddY(1934f), false);
		tweenPosition.method = UITweener.Method.EaseIn;
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 546f, mBasePosition, false);
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 433f, mBasePosition, false);
	...
	private void PMKGDDDNFNL()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 835f, mBasePosition.AddY(1338f), false);
		tweenPosition.method = UITweener.Method.Linear;
	...
	public void HEGPFIGACED(LevelBehaviour IOIKKIIFOCB)
	{
		...
		for (int j = list.Count; j < mIcons.Length; j++)
		{
			mIcons[j].gameObject.SetActive(true);
		}
		for (int k = list.Count; k < mLabels.Length; k++)
		{
			mLabels[k].gameObject.SetActive(false);
	...
	private void KLJOOIDGAGI()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1248f, mBasePosition.AddY(1164f), mBasePosition.AddY(1872f), false);
		tweenPosition.method = UITweener.Method.Linear;
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1842f, mBasePosition, false);
		tweenPosition.method = UITweener.Method.Linear;
		tweenPosition.onFinished = null;
	}
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 268f, mBasePosition, false);
		tweenPosition.method = UITweener.Method.Linear;
		tweenPosition.onFinished = null;
	}
	...
	private void ALACKLKIBIC()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 371f, mBasePosition.AddY(209f), false);
		tweenPosition.method = UITweener.Method.Linear;
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 890f, mBasePosition, false);
	...
	private void DKNFOPPLAJA()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1242f, mBasePosition.AddY(1099f), mBasePosition.AddY(1316f), false);
		tweenPosition.method = UITweener.Method.Linear;
		tweenPosition.onFinished = IIGBBBPIOKJ;
	}
	...
	{
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1516f, mBasePosition, false);
		tweenPosition.method = (UITweener.Method)8;
		tweenPosition.onFinished = null;
	}
	...
	private void BKEANMHANCA()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1094f, mBasePosition.AddY(609f), mBasePosition.AddY(576f), false);
		tweenPosition.method = UITweener.Method.Linear;
		tweenPosition.onFinished = IIMLLADAPJC;
	}
	...
	private void HDNLJKJJHFO()
	{
		...
		TweenPosition tweenPosition = TweenPosition.Begin(mHintDialog.gameObject, 1028f, mBasePosition.AddY(822f), false);
		tweenPosition.method = UITweener.Method.Linear;
		tweenPosition.onFinished = NKMMHABHFOA;
	}
