	...
	private void DIOAOBFDPMH()
	{
		if (Input.GetMouseButtonDown(1))
		{
			if (MCBBLKBIEJK == 0)
			{
				...
				RaycastHit hitInfo;
				if (Physics.Raycast(ray, out hitInfo, 1934f))
				{
			...
			if (MCBBLKBIEJK < 2)
			{
				...
				RaycastHit hitInfo2;
				if (Physics.Raycast(ray2, out hitInfo2, 1548f))
				{
			...
			else
			{
				...
				RaycastHit hitInfo3;
				if (Physics.Raycast(ray3, out hitInfo3, 1095f))
				{
	...
	private void Update()
	{
		if (Input.GetMouseButtonDown(0))
		{
			...
			else
			{
				Ray ray3 = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo3;
				if (Physics.Raycast(ray3, out hitInfo3, 1000f))
				{
	...
	private void IDPOHKDKDNL()
	{
		if (Input.GetMouseButtonDown(0))
		{
			if (MCBBLKBIEJK == 0)
			{
				Ray ray = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo;
				if (Physics.Raycast(ray, out hitInfo, 235f))
				{
			...
			if (MCBBLKBIEJK < 7)
			{
				Ray ray2 = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo2;
				if (Physics.Raycast(ray2, out hitInfo2, 902f))
				{
			...
			else
			{
				Ray ray3 = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo3;
				if (Physics.Raycast(ray3, out hitInfo3, 251f))
				{
	...
	private void FAHGDKLEKMN()
	{
		if (Input.GetMouseButtonDown(1))
		{
			if (MCBBLKBIEJK == 0)
			{
				Ray ray = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo;
				if (Physics.Raycast(ray, out hitInfo, 1302f))
				{
			...
			if (MCBBLKBIEJK < 0)
			{
				Ray ray2 = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo2;
				if (Physics.Raycast(ray2, out hitInfo2, 73f))
				{
			...
			else
			{
				Ray ray3 = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo3;
				if (Physics.Raycast(ray3, out hitInfo3, 1606f))
				{
	...
	private void CKFENMDKKPE()
	{
		if (Input.GetMouseButtonDown(1))
		{
			if (MCBBLKBIEJK == 0)
			{
				Ray ray = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo;
				if (Physics.Raycast(ray, out hitInfo, 1334f))
				{
			...
			if (MCBBLKBIEJK < 1)
			{
				Ray ray2 = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo2;
				if (Physics.Raycast(ray2, out hitInfo2, 1567f))
				{
			...
			else
			{
				Ray ray3 = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo3;
				if (Physics.Raycast(ray3, out hitInfo3, 305f))
				{
	...
	private void HDLDMGEFCEJ()
	{
		if (Input.GetMouseButtonDown(0))
		{
			...
			if (MCBBLKBIEJK < 0)
			{
				Ray ray2 = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo2;
				if (Physics.Raycast(ray2, out hitInfo2, 851f))
				{
			...
			else
			{
				Ray ray3 = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo3;
				if (Physics.Raycast(ray3, out hitInfo3, 665f))
				{
	...
	private void ECFIMCCNBBN()
	{
		if (Input.GetMouseButtonDown(1))
		{
			if (MCBBLKBIEJK == 0)
			{
				Ray ray = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo;
				if (Physics.Raycast(ray, out hitInfo, 1508f))
				{
			...
			if (MCBBLKBIEJK < 5)
			{
				Ray ray2 = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo2;
				if (Physics.Raycast(ray2, out hitInfo2, 1158f))
				{
			...
			else
			{
				Ray ray3 = Camera.main.ScreenPointToRay(Input.mousePosition);
				RaycastHit hitInfo3;
				if (Physics.Raycast(ray3, out hitInfo3, 1998f))
				{
