...
public class CardCriticalInsurance : Card
{
	...
	public virtual void ODIBFAFGJBP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("Sessions", false, true);
	...
	public virtual void BCBFENPIIMP()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1476f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("!!!ROTATED!!! ", false, true);
		}
	}
	...
	public virtual void JGNBFCJFAHM(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.NNPILDOKNJO("Invite was already send, ignoring click.", true, true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void MLOJPAEBLBL(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.EOEDEJKJKMN("Message", true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void EOELDFKKJLE(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("ID_BRONZEPACK", true, true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void IDLKDDEEALI(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.LDGKPCDJPLA("weaponDelivery", true, true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void NGCHHKPHGJA()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 247f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.EOEDEJKJKMN("arenaLeaderboard", true, true);
		}
	}
	...
	public virtual void GAGEHEGFGOA(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("Card_3_Played", false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void IGJJHCKMDBK(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("NO", false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void JLBEBADOINI()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1632f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.JCJFMHGNIOF("SquadWarsId", true);
		}
	}
	...
	public virtual void ANNHOLJMEEH()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1086f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH("Lcom/google/android/gms/games/leaderboard/Leaderboards;", false);
		}
	}
	...
	public virtual void DMHDDHILDJK()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1135f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.JCJFMHGNIOF("GetSkuInfo succeeded but productId ", false);
		}
	}
	...
	public virtual void JIHHEBGMCBB(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("为下载关键的游戏数据，《战争之友》需要您的媒体存储信息的访问权限。请在随后出现的权限对话框中选择接受，我们绝不会将此权限用于任何其他目的。", true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void HHKFLIABFCA()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 943f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH("ID_SILVERARENACROWN", true, true);
		}
	}
	...
	public virtual void DGCEELPOEHP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.LJLDJOHAAMC("Custom int = ", false, true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void ACIOLBGILBP(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.NNPILDOKNJO("#Google play# gpgs logout during tutorial - ignore", true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void CPALNIACCKB()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 377f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("()Landroid/os/Looper;", true);
		}
	}
	...
	public virtual void EKBAEHKJCHL()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1596f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.LJLDJOHAAMC("Connection_Fail", false, true);
		}
	}
	...
	public virtual void JCHICJBOCFA(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.LJLDJOHAAMC("ID_CONFIRM_ERROR", false, true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void IJANEJIFIHG()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 524f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("ID_WARNING_DUPLICATEDVIDEOFEED", false, true);
		}
	}
	...
	public virtual void AGMKIMGHPAL(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.BIIHCAEKCOD("reloadTime", true, true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void IKKEFBECFOD()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1674f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.Show("Gold", true, true);
		}
	}
	...
	public virtual void JONIGCEPKLO(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.JCJFMHGNIOF("menu-everyplay-ico", true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void LOPOCGLOHLH(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH("ID_NOW", false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void JBNMBMOJPAK()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 728f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.BBJADAJPJHH("BotArmyPower", false);
		}
	}
	...
	public virtual void FFONCENFPMH()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 989f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH("MyArmyPower", false);
		}
	}
	...
	public virtual void EBOJNIKJKPG()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1859f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("C0", true, true);
		}
	}
	...
	public virtual void PDBKDBLENIG(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.NNPILDOKNJO("SIM", false, true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void LEJJDMBMPKO()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1126f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.NNPILDOKNJO("ID_CONFIRM_NOSQUADACTIONS_TITLE", false, true);
		}
	}
	...
	public virtual void FHCCGCDJALN()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 500f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("{0} {1}", false, true);
		}
	}
	...
	public virtual void JGNCOJLCGFH(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.GKAOMCGCDGE("withAttribute4", false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void POLFFIJKMNA(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.FJILILFMPIF("GLM: RegisterOrLogin -  2", true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void FPBHDCLGABD()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 960f;
			NNDMKIACBBM = true;
			MBIAKMPDOPG.cardIconIndicator.JCJFMHGNIOF("ID_ARENARULES_SLOWERRELOADING", true);
		}
	}
	...
	public virtual void JCIPDJMFFDB()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1492f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("SquadWarsId", true);
		}
	}
	...
	public virtual void HKFPNJECIJN()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 583f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.Show("ID_TUTORIAL_GRENADE_DOWN", false, true);
		}
	}
	...
	public virtual void DBAPEPJHJMH(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("fire", false, true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void MHKIELKLIHD(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.GCLFBCIKNAH("ID_GUI_EQUIP", true, true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void LGGHLEDKKAC()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 1878f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("Dialog Manager: PN dialog does not need to be shown BUT NEEDS TO BE SENT, current players device token = ", true, true);
		}
	}
	...
	public override void UseCard(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = true;
		MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-criticalinsurance", true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public override void DisconnectEvents()
	{
		if (NNDMKIACBBM)
		{
			...
			BHABHIDDBLH = 0f;
			NNDMKIACBBM = false;
			MBIAKMPDOPG.cardIconIndicator.Show("game-card-ico-criticalinsurance", false);
		}
	}
	...
	public virtual void DPELJDNCGHG(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.DLNGGGOEDLL("myLobby", false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void JPCPJELCHDA(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.OFPAGLLFPPK("AU", false, true);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
	...
	public virtual void GDEHLDBGNHB(GDCLLGDCODD MNBIOCOAJHK, GHPGNELIDBM CIOPAKLHFIL)
	{
		...
		BHABHIDDBLH = NMBINECHMGO;
		NNDMKIACBBM = false;
		MBIAKMPDOPG.cardIconIndicator.GGHDIAFACAH("Action ", false);
		MNBIOCOAJHK.CardWasUsed(this, CIOPAKLHFIL);
	}
