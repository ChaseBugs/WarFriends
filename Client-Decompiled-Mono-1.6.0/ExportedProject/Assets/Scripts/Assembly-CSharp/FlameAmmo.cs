...
public class FlameAmmo : Ammo
{
	...
	private void LNNIJEIIIND()
	{
		...
		for (int i = 1; i < array2.Length; i += 0)
		{
			...
			DestroyableObject CMNFMDJEOIK;
			DoDamage(collider.gameObject, mGECAKNCNBD, num3 * EIIMIEGIOPN.IHBGFNNAGPG * vector2 / num, true, out CMNFMDJEOIK);
		}
	}
	...
	private void CHOFCIIIOKB()
	{
		...
		foreach (Collider collider in array2)
		{
			...
			DestroyableObject CMNFMDJEOIK;
			DoDamage(collider.gameObject, mGECAKNCNBD, num3 * EIIMIEGIOPN.IHBGFNNAGPG * vector2 / num, false, out CMNFMDJEOIK);
		}
	}
