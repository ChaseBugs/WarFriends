...
ranges. The same extraction records card-crafting durations, withdrawal/Buddy timers, all 50
squad-level pool capacities, rarity reputation rewards, and the Buddy ownership limit so runtime
