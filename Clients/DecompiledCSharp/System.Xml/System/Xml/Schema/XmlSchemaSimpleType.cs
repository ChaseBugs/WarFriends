...
public class XmlSchemaSimpleType : XmlSchemaType
{
	...
	internal override int Validate(ValidationEventHandler h, XmlSchema schema)
	{
		...
		if (Content is XmlSchemaSimpleTypeList { ValidatedListItemType: XmlSchemaSimpleType validatedListItemType } && validatedListItemType.Content is XmlSchemaSimpleTypeList)
		{
