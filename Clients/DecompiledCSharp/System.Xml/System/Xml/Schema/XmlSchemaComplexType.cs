	...
	internal override int Compile(ValidationEventHandler h, XmlSchema schema)
	{
		...
		if (contentModel != null)
		{
			...
			if (ContentModel is XmlSchemaSimpleContent xmlSchemaSimpleContent)
			{
				...
				if (xmlSchemaSimpleContentExtension == null && xmlSchemaSimpleContent.Content is XmlSchemaSimpleContentRestriction { BaseType: not null } xmlSchemaSimpleContentRestriction)
				{
