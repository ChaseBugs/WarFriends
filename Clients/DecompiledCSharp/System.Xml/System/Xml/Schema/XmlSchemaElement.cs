...
public class XmlSchemaElement : XmlSchemaParticle
{
	...
	internal override int Validate(ValidationEventHandler h, XmlSchema schema)
	{
		...
		if (SubstitutionGroup != XmlQualifiedName.Empty)
		{
			...
			if (xmlSchemaElement2 != null)
			{
				...
				{
					if ((xmlSchemaElement2.FinalResolved & XmlSchemaDerivationMethod.Substitution) != XmlSchemaDerivationMethod.Empty)
					{
						error(h, "Substituted element blocks substitution.");
					}
					if (xmlSchemaType2 != null && (xmlSchemaElement2.FinalResolved & xmlSchemaType2.DerivedBy) != XmlSchemaDerivationMethod.Empty)
					{
	...
	{
		if (ElementType is XmlSchemaComplexType { Particle: not null } xmlSchemaComplexType)
		{
