...
public sealed class ProxyElement : ConfigurationElement
{
	...
	public AutoDetectValues AutoDetect
	{
		get
		{
			return (AutoDetectValues)(int)base[autoDetectProp];
		}
		set
		{
	...
	public BypassOnLocalValues BypassOnLocal
	{
		get
		{
			return (BypassOnLocalValues)(int)base[bypassOnLocalProp];
		}
		set
		{
	...
	public UseSystemDefaultValues UseSystemDefault
	{
		get
		{
			return (UseSystemDefaultValues)(int)base[useSystemDefaultProp];
		}
		set
		{
