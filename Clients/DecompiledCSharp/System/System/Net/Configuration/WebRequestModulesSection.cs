...
public sealed class WebRequestModulesSection : ConfigurationSection
{
	...
	{
		webRequestModulesProp = new ConfigurationProperty(string.Empty, typeof(WebRequestModuleElementCollection), null, ConfigurationPropertyOptions.IsDefaultCollection);
