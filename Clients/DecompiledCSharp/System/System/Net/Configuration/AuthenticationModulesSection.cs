...
public sealed class AuthenticationModulesSection : ConfigurationSection
{
	...
	{
		authenticationModulesProp = new ConfigurationProperty(string.Empty, typeof(AuthenticationModuleElementCollection), null, ConfigurationPropertyOptions.IsDefaultCollection);
