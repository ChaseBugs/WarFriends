...
internal class Win32IPGlobalProperties : IPGlobalProperties
{
	...
	private class Win32_MIB_TCPROW
	{
		...
		public TcpConnectionInformation TcpInfo => new System.Net.NetworkInformation.TcpConnectionInformationImpl(LocalEndPoint, RemoteEndPoint, State);
	}
	...
	public override string DhcpScopeName => System.Net.NetworkInformation.Win32_FIXED_INFO.Instance.ScopeId;

	public override string DomainName => System.Net.NetworkInformation.Win32_FIXED_INFO.Instance.DomainName;

	public override string HostName => System.Net.NetworkInformation.Win32_FIXED_INFO.Instance.HostName;

	public override bool IsWinsProxy => System.Net.NetworkInformation.Win32_FIXED_INFO.Instance.EnableProxy != 0;

	public override NetBiosNodeType NodeType => System.Net.NetworkInformation.Win32_FIXED_INFO.Instance.NodeType;
