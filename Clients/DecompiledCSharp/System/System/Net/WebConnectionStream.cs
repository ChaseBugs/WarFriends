...
internal class WebConnectionStream : Stream
{
	...
	internal System.Net.WebConnection Connection => cnc;
	...
	{
		if (!(r is System.Net.WebAsyncResult { AsyncWriteAll: not false }))
		{
			if (r.AsyncState != null)
			{
				System.Net.WebAsyncResult webAsyncResult2 = (System.Net.WebAsyncResult)r.AsyncState;
	...
	public override void EndWrite(IAsyncResult r)
	{
		...
		if (!(r is System.Net.WebAsyncResult webAsyncResult))
		{
