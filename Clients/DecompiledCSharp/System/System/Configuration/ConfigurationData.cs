...
{
	private System.Configuration.ConfigurationData parent;
	...
	public ConfigurationData(System.Configuration.ConfigurationData parent)
	{
	...
	private object GetHandler(string sectionName)
	{
		lock (factories)
		{
			...
			obj = CreateNewHandler(sectionName, (System.Configuration.SectionData)obj);
			factories[sectionName] = obj;
			return obj;
		}
	}

	private object CreateNewHandler(string sectionName, System.Configuration.SectionData section)
	{
	...
	public object GetConfig(string sectionName)
	{
		...
		lock (this)
		{
			...
			FileCache[sectionName] = ((obj != null) ? obj : emptyMark);
			return obj;
		}
	}
	...
	private void ReadSection(XmlTextReader reader, string sectionName)
	{
		...
		string text5 = null;
		bool flag2 = true;
		System.Configuration.AllowDefinition allowDefinition = System.Configuration.AllowDefinition.Everywhere;
		while (reader.MoveToNextAttribute())
		{
			...
			case "allowDefinition":
				...
				try
				{
					allowDefinition = (System.Configuration.AllowDefinition)(int)Enum.Parse(typeof(System.Configuration.AllowDefinition), text4);
				}
				catch
				{
					ThrowException("Invalid attribute value", reader);
		...
		System.Configuration.SectionData sectionData = new System.Configuration.SectionData(text, text2, flag2, allowDefinition, flag);
