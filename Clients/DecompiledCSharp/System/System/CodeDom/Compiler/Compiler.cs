...
internal sealed class Compiler : ConfigurationElement
{
	...
	public System.CodeDom.Compiler.CompilerProviderOptionsCollection ProviderOptions
	{
		get
		{
			return (System.CodeDom.Compiler.CompilerProviderOptionsCollection)base[providerOptionsProp];
		}
		internal set
		{
	...
	static Compiler()
	{
		compilerOptionsProp = new ConfigurationProperty("compilerOptions", typeof(string), string.Empty);
		extensionProp = new ConfigurationProperty("extension", typeof(string), string.Empty);
		languageProp = new ConfigurationProperty("language", typeof(string), string.Empty, ConfigurationPropertyOptions.IsRequired | ConfigurationPropertyOptions.IsKey);
		typeProp = new ConfigurationProperty("type", typeof(string), string.Empty, ConfigurationPropertyOptions.IsRequired);
		...
		providerOptionsProp = new ConfigurationProperty(string.Empty, typeof(System.CodeDom.Compiler.CompilerProviderOptionsCollection), null, null, null, ConfigurationPropertyOptions.IsDefaultCollection);
