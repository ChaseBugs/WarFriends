...
internal class TraceImpl
{
	...
	private static void InitOnce()
	{
		...
		lock (initLock)
		{
			if (listeners == null)
			{
				IDictionary settings = System.Diagnostics.DiagnosticsConfiguration.Settings;
				System.Diagnostics.TraceImplSettings traceImplSettings = (System.Diagnostics.TraceImplSettings)settings[".__TraceInfoSettingsKey__."];
