...
public sealed class EventLogEntry : Component, ISerializable
{
	...
	public bool Equals(EventLogEntry otherEntry)
	{
		...
		return otherEntry.Category == category && otherEntry.CategoryNumber == categoryNumber && otherEntry.Data.Equals(data) && otherEntry.EntryType == entryType && otherEntry.EventID == eventID && otherEntry.Index == index && otherEntry.MachineName == machineName && otherEntry.Message == message && otherEntry.ReplacementStrings.Equals(replacementStrings) && otherEntry.Source == source && otherEntry.TimeGenerated.Equals(timeGenerated) && otherEntry.TimeWritten.Equals(timeWritten) && otherEntry.UserName == userName;
	}
}
