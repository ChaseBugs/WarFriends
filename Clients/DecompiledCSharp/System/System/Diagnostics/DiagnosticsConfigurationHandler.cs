...
public class DiagnosticsConfigurationHandler : IConfigurationSectionHandler
{
	...
	private System.Diagnostics.TraceImplSettings configValues;
	...
	public virtual object Create(object parent, object configContext, XmlNode section)
	{
		...
		{
			configValues = (System.Diagnostics.TraceImplSettings)dictionary[".__TraceInfoSettingsKey__."];
		}
		else
		{
			dictionary.Add(".__TraceInfoSettingsKey__.", configValues = new System.Diagnostics.TraceImplSettings());
		}
	...
	private void AddTraceSource(IDictionary d, Hashtable sources, XmlNode node)
	{
		...
		foreach (XmlAttribute attribute in node.Attributes)
		{
			...
			case "name":
				...
				break;
			case "switchValue":
				levels = (SourceLevels)(int)Enum.Parse(typeof(SourceLevels), attribute.Value);
				break;
			default:
		...
		System.Diagnostics.TraceSourceInfo traceSourceInfo = new System.Diagnostics.TraceSourceInfo(text, levels, configValues);
	...
	private void AddTraceListener(IDictionary d, XmlNode child, XmlAttributeCollection attributes, TraceListenerCollection listeners)
	{
		...
		if (text == null)
		{
			...
			listeners.Add(traceListener, configValues);
			return;
		}
		...
		if (attribute3 != null)
		{
			...
			try
			{
				traceOutputOptions = (TraceOptions)(int)Enum.Parse(typeof(TraceOptions), attribute3);
			}
		...
		listeners.Add(traceListener2, configValues);
	}
