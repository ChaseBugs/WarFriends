...
internal sealed class HTTPConnection : ConnectionBase
{
	...
	private void Connect()
	{
		...
		if (flag)
		{
			...
			{
				SslStream sslStream = new SslStream(Client.GetStream(), leaveStreamOpen: false, (object sender, X509Certificate cert, X509Chain chain, SslPolicyErrors errors) => base.CurrentRequest.CallCustomCertificationValidator(cert, chain));
