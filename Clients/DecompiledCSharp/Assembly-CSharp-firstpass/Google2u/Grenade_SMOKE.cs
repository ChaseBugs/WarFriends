...
public class Grenade_SMOKE : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Grenade_SMOKERow> Rows = new List<Grenade_SMOKERow>();
	...
	{
		Rows.Add(new Grenade_SMOKERow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public Grenade_SMOKERow GetRow(rowIds in_RowID)
	{
		Grenade_SMOKERow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Grenade_SMOKERow GetRow(string in_RowString)
	{
		Grenade_SMOKERow result = null;
