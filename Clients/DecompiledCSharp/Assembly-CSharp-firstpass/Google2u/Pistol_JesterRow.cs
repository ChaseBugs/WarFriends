...
[Serializable]
public class Pistol_JesterRow : IGoogle2uRow
{
	...
	public Pistol_JesterRow()
	{
	}

	public Pistol_JesterRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
	{
