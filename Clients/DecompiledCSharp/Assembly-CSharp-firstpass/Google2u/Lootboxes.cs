...
public class Lootboxes : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		lootboxes1,
	...
	public string[] rowNames = new string[6] { "lootboxes1", "lootboxes2", "lootboxes3", "lootboxes4", "lootboxes5", "lootboxes6" };
	...
	public List<LootboxesRow> Rows = new List<LootboxesRow>();
	...
	{
		Rows.Add(new LootboxesRow(input[0], input[1], input[2], input[3]));
	}
	...
	public LootboxesRow GetRow(rowIds in_RowID)
	{
		LootboxesRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public LootboxesRow GetRow(string in_RowString)
	{
		LootboxesRow result = null;
