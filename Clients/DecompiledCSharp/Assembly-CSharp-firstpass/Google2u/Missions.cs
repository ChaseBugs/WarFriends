...
public class Missions : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ID_1,
	...
	public string[] rowNames = new string[75]
	{
	...
	public List<MissionsRow> Rows = new List<MissionsRow>();

	public override bool haveDictionary => true;

	public override int getColumnCount => 21;
	...
	{
		Rows.Add(new MissionsRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15], input[16], input[17], input[18], input[19], input[20], input[21]));
	}
