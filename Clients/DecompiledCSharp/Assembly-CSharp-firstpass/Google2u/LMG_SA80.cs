...
public class LMG_SA80 : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<LMG_SA80Row> Rows = new List<LMG_SA80Row>();
	...
	{
		Rows.Add(new LMG_SA80Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public LMG_SA80Row GetRow(rowIds in_RowID)
	{
		LMG_SA80Row result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public LMG_SA80Row GetRow(string in_RowString)
	{
		LMG_SA80Row result = null;
