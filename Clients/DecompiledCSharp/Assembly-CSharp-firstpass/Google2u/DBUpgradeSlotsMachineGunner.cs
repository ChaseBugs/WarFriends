...
public class DBUpgradeSlotsMachineGunner : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public string[] rowNames = new string[128]
	{
		...
		"SPECIAL_19", "SPECIAL_20", "SPECIAL_21", "SPECIAL_22", "SPECIAL_23", "SPECIAL_24", "SPECIAL_25", "WARARENA"
	};
	...
	public List<DBUpgradeSlotsMachineGunnerRow> Rows = new List<DBUpgradeSlotsMachineGunnerRow>();

	public override bool haveDictionary => true;

	public override int getColumnCount => 14;
	...
	{
		Rows.Add(new DBUpgradeSlotsMachineGunnerRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new DBUpgradeSlotsMachineGunnerRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public DBUpgradeSlotsMachineGunnerRow GetRow(rowIds in_RowID)
	{
		DBUpgradeSlotsMachineGunnerRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public DBUpgradeSlotsMachineGunnerRow GetRow(string in_RowString)
	{
		DBUpgradeSlotsMachineGunnerRow result = null;
