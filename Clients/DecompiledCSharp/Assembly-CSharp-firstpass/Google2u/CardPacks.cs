...
public class CardPacks : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		BRONZE_CARDPACK,
	...
	public string[] rowNames = new string[4] { "BRONZE_CARDPACK", "SILVER_CARDPACK", "GOLD_CARDPACK", "THREE_CARDS" };
	...
	public List<CardPacksRow> Rows = new List<CardPacksRow>();
	...
	{
		Rows.Add(new CardPacksRow(input[0], input[1], input[2], input[3]));
	}
	...
	public CardPacksRow GetRow(rowIds in_RowID)
	{
		CardPacksRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public CardPacksRow GetRow(string in_RowString)
	{
		CardPacksRow result = null;
