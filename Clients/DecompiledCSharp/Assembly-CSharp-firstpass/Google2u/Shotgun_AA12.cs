...
public class Shotgun_AA12 : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Shotgun_AA12Row> Rows = new List<Shotgun_AA12Row>();
	...
	{
		Rows.Add(new Shotgun_AA12Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
	}
	...
	public Shotgun_AA12Row GetRow(rowIds in_RowID)
	{
		Shotgun_AA12Row result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Shotgun_AA12Row GetRow(string in_RowString)
	{
		Shotgun_AA12Row result = null;
