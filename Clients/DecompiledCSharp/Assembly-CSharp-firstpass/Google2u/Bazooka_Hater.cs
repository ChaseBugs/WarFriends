...
public class Bazooka_Hater : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Bazooka_HaterRow> Rows = new List<Bazooka_HaterRow>();
	...
	{
		Rows.Add(new Bazooka_HaterRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public Bazooka_HaterRow GetRow(rowIds in_RowID)
	{
		Bazooka_HaterRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Bazooka_HaterRow GetRow(string in_RowString)
	{
		Bazooka_HaterRow result = null;
