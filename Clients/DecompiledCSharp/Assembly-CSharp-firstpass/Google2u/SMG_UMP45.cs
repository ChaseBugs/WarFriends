...
public class SMG_UMP45 : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<SMG_UMP45Row> Rows = new List<SMG_UMP45Row>();
	...
	{
		Rows.Add(new SMG_UMP45Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public SMG_UMP45Row GetRow(rowIds in_RowID)
	{
		SMG_UMP45Row result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public SMG_UMP45Row GetRow(string in_RowString)
	{
		SMG_UMP45Row result = null;
