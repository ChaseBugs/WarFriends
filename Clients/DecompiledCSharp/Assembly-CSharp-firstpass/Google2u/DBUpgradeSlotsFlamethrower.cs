...
public class DBUpgradeSlotsFlamethrower : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public string[] rowNames = new string[60]
	{
		...
		"ROW_51", "SPECIAL_0", "SPECIAL_1", "SPECIAL_2", "SPECIAL_3", "SPECIAL_4", "SPECIAL_5", "CARDS_MIN", "CARDS_MAX", "WARARENA"
	};
	...
	public List<DBUpgradeSlotsFlamethrowerRow> Rows = new List<DBUpgradeSlotsFlamethrowerRow>();
	...
	{
		Rows.Add(new DBUpgradeSlotsFlamethrowerRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new DBUpgradeSlotsFlamethrowerRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public DBUpgradeSlotsFlamethrowerRow GetRow(rowIds in_RowID)
	{
		DBUpgradeSlotsFlamethrowerRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public DBUpgradeSlotsFlamethrowerRow GetRow(string in_RowString)
	{
		DBUpgradeSlotsFlamethrowerRow result = null;
