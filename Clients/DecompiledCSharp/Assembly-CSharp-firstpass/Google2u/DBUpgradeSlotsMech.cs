...
public class DBUpgradeSlotsMech : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<DBUpgradeSlotsMechRow> Rows = new List<DBUpgradeSlotsMechRow>();
	...
	{
		Rows.Add(new DBUpgradeSlotsMechRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new DBUpgradeSlotsMechRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public DBUpgradeSlotsMechRow GetRow(rowIds in_RowID)
	{
		DBUpgradeSlotsMechRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public DBUpgradeSlotsMechRow GetRow(string in_RowString)
	{
		DBUpgradeSlotsMechRow result = null;
