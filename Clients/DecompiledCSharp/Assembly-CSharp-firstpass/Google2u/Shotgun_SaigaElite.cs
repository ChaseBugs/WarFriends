...
public class Shotgun_SaigaElite : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Shotgun_SaigaEliteRow> Rows = new List<Shotgun_SaigaEliteRow>();
	...
	{
		Rows.Add(new Shotgun_SaigaEliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new Shotgun_SaigaEliteRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public Shotgun_SaigaEliteRow GetRow(rowIds in_RowID)
	{
		Shotgun_SaigaEliteRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Shotgun_SaigaEliteRow GetRow(string in_RowString)
	{
		Shotgun_SaigaEliteRow result = null;
