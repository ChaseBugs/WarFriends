...
[Serializable]
public class DBUpgradeSlotsGrennaderRow : IGoogle2uRow
{
	public int TIER;
	...
	public ObscuredFloat GRENADEMINDAMAGE;

	public ObscuredFloat GRENADEEXPLODEDAMAGE;
	...
	public ObscuredFloat Get_GRENADEMINDAMAGE
	{
		get
		{
			return GRENADEMINDAMAGE;
		}
		set
		{
			GRENADEMINDAMAGE = value;
		}
	}

	public ObscuredFloat Get_GRENADEEXPLODEDAMAGE
	{
		get
		{
			return GRENADEEXPLODEDAMAGE;
		}
		set
		{
			GRENADEEXPLODEDAMAGE = value;
		}
	}
	...
	public DBUpgradeSlotsGrennaderRow(string _GOOGLEFU_ID, string _TIER, string _HP, string _DAMAGE, string _GRENADEMINDAMAGE, string _GRENADEEXPLODEDAMAGE, string _BATCHSIZEMIN, string _BATCHSIZEMAX, string _SHOTFREQUENCYMIN, string _SHOTFREQUENCYMAX, string _REALSHOTPROBABILITY, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ARMYPOWER, string _SPECIAL, string _ELITE)
	{
		...
		if (float.TryParse(_GRENADEMINDAMAGE, out var result4))
		{
			GRENADEMINDAMAGE = result4;
		}
		else
		{
			Debug.LogError("Failed To Convert GRENADEMINDAMAGE string: " + _GRENADEMINDAMAGE + " to float");
		}
		if (float.TryParse(_GRENADEEXPLODEDAMAGE, out var result5))
		{
			GRENADEEXPLODEDAMAGE = result5;
		}
		else
		{
			Debug.LogError("Failed To Convert GRENADEEXPLODEDAMAGE string: " + _GRENADEEXPLODEDAMAGE + " to float");
		}
		...
		if (int.TryParse(_NEXTUPGRADEPRICE, out var result11))
		{
			NEXTUPGRADEPRICE = result11;
		}
		else
		{
			Debug.LogError("Failed To Convert NEXTUPGRADEPRICE string: " + _NEXTUPGRADEPRICE + " to float");
		}
		if (int.TryParse(_NEXTUPGRADEPRICEGOLD, out var result12))
		{
			NEXTUPGRADEPRICEGOLD = result12;
		}
		else
		{
			Debug.LogError("Failed To Convert NEXTUPGRADEPRICEGOLD string: " + _NEXTUPGRADEPRICEGOLD + " to int");
		}
		if (float.TryParse(_DELIVERYTIME, out var result13))
		{
			DELIVERYTIME = result13;
		}
		else
		{
			Debug.LogError("Failed To Convert DELIVERYTIME string: " + _DELIVERYTIME + " to float");
		}
		if (float.TryParse(_DPS, out var result14))
		{
			DPS = result14;
		}
		else
		...
		if (float.TryParse(_ARMYPOWER, out var result15))
		{
			ARMYPOWER = result15;
		}
		else
		...
		if (float.TryParse(_SPECIAL, out var result16))
		{
			SPECIAL = result16;
		}
		else
		...
		if (float.TryParse(_ELITE, out var result17))
		{
			ELITE = result17;
		}
		else
	...
	public string GetStringDataByIndex(int index)
	{
		...
		case 2:
			...
			break;
		case 3:
			result = GRENADEMINDAMAGE.ToString();
			break;
		case 4:
			result = GRENADEEXPLODEDAMAGE.ToString();
			break;
		case 5:
	...
	public string GetStringData(string colID)
	{
		...
		case "DAMAGE":
			result = DAMAGE.ToString();
			break;
		case "GRENADEMINDAMAGE":
			result = GRENADEMINDAMAGE.ToString();
			break;
		case "GRENADEEXPLODEDAMAGE":
			result = GRENADEEXPLODEDAMAGE.ToString();
			break;
		case "BATCHSIZEMIN":
			result = BATCHSIZEMIN.ToString();
	...
	public override string ToString()
	{
		...
		empty = empty + "{GRENADEMINDAMAGE : " + GRENADEMINDAMAGE.ToString() + "} ";
		empty = empty + "{GRENADEEXPLODEDAMAGE : " + GRENADEEXPLODEDAMAGE.ToString() + "} ";
