...
public class Shotgun_Striker : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Shotgun_StrikerRow> Rows = new List<Shotgun_StrikerRow>();
	...
	{
		Rows.Add(new Shotgun_StrikerRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new Shotgun_StrikerRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public Shotgun_StrikerRow GetRow(rowIds in_RowID)
	{
		Shotgun_StrikerRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Shotgun_StrikerRow GetRow(string in_RowString)
	{
		Shotgun_StrikerRow result = null;
