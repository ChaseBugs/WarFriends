...
public class LMG_Minigun : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<LMG_MinigunRow> Rows = new List<LMG_MinigunRow>();
	...
	{
		Rows.Add(new LMG_MinigunRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8]));
	}
	...
	public LMG_MinigunRow GetRow(rowIds in_RowID)
	{
		LMG_MinigunRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public LMG_MinigunRow GetRow(string in_RowString)
	{
		LMG_MinigunRow result = null;
