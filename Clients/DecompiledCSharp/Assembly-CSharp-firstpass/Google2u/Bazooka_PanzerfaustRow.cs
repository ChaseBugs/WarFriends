...
[Serializable]
public class Bazooka_PanzerfaustRow : IGoogle2uRow
{
	...
	public Bazooka_PanzerfaustRow()
	{
	}

	public Bazooka_PanzerfaustRow(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
	{
