...
public class Grenade_POISON : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Grenade_POISONRow> Rows = new List<Grenade_POISONRow>();
	...
	{
		Rows.Add(new Grenade_POISONRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new Grenade_POISONRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public Grenade_POISONRow GetRow(rowIds in_RowID)
	{
		Grenade_POISONRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Grenade_POISONRow GetRow(string in_RowString)
	{
		Grenade_POISONRow result = null;
