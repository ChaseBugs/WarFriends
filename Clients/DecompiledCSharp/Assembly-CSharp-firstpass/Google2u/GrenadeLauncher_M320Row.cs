...
[Serializable]
public class GrenadeLauncher_M320Row : IGoogle2uRow
{
	...
	public GrenadeLauncher_M320Row()
	{
	}

	public GrenadeLauncher_M320Row(string _GOOGLEFU_ID, string _RELOADTIME, string _AMMO, string _EXPLODEDAMAGE, string _MINDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _DEADRADIUS, string _ATTACK)
	{
