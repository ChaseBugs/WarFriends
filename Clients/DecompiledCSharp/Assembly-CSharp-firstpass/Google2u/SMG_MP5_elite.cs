...
public class SMG_MP5_elite : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<SMG_MP5_eliteRow> Rows = new List<SMG_MP5_eliteRow>();
	...
	{
		Rows.Add(new SMG_MP5_eliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public SMG_MP5_eliteRow GetRow(rowIds in_RowID)
	{
		SMG_MP5_eliteRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public SMG_MP5_eliteRow GetRow(string in_RowString)
	{
		SMG_MP5_eliteRow result = null;
