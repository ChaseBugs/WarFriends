...
[Serializable]
public class SniperRifle_MSRRow : IGoogle2uRow
{
	...
	public SniperRifle_MSRRow()
	{
	}

	public SniperRifle_MSRRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
	{
