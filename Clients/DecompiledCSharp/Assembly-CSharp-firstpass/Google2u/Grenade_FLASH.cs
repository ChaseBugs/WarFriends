...
public class Grenade_FLASH : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Grenade_FLASHRow> Rows = new List<Grenade_FLASHRow>();
	...
	{
		Rows.Add(new Grenade_FLASHRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public Grenade_FLASHRow GetRow(rowIds in_RowID)
	{
		Grenade_FLASHRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Grenade_FLASHRow GetRow(string in_RowString)
	{
		Grenade_FLASHRow result = null;
