...
public class LMG_PKMachinegunElite : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<LMG_PKMachinegunEliteRow> Rows = new List<LMG_PKMachinegunEliteRow>();
	...
	{
		Rows.Add(new LMG_PKMachinegunEliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new LMG_PKMachinegunEliteRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public LMG_PKMachinegunEliteRow GetRow(rowIds in_RowID)
	{
		LMG_PKMachinegunEliteRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public LMG_PKMachinegunEliteRow GetRow(string in_RowString)
	{
		LMG_PKMachinegunEliteRow result = null;
