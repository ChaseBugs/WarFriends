...
public class SquadLeaderboardsRow : IGoogle2uRow
{
	...
	public SquadLeaderboardsRow(string _ID, string _DBID, string _TIER1REWARD, string _TIER2REWARD, string _TIER3REWARD, string _TIER4REWARD, string _TIER5REWARD, string _GOUPPERCENTAGE, string _GODOWNPERCENTAGE)
	{
		...
		if (int.TryParse(_TIER1REWARD, out var result2))
		{
			TIER1REWARD = result2;
		}
		else
		...
		if (int.TryParse(_TIER2REWARD, out var result3))
		{
			TIER2REWARD = result3;
		}
		else
		...
		if (int.TryParse(_TIER3REWARD, out var result4))
		{
			TIER3REWARD = result4;
		}
		else
		...
		if (int.TryParse(_TIER4REWARD, out var result5))
		{
			TIER4REWARD = result5;
		}
		else
		...
		if (int.TryParse(_TIER5REWARD, out var result6))
		{
			TIER5REWARD = result6;
		}
		else
		...
		if (float.TryParse(_GOUPPERCENTAGE, out var result7))
		{
		...
		if (float.TryParse(_GODOWNPERCENTAGE, out var result8))
		{
