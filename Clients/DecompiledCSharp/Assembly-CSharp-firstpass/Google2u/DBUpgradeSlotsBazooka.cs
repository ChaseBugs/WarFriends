...
public class DBUpgradeSlotsBazooka : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public string[] rowNames = new string[120]
	{
		...
		"SPECIAL_14", "SPECIAL_15", "SPECIAL_16", "SPECIAL_17", "SPECIAL_18", "SPECIAL_19", "SPECIAL_20", "CARDS_MIN", "CARDS_MAX", "WARARENA"
	};
	...
	public List<DBUpgradeSlotsBazookaRow> Rows = new List<DBUpgradeSlotsBazookaRow>();
	...
	{
		Rows.Add(new DBUpgradeSlotsBazookaRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new DBUpgradeSlotsBazookaRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public DBUpgradeSlotsBazookaRow GetRow(rowIds in_RowID)
	{
		DBUpgradeSlotsBazookaRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public DBUpgradeSlotsBazookaRow GetRow(string in_RowString)
	{
		DBUpgradeSlotsBazookaRow result = null;
