...
public class HeroicRewards : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		Reward1,
	...
	public string[] rowNames = new string[6] { "Reward1", "Reward2", "Reward3", "Reward4", "Reward5", "Reward6" };
	...
	public List<HeroicRewardsRow> Rows = new List<HeroicRewardsRow>();
	...
	{
		Rows.Add(new HeroicRewardsRow(input[0], input[1], input[2], input[3], input[4]));
	}
	...
	public HeroicRewardsRow GetRow(rowIds in_RowID)
	{
		HeroicRewardsRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public HeroicRewardsRow GetRow(string in_RowString)
	{
		HeroicRewardsRow result = null;
