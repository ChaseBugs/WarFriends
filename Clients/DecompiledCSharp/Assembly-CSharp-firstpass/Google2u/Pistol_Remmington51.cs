...
public class Pistol_Remmington51 : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Pistol_Remmington51Row> Rows = new List<Pistol_Remmington51Row>();
	...
	{
		Rows.Add(new Pistol_Remmington51Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new Pistol_Remmington51Row());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public Pistol_Remmington51Row GetRow(rowIds in_RowID)
	{
		Pistol_Remmington51Row result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Pistol_Remmington51Row GetRow(string in_RowString)
	{
		Pistol_Remmington51Row result = null;
