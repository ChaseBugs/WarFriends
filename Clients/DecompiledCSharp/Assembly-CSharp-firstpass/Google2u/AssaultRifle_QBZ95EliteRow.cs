...
[Serializable]
public class AssaultRifle_QBZ95EliteRow : IGoogle2uRow
{
	...
	public AssaultRifle_QBZ95EliteRow()
	{
	}

	public AssaultRifle_QBZ95EliteRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
	{
