...
public class StarterAssignments : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ID_1,
	...
	public string[] rowNames = new string[10] { "ID_1", "ID_2", "ID_3", "ID_4", "ID_5", "ID_6", "ID_7", "ID_8", "ID_9", "ID_10" };
	...
	public List<StarterAssignmentsRow> Rows = new List<StarterAssignmentsRow>();
	...
	{
		Rows.Add(new StarterAssignmentsRow(input[0], input[1], input[2], input[3], input[4]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new StarterAssignmentsRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public StarterAssignmentsRow GetRow(rowIds in_RowID)
	{
		StarterAssignmentsRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public StarterAssignmentsRow GetRow(string in_RowString)
	{
		StarterAssignmentsRow result = null;
