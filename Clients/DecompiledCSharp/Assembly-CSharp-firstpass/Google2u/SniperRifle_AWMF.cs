...
public class SniperRifle_AWMF : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<SniperRifle_AWMFRow> Rows = new List<SniperRifle_AWMFRow>();
	...
	{
		Rows.Add(new SniperRifle_AWMFRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new SniperRifle_AWMFRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public SniperRifle_AWMFRow GetRow(rowIds in_RowID)
	{
		SniperRifle_AWMFRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public SniperRifle_AWMFRow GetRow(string in_RowString)
	{
		SniperRifle_AWMFRow result = null;
