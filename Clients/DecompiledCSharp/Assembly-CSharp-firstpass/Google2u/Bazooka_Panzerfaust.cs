...
public class Bazooka_Panzerfaust : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Bazooka_PanzerfaustRow> Rows = new List<Bazooka_PanzerfaustRow>();
	...
	{
		Rows.Add(new Bazooka_PanzerfaustRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new Bazooka_PanzerfaustRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public Bazooka_PanzerfaustRow GetRow(rowIds in_RowID)
	{
		Bazooka_PanzerfaustRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Bazooka_PanzerfaustRow GetRow(string in_RowString)
	{
		Bazooka_PanzerfaustRow result = null;
