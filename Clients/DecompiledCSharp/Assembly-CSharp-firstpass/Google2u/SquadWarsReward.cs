...
public class SquadWarsReward : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ID_0,
	...
	public string[] rowNames = new string[7] { "ID_0", "ID_1", "ID_2", "ID_3", "ID_4", "ID_5", "ID_6" };
	...
	public List<SquadWarsRewardRow> Rows = new List<SquadWarsRewardRow>();
	...
	{
		Rows.Add(new SquadWarsRewardRow(input[0], input[1], input[2]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new SquadWarsRewardRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public SquadWarsRewardRow GetRow(rowIds in_RowID)
	{
		SquadWarsRewardRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public SquadWarsRewardRow GetRow(string in_RowString)
	{
		SquadWarsRewardRow result = null;
