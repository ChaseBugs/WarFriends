...
[Serializable]
public class Shotgun_SaigaRow : IGoogle2uRow
{
	...
	public Shotgun_SaigaRow()
	{
	}

	public Shotgun_SaigaRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _MINDAMAGE, string _MAXDAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
	{
