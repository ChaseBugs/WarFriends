...
public class LevelsRow : IGoogle2uRow
{
	...
	public LevelsRow(string _ID, string _LEVEL, string _EXPERIENCE, string _REWARDGOLD, string _REWARDWARBUCKS, string _ARMYPOWER)
	{
		...
		if (int.TryParse(_ARMYPOWER, out var result5))
		{
			ARMYPOWER = result5;
		}
		else
	...
	public override string ToString()
	{
		...
		return empty + "{ARMYPOWER : " + ARMYPOWER + "} ";
	}
}
