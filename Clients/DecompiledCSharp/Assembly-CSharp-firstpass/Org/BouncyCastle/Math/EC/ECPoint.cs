...
public abstract class ECPoint
{
	...
	protected virtual int CurveCoordinateSystem => (m_curve != null) ? m_curve.CoordinateSystem : 0;
	...
	{
		return (index >= 0 && index < m_zs.Length) ? m_zs[index] : null;
	}
	...
	public virtual bool IsNormalized()
	{
		...
		return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || IsInfinity || RawZCoords[0].IsOne;
	}
	...
	{
		return (!IsInfinity) ? Curve.CreateRawPoint(RawXCoord.Multiply(scale), RawYCoord, RawZCoords, IsCompressed) : this;
	}

	public virtual ECPoint ScaleY(ECFieldElement scale)
	{
		return (!IsInfinity) ? Curve.CreateRawPoint(RawXCoord, RawYCoord.Multiply(scale), RawZCoords, IsCompressed) : this;
	}
