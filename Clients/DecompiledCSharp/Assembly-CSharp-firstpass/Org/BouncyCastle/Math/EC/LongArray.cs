...
internal class LongArray
{
	...
	private static long Interleave3(long x)
	{
		...
		return num | Interleave3_21to63((int)x & 0x1FFFFF) | (Interleave3_21to63((int)(x >>> 21) & 0x1FFFFF) << 1) | (Interleave3_21to63((int)(x >>> 42) & 0x1FFFFF) << 2);
	}
	...
	{
		long num = x & long.MinValue;
		return num | INTERLEAVE7_TABLE[(int)x & 0x1FF] | (INTERLEAVE7_TABLE[(int)(x >>> 9) & 0x1FF] << 1) | (INTERLEAVE7_TABLE[(int)(x >>> 18) & 0x1FF] << 2) | (INTERLEAVE7_TABLE[(int)(x >>> 27) & 0x1FF] << 3) | (INTERLEAVE7_TABLE[(int)(x >>> 36) & 0x1FF] << 4) | (INTERLEAVE7_TABLE[(int)(x >>> 45) & 0x1FF] << 5) | (INTERLEAVE7_TABLE[(int)(x >>> 54) & 0x1FF] << 6);
	}
	...
	private static long Interleave2_32to64(int x)
	{
		...
		int num2 = INTERLEAVE2_TABLE[(x >>> 16) & 0xFF] | (INTERLEAVE2_TABLE[x >>> 24] << 16);
		return ((num2 & 0xFFFFFFFFu) << 32) | (num & 0xFFFFFFFFu);
	}
