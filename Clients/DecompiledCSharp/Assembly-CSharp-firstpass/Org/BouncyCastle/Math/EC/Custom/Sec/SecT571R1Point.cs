...
internal class SecT571R1Point : AbstractF2mPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		return new SecT571R1Point(curve, eCFieldElement10, y, new ECFieldElement[1] { eCFieldElement12 }, base.IsCompressed);
	}
	...
	public override ECPoint TwicePlus(ECPoint b)
	{
		...
		return new SecT571R1Point(curve, x3, y, new ECFieldElement[1] { eCFieldElement7 }, base.IsCompressed);
	}
