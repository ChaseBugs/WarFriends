...
internal class SecT571K1Point : AbstractF2mPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		return new SecT571K1Point(curve, eCFieldElement10, y, new ECFieldElement[1] { eCFieldElement12 }, base.IsCompressed);
	}
	...
	public override ECPoint Twice()
	{
		...
		ECFieldElement eCFieldElement = base.RawZCoords[0];
		bool isOne = eCFieldElement.IsOne;
		ECFieldElement eCFieldElement2 = ((!isOne) ? eCFieldElement.Square() : eCFieldElement);
		...
		ECFieldElement eCFieldElement5 = ((!isOne) ? eCFieldElement3.Multiply(eCFieldElement2) : eCFieldElement3);
		ECFieldElement eCFieldElement6 = rawYCoord.Add(rawXCoord).Square();
		ECFieldElement b = ((!isOne) ? eCFieldElement2.Square() : eCFieldElement);
