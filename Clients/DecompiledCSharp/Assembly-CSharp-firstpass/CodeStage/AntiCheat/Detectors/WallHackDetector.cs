		...
		if (base.enabled && base.gameObject.activeSelf)
		{
			...
			if (checkWireframe && wfCamera == null)
			{
				...
				else
				{
					...
					{
						shaderTexture = new Texture2D(4, 4, TextureFormat.ARGB32, mipmap: false);
					...
					{
						targetTexture = new Texture2D(renderTexture.width, renderTexture.height, TextureFormat.ARGB32, mipmap: false);
