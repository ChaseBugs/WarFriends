...
internal class DtlsRecordLayer : DatagramTransport
{
	...
	internal virtual ProtocolVersion DiscoveredPeerVersion => mDiscoveredPeerVersion;
				...
				case 24:
					{
						...
						if (mDiscoveredPeerVersion != null && !mDiscoveredPeerVersion.Equals(other))
						{
							break;
						}
