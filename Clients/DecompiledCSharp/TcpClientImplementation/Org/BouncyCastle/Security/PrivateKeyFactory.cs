...
public sealed class PrivateKeyFactory
{
	...
	public static AsymmetricKeyParameter CreateKey(PrivateKeyInfo keyInfo)
	{
		...
		if (objectID.Equals(CryptoProObjectIdentifiers.GostR3410x2001))
		{
			...
			ECPrivateKeyStructure eCPrivateKeyStructure2 = ((!(asn1Object is DerInteger)) ? ECPrivateKeyStructure.GetInstance(asn1Object) : new ECPrivateKeyStructure(((DerInteger)asn1Object).Value));
