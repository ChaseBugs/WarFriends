...
public class BasicOcspResp : X509ExtensionBase
{
	...
	public string SignatureAlgName => OcspUtilities.GetAlgorithmName(resp.SignatureAlgorithm.ObjectID);

	public string SignatureAlgOid => resp.SignatureAlgorithm.ObjectID.Id;
