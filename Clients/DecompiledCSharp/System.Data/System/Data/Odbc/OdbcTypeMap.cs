...
internal struct OdbcTypeMap(DbType dbType, OdbcType odbcType, SQL_C_TYPE nativeType, SQL_TYPE sqlType)
{
	public DbType DbType = dbType;

	public OdbcType OdbcType = odbcType;

	public SQL_C_TYPE NativeType = nativeType;

	public SQL_TYPE SqlType = sqlType;
