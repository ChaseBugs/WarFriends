...
public class ProtectedProviderSettings : ConfigurationElement
{
	...
	{
		providersProp = new ConfigurationProperty(string.Empty, typeof(ProviderSettingsCollection), null, null, null, ConfigurationPropertyOptions.IsDefaultCollection);
