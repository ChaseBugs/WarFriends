...
public sealed class ConfigurationLockCollection : ICollection, IEnumerable
{
	...
	private void CheckName(string name)
	{
		...
		{
			throw new ConfigurationErrorsException(string.Format("The {2} '{0}' is not valid in the locked list for this section.  The following {3} can be locked: '{1}'", name, valid_names, (!flag) ? "element" : "attribute", (!flag) ? "elements" : "attributes"));
		}
	}
