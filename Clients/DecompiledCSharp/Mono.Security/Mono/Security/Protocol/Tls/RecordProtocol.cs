...
internal abstract class RecordProtocol
{
	...
	private CipherSuite MapV2CipherCode(string prefix, int code)
	{
		try
		{
			return code switch
			{
				65664 => Context.SupportedCiphers[prefix + "RSA_WITH_RC4_128_MD5"], 
				131200 => Context.SupportedCiphers[prefix + "RSA_EXPORT_WITH_RC4_40_MD5"], 
				196736 => Context.SupportedCiphers[prefix + "RSA_EXPORT_WITH_RC2_CBC_40_MD5"], 
				262272 => Context.SupportedCiphers[prefix + "RSA_EXPORT_WITH_RC2_CBC_40_MD5"], 
				327808 => null, 
				393280 => null, 
				458944 => null, 
				_ => null, 
