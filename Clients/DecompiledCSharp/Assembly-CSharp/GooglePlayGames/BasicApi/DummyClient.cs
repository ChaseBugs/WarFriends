...
public class DummyClient : IPlayGamesClient
{
	...
	{
		LogUsage();
		idTokenCallback?.Invoke("DummyIdToken");
	}
	...
	{
		LogUsage();
		callback?.Invoke(CommonStatusCodes.ApiNotConnected, "DummyServerAuthCode");
	}
	...
	{
		LogUsage();
		callback?.Invoke(CommonStatusCodes.ApiNotConnected, null);
	}
