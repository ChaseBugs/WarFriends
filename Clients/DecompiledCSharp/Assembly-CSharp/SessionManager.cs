...
public class SessionManager : Singleton<SessionManager>
{
	...
	private bool skipFullSesionUpdate => !GameLoginManager.instance.data.isDeviceRegistered || Singleton<GameController>.instance.isTutorialInProgressOrPlaned || GameLoginManager.instance.acountDataDownloadingInProgress;
	...
	protected void Update()
	{
		...
		if (paused)
		{
			...
			if (mHelpC > 10)
			{
				...
				SendOnApplicationResumed(Singleton<MainSceneRoot>.instance.transform.FindChild("Managers"));
			}
			return;
		}
