...
public class CameraLineRenderer : MonoBehaviour
{
	...
	private static void CreateLineMaterial()
	{
		...
		{
			Instance.lineMaterial = new Material("Shader \"Lines/Colored Blended\" {SubShader { Pass {     Blend SrcAlpha OneMinusSrcAlpha     ZWrite Off Cull Off Fog { Mode Off }     BindChannels {      Bind \"vertex\", vertex Bind \"color\", color }} } }");
