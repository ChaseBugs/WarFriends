...
public abstract class UpgradeSlots : Core_BaseScript
{
	...
	[Skip]
	public struct UnitUpgrades(float scale)
	{
		public bool isElite = false;

		public bool isSpecial = false;

		public int slotUpgradeindex = 0;

		public int slotUpgradeIndexElite = 0;

		public int slotUpgradeIndexSpecial = 0;

		public float scaleDamage = scale;

		public float scaleHp = scale;
