...
public class PlayerTexturePool : Singleton<PlayerTexturePool>
{
	...
	protected override void Awake()
	{
		...
		{
			Texture2D texture2D = new Texture2D(Singleton<ArmyPreviewCamera>.instance.playerTexture.width, Singleton<ArmyPreviewCamera>.instance.playerTexture.height, TextureFormat.ARGB32, mipmap: true);
