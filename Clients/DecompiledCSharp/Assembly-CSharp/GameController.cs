...
public class GameController : Singleton<GameController>
{
	...
	private IEnumerator WaitForGameEndResponse()
	{
		...
		if (gameEndServerResponse == ServerResponse.Error)
		{
			...
			WarningDialog.ShowError(errorReason switch
			{
				DatabaseResult.ServerRespondedWithError => Localization.Localize("ID_CONFIRM_SERVERRESPONDEDWITHERROR"), 
				DatabaseResult.ServerDidntRespondAfterGame => Localization.Localize("ID_CONFIRM_SERVERDIDNTRESPONDAFTER"), 
				DatabaseResult.GameDidntExist => Localization.Localize("ID_CONFIRM_GAMEDIDNTEXIST"), 
				DatabaseResult.GameAlreadyEnded => Localization.Localize("ID_CONFIRM_GAMELAREADYENDED"), 
				DatabaseResult.InvalidToken => Localization.Localize("ID_CONFIRM_LOGGEDOUT_TEXT"), 
				_ => string.Format("{0} {1}.", Localization.Localize("ID_CONFIRM_OTHERSERVERRESPONDERROR"), (int)errorReason), 
			}, Localization.Localize("ID_CONFIRM_SERVERERROR"), 0f, delegate
			{
