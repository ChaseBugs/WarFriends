...
public class UnityWebRequestWrapper : IDisposable
{
	...
	public DownloadHandlerBufferWrapper DownloadHandler
	{
		...
		set
		{
			...
			downloadHandlerSetMethod.Invoke(unityWebRequestInstance, new object[1] { value.Instance });
	...
	public UploadHandlerRawWrapper UploadHandler
	{
		...
		set
		{
			...
			uploadHandlerSetMethod.Invoke(unityWebRequestInstance, new object[1] { value.Instance });
			uploadHandler = value;
		}
	}
	...
	{
		setRequestHeaderMethod.Invoke(unityWebRequestInstance, new object[2] { key, value });
	}
	...
	protected virtual void Dispose(bool disposing)
	{
		if (!disposedValue)
		{
			if (disposing && unityWebRequestInstance is IDisposable disposable)
			{
				disposable.Dispose();
			}
