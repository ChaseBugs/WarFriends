...
public class NSNumberFormatter : NSObject
{
	...
	public uint FormatWidth
	{
		...
		set
		{
			ObjC.MessageSend(Handle, Selector.GetHandle("setFormatWidth:"), value);
		}
	}
	...
	public uint GroupingSize
	{
		...
		set
		{
			ObjC.MessageSend(Handle, Selector.GetHandle("setGroupingSize:"), value);
		}
	}
	...
	public uint MaximumSignificantDigits
	{
		...
		set
		{
			ObjC.MessageSend(Handle, Selector.GetHandle("setMaximumSignificantDigits:"), value);
		}
	}
	...
	public uint MinimumSignificantDigits
	{
		...
		set
		{
			ObjC.MessageSend(Handle, Selector.GetHandle("setMinimumSignificantDigits:"), value);
		}
	}
	...
	public uint SecondaryGroupingSize
	{
		...
		set
		{
			ObjC.MessageSend(Handle, Selector.GetHandle("setSecondaryGroupingSize:"), value);
		}
	}
