...
public class LandingSpot : MonoBehaviour
{
				...
				case 2:
					if (_0024self__002421._controller._flock.gameObject.activeInHierarchy && !_0024self__002421.landingChild)
					{
						...
						if ((bool)_0024fChild_002416)
						{
							...
							_0024self__002421.StartCoroutine_Auto(_0024self__002421.ReleaseFlockChild(_0024self__002421._controller._autoDismountDelay.x, _0024self__002421._controller._autoDismountDelay.y));
						}
						else if (!(_0024self__002421._controller._autoCatchDelay.x <= 0f))
						{
							_0024self__002421.StartCoroutine_Auto(_0024self__002421.GetFlockChild(_0024self__002421._controller._autoCatchDelay.x, _0024self__002421._controller._autoCatchDelay.y));
						}
					}
					YieldDefault(1);
					goto case 1;
		...
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			...
			public override bool MoveNext()
			{
				...
				case 3:
					...
					{
						_0024self__002428.StartCoroutine_Auto(_0024self__002428.GetFlockChild(_0024self__002428._controller._autoCatchDelay.x, _0024self__002428._controller._autoCatchDelay.y));
					}
	...
	public virtual void Start()
	{
		...
		{
			StartCoroutine_Auto(GetFlockChild(_controller._autoCatchDelay.x, _controller._autoCatchDelay.y));
		}
		RandomRotate();
	}
	...
	public virtual void LateUpdate()
	{
		...
		{
			StartCoroutine_Auto(ReleaseFlockChild(0f, 0f));
		}
	...
	public virtual void InstantLand()
	{
		...
		if ((bool)flockChild)
		{
			...
			StartCoroutine_Auto(ReleaseFlockChild(_controller._autoDismountDelay.x, _controller._autoDismountDelay.y));
		}
