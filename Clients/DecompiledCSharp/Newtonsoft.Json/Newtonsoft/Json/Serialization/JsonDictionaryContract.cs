...
public class JsonDictionaryContract : JsonContainerContract
{
		...
		: base(underlyingType)
	{
		...
		if (DictionaryValueType != null && ReflectionUtils.IsNullableType(DictionaryValueType) && ReflectionUtils.InheritsGenericDefinition(base.CreatedType, typeof(Dictionary<, >), out var _))
		{
