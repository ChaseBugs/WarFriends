...
public class MissionDialog : GuiElementSingle<MissionDialog>, IGuiDialog
{
	...
	public override void InitControls()
	{
		...
		mBossTexture = new Texture2D(Singleton<ArmyPreviewCamera>.instance.playerTexture.width, Singleton<ArmyPreviewCamera>.instance.playerTexture.height, TextureFormat.ARGB32, mipChain: true);
	}
