	...
	public class PlayerAccount
	{
		...
		public string hashKeyByAccount
		{
			get
			{
				switch (accountType)
				{
					case AccountType.Facebook: return hashKeyFB;
					case AccountType.GameCenter: return hashKeyGC;
					case AccountType.GooglePlay: return hashKeyGP;
					default: return hashKeyGuest;
				}
			}
		}
		...
		public string passwordByAccount
		{
			get
			{
				switch (accountType)
				{
					case AccountType.Facebook: return passwordFB;
					case AccountType.GameCenter: return passwordGC;
					case AccountType.GooglePlay: return passwordGP;
					default: return passwordGuest;
				}
			}
		}
