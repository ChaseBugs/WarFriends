...
{
	public string Id => PInvokeUtilities.OutParamsToString((StringBuilder out_string, UIntPtr out_size) => Event.Event_Id(SelfPtr(), out_string, out_size));

	public string Name => PInvokeUtilities.OutParamsToString((StringBuilder out_string, UIntPtr out_size) => Event.Event_Name(SelfPtr(), out_string, out_size));

	public string Description => PInvokeUtilities.OutParamsToString((StringBuilder out_string, UIntPtr out_size) => Event.Event_Description(SelfPtr(), out_string, out_size));

	public string ImageUrl => PInvokeUtilities.OutParamsToString((StringBuilder out_string, UIntPtr out_size) => Event.Event_ImageUrl(SelfPtr(), out_string, out_size));
