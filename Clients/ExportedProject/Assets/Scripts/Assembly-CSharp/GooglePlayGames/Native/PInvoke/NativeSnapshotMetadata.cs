...
internal class NativeSnapshotMetadata : BaseReferenceHolder, ISavedGameMetadata
{
	...
	public string Filename => PInvokeUtilities.OutParamsToString((StringBuilder out_string, UIntPtr out_size) => SnapshotMetadata.SnapshotMetadata_FileName(SelfPtr(), out_string, out_size));

	public string Description => PInvokeUtilities.OutParamsToString((StringBuilder out_string, UIntPtr out_size) => SnapshotMetadata.SnapshotMetadata_Description(SelfPtr(), out_string, out_size));

	public string CoverImageURL => PInvokeUtilities.OutParamsToString((StringBuilder out_string, UIntPtr out_size) => SnapshotMetadata.SnapshotMetadata_CoverImageURL(SelfPtr(), out_string, out_size));
