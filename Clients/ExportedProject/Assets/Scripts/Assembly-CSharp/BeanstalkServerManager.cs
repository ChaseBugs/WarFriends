...
public class BeanstalkServerManager : Singleton<BeanstalkServerManager>
{
	...
	public string environmentName
	{
		get
		{
			switch (environment)
			{
				case DatabaseEnvironment.DevelopmentSvk: return "DevelopmentSvk";
				case DatabaseEnvironment.Staging: return "Staging";
				case DatabaseEnvironment.Production: return "Production";
				case DatabaseEnvironment.QA: return "QA";
	...
	public bool shouldGetMessages => mInitialized && isPlayerDataLoaded && GameLoginManager.instance != null && GameLoginManager.instance.data != null && GameLoginManager.instance.data.isDeviceRegistered && Singleton<GameController>.instance != null && Singleton<GameController>.instance.gameState == GameController.GameState.Menu && !Singleton<GameController>.instance.isTutorial;
			...
			for (int i = 0; i < retryCount; i++)
			{
				...
				if (CachedApplicationInternetReachability.internetReachability != NetworkReachability.NotReachable)
				{
					...
					if (download.Exception != null)
					{
						...
						if (download.Exception is SocketException socketException && socketException.SocketErrorCode == SocketError.HostNotFound)
						{
