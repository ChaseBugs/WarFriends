...
public class Missile : PhysicalAmmo
{
	...
	private void TryKill(Vector3 impactPos)
	{
		if (!mExploded)
		{
			...
			switch (mSetup.missileType)
			{
				case MissileSetup.MissileType.Small: explosionType = Explosion.ExplosionType.Small; break;
				case MissileSetup.MissileType.RpgBasic: explosionType = Explosion.ExplosionType.Medium; break;
				case MissileSetup.MissileType.RpgBold: explosionType = Explosion.ExplosionType.Medium; break;
				default: explosionType = Explosion.ExplosionType.Big; break;
			}
