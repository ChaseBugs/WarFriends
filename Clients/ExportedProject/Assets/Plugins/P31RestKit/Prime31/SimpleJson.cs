...
public class SimpleJson
{
	...
	private static object decode(string json, Type type, string rootElement = null)
	{
		...
		if (rootElement != null)
		{
			...
			{
				Utils.logObject($"A rootElement was requested ({rootElement}) but the decoded object is not a Dictionary. It is a {obj.GetType()}");
			}
		}
	...
	public static T decodeObject<T>(object jsonObject, string rootElement = null)
	{
		...
		if (rootElement != null)
		{
			...
			{
				Utils.logObject($"A rootElement was requested ({rootElement}) but the decoded object is not a Dictionary. It is a {jsonObject.GetType()}");
			}
		}
