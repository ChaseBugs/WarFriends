...
public class P31RestKit
{
		...
		get
		{
			if (_surrogateGameObject == null)
			{
				...
				if (_surrogateGameObject == null)
				{
					...
					_surrogateGameObject.transform.parent = AbstractManager.getPrime31ManagerGameObject().transform;
				}
			}
	...
	protected MonoBehaviour surrogateMonobehaviour
	{
		get
		{
			...
			{
				_surrogateMonobehaviour = surrogateGameObject.AddComponent<CoroutineSurrogate>();
			}
