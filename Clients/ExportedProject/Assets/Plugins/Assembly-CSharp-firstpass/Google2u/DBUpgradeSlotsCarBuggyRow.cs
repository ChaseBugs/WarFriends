...
{
[Serializable]
public class DBUpgradeSlotsCarBuggyRow : IGoogle2uRow
{
	public int TIER;
	...
	public ObscuredFloat CANNONDAMAGE;

	public ObscuredFloat SHOTFREQUENCYMINCANNON;

	public ObscuredFloat SHOTFREQUENCYMAXCANNON;
	...
	public ObscuredFloat Get_CANNONDAMAGE
	{
		get
		{
			return CANNONDAMAGE;
	...
	public ObscuredFloat Get_SHOTFREQUENCYMINCANNON
	{
		get
		{
			return SHOTFREQUENCYMINCANNON;
		}
		set
		{
			SHOTFREQUENCYMINCANNON = value;
		}
	}

	public ObscuredFloat Get_SHOTFREQUENCYMAXCANNON
	{
		get
		{
			return SHOTFREQUENCYMAXCANNON;
		}
		set
		{
			SHOTFREQUENCYMAXCANNON = value;
		}
	}
	...
	public DBUpgradeSlotsCarBuggyRow()
	{
	}

	public DBUpgradeSlotsCarBuggyRow(string _GOOGLEFU_ID, string _TIER, string _HP, string _DAMAGE, string _BATCHSIZEMIN, string _BATCHSIZEMAX, string _SHOTFREQUENCYMIN, string _SHOTFREQUENCYMAX, string _REALSHOTPROBABILITY, string _CANNONDAMAGE, string _SHOTFREQUENCYMINCANNON, string _SHOTFREQUENCYMAXCANNON, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ARMYPOWER, string _SPECIAL, string _SOLDIERHP)
	{
		...
		if (float.TryParse(_CANNONDAMAGE, out var result9))
		{
			CANNONDAMAGE = result9;
		}
		else
		{
			Debug.LogError("Failed To Convert CANNONDAMAGE string: " + _CANNONDAMAGE + " to float");
		}
		if (float.TryParse(_SHOTFREQUENCYMINCANNON, out var result10))
		{
			SHOTFREQUENCYMINCANNON = result10;
		}
		else
		{
			Debug.LogError("Failed To Convert SHOTFREQUENCYMINCANNON string: " + _SHOTFREQUENCYMINCANNON + " to float");
		}
		if (float.TryParse(_SHOTFREQUENCYMAXCANNON, out var result11))
		{
			SHOTFREQUENCYMAXCANNON = result11;
		}
		else
		{
			Debug.LogError("Failed To Convert SHOTFREQUENCYMAXCANNON string: " + _SHOTFREQUENCYMAXCANNON + " to float");
		}
		if (int.TryParse(_NEXTUPGRADEPRICE, out var result12))
		{
			NEXTUPGRADEPRICE = result12;
		}
		else
		{
			Debug.LogError("Failed To Convert NEXTUPGRADEPRICE string: " + _NEXTUPGRADEPRICE + " to float");
		}
		if (int.TryParse(_NEXTUPGRADEPRICEGOLD, out var result13))
		{
			NEXTUPGRADEPRICEGOLD = result13;
		}
		else
		{
			Debug.LogError("Failed To Convert NEXTUPGRADEPRICEGOLD string: " + _NEXTUPGRADEPRICEGOLD + " to int");
		}
		if (float.TryParse(_DELIVERYTIME, out var result14))
		{
			DELIVERYTIME = result14;
		}
		else
		{
			Debug.LogError("Failed To Convert DELIVERYTIME string: " + _DELIVERYTIME + " to float");
		}
		if (float.TryParse(_DPS, out var result15))
		{
			DPS = result15;
		}
		else
		...
		if (float.TryParse(_ARMYPOWER, out var result16))
		{
			ARMYPOWER = result16;
		}
		else
		...
		if (float.TryParse(_SPECIAL, out var result17))
		{
			SPECIAL = result17;
		}
		else
		...
		if (float.TryParse(_SOLDIERHP, out var result18))
		{
			SOLDIERHP = result18;
		}
		else
		{
			Debug.LogError("Failed To Convert SOLDIERHP string: " + _SOLDIERHP + " to float");
		}
	}
	...
	public string GetStringDataByIndex(int index)
	{
		...
		case 7:
			...
			break;
		case 8:
			result = CANNONDAMAGE.ToString();
			break;
		case 9:
			result = SHOTFREQUENCYMINCANNON.ToString();
			break;
		case 10:
			result = SHOTFREQUENCYMAXCANNON.ToString();
			break;
		case 11:
	...
	public string GetStringData(string colID)
	{
		...
		case "CANNONDAMAGE":
			result = CANNONDAMAGE.ToString();
			break;
		case "SHOTFREQUENCYMINCANNON":
			result = SHOTFREQUENCYMINCANNON.ToString();
			break;
		case "SHOTFREQUENCYMAXCANNON":
			result = SHOTFREQUENCYMAXCANNON.ToString();
			break;
	...
	public override string ToString()
	{
		...
		empty = empty + "{CANNONDAMAGE : " + CANNONDAMAGE.ToString() + "} ";
		empty = empty + "{SHOTFREQUENCYMINCANNON : " + SHOTFREQUENCYMINCANNON.ToString() + "} ";
		empty = empty + "{SHOTFREQUENCYMAXCANNON : " + SHOTFREQUENCYMAXCANNON.ToString() + "} ";
		...
		return empty + "{SOLDIERHP : " + SOLDIERHP + "} ";
	}
}
}
