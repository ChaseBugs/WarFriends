...
namespace Google2u
{
public class SMG_P90 : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<SMG_P90Row> Rows = new List<SMG_P90Row>();
	...
	{
		Rows.Add(new SMG_P90Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public SMG_P90Row GetRow(rowIds in_RowID)
	{
		SMG_P90Row result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public SMG_P90Row GetRow(string in_RowString)
	{
		SMG_P90Row result = null;
