...
{
[Serializable]
public class AssaultRifle_AKS47URow : IGoogle2uRow
{
	...
	public AssaultRifle_AKS47URow()
	{
	}

	public AssaultRifle_AKS47URow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
	{
