...
namespace Google2u
{
public class Shotgun_SawnOff : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Shotgun_SawnOffRow> Rows = new List<Shotgun_SawnOffRow>();
	...
	{
		Rows.Add(new Shotgun_SawnOffRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new Shotgun_SawnOffRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public Shotgun_SawnOffRow GetRow(rowIds in_RowID)
	{
		Shotgun_SawnOffRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Shotgun_SawnOffRow GetRow(string in_RowString)
	{
		Shotgun_SawnOffRow result = null;
