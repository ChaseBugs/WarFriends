...
namespace Google2u
{
public class DBUpgradeSlotsCarBuggy : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public string[] rowNames = new string[103]
	{
		...
		"SPECIAL_14", "SPECIAL_15", "WARARENA"
	};
	...
	public List<DBUpgradeSlotsCarBuggyRow> Rows = new List<DBUpgradeSlotsCarBuggyRow>();
	...
	{
		Rows.Add(new DBUpgradeSlotsCarBuggyRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15], input[16], input[17], input[18]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new DBUpgradeSlotsCarBuggyRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public DBUpgradeSlotsCarBuggyRow GetRow(rowIds in_RowID)
	{
		DBUpgradeSlotsCarBuggyRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public DBUpgradeSlotsCarBuggyRow GetRow(string in_RowString)
	{
		DBUpgradeSlotsCarBuggyRow result = null;
