...
namespace Google2u
{
public class Shotgun_Blackhand : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Shotgun_BlackhandRow> Rows = new List<Shotgun_BlackhandRow>();
	...
	{
		Rows.Add(new Shotgun_BlackhandRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new Shotgun_BlackhandRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public Shotgun_BlackhandRow GetRow(rowIds in_RowID)
	{
		Shotgun_BlackhandRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Shotgun_BlackhandRow GetRow(string in_RowString)
	{
		Shotgun_BlackhandRow result = null;
