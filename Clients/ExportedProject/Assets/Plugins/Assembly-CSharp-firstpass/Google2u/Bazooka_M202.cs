...
namespace Google2u
{
public class Bazooka_M202 : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Bazooka_M202Row> Rows = new List<Bazooka_M202Row>();
	...
	{
		Rows.Add(new Bazooka_M202Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public Bazooka_M202Row GetRow(rowIds in_RowID)
	{
		Bazooka_M202Row result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Bazooka_M202Row GetRow(string in_RowString)
	{
		Bazooka_M202Row result = null;
