...
namespace Google2u
{
public class SMG_Vector : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<SMG_VectorRow> Rows = new List<SMG_VectorRow>();
	...
	{
		Rows.Add(new SMG_VectorRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public SMG_VectorRow GetRow(rowIds in_RowID)
	{
		SMG_VectorRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public SMG_VectorRow GetRow(string in_RowString)
	{
		SMG_VectorRow result = null;
