...
namespace Google2u
{
public class AssaultRifle_FamasElite : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<AssaultRifle_FamasEliteRow> Rows = new List<AssaultRifle_FamasEliteRow>();
	...
	{
		Rows.Add(new AssaultRifle_FamasEliteRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new AssaultRifle_FamasEliteRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public AssaultRifle_FamasEliteRow GetRow(rowIds in_RowID)
	{
		AssaultRifle_FamasEliteRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public AssaultRifle_FamasEliteRow GetRow(string in_RowString)
	{
		AssaultRifle_FamasEliteRow result = null;
