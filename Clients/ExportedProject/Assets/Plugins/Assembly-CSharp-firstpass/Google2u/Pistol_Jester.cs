...
namespace Google2u
{
public class Pistol_Jester : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Pistol_JesterRow> Rows = new List<Pistol_JesterRow>();
	...
	{
		Rows.Add(new Pistol_JesterRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public Pistol_JesterRow GetRow(rowIds in_RowID)
	{
		Pistol_JesterRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Pistol_JesterRow GetRow(string in_RowString)
	{
		Pistol_JesterRow result = null;
