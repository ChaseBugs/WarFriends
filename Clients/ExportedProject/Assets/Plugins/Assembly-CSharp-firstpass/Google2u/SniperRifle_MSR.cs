...
namespace Google2u
{
public class SniperRifle_MSR : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<SniperRifle_MSRRow> Rows = new List<SniperRifle_MSRRow>();
	...
	{
		Rows.Add(new SniperRifle_MSRRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new SniperRifle_MSRRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public SniperRifle_MSRRow GetRow(rowIds in_RowID)
	{
		SniperRifle_MSRRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public SniperRifle_MSRRow GetRow(string in_RowString)
	{
		SniperRifle_MSRRow result = null;
