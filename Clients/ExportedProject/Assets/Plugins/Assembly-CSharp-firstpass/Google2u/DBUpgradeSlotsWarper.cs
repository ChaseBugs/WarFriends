...
namespace Google2u
{
public class DBUpgradeSlotsWarper : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<DBUpgradeSlotsWarperRow> Rows = new List<DBUpgradeSlotsWarperRow>();
	...
	{
		Rows.Add(new DBUpgradeSlotsWarperRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new DBUpgradeSlotsWarperRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public DBUpgradeSlotsWarperRow GetRow(rowIds in_RowID)
	{
		DBUpgradeSlotsWarperRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public DBUpgradeSlotsWarperRow GetRow(string in_RowString)
	{
		DBUpgradeSlotsWarperRow result = null;
