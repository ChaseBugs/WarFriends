...
public class Achievements : Google2uComponentBase, IGoogle2uDB
{
	...
	public string[] rowNames = new string[13]
	{
		"finishBootcamp", "completeWarpath_1", "completeWarpath_2", "completeWarpath_3", "deployUnits_1", "deployUnits_2", "deployUnits_3", "winRankedBattles_1", "winRankedBattles_2", "winRankedBattles_3",
		"achieveRank_1", "achieveRank_2", "achieveRank_3"
	};
	...
	public Dictionary<string, int> namesToIndex = new Dictionary<string, int>
	{
		...
		{ "deployUnits_2", 5 },
		{ "deployUnits_3", 6 },
		{ "winRankedBattles_1", 7 },
		{ "winRankedBattles_2", 8 },
		{ "winRankedBattles_3", 9 },
		{ "achieveRank_1", 10 },
		{ "achieveRank_2", 11 },
		{ "achieveRank_3", 12 }
	};
	...
	{
		Rows.Add(new AchievementsRow(input[0], input[1], input[2], input[3], input[4], input[5]));
	}
