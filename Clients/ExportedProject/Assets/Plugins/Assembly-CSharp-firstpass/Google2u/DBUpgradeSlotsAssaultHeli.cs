...
namespace Google2u
{
public class DBUpgradeSlotsAssaultHeli : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public string[] rowNames = new string[109]
	{
		...
		"ROW_81", "ROW_82", "ROW_83", "ROW_84", "ROW_85", "ROW_86", "SPECIAL_0", "SPECIAL_1", "SPECIAL_2", "SPECIAL_3",
		"SPECIAL_4", "SPECIAL_5", "SPECIAL_6", "SPECIAL_7", "SPECIAL_8", "SPECIAL_9", "SPECIAL_10", "SPECIAL_11", "SPECIAL_12", "SPECIAL_13",
		"SPECIAL_14", "SPECIAL_15", "ELITE_0", "ELITE_1", "ELITE_2", "ELITE_3", "ELITE_4", "ELITE_5", "WARARENA"
	};
	...
	public List<DBUpgradeSlotsAssaultHeliRow> Rows = new List<DBUpgradeSlotsAssaultHeliRow>();

	public override bool haveDictionary => true;

	public override int getColumnCount => 18;
	...
	{
		Rows.Add(new DBUpgradeSlotsAssaultHeliRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15], input[16], input[17], input[18]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new DBUpgradeSlotsAssaultHeliRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public DBUpgradeSlotsAssaultHeliRow GetRow(rowIds in_RowID)
	{
		DBUpgradeSlotsAssaultHeliRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public DBUpgradeSlotsAssaultHeliRow GetRow(string in_RowString)
	{
		DBUpgradeSlotsAssaultHeliRow result = null;
