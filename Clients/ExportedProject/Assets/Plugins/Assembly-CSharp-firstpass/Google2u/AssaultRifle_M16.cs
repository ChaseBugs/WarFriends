...
namespace Google2u
{
public class AssaultRifle_M16 : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<AssaultRifle_M16Row> Rows = new List<AssaultRifle_M16Row>();
	...
	{
		Rows.Add(new AssaultRifle_M16Row(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new AssaultRifle_M16Row());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public AssaultRifle_M16Row GetRow(rowIds in_RowID)
	{
		AssaultRifle_M16Row result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public AssaultRifle_M16Row GetRow(string in_RowString)
	{
		AssaultRifle_M16Row result = null;
