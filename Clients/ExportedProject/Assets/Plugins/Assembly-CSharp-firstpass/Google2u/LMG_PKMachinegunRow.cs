...
{
[Serializable]
public class LMG_PKMachinegunRow : IGoogle2uRow
{
	...
	public LMG_PKMachinegunRow()
	{
	}

	public LMG_PKMachinegunRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
	{
