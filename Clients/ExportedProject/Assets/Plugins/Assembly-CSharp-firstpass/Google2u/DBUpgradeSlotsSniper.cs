...
namespace Google2u
{
public class DBUpgradeSlotsSniper : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public string[] rowNames = new string[126]
	{
		...
		"ELITE_3", "ELITE_4", "ELITE_5", "VEHICLE_MIN", "VEHICLE_MAX", "WARARENA"
	};
	...
	public List<DBUpgradeSlotsSniperRow> Rows = new List<DBUpgradeSlotsSniperRow>();
	...
	{
		Rows.Add(new DBUpgradeSlotsSniperRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14], input[15]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new DBUpgradeSlotsSniperRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public DBUpgradeSlotsSniperRow GetRow(rowIds in_RowID)
	{
		DBUpgradeSlotsSniperRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public DBUpgradeSlotsSniperRow GetRow(string in_RowString)
	{
		DBUpgradeSlotsSniperRow result = null;
