...
{
[Serializable]
public class SniperRifle_DragunovRow : IGoogle2uRow
{
	...
	public SniperRifle_DragunovRow()
	{
	}

	public SniperRifle_DragunovRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
	{
