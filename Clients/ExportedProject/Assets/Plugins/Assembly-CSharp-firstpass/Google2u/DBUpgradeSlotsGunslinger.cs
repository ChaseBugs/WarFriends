...
namespace Google2u
{
public class DBUpgradeSlotsGunslinger : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<DBUpgradeSlotsGunslingerRow> Rows = new List<DBUpgradeSlotsGunslingerRow>();
	...
	{
		Rows.Add(new DBUpgradeSlotsGunslingerRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9], input[10], input[11], input[12], input[13], input[14]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new DBUpgradeSlotsGunslingerRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public DBUpgradeSlotsGunslingerRow GetRow(rowIds in_RowID)
	{
		DBUpgradeSlotsGunslingerRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public DBUpgradeSlotsGunslingerRow GetRow(string in_RowString)
	{
		DBUpgradeSlotsGunslingerRow result = null;
