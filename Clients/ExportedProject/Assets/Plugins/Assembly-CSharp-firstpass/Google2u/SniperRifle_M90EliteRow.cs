...
{
[Serializable]
public class SniperRifle_M90EliteRow : IGoogle2uRow
{
	...
	public SniperRifle_M90EliteRow()
	{
	}

	public SniperRifle_M90EliteRow(string _GOOGLEFU_ID, string _RELOADTIME, string _CLIPSIZE, string _AMMO, string _DAMAGE, string _NEXTUPGRADEPRICE, string _NEXTUPGRADEPRICEGOLD, string _DELIVERYTIME, string _DPS, string _ATTACK)
	{
