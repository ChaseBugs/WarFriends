...
namespace Google2u
{
public class Pistol_DesertEagle : Google2uComponentBase, IGoogle2uDB
{
	public enum rowIds
	{
		ROW_1,
	...
	public List<Pistol_DesertEagleRow> Rows = new List<Pistol_DesertEagleRow>();
	...
	{
		Rows.Add(new Pistol_DesertEagleRow(input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7], input[8], input[9]));
	}
	...
	public override int AddBlanckRowGeneric(string rowId)
	{
		...
		Rows.Add(new Pistol_DesertEagleRow());
		mRows = null;
		return namesToIndex[rowId];
	}
	...
	public Pistol_DesertEagleRow GetRow(rowIds in_RowID)
	{
		Pistol_DesertEagleRow result = null;
		try
		{
			result = Rows[(int)in_RowID];
		}
	...
	public Pistol_DesertEagleRow GetRow(string in_RowString)
	{
		Pistol_DesertEagleRow result = null;
