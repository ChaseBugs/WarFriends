...
public class UIAnchor : MonoBehaviour
{
	...
	public void Start()
	{
		...
		mNeedsHalfPixelOffset = Application.platform == RuntimePlatform.WindowsPlayer || Application.platform == RuntimePlatform.XBOX360 || Application.platform == (RuntimePlatform)5 || Application.platform == RuntimePlatform.WindowsEditor;
