...
public class FpPoint : AbstractFpPoint
{
	...
	{
		if (index == 1 && CurveCoordinateSystem == 4)
		{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		case 1:
		{
			...
			ECFieldElement eCFieldElement23 = ((!isOne3) ? rawYCoord2.Multiply(eCFieldElement21) : rawYCoord2);
			ECFieldElement eCFieldElement24 = ((!isOne4) ? rawYCoord.Multiply(eCFieldElement22) : rawYCoord);
			ECFieldElement eCFieldElement25 = eCFieldElement23.Subtract(eCFieldElement24);
			ECFieldElement eCFieldElement26 = ((!isOne3) ? rawXCoord2.Multiply(eCFieldElement21) : rawXCoord2);
			ECFieldElement b6 = ((!isOne4) ? rawXCoord.Multiply(eCFieldElement22) : rawXCoord);
			...
			ECFieldElement b7 = (isOne3 ? eCFieldElement22 : ((!isOne4) ? eCFieldElement21.Multiply(eCFieldElement22) : eCFieldElement21));
	...
	public override ECPoint Twice()
	{
		...
		case 1:
		{
			...
			ECFieldElement eCFieldElement14 = ((!isOne2) ? rawYCoord.Multiply(eCFieldElement12) : rawYCoord);
			ECFieldElement eCFieldElement15 = ((!isOne2) ? eCFieldElement14.Multiply(rawYCoord) : rawYCoord.Square());
			...
			ECFieldElement x6 = ((!isOne2) ? eCFieldElement18.Square() : Two(eCFieldElement19));
		...
		case 2:
		{
			...
			else
			{
				...
				{
					ECFieldElement eCFieldElement6 = ((!isOne) ? eCFieldElement.Square() : eCFieldElement);
	...
	public override ECPoint TimesPow2(int e)
	{
		...
		ECFieldElement eCFieldElement4 = ((base.RawZCoords.Length >= 1) ? base.RawZCoords[0] : curve.FromBigInteger(BigInteger.One));
		...
		for (int i = 0; i < e; i++)
		{
			...
			eCFieldElement4 = ((!eCFieldElement4.IsOne) ? eCFieldElement7.Multiply(eCFieldElement4) : eCFieldElement7);
		}
		switch (coordinateSystem)
		{
		case 0:
	...
	protected virtual FpPoint TwiceJacobianModified(bool calculateW)
	{
		...
		ECFieldElement eCFieldElement8 = ((!calculateW) ? null : Two(eCFieldElement7.Multiply(jacobianModifiedW)));
		ECFieldElement eCFieldElement9 = ((!eCFieldElement.IsOne) ? eCFieldElement3.Multiply(eCFieldElement) : eCFieldElement3);
