...
internal class LongArray
{
	...
	private static int BitLength(long w)
	{
		...
		{
			num3 = (int)((uint)num >> 8);
			num4 = ((num3 != 0) ? (8 + BitLengths[num3]) : BitLengths[num]);
		}
		else
		{
			int num5 = (int)((uint)num3 >> 8);
			num4 = ((num5 != 0) ? (24 + BitLengths[num5]) : (16 + BitLengths[num3]));
		}
		return num2 + num4;
	}
	...
	{
		int num = otherDegree + (int)((uint)(63) >> (6));
	...
	public LongArray ModMultiplyLD(LongArray other, int m, int[] ks)
	{
		...
		int num4 = num + (int)((uint)(63) >> (6));
		int num5 = num2 + (int)((uint)(63) >> (6));
		int num6 = num + num2 + (int)((uint)(62) >> (6));
		if (num4 == 1)
		{
		...
		for (int num11 = 56; num11 >= 0; num11 -= 8)
		{
			...
			{
				int num12 = (int)((long)((ulong)(ints[j]) >> (num11)));
		...
		for (int num15 = 56; num15 >= 0; num15 -= 8)
		{
			...
			{
				int num16 = (int)((long)((ulong)(ints[k]) >> (num15)));
	...
	public LongArray ModMultiplyAlt(LongArray other, int m, int[] ks)
	{
		...
		int num13 = num2 + num12 + (int)((uint)(63) >> (6));
		...
		while (--num25 > 1)
		{
			...
			{
				AddShiftedUp(array3, array2[(int)((uint)(num25) >> (1))], array3, array2[num25], num6, num9);
			}
			else
			{
	...
	public LongArray ModSquare(int m, int[] ks)
	{
		...
		while (num2 < num)
		{
			long num3 = m_ints[(long)((ulong)(num2) >> (1))];
			array[num2++] = Interleave2_32to64((int)num3);
			array[num2++] = Interleave2_32to64((int)((long)((ulong)(num3) >> (32))));
		}
	...
	private static void SquareInPlace(long[] x, int xLen, int m, int[] ks)
	{
		...
		{
			long num2 = x[xLen];
			x[--num] = Interleave2_32to64((int)((long)((ulong)(num2) >> (32))));
	...
	private static long Interleave3(long x)
	{
		...
		return num | Interleave3_21to63((int)x & 0x1FFFFF) | (Interleave3_21to63((int)((long)((ulong)(x) >> (21))) & 0x1FFFFF) << 1) | (Interleave3_21to63((int)((long)((ulong)(x) >> (42))) & 0x1FFFFF) << 2);
	}

	private static long Interleave3_21to63(int x)
	{
		int num = INTERLEAVE3_TABLE[x & 0x7F];
		int num2 = INTERLEAVE3_TABLE[((long)((ulong)(x) >> (7))) & 0x7F];
		int num3 = INTERLEAVE3_TABLE[(long)((ulong)(x) >> (14))];
	...
	{
		return Interleave3_13to65((int)x & 0x1FFF) | (Interleave3_13to65((int)((long)((ulong)(x) >> (13))) & 0x1FFF) << 1) | (Interleave3_13to65((int)((long)((ulong)(x) >> (26))) & 0x1FFF) << 2) | (Interleave3_13to65((int)((long)((ulong)(x) >> (39))) & 0x1FFF) << 3) | (Interleave3_13to65((int)((long)((ulong)(x) >> (52))) & 0x1FFF) << 4);
	}

	private static long Interleave3_13to65(int x)
	{
		int num = INTERLEAVE5_TABLE[x & 0x7F];
		int num2 = INTERLEAVE5_TABLE[(long)((ulong)(x) >> (7))];
	...
	{
		long num = x & long.MinValue;
		return num | INTERLEAVE7_TABLE[(int)x & 0x1FF] | (INTERLEAVE7_TABLE[(int)((long)((ulong)(x) >> (9))) & 0x1FF] << 1) | (INTERLEAVE7_TABLE[(int)((long)((ulong)(x) >> (18))) & 0x1FF] << 2) | (INTERLEAVE7_TABLE[(int)((long)((ulong)(x) >> (27))) & 0x1FF] << 3) | (INTERLEAVE7_TABLE[(int)((long)((ulong)(x) >> (36))) & 0x1FF] << 4) | (INTERLEAVE7_TABLE[(int)((long)((ulong)(x) >> (45))) & 0x1FF] << 5) | (INTERLEAVE7_TABLE[(int)((long)((ulong)(x) >> (54))) & 0x1FF] << 6);
	}
	...
	private static long Interleave2_n(long x, int rounds)
	{
		...
		{
			rounds -= 2;
			x = Interleave4_16to64((int)x & 0xFFFF) | (Interleave4_16to64((int)((long)((ulong)(x) >> (16))) & 0xFFFF) << 1) | (Interleave4_16to64((int)((long)((ulong)(x) >> (32))) & 0xFFFF) << 2) | (Interleave4_16to64((int)((long)((ulong)(x) >> (48))) & 0xFFFF) << 3);
		}
		if (rounds > 0)
		{
			x = Interleave2_32to64((int)x) | (Interleave2_32to64((int)((long)((ulong)(x) >> (32)))) << 1);
		}
		return x;
	}
	...
	private static long Interleave4_16to64(int x)
	{
		...
		int num2 = INTERLEAVE4_TABLE[(long)((ulong)(x) >> (8))];
		return ((num2 & 0xFFFFFFFFu) << 32) | (num & 0xFFFFFFFFu);
	}

	private static long Interleave2_32to64(int x)
	{
		int num = INTERLEAVE2_TABLE[x & 0xFF] | (INTERLEAVE2_TABLE[((long)((ulong)(x) >> (8))) & 0xFF] << 16);
		int num2 = INTERLEAVE2_TABLE[((long)((ulong)(x) >> (16))) & 0xFF] | (INTERLEAVE2_TABLE[(long)((ulong)(x) >> (24))] << 16);
		return ((num2 & 0xFFFFFFFFu) << 32) | (num & 0xFFFFFFFFu);
	}
