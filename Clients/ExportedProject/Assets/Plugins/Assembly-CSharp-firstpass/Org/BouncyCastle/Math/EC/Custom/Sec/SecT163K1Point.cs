...
internal class SecT163K1Point : AbstractF2mPoint
{
	...
	public override ECPoint Twice()
	{
		...
		ECFieldElement eCFieldElement = base.RawZCoords[0];
		bool isOne = eCFieldElement.IsOne;
		ECFieldElement b = ((!isOne) ? rawYCoord.Multiply(eCFieldElement) : rawYCoord);
		ECFieldElement b2 = ((!isOne) ? eCFieldElement.Square() : eCFieldElement);
		...
		ECFieldElement eCFieldElement4 = ((!isOne) ? eCFieldElement2.Multiply(b2) : eCFieldElement2);
	...
	public override ECPoint TwicePlus(ECPoint b)
	{
		...
		return new SecT163K1Point(curve, x3, y, new ECFieldElement[1] { eCFieldElement7 }, base.IsCompressed);
	}
