	...
	public static ProtocolVersion Get(int major, int minor)
	{
		switch (major)
		{
			case 3:
				...
				{
					case 0: return SSLv3;
					case 1: return TLSv10;
					case 2: return TLSv11;
					case 3: return TLSv12;
					default: return GetUnknownVersion(major, minor, "TLS");
				}
			case 254:
				switch (minor)
				{
					case 255: return DTLSv10;
					case 254: throw new TlsFatalAlert(47);
					case 253: return DTLSv12;
					default: return GetUnknownVersion(major, minor, "DTLS");
				}
			default:
