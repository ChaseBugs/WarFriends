...
public class RijndaelEngine : IBlockCipher
{
	...
	private long[][] GenerateWorkingKey(byte[] key)
	{
		...
		switch (num2)
		{
			case 128: num3 = 4; break;
			case 160: num3 = 5; break;
			case 192: num3 = 6; break;
			case 224: num3 = 7; break;
			case 256: num3 = 8; break;
			default: throw new ArgumentException("Key length not 128/160/192/224/256 bits.");
		}
		if (num2 >= blockBits)
		{
			ROUNDS = num3 + 6;
