...
public abstract class UIWidget : MonoBehaviour
{
	...
	public Color color
	{
		...
		set
		{
			if ((double)mColor.a < 0.0001 && (double)value.a > 0.0001 && !mVisibleByPanel)
			{
				mChanged = true;
				mColor = value;
				mVisibleByPanel = mPanel == null || mPanel.IsVisible(this);
			}
	...
	public float alpha
	{
		...
		set
		{
			if ((double)mColor.a < 0.0001 && (double)value > 0.0001 && !mVisibleByPanel)
			{
				mChanged = true;
				mColor.a = value;
				mVisibleByPanel = mPanel == null || mPanel.IsVisible(this);
	...
	public int depth
	{
		...
		set
		{
			if (mDepth != value)
			{
				...
				if (mPanel != null)
				{
					mPanel.MarkMaterialAsChanged(material, sort: true, isPremultiplied);
				}
			}
		}
	}
	...
	public virtual bool isPremultiplied => true;
	...
	public bool UpdateGeometry(UIPanel p, bool forceVisible)
	{
		if (material != null && p != null)
		{
			...
			if (mChanged)
			{
				...
				{
					mGeom.Clear();
					OnFill(mGeom.verts, mGeom.uvs, mGeom.cols, mGeom.uvs2);
	...
	{
		mGeom.WriteToBuffers(v, u, c, n, t, uvs2);
	}
