...
public class HTTPResponse : IDisposable
{
	...
	protected byte[] DecodeStream(Stream streamToDecode)
	{
		...
		else
		{
			switch (list[0])
			{
				case "gzip": stream = new GZipStream(streamToDecode, CompressionMode.Decompress); break;
				case "deflate": stream = new DeflateStream(streamToDecode, CompressionMode.Decompress); break;
				default: stream = streamToDecode; break;
			}
		}
