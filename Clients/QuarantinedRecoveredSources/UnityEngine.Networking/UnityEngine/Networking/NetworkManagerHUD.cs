	...
	private void OnGUI()
	{
		...
		if (manager.matchInfo == null)
		{
			if (manager.matches == null)
			{
				...
				{
					manager.matchMaker.CreateMatch(manager.matchName, manager.matchSize, matchAdvertise: true, string.Empty, manager.OnMatchCreate);
				}
				num2 += 24;
				...
				{
					manager.matchMaker.ListMatches(0, 20, string.Empty, manager.OnMatchList);
				}
				num2 += 24;
			}
			else
