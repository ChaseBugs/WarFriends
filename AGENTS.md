...
- Validate server-owned assignment, achievement, and War Arena eligibility counters and receipt timestamps as nonnegative safe integers before comparisons or claim markers; `NaN` must never satisfy a reward gate through JavaScript comparison behavior.
