...
- Validate server-owned assignment and achievement eligibility counters as nonnegative safe integers before comparisons or claim markers; `NaN` must never satisfy a reward gate through JavaScript comparison behavior.
