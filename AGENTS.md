...
- Validate server-owned assignment, achievement, War Arena, and Squad War eligibility/placement counters and receipt timestamps as nonnegative safe integers before comparisons, increments, or claim markers; `NaN` must never satisfy a reward gate or placement through JavaScript comparison behavior.
